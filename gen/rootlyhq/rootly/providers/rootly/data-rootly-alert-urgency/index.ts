// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/data-sources/alert_urgency
...
export interface DataRootlyAlertUrgencyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/data-sources/alert_urgency#created_at DataRootlyAlertUrgency#created_at}
  */
  readonly createdAt?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/data-sources/alert_urgency#name DataRootlyAlertUrgency#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/data-sources/alert_urgency rootly_alert_urgency}
*/
export class DataRootlyAlertUrgency extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRootlyAlertUrgency that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/data-sources/alert_urgency#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/data-sources/alert_urgency rootly_alert_urgency} Data Source
  *
  * @param scope The scope in which to define this construct
