// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/data-sources/status_page
...
export interface DataRootlyStatusPageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/data-sources/status_page#created_at DataRootlyStatusPage#created_at}
  */
  readonly createdAt?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/data-sources/status_page#slug DataRootlyStatusPage#slug}
  */
  readonly slug?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/data-sources/status_page rootly_status_page}
*/
export class DataRootlyStatusPage extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRootlyStatusPage that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/data-sources/status_page#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/data-sources/status_page rootly_status_page} Data Source
  *
  * @param scope The scope in which to define this construct
