// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_shortcut_task
...
export interface WorkflowTaskCreateShortcutTaskConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_shortcut_task#enabled WorkflowTaskCreateShortcutTask#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_shortcut_task#id WorkflowTaskCreateShortcutTask#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_shortcut_task#name WorkflowTaskCreateShortcutTask#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_shortcut_task#position WorkflowTaskCreateShortcutTask#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_shortcut_task#skip_on_failure WorkflowTaskCreateShortcutTask#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_shortcut_task#workflow_id WorkflowTaskCreateShortcutTask#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_shortcut_task#task_params WorkflowTaskCreateShortcutTask#task_params}
  */
...
export interface WorkflowTaskCreateShortcutTaskTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_shortcut_task#completion WorkflowTaskCreateShortcutTask#completion}
  */
  readonly completion: { [key: string]: string };
  /**
  * The task description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_shortcut_task#description WorkflowTaskCreateShortcutTask#description}
  */
  readonly description: string;
  /**
  * The parent story
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_shortcut_task#parent_story_id WorkflowTaskCreateShortcutTask#parent_story_id}
  */
  readonly parentStoryId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_shortcut_task#task_type WorkflowTaskCreateShortcutTask#task_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_shortcut_task rootly_workflow_task_create_shortcut_task}
*/
export class WorkflowTaskCreateShortcutTask extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskCreateShortcutTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_shortcut_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_shortcut_task rootly_workflow_task_create_shortcut_task} Resource
  *
  * @param scope The scope in which to define this construct
