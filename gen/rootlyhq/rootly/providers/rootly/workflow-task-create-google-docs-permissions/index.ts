// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_permissions
...
export interface WorkflowTaskCreateGoogleDocsPermissionsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_permissions#enabled WorkflowTaskCreateGoogleDocsPermissions#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_permissions#id WorkflowTaskCreateGoogleDocsPermissions#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_permissions#name WorkflowTaskCreateGoogleDocsPermissions#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_permissions#position WorkflowTaskCreateGoogleDocsPermissions#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_permissions#skip_on_failure WorkflowTaskCreateGoogleDocsPermissions#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_permissions#workflow_id WorkflowTaskCreateGoogleDocsPermissions#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_permissions#task_params WorkflowTaskCreateGoogleDocsPermissions#task_params}
  */
...
export interface WorkflowTaskCreateGoogleDocsPermissionsTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_permissions#email_message WorkflowTaskCreateGoogleDocsPermissions#email_message}
  */
  readonly emailMessage?: string;
  /**
  * The Google Doc file ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_permissions#file_id WorkflowTaskCreateGoogleDocsPermissions#file_id}
  */
  readonly fileId: string;
  /**
  * Page permissions JSON
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_permissions#permissions WorkflowTaskCreateGoogleDocsPermissions#permissions}
  */
  readonly permissions: string;
  /**
  * Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_permissions#send_notification_email WorkflowTaskCreateGoogleDocsPermissions#send_notification_email}
  */
  readonly sendNotificationEmail?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_permissions#task_type WorkflowTaskCreateGoogleDocsPermissions#task_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_permissions rootly_workflow_task_create_google_docs_permissions}
*/
export class WorkflowTaskCreateGoogleDocsPermissions extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskCreateGoogleDocsPermissions that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_permissions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_permissions rootly_workflow_task_create_google_docs_permissions} Resource
  *
  * @param scope The scope in which to define this construct
