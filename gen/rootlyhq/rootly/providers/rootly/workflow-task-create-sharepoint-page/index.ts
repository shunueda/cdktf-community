// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page
...
export interface WorkflowTaskCreateSharepointPageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page#enabled WorkflowTaskCreateSharepointPage#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page#id WorkflowTaskCreateSharepointPage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page#name WorkflowTaskCreateSharepointPage#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page#position WorkflowTaskCreateSharepointPage#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page#skip_on_failure WorkflowTaskCreateSharepointPage#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page#workflow_id WorkflowTaskCreateSharepointPage#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page#task_params WorkflowTaskCreateSharepointPage#task_params}
  */
...
export interface WorkflowTaskCreateSharepointPageTaskParams {
  ...
  * The page content
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page#content WorkflowTaskCreateSharepointPage#content}
  */
  readonly content?: string;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page#drive WorkflowTaskCreateSharepointPage#drive}
  */
  readonly drive: { [key: string]: string };
  /**
  * Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page#mark_post_mortem_as_published WorkflowTaskCreateSharepointPage#mark_post_mortem_as_published}
  */
  readonly markPostMortemAsPublished?: boolean | cdktf.IResolvable;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page#parent_folder WorkflowTaskCreateSharepointPage#parent_folder}
  */
  readonly parentFolder?: { [key: string]: string };
  /**
  * Retrospective template to use when creating page, if desired
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page#post_mortem_template_id WorkflowTaskCreateSharepointPage#post_mortem_template_id}
  */
  readonly postMortemTemplateId?: string;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page#site WorkflowTaskCreateSharepointPage#site}
  */
  readonly site: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page#task_type WorkflowTaskCreateSharepointPage#task_type}
  */
  readonly taskType?: string;
  /**
  * The SharePoint file ID to use as a template
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page#template_id WorkflowTaskCreateSharepointPage#template_id}
  */
  readonly templateId?: string;
  /**
  * The page title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page#title WorkflowTaskCreateSharepointPage#title}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page rootly_workflow_task_create_sharepoint_page}
*/
export class WorkflowTaskCreateSharepointPage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskCreateSharepointPage that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_sharepoint_page rootly_workflow_task_create_sharepoint_page} Resource
  *
  * @param scope The scope in which to define this construct
