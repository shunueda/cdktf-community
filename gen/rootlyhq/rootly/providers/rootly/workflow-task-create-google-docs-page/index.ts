// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page
...
export interface WorkflowTaskCreateGoogleDocsPageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page#enabled WorkflowTaskCreateGoogleDocsPage#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page#id WorkflowTaskCreateGoogleDocsPage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page#name WorkflowTaskCreateGoogleDocsPage#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page#position WorkflowTaskCreateGoogleDocsPage#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page#skip_on_failure WorkflowTaskCreateGoogleDocsPage#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page#workflow_id WorkflowTaskCreateGoogleDocsPage#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page#task_params WorkflowTaskCreateGoogleDocsPage#task_params}
  */
...
export interface WorkflowTaskCreateGoogleDocsPageTaskParams {
  ...
  * The page content
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page#content WorkflowTaskCreateGoogleDocsPage#content}
  */
  readonly content?: string;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page#drive WorkflowTaskCreateGoogleDocsPage#drive}
  */
  readonly drive?: { [key: string]: string };
  /**
  * Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page#mark_post_mortem_as_published WorkflowTaskCreateGoogleDocsPage#mark_post_mortem_as_published}
  */
  readonly markPostMortemAsPublished?: boolean | cdktf.IResolvable;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page#parent_folder WorkflowTaskCreateGoogleDocsPage#parent_folder}
  */
  readonly parentFolder?: { [key: string]: string };
  /**
  * Page permissions JSON
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page#permissions WorkflowTaskCreateGoogleDocsPage#permissions}
  */
  readonly permissions?: string;
  /**
  * Retrospective template to use when creating page, if desired
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page#post_mortem_template_id WorkflowTaskCreateGoogleDocsPage#post_mortem_template_id}
  */
  readonly postMortemTemplateId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page#task_type WorkflowTaskCreateGoogleDocsPage#task_type}
  */
  readonly taskType?: string;
  /**
  * The Google Doc file ID to use as a template
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page#template_id WorkflowTaskCreateGoogleDocsPage#template_id}
  */
  readonly templateId?: string;
  /**
  * The page title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page#title WorkflowTaskCreateGoogleDocsPage#title}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page rootly_workflow_task_create_google_docs_page}
*/
export class WorkflowTaskCreateGoogleDocsPage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskCreateGoogleDocsPage that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_google_docs_page rootly_workflow_task_create_google_docs_page} Resource
  *
  * @param scope The scope in which to define this construct
