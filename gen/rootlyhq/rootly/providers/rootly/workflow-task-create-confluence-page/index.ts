// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page
...
export interface WorkflowTaskCreateConfluencePageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page#enabled WorkflowTaskCreateConfluencePage#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page#id WorkflowTaskCreateConfluencePage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page#name WorkflowTaskCreateConfluencePage#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page#position WorkflowTaskCreateConfluencePage#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page#skip_on_failure WorkflowTaskCreateConfluencePage#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page#workflow_id WorkflowTaskCreateConfluencePage#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page#task_params WorkflowTaskCreateConfluencePage#task_params}
  */
...
export interface WorkflowTaskCreateConfluencePageTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page#ancestor WorkflowTaskCreateConfluencePage#ancestor}
  */
  readonly ancestor?: { [key: string]: string };
  /**
  * The page content
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page#content WorkflowTaskCreateConfluencePage#content}
  */
  readonly content?: string;
  /**
  * Map must contain two fields, `id` and `name`. Specify integration id if you have more than one Confluence instance
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page#integration WorkflowTaskCreateConfluencePage#integration}
  */
  readonly integration?: { [key: string]: string };
  /**
  * Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page#mark_post_mortem_as_published WorkflowTaskCreateConfluencePage#mark_post_mortem_as_published}
  */
  readonly markPostMortemAsPublished?: boolean | cdktf.IResolvable;
  /**
  * The Retrospective template to use
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page#post_mortem_template_id WorkflowTaskCreateConfluencePage#post_mortem_template_id}
  */
  readonly postMortemTemplateId?: string;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page#space WorkflowTaskCreateConfluencePage#space}
  */
  readonly space: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page#task_type WorkflowTaskCreateConfluencePage#task_type}
  */
  readonly taskType?: string;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page#template WorkflowTaskCreateConfluencePage#template}
  */
  readonly template?: { [key: string]: string };
  /**
  * The page title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page#title WorkflowTaskCreateConfluencePage#title}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page rootly_workflow_task_create_confluence_page}
*/
export class WorkflowTaskCreateConfluencePage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskCreateConfluencePage that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/workflow_task_create_confluence_page rootly_workflow_task_create_confluence_page} Resource
  *
  * @param scope The scope in which to define this construct
