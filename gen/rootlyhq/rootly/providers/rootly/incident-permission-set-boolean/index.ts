// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/incident_permission_set_boolean
...
export interface IncidentPermissionSetBooleanConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/incident_permission_set_boolean#enabled IncidentPermissionSetBoolean#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/incident_permission_set_boolean#id IncidentPermissionSetBoolean#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/incident_permission_set_boolean#incident_permission_set_id IncidentPermissionSetBoolean#incident_permission_set_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/incident_permission_set_boolean#kind IncidentPermissionSetBoolean#kind}
  */
  readonly kind?: string;
  /**
  * Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/incident_permission_set_boolean#private IncidentPermissionSetBoolean#private}
  */
  readonly private?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/incident_permission_set_boolean rootly_incident_permission_set_boolean}
*/
export class IncidentPermissionSetBoolean extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IncidentPermissionSetBoolean that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/incident_permission_set_boolean#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.4/docs/resources/incident_permission_set_boolean rootly_incident_permission_set_boolean} Resource
  *
  * @param scope The scope in which to define this construct
