// https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/data-sources/systemsoftware
...
export interface DataMittwaldSystemsoftwareConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/data-sources/systemsoftware#name DataMittwaldSystemsoftware#name}
  */
  readonly name: string;
  /**
  * Set this to just select the recommended version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/data-sources/systemsoftware#recommended DataMittwaldSystemsoftware#recommended}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/data-sources/systemsoftware#selector DataMittwaldSystemsoftware#selector}
  */
  readonly selector?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/data-sources/systemsoftware mittwald_systemsoftware}
*/
export class DataMittwaldSystemsoftware extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMittwaldSystemsoftware that should be imported. Refer to the {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/data-sources/systemsoftware#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/data-sources/systemsoftware mittwald_systemsoftware} Data Source
  *
  * @param scope The scope in which to define this construct
