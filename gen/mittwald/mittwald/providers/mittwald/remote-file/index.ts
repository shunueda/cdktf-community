// https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/remote_file
...
export interface RemoteFileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/remote_file#app_id RemoteFile#app_id}
  */
  readonly appId?: string;
  /**
  * The ID of the container to connect to. Either container_id+stack_id or app_id must be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/remote_file#container_id RemoteFile#container_id}
  */
  readonly containerId?: string;
  /**
  * The contents of the file; use the file function to read from a file on the local filesystem.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/remote_file#contents RemoteFile#contents}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/remote_file#contents_from_url RemoteFile#contents_from_url}
  */
  readonly contentsFromUrl?: string;
  /**
  * The path of the file on the remote server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/remote_file#path RemoteFile#path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/remote_file#ssh_private_key RemoteFile#ssh_private_key}
  */
  readonly sshPrivateKey?: string;
  /**
  * The SSH username to use for the connection. If not specified, it will default to the currently authenticated user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/remote_file#ssh_user RemoteFile#ssh_user}
  */
  readonly sshUser?: string;
  /**
  * The ID of the stack that the container belongs to. Required when container_id is specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/remote_file#stack_id RemoteFile#stack_id}
  */
  readonly stackId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/remote_file mittwald_remote_file}
*/
export class RemoteFile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RemoteFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/remote_file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/remote_file mittwald_remote_file} Resource
  *
  * @param scope The scope in which to define this construct
