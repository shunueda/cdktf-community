// https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/container_registry
...
export interface ContainerRegistryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/container_registry#credentials ContainerRegistry#credentials}
  */
  readonly credentials?: ContainerRegistryCredentials;
  /**
  * Description for the registry
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/container_registry#description ContainerRegistry#description}
  */
  readonly description: string;
  /**
  * The ID of the project the container_registry belongs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/container_registry#project_id ContainerRegistry#project_id}
  */
  readonly projectId: string;
  /**
  * Hostname for the registry, for example `gitlab.example.com`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/container_registry#uri ContainerRegistry#uri}
  */
  readonly uri: string;
}
export interface ContainerRegistryCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/container_registry#password_wo ContainerRegistry#password_wo}
  */
  readonly passwordWo: string;
  /**
  * Version of the password for the registry. You will need to change this value whenever the password is changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/container_registry#password_wo_version ContainerRegistry#password_wo_version}
  */
  readonly passwordWoVersion: number;
  /**
  * Username for the registry
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/container_registry#username ContainerRegistry#username}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/container_registry mittwald_container_registry}
*/
export class ContainerRegistry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContainerRegistry that should be imported. Refer to the {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/container_registry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/container_registry mittwald_container_registry} Resource
  *
  * @param scope The scope in which to define this construct
