// https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/mysql_database
...
export interface MysqlDatabaseConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/mysql_database#character_settings MysqlDatabase#character_settings}
  */
  readonly characterSettings?: MysqlDatabaseCharacterSettings;
  /**
  * Description for your database
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/mysql_database#description MysqlDatabase#description}
  */
  readonly description: string;
  /**
  * The ID of the project the database belongs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/mysql_database#project_id MysqlDatabase#project_id}
  */
  readonly projectId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/mysql_database#user MysqlDatabase#user}
  */
  readonly user: MysqlDatabaseUser;
  /**
  * Version of the database, e.g. `5.7`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/mysql_database#version MysqlDatabase#version}
  */
...
export interface MysqlDatabaseCharacterSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/mysql_database#character_set MysqlDatabase#character_set}
  */
  readonly characterSet?: string;
  /**
  * Collation of the database, e.g. `utf8mb4_general_ci`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/mysql_database#collation MysqlDatabase#collation}
  */
...
export interface MysqlDatabaseUser {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/mysql_database#access_level MysqlDatabase#access_level}
  */
  readonly accessLevel: string;
  /**
  * Whether the database user should be accessible from outside the cluster
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/mysql_database#external_access MysqlDatabase#external_access}
  */
  readonly externalAccess: boolean | cdktf.IResolvable;
  /**
  * Password for the database user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/mysql_database#password MysqlDatabase#password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/mysql_database#password_wo MysqlDatabase#password_wo}
  */
  readonly passwordWo?: string;
  /**
  * Version of the password for the database user; this is required when using `password_wo`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/mysql_database#password_wo_version MysqlDatabase#password_wo_version}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/mysql_database mittwald_mysql_database}
*/
export class MysqlDatabase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/mysql_database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/mysql_database mittwald_mysql_database} Resource
  *
  * @param scope The scope in which to define this construct
