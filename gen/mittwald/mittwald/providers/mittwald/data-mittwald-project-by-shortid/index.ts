// https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/data-sources/project_by_shortid
...
export interface DataMittwaldProjectByShortidConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/data-sources/project_by_shortid#short_id DataMittwaldProjectByShortid#short_id}
  */
  readonly shortId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/data-sources/project_by_shortid mittwald_project_by_shortid}
*/
export class DataMittwaldProjectByShortid extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMittwaldProjectByShortid that should be imported. Refer to the {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/data-sources/project_by_shortid#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/data-sources/project_by_shortid mittwald_project_by_shortid} Data Source
  *
  * @param scope The scope in which to define this construct
