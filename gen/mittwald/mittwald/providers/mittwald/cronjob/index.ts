// https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/cronjob
...
export interface CronjobConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/cronjob#app_id Cronjob#app_id}
  */
  readonly appId: string;
  /**
  * Description for your cronjob
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/cronjob#description Cronjob#description}
  */
  readonly description: string;
  /**
  * Models the action to be executed by the cron job. Exactly one of `url` or `command` must be set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/cronjob#destination Cronjob#destination}
  */
  readonly destination: CronjobDestination;
  /**
  * The email address to send the cron job's output to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/cronjob#email Cronjob#email}
  */
  readonly email?: string;
  /**
  * The interval of the cron job; this should be a cron expression
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/cronjob#interval Cronjob#interval}
  */
  readonly interval: string;
  /**
  * The ID of the project the cronjob belongs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/cronjob#project_id Cronjob#project_id}
  */
...
export interface CronjobDestinationCommand {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/cronjob#interpreter Cronjob#interpreter}
  */
  readonly interpreter: string;
  /**
  * A list of parameters to pass to the command. Each parameter must be a valid string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/cronjob#parameters Cronjob#parameters}
  */
  readonly parameters?: string[];
  /**
  * The path to the file to run. Must be a valid path to an executable file within the project environment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/cronjob#path Cronjob#path}
  */
...
export interface CronjobDestination {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/cronjob#command Cronjob#command}
  */
  readonly command?: CronjobDestinationCommand;
  /**
  * The URL that should be requested by the cron job
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/cronjob#url Cronjob#url}
  */
  readonly url?: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/cronjob mittwald_cronjob}
*/
export class Cronjob extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cronjob that should be imported. Refer to the {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/cronjob#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.2/docs/resources/cronjob mittwald_cronjob} Resource
  *
  * @param scope The scope in which to define this construct
