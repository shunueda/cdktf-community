// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert
...
export interface SecmasterAlertConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#close_comment SecmasterAlert#close_comment}
  */
  readonly closeComment?: string;
  /**
  * Specifies the close reason.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#close_reason SecmasterAlert#close_reason}
  */
  readonly closeReason?: string;
  /**
  * Specifies whether it's debugging data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#debugging_data SecmasterAlert#debugging_data}
  */
  readonly debuggingData?: boolean | cdktf.IResolvable;
  /**
  * Specifies the description of the alert.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#description SecmasterAlert#description}
  */
  readonly description: string;
  /**
  * Specifies the first occurrence time of the indicator.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#first_occurrence_time SecmasterAlert#first_occurrence_time}
  */
  readonly firstOccurrenceTime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#id SecmasterAlert#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#labels SecmasterAlert#labels}
  */
  readonly labels?: string;
  /**
  * Specifies the last occurrence time of the indicator.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#last_occurrence_time SecmasterAlert#last_occurrence_time}
  */
  readonly lastOccurrenceTime?: string;
  /**
  * Specifies the alert name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#name SecmasterAlert#name}
  */
  readonly name: string;
  /**
  * Specifies the owner name of the alert.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#owner SecmasterAlert#owner}
  */
  readonly owner?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#region SecmasterAlert#region}
  */
  readonly region?: string;
  /**
  * Specifies the alert severity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#severity SecmasterAlert#severity}
  */
  readonly severity: string;
  /**
  * Specifies the alert stage.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#stage SecmasterAlert#stage}
  */
  readonly stage: string;
  /**
  * Specifies the alert status.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#status SecmasterAlert#status}
  */
  readonly status: string;
  /**
  * Specifies the alert verification status.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#verification_status SecmasterAlert#verification_status}
  */
  readonly verificationStatus: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#workspace_id SecmasterAlert#workspace_id}
  */
  readonly workspaceId: string;
  /**
  * data_source block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#data_source SecmasterAlert#data_source}
  */
  readonly dataSource: SecmasterAlertDataSource;
  /**
  * type block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#type SecmasterAlert#type}
  */
...
export interface SecmasterAlertDataSource {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#product_feature SecmasterAlert#product_feature}
  */
  readonly productFeature: string;
  /**
  * Specifies the product name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#product_name SecmasterAlert#product_name}
  */
  readonly productName: string;
  /**
  * Specifies the source type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#source_type SecmasterAlert#source_type}
  */
...
export interface SecmasterAlertType {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#alert_type SecmasterAlert#alert_type}
  */
  readonly alertType: string;
  /**
  * Specifies the category.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#category SecmasterAlert#category}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert hcs_secmaster_alert}
*/
export class SecmasterAlert extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_secmaster_alert";
  ...
  * @param importFromId The id of the existing SecmasterAlert that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SecmasterAlert to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_secmaster_alert", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert hcs_secmaster_alert} Resource
  *
  * @param scope The scope in which to define this construct
