// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_topic
...
export interface DmsRocketmqTopicConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_topic#id DmsRocketmqTopic#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_topic#instance_id DmsRocketmqTopic#instance_id}
  */
  readonly instanceId: string;
  /**
  * The message type of the topic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_topic#message_type DmsRocketmqTopic#message_type}
  */
  readonly messageType?: string;
  /**
  * The name of the topic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_topic#name DmsRocketmqTopic#name}
  */
  readonly name: string;
  /**
  * The permissions of the topic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_topic#permission DmsRocketmqTopic#permission}
  */
  readonly permission?: string;
  /**
  * The number of queues.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_topic#queue_num DmsRocketmqTopic#queue_num}
  */
  readonly queueNum?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_topic#region DmsRocketmqTopic#region}
  */
  readonly region?: string;
  /**
  * queues block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_topic#queues DmsRocketmqTopic#queues}
  */
...
export function dmsRocketmqTopicBrokersToTerraform(struct?: DmsRocketmqTopicBrokers): any {
...
export function dmsRocketmqTopicBrokersToHclTerraform(struct?: DmsRocketmqTopicBrokers): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DmsRocketmqTopicBrokersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DmsRocketmqTopicBrokers | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DmsRocketmqTopicBrokers | undefined) {
    if (value === undefined) {
...
export interface DmsRocketmqTopicQueues {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_topic#broker DmsRocketmqTopic#broker}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_topic hcs_dms_rocketmq_topic}
*/
export class DmsRocketmqTopic extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_dms_rocketmq_topic";
  ...
  * @param importFromId The id of the existing DmsRocketmqTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_topic#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DmsRocketmqTopic to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_dms_rocketmq_topic", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_topic hcs_dms_rocketmq_topic} Resource
  *
  * @param scope The scope in which to define this construct
