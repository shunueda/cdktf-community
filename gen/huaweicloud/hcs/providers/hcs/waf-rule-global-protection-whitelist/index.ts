// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/waf_rule_global_protection_whitelist
...
export interface WafRuleGlobalProtectionWhitelistConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/waf_rule_global_protection_whitelist#advanced_content WafRuleGlobalProtectionWhitelist#advanced_content}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/waf_rule_global_protection_whitelist#advanced_field WafRuleGlobalProtectionWhitelist#advanced_field}
  */
  readonly advancedField?: string;
  /**
  * Specifies the description of WAF global protection whitelist rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/waf_rule_global_protection_whitelist#description WafRuleGlobalProtectionWhitelist#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/waf_rule_global_protection_whitelist#domains WafRuleGlobalProtectionWhitelist#domains}
  */
  readonly domains: string[];
  /**
  * Specifies the enterprise project ID of WAF global protection whitelist rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/waf_rule_global_protection_whitelist#enterprise_project_id WafRuleGlobalProtectionWhitelist#enterprise_project_id}
  */
  readonly enterpriseProjectId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/waf_rule_global_protection_whitelist#id WafRuleGlobalProtectionWhitelist#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/waf_rule_global_protection_whitelist#ignore_waf_protection WafRuleGlobalProtectionWhitelist#ignore_waf_protection}
  */
  readonly ignoreWafProtection: string;
  /**
  * Specifies the policy ID of WAF global protection whitelist rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/waf_rule_global_protection_whitelist#policy_id WafRuleGlobalProtectionWhitelist#policy_id}
  */
  readonly policyId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/waf_rule_global_protection_whitelist#region WafRuleGlobalProtectionWhitelist#region}
  */
  readonly region?: string;
  /**
  * Specifies the status of WAF global protection whitelist rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/waf_rule_global_protection_whitelist#status WafRuleGlobalProtectionWhitelist#status}
  */
  readonly status?: number;
  /**
  * conditions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/waf_rule_global_protection_whitelist#conditions WafRuleGlobalProtectionWhitelist#conditions}
  */
...
export interface WafRuleGlobalProtectionWhitelistConditions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/waf_rule_global_protection_whitelist#content WafRuleGlobalProtectionWhitelist#content}
  */
  ...
  * or **header**.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/waf_rule_global_protection_whitelist#field WafRuleGlobalProtectionWhitelist#field}
  */
  readonly field: string;
  /**
  * Specifies the condition matching logic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/waf_rule_global_protection_whitelist#logic WafRuleGlobalProtectionWhitelist#logic}
  */
  readonly logic: string;
  /**
  * Specifies the subfield of the condition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/waf_rule_global_protection_whitelist#subfield WafRuleGlobalProtectionWhitelist#subfield}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/waf_rule_global_protection_whitelist hcs_waf_rule_global_protection_whitelist}
*/
export class WafRuleGlobalProtectionWhitelist extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_waf_rule_global_protection_whitelist";
  ...
  * @param importFromId The id of the existing WafRuleGlobalProtectionWhitelist that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/waf_rule_global_protection_whitelist#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_waf_rule_global_protection_whitelist", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/waf_rule_global_protection_whitelist hcs_waf_rule_global_protection_whitelist} Resource
  *
  * @param scope The scope in which to define this construct
