// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance
...
export interface DmsRocketmqInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#availability_zones DmsRocketmqInstance#availability_zones}
  */
  readonly availabilityZones: string[];
  /**
  * Specifies the broker numbers.(HCS is required, HC is optional)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#broker_num DmsRocketmqInstance#broker_num}
  */
  readonly brokerNum: number;
  /**
  * Specifies the description of the DMS RocketMQ instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#description DmsRocketmqInstance#description}
  */
  readonly description?: string;
  /**
  * Specifies whether access control is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#enable_acl DmsRocketmqInstance#enable_acl}
  */
  readonly enableAcl?: boolean | cdktf.IResolvable;
  /**
  * Specifies whether to enable public access.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#enable_publicip DmsRocketmqInstance#enable_publicip}
  */
  readonly enablePublicip?: boolean | cdktf.IResolvable;
  /**
  * Specifies the version of the RocketMQ engine.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#engine_version DmsRocketmqInstance#engine_version}
  */
  readonly engineVersion: string;
  /**
  * Specifies the enterprise project id of the instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#enterprise_project_id DmsRocketmqInstance#enterprise_project_id}
  */
  readonly enterpriseProjectId?: string;
  /**
  * Specifies a product ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#flavor_id DmsRocketmqInstance#flavor_id}
  */
  readonly flavorId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#id DmsRocketmqInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#ipv6_enable DmsRocketmqInstance#ipv6_enable}
  */
  readonly ipv6Enable?: boolean | cdktf.IResolvable;
  /**
  * Specifies the name of the DMS RocketMQ instance
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#name DmsRocketmqInstance#name}
  */
  readonly name: string;
  /**
  * Specifies the ID of the EIP bound to the instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#publicip_id DmsRocketmqInstance#publicip_id}
  */
  readonly publicipId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#region DmsRocketmqInstance#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#retention_policy DmsRocketmqInstance#retention_policy}
  */
  readonly retentionPolicy?: boolean | cdktf.IResolvable;
  /**
  * Specifies the ID of a security group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#security_group_id DmsRocketmqInstance#security_group_id}
  */
  readonly securityGroupId: string;
  /**
  * Specifies whether the RocketMQ SASL_SSL is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#ssl_enable DmsRocketmqInstance#ssl_enable}
  */
  readonly sslEnable?: boolean | cdktf.IResolvable;
  /**
  * Specifies the message storage capacity, Unit: GB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#storage_space DmsRocketmqInstance#storage_space}
  */
  readonly storageSpace: number;
  /**
  * Specifies the storage I/O specification
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#storage_spec_code DmsRocketmqInstance#storage_spec_code}
  */
  readonly storageSpecCode: string;
  /**
  * Specifies the ID of a subnet
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#subnet_id DmsRocketmqInstance#subnet_id}
  */
  readonly subnetId: string;
  /**
  * Specifies the ID of a VPC
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#vpc_id DmsRocketmqInstance#vpc_id}
  */
  readonly vpcId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#timeouts DmsRocketmqInstance#timeouts}
  */
...
export interface DmsRocketmqInstanceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#create DmsRocketmqInstance#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#delete DmsRocketmqInstance#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#update DmsRocketmqInstance#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance hcs_dms_rocketmq_instance}
*/
export class DmsRocketmqInstance extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_dms_rocketmq_instance";
  ...
  * @param importFromId The id of the existing DmsRocketmqInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_dms_rocketmq_instance", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/dms_rocketmq_instance hcs_dms_rocketmq_instance} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // public_grpc_address - computed: true, optional: false, required: false
  public get publicGrpcAddress() {
    return this.getStringAttribute('public_grpc_address');
  }
  ...
  // publicip_id - computed: true, optional: true, required: false
