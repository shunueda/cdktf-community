// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident
...
export interface SecmasterIncidentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#close_comment SecmasterIncident#close_comment}
  */
  readonly closeComment?: string;
  /**
  * Specifies the close reason.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#close_reason SecmasterIncident#close_reason}
  */
  readonly closeReason?: string;
  /**
  * Specifies whether it's debugging data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#debugging_data SecmasterIncident#debugging_data}
  */
  readonly debuggingData?: boolean | cdktf.IResolvable;
  /**
  * Specifies the incident description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#description SecmasterIncident#description}
  */
  readonly description: string;
  /**
  * Specifies the first occurrence time of the incident.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#first_occurrence_time SecmasterIncident#first_occurrence_time}
  */
  readonly firstOccurrenceTime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#id SecmasterIncident#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#labels SecmasterIncident#labels}
  */
  readonly labels?: string;
  /**
  * Specifies the last occurrence time of the incident.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#last_occurrence_time SecmasterIncident#last_occurrence_time}
  */
  readonly lastOccurrenceTime?: string;
  /**
  * Specifies the incident level.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#level SecmasterIncident#level}
  */
  readonly level: string;
  /**
  * Specifies the incident name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#name SecmasterIncident#name}
  */
  readonly name: string;
  /**
  * Specifies the user name of the owner.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#owner SecmasterIncident#owner}
  */
  readonly owner?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#region SecmasterIncident#region}
  */
  readonly region?: string;
  /**
  * Specifies the stage of the incident.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#stage SecmasterIncident#stage}
  */
  readonly stage?: string;
  /**
  * Specifies the incident status.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#status SecmasterIncident#status}
  */
  readonly status: string;
  /**
  * Specifies the verification status.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#verification_status SecmasterIncident#verification_status}
  */
  readonly verificationStatus?: string;
  /**
  * Specifies the ID of the workspace to which the incident belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#workspace_id SecmasterIncident#workspace_id}
  */
  readonly workspaceId: string;
  /**
  * data_source block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#data_source SecmasterIncident#data_source}
  */
  readonly dataSource: SecmasterIncidentDataSource;
  /**
  * type block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#type SecmasterIncident#type}
  */
...
export interface SecmasterIncidentDataSource {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#product_feature SecmasterIncident#product_feature}
  */
  readonly productFeature: string;
  /**
  * Specifies the product name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#product_name SecmasterIncident#product_name}
  */
  readonly productName: string;
  /**
  * Specifies the source type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#source_type SecmasterIncident#source_type}
  */
...
export interface SecmasterIncidentType {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#category SecmasterIncident#category}
  */
  readonly category: string;
  /**
  * Specifies the incident type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#incident_type SecmasterIncident#incident_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident hcs_secmaster_incident}
*/
export class SecmasterIncident extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_secmaster_incident";
  ...
  * @param importFromId The id of the existing SecmasterIncident that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SecmasterIncident to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_secmaster_incident", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_incident hcs_secmaster_incident} Resource
  *
  * @param scope The scope in which to define this construct
