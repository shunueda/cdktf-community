// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/nat_dnat_rule
...
export interface NatDnatRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/nat_dnat_rule#description NatDnatRule#description}
  */
  readonly description?: string;
  /**
  * The port range used by Floating IP provide services for external systems.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/nat_dnat_rule#external_service_port NatDnatRule#external_service_port}
  */
  readonly externalServicePort?: number;
  /**
  * The port range used by ECSs or BMSs to provide services for external systems.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/nat_dnat_rule#external_service_port_range NatDnatRule#external_service_port_range}
  */
  readonly externalServicePortRange?: string;
  /**
  * The ID of the floating IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/nat_dnat_rule#floating_ip_id NatDnatRule#floating_ip_id}
  */
  readonly floatingIpId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/nat_dnat_rule#id NatDnatRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/nat_dnat_rule#internal_service_port NatDnatRule#internal_service_port}
  */
  readonly internalServicePort?: number;
  /**
  * The port used by ECSs or BMSs to provide services for external systems.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/nat_dnat_rule#internal_service_port_range NatDnatRule#internal_service_port_range}
  */
  readonly internalServicePortRange?: string;
  /**
  * The ID of the NAT gateway to which the DNAT rule belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/nat_dnat_rule#nat_gateway_id NatDnatRule#nat_gateway_id}
  */
  readonly natGatewayId: string;
  /**
  * The port ID of network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/nat_dnat_rule#port_id NatDnatRule#port_id}
  */
  readonly portId?: string;
  /**
  * The private IP address of a user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/nat_dnat_rule#private_ip NatDnatRule#private_ip}
  */
  readonly privateIp?: string;
  /**
  * The protocol type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/nat_dnat_rule#protocol NatDnatRule#protocol}
  */
  readonly protocol: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/nat_dnat_rule#timeouts NatDnatRule#timeouts}
  */
  readonly timeouts?: NatDnatRuleTimeouts;
}
export interface NatDnatRuleTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/nat_dnat_rule#create NatDnatRule#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/nat_dnat_rule#delete NatDnatRule#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/nat_dnat_rule#update NatDnatRule#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/nat_dnat_rule hcs_nat_dnat_rule}
*/
export class NatDnatRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NatDnatRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/nat_dnat_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/nat_dnat_rule hcs_nat_dnat_rule} Resource
  *
  * @param scope The scope in which to define this construct
