// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/rds_sql_audit
...
export interface RdsSqlAuditConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/rds_sql_audit#audit_types RdsSqlAudit#audit_types}
  */
  readonly auditTypes?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/rds_sql_audit#id RdsSqlAudit#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/rds_sql_audit#instance_id RdsSqlAudit#instance_id}
  */
  readonly instanceId: string;
  /**
  * Specifies the number of days for storing audit logs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/rds_sql_audit#keep_days RdsSqlAudit#keep_days}
  */
  readonly keepDays: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/rds_sql_audit#region RdsSqlAudit#region}
  */
  ...
  * audit is disabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/rds_sql_audit#reserve_auditlogs RdsSqlAudit#reserve_auditlogs}
  */
  readonly reserveAuditlogs?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/rds_sql_audit#timeouts RdsSqlAudit#timeouts}
  */
  readonly timeouts?: RdsSqlAuditTimeouts;
}
export interface RdsSqlAuditTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/rds_sql_audit#create RdsSqlAudit#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/rds_sql_audit#delete RdsSqlAudit#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/rds_sql_audit#update RdsSqlAudit#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/rds_sql_audit hcs_rds_sql_audit}
*/
export class RdsSqlAudit extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_rds_sql_audit";
  ...
  * @param importFromId The id of the existing RdsSqlAudit that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/rds_sql_audit#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the RdsSqlAudit to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_rds_sql_audit", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/rds_sql_audit hcs_rds_sql_audit} Resource
  *
  * @param scope The scope in which to define this construct
