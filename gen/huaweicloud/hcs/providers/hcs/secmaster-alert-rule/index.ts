// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule
...
export interface SecmasterAlertRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#custom_information SecmasterAlertRule#custom_information}
  */
  readonly customInformation?: { [key: string]: string };
  /**
  * Specifies whether to generate debugging alarms.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#debugging_alarm SecmasterAlertRule#debugging_alarm}
  */
  readonly debuggingAlarm?: boolean | cdktf.IResolvable;
  /**
  * Specifies the description of the alert rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#description SecmasterAlertRule#description}
  */
  readonly description: string;
  /**
  * Specifies whether to put events in a group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#event_grouping SecmasterAlertRule#event_grouping}
  */
  readonly eventGrouping?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#id SecmasterAlertRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#name SecmasterAlertRule#name}
  */
  readonly name: string;
  /**
  * Specifies the pipeline ID of the alert rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#pipeline_id SecmasterAlertRule#pipeline_id}
  */
  readonly pipelineId: string;
  /**
  * Specifies the query rule of the alert rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#query_rule SecmasterAlertRule#query_rule}
  */
  readonly queryRule: string;
  /**
  * Specifies the query type of the alert rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#query_type SecmasterAlertRule#query_type}
  */
  readonly queryType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#region SecmasterAlertRule#region}
  */
  readonly region?: string;
  /**
  * Specifies the severity of the alert rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#severity SecmasterAlertRule#severity}
  */
  readonly severity: string;
  /**
  * Specifies the status of the alert rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#status SecmasterAlertRule#status}
  */
  readonly status: string;
  /**
  * Specifies whether to stop the query when an alarm is generated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#suppression SecmasterAlertRule#suppression}
  */
  readonly suppression?: boolean | cdktf.IResolvable;
  /**
  * Specifies the type of the alert rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#type SecmasterAlertRule#type}
  */
  readonly type: { [key: string]: string };
  /**
  * Specifies the ID of the workspace to which the alert rule belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#workspace_id SecmasterAlertRule#workspace_id}
  */
  readonly workspaceId: string;
  /**
  * query_plan block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#query_plan SecmasterAlertRule#query_plan}
  */
  readonly queryPlan: SecmasterAlertRuleQueryPlan;
  /**
  * triggers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#triggers SecmasterAlertRule#triggers}
  */
...
export interface SecmasterAlertRuleQueryPlan {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#execution_delay SecmasterAlertRule#execution_delay}
  */
  readonly executionDelay?: number;
  /**
  * Specifies the overtime interval in minutes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#overtime_interval SecmasterAlertRule#overtime_interval}
  */
  readonly overtimeInterval?: number;
  /**
  * Specifies the query interval.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#query_interval SecmasterAlertRule#query_interval}
  */
  readonly queryInterval: number;
  /**
  * Specifies the query interval unit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#query_interval_unit SecmasterAlertRule#query_interval_unit}
  */
  readonly queryIntervalUnit: string;
  /**
  * Specifies the time window.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#time_window SecmasterAlertRule#time_window}
  */
  readonly timeWindow: number;
  /**
  * Specifies the time window unit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#time_window_unit SecmasterAlertRule#time_window_unit}
  */
...
export interface SecmasterAlertRuleTriggers {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#accumulated_times SecmasterAlertRule#accumulated_times}
  */
  readonly accumulatedTimes: number;
  /**
  * Specifies the expression.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#expression SecmasterAlertRule#expression}
  */
  readonly expression: string;
  /**
  * Specifies the trigger mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#mode SecmasterAlertRule#mode}
  */
  readonly mode: string;
  /**
  * Specifies the operator.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#operator SecmasterAlertRule#operator}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule hcs_secmaster_alert_rule}
*/
export class SecmasterAlertRule extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_secmaster_alert_rule";
  ...
  * @param importFromId The id of the existing SecmasterAlertRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SecmasterAlertRule to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_secmaster_alert_rule", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_alert_rule hcs_secmaster_alert_rule} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: SecmasterAlertRuleConfig) {
    super(scope, id, {
      terraformResourceType: 'hcs_secmaster_alert_rule',
