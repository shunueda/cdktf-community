// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator
...
export interface SecmasterIndicatorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#confidence SecmasterIndicator#confidence}
  */
  readonly confidence: number;
  /**
  * Specifies the first occurrence time of the indicator.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#first_occurrence_time SecmasterIndicator#first_occurrence_time}
  */
  readonly firstOccurrenceTime: string;
  /**
  * Specifies the granularity of the indicator.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#granularity SecmasterIndicator#granularity}
  */
  readonly granularity: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#id SecmasterIndicator#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#invalid SecmasterIndicator#invalid}
  */
  readonly invalid?: boolean | cdktf.IResolvable;
  /**
  * Specifies the labels of the indicator in comma-separated string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#labels SecmasterIndicator#labels}
  */
  readonly labels?: string;
  /**
  * Specifies the last occurrence time of the indicator.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#last_occurrence_time SecmasterIndicator#last_occurrence_time}
  */
  readonly lastOccurrenceTime: string;
  /**
  * Specifies the indicator name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#name SecmasterIndicator#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#region SecmasterIndicator#region}
  */
  readonly region?: string;
  /**
  * Specifies the indicator status.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#status SecmasterIndicator#status}
  */
  readonly status: string;
  /**
  * Specifies the indicator type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#threat_degree SecmasterIndicator#threat_degree}
  */
  readonly threatDegree: string;
  /**
  * Specifies the value of the indicator.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#value SecmasterIndicator#value}
  */
  readonly value: string;
  /**
  * Specifies the ID of the workspace to which the indicator belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#workspace_id SecmasterIndicator#workspace_id}
  */
  readonly workspaceId: string;
  /**
  * data_source block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#data_source SecmasterIndicator#data_source}
  */
  readonly dataSource: SecmasterIndicatorDataSource;
  /**
  * type block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#type SecmasterIndicator#type}
  */
...
export interface SecmasterIndicatorDataSource {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#product_feature SecmasterIndicator#product_feature}
  */
  readonly productFeature: string;
  /**
  * Specifies the product name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#product_name SecmasterIndicator#product_name}
  */
  readonly productName: string;
  /**
  * Specifies the data source type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#source_type SecmasterIndicator#source_type}
  */
...
export interface SecmasterIndicatorType {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#category SecmasterIndicator#category}
  */
  ...
  * Specifies the indicator type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#indicator_type SecmasterIndicator#indicator_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator hcs_secmaster_indicator}
*/
export class SecmasterIndicator extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_secmaster_indicator";
  ...
  * @param importFromId The id of the existing SecmasterIndicator that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SecmasterIndicator to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_secmaster_indicator", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.18/docs/resources/secmaster_indicator hcs_secmaster_indicator} Resource
  *
  * @param scope The scope in which to define this construct
