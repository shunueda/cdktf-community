// https://registry.terraform.io/providers/files-com/files/0.1.365/docs/data-sources/priority
...
export interface DataFilesPriorityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/files-com/files/0.1.365/docs/data-sources/priority#path DataFilesPriority#path}
  */
  readonly path: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/files-com/files/0.1.365/docs/data-sources/priority files_priority}
*/
export class DataFilesPriority extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFilesPriority that should be imported. Refer to the {@link https://registry.terraform.io/providers/files-com/files/0.1.365/docs/data-sources/priority#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/files-com/files/0.1.365/docs/data-sources/priority files_priority} Data Source
  *
  * @param scope The scope in which to define this construct
