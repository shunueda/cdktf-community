// https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/data-sources/oncall_user_group
...
export interface DataGrafanaOncallUserGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/data-sources/oncall_user_group#id DataGrafanaOncallUserGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/data-sources/oncall_user_group#slack_handle DataGrafanaOncallUserGroup#slack_handle}
  */
  readonly slackHandle: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/data-sources/oncall_user_group grafana_oncall_user_group}
*/
export class DataGrafanaOncallUserGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaOncallUserGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/data-sources/oncall_user_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/data-sources/oncall_user_group grafana_oncall_user_group} Data Source
  *
  * @param scope The scope in which to define this construct
