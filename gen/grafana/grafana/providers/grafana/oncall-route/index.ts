// https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/resources/oncall_route
...
export interface OncallRouteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/resources/oncall_route#escalation_chain_id OncallRoute#escalation_chain_id}
  */
  readonly escalationChainId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/resources/oncall_route#id OncallRoute#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/resources/oncall_route#integration_id OncallRoute#integration_id}
  */
  readonly integrationId: string;
  /**
  * The position of the route (starts from 0).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/resources/oncall_route#position OncallRoute#position}
  */
  readonly position: number;
  /**
  * Python Regex query. Route is chosen for an alert if there is a match inside the alert payload.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/resources/oncall_route#routing_regex OncallRoute#routing_regex}
  */
  readonly routingRegex: string;
  /**
  * The type of route. Can be jinja2, regex Defaults to `regex`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/resources/oncall_route#routing_type OncallRoute#routing_type}
  */
  readonly routingType?: string;
  /**
  * msteams block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/resources/oncall_route#msteams OncallRoute#msteams}
  */
  readonly msteams?: OncallRouteMsteams;
  /**
  * slack block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/resources/oncall_route#slack OncallRoute#slack}
  */
  readonly slack?: OncallRouteSlack;
  /**
  * telegram block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/resources/oncall_route#telegram OncallRoute#telegram}
  */
...
export interface OncallRouteMsteams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/resources/oncall_route#enabled OncallRoute#enabled}
  */
...
export interface OncallRouteSlack {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/resources/oncall_route#channel_id OncallRoute#channel_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/resources/oncall_route grafana_oncall_route}
*/
export class OncallRoute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OncallRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/resources/oncall_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.12.0/docs/resources/oncall_route grafana_oncall_route} Resource
  *
  * @param scope The scope in which to define this construct
