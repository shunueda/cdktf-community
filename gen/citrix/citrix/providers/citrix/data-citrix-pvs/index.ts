// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/pvs
...
export interface DataCitrixPvsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/pvs#pvs_farm_name DataCitrixPvs#pvs_farm_name}
  */
  readonly pvsFarmName: string;
  /**
  * Name of the PVS site.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/pvs#pvs_site_name DataCitrixPvs#pvs_site_name}
  */
  readonly pvsSiteName: string;
  /**
  * Name of the PVS store.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/pvs#pvs_store_name DataCitrixPvs#pvs_store_name}
  */
  readonly pvsStoreName: string;
  /**
  * Name of the PVS vDisk.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/pvs#pvs_vdisk_name DataCitrixPvs#pvs_vdisk_name}
  */
  readonly pvsVdiskName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/pvs citrix_pvs}
*/
export class DataCitrixPvs extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixPvs that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/pvs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/pvs citrix_pvs} Data Source
  *
  * @param scope The scope in which to define this construct
