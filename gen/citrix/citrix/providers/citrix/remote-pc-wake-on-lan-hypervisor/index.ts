// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/remote_pc_wake_on_lan_hypervisor
...
export interface RemotePcWakeOnLanHypervisorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/remote_pc_wake_on_lan_hypervisor#max_absolute_active_actions RemotePcWakeOnLanHypervisor#max_absolute_active_actions}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/remote_pc_wake_on_lan_hypervisor#max_absolute_new_actions_per_minute RemotePcWakeOnLanHypervisor#max_absolute_new_actions_per_minute}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/remote_pc_wake_on_lan_hypervisor#max_power_actions_percentage_of_machines RemotePcWakeOnLanHypervisor#max_power_actions_percentage_of_machines}
  */
  readonly maxPowerActionsPercentageOfMachines?: number;
  /**
  * Metadata for the Hypervisor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/remote_pc_wake_on_lan_hypervisor#metadata RemotePcWakeOnLanHypervisor#metadata}
  */
  readonly metadata?: RemotePcWakeOnLanHypervisorMetadata[] | cdktf.IResolvable;
  /**
  * The name of the hypervisor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/remote_pc_wake_on_lan_hypervisor#name RemotePcWakeOnLanHypervisor#name}
  */
  readonly name: string;
  /**
  * The IDs of the scopes for the hypervisor to be a part of.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/remote_pc_wake_on_lan_hypervisor#scopes RemotePcWakeOnLanHypervisor#scopes}
  */
  readonly scopes?: string[];
  /**
  * Id of the zone the hypervisor is associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/remote_pc_wake_on_lan_hypervisor#zone RemotePcWakeOnLanHypervisor#zone}
  */
...
export interface RemotePcWakeOnLanHypervisorMetadata {
  ...
  * Metadata value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/remote_pc_wake_on_lan_hypervisor#value RemotePcWakeOnLanHypervisor#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/remote_pc_wake_on_lan_hypervisor citrix_remote_pc_wake_on_lan_hypervisor}
*/
export class RemotePcWakeOnLanHypervisor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RemotePcWakeOnLanHypervisor that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/remote_pc_wake_on_lan_hypervisor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/remote_pc_wake_on_lan_hypervisor citrix_remote_pc_wake_on_lan_hypervisor} Resource
  *
  * @param scope The scope in which to define this construct
