// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/site_backup_schedule
...
export interface SiteBackupScheduleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/site_backup_schedule#description SiteBackupSchedule#description}
  */
  readonly description?: string;
  /**
  * Whether the backup schedule is enabled. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/site_backup_schedule#enabled SiteBackupSchedule#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Frequency of the backup schedule. Defaults to `Daily`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/site_backup_schedule#frequency SiteBackupSchedule#frequency}
  */
  readonly frequency?: string;
  /**
  * Frequency factor for the backup schedule. Defaults to `1`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/site_backup_schedule#frequency_factor SiteBackupSchedule#frequency_factor}
  */
  readonly frequencyFactor?: number;
  /**
  * Name of the backup schedule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/site_backup_schedule#name SiteBackupSchedule#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/site_backup_schedule#start_date SiteBackupSchedule#start_date}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/site_backup_schedule#start_time SiteBackupSchedule#start_time}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/site_backup_schedule#timezone SiteBackupSchedule#timezone}
  */
  readonly timezone?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/site_backup_schedule citrix_site_backup_schedule}
*/
export class SiteBackupSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SiteBackupSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/site_backup_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/site_backup_schedule citrix_site_backup_schedule} Resource
  *
  * @param scope The scope in which to define this construct
