// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_priority
...
export interface PolicyPriorityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_priority#policy_priority PolicyPriority#policy_priority}
  */
  readonly policyPriority: string[];
  /**
  * GUID identifier of the policy set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_priority#policy_set_id PolicyPriority#policy_set_id}
  */
  readonly policySetId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_priority citrix_policy_priority}
*/
export class PolicyPriority extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyPriority that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_priority#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_priority citrix_policy_priority} Resource
  *
  * @param scope The scope in which to define this construct
