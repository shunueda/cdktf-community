// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/policy_priority
...
export interface DataCitrixPolicyPriorityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/policy_priority#policy_set_id DataCitrixPolicyPriority#policy_set_id}
  */
  readonly policySetId?: string;
  /**
  * Name of the policy set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/policy_priority#policy_set_name DataCitrixPolicyPriority#policy_set_name}
  */
  readonly policySetName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/policy_priority citrix_policy_priority}
*/
export class DataCitrixPolicyPriority extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixPolicyPriority that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/policy_priority#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/policy_priority citrix_policy_priority} Data Source
  *
  * @param scope The scope in which to define this construct
