// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/openshift_hypervisor
...
export interface OpenshiftHypervisorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/openshift_hypervisor#addresses OpenshiftHypervisor#addresses}
  */
  readonly addresses: string[];
  /**
  * Maximum number of actions that can execute in parallel on the hypervisor. Default is 100.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/openshift_hypervisor#max_absolute_active_actions OpenshiftHypervisor#max_absolute_active_actions}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/openshift_hypervisor#max_absolute_new_actions_per_minute OpenshiftHypervisor#max_absolute_new_actions_per_minute}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/openshift_hypervisor#max_power_actions_percentage_of_machines OpenshiftHypervisor#max_power_actions_percentage_of_machines}
  */
  readonly maxPowerActionsPercentageOfMachines?: number;
  /**
  * Metadata for the Hypervisor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/openshift_hypervisor#metadata OpenshiftHypervisor#metadata}
  */
  readonly metadata?: OpenshiftHypervisorMetadata[] | cdktf.IResolvable;
  /**
  * Name of the hypervisor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/openshift_hypervisor#name OpenshiftHypervisor#name}
  */
  readonly name: string;
  /**
  * The IDs of the scopes for the hypervisor to be a part of.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/openshift_hypervisor#scopes OpenshiftHypervisor#scopes}
  */
  readonly scopes?: string[];
  /**
  * The Application Secret of the service principal used to access the OpenShift APIs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/openshift_hypervisor#service_account_token OpenshiftHypervisor#service_account_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/openshift_hypervisor#ssl_thumbprints OpenshiftHypervisor#ssl_thumbprints}
  */
  readonly sslThumbprints: string[];
  /**
  * Id of the zone the hypervisor is associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/openshift_hypervisor#zone OpenshiftHypervisor#zone}
  */
...
export interface OpenshiftHypervisorMetadata {
  ...
  * Metadata value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/openshift_hypervisor#value OpenshiftHypervisor#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/openshift_hypervisor citrix_openshift_hypervisor}
*/
export class OpenshiftHypervisor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpenshiftHypervisor that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/openshift_hypervisor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/openshift_hypervisor citrix_openshift_hypervisor} Resource
  *
  * @param scope The scope in which to define this construct
