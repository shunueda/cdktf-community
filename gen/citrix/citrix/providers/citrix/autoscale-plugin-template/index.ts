// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/autoscale_plugin_template
...
export interface AutoscalePluginTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/autoscale_plugin_template#dates AutoscalePluginTemplate#dates}
  */
  readonly dates?: string[];
  /**
  * Name of the autoscale plugin template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/autoscale_plugin_template#name AutoscalePluginTemplate#name}
  */
  readonly name: string;
  /**
  * Type of the autoscale plugin template. Only template type `Holiday` is supported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/autoscale_plugin_template#type AutoscalePluginTemplate#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/autoscale_plugin_template citrix_autoscale_plugin_template}
*/
export class AutoscalePluginTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AutoscalePluginTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/autoscale_plugin_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/autoscale_plugin_template citrix_autoscale_plugin_template} Resource
  *
  * @param scope The scope in which to define this construct
