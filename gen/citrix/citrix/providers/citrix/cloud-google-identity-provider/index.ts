// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_google_identity_provider
...
export interface CloudGoogleIdentityProviderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_google_identity_provider#auth_domain_name CloudGoogleIdentityProvider#auth_domain_name}
  */
  readonly authDomainName: string;
  /**
  * Email of the Google client for configuring Google Cloud Identity Provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_google_identity_provider#client_email CloudGoogleIdentityProvider#client_email}
  */
  readonly clientEmail: string;
  /**
  * Impersonated user for configuring Google Cloud Identity Provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_google_identity_provider#impersonated_user CloudGoogleIdentityProvider#impersonated_user}
  */
  readonly impersonatedUser: string;
  /**
  * Name of the Citrix Cloud Google Cloud Identity Provider instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_google_identity_provider#name CloudGoogleIdentityProvider#name}
  */
  readonly name: string;
  /**
  * Private key of the Google Cloud Identity Provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_google_identity_provider#private_key CloudGoogleIdentityProvider#private_key}
  */
  readonly privateKey: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_google_identity_provider citrix_cloud_google_identity_provider}
*/
export class CloudGoogleIdentityProvider extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudGoogleIdentityProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_google_identity_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_google_identity_provider citrix_cloud_google_identity_provider} Resource
  *
  * @param scope The scope in which to define this construct
