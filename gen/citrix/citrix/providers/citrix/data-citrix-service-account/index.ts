// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/service_account
...
export interface DataCitrixServiceAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/service_account#account_id DataCitrixServiceAccount#account_id}
  */
  readonly accountId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/service_account citrix_service_account}
*/
export class DataCitrixServiceAccount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixServiceAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/service_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/service_account citrix_service_account} Data Source
  *
  * @param scope The scope in which to define this construct
