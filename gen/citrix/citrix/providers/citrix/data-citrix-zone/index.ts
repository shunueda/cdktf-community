// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/zone
...
export interface DataCitrixZoneConfig extends cdktf.TerraformMetaArguments {
  ...
  * Name of the zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/zone#name DataCitrixZone#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/zone citrix_zone}
*/
export class DataCitrixZone extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/zone citrix_zone} Data Source
  *
  * @param scope The scope in which to define this construct
