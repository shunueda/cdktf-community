// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/tag
...
export interface TagConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/tag#description Tag#description}
  */
  readonly description?: string;
  /**
  * Name of the tag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/tag#name Tag#name}
  */
  readonly name: string;
  /**
  * The set of IDs of the scopes applied on the tag. Please note that the ALL scope will be applied to the tag by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/tag#scopes Tag#scopes}
  */
  readonly scopes?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/tag citrix_tag}
*/
export class Tag extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Tag that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/tag#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/tag citrix_tag} Resource
  *
  * @param scope The scope in which to define this construct
