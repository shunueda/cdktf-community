// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_account
...
export interface QuickcreateAwsWorkspacesAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_account#aws_access_key_id QuickcreateAwsWorkspacesAccount#aws_access_key_id}
  */
  readonly awsAccessKeyId?: string;
  /**
  * Indicates if the associated AWS EDC account has BYOL support enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_account#aws_byol_feature_enabled QuickcreateAwsWorkspacesAccount#aws_byol_feature_enabled}
  */
  readonly awsByolFeatureEnabled?: boolean | cdktf.IResolvable;
  /**
  * AWS region the account is associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_account#aws_region QuickcreateAwsWorkspacesAccount#aws_region}
  */
  readonly awsRegion: string;
  /**
  * ARN of the role to assume when making requests in this account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_account#aws_role_arn QuickcreateAwsWorkspacesAccount#aws_role_arn}
  */
  readonly awsRoleArn?: string;
  /**
  * Secret associated with the Access Key for the account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_account#aws_secret_access_key QuickcreateAwsWorkspacesAccount#aws_secret_access_key}
  */
  readonly awsSecretAccessKey?: string;
  /**
  * Name of the account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_account#name QuickcreateAwsWorkspacesAccount#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_account citrix_quickcreate_aws_workspaces_account}
*/
export class QuickcreateAwsWorkspacesAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QuickcreateAwsWorkspacesAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_account citrix_quickcreate_aws_workspaces_account} Resource
  *
  * @param scope The scope in which to define this construct
