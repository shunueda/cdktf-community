// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/admin_scope
...
export interface DataCitrixAdminScopeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/admin_scope#id DataCitrixAdminScope#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/admin_scope#name DataCitrixAdminScope#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/admin_scope citrix_admin_scope}
*/
export class DataCitrixAdminScope extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixAdminScope that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/admin_scope#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/admin_scope citrix_admin_scope} Data Source
  *
  * @param scope The scope in which to define this construct
