// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_directory_connection
...
export interface QuickcreateAwsWorkspacesDirectoryConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_directory_connection#account QuickcreateAwsWorkspacesDirectoryConnection#account}
  */
  readonly account: string;
  /**
  * Default OU for VDAs in the directory connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_directory_connection#default_ou QuickcreateAwsWorkspacesDirectoryConnection#default_ou}
  */
  readonly defaultOu: string;
  /**
  * ID of the AWS directory the directory connection is associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_directory_connection#directory QuickcreateAwsWorkspacesDirectoryConnection#directory}
  */
  readonly directory: string;
  /**
  * Name of the directory connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_directory_connection#name QuickcreateAwsWorkspacesDirectoryConnection#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_directory_connection#resource_location QuickcreateAwsWorkspacesDirectoryConnection#resource_location}
  */
  readonly resourceLocation?: string;
  /**
  * ID of the security group the directory connection is associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_directory_connection#security_group QuickcreateAwsWorkspacesDirectoryConnection#security_group}
  */
  readonly securityGroup: string;
  /**
  * IDs of the subnets the directory connection is associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_directory_connection#subnets QuickcreateAwsWorkspacesDirectoryConnection#subnets}
  */
  readonly subnets: string[];
  /**
  * Tenancy of the directory connection. Possible values are `SHARED` and `DEDICATED`. Defaults to `DEDICATED`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_directory_connection#tenancy QuickcreateAwsWorkspacesDirectoryConnection#tenancy}
  */
  readonly tenancy?: string;
  /**
  * Enable users to be local administrators. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_directory_connection#user_enabled_as_local_administrator QuickcreateAwsWorkspacesDirectoryConnection#user_enabled_as_local_administrator}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_directory_connection#zone QuickcreateAwsWorkspacesDirectoryConnection#zone}
  */
  readonly zone?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_directory_connection citrix_quickcreate_aws_workspaces_directory_connection}
*/
export class QuickcreateAwsWorkspacesDirectoryConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QuickcreateAwsWorkspacesDirectoryConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_directory_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_directory_connection citrix_quickcreate_aws_workspaces_directory_connection} Resource
  *
  * @param scope The scope in which to define this construct
