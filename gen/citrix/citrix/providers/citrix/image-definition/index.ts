// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/image_definition
...
export interface ImageDefinitionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/image_definition#azure_image_definition ImageDefinition#azure_image_definition}
  */
  readonly azureImageDefinition?: ImageDefinitionAzureImageDefinition;
  /**
  * Description of the image definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/image_definition#description ImageDefinition#description}
  */
  readonly description?: string;
  /**
  * ID of the hypervisor connection to be used for image definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/image_definition#hypervisor ImageDefinition#hypervisor}
  */
  readonly hypervisor: string;
  /**
  * ID of the hypervisor resource pool to be used for image definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/image_definition#hypervisor_resource_pool ImageDefinition#hypervisor_resource_pool}
  */
  readonly hypervisorResourcePool: string;
  /**
  * Name of the image definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/image_definition#name ImageDefinition#name}
  */
  readonly name: string;
  /**
  * Operating system type of the image definition. Valid values are `Windows` and `Linux`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/image_definition#os_type ImageDefinition#os_type}
  */
  readonly osType: string;
  /**
  * Session support of the image definition. Valid values are `MultiSession` and `SingleSession`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/image_definition#session_support ImageDefinition#session_support}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/image_definition#timeout ImageDefinition#timeout}
  */
...
export interface ImageDefinitionAzureImageDefinition {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/image_definition#image_gallery_name ImageDefinition#image_gallery_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/image_definition#resource_group ImageDefinition#resource_group}
  */
  readonly resourceGroup?: string;
  /**
  * Whether image gallery is used to store the image definition. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/image_definition#use_image_gallery ImageDefinition#use_image_gallery}
  */
...
export interface ImageDefinitionTimeout {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/image_definition#create ImageDefinition#create}
  */
  readonly create?: number;
  /**
  * Timeout in minutes for the long-running jobs in delete operation. Defaults to 10. Minimum value is 5.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/image_definition#delete ImageDefinition#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/image_definition citrix_image_definition}
*/
export class ImageDefinition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ImageDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/image_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/image_definition citrix_image_definition} Resource
  *
  * @param scope The scope in which to define this construct
