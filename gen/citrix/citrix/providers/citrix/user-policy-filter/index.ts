// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/user_policy_filter
...
export interface UserPolicyFilterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/user_policy_filter#allowed UserPolicyFilter#allowed}
  */
  readonly allowed: boolean | cdktf.IResolvable;
  /**
  * Indicate whether the filter is being enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/user_policy_filter#enabled UserPolicyFilter#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Id of the policy to which the filter belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/user_policy_filter#policy_id UserPolicyFilter#policy_id}
  */
  readonly policyId: string;
  /**
  * SID of the user or user group to be filtered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/user_policy_filter#sid UserPolicyFilter#sid}
  */
  readonly sid: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/user_policy_filter citrix_user_policy_filter}
*/
export class UserPolicyFilter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserPolicyFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/user_policy_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/user_policy_filter citrix_user_policy_filter} Resource
  *
  * @param scope The scope in which to define this construct
