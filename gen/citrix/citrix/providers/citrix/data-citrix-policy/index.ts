// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/policy
...
export interface DataCitrixPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  * Id of the policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/policy#id DataCitrixPolicy#id}
  *
  ...
  * Name of the policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/policy#name DataCitrixPolicy#name}
  */
  readonly name?: string;
  /**
  * Id of the policy set the policy belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/policy#policy_set_id DataCitrixPolicy#policy_set_id}
  */
  readonly policySetId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/policy citrix_policy}
*/
export class DataCitrixPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/policy citrix_policy} Data Source
  *
  * @param scope The scope in which to define this construct
