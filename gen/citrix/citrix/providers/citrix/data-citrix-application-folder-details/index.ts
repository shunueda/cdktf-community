// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/application_folder_details
...
export interface DataCitrixApplicationFolderDetailsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/application_folder_details#path DataCitrixApplicationFolderDetails#path}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/application_folder_details citrix_application_folder_details}
*/
export class DataCitrixApplicationFolderDetails extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixApplicationFolderDetails that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/application_folder_details#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/application_folder_details citrix_application_folder_details} Data Source
  *
  * @param scope The scope in which to define this construct
