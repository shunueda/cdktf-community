// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/aws_hypervisor_resource_pool
...
export interface AwsHypervisorResourcePoolConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/aws_hypervisor_resource_pool#availability_zone AwsHypervisorResourcePool#availability_zone}
  */
  readonly availabilityZone: string;
  /**
  * Id of the hypervisor for which the resource pool needs to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/aws_hypervisor_resource_pool#hypervisor AwsHypervisorResourcePool#hypervisor}
  */
  readonly hypervisor: string;
  /**
  * Metadata for the Hypervisor Resource Pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/aws_hypervisor_resource_pool#metadata AwsHypervisorResourcePool#metadata}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/aws_hypervisor_resource_pool#name AwsHypervisorResourcePool#name}
  */
  readonly name: string;
  /**
  * Subnets to allocate VDAs within the virtual private cloud.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/aws_hypervisor_resource_pool#subnets AwsHypervisorResourcePool#subnets}
  */
  readonly subnets: string[];
  /**
  * Indicates whether VMs created by provisioning operations should be tagged. Default is `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/aws_hypervisor_resource_pool#vm_tagging AwsHypervisorResourcePool#vm_tagging}
  */
  readonly vmTagging?: boolean | cdktf.IResolvable;
  /**
  * Name of the virtual private cloud.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/aws_hypervisor_resource_pool#vpc AwsHypervisorResourcePool#vpc}
  */
  readonly vpc: string;
}
export interface AwsHypervisorResourcePoolMetadata {
  ...
  * Metadata value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/aws_hypervisor_resource_pool#value AwsHypervisorResourcePool#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/aws_hypervisor_resource_pool citrix_aws_hypervisor_resource_pool}
*/
export class AwsHypervisorResourcePool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsHypervisorResourcePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/aws_hypervisor_resource_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/aws_hypervisor_resource_pool citrix_aws_hypervisor_resource_pool} Resource
  *
  * @param scope The scope in which to define this construct
