// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gac_discovery
...
export interface GacDiscoveryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gac_discovery#allowed_web_store_urls GacDiscovery#allowed_web_store_urls}
  */
  readonly allowedWebStoreUrls?: string[];
  /**
  * Domain name of the discovery record. The domain must not contain uppercase letters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gac_discovery#domain GacDiscovery#domain}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gac_discovery#service_urls GacDiscovery#service_urls}
  */
  readonly serviceUrls: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gac_discovery citrix_gac_discovery}
*/
export class GacDiscovery extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GacDiscovery that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gac_discovery#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gac_discovery citrix_gac_discovery} Resource
  *
  * @param scope The scope in which to define this construct
