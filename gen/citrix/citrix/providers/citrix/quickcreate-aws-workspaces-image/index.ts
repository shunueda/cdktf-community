// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_image
...
export interface QuickcreateAwsWorkspacesImageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_image#account_id QuickcreateAwsWorkspacesImage#account_id}
  */
  readonly accountId: string;
  /**
  * Id of the image to be imported in AWS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_image#aws_image_id QuickcreateAwsWorkspacesImage#aws_image_id}
  */
  readonly awsImageId: string;
  /**
  * Description of the image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_image#description QuickcreateAwsWorkspacesImage#description}
  */
  readonly description: string;
  /**
  * The type of ingestion process of the image. Possible values are `BYOL_REGULAR_BYOP` and `BYOL_GRAPHICS_G4DN_BYOP`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_image#ingestion_process QuickcreateAwsWorkspacesImage#ingestion_process}
  */
  readonly ingestionProcess: string;
  /**
  * Name of the image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_image#name QuickcreateAwsWorkspacesImage#name}
  */
  readonly name: string;
  /**
  * The type of operating system of the image. Possible values are `WINDOWS` and `LINUX`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_image#operating_system QuickcreateAwsWorkspacesImage#operating_system}
  */
  readonly operatingSystem: string;
  /**
  * The supported session type of the image. Possible values are `SingleSession` and `MultiSession`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_image#session_support QuickcreateAwsWorkspacesImage#session_support}
  */
  readonly sessionSupport: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_image citrix_quickcreate_aws_workspaces_image}
*/
export class QuickcreateAwsWorkspacesImage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QuickcreateAwsWorkspacesImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickcreate_aws_workspaces_image citrix_quickcreate_aws_workspaces_image} Resource
  *
  * @param scope The scope in which to define this construct
