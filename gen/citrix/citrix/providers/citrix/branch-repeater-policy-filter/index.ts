// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/branch_repeater_policy_filter
...
export interface BranchRepeaterPolicyFilterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/branch_repeater_policy_filter#allowed BranchRepeaterPolicyFilter#allowed}
  */
  readonly allowed: boolean | cdktf.IResolvable;
  /**
  * Id of the policy to which the filter belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/branch_repeater_policy_filter#policy_id BranchRepeaterPolicyFilter#policy_id}
  */
  readonly policyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/branch_repeater_policy_filter citrix_branch_repeater_policy_filter}
*/
export class BranchRepeaterPolicyFilter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BranchRepeaterPolicyFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/branch_repeater_policy_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/branch_repeater_policy_filter citrix_branch_repeater_policy_filter} Resource
  *
  * @param scope The scope in which to define this construct
