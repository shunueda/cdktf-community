// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/site
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/site citrix_site}
*/
export class DataCitrixSite extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixSite that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/site#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/site citrix_site} Data Source
  *
  * @param scope The scope in which to define this construct
