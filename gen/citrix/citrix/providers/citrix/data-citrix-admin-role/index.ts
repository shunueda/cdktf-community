// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/admin_role
...
export interface DataCitrixAdminRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/admin_role#id DataCitrixAdminRole#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/admin_role#name DataCitrixAdminRole#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/admin_role citrix_admin_role}
*/
export class DataCitrixAdminRole extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixAdminRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/admin_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/admin_role citrix_admin_role} Data Source
  *
  * @param scope The scope in which to define this construct
