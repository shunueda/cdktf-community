// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickcreate_aws_workspaces_cloudformation_template
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickcreate_aws_workspaces_cloudformation_template citrix_quickcreate_aws_workspaces_cloudformation_template}
*/
export class DataCitrixQuickcreateAwsWorkspacesCloudformationTemplate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixQuickcreateAwsWorkspacesCloudformationTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickcreate_aws_workspaces_cloudformation_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickcreate_aws_workspaces_cloudformation_template citrix_quickcreate_aws_workspaces_cloudformation_template} Data Source
  *
  * @param scope The scope in which to define this construct
