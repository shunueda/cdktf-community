// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider
...
export interface CloudSamlIdentityProviderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#attribute_names CloudSamlIdentityProvider#attribute_names}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#auth_domain_name CloudSamlIdentityProvider#auth_domain_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#authentication_context CloudSamlIdentityProvider#authentication_context}
  */
  readonly authenticationContext: string;
  /**
  * The authentication context comparison type. Valid values are `Exact` and `Minimum`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#authentication_context_comparison CloudSamlIdentityProvider#authentication_context_comparison}
  */
  readonly authenticationContextComparison: string;
  /**
  * The file path of the certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#cert_file_path CloudSamlIdentityProvider#cert_file_path}
  */
  readonly certFilePath: string;
  /**
  * The entity ID of the SAML 2.0 Identity Provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#entity_id CloudSamlIdentityProvider#entity_id}
  */
  readonly entityId: string;
  /**
  * The binding of the logout service. Valid values are `HttpPost` and `HttpRedirect`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#logout_binding CloudSamlIdentityProvider#logout_binding}
  */
  readonly logoutBinding?: string;
  /**
  * The URL of the logout service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#logout_url CloudSamlIdentityProvider#logout_url}
  */
  readonly logoutUrl?: string;
  /**
  * Name of the SAML 2.0 Identity Provider instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#name CloudSamlIdentityProvider#name}
  */
  readonly name: string;
  /**
  * The SAML response. Valid values are `SignEitherResponseOrAssertion`, `MustSignResponse`, and `MustSignAssertion`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#saml_response CloudSamlIdentityProvider#saml_response}
  */
  readonly samlResponse: string;
  /**
  * Whether to sign the authentication request. Valid values are `Yes` and `No`. Defaults to `Yes`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#sign_auth_request CloudSamlIdentityProvider#sign_auth_request}
  */
  readonly signAuthRequest?: string;
  /**
  * Whether to sign the logout request. Valid values are `Yes` and `No`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#sign_logout_request CloudSamlIdentityProvider#sign_logout_request}
  */
  readonly signLogoutRequest?: string;
  /**
  * The binding of the single sign-on service. Valid values are `HttpPost` and `HttpRedirect`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#single_sign_on_service_binding CloudSamlIdentityProvider#single_sign_on_service_binding}
  */
  readonly singleSignOnServiceBinding: string;
  /**
  * The URL of the single sign-on service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#single_sign_on_service_url CloudSamlIdentityProvider#single_sign_on_service_url}
  */
  readonly singleSignOnServiceUrl: string;
  /**
  * Whether to use the Scoped Entity Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#use_scoped_entity_id CloudSamlIdentityProvider#use_scoped_entity_id}
  */
...
export interface CloudSamlIdentityProviderAttributeNames {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#ad_domain CloudSamlIdentityProvider#ad_domain}
  */
  readonly adDomain?: string;
  /**
  * The attribute name for the user's Active Directory forest. Defaults to `cip_forest`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#ad_forest CloudSamlIdentityProvider#ad_forest}
  */
  readonly adForest?: string;
  /**
  * The attribute name for the user's Active Directory object identifier. Defaults to `cip_oid`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#ad_object_identifier CloudSamlIdentityProvider#ad_object_identifier}
  */
  readonly adObjectIdentifier?: string;
  /**
  * The attribute name for the user's email. Defaults to `cip_email`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#email CloudSamlIdentityProvider#email}
  */
  readonly email?: string;
  /**
  * The attribute name for the user's security identifier. Defaults to `cip_sid`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#security_identifier CloudSamlIdentityProvider#security_identifier}
  */
  readonly securityIdentifier?: string;
  /**
  * The attribute name for the user's display name. Defaults to `displayName`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#user_display_name CloudSamlIdentityProvider#user_display_name}
  */
  readonly userDisplayName?: string;
  /**
  * The attribute name for the user's family name. Defaults to `familyName`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#user_family_name CloudSamlIdentityProvider#user_family_name}
  */
  readonly userFamilyName?: string;
  /**
  * The attribute name for the user's given name. Defaults to `givenName`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#user_given_name CloudSamlIdentityProvider#user_given_name}
  */
  readonly userGivenName?: string;
  /**
  * The attribute name for the user's principal name. Defaults to `cip_upn`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#user_principal_name CloudSamlIdentityProvider#user_principal_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider citrix_cloud_saml_identity_provider}
*/
export class CloudSamlIdentityProvider extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudSamlIdentityProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_saml_identity_provider citrix_cloud_saml_identity_provider} Resource
  *
  * @param scope The scope in which to define this construct
