// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/delivery_group_type_policy_filter
...
export interface DataCitrixDeliveryGroupTypePolicyFilterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/delivery_group_type_policy_filter#id DataCitrixDeliveryGroupTypePolicyFilter#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/delivery_group_type_policy_filter citrix_delivery_group_type_policy_filter}
*/
export class DataCitrixDeliveryGroupTypePolicyFilter extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixDeliveryGroupTypePolicyFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/delivery_group_type_policy_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/delivery_group_type_policy_filter citrix_delivery_group_type_policy_filter} Data Source
  *
  * @param scope The scope in which to define this construct
