// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/delivery_group_policy_filter
...
export interface DeliveryGroupPolicyFilterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/delivery_group_policy_filter#allowed DeliveryGroupPolicyFilter#allowed}
  */
  readonly allowed: boolean | cdktf.IResolvable;
  /**
  * Id of the delivery group to be filtered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/delivery_group_policy_filter#delivery_group_id DeliveryGroupPolicyFilter#delivery_group_id}
  */
  readonly deliveryGroupId: string;
  /**
  * Indicate whether the filter is being enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/delivery_group_policy_filter#enabled DeliveryGroupPolicyFilter#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Id of the policy to which the filter belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/delivery_group_policy_filter#policy_id DeliveryGroupPolicyFilter#policy_id}
  */
  readonly policyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/delivery_group_policy_filter citrix_delivery_group_policy_filter}
*/
export class DeliveryGroupPolicyFilter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DeliveryGroupPolicyFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/delivery_group_policy_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/delivery_group_policy_filter citrix_delivery_group_policy_filter} Resource
  *
  * @param scope The scope in which to define this construct
