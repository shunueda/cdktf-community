// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gcp_hypervisor_resource_pool
...
export interface GcpHypervisorResourcePoolConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gcp_hypervisor_resource_pool#hypervisor GcpHypervisorResourcePool#hypervisor}
  */
  readonly hypervisor: string;
  /**
  * Metadata for the Hypervisor Resource Pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gcp_hypervisor_resource_pool#metadata GcpHypervisorResourcePool#metadata}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gcp_hypervisor_resource_pool#name GcpHypervisorResourcePool#name}
  */
  readonly name: string;
  /**
  * GCP Project name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gcp_hypervisor_resource_pool#project_name GcpHypervisorResourcePool#project_name}
  */
  readonly projectName: string;
  /**
  * Cloud Region where the virtual network sits in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gcp_hypervisor_resource_pool#region GcpHypervisorResourcePool#region}
  */
  readonly region: string;
  /**
  * Indicate whether the GCP Virtual Private Cloud is a shared VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gcp_hypervisor_resource_pool#shared_vpc GcpHypervisorResourcePool#shared_vpc}
  */
  readonly sharedVpc?: boolean | cdktf.IResolvable;
  /**
  * Subnets to allocate VDAs within the virtual network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gcp_hypervisor_resource_pool#subnets GcpHypervisorResourcePool#subnets}
  */
  readonly subnets: string[];
  /**
  * Indicates whether VMs created by provisioning operations should be tagged. Default is `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gcp_hypervisor_resource_pool#vm_tagging GcpHypervisorResourcePool#vm_tagging}
  */
  readonly vmTagging?: boolean | cdktf.IResolvable;
  /**
  * Name of the cloud virtual network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gcp_hypervisor_resource_pool#vpc GcpHypervisorResourcePool#vpc}
  */
  readonly vpc: string;
}
export interface GcpHypervisorResourcePoolMetadata {
  ...
  * Metadata value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gcp_hypervisor_resource_pool#value GcpHypervisorResourcePool#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gcp_hypervisor_resource_pool citrix_gcp_hypervisor_resource_pool}
*/
export class GcpHypervisorResourcePool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GcpHypervisorResourcePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gcp_hypervisor_resource_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/gcp_hypervisor_resource_pool citrix_gcp_hypervisor_resource_pool} Resource
  *
  * @param scope The scope in which to define this construct
