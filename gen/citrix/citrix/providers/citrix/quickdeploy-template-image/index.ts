// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickdeploy_template_image
...
export interface QuickdeployTemplateImageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickdeploy_template_image#guest_disk_uri QuickdeployTemplateImage#guest_disk_uri}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickdeploy_template_image#machine_generation QuickdeployTemplateImage#machine_generation}
  */
  readonly machineGeneration: string;
  /**
  * Name of the image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickdeploy_template_image#name QuickdeployTemplateImage#name}
  */
  readonly name: string;
  /**
  * Notes of the image. Note length cannot exceed 1024 characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickdeploy_template_image#notes QuickdeployTemplateImage#notes}
  */
  readonly notes?: string;
  /**
  * The OS platform of the image. Choose between `Windows` and `Linux`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickdeploy_template_image#os_platform QuickdeployTemplateImage#os_platform}
  */
  readonly osPlatform: string;
  /**
  * The Azure region to import the image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickdeploy_template_image#region QuickdeployTemplateImage#region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickdeploy_template_image#secure_boot_enabled QuickdeployTemplateImage#secure_boot_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickdeploy_template_image#subscription_name QuickdeployTemplateImage#subscription_name}
  */
  readonly subscriptionName?: string;
  /**
  * The Azure-generated URL for the Image's Virtual Hard Disk.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickdeploy_template_image#vhd_uri QuickdeployTemplateImage#vhd_uri}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickdeploy_template_image#vtpm_enabled QuickdeployTemplateImage#vtpm_enabled}
  */
  readonly vtpmEnabled?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickdeploy_template_image citrix_quickdeploy_template_image}
*/
export class QuickdeployTemplateImage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QuickdeployTemplateImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickdeploy_template_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/quickdeploy_template_image citrix_quickdeploy_template_image} Resource
  *
  * @param scope The scope in which to define this construct
