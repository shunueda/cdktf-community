// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/site_settings
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/site_settings citrix_site_settings}
*/
export class DataCitrixSiteSettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixSiteSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/site_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/site_settings citrix_site_settings} Data Source
  *
  * @param scope The scope in which to define this construct
