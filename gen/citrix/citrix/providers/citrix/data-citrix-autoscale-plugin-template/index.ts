// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/autoscale_plugin_template
...
export interface DataCitrixAutoscalePluginTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/autoscale_plugin_template#name DataCitrixAutoscalePluginTemplate#name}
  */
  readonly name: string;
  /**
  * Type of the autoscale plugin template. Only template type `Holiday` is supported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/autoscale_plugin_template#type DataCitrixAutoscalePluginTemplate#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/autoscale_plugin_template citrix_autoscale_plugin_template}
*/
export class DataCitrixAutoscalePluginTemplate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixAutoscalePluginTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/autoscale_plugin_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/autoscale_plugin_template citrix_autoscale_plugin_template} Data Source
  *
  * @param scope The scope in which to define this construct
