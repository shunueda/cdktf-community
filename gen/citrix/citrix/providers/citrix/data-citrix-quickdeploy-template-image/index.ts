// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickdeploy_template_image
...
export interface DataCitrixQuickdeployTemplateImageConfig extends cdktf.TerraformMetaArguments {
  ...
  * Name of the image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickdeploy_template_image#name DataCitrixQuickdeployTemplateImage#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickdeploy_template_image citrix_quickdeploy_template_image}
*/
export class DataCitrixQuickdeployTemplateImage extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixQuickdeployTemplateImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickdeploy_template_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickdeploy_template_image citrix_quickdeploy_template_image} Data Source
  *
  * @param scope The scope in which to define this construct
