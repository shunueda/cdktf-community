// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_role
...
export interface AdminRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_role#can_launch_manage AdminRole#can_launch_manage}
  */
  ...
  * ~> **Please Note** This field is only applicable for cloud admins. For on-premise admins, the only acceptable value is `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_role#can_launch_monitor AdminRole#can_launch_monitor}
  */
  readonly canLaunchMonitor?: boolean | cdktf.IResolvable;
  /**
  * Description of the admin role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_role#description AdminRole#description}
  */
  readonly description?: string;
  /**
  * Name of the admin role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_role#name AdminRole#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_role#permissions AdminRole#permissions}
  */
  readonly permissions: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_role citrix_admin_role}
*/
export class AdminRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AdminRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_role citrix_admin_role} Resource
  *
  * @param scope The scope in which to define this construct
