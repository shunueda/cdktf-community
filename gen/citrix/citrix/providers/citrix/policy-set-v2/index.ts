// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_set_v2
...
export interface PolicySetV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_set_v2#delivery_groups PolicySetV2#delivery_groups}
  */
  readonly deliveryGroups?: string[];
  /**
  * Description of the policy set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_set_v2#description PolicySetV2#description}
  */
  readonly description?: string;
  /**
  * Name of the policy set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_set_v2#name PolicySetV2#name}
  */
  readonly name: string;
  /**
  * The IDs of the scopes for the policy set to be a part of.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_set_v2#scopes PolicySetV2#scopes}
  */
  readonly scopes?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_set_v2 citrix_policy_set_v2}
*/
export class PolicySetV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicySetV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_set_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_set_v2 citrix_policy_set_v2} Resource
  *
  * @param scope The scope in which to define this construct
