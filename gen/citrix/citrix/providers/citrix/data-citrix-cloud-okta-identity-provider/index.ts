// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/cloud_okta_identity_provider
...
export interface DataCitrixCloudOktaIdentityProviderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/cloud_okta_identity_provider#id DataCitrixCloudOktaIdentityProvider#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/cloud_okta_identity_provider#name DataCitrixCloudOktaIdentityProvider#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/cloud_okta_identity_provider citrix_cloud_okta_identity_provider}
*/
export class DataCitrixCloudOktaIdentityProvider extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixCloudOktaIdentityProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/cloud_okta_identity_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/cloud_okta_identity_provider citrix_cloud_okta_identity_provider} Data Source
  *
  * @param scope The scope in which to define this construct
