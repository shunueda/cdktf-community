// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/vda
...
export interface DataCitrixVdaConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/vda#delivery_group DataCitrixVda#delivery_group}
  */
  readonly deliveryGroup?: string;
  /**
  * The machine catalog which the VDAs are associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/vda#machine_catalog DataCitrixVda#machine_catalog}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/vda citrix_vda}
*/
export class DataCitrixVda extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixVda that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/vda#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/vda citrix_vda} Data Source
  *
  * @param scope The scope in which to define this construct
