// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/image_definition
...
export interface DataCitrixImageDefinitionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/image_definition#id DataCitrixImageDefinition#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/image_definition#name DataCitrixImageDefinition#name}
  */
  readonly name?: string;
  /**
  * Timeout in minutes for the long-running jobs in image definition resource's create, delete operation(s).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/image_definition#timeout DataCitrixImageDefinition#timeout}
  */
...
export interface DataCitrixImageDefinitionTimeout {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/image_definition#create DataCitrixImageDefinition#create}
  */
  readonly create?: number;
  /**
  * Timeout in minutes for the long-running jobs in delete operation. Defaults to 10. Minimum value is 5.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/image_definition#delete DataCitrixImageDefinition#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/image_definition citrix_image_definition}
*/
export class DataCitrixImageDefinition extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixImageDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/image_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/image_definition citrix_image_definition} Data Source
  *
  * @param scope The scope in which to define this construct
