// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/application_group
...
export interface ApplicationGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/application_group#application_group_folder_path ApplicationGroup#application_group_folder_path}
  */
  readonly applicationGroupFolderPath?: string;
  /**
  * Delivery groups to associate with the application group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/application_group#delivery_groups ApplicationGroup#delivery_groups}
  */
  readonly deliveryGroups: string[];
  /**
  * Description of the application group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/application_group#description ApplicationGroup#description}
  */
  readonly description?: string;
  /**
  * Whether the application group is enabled or not. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/application_group#enabled ApplicationGroup#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/application_group#included_users ApplicationGroup#included_users}
  */
  readonly includedUsers?: string[];
  /**
  * Metadata for the Application Group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/application_group#metadata ApplicationGroup#metadata}
  */
  readonly metadata?: ApplicationGroupMetadata[] | cdktf.IResolvable;
  /**
  * Name of the application group to create.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/application_group#name ApplicationGroup#name}
  */
  readonly name: string;
  /**
  * The tag to restrict the application group to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/application_group#restrict_to_tag ApplicationGroup#restrict_to_tag}
  */
  readonly restrictToTag?: string;
  /**
  * The IDs of the scopes for the application group to be a part of.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/application_group#scopes ApplicationGroup#scopes}
  */
  readonly scopes?: string[];
  /**
  * A set of identifiers of tags to associate with the application group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/application_group#tags ApplicationGroup#tags}
  */
...
export interface ApplicationGroupMetadata {
  ...
  * Metadata value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/application_group#value ApplicationGroup#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/application_group citrix_application_group}
*/
export class ApplicationGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/application_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/application_group citrix_application_group} Resource
  *
  * @param scope The scope in which to define this construct
