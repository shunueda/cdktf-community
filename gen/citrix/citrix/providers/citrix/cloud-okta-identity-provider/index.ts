// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_okta_identity_provider
...
export interface CloudOktaIdentityProviderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_okta_identity_provider#name CloudOktaIdentityProvider#name}
  */
  readonly name: string;
  /**
  * Okta API token for configuring Okta Identity Provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_okta_identity_provider#okta_api_token CloudOktaIdentityProvider#okta_api_token}
  */
  readonly oktaApiToken: string;
  /**
  * ID of the Okta client for configuring Okta Identity Provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_okta_identity_provider#okta_client_id CloudOktaIdentityProvider#okta_client_id}
  */
  readonly oktaClientId: string;
  /**
  * Secret of the Okta client for configuring Okta Identity Provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_okta_identity_provider#okta_client_secret CloudOktaIdentityProvider#okta_client_secret}
  */
  readonly oktaClientSecret: string;
  /**
  * Okta domain name for configuring Okta Identity Provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_okta_identity_provider#okta_domain CloudOktaIdentityProvider#okta_domain}
  */
  readonly oktaDomain: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_okta_identity_provider citrix_cloud_okta_identity_provider}
*/
export class CloudOktaIdentityProvider extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudOktaIdentityProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_okta_identity_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/cloud_okta_identity_provider citrix_cloud_okta_identity_provider} Resource
  *
  * @param scope The scope in which to define this construct
