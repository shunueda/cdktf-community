// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_folder
...
export interface AdminFolderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_folder#name AdminFolder#name}
  */
  readonly name: string;
  /**
  * Path of the parent admin folder. Please note that the parent path should not end with a `\`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_folder#parent_path AdminFolder#parent_path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_folder#type AdminFolder#type}
  */
  readonly type: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_folder citrix_admin_folder}
*/
export class AdminFolder extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AdminFolder that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_folder#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_folder citrix_admin_folder} Resource
  *
  * @param scope The scope in which to define this construct
