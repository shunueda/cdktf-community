// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/client_platform_policy_filter
...
export interface ClientPlatformPolicyFilterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/client_platform_policy_filter#allowed ClientPlatformPolicyFilter#allowed}
  */
  readonly allowed: boolean | cdktf.IResolvable;
  /**
  * Indicate whether the filter is being enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/client_platform_policy_filter#enabled ClientPlatformPolicyFilter#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Name of the client platform to be filtered. Available values are `Windows`, `Linux`, `Mac`, `Ios`, `Android`, and `Html5`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/client_platform_policy_filter#platform ClientPlatformPolicyFilter#platform}
  */
  readonly platform: string;
  /**
  * Id of the policy to which the filter belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/client_platform_policy_filter#policy_id ClientPlatformPolicyFilter#policy_id}
  */
  readonly policyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/client_platform_policy_filter citrix_client_platform_policy_filter}
*/
export class ClientPlatformPolicyFilter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClientPlatformPolicyFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/client_platform_policy_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/client_platform_policy_filter citrix_client_platform_policy_filter} Resource
  *
  * @param scope The scope in which to define this construct
