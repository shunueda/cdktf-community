// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_scope
...
export interface AdminScopeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_scope#description AdminScope#description}
  */
  readonly description?: string;
  /**
  * Indicates whether the admin scope is a tenant scope. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_scope#is_tenant_scope AdminScope#is_tenant_scope}
  */
  readonly isTenantScope?: boolean | cdktf.IResolvable;
  /**
  * Name of the admin scope.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_scope#name AdminScope#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_scope citrix_admin_scope}
*/
export class AdminScope extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AdminScope that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_scope#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_scope citrix_admin_scope} Resource
  *
  * @param scope The scope in which to define this construct
