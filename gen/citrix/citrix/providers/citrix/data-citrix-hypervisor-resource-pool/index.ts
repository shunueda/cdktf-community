// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/hypervisor_resource_pool
...
export interface DataCitrixHypervisorResourcePoolConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/hypervisor_resource_pool#hypervisor_name DataCitrixHypervisorResourcePool#hypervisor_name}
  */
  readonly hypervisorName: string;
  /**
  * GUID identifier of the hypervisor resource pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/hypervisor_resource_pool#id DataCitrixHypervisorResourcePool#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/hypervisor_resource_pool#name DataCitrixHypervisorResourcePool#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/hypervisor_resource_pool citrix_hypervisor_resource_pool}
*/
export class DataCitrixHypervisorResourcePool extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixHypervisorResourcePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/hypervisor_resource_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/hypervisor_resource_pool citrix_hypervisor_resource_pool} Data Source
  *
  * @param scope The scope in which to define this construct
