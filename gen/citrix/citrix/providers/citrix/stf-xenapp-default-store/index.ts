// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/stf_xenapp_default_store
...
export interface StfXenappDefaultStoreConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/stf_xenapp_default_store#store_site_id StfXenappDefaultStore#store_site_id}
  */
  readonly storeSiteId: string;
  /**
  * The Virtual Path of the StoreFront Default Store for XenApp Service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/stf_xenapp_default_store#store_virtual_path StfXenappDefaultStore#store_virtual_path}
  */
  readonly storeVirtualPath: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/stf_xenapp_default_store citrix_stf_xenapp_default_store}
*/
export class StfXenappDefaultStore extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StfXenappDefaultStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/stf_xenapp_default_store#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/stf_xenapp_default_store citrix_stf_xenapp_default_store} Resource
  *
  * @param scope The scope in which to define this construct
