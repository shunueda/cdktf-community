// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickcreate_aws_workspaces_directory_connection
...
export interface DataCitrixQuickcreateAwsWorkspacesDirectoryConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickcreate_aws_workspaces_directory_connection#account DataCitrixQuickcreateAwsWorkspacesDirectoryConnection#account}
  */
  readonly account: string;
  /**
  * GUID identifier of the directory connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickcreate_aws_workspaces_directory_connection#id DataCitrixQuickcreateAwsWorkspacesDirectoryConnection#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickcreate_aws_workspaces_directory_connection#name DataCitrixQuickcreateAwsWorkspacesDirectoryConnection#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickcreate_aws_workspaces_directory_connection citrix_quickcreate_aws_workspaces_directory_connection}
*/
export class DataCitrixQuickcreateAwsWorkspacesDirectoryConnection extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixQuickcreateAwsWorkspacesDirectoryConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickcreate_aws_workspaces_directory_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickcreate_aws_workspaces_directory_connection citrix_quickcreate_aws_workspaces_directory_connection} Data Source
  *
  * @param scope The scope in which to define this construct
