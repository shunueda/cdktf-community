// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/service_account
...
export interface ServiceAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/service_account#account_id ServiceAccount#account_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/service_account#account_secret ServiceAccount#account_secret}
  */
  readonly accountSecret: string;
  /**
  * The format of the account secret. Possible values are `PlainText` and `Base64`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/service_account#account_secret_format ServiceAccount#account_secret_format}
  */
  readonly accountSecretFormat: string;
  /**
  * A description for the service account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/service_account#description ServiceAccount#description}
  */
  readonly description?: string;
  /**
  * A friendly name for the service account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/service_account#display_name ServiceAccount#display_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/service_account#enable_intune_enrolled_device_management ServiceAccount#enable_intune_enrolled_device_management}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/service_account#identity_provider_identifier ServiceAccount#identity_provider_identifier}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/service_account#identity_provider_type ServiceAccount#identity_provider_type}
  */
  readonly identityProviderType: string;
  /**
  * The IDs of the scopes for the service account to be a part of.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/service_account#scopes ServiceAccount#scopes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/service_account#secret_expiry_time ServiceAccount#secret_expiry_time}
  */
  readonly secretExpiryTime?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/service_account citrix_service_account}
*/
export class ServiceAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/service_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/service_account citrix_service_account} Resource
  *
  * @param scope The scope in which to define this construct
