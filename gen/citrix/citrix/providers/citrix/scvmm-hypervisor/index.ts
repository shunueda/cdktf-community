// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/scvmm_hypervisor
...
export interface ScvmmHypervisorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/scvmm_hypervisor#addresses ScvmmHypervisor#addresses}
  */
  readonly addresses: string[];
  /**
  * Maximum number of actions that can execute in parallel on the hypervisor. Default is 50.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/scvmm_hypervisor#max_absolute_active_actions ScvmmHypervisor#max_absolute_active_actions}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/scvmm_hypervisor#max_absolute_new_actions_per_minute ScvmmHypervisor#max_absolute_new_actions_per_minute}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/scvmm_hypervisor#max_power_actions_percentage_of_machines ScvmmHypervisor#max_power_actions_percentage_of_machines}
  */
  readonly maxPowerActionsPercentageOfMachines?: number;
  /**
  * Metadata for the Hypervisor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/scvmm_hypervisor#metadata ScvmmHypervisor#metadata}
  */
  readonly metadata?: ScvmmHypervisorMetadata[] | cdktf.IResolvable;
  /**
  * Name of the hypervisor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/scvmm_hypervisor#name ScvmmHypervisor#name}
  */
  readonly name: string;
  /**
  * Password of the hypervisor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/scvmm_hypervisor#password ScvmmHypervisor#password}
  */
  readonly password: string;
  /**
  * Password format of the hypervisor. Choose between Base64 and PlainText.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/scvmm_hypervisor#password_format ScvmmHypervisor#password_format}
  */
  readonly passwordFormat: string;
  /**
  * The IDs of the scopes for the hypervisor to be a part of.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/scvmm_hypervisor#scopes ScvmmHypervisor#scopes}
  */
  readonly scopes?: string[];
  /**
  * Username of the hypervisor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/scvmm_hypervisor#username ScvmmHypervisor#username}
  */
  readonly username: string;
  /**
  * Id of the zone the hypervisor is associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/scvmm_hypervisor#zone ScvmmHypervisor#zone}
  */
...
export interface ScvmmHypervisorMetadata {
  ...
  * Metadata value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/scvmm_hypervisor#value ScvmmHypervisor#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/scvmm_hypervisor citrix_scvmm_hypervisor}
*/
export class ScvmmHypervisor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ScvmmHypervisor that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/scvmm_hypervisor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/scvmm_hypervisor citrix_scvmm_hypervisor} Resource
  *
  * @param scope The scope in which to define this construct
