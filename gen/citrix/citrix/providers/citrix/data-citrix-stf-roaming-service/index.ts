// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/stf_roaming_service
...
export interface DataCitrixStfRoamingServiceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/stf_roaming_service#site_id DataCitrixStfRoamingService#site_id}
  */
  readonly siteId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/stf_roaming_service citrix_stf_roaming_service}
*/
export class DataCitrixStfRoamingService extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixStfRoamingService that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/stf_roaming_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/stf_roaming_service citrix_stf_roaming_service} Data Source
  *
  * @param scope The scope in which to define this construct
