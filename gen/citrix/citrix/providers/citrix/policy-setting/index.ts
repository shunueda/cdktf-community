// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_setting
...
export interface PolicySettingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_setting#enabled PolicySetting#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Name of the policy setting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_setting#name PolicySetting#name}
  */
  readonly name: string;
  /**
  * Id of the policy to which the setting belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_setting#policy_id PolicySetting#policy_id}
  */
  readonly policyId: string;
  /**
  * Indicate whether using default value for the policy setting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_setting#use_default PolicySetting#use_default}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_setting#value PolicySetting#value}
  */
  readonly value?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_setting citrix_policy_setting}
*/
export class PolicySetting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicySetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_setting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy_setting citrix_policy_setting} Resource
  *
  * @param scope The scope in which to define this construct
