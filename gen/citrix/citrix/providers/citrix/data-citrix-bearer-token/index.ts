// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/bearer_token
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/bearer_token citrix_bearer_token}
*/
export class DataCitrixBearerToken extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixBearerToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/bearer_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/bearer_token citrix_bearer_token} Data Source
  *
  * @param scope The scope in which to define this construct
