// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickcreate_aws_workspaces_image
...
export interface DataCitrixQuickcreateAwsWorkspacesImageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickcreate_aws_workspaces_image#account_id DataCitrixQuickcreateAwsWorkspacesImage#account_id}
  */
  readonly accountId: string;
  /**
  * GUID identifier of the image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickcreate_aws_workspaces_image#id DataCitrixQuickcreateAwsWorkspacesImage#id}
  *
  ...
  * Name of the image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickcreate_aws_workspaces_image#name DataCitrixQuickcreateAwsWorkspacesImage#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickcreate_aws_workspaces_image citrix_quickcreate_aws_workspaces_image}
*/
export class DataCitrixQuickcreateAwsWorkspacesImage extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixQuickcreateAwsWorkspacesImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickcreate_aws_workspaces_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/quickcreate_aws_workspaces_image citrix_quickcreate_aws_workspaces_image} Data Source
  *
  * @param scope The scope in which to define this construct
