// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/azure_hypervisor_resource_pool
...
export interface AzureHypervisorResourcePoolConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/azure_hypervisor_resource_pool#hypervisor AzureHypervisorResourcePool#hypervisor}
  */
  readonly hypervisor: string;
  /**
  * Metadata for the Hypervisor Resource Pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/azure_hypervisor_resource_pool#metadata AzureHypervisorResourcePool#metadata}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/azure_hypervisor_resource_pool#name AzureHypervisorResourcePool#name}
  */
  readonly name: string;
  /**
  * Cloud Region where the virtual network sits in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/azure_hypervisor_resource_pool#region AzureHypervisorResourcePool#region}
  */
  readonly region: string;
  /**
  * Subnets to allocate VDAs within the virtual network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/azure_hypervisor_resource_pool#subnets AzureHypervisorResourcePool#subnets}
  */
  readonly subnets: string[];
  /**
  * Timeout in minutes for the long-running jobs in resource pool resource's delete operation(s).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/azure_hypervisor_resource_pool#timeout AzureHypervisorResourcePool#timeout}
  */
  readonly timeout?: AzureHypervisorResourcePoolTimeout;
  /**
  * Name of the cloud virtual network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/azure_hypervisor_resource_pool#virtual_network AzureHypervisorResourcePool#virtual_network}
  */
  readonly virtualNetwork: string;
  /**
  * The name of the resource group where the vnet resides.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/azure_hypervisor_resource_pool#virtual_network_resource_group AzureHypervisorResourcePool#virtual_network_resource_group}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/azure_hypervisor_resource_pool#vm_tagging AzureHypervisorResourcePool#vm_tagging}
  */
...
export interface AzureHypervisorResourcePoolMetadata {
  ...
  * Metadata value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/azure_hypervisor_resource_pool#value AzureHypervisorResourcePool#value}
  */
...
export interface AzureHypervisorResourcePoolTimeout {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/azure_hypervisor_resource_pool#delete AzureHypervisorResourcePool#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/azure_hypervisor_resource_pool citrix_azure_hypervisor_resource_pool}
*/
export class AzureHypervisorResourcePool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureHypervisorResourcePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/azure_hypervisor_resource_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/azure_hypervisor_resource_pool citrix_azure_hypervisor_resource_pool} Resource
  *
  * @param scope The scope in which to define this construct
