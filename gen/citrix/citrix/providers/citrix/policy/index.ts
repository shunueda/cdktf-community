// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy
...
export interface PolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy#description Policy#description}
  */
  readonly description?: string;
  /**
  * Indicate whether the policy is being enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy#enabled Policy#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Name of the policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy#name Policy#name}
  */
  readonly name: string;
  /**
  * Id of the policy set the policy belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy#policy_set_id Policy#policy_set_id}
  */
  readonly policySetId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy citrix_policy}
*/
export class Policy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Policy that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/policy citrix_policy} Resource
  *
  * @param scope The scope in which to define this construct
