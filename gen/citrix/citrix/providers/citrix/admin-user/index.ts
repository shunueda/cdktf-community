// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_user
...
export interface AdminUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_user#domain_name AdminUser#domain_name}
  */
  readonly domainName: string;
  /**
  * Flag to determine if the administrator is to be enabled or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_user#is_enabled AdminUser#is_enabled}
  */
  readonly isEnabled?: boolean | cdktf.IResolvable;
  /**
  * Name of an existing user in the active directory.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_user#name AdminUser#name}
  */
  readonly name: string;
  /**
  * Rights to be associated with the admin user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_user#rights AdminUser#rights}
  */
...
export interface AdminUserRights {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_user#role AdminUser#role}
  */
  readonly role: string;
  /**
  * Name of the scope to be associated with the admin user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_user#scope AdminUser#scope}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_user citrix_admin_user}
*/
export class AdminUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AdminUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/admin_user citrix_admin_user} Resource
  *
  * @param scope The scope in which to define this construct
