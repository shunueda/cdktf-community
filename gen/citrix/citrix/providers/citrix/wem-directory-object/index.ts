// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/wem_directory_object
...
export interface WemDirectoryObjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/wem_directory_object#configuration_set_id WemDirectoryObject#configuration_set_id}
  */
  readonly configurationSetId: number;
  /**
  * Indicates whether the machine-level AD object is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/wem_directory_object#enabled WemDirectoryObject#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * GUID identifier of the machine catalog.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/wem_directory_object#machine_catalog_id WemDirectoryObject#machine_catalog_id}
  */
  readonly machineCatalogId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/wem_directory_object citrix_wem_directory_object}
*/
export class WemDirectoryObject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WemDirectoryObject that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/wem_directory_object#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/wem_directory_object citrix_wem_directory_object} Resource
  *
  * @param scope The scope in which to define this construct
