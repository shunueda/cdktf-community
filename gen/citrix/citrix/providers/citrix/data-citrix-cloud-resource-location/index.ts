// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/cloud_resource_location
...
export interface DataCitrixCloudResourceLocationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/cloud_resource_location#name DataCitrixCloudResourceLocation#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/cloud_resource_location citrix_cloud_resource_location}
*/
export class DataCitrixCloudResourceLocation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixCloudResourceLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/cloud_resource_location#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/cloud_resource_location citrix_cloud_resource_location} Data Source
  *
  * @param scope The scope in which to define this construct
