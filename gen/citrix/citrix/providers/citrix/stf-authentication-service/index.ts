// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/stf_authentication_service
...
export interface StfAuthenticationServiceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/stf_authentication_service#citrix_ag_basic_options StfAuthenticationService#citrix_ag_basic_options}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/stf_authentication_service#claims_factory_name StfAuthenticationService#claims_factory_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/stf_authentication_service#friendly_name StfAuthenticationService#friendly_name}
  */
  readonly friendlyName?: string;
  /**
  * The IIS site to configure the authentication service for. Defaults to `1`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/stf_authentication_service#site_id StfAuthenticationService#site_id}
  */
  readonly siteId?: string;
  /**
  * The IIS virtual path to use for the authentication service. Defaults to `/Citrix/Authentication`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/stf_authentication_service#virtual_path StfAuthenticationService#virtual_path}
  */
...
export interface StfAuthenticationServiceCitrixAgBasicOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/stf_authentication_service#credential_validation_mode StfAuthenticationService#credential_validation_mode}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/stf_authentication_service citrix_stf_authentication_service}
*/
export class StfAuthenticationService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StfAuthenticationService that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/stf_authentication_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/resources/stf_authentication_service citrix_stf_authentication_service} Resource
  *
  * @param scope The scope in which to define this construct
