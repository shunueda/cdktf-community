// https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/admin_folder
...
export interface DataCitrixAdminFolderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/admin_folder#id DataCitrixAdminFolder#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/admin_folder#path DataCitrixAdminFolder#path}
  */
  readonly path?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/admin_folder citrix_admin_folder}
*/
export class DataCitrixAdminFolder extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixAdminFolder that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/admin_folder#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.29/docs/data-sources/admin_folder citrix_admin_folder} Data Source
  *
  * @param scope The scope in which to define this construct
