// https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/resources/rule_group_recording
...
export interface RuleGroupRecordingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/resources/rule_group_recording#id RuleGroupRecording#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/resources/rule_group_recording#interval RuleGroupRecording#interval}
  */
  readonly interval?: string;
  /**
  * Recording Rule group name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/resources/rule_group_recording#name RuleGroupRecording#name}
  */
  readonly name: string;
  /**
  * Recording Rule group namespace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/resources/rule_group_recording#namespace RuleGroupRecording#namespace}
  */
  readonly namespace?: string;
  /**
  * The Organization ID. If not set, the Org ID defined in the provider block will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/resources/rule_group_recording#org_id RuleGroupRecording#org_id}
  */
  readonly orgId?: string;
  /**
  * rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/resources/rule_group_recording#rule RuleGroupRecording#rule}
  */
...
export interface RuleGroupRecordingRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/resources/rule_group_recording#expr RuleGroupRecording#expr}
  */
  readonly expr: string;
  /**
  * Labels to add or overwrite before storing the result.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/resources/rule_group_recording#labels RuleGroupRecording#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The name of the time series to output to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/resources/rule_group_recording#record RuleGroupRecording#record}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/resources/rule_group_recording loki_rule_group_recording}
*/
export class RuleGroupRecording extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RuleGroupRecording that should be imported. Refer to the {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/resources/rule_group_recording#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/resources/rule_group_recording loki_rule_group_recording} Resource
  *
  * @param scope The scope in which to define this construct
