// https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/data-sources/rule_group_list
...
export interface DataLokiRuleGroupListConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/data-sources/rule_group_list#id DataLokiRuleGroupList#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/data-sources/rule_group_list#name DataLokiRuleGroupList#name}
  */
  readonly name?: string;
  /**
  * The Organization ID. If not set, the Org ID defined in the provider block will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/data-sources/rule_group_list#org_id DataLokiRuleGroupList#org_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/data-sources/rule_group_list loki_rule_group_list}
*/
export class DataLokiRuleGroupList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLokiRuleGroupList that should be imported. Refer to the {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/data-sources/rule_group_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs/data-sources/rule_group_list loki_rule_group_list} Data Source
  *
  * @param scope The scope in which to define this construct
