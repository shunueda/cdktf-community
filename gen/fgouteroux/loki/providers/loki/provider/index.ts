// https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs
...
export interface LokiProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs#ca LokiProvider#ca}
  */
  readonly ca?: string;
  /**
  * Client cert for client authentication
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs#cert LokiProvider#cert}
  */
  readonly cert?: string;
  /**
  * Enable debug mode to trace requests executed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs#debug LokiProvider#debug}
  */
  readonly debug?: boolean | cdktf.IResolvable;
  /**
  * A map of header names and values to set on all outbound requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs#headers LokiProvider#headers}
  */
  readonly headers?: { [key: string]: string };
  /**
  * When using https, this disables TLS verification of the host.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs#insecure LokiProvider#insecure}
  */
  readonly insecure?: boolean | cdktf.IResolvable;
  /**
  * Client key for client authentication
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs#key LokiProvider#key}
  */
  readonly key?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs#org_id LokiProvider#org_id}
  */
  readonly orgId: string;
  /**
  * When set, will use this password for BASIC auth to the API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs#password LokiProvider#password}
  */
  readonly password?: string;
  /**
  * URL to the proxy to be used for all API requests
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs#proxy_url LokiProvider#proxy_url}
  */
  readonly proxyUrl?: string;
  /**
  * When set, will cause requests taking longer than this time (in seconds) to be aborted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs#timeout LokiProvider#timeout}
  */
  readonly timeout?: number;
  /**
  * When set, will use this token for Bearer auth to the API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs#token LokiProvider#token}
  */
  readonly token?: string;
  /**
  * loki base url
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs#uri LokiProvider#uri}
  */
  readonly uri: string;
  /**
  * When set, will use this username for BASIC auth to the API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs#username LokiProvider#username}
  */
  readonly username?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs#alias LokiProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs loki}
*/
export class LokiProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing LokiProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.0/docs loki} Resource
  *
  * @param scope The scope in which to define this construct
