// https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/installed_collector
...
export interface InstalledCollectorConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/installed_collector#category InstalledCollector#category}
  */
  readonly category?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/installed_collector#cutoff_timestamp InstalledCollector#cutoff_timestamp}
  */
  readonly cutoffTimestamp?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/installed_collector#description InstalledCollector#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/installed_collector#ephemeral InstalledCollector#ephemeral}
  */
  readonly ephemeral: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/installed_collector#fields InstalledCollector#fields}
  */
  readonly fields?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/installed_collector#host_name InstalledCollector#host_name}
  */
  readonly hostName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/installed_collector#id InstalledCollector#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/installed_collector#name InstalledCollector#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/installed_collector#source_sync_mode InstalledCollector#source_sync_mode}
  */
  readonly sourceSyncMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/installed_collector#target_cpu InstalledCollector#target_cpu}
  */
  readonly targetCpu?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/installed_collector#timezone InstalledCollector#timezone}
  */
  readonly timezone?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/installed_collector sumologic_installed_collector}
*/
export class InstalledCollector extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the InstalledCollector to import
  * @param importFromId The id of the existing InstalledCollector that should be imported. Refer to the {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/installed_collector#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the InstalledCollector to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sumologic_installed_collector", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/installed_collector sumologic_installed_collector} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      source_sync_mode: {
        value: cdktf.stringToHclTerraform(this._sourceSyncMode),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      target_cpu: {
        value: cdktf.numberToHclTerraform(this._targetCpu),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
