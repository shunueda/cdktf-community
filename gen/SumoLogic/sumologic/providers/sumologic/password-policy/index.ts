// https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/password_policy
...
export interface PasswordPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/password_policy#account_lockout_duration_in_mins PasswordPolicy#account_lockout_duration_in_mins}
  */
  readonly accountLockoutDurationInMins?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/password_policy#account_lockout_threshold PasswordPolicy#account_lockout_threshold}
  */
  readonly accountLockoutThreshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/password_policy#failed_login_reset_duration_in_mins PasswordPolicy#failed_login_reset_duration_in_mins}
  */
  readonly failedLoginResetDurationInMins?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/password_policy#id PasswordPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/password_policy#max_length PasswordPolicy#max_length}
  */
  readonly maxLength?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/password_policy#max_password_age_in_days PasswordPolicy#max_password_age_in_days}
  */
  readonly maxPasswordAgeInDays?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/password_policy#min_length PasswordPolicy#min_length}
  */
  readonly minLength?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/password_policy#min_unique_passwords PasswordPolicy#min_unique_passwords}
  */
  readonly minUniquePasswords?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/password_policy#must_contain_digits PasswordPolicy#must_contain_digits}
  */
  readonly mustContainDigits?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/password_policy#must_contain_lowercase PasswordPolicy#must_contain_lowercase}
  */
  readonly mustContainLowercase?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/password_policy#must_contain_special_chars PasswordPolicy#must_contain_special_chars}
  */
  readonly mustContainSpecialChars?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/password_policy#must_contain_uppercase PasswordPolicy#must_contain_uppercase}
  */
  readonly mustContainUppercase?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/password_policy#remember_mfa PasswordPolicy#remember_mfa}
  */
  readonly rememberMfa?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/password_policy#require_mfa PasswordPolicy#require_mfa}
  */
  readonly requireMfa?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/password_policy sumologic_password_policy}
*/
export class PasswordPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PasswordPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/password_policy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the PasswordPolicy to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sumologic_password_policy", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.6/docs/resources/password_policy sumologic_password_policy} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      account_lockout_duration_in_mins: {
        value: cdktf.numberToHclTerraform(this._accountLockoutDurationInMins),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      account_lockout_threshold: {
        value: cdktf.numberToHclTerraform(this._accountLockoutThreshold),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      failed_login_reset_duration_in_mins: {
        value: cdktf.numberToHclTerraform(this._failedLoginResetDurationInMins),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      ...
      max_password_age_in_days: {
        value: cdktf.numberToHclTerraform(this._maxPasswordAgeInDays),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      ...
      min_unique_passwords: {
        value: cdktf.numberToHclTerraform(this._minUniquePasswords),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      must_contain_digits: {
        value: cdktf.booleanToHclTerraform(this._mustContainDigits),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      must_contain_lowercase: {
        value: cdktf.booleanToHclTerraform(this._mustContainLowercase),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      must_contain_special_chars: {
        value: cdktf.booleanToHclTerraform(this._mustContainSpecialChars),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      must_contain_uppercase: {
        value: cdktf.booleanToHclTerraform(this._mustContainUppercase),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      remember_mfa: {
        value: cdktf.booleanToHclTerraform(this._rememberMfa),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      require_mfa: {
        value: cdktf.booleanToHclTerraform(this._requireMfa),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
