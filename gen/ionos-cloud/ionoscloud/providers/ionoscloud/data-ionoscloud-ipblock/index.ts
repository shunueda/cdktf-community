// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.17/docs/data-sources/ipblock
...
export function dataIonoscloudIpblockTimeoutsToHclTerraform(struct?: DataIonoscloudIpblockTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataIonoscloudIpblock extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIonoscloudIpblock that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.17/docs/data-sources/ipblock#import import section} in the documentation of this resource for the id to use
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        ...
        isBlock: true,
        type: "struct",
        storageClassType: "DataIonoscloudIpblockTimeouts",
      },
    };
