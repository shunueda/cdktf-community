// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.17/docs/data-sources/lan
...
export function dataIonoscloudLanIpFailoverToTerraform(struct?: DataIonoscloudLanIpFailover): any {
...
export function dataIonoscloudLanIpFailoverToHclTerraform(struct?: DataIonoscloudLanIpFailover): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataIonoscloudLanIpFailoverOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataIonoscloudLanIpFailover | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataIonoscloudLanIpFailover | undefined) {
    if (value === undefined) {
...
export class DataIonoscloudLanIpFailoverList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataIonoscloudLanIpFailoverOutputReference {
    return new DataIonoscloudLanIpFailoverOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function dataIonoscloudLanTimeoutsToTerraform(struct?: DataIonoscloudLanTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataIonoscloudLanTimeoutsToHclTerraform(struct?: DataIonoscloudLanTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataIonoscloudLanTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataIonoscloudLanTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataIonoscloudLanTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataIonoscloudLan extends cdktf.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataIonoscloudLan to import
  * @param importFromId The id of the existing DataIonoscloudLan that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.17/docs/data-sources/lan#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: DataIonoscloudLanConfig) {
    super(scope, id, {
  ...
  // ip_failover - computed: true, optional: false, required: false
  ...
  // pcc - computed: true, optional: false, required: false
  public get pcc() {
  ...
  private _timeouts = new DataIonoscloudLanTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataIonoscloudLanTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataIonoscloudLanTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: dataIonoscloudLanTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DataIonoscloudLanTimeouts",
      },
    };
