// https://registry.terraform.io/providers/chronosphereio/chronosphere/1.16.0/docs/resources/classic_dashboard
...
export interface ClassicDashboardConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.16.0/docs/resources/classic_dashboard#bucket_id ClassicDashboard#bucket_id}
  */
  readonly bucketId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.16.0/docs/resources/classic_dashboard#collection_id ClassicDashboard#collection_id}
  */
  readonly collectionId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.16.0/docs/resources/classic_dashboard#dashboard_json ClassicDashboard#dashboard_json}
  */
  readonly dashboardJson: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.16.0/docs/resources/classic_dashboard#id ClassicDashboard#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.16.0/docs/resources/classic_dashboard chronosphere_classic_dashboard}
*/
export class ClassicDashboard extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClassicDashboard that should be imported. Refer to the {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.16.0/docs/resources/classic_dashboard#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.16.0/docs/resources/classic_dashboard chronosphere_classic_dashboard} Resource
  *
  * @param scope The scope in which to define this construct
