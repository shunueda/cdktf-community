// https://registry.terraform.io/providers/chronosphereio/chronosphere/1.16.0/docs
...
export interface ChronosphereProviderConfig {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.16.0/docs#api_token ChronosphereProvider#api_token}
  */
  readonly apiToken?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.16.0/docs#disable_dryrun ChronosphereProvider#disable_dryrun}
  */
  readonly disableDryrun?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.16.0/docs#entity_namespace ChronosphereProvider#entity_namespace}
  */
  readonly entityNamespace?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.16.0/docs#org ChronosphereProvider#org}
  */
  readonly org: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.16.0/docs#unstable ChronosphereProvider#unstable}
  */
  readonly unstable?: boolean | cdktf.IResolvable;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.16.0/docs#alias ChronosphereProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.16.0/docs chronosphere}
*/
export class ChronosphereProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing ChronosphereProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.16.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.16.0/docs chronosphere} Resource
  *
  * @param scope The scope in which to define this construct
