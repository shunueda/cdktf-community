// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_cloudwatch_metric_alarm
...
export interface AwsCloudwatchMetricAlarmConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_cloudwatch_metric_alarm#comparison_operator AwsCloudwatchMetricAlarm#comparison_operator}
  */
  readonly comparisonOperator: string;
  /**
  * The number of periods over which data is compared to the specified threshold.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_cloudwatch_metric_alarm#evaluation_periods AwsCloudwatchMetricAlarm#evaluation_periods}
  */
  readonly evaluationPeriods: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_cloudwatch_metric_alarm#id AwsCloudwatchMetricAlarm#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_cloudwatch_metric_alarm#metric_name AwsCloudwatchMetricAlarm#metric_name}
  */
  readonly metricName: string;
  /**
  * The namespace for the alarm's associated metric.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_cloudwatch_metric_alarm#namespace AwsCloudwatchMetricAlarm#namespace}
  */
  readonly namespace?: string;
  /**
  * The period in seconds over which the specified `statistic` is applied.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_cloudwatch_metric_alarm#period AwsCloudwatchMetricAlarm#period}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_cloudwatch_metric_alarm#statistic AwsCloudwatchMetricAlarm#statistic}
  */
  readonly statistic?: string;
  /**
  * The GUID of the tenant that the cloudwatch metric alarm will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_cloudwatch_metric_alarm#tenant_id AwsCloudwatchMetricAlarm#tenant_id}
  */
  readonly tenantId: string;
  /**
  * The value against which the specified statistic is compared. This parameter is required for alarms based on static thresholds, but should not be used for alarms based on anomaly detection models.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_cloudwatch_metric_alarm#threshold AwsCloudwatchMetricAlarm#threshold}
  */
  readonly threshold?: number;
  /**
  * dimension block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_cloudwatch_metric_alarm#dimension AwsCloudwatchMetricAlarm#dimension}
  */
  readonly dimension?: AwsCloudwatchMetricAlarmDimension[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_cloudwatch_metric_alarm#timeouts AwsCloudwatchMetricAlarm#timeouts}
  */
  readonly timeouts?: AwsCloudwatchMetricAlarmTimeouts;
}
export interface AwsCloudwatchMetricAlarmDimension {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_cloudwatch_metric_alarm#key AwsCloudwatchMetricAlarm#key}
  */
  readonly key: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_cloudwatch_metric_alarm#value AwsCloudwatchMetricAlarm#value}
  */
...
export interface AwsCloudwatchMetricAlarmTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_cloudwatch_metric_alarm#create AwsCloudwatchMetricAlarm#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_cloudwatch_metric_alarm#delete AwsCloudwatchMetricAlarm#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_cloudwatch_metric_alarm duplocloud_aws_cloudwatch_metric_alarm}
*/
export class AwsCloudwatchMetricAlarm extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsCloudwatchMetricAlarm that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_cloudwatch_metric_alarm#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_cloudwatch_metric_alarm duplocloud_aws_cloudwatch_metric_alarm} Resource
  *
  * @param scope The scope in which to define this construct
