// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/gcp_sql_database_instance
...
export interface DataDuplocloudGcpSqlDatabaseInstanceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/gcp_sql_database_instance#id DataDuplocloudGcpSqlDatabaseInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/gcp_sql_database_instance#name DataDuplocloudGcpSqlDatabaseInstance#name}
  */
  readonly name: string;
  /**
  * The GUID of the tenant that the sql database will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/gcp_sql_database_instance#tenant_id DataDuplocloudGcpSqlDatabaseInstance#tenant_id}
  */
  readonly tenantId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/gcp_sql_database_instance duplocloud_gcp_sql_database_instance}
*/
export class DataDuplocloudGcpSqlDatabaseInstance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDuplocloudGcpSqlDatabaseInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/gcp_sql_database_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/gcp_sql_database_instance duplocloud_gcp_sql_database_instance} Data Source
  *
  * @param scope The scope in which to define this construct
