// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/plan_waf_v2
...
export interface DataDuplocloudPlanWafV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/plan_waf_v2#id DataDuplocloudPlanWafV2#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/plan_waf_v2#name DataDuplocloudPlanWafV2#name}
  */
  readonly name: string;
  /**
  * The plan ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/plan_waf_v2#plan_id DataDuplocloudPlanWafV2#plan_id}
  */
  readonly planId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/plan_waf_v2 duplocloud_plan_waf_v2}
*/
export class DataDuplocloudPlanWafV2 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDuplocloudPlanWafV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/plan_waf_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/plan_waf_v2 duplocloud_plan_waf_v2} Data Source
  *
  * @param scope The scope in which to define this construct
