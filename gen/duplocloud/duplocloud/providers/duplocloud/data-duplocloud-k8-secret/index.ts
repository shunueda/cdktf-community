// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/k8_secret
...
export interface DataDuplocloudK8SecretConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/k8_secret#id DataDuplocloudK8Secret#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/k8_secret#secret_name DataDuplocloudK8Secret#secret_name}
  */
  readonly secretName: string;
  /**
  * The GUID of the tenant that the secret will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/k8_secret#tenant_id DataDuplocloudK8Secret#tenant_id}
  */
  readonly tenantId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/k8_secret duplocloud_k8_secret}
*/
export class DataDuplocloudK8Secret extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDuplocloudK8Secret that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/k8_secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/k8_secret duplocloud_k8_secret} Data Source
  *
  * @param scope The scope in which to define this construct
