// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance
...
export interface EcacheInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#auth_token EcacheInstance#auth_token}
  */
  readonly authToken?: string;
  /**
  * Enables automatic failover. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#automatic_failover_enabled EcacheInstance#automatic_failover_enabled}
  */
  ...
  *  Defaults to `0`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#cache_type EcacheInstance#cache_type}
  */
  readonly cacheType?: number;
  /**
  * Flag to enable/disable redis/valkey cluster mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#enable_cluster_mode EcacheInstance#enable_cluster_mode}
  */
  readonly enableClusterMode?: boolean | cdktf.IResolvable;
  /**
  * Enables encryption-at-rest. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#encryption_at_rest EcacheInstance#encryption_at_rest}
  */
  readonly encryptionAtRest?: boolean | cdktf.IResolvable;
  /**
  * Enables encryption-in-transit. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#encryption_in_transit EcacheInstance#encryption_in_transit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#engine_version EcacheInstance#engine_version}
  */
  readonly engineVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#id EcacheInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#kms_key_id EcacheInstance#kms_key_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#name EcacheInstance#name}
  */
  readonly name: string;
  /**
  * The number of shards to create. Applicable only if enable_cluster_mode is set to true
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#number_of_shards EcacheInstance#number_of_shards}
  */
  readonly numberOfShards?: number;
  /**
  * The REDIS/Valkey parameter group to supply.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#parameter_group_name EcacheInstance#parameter_group_name}
  */
  readonly parameterGroupName?: string;
  /**
  * The number of replicas to create. Supported number of replicas is 1 to 6 Defaults to `1`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#replicas EcacheInstance#replicas}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#size EcacheInstance#size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#snapshot_arns EcacheInstance#snapshot_arns}
  */
  readonly snapshotArns?: string[];
  /**
  * Select the snapshot/backup you want to use for creating redis/valkey.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#snapshot_name EcacheInstance#snapshot_name}
  */
  readonly snapshotName?: string;
  /**
  * Specify retention limit in days. Accepted values - 1-35.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#snapshot_retention_limit EcacheInstance#snapshot_retention_limit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#snapshot_window EcacheInstance#snapshot_window}
  */
  readonly snapshotWindow?: string;
  /**
  * The GUID of the tenant that the elasticache instance will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#tenant_id EcacheInstance#tenant_id}
  */
  readonly tenantId: string;
  /**
  * log_delivery_configuration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#log_delivery_configuration EcacheInstance#log_delivery_configuration}
  */
  readonly logDeliveryConfiguration?: EcacheInstanceLogDeliveryConfiguration[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#timeouts EcacheInstance#timeouts}
  */
...
export interface EcacheInstanceLogDeliveryConfiguration {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#destination_type EcacheInstance#destination_type}
  */
  readonly destinationType: string;
  /**
  * log_format: Value must be one of the ['json', 'text']
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#log_format EcacheInstance#log_format}
  */
  readonly logFormat: string;
  /**
  * cloudwatch log_group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#log_group EcacheInstance#log_group}
  */
  readonly logGroup?: string;
  /**
  * log_type: Value must be one of the ['slow-log', 'engine-log']
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#log_type EcacheInstance#log_type}
  */
...
export interface EcacheInstanceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#create EcacheInstance#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#delete EcacheInstance#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#update EcacheInstance#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance duplocloud_ecache_instance}
*/
export class EcacheInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EcacheInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_instance duplocloud_ecache_instance} Resource
  *
  * @param scope The scope in which to define this construct
