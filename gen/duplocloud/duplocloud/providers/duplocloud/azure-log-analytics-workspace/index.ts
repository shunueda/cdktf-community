// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/azure_log_analytics_workspace
...
export interface AzureLogAnalyticsWorkspaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/azure_log_analytics_workspace#id AzureLogAnalyticsWorkspace#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/azure_log_analytics_workspace#infra_name AzureLogAnalyticsWorkspace#infra_name}
  */
  readonly infraName: string;
  /**
  * Specifies the name of the Log Analytics Workspace. Workspace name should include 4-63 letters, digits or '-'. The '-' shouldn't be the first or the last symbol. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/azure_log_analytics_workspace#name AzureLogAnalyticsWorkspace#name}
  */
  readonly name: string;
  /**
  * The name of the resource group in which the Log Analytics workspace is created. Changing this forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/azure_log_analytics_workspace#resource_group_name AzureLogAnalyticsWorkspace#resource_group_name}
  */
  readonly resourceGroupName?: string;
  /**
  * Whether or not to wait until Log Analytics Workspace to be ready, after creation. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/azure_log_analytics_workspace#wait_until_ready AzureLogAnalyticsWorkspace#wait_until_ready}
  */
  readonly waitUntilReady?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/azure_log_analytics_workspace#timeouts AzureLogAnalyticsWorkspace#timeouts}
  */
  readonly timeouts?: AzureLogAnalyticsWorkspaceTimeouts;
}
export interface AzureLogAnalyticsWorkspaceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/azure_log_analytics_workspace#create AzureLogAnalyticsWorkspace#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/azure_log_analytics_workspace#delete AzureLogAnalyticsWorkspace#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/azure_log_analytics_workspace duplocloud_azure_log_analytics_workspace}
*/
export class AzureLogAnalyticsWorkspace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureLogAnalyticsWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/azure_log_analytics_workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/azure_log_analytics_workspace duplocloud_azure_log_analytics_workspace} Resource
  *
  * @param scope The scope in which to define this construct
