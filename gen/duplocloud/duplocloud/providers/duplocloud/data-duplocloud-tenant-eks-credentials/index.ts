// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/tenant_eks_credentials
...
export interface DataDuplocloudTenantEksCredentialsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/tenant_eks_credentials#id DataDuplocloudTenantEksCredentials#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/tenant_eks_credentials#tenant_id DataDuplocloudTenantEksCredentials#tenant_id}
  */
  readonly tenantId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/tenant_eks_credentials duplocloud_tenant_eks_credentials}
*/
export class DataDuplocloudTenantEksCredentials extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDuplocloudTenantEksCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/tenant_eks_credentials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/data-sources/tenant_eks_credentials duplocloud_tenant_eks_credentials} Data Source
  *
  * @param scope The scope in which to define this construct
