// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function
...
export interface AwsLambdaFunctionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#architectures AwsLambdaFunction#architectures}
  */
  readonly architectures?: string[];
  /**
  * A description of the lambda function.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#description AwsLambdaFunction#description}
  */
  readonly description?: string;
  /**
  * The Ephemeral Storage size, in MB, that your lambda function is allowed to use at runtime. Defaults to `512`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#ephemeral_storage AwsLambdaFunction#ephemeral_storage}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#handler AwsLambdaFunction#handler}
  */
  readonly handler?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#id AwsLambdaFunction#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#image_uri AwsLambdaFunction#image_uri}
  */
  readonly imageUri?: string;
  /**
  * List of Lambda Layer Version ARNs (maximum of 5) to attach to your Lambda Function.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#layers AwsLambdaFunction#layers}
  */
  readonly layers?: string[];
  /**
  * The maximum amount of memory, in MB, that your lambda function is allowed to use at runtime. Defaults to `128`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#memory_size AwsLambdaFunction#memory_size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#name AwsLambdaFunction#name}
  */
  readonly name: string;
  /**
  * The type of lambda package.  Must be `Zip` or `Image`.  Defaults to `Zip`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#package_type AwsLambdaFunction#package_type}
  */
  readonly packageType?: string;
  /**
  * The [runtime](https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html) that the lambda function needs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#runtime AwsLambdaFunction#runtime}
  */
  readonly runtime?: string;
  /**
  * The S3 bucket where the lambda function package is located. Used (and required) only when `package_type` is `"Zip"`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#s3_bucket AwsLambdaFunction#s3_bucket}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#s3_key AwsLambdaFunction#s3_key}
  */
  readonly s3Key?: string;
  /**
  * Map of tags to assign to the object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#tags AwsLambdaFunction#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * The GUID of the tenant that the lambda function will be created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#tenant_id AwsLambdaFunction#tenant_id}
  */
  readonly tenantId: string;
  /**
  * The execution time limit for the lambda function. Defaults to `3`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#timeout AwsLambdaFunction#timeout}
  */
  readonly timeout?: number;
  /**
  * dead_letter_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#dead_letter_config AwsLambdaFunction#dead_letter_config}
  */
  readonly deadLetterConfig?: AwsLambdaFunctionDeadLetterConfig[] | cdktf.IResolvable;
  /**
  * environment block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#environment AwsLambdaFunction#environment}
  */
  readonly environment?: AwsLambdaFunctionEnvironment;
  /**
  * image_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#image_config AwsLambdaFunction#image_config}
  */
  readonly imageConfig?: AwsLambdaFunctionImageConfig;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#timeouts AwsLambdaFunction#timeouts}
  */
  readonly timeouts?: AwsLambdaFunctionTimeouts;
  /**
  * tracing_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#tracing_config AwsLambdaFunction#tracing_config}
  */
...
export interface AwsLambdaFunctionDeadLetterConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#target_arn AwsLambdaFunction#target_arn}
  */
...
export interface AwsLambdaFunctionEnvironment {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#variables AwsLambdaFunction#variables}
  */
...
export interface AwsLambdaFunctionImageConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#command AwsLambdaFunction#command}
  */
  readonly command?: string[];
  /**
  * The entry point that is passed to the container.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#entry_point AwsLambdaFunction#entry_point}
  */
  readonly entryPoint?: string[];
  /**
  * The working directory that is passed to the container.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#working_directory AwsLambdaFunction#working_directory}
  */
...
export interface AwsLambdaFunctionTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#create AwsLambdaFunction#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#delete AwsLambdaFunction#delete}
  */
...
export interface AwsLambdaFunctionTracingConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#mode AwsLambdaFunction#mode}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function duplocloud_aws_lambda_function}
*/
export class AwsLambdaFunction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsLambdaFunction that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/aws_lambda_function duplocloud_aws_lambda_function} Resource
  *
  * @param scope The scope in which to define this construct
