// https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_associate_global_secondary_cluster
...
export interface EcacheAssociateGlobalSecondaryClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_associate_global_secondary_cluster#auth_token EcacheAssociateGlobalSecondaryCluster#auth_token}
  */
  readonly authToken?: string;
  /**
  * The description for secondary cluster
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_associate_global_secondary_cluster#description EcacheAssociateGlobalSecondaryCluster#description}
  */
  readonly description?: string;
  /**
  * Specify the global datastore name with which the secondary regional cluster should be associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_associate_global_secondary_cluster#global_datastore_id EcacheAssociateGlobalSecondaryCluster#global_datastore_id}
  */
  readonly globalDatastoreId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_associate_global_secondary_cluster#id EcacheAssociateGlobalSecondaryCluster#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_associate_global_secondary_cluster#secondary_cluster_name EcacheAssociateGlobalSecondaryCluster#secondary_cluster_name}
  */
  readonly secondaryClusterName: string;
  /**
  * Specify kms key for secondary cluster
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_associate_global_secondary_cluster#secondary_kms_key EcacheAssociateGlobalSecondaryCluster#secondary_kms_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_associate_global_secondary_cluster#secondary_tenant_id EcacheAssociateGlobalSecondaryCluster#secondary_tenant_id}
  */
  readonly secondaryTenantId: string;
  /**
  * The GUID of the tenant that the elasticache instance datastore has been created in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_associate_global_secondary_cluster#tenant_id EcacheAssociateGlobalSecondaryCluster#tenant_id}
  */
  readonly tenantId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_associate_global_secondary_cluster#timeouts EcacheAssociateGlobalSecondaryCluster#timeouts}
  */
...
export interface EcacheAssociateGlobalSecondaryClusterTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_associate_global_secondary_cluster#create EcacheAssociateGlobalSecondaryCluster#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_associate_global_secondary_cluster#delete EcacheAssociateGlobalSecondaryCluster#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_associate_global_secondary_cluster duplocloud_ecache_associate_global_secondary_cluster}
*/
export class EcacheAssociateGlobalSecondaryCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EcacheAssociateGlobalSecondaryCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_associate_global_secondary_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/duplocloud/duplocloud/0.11.27/docs/resources/ecache_associate_global_secondary_cluster duplocloud_ecache_associate_global_secondary_cluster} Resource
  *
  * @param scope The scope in which to define this construct
