// https://registry.terraform.io/providers/chainguard-dev/helm/0.0.7/docs
...
export interface HelmProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/helm/0.0.7/docs#default_arch HelmProvider#default_arch}
  */
  readonly defaultArch?: string;
  /**
  * A list of paths to package repository public keys for signature verification.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/helm/0.0.7/docs#extra_keyrings HelmProvider#extra_keyrings}
  */
  readonly extraKeyrings?: string[];
  /**
  * A list of URLs for package repositories to use for fetching APK packages.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/helm/0.0.7/docs#extra_repositories HelmProvider#extra_repositories}
  */
  readonly extraRepositories?: string[];
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/helm/0.0.7/docs#alias HelmProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/helm/0.0.7/docs helm}
*/
export class HelmProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing HelmProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/helm/0.0.7/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/helm/0.0.7/docs helm} Resource
  *
  * @param scope The scope in which to define this construct
