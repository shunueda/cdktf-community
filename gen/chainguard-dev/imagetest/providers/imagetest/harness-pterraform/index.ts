// https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.98/docs/resources/harness_pterraform
...
export interface HarnessPterraformConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.98/docs/resources/harness_pterraform#inventory HarnessPterraform#inventory}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.98/docs/resources/harness_pterraform#name HarnessPterraform#name}
  */
  readonly name: string;
  /**
  * The path to the terraform source directory.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.98/docs/resources/harness_pterraform#path HarnessPterraform#path}
  */
  readonly path: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.98/docs/resources/harness_pterraform#timeouts HarnessPterraform#timeouts}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.98/docs/resources/harness_pterraform#vars HarnessPterraform#vars}
  */
  readonly vars?: string;
}
export interface HarnessPterraformInventory {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.98/docs/resources/harness_pterraform#seed HarnessPterraform#seed}
  */
...
export interface HarnessPterraformTimeouts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.98/docs/resources/harness_pterraform#create HarnessPterraform#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.98/docs/resources/harness_pterraform imagetest_harness_pterraform}
*/
export class HarnessPterraform extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HarnessPterraform that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.98/docs/resources/harness_pterraform#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.98/docs/resources/harness_pterraform imagetest_harness_pterraform} Resource
  *
  * @param scope The scope in which to define this construct
