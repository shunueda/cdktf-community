// https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_anti_virus
...
export interface ProfileAntiVirusConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_anti_virus#action ProfileAntiVirus#action}
  */
  readonly action: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_anti_virus#auto_update ProfileAntiVirus#auto_update}
  */
  readonly autoUpdate?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_anti_virus#delay_by_days ProfileAntiVirus#delay_by_days}
  */
  readonly delayByDays?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_anti_virus#description ProfileAntiVirus#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_anti_virus#id ProfileAntiVirus#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_anti_virus#name ProfileAntiVirus#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_anti_virus#talos_ruleset_version ProfileAntiVirus#talos_ruleset_version}
  */
  readonly talosRulesetVersion?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_anti_virus valtix_profile_anti_virus}
*/
export class ProfileAntiVirus extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProfileAntiVirus that should be imported. Refer to the {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_anti_virus#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_anti_virus valtix_profile_anti_virus} Resource
  *
  * @param scope The scope in which to define this construct
