// https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_l7dos
...
export interface ProfileL7DosConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_l7dos#description ProfileL7Dos#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_l7dos#id ProfileL7Dos#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_l7dos#name ProfileL7Dos#name}
  */
  readonly name: string;
  /**
  * request_limits block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_l7dos#request_limits ProfileL7Dos#request_limits}
  */
  readonly requestLimits?: ProfileL7DosRequestLimits[] | cdktf.IResolvable;
}
export interface ProfileL7DosRequestLimits {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_l7dos#burst_size ProfileL7Dos#burst_size}
  */
  readonly burstSize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_l7dos#rate_limited_methods ProfileL7Dos#rate_limited_methods}
  */
  readonly rateLimitedMethods: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_l7dos#requests_rate_block ProfileL7Dos#requests_rate_block}
  */
  readonly requestsRateBlock: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_l7dos#target_uri ProfileL7Dos#target_uri}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_l7dos valtix_profile_l7dos}
*/
export class ProfileL7Dos extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProfileL7Dos that should be imported. Refer to the {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_l7dos#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_l7dos valtix_profile_l7dos} Resource
  *
  * @param scope The scope in which to define this construct
