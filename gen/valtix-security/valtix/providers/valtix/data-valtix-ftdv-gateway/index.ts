// https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/data-sources/ftdv_gateway
...
export interface DataValtixFtdvGatewayConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/data-sources/ftdv_gateway#id DataValtixFtdvGateway#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/data-sources/ftdv_gateway#name DataValtixFtdvGateway#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/data-sources/ftdv_gateway valtix_ftdv_gateway}
*/
export class DataValtixFtdvGateway extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataValtixFtdvGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/data-sources/ftdv_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/data-sources/ftdv_gateway valtix_ftdv_gateway} Data Source
  *
  * @param scope The scope in which to define this construct
