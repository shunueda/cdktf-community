// https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object
...
export interface ServiceObjectConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object#app_id ServiceObject#app_id}
  */
  readonly appId?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object#backend_address_group ServiceObject#backend_address_group}
  */
  readonly backendAddressGroup?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object#client_tls_profile ServiceObject#client_tls_profile}
  */
  readonly clientTlsProfile?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object#description ServiceObject#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object#http2_enable ServiceObject#http2_enable}
  */
  readonly http2Enable?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object#id ServiceObject#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object#l7dos_profile ServiceObject#l7dos_profile}
  */
  readonly l7DosProfile?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object#name ServiceObject#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object#protocol ServiceObject#protocol}
  */
  readonly protocol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object#service_type ServiceObject#service_type}
  */
  readonly serviceType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object#sni ServiceObject#sni}
  */
  readonly sni?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object#source_nat ServiceObject#source_nat}
  */
  readonly sourceNat?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object#tls_profile ServiceObject#tls_profile}
  */
  readonly tlsProfile?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object#transport_mode ServiceObject#transport_mode}
  */
  readonly transportMode?: string;
  /**
  * port block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object#port ServiceObject#port}
  */
  readonly port?: ServiceObjectPort[] | cdktf.IResolvable;
}
export interface ServiceObjectPort {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object#backend_ports ServiceObject#backend_ports}
  */
  readonly backendPorts?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object#destination_ports ServiceObject#destination_ports}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object valtix_service_object}
*/
export class ServiceObject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceObject that should be imported. Refer to the {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/service_object valtix_service_object} Resource
  *
  * @param scope The scope in which to define this construct
