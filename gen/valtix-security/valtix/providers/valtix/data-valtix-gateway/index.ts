// https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/data-sources/gateway
...
export interface DataValtixGatewayConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/data-sources/gateway#id DataValtixGateway#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/data-sources/gateway#name DataValtixGateway#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/data-sources/gateway valtix_gateway}
*/
export class DataValtixGateway extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataValtixGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/data-sources/gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/data-sources/gateway valtix_gateway} Data Source
  *
  * @param scope The scope in which to define this construct
