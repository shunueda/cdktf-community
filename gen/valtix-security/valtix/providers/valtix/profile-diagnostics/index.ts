// https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_diagnostics
...
export interface ProfileDiagnosticsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_diagnostics#aws_s3_bucket ProfileDiagnostics#aws_s3_bucket}
  */
  readonly awsS3Bucket?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_diagnostics#azure_blob_container_name ProfileDiagnostics#azure_blob_container_name}
  */
  readonly azureBlobContainerName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_diagnostics#azure_storage_access_key ProfileDiagnostics#azure_storage_access_key}
  */
  readonly azureStorageAccessKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_diagnostics#azure_storage_accnt_name ProfileDiagnostics#azure_storage_accnt_name}
  */
  readonly azureStorageAccntName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_diagnostics#csp_type ProfileDiagnostics#csp_type}
  */
  readonly cspType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_diagnostics#description ProfileDiagnostics#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_diagnostics#id ProfileDiagnostics#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_diagnostics#name ProfileDiagnostics#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_diagnostics valtix_profile_diagnostics}
*/
export class ProfileDiagnostics extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProfileDiagnostics that should be imported. Refer to the {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_diagnostics#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.1/docs/resources/profile_diagnostics valtix_profile_diagnostics} Resource
  *
  * @param scope The scope in which to define this construct
