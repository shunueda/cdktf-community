// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/agent_profiles
...
export interface DataApstraAgentProfilesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/agent_profiles#has_credentials DataApstraAgentProfiles#has_credentials}
  */
  readonly hasCredentials?: boolean | cdktf.IResolvable;
  /**
  * Filter to select only Agent Profiles for the specified platform.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/agent_profiles#platform DataApstraAgentProfiles#platform}
  */
  readonly platform?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/agent_profiles apstra_agent_profiles}
*/
export class DataApstraAgentProfiles extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataApstraAgentProfiles that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/agent_profiles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/agent_profiles apstra_agent_profiles} Data Source
  *
  * @param scope The scope in which to define this construct
