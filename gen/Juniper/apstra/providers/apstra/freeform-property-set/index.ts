// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_property_set
...
export interface FreeformPropertySetConfig extends cdktf.TerraformMetaArguments {
  ...
  * Apstra Blueprint ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_property_set#blueprint_id FreeformPropertySet#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Property Set name as shown in the Web UI.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_property_set#name FreeformPropertySet#name}
  */
  readonly name: string;
  /**
  * The system ID where the Property Set is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_property_set#system_id FreeformPropertySet#system_id}
  */
  readonly systemId?: string;
  /**
  * A map of values in the Property Set in JSON format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_property_set#values FreeformPropertySet#values}
  */
  readonly values: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_property_set apstra_freeform_property_set}
*/
export class FreeformPropertySet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FreeformPropertySet that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_property_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_property_set apstra_freeform_property_set} Resource
  *
  * @param scope The scope in which to define this construct
