// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_virtual_network_multiple
...
export interface DataApstraDatacenterCtVirtualNetworkMultipleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_virtual_network_multiple#name DataApstraDatacenterCtVirtualNetworkMultiple#name}
  */
  readonly name?: string;
  /**
  * Set of Virtual Network IDs which should be presented with VLAN tags
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_virtual_network_multiple#tagged_vn_ids DataApstraDatacenterCtVirtualNetworkMultiple#tagged_vn_ids}
  */
  readonly taggedVnIds?: string[];
  /**
  * Virtual Network ID which should be presented without VLAN tags
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_virtual_network_multiple#untagged_vn_id DataApstraDatacenterCtVirtualNetworkMultiple#untagged_vn_id}
  */
  readonly untaggedVnId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_virtual_network_multiple apstra_datacenter_ct_virtual_network_multiple}
*/
export class DataApstraDatacenterCtVirtualNetworkMultiple extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_virtual_network_multiple apstra_datacenter_ct_virtual_network_multiple} Data Source
  *
  * @param scope The scope in which to define this construct
