// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/blueprint_device_rendered_config
...
export interface DataApstraBlueprintDeviceRenderedConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  * Apstra Blueprint ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/blueprint_device_rendered_config#blueprint_id DataApstraBlueprintDeviceRenderedConfig#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Apstra ID of the System (spine, leaf, etc...) node. Required when `system_id` is omitted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/blueprint_device_rendered_config#node_id DataApstraBlueprintDeviceRenderedConfig#node_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/blueprint_device_rendered_config#system_id DataApstraBlueprintDeviceRenderedConfig#system_id}
  */
  readonly systemId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/blueprint_device_rendered_config apstra_blueprint_device_rendered_config}
*/
export class DataApstraBlueprintDeviceRenderedConfig extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/blueprint_device_rendered_config apstra_blueprint_device_rendered_config} Data Source
  *
  * @param scope The scope in which to define this construct
