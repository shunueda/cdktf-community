// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_routing_zone_loopback_addresses
...
export interface DatacenterRoutingZoneLoopbackAddressesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Apstra Blueprint ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_routing_zone_loopback_addresses#blueprint_id DatacenterRoutingZoneLoopbackAddresses#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Map of Loopback IPv4 and IPv6 addresses, keyed by System (switch) Node ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_routing_zone_loopback_addresses#loopbacks DatacenterRoutingZoneLoopbackAddresses#loopbacks}
  */
  readonly loopbacks: { [key: string]: DatacenterRoutingZoneLoopbackAddressesLoopbacks } | cdktf.IResolvable;
  /**
  * Routing Zone ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_routing_zone_loopback_addresses#routing_zone_id DatacenterRoutingZoneLoopbackAddresses#routing_zone_id}
  */
...
export interface DatacenterRoutingZoneLoopbackAddressesLoopbacks {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_routing_zone_loopback_addresses#ipv4_addr DatacenterRoutingZoneLoopbackAddresses#ipv4_addr}
  */
  readonly ipv4Addr?: string;
  /**
  * The IPv6 address to be assigned within the Routing Zone, in CIDR notation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_routing_zone_loopback_addresses#ipv6_addr DatacenterRoutingZoneLoopbackAddresses#ipv6_addr}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_routing_zone_loopback_addresses apstra_datacenter_routing_zone_loopback_addresses}
*/
export class DatacenterRoutingZoneLoopbackAddresses extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_routing_zone_loopback_addresses apstra_datacenter_routing_zone_loopback_addresses} Resource
  *
  * @param scope The scope in which to define this construct
