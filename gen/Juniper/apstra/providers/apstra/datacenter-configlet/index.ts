// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_configlet
...
export interface DatacenterConfigletConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_configlet#blueprint_id DatacenterConfiglet#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Id of the catalog configlet to be imported. This is an alternative to specifying the `generators` attribute
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_configlet#catalog_configlet_id DatacenterConfiglet#catalog_configlet_id}
  */
  readonly catalogConfigletId?: string;
  /**
  * Condition determines where the Configlet is applied.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_configlet#condition DatacenterConfiglet#condition}
  */
  readonly condition: string;
  /**
  * Ordered list of Generators. This is an alternative to specifying the `catalog_configlet_id` attribute
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_configlet#generators DatacenterConfiglet#generators}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_configlet#name DatacenterConfiglet#name}
  */
...
export interface DatacenterConfigletGenerators {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_configlet#config_style DatacenterConfiglet#config_style}
  */
  readonly configStyle: string;
  /**
  * FileName
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_configlet#filename DatacenterConfiglet#filename}
  */
  readonly filename?: string;
  /**
  * Negation Template Text
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_configlet#negation_template_text DatacenterConfiglet#negation_template_text}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_configlet#section DatacenterConfiglet#section}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_configlet#section_condition DatacenterConfiglet#section_condition}
  */
  readonly sectionCondition?: string;
  /**
  * Template Text
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_configlet#template_text DatacenterConfiglet#template_text}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_configlet apstra_datacenter_configlet}
*/
export class DatacenterConfiglet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatacenterConfiglet that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_configlet#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_configlet apstra_datacenter_configlet} Resource
  *
  * @param scope The scope in which to define this construct
