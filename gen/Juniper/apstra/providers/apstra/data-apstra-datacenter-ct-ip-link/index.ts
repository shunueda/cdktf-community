// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_ip_link
...
export interface DataApstraDatacenterCtIpLinkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_ip_link#child_primitives DataApstraDatacenterCtIpLink#child_primitives}
  */
  readonly childPrimitives?: string[];
  /**
  * One of `numbered`, `none` (or omit)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_ip_link#ipv4_addressing_type DataApstraDatacenterCtIpLink#ipv4_addressing_type}
  */
  readonly ipv4AddressingType?: string;
  /**
  * One of `link_local`, `numbered`, `none` (or omit)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_ip_link#ipv6_addressing_type DataApstraDatacenterCtIpLink#ipv6_addressing_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_ip_link#l3_mtu DataApstraDatacenterCtIpLink#l3_mtu}
  */
  readonly l3Mtu?: number;
  /**
  * Primitive name displayed in the web UI
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_ip_link#name DataApstraDatacenterCtIpLink#name}
  */
  readonly name?: string;
  /**
  * Apstra Object ID of the Routing Zone to which this IP Link belongs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_ip_link#routing_zone_id DataApstraDatacenterCtIpLink#routing_zone_id}
  */
  readonly routingZoneId: string;
  /**
  * When set, selects the 802.1Q VLAN ID to use for the link's traffic. Omit for an untagged link.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_ip_link#vlan_id DataApstraDatacenterCtIpLink#vlan_id}
  */
  readonly vlanId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_ip_link apstra_datacenter_ct_ip_link}
*/
export class DataApstraDatacenterCtIpLink extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataApstraDatacenterCtIpLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_ip_link#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_ip_link apstra_datacenter_ct_ip_link} Data Source
  *
  * @param scope The scope in which to define this construct
