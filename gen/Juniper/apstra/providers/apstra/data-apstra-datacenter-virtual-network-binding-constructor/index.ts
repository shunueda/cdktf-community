// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_virtual_network_binding_constructor
...
export interface DataApstraDatacenterVirtualNetworkBindingConstructorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_virtual_network_binding_constructor#blueprint_id DataApstraDatacenterVirtualNetworkBindingConstructor#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Set of graph db node IDs representing access and/or leaf switches for which a binding should be constructed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_virtual_network_binding_constructor#switch_ids DataApstraDatacenterVirtualNetworkBindingConstructor#switch_ids}
  */
  readonly switchIds: string[];
  /**
  * VLAN ID will be populated directly into the `bindings` output.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_virtual_network_binding_constructor#vlan_id DataApstraDatacenterVirtualNetworkBindingConstructor#vlan_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_virtual_network_binding_constructor apstra_datacenter_virtual_network_binding_constructor}
*/
export class DataApstraDatacenterVirtualNetworkBindingConstructor extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_virtual_network_binding_constructor apstra_datacenter_virtual_network_binding_constructor} Data Source
  *
  * @param scope The scope in which to define this construct
