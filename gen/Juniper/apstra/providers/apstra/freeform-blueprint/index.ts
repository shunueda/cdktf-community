// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_blueprint
...
export interface FreeformBlueprintConfig extends cdktf.TerraformMetaArguments {
  ...
  * Blueprint name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_blueprint#name FreeformBlueprint#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_blueprint apstra_freeform_blueprint}
*/
export class FreeformBlueprint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FreeformBlueprint that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_blueprint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_blueprint apstra_freeform_blueprint} Resource
  *
  * @param scope The scope in which to define this construct
