// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/ipv6_pool
...
export interface Ipv6PoolConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/ipv6_pool#name Ipv6Pool#name}
  */
  readonly name: string;
  /**
  * Detailed info about individual IPv6 CIDR allocations within the IPv6 Pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/ipv6_pool#subnets Ipv6Pool#subnets}
  */
...
export interface Ipv6PoolSubnets {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/ipv6_pool#network Ipv6Pool#network}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/ipv6_pool apstra_ipv6_pool}
*/
export class Ipv6Pool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ipv6Pool that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/ipv6_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/ipv6_pool apstra_ipv6_pool} Resource
  *
  * @param scope The scope in which to define this construct
