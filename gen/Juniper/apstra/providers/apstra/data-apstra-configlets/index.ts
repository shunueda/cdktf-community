// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/configlets
...
export interface DataApstraConfigletsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/configlets#supported_platforms DataApstraConfiglets#supported_platforms}
  */
  readonly supportedPlatforms?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/configlets apstra_configlets}
*/
export class DataApstraConfiglets extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataApstraConfiglets that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/configlets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/configlets apstra_configlets} Data Source
  *
  * @param scope The scope in which to define this construct
