// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_resource_generator
...
export interface FreeformResourceGeneratorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_resource_generator#allocated_from FreeformResourceGenerator#allocated_from}
  */
  readonly allocatedFrom: string;
  /**
  * Apstra Blueprint ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_resource_generator#blueprint_id FreeformResourceGenerator#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * ID of the group where Resources are generated. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_resource_generator#container_id FreeformResourceGenerator#container_id}
  */
  readonly containerId: string;
  /**
  * Freeform Resource Generator name as shown in the Web UI.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_resource_generator#name FreeformResourceGenerator#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_resource_generator#scope FreeformResourceGenerator#scope}
  */
  readonly scope: string;
  /**
  * Length of the subnet for the generated Resources. Only applicable when `type` is `ipv4` or `ipv6`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_resource_generator#subnet_prefix_len FreeformResourceGenerator#subnet_prefix_len}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_resource_generator#type FreeformResourceGenerator#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_resource_generator apstra_freeform_resource_generator}
*/
export class FreeformResourceGenerator extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FreeformResourceGenerator that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_resource_generator#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_resource_generator apstra_freeform_resource_generator} Resource
  *
  * @param scope The scope in which to define this construct
