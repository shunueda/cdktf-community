// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_connectivity_templates_assignment
...
export interface DatacenterConnectivityTemplatesAssignmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_connectivity_templates_assignment#application_point_id DatacenterConnectivityTemplatesAssignment#application_point_id}
  */
  readonly applicationPointId: string;
  /**
  * Apstra Blueprint ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_connectivity_templates_assignment#blueprint_id DatacenterConnectivityTemplatesAssignment#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Set of Connectivity Template IDs which should be applied to the Application Point.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_connectivity_templates_assignment#connectivity_template_ids DatacenterConnectivityTemplatesAssignment#connectivity_template_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_connectivity_templates_assignment#fetch_ip_link_ids DatacenterConnectivityTemplatesAssignment#fetch_ip_link_ids}
  */
  readonly fetchIpLinkIds?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_connectivity_templates_assignment apstra_datacenter_connectivity_templates_assignment}
*/
export class DatacenterConnectivityTemplatesAssignment extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_connectivity_templates_assignment apstra_datacenter_connectivity_templates_assignment} Resource
  *
  * @param scope The scope in which to define this construct
