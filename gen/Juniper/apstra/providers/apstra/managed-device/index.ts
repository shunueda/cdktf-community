// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/managed_device
...
export interface ManagedDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/managed_device#agent_profile_id ManagedDevice#agent_profile_id}
  */
  readonly agentProfileId: string;
  /**
  * Key which uniquely identifies a System asset. Possibly a MAC address or serial number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/managed_device#device_key ManagedDevice#device_key}
  */
  readonly deviceKey?: string;
  /**
  * Device `location` field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/managed_device#location ManagedDevice#location}
  */
  readonly location?: string;
  /**
  * Management IP address of the system.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/managed_device#management_ip ManagedDevice#management_ip}
  */
  readonly managementIp: string;
  /**
  * Indicates that an *offbox* agent should be created (required for Junos devices, default: `true`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/managed_device#off_box ManagedDevice#off_box}
  */
  readonly offBox?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/managed_device apstra_managed_device}
*/
export class ManagedDevice extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/managed_device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/managed_device apstra_managed_device} Resource
  *
  * @param scope The scope in which to define this construct
