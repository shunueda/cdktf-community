// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_external_gateways
...
export interface DataApstraDatacenterExternalGatewaysConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_external_gateways#blueprint_id DataApstraDatacenterExternalGateways#blueprint_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_external_gateways#filters DataApstraDatacenterExternalGateways#filters}
  */
...
export interface DataApstraDatacenterExternalGatewaysFilters {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_external_gateways#asn DataApstraDatacenterExternalGateways#asn}
  */
  readonly asn?: number;
  /**
  * EVPN route types. Valid values are: ["all", "type5_only"]. Default: "all"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_external_gateways#evpn_route_types DataApstraDatacenterExternalGateways#evpn_route_types}
  */
  readonly evpnRouteTypes?: string;
  /**
  * BGP hold time (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_external_gateways#hold_time DataApstraDatacenterExternalGateways#hold_time}
  */
  readonly holdTime?: number;
  /**
  * Apstra Object ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_external_gateways#id DataApstraDatacenterExternalGateways#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_external_gateways#ip_address DataApstraDatacenterExternalGateways#ip_address}
  */
  readonly ipAddress?: string;
  /**
  * BGP keepalive time (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_external_gateways#keepalive_time DataApstraDatacenterExternalGateways#keepalive_time}
  */
  readonly keepaliveTime?: number;
  /**
  * Set of IDs of switch nodes which will be configured to peer with the External Gateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_external_gateways#local_gateway_nodes DataApstraDatacenterExternalGateways#local_gateway_nodes}
  */
  readonly localGatewayNodes?: string[];
  /**
  * External Gateway name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_external_gateways#name DataApstraDatacenterExternalGateways#name}
  */
  readonly name?: string;
  /**
  * BGP TCP authentication password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_external_gateways#password DataApstraDatacenterExternalGateways#password}
  */
  readonly password?: string;
  /**
  * BGP Time To Live. Omit to use device defaults.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_external_gateways#ttl DataApstraDatacenterExternalGateways#ttl}
  */
  readonly ttl?: number;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_external_gateways apstra_datacenter_external_gateways}
*/
export class DataApstraDatacenterExternalGateways extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_external_gateways apstra_datacenter_external_gateways} Data Source
  *
  * @param scope The scope in which to define this construct
