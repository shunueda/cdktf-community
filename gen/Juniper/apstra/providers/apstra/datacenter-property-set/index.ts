// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_property_set
...
export interface DatacenterPropertySetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_property_set#blueprint_id DatacenterPropertySet#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * ID of the Property Set ID to be imported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_property_set#id DatacenterPropertySet#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_property_set#keys DatacenterPropertySet#keys}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_property_set#sync_required DatacenterPropertySet#sync_required}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_property_set#sync_with_catalog DatacenterPropertySet#sync_with_catalog}
  */
  readonly syncWithCatalog?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_property_set apstra_datacenter_property_set}
*/
export class DatacenterPropertySet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatacenterPropertySet that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_property_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_property_set apstra_datacenter_property_set} Resource
  *
  * @param scope The scope in which to define this construct
