// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/managed_device_ack
...
export interface ManagedDeviceAckConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/managed_device_ack#agent_id ManagedDeviceAck#agent_id}
  */
  readonly agentId: string;
  /**
  * Key which uniquely identifies a System asset, probably the serial number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/managed_device_ack#device_key ManagedDeviceAck#device_key}
  */
  readonly deviceKey: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/managed_device_ack apstra_managed_device_ack}
*/
export class ManagedDeviceAck extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedDeviceAck that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/managed_device_ack#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/managed_device_ack apstra_managed_device_ack} Resource
  *
  * @param scope The scope in which to define this construct
