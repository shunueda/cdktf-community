// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_resource_pool_allocation
...
export interface DatacenterResourcePoolAllocationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_resource_pool_allocation#blueprint_id DatacenterResourcePoolAllocation#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Apstra IDs of the Resource Pools to be allocated to the given Blueprint role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_resource_pool_allocation#pool_ids DatacenterResourcePoolAllocation#pool_ids}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_resource_pool_allocation#role DatacenterResourcePoolAllocation#role}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_resource_pool_allocation#routing_zone_id DatacenterResourcePoolAllocation#routing_zone_id}
  */
  readonly routingZoneId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_resource_pool_allocation apstra_datacenter_resource_pool_allocation}
*/
export class DatacenterResourcePoolAllocation extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_resource_pool_allocation apstra_datacenter_resource_pool_allocation} Resource
  *
  * @param scope The scope in which to define this construct
