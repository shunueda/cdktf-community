// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/blueprint_iba_probe
...
export interface BlueprintIbaProbeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/blueprint_iba_probe#blueprint_id BlueprintIbaProbe#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Id of predefined IBA Probe
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/blueprint_iba_probe#predefined_probe_id BlueprintIbaProbe#predefined_probe_id}
  */
  readonly predefinedProbeId?: string;
  /**
  * Configuration elements for the IBA Probe
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/blueprint_iba_probe#probe_config BlueprintIbaProbe#probe_config}
  */
  readonly probeConfig?: string;
  /**
  * Define the probe as json. If this is present, there can be no predefined probe.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/blueprint_iba_probe#probe_json BlueprintIbaProbe#probe_json}
  */
  readonly probeJson?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/blueprint_iba_probe apstra_blueprint_iba_probe}
*/
export class BlueprintIbaProbe extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BlueprintIbaProbe that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/blueprint_iba_probe#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/blueprint_iba_probe apstra_blueprint_iba_probe} Resource
  *
  * @param scope The scope in which to define this construct
