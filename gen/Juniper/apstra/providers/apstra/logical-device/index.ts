// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/logical_device
...
export interface LogicalDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/logical_device#name LogicalDevice#name}
  */
  readonly name: string;
  /**
  * Details physical layout of interfaces on the device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/logical_device#panels LogicalDevice#panels}
  */
...
export interface LogicalDevicePanelsPortGroups {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/logical_device#port_count LogicalDevice#port_count}
  */
  readonly portCount: number;
  /**
  * One or more of: 'access', 'generic', 'leaf', 'peer', 'spine', 'superspine', 'unused', by default all values are selected.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/logical_device#port_roles LogicalDevice#port_roles}
  */
  readonly portRoles?: string[];
  /**
  * Port speed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/logical_device#port_speed LogicalDevice#port_speed}
  */
...
export interface LogicalDevicePanels {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/logical_device#columns LogicalDevice#columns}
  */
  readonly columns: number;
  /**
  * Ordered logical groupings of interfaces by speed or purpose within a panel
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/logical_device#port_groups LogicalDevice#port_groups}
  */
  readonly portGroups: LogicalDevicePanelsPortGroups[] | cdktf.IResolvable;
  /**
  * Physical vertical dimension of the panel.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/logical_device#rows LogicalDevice#rows}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/logical_device apstra_logical_device}
*/
export class LogicalDevice extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogicalDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/logical_device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/logical_device apstra_logical_device} Resource
  *
  * @param scope The scope in which to define this construct
