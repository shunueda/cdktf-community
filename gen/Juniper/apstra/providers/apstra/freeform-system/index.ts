// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_system
...
export interface FreeformSystemConfig extends cdktf.TerraformMetaArguments {
  ...
  * Apstra Blueprint ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_system#blueprint_id FreeformSystem#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Deploy mode of the System
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_system#deploy_mode FreeformSystem#deploy_mode}
  */
  readonly deployMode?: string;
  /**
  * Device profile ID of the System. Required when `type` is "internal".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_system#device_profile_id FreeformSystem#device_profile_id}
  */
  readonly deviceProfileId?: string;
  /**
  * Hostname of the Freeform System.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_system#hostname FreeformSystem#hostname}
  */
  readonly hostname: string;
  /**
  * Freeform System name as shown in the Web UI.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_system#name FreeformSystem#name}
  */
  readonly name: string;
  /**
  * ID (usually serial number) of the Managed Device to associate with this System
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_system#system_id FreeformSystem#system_id}
  */
  readonly systemId?: string;
  /**
  * Set of Tag labels
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_system#tags FreeformSystem#tags}
  */
  readonly tags?: string[];
  /**
  * Type of the System. Must be one of `internal` or `external`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_system#type FreeformSystem#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_system apstra_freeform_system}
*/
export class FreeformSystem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FreeformSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_system#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_system apstra_freeform_system} Resource
  *
  * @param scope The scope in which to define this construct
