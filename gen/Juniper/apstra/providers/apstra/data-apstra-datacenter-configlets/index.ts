// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_configlets
...
export interface DataApstraDatacenterConfigletsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_configlets#blueprint_id DataApstraDatacenterConfiglets#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Configlets which do not support each of the specified platforms will be filtered out of the results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_configlets#supported_platforms DataApstraDatacenterConfiglets#supported_platforms}
  */
  readonly supportedPlatforms?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_configlets apstra_datacenter_configlets}
*/
export class DataApstraDatacenterConfiglets extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataApstraDatacenterConfiglets that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_configlets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_configlets apstra_datacenter_configlets} Data Source
  *
  * @param scope The scope in which to define this construct
