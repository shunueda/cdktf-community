// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_interconnect_domain
...
export interface DatacenterInterconnectDomainConfig extends cdktf.TerraformMetaArguments {
  ...
  * Apstra Blueprint ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_interconnect_domain#blueprint_id DatacenterInterconnectDomain#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Each site requires a unique site id iESI at the MAC-VRF level. This can be auto-derived or manually set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_interconnect_domain#esi_mac DatacenterInterconnectDomain#esi_mac}
  */
  readonly esiMac?: string;
  /**
  * Name displayed in the Apstra web UI.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_interconnect_domain#name DatacenterInterconnectDomain#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_interconnect_domain#route_target DatacenterInterconnectDomain#route_target}
  */
  readonly routeTarget: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_interconnect_domain apstra_datacenter_interconnect_domain}
*/
export class DatacenterInterconnectDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatacenterInterconnectDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_interconnect_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_interconnect_domain apstra_datacenter_interconnect_domain} Resource
  *
  * @param scope The scope in which to define this construct
