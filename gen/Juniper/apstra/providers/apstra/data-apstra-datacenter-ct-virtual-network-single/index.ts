// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_virtual_network_single
...
export interface DataApstraDatacenterCtVirtualNetworkSingleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_virtual_network_single#child_primitives DataApstraDatacenterCtVirtualNetworkSingle#child_primitives}
  */
  readonly childPrimitives?: string[];
  /**
  * Primitive name displayed in the web UI
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_virtual_network_single#name DataApstraDatacenterCtVirtualNetworkSingle#name}
  */
  readonly name?: string;
  /**
  * Indicates whether the VN should mark frames belonging to the VN with 802.1Q tags. Default: `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_virtual_network_single#tagged DataApstraDatacenterCtVirtualNetworkSingle#tagged}
  */
  readonly tagged?: boolean | cdktf.IResolvable;
  /**
  * Virtual Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_virtual_network_single#vn_id DataApstraDatacenterCtVirtualNetworkSingle#vn_id}
  */
  readonly vnId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_virtual_network_single apstra_datacenter_ct_virtual_network_single}
*/
export class DataApstraDatacenterCtVirtualNetworkSingle extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_virtual_network_single apstra_datacenter_ct_virtual_network_single} Data Source
  *
  * @param scope The scope in which to define this construct
