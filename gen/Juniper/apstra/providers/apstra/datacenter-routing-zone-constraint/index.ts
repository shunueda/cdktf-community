// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_routing_zone_constraint
...
export interface DatacenterRoutingZoneConstraintConfig extends cdktf.TerraformMetaArguments {
  ...
  * Apstra Blueprint ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_routing_zone_constraint#blueprint_id DatacenterRoutingZoneConstraint#blueprint_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_routing_zone_constraint#constraints DatacenterRoutingZoneConstraint#constraints}
  */
  readonly constraints?: string[];
  /**
  * The maximum number of Routing Zones that the Application Point can be part of.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_routing_zone_constraint#max_count_constraint DatacenterRoutingZoneConstraint#max_count_constraint}
  */
  readonly maxCountConstraint?: number;
  /**
  * Name displayed in the Apstra web UI.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_routing_zone_constraint#name DatacenterRoutingZoneConstraint#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_routing_zone_constraint#routing_zones_list_constraint DatacenterRoutingZoneConstraint#routing_zones_list_constraint}
  */
  readonly routingZonesListConstraint: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_routing_zone_constraint apstra_datacenter_routing_zone_constraint}
*/
export class DatacenterRoutingZoneConstraint extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_routing_zone_constraint apstra_datacenter_routing_zone_constraint} Resource
  *
  * @param scope The scope in which to define this construct
