// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/modular_device_profile
...
export interface ModularDeviceProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/modular_device_profile#chassis_profile_id ModularDeviceProfile#chassis_profile_id}
  */
  readonly chassisProfileId: string;
  /**
  * A map of Line Card Device Profile IDs, keyed by slot number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/modular_device_profile#line_card_profile_ids ModularDeviceProfile#line_card_profile_ids}
  */
  readonly lineCardProfileIds: { [key: string]: string };
  /**
  * Name displayed in web UI.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/modular_device_profile#name ModularDeviceProfile#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/modular_device_profile apstra_modular_device_profile}
*/
export class ModularDeviceProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ModularDeviceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/modular_device_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/modular_device_profile apstra_modular_device_profile} Resource
  *
  * @param scope The scope in which to define this construct
