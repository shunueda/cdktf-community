// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/agent_profile
...
export interface AgentProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/agent_profile#name AgentProfile#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/agent_profile#open_options AgentProfile#open_options}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/agent_profile#packages AgentProfile#packages}
  */
  readonly packages?: { [key: string]: string };
  /**
  * Specifies the platform supported by the Agent Profile.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/agent_profile#platform AgentProfile#platform}
  */
  readonly platform?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/agent_profile apstra_agent_profile}
*/
export class AgentProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AgentProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/agent_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/agent_profile apstra_agent_profile} Resource
  *
  * @param scope The scope in which to define this construct
