// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_blueprint
...
export interface DataApstraDatacenterBlueprintConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_blueprint#id DataApstraDatacenterBlueprint#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_blueprint#max_mlag_routes_count DataApstraDatacenterBlueprint#max_mlag_routes_count}
  */
  readonly maxMlagRoutesCount?: number;
  /**
  * Name of the Blueprint. Required when `id` is omitted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_blueprint#name DataApstraDatacenterBlueprint#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_blueprint apstra_datacenter_blueprint}
*/
export class DataApstraDatacenterBlueprint extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataApstraDatacenterBlueprint that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_blueprint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_blueprint apstra_datacenter_blueprint} Data Source
  *
  * @param scope The scope in which to define this construct
