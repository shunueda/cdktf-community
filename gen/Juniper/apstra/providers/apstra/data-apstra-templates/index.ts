// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/templates
...
export interface DataApstraTemplatesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/templates#overlay_control_protocol DataApstraTemplates#overlay_control_protocol}
  */
  readonly overlayControlProtocol?: string;
  /**
  * Optional filter to select only Templates of the specified type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/templates#type DataApstraTemplates#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/templates apstra_templates}
*/
export class DataApstraTemplates extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataApstraTemplates that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/templates#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/templates apstra_templates} Data Source
  *
  * @param scope The scope in which to define this construct
