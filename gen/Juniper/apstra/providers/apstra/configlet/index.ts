// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/configlet
...
export interface ConfigletConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/configlet#generators Configlet#generators}
  */
  readonly generators: ConfigletGenerators[] | cdktf.IResolvable;
  /**
  * Configlet name displayed in the Apstra web UI
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/configlet#name Configlet#name}
  */
...
export interface ConfigletGenerators {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/configlet#config_style Configlet#config_style}
  */
  readonly configStyle: string;
  /**
  * FileName
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/configlet#filename Configlet#filename}
  */
  readonly filename?: string;
  /**
  * Negation Template Text
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/configlet#negation_template_text Configlet#negation_template_text}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/configlet#section Configlet#section}
  */
  readonly section: string;
  /**
  * Template Text
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/configlet#template_text Configlet#template_text}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/configlet apstra_configlet}
*/
export class Configlet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Configlet that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/configlet#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/configlet apstra_configlet} Resource
  *
  * @param scope The scope in which to define this construct
