// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_device_profile
...
export interface FreeformDeviceProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  * Apstra Blueprint ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_device_profile#blueprint_id FreeformDeviceProfile#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Device Profile ID to be imported from the global catalog.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_device_profile#device_profile_id FreeformDeviceProfile#device_profile_id}
  */
  readonly deviceProfileId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_device_profile apstra_freeform_device_profile}
*/
export class FreeformDeviceProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FreeformDeviceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_device_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_device_profile apstra_freeform_device_profile} Resource
  *
  * @param scope The scope in which to define this construct
