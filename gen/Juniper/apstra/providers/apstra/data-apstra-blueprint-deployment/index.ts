// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/blueprint_deployment
...
export interface DataApstraBlueprintDeploymentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/blueprint_deployment#blueprint_id DataApstraBlueprintDeployment#blueprint_id}
  */
  readonly blueprintId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/blueprint_deployment apstra_blueprint_deployment}
*/
export class DataApstraBlueprintDeployment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataApstraBlueprintDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/blueprint_deployment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/blueprint_deployment apstra_blueprint_deployment} Data Source
  *
  * @param scope The scope in which to define this construct
