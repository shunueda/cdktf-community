// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_dynamic_bgp_peering
...
export interface DataApstraDatacenterCtDynamicBgpPeeringConfig extends cdktf.TerraformMetaArguments {
  ...
  * Enable BFD.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_dynamic_bgp_peering#bfd_enabled DataApstraDatacenterCtDynamicBgpPeering#bfd_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_dynamic_bgp_peering#child_primitives DataApstraDatacenterCtDynamicBgpPeering#child_primitives}
  */
  readonly childPrimitives?: string[];
  /**
  * BGP hold time (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_dynamic_bgp_peering#hold_time DataApstraDatacenterCtDynamicBgpPeering#hold_time}
  */
  readonly holdTime?: number;
  /**
  * Enable to allow IPv4 peers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_dynamic_bgp_peering#ipv4_enabled DataApstraDatacenterCtDynamicBgpPeering#ipv4_enabled}
  */
  readonly ipv4Enabled?: boolean | cdktf.IResolvable;
  /**
  * Omit to derive prefix from the application point.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_dynamic_bgp_peering#ipv4_peer_prefix DataApstraDatacenterCtDynamicBgpPeering#ipv4_peer_prefix}
  */
  readonly ipv4PeerPrefix?: string;
  /**
  * Enable to allow IPv6 peers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_dynamic_bgp_peering#ipv6_enabled DataApstraDatacenterCtDynamicBgpPeering#ipv6_enabled}
  */
  readonly ipv6Enabled?: boolean | cdktf.IResolvable;
  /**
  * Omit to derive prefix from the application point.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_dynamic_bgp_peering#ipv6_peer_prefix DataApstraDatacenterCtDynamicBgpPeering#ipv6_peer_prefix}
  */
  readonly ipv6PeerPrefix?: string;
  /**
  * BGP keepalive time (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_dynamic_bgp_peering#keepalive_time DataApstraDatacenterCtDynamicBgpPeering#keepalive_time}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_dynamic_bgp_peering#local_asn DataApstraDatacenterCtDynamicBgpPeering#local_asn}
  */
  readonly localAsn?: number;
  /**
  * Primitive name displayed in the web UI
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_dynamic_bgp_peering#name DataApstraDatacenterCtDynamicBgpPeering#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_dynamic_bgp_peering#password DataApstraDatacenterCtDynamicBgpPeering#password}
  */
  readonly password?: string;
  /**
  * BGP Time To Live. Omit to use device defaults.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_dynamic_bgp_peering#ttl DataApstraDatacenterCtDynamicBgpPeering#ttl}
  */
  readonly ttl?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_dynamic_bgp_peering apstra_datacenter_ct_dynamic_bgp_peering}
*/
export class DataApstraDatacenterCtDynamicBgpPeering extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/datacenter_ct_dynamic_bgp_peering apstra_datacenter_ct_dynamic_bgp_peering} Data Source
  *
  * @param scope The scope in which to define this construct
