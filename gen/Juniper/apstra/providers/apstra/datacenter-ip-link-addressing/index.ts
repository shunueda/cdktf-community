// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_ip_link_addressing
...
export interface DatacenterIpLinkAddressingConfig extends cdktf.TerraformMetaArguments {
  ...
  * Apstra Blueprint ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_ip_link_addressing#blueprint_id DatacenterIpLinkAddressing#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * IPv4 address in CIDR notation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_ip_link_addressing#generic_ipv4_address DatacenterIpLinkAddressing#generic_ipv4_address}
  */
  readonly genericIpv4Address?: string;
  /**
  * Allowed values: [`none`,`numbered`]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_ip_link_addressing#generic_ipv4_address_type DatacenterIpLinkAddressing#generic_ipv4_address_type}
  */
  readonly genericIpv4AddressType?: string;
  /**
  * IPv6 address in CIDR notation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_ip_link_addressing#generic_ipv6_address DatacenterIpLinkAddressing#generic_ipv6_address}
  */
  readonly genericIpv6Address?: string;
  /**
  * Allowed values: [`link_local`,`none`,`numbered`]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_ip_link_addressing#generic_ipv6_address_type DatacenterIpLinkAddressing#generic_ipv6_address_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_ip_link_addressing#link_id DatacenterIpLinkAddressing#link_id}
  */
  readonly linkId: string;
  /**
  * IPv4 address in CIDR notation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_ip_link_addressing#switch_ipv4_address DatacenterIpLinkAddressing#switch_ipv4_address}
  */
  readonly switchIpv4Address?: string;
  /**
  * Allowed values: [`none`,`numbered`]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_ip_link_addressing#switch_ipv4_address_type DatacenterIpLinkAddressing#switch_ipv4_address_type}
  */
  readonly switchIpv4AddressType?: string;
  /**
  * IPv6 address in CIDR notation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_ip_link_addressing#switch_ipv6_address DatacenterIpLinkAddressing#switch_ipv6_address}
  */
  readonly switchIpv6Address?: string;
  /**
  * Allowed values: [`link_local`,`none`,`numbered`]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_ip_link_addressing#switch_ipv6_address_type DatacenterIpLinkAddressing#switch_ipv6_address_type}
  */
  readonly switchIpv6AddressType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_ip_link_addressing apstra_datacenter_ip_link_addressing}
*/
export class DatacenterIpLinkAddressing extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatacenterIpLinkAddressing that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_ip_link_addressing#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_ip_link_addressing apstra_datacenter_ip_link_addressing} Resource
  *
  * @param scope The scope in which to define this construct
