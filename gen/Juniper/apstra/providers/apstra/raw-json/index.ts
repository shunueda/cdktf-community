// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/raw_json
...
export interface RawJsonConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/raw_json#id RawJson#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/raw_json#payload RawJson#payload}
  */
  readonly payload: string;
  /**
  * The method used to update the JSON object. Must be one of `PUT` or `PATCH`. Default: `PUT`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/raw_json#update_method RawJson#update_method}
  */
  readonly updateMethod?: string;
  /**
  * The API URL associated with the raw JSON object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/raw_json#url RawJson#url}
  */
  readonly url: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/raw_json apstra_raw_json}
*/
export class RawJson extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RawJson that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/raw_json#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/raw_json apstra_raw_json} Resource
  *
  * @param scope The scope in which to define this construct
