// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_resource_group
...
export interface FreeformResourceGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  * Apstra Blueprint ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_resource_group#blueprint_id FreeformResourceGroup#blueprint_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_resource_group#data FreeformResourceGroup#data}
  */
  readonly data?: string;
  /**
  * Freeform Resource Group name as shown in the Web UI.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_resource_group#name FreeformResourceGroup#name}
  */
  readonly name: string;
  /**
  * ID of the parent Freeform Resource Group, if this group is to be nested.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_resource_group#parent_id FreeformResourceGroup#parent_id}
  */
  readonly parentId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_resource_group apstra_freeform_resource_group}
*/
export class FreeformResourceGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FreeformResourceGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_resource_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/freeform_resource_group apstra_freeform_resource_group} Resource
  *
  * @param scope The scope in which to define this construct
