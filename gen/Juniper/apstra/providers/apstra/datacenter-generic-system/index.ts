// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system
...
export interface DatacenterGenericSystemConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system#asn DatacenterGenericSystem#asn}
  */
  readonly asn?: number;
  /**
  * Apstra Blueprint ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system#blueprint_id DatacenterGenericSystem#blueprint_id}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system#clear_cts_on_destroy DatacenterGenericSystem#clear_cts_on_destroy}
  */
  readonly clearCtsOnDestroy?: boolean | cdktf.IResolvable;
  /**
  * Set the Apstra Deploy Mode for this Generic System. Default: `deploy`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system#deploy_mode DatacenterGenericSystem#deploy_mode}
  */
  readonly deployMode?: string;
  /**
  * Set `true` to create an External Generic System
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system#external DatacenterGenericSystem#external}
  */
  readonly external?: boolean | cdktf.IResolvable;
  /**
  * System hostname.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system#hostname DatacenterGenericSystem#hostname}
  */
  readonly hostname?: string;
  /**
  * Generic System link details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system#links DatacenterGenericSystem#links}
  */
  readonly links: DatacenterGenericSystemLinks[] | cdktf.IResolvable;
  /**
  * IPv4 address of loopback interface in CIDR notation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system#loopback_ipv4 DatacenterGenericSystem#loopback_ipv4}
  */
  readonly loopbackIpv4?: string;
  /**
  * IPv6 address of loopback interface in CIDR notation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system#loopback_ipv6 DatacenterGenericSystem#loopback_ipv6}
  */
  readonly loopbackIpv6?: string;
  /**
  * Name displayed in the Apstra web UI.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system#name DatacenterGenericSystem#name}
  */
  readonly name?: string;
  /**
  * Omit this attribute to allow any available port-channel to be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system#port_channel_id_max DatacenterGenericSystem#port_channel_id_max}
  */
  readonly portChannelIdMax?: number;
  /**
  * Omit this attribute to allow any available port-channel to be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system#port_channel_id_min DatacenterGenericSystem#port_channel_id_min}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system#tags DatacenterGenericSystem#tags}
  */
...
export interface DatacenterGenericSystemLinks {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system#group_label DatacenterGenericSystem#group_label}
  */
  readonly groupLabel?: string;
  /**
  * LAG negotiation mode of the Link. All links with the same `group_label` must use the value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system#lag_mode DatacenterGenericSystem#lag_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system#target_switch_id DatacenterGenericSystem#target_switch_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system#target_switch_if_name DatacenterGenericSystem#target_switch_if_name}
  */
  readonly targetSwitchIfName: string;
  /**
  * Transformation ID sets the operational mode of an interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system#target_switch_if_transform_id DatacenterGenericSystem#target_switch_if_transform_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system apstra_datacenter_generic_system}
*/
export class DatacenterGenericSystem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatacenterGenericSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/datacenter_generic_system apstra_datacenter_generic_system} Resource
  *
  * @param scope The scope in which to define this construct
