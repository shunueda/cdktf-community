// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/blueprint_iba_predefined_probe
...
export interface DataApstraBlueprintIbaPredefinedProbeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/blueprint_iba_predefined_probe#blueprint_id DataApstraBlueprintIbaPredefinedProbe#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Populate this field to look up an IBA Predefined Probe.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/blueprint_iba_predefined_probe#name DataApstraBlueprintIbaPredefinedProbe#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/blueprint_iba_predefined_probe apstra_blueprint_iba_predefined_probe}
*/
export class DataApstraBlueprintIbaPredefinedProbe extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/blueprint_iba_predefined_probe apstra_blueprint_iba_predefined_probe} Data Source
  *
  * @param scope The scope in which to define this construct
