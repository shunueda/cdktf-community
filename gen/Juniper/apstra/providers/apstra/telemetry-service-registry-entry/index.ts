// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/telemetry_service_registry_entry
...
export interface TelemetryServiceRegistryEntryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/telemetry_service_registry_entry#application_schema TelemetryServiceRegistryEntry#application_schema}
  */
  readonly applicationSchema: string;
  /**
  * Description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/telemetry_service_registry_entry#description TelemetryServiceRegistryEntry#description}
  */
  readonly description?: string;
  /**
  * Service Name. Used to identify the Service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/telemetry_service_registry_entry#name TelemetryServiceRegistryEntry#name}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/telemetry_service_registry_entry#storage_schema_path TelemetryServiceRegistryEntry#storage_schema_path}
  */
  readonly storageSchemaPath: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/telemetry_service_registry_entry apstra_telemetry_service_registry_entry}
*/
export class TelemetryServiceRegistryEntry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TelemetryServiceRegistryEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/telemetry_service_registry_entry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/resources/telemetry_service_registry_entry apstra_telemetry_service_registry_entry} Resource
  *
  * @param scope The scope in which to define this construct
