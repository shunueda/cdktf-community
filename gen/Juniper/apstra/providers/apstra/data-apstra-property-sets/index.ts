// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/property_sets
...
/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/property_sets apstra_property_sets}
*/
export class DataApstraPropertySets extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataApstraPropertySets that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/property_sets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/property_sets apstra_property_sets} Data Source
  *
  * @param scope The scope in which to define this construct
