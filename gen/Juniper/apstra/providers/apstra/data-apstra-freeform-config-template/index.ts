// https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/freeform_config_template
...
export interface DataApstraFreeformConfigTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/freeform_config_template#blueprint_id DataApstraFreeformConfigTemplate#blueprint_id}
  */
  readonly blueprintId: string;
  /**
  * Populate this field to look up the Config Template by ID. Required when `name` is omitted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/freeform_config_template#id DataApstraFreeformConfigTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/freeform_config_template#name DataApstraFreeformConfigTemplate#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/freeform_config_template apstra_freeform_config_template}
*/
export class DataApstraFreeformConfigTemplate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataApstraFreeformConfigTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/freeform_config_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juniper/apstra/0.94.0/docs/data-sources/freeform_config_template apstra_freeform_config_template} Data Source
  *
  * @param scope The scope in which to define this construct
