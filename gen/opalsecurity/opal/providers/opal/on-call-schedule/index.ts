// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/on_call_schedule
...
export interface OnCallScheduleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/on_call_schedule#remote_id OnCallSchedule#remote_id}
  */
  readonly remoteId: string;
  /**
  * The third party provider of the on call schedule. must be one of ["OPSGENIE", "PAGER_DUTY"]; Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/on_call_schedule#third_party_provider OnCallSchedule#third_party_provider}
  */
  readonly thirdPartyProvider: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/on_call_schedule opal_on_call_schedule}
*/
export class OnCallSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OnCallSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/on_call_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/on_call_schedule opal_on_call_schedule} Resource
  *
  * @param scope The scope in which to define this construct
