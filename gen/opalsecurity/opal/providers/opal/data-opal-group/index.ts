// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group
...
export interface DataOpalGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  * The ID of the group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group#id DataOpalGroup#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group opal_group}
*/
export class DataOpalGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpalGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group opal_group} Data Source
  *
  * @param scope The scope in which to define this construct
