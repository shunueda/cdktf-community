// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_catalog_mapping
...
export interface DataOpalGroupCatalogMappingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_catalog_mapping#app_resource_id DataOpalGroupCatalogMapping#app_resource_id}
  */
  readonly appResourceId: string;
  /**
  * The ID of the group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_catalog_mapping#group_id DataOpalGroupCatalogMapping#group_id}
  */
  readonly groupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_catalog_mapping opal_group_catalog_mapping}
*/
export class DataOpalGroupCatalogMapping extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpalGroupCatalogMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_catalog_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_catalog_mapping opal_group_catalog_mapping} Data Source
  *
  * @param scope The scope in which to define this construct
