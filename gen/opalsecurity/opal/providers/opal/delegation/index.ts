// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/delegation
...
export interface DelegationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/delegation#delegate_user_id Delegation#delegate_user_id}
  */
  readonly delegateUserId: string;
  /**
  * The ID of the user delegating their access review requests. Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/delegation#delegator_user_id Delegation#delegator_user_id}
  */
  readonly delegatorUserId: string;
  /**
  * The end time of the delegation. Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/delegation#end_time Delegation#end_time}
  */
  readonly endTime: string;
  /**
  * The reason for the delegation. Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/delegation#reason Delegation#reason}
  */
  readonly reason: string;
  /**
  * The start time of the delegation. Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/delegation#start_time Delegation#start_time}
  */
  readonly startTime: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/delegation opal_delegation}
*/
export class Delegation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Delegation that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/delegation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/delegation opal_delegation} Resource
  *
  * @param scope The scope in which to define this construct
