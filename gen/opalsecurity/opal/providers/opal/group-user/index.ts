// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_user
...
export interface GroupUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_user#access_level_remote_id GroupUser#access_level_remote_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_user#duration_minutes GroupUser#duration_minutes}
  */
  readonly durationMinutes?: number;
  /**
  * The ID of the group. Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_user#group_id GroupUser#group_id}
  */
  readonly groupId: string;
  /**
  * The ID of the user to add. Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_user#user_id GroupUser#user_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_user opal_group_user}
*/
export class GroupUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GroupUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_user opal_group_user} Resource
  *
  * @param scope The scope in which to define this construct
