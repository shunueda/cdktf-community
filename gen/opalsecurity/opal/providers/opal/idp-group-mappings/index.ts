// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/idp_group_mappings
...
export interface IdpGroupMappingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/idp_group_mappings#app_resource_id IdpGroupMappings#app_resource_id}
  */
  readonly appResourceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/idp_group_mappings#mappings IdpGroupMappings#mappings}
  */
  readonly mappings: IdpGroupMappingsMappings[] | cdktf.IResolvable;
}
export interface IdpGroupMappingsMappings {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/idp_group_mappings#alias IdpGroupMappings#alias}
  */
  readonly alias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/idp_group_mappings#group_id IdpGroupMappings#group_id}
  */
  readonly groupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/idp_group_mappings#hidden_from_end_user IdpGroupMappings#hidden_from_end_user}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/idp_group_mappings opal_idp_group_mappings}
*/
export class IdpGroupMappings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdpGroupMappings that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/idp_group_mappings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/idp_group_mappings opal_idp_group_mappings} Resource
  *
  * @param scope The scope in which to define this construct
