// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/user_tags
...
export interface DataOpalUserTagsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/user_tags#user_id DataOpalUserTags#user_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/user_tags opal_user_tags}
*/
export class DataOpalUserTags extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpalUserTags that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/user_tags#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/user_tags opal_user_tags} Data Source
  *
  * @param scope The scope in which to define this construct
