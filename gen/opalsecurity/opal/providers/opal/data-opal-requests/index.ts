// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/requests
...
export interface DataOpalRequestsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/requests#cursor DataOpalRequests#cursor}
  */
  readonly cursor?: string;
  /**
  * An end date filter for the events.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/requests#end_date_filter DataOpalRequests#end_date_filter}
  */
  readonly endDateFilter?: string;
  /**
  * Number of results to return per page. Default is 200.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/requests#page_size DataOpalRequests#page_size}
  */
  readonly pageSize?: number;
  /**
  * Filter requests by their requester ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/requests#requester_id DataOpalRequests#requester_id}
  */
  readonly requesterId?: string;
  /**
  * Boolean toggle for if it should only show pending requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/requests#show_pending_only DataOpalRequests#show_pending_only}
  */
  readonly showPendingOnly?: boolean | cdktf.IResolvable;
  /**
  * A start date filter for the events.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/requests#start_date_filter DataOpalRequests#start_date_filter}
  */
  readonly startDateFilter?: string;
  /**
  * Filter requests by their target user ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/requests#target_user_id DataOpalRequests#target_user_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/requests opal_requests}
*/
export class DataOpalRequests extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpalRequests that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/requests#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/requests opal_requests} Data Source
  *
  * @param scope The scope in which to define this construct
