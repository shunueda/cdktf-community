// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/uar
...
export interface DataOpalUarConfig extends cdktf.TerraformMetaArguments {
  ...
  * The ID of the UAR.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/uar#uar_id DataOpalUar#uar_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/uar opal_uar}
*/
export class DataOpalUar extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpalUar that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/uar#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/uar opal_uar} Data Source
  *
  * @param scope The scope in which to define this construct
