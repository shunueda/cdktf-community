// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/tag_user
...
export interface TagUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/tag_user#request_body TagUser#request_body}
  */
  readonly requestBody?: TagUserRequestBody;
  /**
  * The ID of the tag to apply. Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/tag_user#tag_id TagUser#tag_id}
  */
  readonly tagId: string;
  /**
  * The ID of the user to apply the tag to. Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/tag_user#user_id TagUser#user_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/tag_user opal_tag_user}
*/
export class TagUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TagUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/tag_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/tag_user opal_tag_user} Resource
  *
  * @param scope The scope in which to define this construct
