// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/on_call_schedule_list
...
/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/on_call_schedule_list opal_on_call_schedule_list}
*/
export class DataOpalOnCallScheduleList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpalOnCallScheduleList that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/on_call_schedule_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/on_call_schedule_list opal_on_call_schedule_list} Data Source
  *
  * @param scope The scope in which to define this construct
