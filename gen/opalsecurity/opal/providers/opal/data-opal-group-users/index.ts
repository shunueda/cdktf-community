// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_users
...
export interface DataOpalGroupUsersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_users#cursor DataOpalGroupUsers#cursor}
  */
  readonly cursor?: string;
  /**
  * The ID of the group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_users#group_id DataOpalGroupUsers#group_id}
  */
  readonly groupId: string;
  /**
  * Number of results to return per page. Default is 200.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_users#page_size DataOpalGroupUsers#page_size}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_users opal_group_users}
*/
export class DataOpalGroupUsers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpalGroupUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_users#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_users opal_group_users} Data Source
  *
  * @param scope The scope in which to define this construct
