// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/tag
...
export interface DataOpalTagConfig extends cdktf.TerraformMetaArguments {
  ...
  * The tag ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/tag#id DataOpalTag#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/tag opal_tag}
*/
export class DataOpalTag extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpalTag that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/tag#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/tag opal_tag} Data Source
  *
  * @param scope The scope in which to define this construct
