// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/delegations
...
export interface DataOpalDelegationsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/delegations#cursor DataOpalDelegations#cursor}
  */
  readonly cursor?: string;
  /**
  * The delegate user ID to filter delegations by the user being delegated to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/delegations#delegate_user_id DataOpalDelegations#delegate_user_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/delegations#delegator_user_id DataOpalDelegations#delegator_user_id}
  */
  readonly delegatorUserId?: string;
  /**
  * The maximum number of results to return per page. The default is 200.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/delegations#page_size DataOpalDelegations#page_size}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/delegations opal_delegations}
*/
export class DataOpalDelegations extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpalDelegations that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/delegations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/delegations opal_delegations} Data Source
  *
  * @param scope The scope in which to define this construct
