// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_catalog_mapping
...
export interface GroupCatalogMappingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_catalog_mapping#alias GroupCatalogMapping#alias}
  */
  readonly alias?: string;
  /**
  * The ID of the Okta app.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_catalog_mapping#app_resource_id GroupCatalogMapping#app_resource_id}
  */
  readonly appResourceId: string;
  /**
  * The ID of the group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_catalog_mapping#group_id GroupCatalogMapping#group_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_catalog_mapping#hidden_from_end_user GroupCatalogMapping#hidden_from_end_user}
  */
  readonly hiddenFromEndUser?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_catalog_mapping opal_group_catalog_mapping}
*/
export class GroupCatalogMapping extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GroupCatalogMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_catalog_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_catalog_mapping opal_group_catalog_mapping} Resource
  *
  * @param scope The scope in which to define this construct
