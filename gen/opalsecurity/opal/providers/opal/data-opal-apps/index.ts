// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/apps
...
export interface DataOpalAppsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/apps#app_type_filter DataOpalApps#app_type_filter}
  */
  readonly appTypeFilter?: string[];
  /**
  * An owner ID to filter by.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/apps#owner_filter DataOpalApps#owner_filter}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/apps opal_apps}
*/
export class DataOpalApps extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpalApps that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/apps#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/apps opal_apps} Data Source
  *
  * @param scope The scope in which to define this construct
