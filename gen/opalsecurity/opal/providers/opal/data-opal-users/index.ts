// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/users
...
export interface DataOpalUsersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/users#cursor DataOpalUsers#cursor}
  */
  readonly cursor?: string;
  /**
  * Number of results to return per page. Default is 200.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/users#page_size DataOpalUsers#page_size}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/users opal_users}
*/
export class DataOpalUsers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpalUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/users#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/users opal_users} Data Source
  *
  * @param scope The scope in which to define this construct
