// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/bundle
...
export interface BundleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/bundle#admin_owner_id Bundle#admin_owner_id}
  */
  readonly adminOwnerId: string;
  /**
  * A brief description of the bundle.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/bundle#description Bundle#description}
  */
  readonly description?: string;
  /**
  * The name of the bundle.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/bundle#name Bundle#name}
  */
  readonly name: string;
  /**
  * The visibility level of the entity. must be one of ["GLOBAL", "LIMITED"]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/bundle#visibility Bundle#visibility}
  */
  readonly visibility: string;
  /**
  * Default: []
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/bundle#visibility_group_ids Bundle#visibility_group_ids}
  */
  readonly visibilityGroupIds?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/bundle opal_bundle}
*/
export class Bundle extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Bundle that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/bundle#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/bundle opal_bundle} Resource
  *
  * @param scope The scope in which to define this construct
