// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/user
...
export interface DataOpalUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/user#email DataOpalUser#email}
  */
  readonly email?: string;
  /**
  * The user ID of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/user#id DataOpalUser#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/user opal_user}
*/
export class DataOpalUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpalUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/user opal_user} Data Source
  *
  * @param scope The scope in which to define this construct
