// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/owner
...
export interface OwnerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/owner#access_request_escalation_period Owner#access_request_escalation_period}
  */
  readonly accessRequestEscalationPeriod?: number;
  /**
  * A description of the owner.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/owner#description Owner#description}
  */
  readonly description?: string;
  /**
  * The name of the owner.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/owner#name Owner#name}
  */
  readonly name: string;
  /**
  * The message channel id for the reviewer channel.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/owner#reviewer_message_channel_id Owner#reviewer_message_channel_id}
  */
  readonly reviewerMessageChannelId?: string;
  /**
  * Sync this owner's user list with a source group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/owner#source_group_id Owner#source_group_id}
  */
  readonly sourceGroupId?: string;
  /**
  * Users to add to the created owner. If setting a source_group_id this list must be empty.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/owner#user_ids Owner#user_ids}
  */
  readonly userIds: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/owner opal_owner}
*/
export class Owner extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Owner that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/owner#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/owner opal_owner} Resource
  *
  * @param scope The scope in which to define this construct
