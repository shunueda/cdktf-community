// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_resource_list
...
export interface DataOpalGroupResourceListConfig extends cdktf.TerraformMetaArguments {
  ...
  * The ID of the group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_resource_list#group_id DataOpalGroupResourceList#group_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_resource_list opal_group_resource_list}
*/
export class DataOpalGroupResourceList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpalGroupResourceList that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_resource_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_resource_list opal_group_resource_list} Data Source
  *
  * @param scope The scope in which to define this construct
