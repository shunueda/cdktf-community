// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/events
...
export interface DataOpalEventsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/events#actor_filter DataOpalEvents#actor_filter}
  */
  readonly actorFilter?: string;
  /**
  * An API filter for the events. Supply the name and preview of the API token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/events#api_token_filter DataOpalEvents#api_token_filter}
  */
  readonly apiTokenFilter?: string;
  /**
  * The pagination cursor value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/events#cursor DataOpalEvents#cursor}
  */
  readonly cursor?: string;
  /**
  * An end date filter for the events.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/events#end_date_filter DataOpalEvents#end_date_filter}
  */
  readonly endDateFilter?: string;
  /**
  * An event type filter for the events.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/events#event_type_filter DataOpalEvents#event_type_filter}
  */
  readonly eventTypeFilter?: string;
  /**
  * An object filter for the events. Supply the ID of the object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/events#object_filter DataOpalEvents#object_filter}
  */
  readonly objectFilter?: string;
  /**
  * Number of results to return per page. Default is 200.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/events#page_size DataOpalEvents#page_size}
  */
  readonly pageSize?: number;
  /**
  * A start date filter for the events.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/events#start_date_filter DataOpalEvents#start_date_filter}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/events opal_events}
*/
export class DataOpalEvents extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpalEvents that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/events#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/events opal_events} Data Source
  *
  * @param scope The scope in which to define this construct
