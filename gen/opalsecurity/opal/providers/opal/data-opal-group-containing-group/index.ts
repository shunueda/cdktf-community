// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_containing_group
...
export interface DataOpalGroupContainingGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_containing_group#containing_group_id DataOpalGroupContainingGroup#containing_group_id}
  */
  readonly containingGroupId: string;
  /**
  * The ID of the group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_containing_group#group_id DataOpalGroupContainingGroup#group_id}
  */
  readonly groupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_containing_group opal_group_containing_group}
*/
export class DataOpalGroupContainingGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpalGroupContainingGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_containing_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/data-sources/group_containing_group opal_group_containing_group} Data Source
  *
  * @param scope The scope in which to define this construct
