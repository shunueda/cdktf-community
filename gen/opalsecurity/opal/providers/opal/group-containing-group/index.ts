// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_containing_group
...
export interface GroupContainingGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_containing_group#containing_group_id GroupContainingGroup#containing_group_id}
  */
  readonly containingGroupId: string;
  /**
  * The ID of the group. Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_containing_group#group_id GroupContainingGroup#group_id}
  */
  readonly groupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_containing_group opal_group_containing_group}
*/
export class GroupContainingGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GroupContainingGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_containing_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_containing_group opal_group_containing_group} Resource
  *
  * @param scope The scope in which to define this construct
