// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_resource_list
...
export interface GroupResourceListConfig extends cdktf.TerraformMetaArguments {
  ...
  * The ID of the group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_resource_list#group_id GroupResourceList#group_id}
  */
  readonly groupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_resource_list#resources GroupResourceList#resources}
  */
...
export interface GroupResourceListResources {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_resource_list#access_level_remote_id GroupResourceList#access_level_remote_id}
  */
  readonly accessLevelRemoteId?: string;
  /**
  * The ID of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_resource_list#resource_id GroupResourceList#resource_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_resource_list opal_group_resource_list}
*/
export class GroupResourceList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GroupResourceList that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_resource_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/group_resource_list opal_group_resource_list} Resource
  *
  * @param scope The scope in which to define this construct
