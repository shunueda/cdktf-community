// https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/bundle_resource
...
export interface BundleResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/bundle_resource#access_level_name BundleResource#access_level_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/bundle_resource#access_level_remote_id BundleResource#access_level_remote_id}
  */
  readonly accessLevelRemoteId?: string;
  /**
  * The ID of the bundle. Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/bundle_resource#bundle_id BundleResource#bundle_id}
  */
  readonly bundleId: string;
  /**
  * The ID of the resource to add. Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/bundle_resource#resource_id BundleResource#resource_id}
  */
  readonly resourceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/bundle_resource opal_bundle_resource}
*/
export class BundleResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BundleResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/bundle_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.3.2/docs/resources/bundle_resource opal_bundle_resource} Resource
  *
  * @param scope The scope in which to define this construct
