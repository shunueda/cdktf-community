// https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2
...
export interface CatalogV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#annotations CatalogV2#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * CA certificate in base64-encoded DER format which will be used to validate the repo's certificate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#ca_bundle CatalogV2#ca_bundle}
  */
  readonly caBundle?: string;
  /**
  * K8s cluster ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#cluster_id CatalogV2#cluster_id}
  */
  readonly clusterId: string;
  /**
  * If disabled the repo clone will not be updated or allowed to be installed from
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#enabled CatalogV2#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Maximum number of retries before returning error
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#exponential_backoff_max_retries CatalogV2#exponential_backoff_max_retries}
  */
  readonly exponentialBackoffMaxRetries?: number;
  /**
  * Maximum amount of seconds to wait before retrying
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#exponential_backoff_max_wait CatalogV2#exponential_backoff_max_wait}
  */
  readonly exponentialBackoffMaxWait?: number;
  /**
  * Minimum amount of seconds to wait before retrying
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#exponential_backoff_min_wait CatalogV2#exponential_backoff_min_wait}
  */
  readonly exponentialBackoffMinWait?: number;
  /**
  * Git Repository branch containing Helm chart definitions
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#git_branch CatalogV2#git_branch}
  */
  readonly gitBranch?: string;
  /**
  * Git Repository containing Helm chart definitions
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#git_repo CatalogV2#git_repo}
  */
  readonly gitRepo?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#id CatalogV2#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#insecure CatalogV2#insecure}
  */
  readonly insecure?: boolean | cdktf.IResolvable;
  /**
  * Only valid for OCI URL's. Allows insecure connections to registries without enforcing TLS checks
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#insecure_plain_http CatalogV2#insecure_plain_http}
  */
  readonly insecurePlainHttp?: boolean | cdktf.IResolvable;
  /**
  * Labels of the resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#labels CatalogV2#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * K8s Repo name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#name CatalogV2#name}
  */
  readonly name: string;
  /**
  * K8s secret name to be used to connect to the repo
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#secret_name CatalogV2#secret_name}
  */
  readonly secretName?: string;
  /**
  * K8s secret namespace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#secret_namespace CatalogV2#secret_namespace}
  */
  readonly secretNamespace?: string;
  /**
  * K8s service account used to deploy charts instead of the end users credentials
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#service_account CatalogV2#service_account}
  */
  readonly serviceAccount?: string;
  /**
  * K8s namsepace of the service account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#service_account_namespace CatalogV2#service_account_namespace}
  */
  readonly serviceAccountNamespace?: string;
  /**
  * URL to an index generated by Helm
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#url CatalogV2#url}
  */
  readonly url?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#timeouts CatalogV2#timeouts}
  */
  readonly timeouts?: CatalogV2Timeouts;
}
export interface CatalogV2Timeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#create CatalogV2#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#delete CatalogV2#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#update CatalogV2#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2 rancher2_catalog_v2}
*/
export class CatalogV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CatalogV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/catalog_v2 rancher2_catalog_v2} Resource
  *
  * @param scope The scope in which to define this construct
