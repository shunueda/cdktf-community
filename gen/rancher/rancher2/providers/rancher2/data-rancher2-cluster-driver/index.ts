// https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/data-sources/cluster_driver
...
export interface DataRancher2ClusterDriverConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/data-sources/cluster_driver#id DataRancher2ClusterDriver#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/data-sources/cluster_driver#name DataRancher2ClusterDriver#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/data-sources/cluster_driver#url DataRancher2ClusterDriver#url}
  */
  readonly url?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/data-sources/cluster_driver rancher2_cluster_driver}
*/
export class DataRancher2ClusterDriver extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRancher2ClusterDriver that should be imported. Refer to the {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/data-sources/cluster_driver#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/data-sources/cluster_driver rancher2_cluster_driver} Data Source
  *
  * @param scope The scope in which to define this construct
