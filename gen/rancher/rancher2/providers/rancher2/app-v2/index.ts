// https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2
...
export interface AppV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#annotations AppV2#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Chart name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#chart_name AppV2#chart_name}
  */
  readonly chartName: string;
  /**
  * Chart version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#chart_version AppV2#chart_version}
  */
  readonly chartVersion?: string;
  /**
  * Cleanup app V2 on failed chart upgrade
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#cleanup_on_fail AppV2#cleanup_on_fail}
  */
  readonly cleanupOnFail?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#cluster_id AppV2#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Disable app V2 chart hooks
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#disable_hooks AppV2#disable_hooks}
  */
  readonly disableHooks?: boolean | cdktf.IResolvable;
  /**
  * Disable app V2 Open API Validation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#disable_open_api_validation AppV2#disable_open_api_validation}
  */
  readonly disableOpenApiValidation?: boolean | cdktf.IResolvable;
  /**
  * Force app V2 chart upgrade
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#force_upgrade AppV2#force_upgrade}
  */
  readonly forceUpgrade?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#id AppV2#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#labels AppV2#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * App v2 name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#name AppV2#name}
  */
  readonly name: string;
  /**
  * App v2 namespace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#namespace AppV2#namespace}
  */
  readonly namespace: string;
  /**
  * Deploy app within project ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#project_id AppV2#project_id}
  */
  readonly projectId?: string;
  /**
  * Repo name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#repo_name AppV2#repo_name}
  */
  readonly repoName: string;
  /**
  * System default registry providing images for app deployment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#system_default_registry AppV2#system_default_registry}
  */
  readonly systemDefaultRegistry?: string;
  /**
  * App v2 custom values yaml
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#values AppV2#values}
  */
  readonly values?: string;
  /**
  * Wait until app is deployed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#wait AppV2#wait}
  */
  readonly wait?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#timeouts AppV2#timeouts}
  */
  readonly timeouts?: AppV2Timeouts;
}
export interface AppV2Timeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#create AppV2#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#delete AppV2#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#update AppV2#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2 rancher2_app_v2}
*/
export class AppV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/app_v2 rancher2_app_v2} Resource
  *
  * @param scope The scope in which to define this construct
