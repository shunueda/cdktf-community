// https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/auth_config_ping
...
export interface AuthConfigPingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/auth_config_ping#access_mode AuthConfigPing#access_mode}
  */
  readonly accessMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/auth_config_ping#allowed_principal_ids AuthConfigPing#allowed_principal_ids}
  */
  readonly allowedPrincipalIds?: string[];
  /**
  * Annotations of the resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/auth_config_ping#annotations AuthConfigPing#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/auth_config_ping#display_name_field AuthConfigPing#display_name_field}
  */
  readonly displayNameField: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/auth_config_ping#enabled AuthConfigPing#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/auth_config_ping#entity_id_field AuthConfigPing#entity_id_field}
  */
  readonly entityIdField?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/auth_config_ping#groups_field AuthConfigPing#groups_field}
  */
  readonly groupsField: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/auth_config_ping#id AuthConfigPing#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/auth_config_ping#idp_metadata_content AuthConfigPing#idp_metadata_content}
  */
  readonly idpMetadataContent: string;
  /**
  * Labels of the resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/auth_config_ping#labels AuthConfigPing#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/auth_config_ping#rancher_api_host AuthConfigPing#rancher_api_host}
  */
  readonly rancherApiHost: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/auth_config_ping#sp_cert AuthConfigPing#sp_cert}
  */
  readonly spCert: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/auth_config_ping#sp_key AuthConfigPing#sp_key}
  */
  readonly spKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/auth_config_ping#uid_field AuthConfigPing#uid_field}
  */
  readonly uidField: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/auth_config_ping#user_name_field AuthConfigPing#user_name_field}
  */
  readonly userNameField: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/auth_config_ping rancher2_auth_config_ping}
*/
export class AuthConfigPing extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuthConfigPing that should be imported. Refer to the {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/auth_config_ping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/auth_config_ping rancher2_auth_config_ping} Resource
  *
  * @param scope The scope in which to define this construct
