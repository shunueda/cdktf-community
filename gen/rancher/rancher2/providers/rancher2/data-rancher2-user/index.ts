// https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/data-sources/user
...
export interface DataRancher2UserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/data-sources/user#id DataRancher2User#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/data-sources/user#is_external DataRancher2User#is_external}
  */
  readonly isExternal?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/data-sources/user#name DataRancher2User#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/data-sources/user#username DataRancher2User#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/data-sources/user rancher2_user}
*/
export class DataRancher2User extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRancher2User that should be imported. Refer to the {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/data-sources/user rancher2_user} Data Source
  *
  * @param scope The scope in which to define this construct
