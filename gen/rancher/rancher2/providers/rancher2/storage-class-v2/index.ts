// https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/storage_class_v2
...
export interface StorageClassV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/storage_class_v2#allow_volume_expansion StorageClassV2#allow_volume_expansion}
  */
  readonly allowVolumeExpansion?: boolean | cdktf.IResolvable;
  /**
  * Annotations of the resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/storage_class_v2#annotations StorageClassV2#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * K8s cluster ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/storage_class_v2#cluster_id StorageClassV2#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/storage_class_v2#id StorageClassV2#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/storage_class_v2#k8s_provisioner StorageClassV2#k8s_provisioner}
  */
  readonly k8SProvisioner: string;
  /**
  * Labels of the resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/storage_class_v2#labels StorageClassV2#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * StorageClass mount options
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/storage_class_v2#mount_options StorageClassV2#mount_options}
  */
  readonly mountOptions?: string[];
  /**
  * StorageClass name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/storage_class_v2#name StorageClassV2#name}
  */
  readonly name: string;
  /**
  * StorageClass provisioner paramaters
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/storage_class_v2#parameters StorageClassV2#parameters}
  */
  readonly parameters?: { [key: string]: string };
  /**
  * StorageClass provisioner reclaim policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/storage_class_v2#reclaim_policy StorageClassV2#reclaim_policy}
  */
  readonly reclaimPolicy?: string;
  /**
  * StorageClass provisioner volume binding mode
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/storage_class_v2#volume_binding_mode StorageClassV2#volume_binding_mode}
  */
  readonly volumeBindingMode?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/storage_class_v2#timeouts StorageClassV2#timeouts}
  */
  readonly timeouts?: StorageClassV2Timeouts;
}
export interface StorageClassV2Timeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/storage_class_v2#create StorageClassV2#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/storage_class_v2#delete StorageClassV2#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/storage_class_v2#update StorageClassV2#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/storage_class_v2 rancher2_storage_class_v2}
*/
export class StorageClassV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageClassV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/storage_class_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rancher/rancher2/8.2.1/docs/resources/storage_class_v2 rancher2_storage_class_v2} Resource
  *
  * @param scope The scope in which to define this construct
