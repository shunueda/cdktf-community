// https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest
...
export interface DataK8SSubmarinerIoSubmarinerV1Alpha1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#metadata DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#metadata}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#spec DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#spec}
  */
...
export interface DataK8SSubmarinerIoSubmarinerV1Alpha1ManifestMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#annotations DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Keys and values that can be used to organize and categorize objects. See https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#labels DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Unique identifier for this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#name DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#name}
  */
  readonly name: string;
  /**
  * Namespaces provides a mechanism for isolating groups of resources within a single cluster. See https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#namespace DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#namespace}
  */
...
export interface DataK8SSubmarinerIoSubmarinerV1Alpha1ManifestSpecConnectionHealthCheck {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#enabled DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The interval at which health check pings are sent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#interval_seconds DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#interval_seconds}
  */
  readonly intervalSeconds?: number;
  /**
  * The maximum number of packets lost at which the health checker will mark the connection as down.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#max_packet_loss_count DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#max_packet_loss_count}
  */
...
export interface DataK8SSubmarinerIoSubmarinerV1Alpha1ManifestSpecCoreDnsCustomConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#config_map_name DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#config_map_name}
  */
...
export interface DataK8SSubmarinerIoSubmarinerV1Alpha1ManifestSpecTolerations {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#effect DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#effect}
  */
  readonly effect?: string;
  /**
  * Key is the taint key that the toleration applies to. Empty means match all taint keys. If the key is empty, operator must be Exists; this combination means to match all values and all keys.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#key DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#key}
  */
  readonly key?: string;
  /**
  * Operator represents a key's relationship to the value. Valid operators are Exists and Equal. Defaults to Equal. Exists is equivalent to wildcard for value, so that a pod can tolerate all taints of a particular category.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#operator DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#operator}
  */
  readonly operator?: string;
  /**
  * TolerationSeconds represents the period of time the toleration (which must be of effect NoExecute, otherwise this field is ignored) tolerates the taint. By default, it is not set, which means tolerate the taint forever (do not evict). Zero and negative values will be treated as 0 (evict immediately) by the system.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#toleration_seconds DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#toleration_seconds}
  */
  readonly tolerationSeconds?: number;
  /**
  * Value is the taint value the toleration matches to. If the operator is Exists, the value should be empty, otherwise just a regular string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#value DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#value}
  */
...
export interface DataK8SSubmarinerIoSubmarinerV1Alpha1ManifestSpec {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#air_gapped_deployment DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#air_gapped_deployment}
  */
  readonly airGappedDeployment?: boolean | cdktf.IResolvable;
  /**
  * Type of broker (must be 'k8s').
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#broker DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#broker}
  */
  readonly broker: string;
  /**
  * The broker API URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#broker_k8s_api_server DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#broker_k8s_api_server}
  */
  readonly brokerK8SApiServer: string;
  /**
  * The broker API Token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#broker_k8s_api_server_token DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#broker_k8s_api_server_token}
  */
  readonly brokerK8SApiServerToken?: string;
  /**
  * The broker certificate authority.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#broker_k8s_ca DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#broker_k8s_ca}
  */
  readonly brokerK8SCa?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#broker_k8s_insecure DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#broker_k8s_insecure}
  */
  readonly brokerK8SInsecure?: boolean | cdktf.IResolvable;
  /**
  * The Broker namespace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#broker_k8s_remote_namespace DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#broker_k8s_remote_namespace}
  */
  readonly brokerK8SRemoteNamespace: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#broker_k8s_secret DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#broker_k8s_secret}
  */
  readonly brokerK8SSecret?: string;
  /**
  * Cable driver implementation - any of [libreswan, wireguard, vxlan].
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#cable_driver DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#cable_driver}
  */
  readonly cableDriver?: string;
  /**
  * Enable logging IPsec debugging information.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#ce_ip_sec_debug DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#ce_ip_sec_debug}
  */
  readonly ceIpSecDebug: boolean | cdktf.IResolvable;
  /**
  * Force UDP encapsulation for IPsec.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#ce_ip_sec_force_udp_encaps DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#ce_ip_sec_force_udp_encaps}
  */
  readonly ceIpSecForceUdpEncaps?: boolean | cdktf.IResolvable;
  /**
  * The IPsec IKE port (500 usually).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#ce_ip_sec_ike_port DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#ce_ip_sec_ike_port}
  */
  readonly ceIpSecIkePort?: number;
  /**
  * The IPsec NAT traversal port (4500 usually).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#ce_ip_sec_natt_port DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#ce_ip_sec_natt_port}
  */
  readonly ceIpSecNattPort?: number;
  /**
  * Enable this cluster as a preferred server for data-plane connections.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#ce_ip_sec_preferred_server DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#ce_ip_sec_preferred_server}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#ce_ip_sec_psk DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#ce_ip_sec_psk}
  */
  readonly ceIpSecPsk?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#ce_ip_sec_psk_secret DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#ce_ip_sec_psk_secret}
  */
  readonly ceIpSecPskSecret?: string;
  /**
  * The cluster CIDR.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#cluster_cidr DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#cluster_cidr}
  */
  readonly clusterCidr: string;
  /**
  * The cluster ID used to identify the tunnels.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#cluster_id DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#cluster_id}
  */
  readonly clusterId: string;
  /**
  * ClustersetIP CIDR for allocating ClustersetIPs to exported services.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#clusterset_ip_cidr DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#clusterset_ip_cidr}
  */
  readonly clustersetIpCidr?: string;
  /**
  * Enable ClustersetIP default for services exported on this cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#clusterset_ip_enabled DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#clusterset_ip_enabled}
  */
  readonly clustersetIpEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#color_codes DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#color_codes}
  */
  readonly colorCodes?: string;
  /**
  * The gateway connection health check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#connection_health_check DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#connection_health_check}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#core_dns_custom_config DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#core_dns_custom_config}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#custom_domains DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#custom_domains}
  */
  readonly customDomains?: string[];
  /**
  * Enable operator debugging.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#debug DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#debug}
  */
  readonly debug: boolean | cdktf.IResolvable;
  /**
  * The Global CIDR super-net range for allocating GlobalCIDRs to each cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#global_cidr DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#global_cidr}
  */
  readonly globalCidr?: string;
  /**
  * Halt on certificate error (so the pod gets restarted).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#halt_on_certificate_error DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#halt_on_certificate_error}
  */
  readonly haltOnCertificateError?: boolean | cdktf.IResolvable;
  /**
  * Override component images.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#image_overrides DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#image_overrides}
  */
  readonly imageOverrides?: { [key: string]: string };
  /**
  * Enable automatic Load Balancer in front of the gateways.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#load_balancer_enabled DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#load_balancer_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#nat_enabled DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#nat_enabled}
  */
  readonly natEnabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#node_selector DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#node_selector}
  */
  readonly nodeSelector?: { [key: string]: string };
  /**
  * The image repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#repository DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#repository}
  */
  readonly repository?: string;
  /**
  * The service CIDR.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#service_cidr DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#service_cidr}
  */
  readonly serviceCidr: string;
  /**
  * Enable support for Service Discovery (Lighthouse).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#service_discovery_enabled DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#service_discovery_enabled}
  */
  readonly serviceDiscoveryEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#tolerations DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#tolerations}
  */
  readonly tolerations?: DataK8SSubmarinerIoSubmarinerV1Alpha1ManifestSpecTolerations[] | cdktf.IResolvable;
  /**
  * The image tag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#version DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest#version}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest k8s_submariner_io_submariner_v1alpha1_manifest}
*/
export class DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SSubmarinerIoSubmarinerV1Alpha1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/submariner_io_submariner_v1alpha1_manifest k8s_submariner_io_submariner_v1alpha1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
