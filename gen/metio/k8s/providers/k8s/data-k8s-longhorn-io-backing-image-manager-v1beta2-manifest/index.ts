// https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/longhorn_io_backing_image_manager_v1beta2_manifest
...
export interface DataK8SLonghornIoBackingImageManagerV1Beta2ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/longhorn_io_backing_image_manager_v1beta2_manifest#metadata DataK8SLonghornIoBackingImageManagerV1Beta2Manifest#metadata}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/longhorn_io_backing_image_manager_v1beta2_manifest#spec DataK8SLonghornIoBackingImageManagerV1Beta2Manifest#spec}
  */
...
export interface DataK8SLonghornIoBackingImageManagerV1Beta2ManifestMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/longhorn_io_backing_image_manager_v1beta2_manifest#annotations DataK8SLonghornIoBackingImageManagerV1Beta2Manifest#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Keys and values that can be used to organize and categorize objects. See https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/longhorn_io_backing_image_manager_v1beta2_manifest#labels DataK8SLonghornIoBackingImageManagerV1Beta2Manifest#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Unique identifier for this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/longhorn_io_backing_image_manager_v1beta2_manifest#name DataK8SLonghornIoBackingImageManagerV1Beta2Manifest#name}
  */
  readonly name: string;
  /**
  * Namespaces provides a mechanism for isolating groups of resources within a single cluster. See https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/longhorn_io_backing_image_manager_v1beta2_manifest#namespace DataK8SLonghornIoBackingImageManagerV1Beta2Manifest#namespace}
  */
...
export interface DataK8SLonghornIoBackingImageManagerV1Beta2ManifestSpec {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/longhorn_io_backing_image_manager_v1beta2_manifest#backing_images DataK8SLonghornIoBackingImageManagerV1Beta2Manifest#backing_images}
  */
  readonly backingImages?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/longhorn_io_backing_image_manager_v1beta2_manifest#disk_path DataK8SLonghornIoBackingImageManagerV1Beta2Manifest#disk_path}
  */
  readonly diskPath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/longhorn_io_backing_image_manager_v1beta2_manifest#disk_uuid DataK8SLonghornIoBackingImageManagerV1Beta2Manifest#disk_uuid}
  */
  readonly diskUuid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/longhorn_io_backing_image_manager_v1beta2_manifest#image DataK8SLonghornIoBackingImageManagerV1Beta2Manifest#image}
  */
  readonly image?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/longhorn_io_backing_image_manager_v1beta2_manifest#node_id DataK8SLonghornIoBackingImageManagerV1Beta2Manifest#node_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/longhorn_io_backing_image_manager_v1beta2_manifest k8s_longhorn_io_backing_image_manager_v1beta2_manifest}
*/
export class DataK8SLonghornIoBackingImageManagerV1Beta2Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SLonghornIoBackingImageManagerV1Beta2Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/longhorn_io_backing_image_manager_v1beta2_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/longhorn_io_backing_image_manager_v1beta2_manifest k8s_longhorn_io_backing_image_manager_v1beta2_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
