// https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_blob_container_v1alpha2_manifest
...
export interface DataK8SAzureMicrosoftComBlobContainerV1Alpha2ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_blob_container_v1alpha2_manifest#metadata DataK8SAzureMicrosoftComBlobContainerV1Alpha2Manifest#metadata}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_blob_container_v1alpha2_manifest#spec DataK8SAzureMicrosoftComBlobContainerV1Alpha2Manifest#spec}
  */
...
export interface DataK8SAzureMicrosoftComBlobContainerV1Alpha2ManifestMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_blob_container_v1alpha2_manifest#annotations DataK8SAzureMicrosoftComBlobContainerV1Alpha2Manifest#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Keys and values that can be used to organize and categorize objects. See https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_blob_container_v1alpha2_manifest#labels DataK8SAzureMicrosoftComBlobContainerV1Alpha2Manifest#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Unique identifier for this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_blob_container_v1alpha2_manifest#name DataK8SAzureMicrosoftComBlobContainerV1Alpha2Manifest#name}
  */
  readonly name: string;
  /**
  * Namespaces provides a mechanism for isolating groups of resources within a single cluster. See https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_blob_container_v1alpha2_manifest#namespace DataK8SAzureMicrosoftComBlobContainerV1Alpha2Manifest#namespace}
  */
...
export interface DataK8SAzureMicrosoftComBlobContainerV1Alpha2ManifestSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_blob_container_v1alpha2_manifest#access_level DataK8SAzureMicrosoftComBlobContainerV1Alpha2Manifest#access_level}
  */
  readonly accessLevel?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_blob_container_v1alpha2_manifest#account_name DataK8SAzureMicrosoftComBlobContainerV1Alpha2Manifest#account_name}
  */
  readonly accountName?: string;
  /**
  * INSERT ADDITIONAL SPEC FIELDS - desired state of cluster Important: Run 'make' to regenerate code after modifying this file
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_blob_container_v1alpha2_manifest#location DataK8SAzureMicrosoftComBlobContainerV1Alpha2Manifest#location}
  */
  readonly location: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_blob_container_v1alpha2_manifest#resource_group DataK8SAzureMicrosoftComBlobContainerV1Alpha2Manifest#resource_group}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_blob_container_v1alpha2_manifest k8s_azure_microsoft_com_blob_container_v1alpha2_manifest}
*/
export class DataK8SAzureMicrosoftComBlobContainerV1Alpha2Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SAzureMicrosoftComBlobContainerV1Alpha2Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_blob_container_v1alpha2_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_blob_container_v1alpha2_manifest k8s_azure_microsoft_com_blob_container_v1alpha2_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
