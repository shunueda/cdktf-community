// https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/notification_toolkit_fluxcd_io_provider_v1beta1_manifest
...
export interface DataK8SNotificationToolkitFluxcdIoProviderV1Beta1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/notification_toolkit_fluxcd_io_provider_v1beta1_manifest#metadata DataK8SNotificationToolkitFluxcdIoProviderV1Beta1Manifest#metadata}
  */
  readonly metadata: DataK8SNotificationToolkitFluxcdIoProviderV1Beta1ManifestMetadata;
  /**
  * ProviderSpec defines the desired state of Provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/notification_toolkit_fluxcd_io_provider_v1beta1_manifest#spec DataK8SNotificationToolkitFluxcdIoProviderV1Beta1Manifest#spec}
  */
...
export interface DataK8SNotificationToolkitFluxcdIoProviderV1Beta1ManifestMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/notification_toolkit_fluxcd_io_provider_v1beta1_manifest#annotations DataK8SNotificationToolkitFluxcdIoProviderV1Beta1Manifest#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Keys and values that can be used to organize and categorize objects. See https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/notification_toolkit_fluxcd_io_provider_v1beta1_manifest#labels DataK8SNotificationToolkitFluxcdIoProviderV1Beta1Manifest#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Unique identifier for this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/notification_toolkit_fluxcd_io_provider_v1beta1_manifest#name DataK8SNotificationToolkitFluxcdIoProviderV1Beta1Manifest#name}
  */
  readonly name: string;
  /**
  * Namespaces provides a mechanism for isolating groups of resources within a single cluster. See https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/notification_toolkit_fluxcd_io_provider_v1beta1_manifest#namespace DataK8SNotificationToolkitFluxcdIoProviderV1Beta1Manifest#namespace}
  */
...
export interface DataK8SNotificationToolkitFluxcdIoProviderV1Beta1ManifestSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/notification_toolkit_fluxcd_io_provider_v1beta1_manifest#address DataK8SNotificationToolkitFluxcdIoProviderV1Beta1Manifest#address}
  */
  readonly address?: string;
  /**
  * CertSecretRef can be given the name of a secret containing a PEM-encoded CA certificate ('caFile')
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/notification_toolkit_fluxcd_io_provider_v1beta1_manifest#cert_secret_ref DataK8SNotificationToolkitFluxcdIoProviderV1Beta1Manifest#cert_secret_ref}
  */
  readonly certSecretRef?: DataK8SNotificationToolkitFluxcdIoProviderV1Beta1ManifestSpecCertSecretRef;
  /**
  * Alert channel for this provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/notification_toolkit_fluxcd_io_provider_v1beta1_manifest#channel DataK8SNotificationToolkitFluxcdIoProviderV1Beta1Manifest#channel}
  */
  readonly channel?: string;
  /**
  * HTTP/S address of the proxy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/notification_toolkit_fluxcd_io_provider_v1beta1_manifest#proxy DataK8SNotificationToolkitFluxcdIoProviderV1Beta1Manifest#proxy}
  */
  readonly proxy?: string;
  /**
  * Secret reference containing the provider webhook URL using 'address' as data key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/notification_toolkit_fluxcd_io_provider_v1beta1_manifest#secret_ref DataK8SNotificationToolkitFluxcdIoProviderV1Beta1Manifest#secret_ref}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/notification_toolkit_fluxcd_io_provider_v1beta1_manifest#suspend DataK8SNotificationToolkitFluxcdIoProviderV1Beta1Manifest#suspend}
  */
  readonly suspend?: boolean | cdktf.IResolvable;
  /**
  * Timeout for sending alerts to the provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/notification_toolkit_fluxcd_io_provider_v1beta1_manifest#timeout DataK8SNotificationToolkitFluxcdIoProviderV1Beta1Manifest#timeout}
  */
  readonly timeout?: string;
  /**
  * Type of provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/notification_toolkit_fluxcd_io_provider_v1beta1_manifest#type DataK8SNotificationToolkitFluxcdIoProviderV1Beta1Manifest#type}
  */
  readonly type: string;
  /**
  * Bot username for this provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/notification_toolkit_fluxcd_io_provider_v1beta1_manifest#username DataK8SNotificationToolkitFluxcdIoProviderV1Beta1Manifest#username}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/notification_toolkit_fluxcd_io_provider_v1beta1_manifest k8s_notification_toolkit_fluxcd_io_provider_v1beta1_manifest}
*/
export class DataK8SNotificationToolkitFluxcdIoProviderV1Beta1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SNotificationToolkitFluxcdIoProviderV1Beta1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/notification_toolkit_fluxcd_io_provider_v1beta1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/notification_toolkit_fluxcd_io_provider_v1beta1_manifest k8s_notification_toolkit_fluxcd_io_provider_v1beta1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
