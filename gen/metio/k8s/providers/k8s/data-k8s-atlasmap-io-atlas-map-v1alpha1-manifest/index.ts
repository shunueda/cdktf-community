// https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/atlasmap_io_atlas_map_v1alpha1_manifest
...
export interface DataK8SAtlasmapIoAtlasMapV1Alpha1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/atlasmap_io_atlas_map_v1alpha1_manifest#metadata DataK8SAtlasmapIoAtlasMapV1Alpha1Manifest#metadata}
  */
  readonly metadata: DataK8SAtlasmapIoAtlasMapV1Alpha1ManifestMetadata;
  /**
  * AtlasMapSpec defines the desired state of AtlasMap
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/atlasmap_io_atlas_map_v1alpha1_manifest#spec DataK8SAtlasmapIoAtlasMapV1Alpha1Manifest#spec}
  */
...
export interface DataK8SAtlasmapIoAtlasMapV1Alpha1ManifestMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/atlasmap_io_atlas_map_v1alpha1_manifest#annotations DataK8SAtlasmapIoAtlasMapV1Alpha1Manifest#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Keys and values that can be used to organize and categorize objects. See https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/atlasmap_io_atlas_map_v1alpha1_manifest#labels DataK8SAtlasmapIoAtlasMapV1Alpha1Manifest#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Unique identifier for this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/atlasmap_io_atlas_map_v1alpha1_manifest#name DataK8SAtlasmapIoAtlasMapV1Alpha1Manifest#name}
  */
  readonly name: string;
  /**
  * Namespaces provides a mechanism for isolating groups of resources within a single cluster. See https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/atlasmap_io_atlas_map_v1alpha1_manifest#namespace DataK8SAtlasmapIoAtlasMapV1Alpha1Manifest#namespace}
  */
...
export interface DataK8SAtlasmapIoAtlasMapV1Alpha1ManifestSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/atlasmap_io_atlas_map_v1alpha1_manifest#limit_cpu DataK8SAtlasmapIoAtlasMapV1Alpha1Manifest#limit_cpu}
  */
  readonly limitCpu?: string;
  /**
  * The amount of memory to request
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/atlasmap_io_atlas_map_v1alpha1_manifest#limit_memory DataK8SAtlasmapIoAtlasMapV1Alpha1Manifest#limit_memory}
  */
  readonly limitMemory?: string;
  /**
  * Replicas determines the desired number of running AtlasMap pods
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/atlasmap_io_atlas_map_v1alpha1_manifest#replicas DataK8SAtlasmapIoAtlasMapV1Alpha1Manifest#replicas}
  */
  readonly replicas?: number;
  /**
  * The amount of CPU to request
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/atlasmap_io_atlas_map_v1alpha1_manifest#request_cpu DataK8SAtlasmapIoAtlasMapV1Alpha1Manifest#request_cpu}
  */
  readonly requestCpu?: string;
  /**
  * The amount of memory to request
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/atlasmap_io_atlas_map_v1alpha1_manifest#request_memory DataK8SAtlasmapIoAtlasMapV1Alpha1Manifest#request_memory}
  */
  readonly requestMemory?: string;
  /**
  * RouteHostName sets the host name to use on the Ingress or OpenShift Route
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/atlasmap_io_atlas_map_v1alpha1_manifest#route_host_name DataK8SAtlasmapIoAtlasMapV1Alpha1Manifest#route_host_name}
  */
  readonly routeHostName?: string;
  /**
  * Version sets the version of the container image used for AtlasMap
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/atlasmap_io_atlas_map_v1alpha1_manifest#version DataK8SAtlasmapIoAtlasMapV1Alpha1Manifest#version}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/atlasmap_io_atlas_map_v1alpha1_manifest k8s_atlasmap_io_atlas_map_v1alpha1_manifest}
*/
export class DataK8SAtlasmapIoAtlasMapV1Alpha1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SAtlasmapIoAtlasMapV1Alpha1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/atlasmap_io_atlas_map_v1alpha1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/atlasmap_io_atlas_map_v1alpha1_manifest k8s_atlasmap_io_atlas_map_v1alpha1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
