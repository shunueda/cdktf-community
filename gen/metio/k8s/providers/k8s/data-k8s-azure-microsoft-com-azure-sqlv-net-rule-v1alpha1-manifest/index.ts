// https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest
...
export interface DataK8SAzureMicrosoftComAzureSqlvNetRuleV1Alpha1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest#metadata DataK8SAzureMicrosoftComAzureSqlvNetRuleV1Alpha1Manifest#metadata}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest#spec DataK8SAzureMicrosoftComAzureSqlvNetRuleV1Alpha1Manifest#spec}
  */
...
export interface DataK8SAzureMicrosoftComAzureSqlvNetRuleV1Alpha1ManifestMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest#annotations DataK8SAzureMicrosoftComAzureSqlvNetRuleV1Alpha1Manifest#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Keys and values that can be used to organize and categorize objects. See https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest#labels DataK8SAzureMicrosoftComAzureSqlvNetRuleV1Alpha1Manifest#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Unique identifier for this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest#name DataK8SAzureMicrosoftComAzureSqlvNetRuleV1Alpha1Manifest#name}
  */
  readonly name: string;
  /**
  * Namespaces provides a mechanism for isolating groups of resources within a single cluster. See https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest#namespace DataK8SAzureMicrosoftComAzureSqlvNetRuleV1Alpha1Manifest#namespace}
  */
...
export interface DataK8SAzureMicrosoftComAzureSqlvNetRuleV1Alpha1ManifestSpec {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest#ignore_missing_service_endpoint DataK8SAzureMicrosoftComAzureSqlvNetRuleV1Alpha1Manifest#ignore_missing_service_endpoint}
  */
  readonly ignoreMissingServiceEndpoint?: boolean | cdktf.IResolvable;
  /**
  * INSERT ADDITIONAL SPEC FIELDS - desired state of cluster Important: Run 'make' to regenerate code after modifying this file
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest#resource_group DataK8SAzureMicrosoftComAzureSqlvNetRuleV1Alpha1Manifest#resource_group}
  */
  readonly resourceGroup: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest#server DataK8SAzureMicrosoftComAzureSqlvNetRuleV1Alpha1Manifest#server}
  */
  readonly server: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest#server_subscription_id DataK8SAzureMicrosoftComAzureSqlvNetRuleV1Alpha1Manifest#server_subscription_id}
  */
  readonly serverSubscriptionId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest#subnet_name DataK8SAzureMicrosoftComAzureSqlvNetRuleV1Alpha1Manifest#subnet_name}
  */
  readonly subnetName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest#v_net_name DataK8SAzureMicrosoftComAzureSqlvNetRuleV1Alpha1Manifest#v_net_name}
  */
  readonly vNetName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest#v_net_resource_group DataK8SAzureMicrosoftComAzureSqlvNetRuleV1Alpha1Manifest#v_net_resource_group}
  */
  readonly vNetResourceGroup: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest#v_net_subscription_id DataK8SAzureMicrosoftComAzureSqlvNetRuleV1Alpha1Manifest#v_net_subscription_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest k8s_azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest}
*/
export class DataK8SAzureMicrosoftComAzureSqlvNetRuleV1Alpha1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SAzureMicrosoftComAzureSqlvNetRuleV1Alpha1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest k8s_azure_microsoft_com_azure_sqlv_net_rule_v1alpha1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
