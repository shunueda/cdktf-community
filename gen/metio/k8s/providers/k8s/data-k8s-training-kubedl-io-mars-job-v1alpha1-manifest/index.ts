...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/training_kubedl_io_mars_job_v1alpha1_manifest k8s_training_kubedl_io_mars_job_v1alpha1_manifest}
*/
export class DataK8STrainingKubedlIoMarsJobV1Alpha1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8STrainingKubedlIoMarsJobV1Alpha1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/training_kubedl_io_mars_job_v1alpha1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/training_kubedl_io_mars_job_v1alpha1_manifest k8s_training_kubedl_io_mars_job_v1alpha1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
