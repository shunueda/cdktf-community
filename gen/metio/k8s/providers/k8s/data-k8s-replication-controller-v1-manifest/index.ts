...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/replication_controller_v1_manifest k8s_replication_controller_v1_manifest}
*/
export class DataK8SReplicationControllerV1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SReplicationControllerV1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/replication_controller_v1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/replication_controller_v1_manifest k8s_replication_controller_v1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
