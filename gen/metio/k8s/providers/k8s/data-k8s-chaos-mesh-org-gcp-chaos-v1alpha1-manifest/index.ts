// https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/chaos_mesh_org_gcp_chaos_v1alpha1_manifest
...
export interface DataK8SChaosMeshOrgGcpChaosV1Alpha1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/chaos_mesh_org_gcp_chaos_v1alpha1_manifest#metadata DataK8SChaosMeshOrgGcpChaosV1Alpha1Manifest#metadata}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/chaos_mesh_org_gcp_chaos_v1alpha1_manifest#spec DataK8SChaosMeshOrgGcpChaosV1Alpha1Manifest#spec}
  */
...
export interface DataK8SChaosMeshOrgGcpChaosV1Alpha1ManifestMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/chaos_mesh_org_gcp_chaos_v1alpha1_manifest#annotations DataK8SChaosMeshOrgGcpChaosV1Alpha1Manifest#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Keys and values that can be used to organize and categorize objects. See https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/chaos_mesh_org_gcp_chaos_v1alpha1_manifest#labels DataK8SChaosMeshOrgGcpChaosV1Alpha1Manifest#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Unique identifier for this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/chaos_mesh_org_gcp_chaos_v1alpha1_manifest#name DataK8SChaosMeshOrgGcpChaosV1Alpha1Manifest#name}
  */
  readonly name: string;
  /**
  * Namespaces provides a mechanism for isolating groups of resources within a single cluster. See https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/chaos_mesh_org_gcp_chaos_v1alpha1_manifest#namespace DataK8SChaosMeshOrgGcpChaosV1Alpha1Manifest#namespace}
  */
...
export interface DataK8SChaosMeshOrgGcpChaosV1Alpha1ManifestSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/chaos_mesh_org_gcp_chaos_v1alpha1_manifest#action DataK8SChaosMeshOrgGcpChaosV1Alpha1Manifest#action}
  */
  readonly action: string;
  /**
  * The device name of disks to detach. Needed in disk-loss.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/chaos_mesh_org_gcp_chaos_v1alpha1_manifest#device_names DataK8SChaosMeshOrgGcpChaosV1Alpha1Manifest#device_names}
  */
  readonly deviceNames?: string[];
  /**
  * Duration represents the duration of the chaos action.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/chaos_mesh_org_gcp_chaos_v1alpha1_manifest#duration DataK8SChaosMeshOrgGcpChaosV1Alpha1Manifest#duration}
  */
  readonly duration?: string;
  /**
  * Instance defines the name of the instance
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/chaos_mesh_org_gcp_chaos_v1alpha1_manifest#instance DataK8SChaosMeshOrgGcpChaosV1Alpha1Manifest#instance}
  */
  readonly instance: string;
  /**
  * Project defines the ID of gcp project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/chaos_mesh_org_gcp_chaos_v1alpha1_manifest#project DataK8SChaosMeshOrgGcpChaosV1Alpha1Manifest#project}
  */
  readonly project: string;
  /**
  * RemoteCluster represents the remote cluster where the chaos will be deployed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/chaos_mesh_org_gcp_chaos_v1alpha1_manifest#remote_cluster DataK8SChaosMeshOrgGcpChaosV1Alpha1Manifest#remote_cluster}
  */
  readonly remoteCluster?: string;
  /**
  * SecretName defines the name of kubernetes secret. It is used for GCP credentials.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/chaos_mesh_org_gcp_chaos_v1alpha1_manifest#secret_name DataK8SChaosMeshOrgGcpChaosV1Alpha1Manifest#secret_name}
  */
  readonly secretName?: string;
  /**
  * Zone defines the zone of gcp project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/chaos_mesh_org_gcp_chaos_v1alpha1_manifest#zone DataK8SChaosMeshOrgGcpChaosV1Alpha1Manifest#zone}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/chaos_mesh_org_gcp_chaos_v1alpha1_manifest k8s_chaos_mesh_org_gcp_chaos_v1alpha1_manifest}
*/
export class DataK8SChaosMeshOrgGcpChaosV1Alpha1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SChaosMeshOrgGcpChaosV1Alpha1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/chaos_mesh_org_gcp_chaos_v1alpha1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/chaos_mesh_org_gcp_chaos_v1alpha1_manifest k8s_chaos_mesh_org_gcp_chaos_v1alpha1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
