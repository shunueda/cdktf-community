// https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest
...
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestConfig extends cdktf.TerraformMetaArguments {
  /**
  * Data that helps uniquely identify this object. See https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#metadata for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#metadata DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#metadata}
  */
  readonly metadata: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestMetadata;
  /**
  * Specification of desired Filter configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#spec DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#spec}
  */
  readonly spec?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpec;
}
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestMetadata {
  /**
  * Keys and values that can be used by external tooling to store and retrieve arbitrary metadata about this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#annotations DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Keys and values that can be used to organize and categorize objects. See https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#labels DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Unique identifier for this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#name DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#name}
  */
  readonly name: string;
}

export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestMetadataToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestMetadata | cdktf.IResolvable): any {
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestMetadataToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestMetadata | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestMetadataOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestMetadata | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestMetadata | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersAws {
  /**
  * The account ID for current EC2 instance.Default is false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#account_id DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#account_id}
  */
  readonly accountId?: boolean | cdktf.IResolvable;
  /**
  * Alias for the plugin
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#alias DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#alias}
  */
  readonly alias?: string;
  /**
  * The EC2 instance image id.Default is false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#ami_id DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#ami_id}
  */
  readonly amiId?: boolean | cdktf.IResolvable;
  /**
  * The availability zone; for example, 'us-east-1a'. Default is true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#az DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#az}
  */
  readonly az?: boolean | cdktf.IResolvable;
  /**
  * The EC2 instance ID.Default is true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#ec2_instance_id DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#ec2_instance_id}
  */
  readonly ec2InstanceId?: boolean | cdktf.IResolvable;
  /**
  * The EC2 instance type.Default is false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#ec2_instance_type DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#ec2_instance_type}
  */
  readonly ec2InstanceType?: boolean | cdktf.IResolvable;
  /**
  * The hostname for current EC2 instance.Default is false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#host_name DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#host_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#imds_version DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#imds_version}
  */
  readonly imdsVersion?: string;
  /**
  * The EC2 instance private ip.Default is false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#private_ip DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#private_ip}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#retry_limit DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#retry_limit}
  */
  readonly retryLimit?: string;
  /**
  * The VPC ID for current EC2 instance.Default is false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#vpc_id DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#vpc_id}
  */
  readonly vpcId?: boolean | cdktf.IResolvable;
}

export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersAwsToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersAws | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersAwsToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersAws | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersAwsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersAws | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersAws | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersCustomPlugin {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#config DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#config}
  */
  readonly config?: string;
  /**
  * YamlConfig holds the unsupported plugins yaml configurations, it only works when the ConfigFileFormat is yaml
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#yaml_config DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#yaml_config}
  */
  readonly yamlConfig?: { [key: string]: string };
}

export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersCustomPluginToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersCustomPlugin | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersCustomPluginToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersCustomPlugin | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersCustomPluginOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersCustomPlugin | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersCustomPlugin | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersGrep {
  /**
  * Alias for the plugin
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#alias DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#alias}
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#exclude DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#exclude}
  */
  readonly exclude?: string;
  /**
  * Keep records which field matches the regular expression. Value Format: FIELD REGEX
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#regex DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#regex}
  */
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersGrepToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersGrep | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersGrepToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersGrep | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersGrepOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersGrep | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersGrep | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._alias = undefined;
...
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersKubernetes {
  /**
  * Alias for the plugin
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#alias DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#alias}
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#buffer_size DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#buffer_size}
  */
  readonly bufferSize?: string;
  /**
  * When enabled, metadata will be fetched from K8s when docker_id is changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#cache_use_docker_id DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#cache_use_docker_id}
  */
  readonly cacheUseDockerId?: boolean | cdktf.IResolvable;
  /**
  * DNS lookup retries N times until the network start working
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#dns_retries DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#dns_retries}
  */
  readonly dnsRetries?: number;
  /**
  * DNS lookup interval between network status checks
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#dns_wait_time DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#dns_wait_time}
  */
  readonly dnsWaitTime?: number;
  /**
  * If set, use dummy-meta data (for test/dev purposes)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#dummy_meta DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#dummy_meta}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#k8s_logging_exclude DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#k8s_logging_exclude}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#k8s_logging_parser DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#k8s_logging_parser}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#keep_log DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#keep_log}
  */
  readonly keepLog?: boolean | cdktf.IResolvable;
  /**
  * CA certificate file
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#kube_ca_file DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#kube_ca_file}
  */
  readonly kubeCaFile?: string;
  /**
  * Absolute path to scan for certificate files
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#kube_ca_path DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#kube_ca_path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#kube_meta_cache_ttl DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#kube_meta_cache_ttl}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#kube_meta_namespace_cache_ttl DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#kube_meta_namespace_cache_ttl}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#kube_meta_preload_cache_dir DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#kube_meta_preload_cache_dir}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#kube_tag_prefix DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#kube_tag_prefix}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#kube_token_command DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#kube_token_command}
  */
  readonly kubeTokenCommand?: string;
  /**
  * Token file
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#kube_token_file DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#kube_token_file}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#kube_token_ttl DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#kube_token_ttl}
  */
  readonly kubeTokenTtl?: string;
  /**
  * API Server end-point
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#kube_url DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#kube_url}
  */
  readonly kubeUrl?: string;
  /**
  * kubelet host using for HTTP request, this only works when Use_Kubelet set to On.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#kubelet_host DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#kubelet_host}
  */
  readonly kubeletHost?: string;
  /**
  * kubelet port using for HTTP request, this only works when useKubelet is set to On.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#kubelet_port DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#kubelet_port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#merge_log DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#merge_log}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#merge_log_key DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#merge_log_key}
  */
  readonly mergeLogKey?: string;
  /**
  * When Merge_Log is enabled, trim (remove possible n or r) field values.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#merge_log_trim DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#merge_log_trim}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#merge_parser DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#merge_parser}
  */
  readonly mergeParser?: string;
  /**
  * Include Kubernetes namespace resource annotations in the extra metadata.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#namespace_annotations DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#namespace_annotations}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#namespace_labels DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#namespace_labels}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#namespace_metadata_only DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#namespace_metadata_only}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#regex_parser DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#regex_parser}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#tls_debug DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#tls_debug}
  */
  readonly tlsDebug?: number;
  /**
  * When enabled, turns on certificate validation when connecting to the Kubernetes API server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#tls_verify DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#tls_verify}
  */
  readonly tlsVerify?: boolean | cdktf.IResolvable;
  /**
  * When enabled, the filter reads logs coming in Journald format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#use_journal DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#use_journal}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#use_kubelet DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#use_kubelet}
  */
  readonly useKubelet?: boolean | cdktf.IResolvable;
}

export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersKubernetesToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersKubernetes | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersKubernetesToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersKubernetes | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersKubernetesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersKubernetes | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersKubernetes | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._alias = undefined;
...
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLogToMetrics {
  /**
  * Add a custom label NAME and set the value to the value of KEY
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#add_label DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#add_label}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#bucket DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#bucket}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#discard_logs DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#discard_logs}
  */
  readonly discardLogs?: boolean | cdktf.IResolvable;
  /**
  * set a buffer limit to restrict memory usage of metrics emitter
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#emitter_mem_buf_limit DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#emitter_mem_buf_limit}
  */
  readonly emitterMemBufLimit?: string;
  /**
  * Name of the emitter (advanced users)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#emitter_name DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#emitter_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#kubernetes_mode DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#kubernetes_mode}
  */
  readonly kubernetesMode?: boolean | cdktf.IResolvable;
  /**
  * Includes a record field as label dimension in the metric.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#label_field DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#label_field}
  */
  readonly labelField?: string[];
  /**
  * Sets a help text for the metric.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#metric_description DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#metric_description}
  */
  readonly metricDescription?: string;
  /**
  * Defines the mode for the metric. Valid values are [counter, gauge or histogram]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#metric_mode DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#metric_mode}
  */
  readonly metricMode?: string;
  /**
  * Sets the name of the metric.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#metric_name DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#metric_name}
  */
  readonly metricName?: string;
  /**
  * Namespace of the metric
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#metric_namespace DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#metric_namespace}
  */
  readonly metricNamespace?: string;
  /**
  * Sets a sub-system for the metric.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#metric_subsystem DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#metric_subsystem}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#tag DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#tag}
  */
  readonly tag?: string;
  /**
  * Specify the record field that holds a numerical value
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#value_field DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#value_field}
  */
  readonly valueField?: string;
}

export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLogToMetricsToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLogToMetrics | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLogToMetricsToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLogToMetrics | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLogToMetricsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLogToMetrics | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLogToMetrics | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaScript {
  /**
  * The key to select.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#key DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#key}
  */
  readonly key: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#optional DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#optional}
  */
  readonly optional?: boolean | cdktf.IResolvable;
}

export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaScriptToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaScript | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaScriptToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaScript | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaScriptOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaScript | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaScript | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._key = undefined;
...
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLua {
  /**
  * Alias for the plugin
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#alias DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#alias}
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#call DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#call}
  */
  readonly call: string;
  /**
  * Inline LUA code instead of loading from a path via script.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#code DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#code}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#protected_mode DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#protected_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#script DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#script}
  */
  readonly script?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaScript;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#time_as_table DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#time_as_table}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#type_array_key DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#type_array_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#type_int_key DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#type_int_key}
  */
  readonly typeIntKey?: string[];
}

export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLua | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    retry_limit: cdktf.stringToTerraform(struct!.retryLimit),
    script: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaScriptToTerraform(struct!.script),
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLua | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    script: {
      value: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaScriptToHclTerraform(struct!.script),
      isBlock: true,
      type: "struct",
      storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaScript",
    },
    time_as_table: {
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLua | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLua | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._alias = undefined;
  ...
  private _script = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaScriptOutputReference(this, "script");
  public get script() {
    return this._script;
  }
  public putScript(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaScript) {
...
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyConditions {
  /**
  * Is true if a key matches regex KEY
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#a_key_matches DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#a_key_matches}
  */
  readonly aKeyMatches?: string;
  /**
  * Is true if KEY does not exist
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#key_does_not_exist DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#key_does_not_exist}
  */
  readonly keyDoesNotExist?: { [key: string]: string };
  /**
  * Is true if KEY exists
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#key_exists DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#key_exists}
  */
  readonly keyExists?: string;
  /**
  * Is true if KEY exists and its value is not VALUE
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#key_value_does_not_equal DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#key_value_does_not_equal}
  */
  readonly keyValueDoesNotEqual?: { [key: string]: string };
  /**
  * Is true if key KEY exists and its value does not match VALUE
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#key_value_does_not_match DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#key_value_does_not_match}
  */
  readonly keyValueDoesNotMatch?: { [key: string]: string };
  /**
  * Is true if KEY exists and its value is VALUE
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#key_value_equals DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#key_value_equals}
  */
  readonly keyValueEquals?: { [key: string]: string };
  /**
  * Is true if key KEY exists and its value matches VALUE
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#key_value_matches DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#key_value_matches}
  */
  readonly keyValueMatches?: { [key: string]: string };
  /**
  * Is true if all keys matching KEY have values that do not match VALUE
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#matching_keys_do_not_have_matching_values DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#matching_keys_do_not_have_matching_values}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#matching_keys_have_matching_values DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#matching_keys_have_matching_values}
  */
  readonly matchingKeysHaveMatchingValues?: { [key: string]: string };
  /**
  * Is true if no key matches regex KEY
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#no_key_matches DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#no_key_matches}
  */
  readonly noKeyMatches?: string;
}

export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyConditionsToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyConditions | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyConditionsToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyConditions | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyConditionsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyConditions | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyConditions | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyConditionsList extends cdktf.ComplexList {
  public internalValue? : DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyConditions[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyConditionsOutputReference {
    return new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyConditionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyRules {
  /**
  * Add a key/value pair with key KEY and value VALUE if KEY does not exist
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#add DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#add}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#copy DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#copy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#hard_copy DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#hard_copy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#hard_rename DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#hard_rename}
  */
  readonly hardRename?: { [key: string]: string };
  /**
  * Remove a key/value pair with key KEY if it exists
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#remove DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#remove}
  */
  readonly remove?: string;
  /**
  * Remove all key/value pairs with key matching regexp KEY
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#remove_regex DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#remove_regex}
  */
  readonly removeRegex?: string;
  /**
  * Remove all key/value pairs with key matching wildcard KEY
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#remove_wildcard DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#remove_wildcard}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#rename DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#rename}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#set DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#set}
  */
  readonly set?: { [key: string]: string };
}

export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyRulesToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyRules | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyRulesToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyRules | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyRulesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyRules | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyRules | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._add = undefined;
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyRulesList extends cdktf.ComplexList {
  public internalValue? : DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyRules[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyRulesOutputReference {
    return new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyRulesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModify {
  /**
  * Alias for the plugin
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#alias DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#alias}
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#conditions DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#conditions}
  */
  readonly conditions?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyConditions[] | cdktf.IResolvable;
  /**
  * RetryLimit describes how many times fluent-bit should retry to send data to a specific output. If set to false fluent-bit will try indefinetly. If set to any integer N>0 it will try at most N+1 times. Leading zeros are not allowed (values such as 007, 0150, 01 do not work). If this property is not defined fluent-bit will use the default value: 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#retry_limit DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#retry_limit}
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#rules DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#rules}
  */
  readonly rules?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyRules[] | cdktf.IResolvable;
}

export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModify | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    alias: cdktf.stringToTerraform(struct!.alias),
    conditions: cdktf.listMapper(dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyConditionsToTerraform, false)(struct!.conditions),
    retry_limit: cdktf.stringToTerraform(struct!.retryLimit),
    rules: cdktf.listMapper(dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyRulesToTerraform, false)(struct!.rules),
  }
}


export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModify | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    conditions: {
      value: cdktf.listMapperHcl(dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyConditionsToHclTerraform, false)(struct!.conditions),
      isBlock: true,
      type: "list",
      storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyConditionsList",
    },
    retry_limit: {
      value: cdktf.stringToHclTerraform(struct!.retryLimit),
      isBlock: false,
    ...
    rules: {
      value: cdktf.listMapperHcl(dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyRulesToHclTerraform, false)(struct!.rules),
      isBlock: true,
      type: "list",
      storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyRulesList",
    },
  };
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModify | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModify | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._alias = undefined;
  ...
  private _conditions = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyConditionsList(this, "conditions", false);
  public get conditions() {
    return this._conditions;
  }
  public putConditions(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyConditions[] | cdktf.IResolvable) {
  ...
  private _rules = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyRulesList(this, "rules", false);
  public get rules() {
    return this._rules;
  }
  public putRules(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyRules[] | cdktf.IResolvable) {
...
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersMultiline {
  /**
  * Alias for the plugin
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#alias DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#alias}
  */
  readonly alias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#buffer DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#buffer}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#emitter_type DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#emitter_type}
  */
  readonly emitterType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#flush_ms DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#flush_ms}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#key_content DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#key_content}
  */
  readonly keyContent?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#mode DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#parser DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#parser}
  */
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersMultilineToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersMultiline | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersMultilineToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersMultiline | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersMultilineOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersMultiline | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersMultiline | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._alias = undefined;
...
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersNest {
  /**
  * Prefix affected keys with this string
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#add_prefix DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#add_prefix}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#nest_under DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#nest_under}
  */
  readonly nestUnder?: string;
  /**
  * Lift records nested under the Nested_under key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#nested_under DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#nested_under}
  */
  readonly nestedUnder?: string;
  /**
  * Select the operation nest or lift
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#operation DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#operation}
  */
  readonly operation?: string;
  /**
  * Remove prefix from affected keys if it matches this string
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#remove_prefix DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#remove_prefix}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#wildcard DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#wildcard}
  */
  readonly wildcard?: string[];
}

export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersNestToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersNest | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersNestToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersNest | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersNestOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersNest | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersNest | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersParser {
  /**
  * Alias for the plugin
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#alias DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#alias}
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#key_name DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#key_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#preserve_key DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#preserve_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#reserve_data DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#reserve_data}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#unescape_key DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#unescape_key}
  */
  readonly unescapeKey?: boolean | cdktf.IResolvable;
}

export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersParserToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersParser | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersParserToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersParser | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersParserOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersParser | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersParser | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._alias = undefined;
...
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRecordModifier {
  /**
  * Alias for the plugin
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#alias DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#alias}
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#allowlist_keys DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#allowlist_keys}
  */
  readonly allowlistKeys?: string[];
  /**
  * Append fields. This parameter needs key and value pair.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#records DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#records}
  */
  readonly records?: string[];
  /**
  * If the key is matched, that field is removed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#remove_keys DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#remove_keys}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#uuid_keys DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#uuid_keys}
  */
  readonly uuidKeys?: string[];
  /**
  * An alias of allowlistKeys for backwards compatibility.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#whitelist_keys DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#whitelist_keys}
  */
  readonly whitelistKeys?: string[];
}

export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRecordModifierToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRecordModifier | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRecordModifierToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRecordModifier | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRecordModifierOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRecordModifier | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRecordModifier | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._alias = undefined;
...
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRewriteTag {
  /**
  * Alias for the plugin
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#alias DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#alias}
  ...
  */
  readonly emitterName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#emitter_storage_type DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#emitter_storage_type}
  */
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRewriteTagToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRewriteTag | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRewriteTagToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRewriteTag | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRewriteTagOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRewriteTag | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRewriteTag | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._alias = undefined;
...
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersThrottle {
  /**
  * Alias for the plugin
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#alias DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#alias}
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#interval DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#interval}
  */
  readonly interval?: string;
  /**
  * PrintStatus represents whether to print status messages with current rate and the limits to information logs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#print_status DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#print_status}
  */
  readonly printStatus?: boolean | cdktf.IResolvable;
  /**
  * Rate is the amount of messages for the time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#rate DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#rate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#window DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#window}
  */
  readonly window?: number;
}

export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersThrottleToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersThrottle | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersThrottleToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersThrottle | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersThrottleOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersThrottle | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersThrottle | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._alias = undefined;
...
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersWasm {
  /**
  * Specify the whitelist of paths to be able to access paths from WASM programs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#accessible_paths DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#accessible_paths}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#event_format DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#event_format}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#function_name DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#function_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#wasm_heap_size DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#wasm_heap_size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#wasm_path DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#wasm_path}
  */
  readonly wasmPath?: string;
  /**
  * Size of the stack size of Wasm execution. Review unit sizes for allowed values.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#wasm_stack_size DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#wasm_stack_size}
  */
  readonly wasmStackSize?: string;
}

export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersWasmToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersWasm | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersWasmToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersWasm | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersWasmOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersWasm | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersWasm | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFilters {
  /**
  * Aws defines a Aws configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#aws DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#aws}
  */
  readonly aws?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersAws;
  /**
  * CustomPlugin defines a Custom plugin configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#custom_plugin DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#custom_plugin}
  */
  readonly customPlugin?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersCustomPlugin;
  /**
  * Grep defines Grep Filter configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#grep DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#grep}
  */
  readonly grep?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersGrep;
  /**
  * Kubernetes defines Kubernetes Filter configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#kubernetes DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#kubernetes}
  */
  readonly kubernetes?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersKubernetes;
  /**
  * LogToMetrics defines a Log to Metrics Filter configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#log_to_metrics DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#log_to_metrics}
  */
  readonly logToMetrics?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLogToMetrics;
  /**
  * Lua defines Lua Filter configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#lua DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#lua}
  */
  readonly lua?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLua;
  /**
  * Modify defines Modify Filter configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#modify DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#modify}
  */
  readonly modify?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModify;
  /**
  * Multiline defines a Multiline configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#multiline DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#multiline}
  */
  readonly multiline?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersMultiline;
  /**
  * Nest defines Nest Filter configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#nest DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#nest}
  */
  readonly nest?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersNest;
  /**
  * Parser defines Parser Filter configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#parser DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#parser}
  */
  readonly parser?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersParser;
  /**
  * RecordModifier defines Record Modifier Filter configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#record_modifier DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#record_modifier}
  */
  readonly recordModifier?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRecordModifier;
  /**
  * RewriteTag defines a RewriteTag configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#rewrite_tag DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#rewrite_tag}
  */
  readonly rewriteTag?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRewriteTag;
  /**
  * Throttle defines a Throttle configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#throttle DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#throttle}
  */
  readonly throttle?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersThrottle;
  /**
  * Wasm defines a Wasm configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#wasm DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#wasm}
  */
  readonly wasm?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersWasm;
}

export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFilters | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    aws: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersAwsToTerraform(struct!.aws),
    custom_plugin: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersCustomPluginToTerraform(struct!.customPlugin),
    grep: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersGrepToTerraform(struct!.grep),
    kubernetes: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersKubernetesToTerraform(struct!.kubernetes),
    log_to_metrics: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLogToMetricsToTerraform(struct!.logToMetrics),
    lua: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaToTerraform(struct!.lua),
    modify: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyToTerraform(struct!.modify),
    multiline: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersMultilineToTerraform(struct!.multiline),
    nest: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersNestToTerraform(struct!.nest),
    parser: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersParserToTerraform(struct!.parser),
    record_modifier: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRecordModifierToTerraform(struct!.recordModifier),
    rewrite_tag: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRewriteTagToTerraform(struct!.rewriteTag),
    throttle: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersThrottleToTerraform(struct!.throttle),
    wasm: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersWasmToTerraform(struct!.wasm),
  }
}


export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFilters | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    aws: {
      value: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersAwsToHclTerraform(struct!.aws),
      isBlock: true,
      type: "struct",
      storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersAws",
    },
    custom_plugin: {
      value: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersCustomPluginToHclTerraform(struct!.customPlugin),
      isBlock: true,
      type: "struct",
      storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersCustomPlugin",
    },
    grep: {
      value: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersGrepToHclTerraform(struct!.grep),
      isBlock: true,
      type: "struct",
      storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersGrep",
    },
    kubernetes: {
      value: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersKubernetesToHclTerraform(struct!.kubernetes),
      isBlock: true,
      type: "struct",
      storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersKubernetes",
    },
    log_to_metrics: {
      value: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLogToMetricsToHclTerraform(struct!.logToMetrics),
      isBlock: true,
      type: "struct",
      storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLogToMetrics",
    },
    lua: {
      value: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaToHclTerraform(struct!.lua),
      isBlock: true,
      type: "struct",
      storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLua",
    },
    modify: {
      value: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyToHclTerraform(struct!.modify),
      isBlock: true,
      type: "struct",
      storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModify",
    },
    multiline: {
      value: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersMultilineToHclTerraform(struct!.multiline),
      isBlock: true,
      type: "struct",
      storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersMultiline",
    },
    nest: {
      value: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersNestToHclTerraform(struct!.nest),
      isBlock: true,
      type: "struct",
      storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersNest",
    },
    parser: {
      value: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersParserToHclTerraform(struct!.parser),
      isBlock: true,
      type: "struct",
      storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersParser",
    },
    record_modifier: {
      value: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRecordModifierToHclTerraform(struct!.recordModifier),
      isBlock: true,
      type: "struct",
      storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRecordModifier",
    },
    rewrite_tag: {
      value: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRewriteTagToHclTerraform(struct!.rewriteTag),
      isBlock: true,
      type: "struct",
      storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRewriteTag",
    },
    throttle: {
      value: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersThrottleToHclTerraform(struct!.throttle),
      isBlock: true,
      type: "struct",
      storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersThrottle",
    },
    wasm: {
      value: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersWasmToHclTerraform(struct!.wasm),
      isBlock: true,
      type: "struct",
      storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersWasm",
    },
  };
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFilters | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFilters | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  private _aws = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersAwsOutputReference(this, "aws");
  public get aws() {
    return this._aws;
  }
  public putAws(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersAws) {
  ...
  private _customPlugin = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersCustomPluginOutputReference(this, "custom_plugin");
  public get customPlugin() {
    return this._customPlugin;
  }
  public putCustomPlugin(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersCustomPlugin) {
  ...
  private _grep = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersGrepOutputReference(this, "grep");
  public get grep() {
    return this._grep;
  }
  public putGrep(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersGrep) {
  ...
  private _kubernetes = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersKubernetesOutputReference(this, "kubernetes");
  public get kubernetes() {
    return this._kubernetes;
  }
  public putKubernetes(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersKubernetes) {
  ...
  private _logToMetrics = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLogToMetricsOutputReference(this, "log_to_metrics");
  public get logToMetrics() {
    return this._logToMetrics;
  }
  public putLogToMetrics(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLogToMetrics) {
  ...
  private _lua = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLuaOutputReference(this, "lua");
  public get lua() {
    return this._lua;
  }
  public putLua(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersLua) {
  ...
  private _modify = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModifyOutputReference(this, "modify");
  public get modify() {
    return this._modify;
  }
  public putModify(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersModify) {
  ...
  private _multiline = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersMultilineOutputReference(this, "multiline");
  public get multiline() {
    return this._multiline;
  }
  public putMultiline(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersMultiline) {
  ...
  private _nest = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersNestOutputReference(this, "nest");
  public get nest() {
    return this._nest;
  }
  public putNest(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersNest) {
  ...
  // parser - computed: false, optional: true, required: false
  private _parser = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersParserOutputReference(this, "parser");
  public get parser() {
    return this._parser;
  }
  public putParser(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersParser) {
  ...
  private _recordModifier = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRecordModifierOutputReference(this, "record_modifier");
  public get recordModifier() {
    return this._recordModifier;
  }
  public putRecordModifier(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRecordModifier) {
  ...
  private _rewriteTag = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRewriteTagOutputReference(this, "rewrite_tag");
  public get rewriteTag() {
    return this._rewriteTag;
  }
  public putRewriteTag(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersRewriteTag) {
  ...
  private _throttle = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersThrottleOutputReference(this, "throttle");
  public get throttle() {
    return this._throttle;
  }
  public putThrottle(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersThrottle) {
  ...
  private _wasm = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersWasmOutputReference(this, "wasm");
  public get wasm() {
    return this._wasm;
  }
  public putWasm(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersWasm) {
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersList extends cdktf.ComplexList {
  public internalValue? : DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFilters[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersOutputReference {
    return new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpec {
  /**
  * A set of filter plugins in order.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#filters DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#filters}
  */
  readonly filters?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFilters[] | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#log_level DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#log_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#match DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#match}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#match_regex DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest#match_regex}
  */
  readonly matchRegex?: string;
}

export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecToTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpec | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    filters: cdktf.listMapper(dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersToTerraform, false)(struct!.filters),
...
export function dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecToHclTerraform(struct?: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpec | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    filters: {
      value: cdktf.listMapperHcl(dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersToHclTerraform, false)(struct!.filters),
      isBlock: true,
      type: "list",
      storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersList",
    },
    log_level: {
...
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpec | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpec | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  private _filters = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFiltersList(this, "filters", false);
  public get filters() {
    return this._filters;
  }
  public putFilters(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecFilters[] | cdktf.IResolvable) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest k8s_fluentbit_fluent_io_cluster_filter_v1alpha2_manifest}
*/
export class DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "k8s_fluentbit_fluent_io_cluster_filter_v1alpha2_manifest";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest to import
  * @param importFromId The id of the existing DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataK8SFluentbitFluentIoClusterFilterV1Alpha2Manifest to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "k8s_fluentbit_fluent_io_cluster_filter_v1alpha2_manifest", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/fluentbit_fluent_io_cluster_filter_v1alpha2_manifest k8s_fluentbit_fluent_io_cluster_filter_v1alpha2_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestConfig
  */
  public constructor(scope: Construct, id: string, config: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestConfig) {
    super(scope, id, {
      terraformResourceType: 'k8s_fluentbit_fluent_io_cluster_filter_v1alpha2_manifest',
  ...
  private _metadata = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestMetadataOutputReference(this, "metadata");
  public get metadata() {
    return this._metadata;
  }
  public putMetadata(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestMetadata) {
  ...
  private _spec = new DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecOutputReference(this, "spec");
  public get spec() {
    return this._spec;
  }
  public putSpec(value: DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpec) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      metadata: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestMetadataToTerraform(this._metadata.internalValue),
      spec: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecToTerraform(this._spec.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      metadata: {
        value: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestMetadataToHclTerraform(this._metadata.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestMetadata",
      },
      spec: {
        value: dataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpecToHclTerraform(this._spec.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DataK8SFluentbitFluentIoClusterFilterV1Alpha2ManifestSpec",
      },
    };
