// https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/rds_services_k8s_aws_global_cluster_v1alpha1_manifest
...
export interface DataK8SRdsServicesK8SAwsGlobalClusterV1Alpha1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/rds_services_k8s_aws_global_cluster_v1alpha1_manifest#metadata DataK8SRdsServicesK8SAwsGlobalClusterV1Alpha1Manifest#metadata}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/rds_services_k8s_aws_global_cluster_v1alpha1_manifest#spec DataK8SRdsServicesK8SAwsGlobalClusterV1Alpha1Manifest#spec}
  */
...
export interface DataK8SRdsServicesK8SAwsGlobalClusterV1Alpha1ManifestMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/rds_services_k8s_aws_global_cluster_v1alpha1_manifest#annotations DataK8SRdsServicesK8SAwsGlobalClusterV1Alpha1Manifest#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Keys and values that can be used to organize and categorize objects. See https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/rds_services_k8s_aws_global_cluster_v1alpha1_manifest#labels DataK8SRdsServicesK8SAwsGlobalClusterV1Alpha1Manifest#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Unique identifier for this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/rds_services_k8s_aws_global_cluster_v1alpha1_manifest#name DataK8SRdsServicesK8SAwsGlobalClusterV1Alpha1Manifest#name}
  */
  readonly name: string;
  /**
  * Namespaces provides a mechanism for isolating groups of resources within a single cluster. See https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/rds_services_k8s_aws_global_cluster_v1alpha1_manifest#namespace DataK8SRdsServicesK8SAwsGlobalClusterV1Alpha1Manifest#namespace}
  */
...
export interface DataK8SRdsServicesK8SAwsGlobalClusterV1Alpha1ManifestSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/rds_services_k8s_aws_global_cluster_v1alpha1_manifest#database_name DataK8SRdsServicesK8SAwsGlobalClusterV1Alpha1Manifest#database_name}
  */
  readonly databaseName?: string;
  /**
  * The deletion protection setting for the new global database. The global database can't be deleted when deletion protection is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/rds_services_k8s_aws_global_cluster_v1alpha1_manifest#deletion_protection DataK8SRdsServicesK8SAwsGlobalClusterV1Alpha1Manifest#deletion_protection}
  */
  readonly deletionProtection?: boolean | cdktf.IResolvable;
  /**
  * The name of the database engine to be used for this DB cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/rds_services_k8s_aws_global_cluster_v1alpha1_manifest#engine DataK8SRdsServicesK8SAwsGlobalClusterV1Alpha1Manifest#engine}
  */
  readonly engine?: string;
  /**
  * The engine version of the Aurora global database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/rds_services_k8s_aws_global_cluster_v1alpha1_manifest#engine_version DataK8SRdsServicesK8SAwsGlobalClusterV1Alpha1Manifest#engine_version}
  */
  readonly engineVersion?: string;
  /**
  * The cluster identifier of the new global database cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/rds_services_k8s_aws_global_cluster_v1alpha1_manifest#global_cluster_identifier DataK8SRdsServicesK8SAwsGlobalClusterV1Alpha1Manifest#global_cluster_identifier}
  */
  readonly globalClusterIdentifier?: string;
  /**
  * The Amazon Resource Name (ARN) to use as the primary cluster of the global database. This parameter is optional.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/rds_services_k8s_aws_global_cluster_v1alpha1_manifest#source_db_cluster_identifier DataK8SRdsServicesK8SAwsGlobalClusterV1Alpha1Manifest#source_db_cluster_identifier}
  */
  readonly sourceDbClusterIdentifier?: string;
  /**
  * The storage encryption setting for the new global database cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/rds_services_k8s_aws_global_cluster_v1alpha1_manifest#storage_encrypted DataK8SRdsServicesK8SAwsGlobalClusterV1Alpha1Manifest#storage_encrypted}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/rds_services_k8s_aws_global_cluster_v1alpha1_manifest k8s_rds_services_k8s_aws_global_cluster_v1alpha1_manifest}
*/
export class DataK8SRdsServicesK8SAwsGlobalClusterV1Alpha1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SRdsServicesK8SAwsGlobalClusterV1Alpha1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/rds_services_k8s_aws_global_cluster_v1alpha1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/rds_services_k8s_aws_global_cluster_v1alpha1_manifest k8s_rds_services_k8s_aws_global_cluster_v1alpha1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
