...
export interface DataK8SCamelApacheOrgIntegrationV1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/camel_apache_org_integration_v1_manifest#metadata DataK8SCamelApacheOrgIntegrationV1Manifest#metadata}
  */
  readonly metadata: DataK8SCamelApacheOrgIntegrationV1ManifestMetadata;
  /**
  * the desired Integration specification
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/camel_apache_org_integration_v1_manifest#spec DataK8SCamelApacheOrgIntegrationV1Manifest#spec}
  */
  readonly spec?: DataK8SCamelApacheOrgIntegrationV1ManifestSpec;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/camel_apache_org_integration_v1_manifest k8s_camel_apache_org_integration_v1_manifest}
*/
export class DataK8SCamelApacheOrgIntegrationV1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SCamelApacheOrgIntegrationV1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/camel_apache_org_integration_v1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/camel_apache_org_integration_v1_manifest k8s_camel_apache_org_integration_v1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
