// https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/repo_manager_pulpproject_org_pulp_restore_v1beta2_manifest
...
export interface DataK8SRepoManagerPulpprojectOrgPulpRestoreV1Beta2ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/repo_manager_pulpproject_org_pulp_restore_v1beta2_manifest#metadata DataK8SRepoManagerPulpprojectOrgPulpRestoreV1Beta2Manifest#metadata}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/repo_manager_pulpproject_org_pulp_restore_v1beta2_manifest#spec DataK8SRepoManagerPulpprojectOrgPulpRestoreV1Beta2Manifest#spec}
  */
...
export interface DataK8SRepoManagerPulpprojectOrgPulpRestoreV1Beta2ManifestMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/repo_manager_pulpproject_org_pulp_restore_v1beta2_manifest#annotations DataK8SRepoManagerPulpprojectOrgPulpRestoreV1Beta2Manifest#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Keys and values that can be used to organize and categorize objects. See https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/repo_manager_pulpproject_org_pulp_restore_v1beta2_manifest#labels DataK8SRepoManagerPulpprojectOrgPulpRestoreV1Beta2Manifest#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Unique identifier for this object. See https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/repo_manager_pulpproject_org_pulp_restore_v1beta2_manifest#name DataK8SRepoManagerPulpprojectOrgPulpRestoreV1Beta2Manifest#name}
  */
  readonly name: string;
  /**
  * Namespaces provides a mechanism for isolating groups of resources within a single cluster. See https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ for more details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/repo_manager_pulpproject_org_pulp_restore_v1beta2_manifest#namespace DataK8SRepoManagerPulpprojectOrgPulpRestoreV1Beta2Manifest#namespace}
  */
...
export interface DataK8SRepoManagerPulpprojectOrgPulpRestoreV1Beta2ManifestSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/repo_manager_pulpproject_org_pulp_restore_v1beta2_manifest#backup_dir DataK8SRepoManagerPulpprojectOrgPulpRestoreV1Beta2Manifest#backup_dir}
  */
  readonly backupDir?: string;
  /**
  * Name of the backup custom resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/repo_manager_pulpproject_org_pulp_restore_v1beta2_manifest#backup_name DataK8SRepoManagerPulpprojectOrgPulpRestoreV1Beta2Manifest#backup_name}
  */
  readonly backupName: string;
  /**
  * Name of the PVC to be restored from, set as a status found on the backup object (backupClaim)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/repo_manager_pulpproject_org_pulp_restore_v1beta2_manifest#backup_pvc DataK8SRepoManagerPulpprojectOrgPulpRestoreV1Beta2Manifest#backup_pvc}
  */
  readonly backupPvc?: string;
  /**
  * Name of the deployment to be restored to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/repo_manager_pulpproject_org_pulp_restore_v1beta2_manifest#deployment_name DataK8SRepoManagerPulpprojectOrgPulpRestoreV1Beta2Manifest#deployment_name}
  */
  readonly deploymentName?: string;
  /**
  * Name of the deployment type. Can be one of {galaxy,pulp}.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/repo_manager_pulpproject_org_pulp_restore_v1beta2_manifest#deployment_type DataK8SRepoManagerPulpprojectOrgPulpRestoreV1Beta2Manifest#deployment_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/repo_manager_pulpproject_org_pulp_restore_v1beta2_manifest#keep_replicas DataK8SRepoManagerPulpprojectOrgPulpRestoreV1Beta2Manifest#keep_replicas}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/repo_manager_pulpproject_org_pulp_restore_v1beta2_manifest k8s_repo_manager_pulpproject_org_pulp_restore_v1beta2_manifest}
*/
export class DataK8SRepoManagerPulpprojectOrgPulpRestoreV1Beta2Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SRepoManagerPulpprojectOrgPulpRestoreV1Beta2Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/repo_manager_pulpproject_org_pulp_restore_v1beta2_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/repo_manager_pulpproject_org_pulp_restore_v1beta2_manifest k8s_repo_manager_pulpproject_org_pulp_restore_v1beta2_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
