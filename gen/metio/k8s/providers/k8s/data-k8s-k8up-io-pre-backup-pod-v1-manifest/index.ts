...
export interface DataK8SK8UpIoPreBackupPodV1ManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/k8up_io_pre_backup_pod_v1_manifest#metadata DataK8SK8UpIoPreBackupPodV1Manifest#metadata}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/k8up_io_pre_backup_pod_v1_manifest#spec DataK8SK8UpIoPreBackupPodV1Manifest#spec}
  */
  readonly spec?: DataK8SK8UpIoPreBackupPodV1ManifestSpec;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/k8up_io_pre_backup_pod_v1_manifest k8s_k8up_io_pre_backup_pod_v1_manifest}
*/
export class DataK8SK8UpIoPreBackupPodV1Manifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataK8SK8UpIoPreBackupPodV1Manifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/k8up_io_pre_backup_pod_v1_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metio/k8s/2025.10.20/docs/data-sources/k8up_io_pre_backup_pod_v1_manifest k8s_k8up_io_pre_backup_pod_v1_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
