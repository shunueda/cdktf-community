// https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/aws_manual_connection_resources
...
export interface DataClumioAwsManualConnectionResourcesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/aws_manual_connection_resources#account_native_id DataClumioAwsManualConnectionResources#account_native_id}
  */
  readonly accountNativeId: string;
  /**
  * Assets to be connected to Clumio. Note that `mssql` is only available for legacy connections.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/aws_manual_connection_resources#asset_types_enabled DataClumioAwsManualConnectionResources#asset_types_enabled}
  */
  readonly assetTypesEnabled: DataClumioAwsManualConnectionResourcesAssetTypesEnabled;
  /**
  * AWS Region to be connected to Clumio.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/aws_manual_connection_resources#aws_region DataClumioAwsManualConnectionResources#aws_region}
  */
  readonly awsRegion: string;
}
export interface DataClumioAwsManualConnectionResourcesAssetTypesEnabled {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/aws_manual_connection_resources#ddb DataClumioAwsManualConnectionResources#ddb}
  */
  readonly ddb: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/aws_manual_connection_resources#ebs DataClumioAwsManualConnectionResources#ebs}
  */
  readonly ebs: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/aws_manual_connection_resources#mssql DataClumioAwsManualConnectionResources#mssql}
  */
  readonly mssql: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/aws_manual_connection_resources#rds DataClumioAwsManualConnectionResources#rds}
  */
  readonly rds: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/aws_manual_connection_resources#s3 DataClumioAwsManualConnectionResources#s3}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/aws_manual_connection_resources clumio_aws_manual_connection_resources}
*/
export class DataClumioAwsManualConnectionResources extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataClumioAwsManualConnectionResources that should be imported. Refer to the {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/aws_manual_connection_resources#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/aws_manual_connection_resources clumio_aws_manual_connection_resources} Data Source
  *
  * @param scope The scope in which to define this construct
