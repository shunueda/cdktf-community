// https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/s3_bucket_properties
...
export interface S3BucketPropertiesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/s3_bucket_properties#bucket_id S3BucketProperties#bucket_id}
  */
  readonly bucketId: string;
  /**
  * Determines if continuous backup is enabled for the S3 bucket.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/s3_bucket_properties#event_bridge_enabled S3BucketProperties#event_bridge_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/s3_bucket_properties#event_bridge_notification_disabled S3BucketProperties#event_bridge_notification_disabled}
  */
  readonly eventBridgeNotificationDisabled?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/s3_bucket_properties clumio_s3_bucket_properties}
*/
export class S3BucketProperties extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing S3BucketProperties that should be imported. Refer to the {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/s3_bucket_properties#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/s3_bucket_properties clumio_s3_bucket_properties} Resource
  *
  * @param scope The scope in which to define this construct
