// https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/policy_rule
...
export interface PolicyRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/policy_rule#before_rule_id PolicyRule#before_rule_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/policy_rule#condition PolicyRule#condition}
  */
  readonly condition: string;
  /**
  * The name of the policy rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/policy_rule#name PolicyRule#name}
  */
  readonly name: string;
  /**
  * The Clumio-assigned ID of the policy. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/policy_rule#policy_id PolicyRule#policy_id}
  */
  readonly policyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/policy_rule clumio_policy_rule}
*/
export class PolicyRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/policy_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/policy_rule clumio_policy_rule} Resource
  *
  * @param scope The scope in which to define this construct
