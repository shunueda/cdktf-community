// https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/dynamodb_tables
...
export interface DataClumioDynamodbTablesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/dynamodb_tables#account_native_id DataClumioDynamodbTables#account_native_id}
  */
  readonly accountNativeId: string;
  /**
  * The AWS region associated with the DynamoDB tables.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/dynamodb_tables#aws_region DataClumioDynamodbTables#aws_region}
  */
  readonly awsRegion: string;
  /**
  * The DynamoDB table name to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/dynamodb_tables#name DataClumioDynamodbTables#name}
  */
  readonly name?: string;
  /**
  * Native identifier of the DynamoDB table to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/dynamodb_tables#table_native_id DataClumioDynamodbTables#table_native_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/dynamodb_tables clumio_dynamodb_tables}
*/
export class DataClumioDynamodbTables extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataClumioDynamodbTables that should be imported. Refer to the {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/dynamodb_tables#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/dynamodb_tables clumio_dynamodb_tables} Data Source
  *
  * @param scope The scope in which to define this construct
