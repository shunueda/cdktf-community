// https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/policy
...
export interface DataClumioPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/policy#activation_status DataClumioPolicy#activation_status}
  */
  readonly activationStatus?: string;
  /**
  * The name of the policy to be included in the read policies query.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/policy#name DataClumioPolicy#name}
  */
  readonly name?: string;
  /**
  * Operation types to be included in the read policies query.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/policy#operation_types DataClumioPolicy#operation_types}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/policy clumio_policy}
*/
export class DataClumioPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataClumioPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/policy clumio_policy} Data Source
  *
  * @param scope The scope in which to define this construct
