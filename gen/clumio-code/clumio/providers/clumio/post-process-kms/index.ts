// https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/post_process_kms
...
export interface PostProcessKmsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/post_process_kms#account_id PostProcessKms#account_id}
  */
  readonly accountId: string;
  /**
  * The ARN of the Clumio IAM role principal.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/post_process_kms#clumio_iam_role_principal PostProcessKms#clumio_iam_role_principal}
  */
  readonly clumioIamRolePrincipal: string;
  /**
  * Indicates if a new customer-managed key was created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/post_process_kms#created_multi_region_cmk PostProcessKms#created_multi_region_cmk}
  */
  readonly createdMultiRegionCmk?: boolean | cdktf.IResolvable;
  /**
  * Identifier of the multi region customer-managed key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/post_process_kms#multi_region_cmk_key_id PostProcessKms#multi_region_cmk_key_id}
  */
  readonly multiRegionCmkKeyId?: string;
  /**
  * Region of the AWS account linked with Clumio.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/post_process_kms#region PostProcessKms#region}
  */
  readonly region: string;
  /**
  * The ARN of the IAM role to manage the customer-managed key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/post_process_kms#role_arn PostProcessKms#role_arn}
  */
  readonly roleArn: string;
  /**
  * Unique identifier Clumio uses to access the service role within your account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/post_process_kms#role_external_id PostProcessKms#role_external_id}
  */
  readonly roleExternalId: string;
  /**
  * Identifier of the IAM role to manage the customer-managed key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/post_process_kms#role_id PostProcessKms#role_id}
  */
  readonly roleId: string;
  /**
  * Version of the BYOK template which was created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/post_process_kms#template_version PostProcessKms#template_version}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/post_process_kms#token PostProcessKms#token}
  */
  readonly token: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/post_process_kms clumio_post_process_kms}
*/
export class PostProcessKms extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PostProcessKms that should be imported. Refer to the {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/post_process_kms#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/post_process_kms clumio_post_process_kms} Resource
  *
  * @param scope The scope in which to define this construct
