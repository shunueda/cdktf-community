// https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/organizational_unit
...
export interface DataClumioOrganizationalUnitConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/organizational_unit#name DataClumioOrganizationalUnit#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/organizational_unit clumio_organizational_unit}
*/
export class DataClumioOrganizationalUnit extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataClumioOrganizationalUnit that should be imported. Refer to the {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/organizational_unit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/organizational_unit clumio_organizational_unit} Data Source
  *
  * @param scope The scope in which to define this construct
