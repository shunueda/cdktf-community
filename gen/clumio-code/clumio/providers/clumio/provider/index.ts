// https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs
...
export interface ClumioProviderConfig {
  ...
  * 		
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs#clumio_api_base_url ClumioProvider#clumio_api_base_url}
  */
  readonly clumioApiBaseUrl?: string;
  /**
  * The API token required to invoke Clumio APIs. Informations for generating this token are available here: https://help.clumio.com/docs/api-tokens#managing-tokens
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs#clumio_api_token ClumioProvider#clumio_api_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs#clumio_organizational_unit_context ClumioProvider#clumio_organizational_unit_context}
  */
  readonly clumioOrganizationalUnitContext?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs#alias ClumioProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs clumio}
*/
export class ClumioProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing ClumioProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs clumio} Resource
  *
  * @param scope The scope in which to define this construct
