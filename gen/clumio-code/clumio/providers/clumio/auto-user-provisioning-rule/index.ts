// https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/auto_user_provisioning_rule
...
export interface AutoUserProvisioningRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/auto_user_provisioning_rule#condition AutoUserProvisioningRule#condition}
  */
  readonly condition: string;
  /**
  * The name of the auto user provisioning rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/auto_user_provisioning_rule#name AutoUserProvisioningRule#name}
  */
  readonly name: string;
  /**
  * List of Clumio organizational unit identifiers to be assigned to the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/auto_user_provisioning_rule#organizational_unit_ids AutoUserProvisioningRule#organizational_unit_ids}
  */
  readonly organizationalUnitIds: string[];
  /**
  * Identifier of the Clumio role to be assigned to the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/auto_user_provisioning_rule#role_id AutoUserProvisioningRule#role_id}
  */
  readonly roleId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/auto_user_provisioning_rule clumio_auto_user_provisioning_rule}
*/
export class AutoUserProvisioningRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AutoUserProvisioningRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/auto_user_provisioning_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/resources/auto_user_provisioning_rule clumio_auto_user_provisioning_rule} Resource
  *
  * @param scope The scope in which to define this construct
