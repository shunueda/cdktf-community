// https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/policy_rule
...
export interface DataClumioPolicyRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/policy_rule#name DataClumioPolicyRule#name}
  */
  readonly name?: string;
  /**
  * Unique identifier of the policy to filter in the list of policy rules returned by the API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/policy_rule#policy_id DataClumioPolicyRule#policy_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/policy_rule clumio_policy_rule}
*/
export class DataClumioPolicyRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataClumioPolicyRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/policy_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/clumio-code/clumio/0.15.0/docs/data-sources/policy_rule clumio_policy_rule} Data Source
  *
  * @param scope The scope in which to define this construct
