// https://registry.terraform.io/providers/cloudflare/cloudflare/5.11.0/docs/resources/total_tls
...
export class TotalTls extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TotalTls that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.11.0/docs/resources/total_tls#import import section} in the documentation of this resource for the id to use
