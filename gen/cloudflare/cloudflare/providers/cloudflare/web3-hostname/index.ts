// https://registry.terraform.io/providers/cloudflare/cloudflare/5.11.0/docs/resources/web3_hostname
...
export class Web3Hostname extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Web3Hostname that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.11.0/docs/resources/web3_hostname#import import section} in the documentation of this resource for the id to use
