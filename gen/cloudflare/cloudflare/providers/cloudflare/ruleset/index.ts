// https://registry.terraform.io/providers/cloudflare/cloudflare/5.11.0/docs/resources/ruleset
...
export class Ruleset extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ruleset that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.11.0/docs/resources/ruleset#import import section} in the documentation of this resource for the id to use
