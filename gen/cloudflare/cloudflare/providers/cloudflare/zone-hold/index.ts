// https://registry.terraform.io/providers/cloudflare/cloudflare/5.11.0/docs/resources/zone_hold
...
export class ZoneHold extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZoneHold that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.11.0/docs/resources/zone_hold#import import section} in the documentation of this resource for the id to use
