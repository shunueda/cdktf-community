// https://registry.terraform.io/providers/cloudflare/cloudflare/5.11.0/docs/resources/healthcheck
...
export class Healthcheck extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Healthcheck that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.11.0/docs/resources/healthcheck#import import section} in the documentation of this resource for the id to use
