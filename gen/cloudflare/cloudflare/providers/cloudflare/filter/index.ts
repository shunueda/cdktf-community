// https://registry.terraform.io/providers/cloudflare/cloudflare/5.11.0/docs/resources/filter
...
export class Filter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Filter that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.11.0/docs/resources/filter#import import section} in the documentation of this resource for the id to use
