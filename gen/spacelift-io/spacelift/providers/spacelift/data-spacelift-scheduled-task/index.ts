// https://registry.terraform.io/providers/spacelift-io/spacelift/1.35.1/docs/data-sources/scheduled_task
...
export interface DataSpaceliftScheduledTaskConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.35.1/docs/data-sources/scheduled_task#id DataSpaceliftScheduledTask#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.35.1/docs/data-sources/scheduled_task#scheduled_task_id DataSpaceliftScheduledTask#scheduled_task_id}
  */
  readonly scheduledTaskId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.35.1/docs/data-sources/scheduled_task spacelift_scheduled_task}
*/
export class DataSpaceliftScheduledTask extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSpaceliftScheduledTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.35.1/docs/data-sources/scheduled_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.35.1/docs/data-sources/scheduled_task spacelift_scheduled_task} Data Source
  *
  * @param scope The scope in which to define this construct
