// https://registry.terraform.io/providers/spacelift-io/spacelift/1.35.1/docs/data-sources/vcs_agent_pool
...
export interface DataSpaceliftVcsAgentPoolConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.35.1/docs/data-sources/vcs_agent_pool#id DataSpaceliftVcsAgentPool#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.35.1/docs/data-sources/vcs_agent_pool#vcs_agent_pool_id DataSpaceliftVcsAgentPool#vcs_agent_pool_id}
  */
  readonly vcsAgentPoolId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.35.1/docs/data-sources/vcs_agent_pool spacelift_vcs_agent_pool}
*/
export class DataSpaceliftVcsAgentPool extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSpaceliftVcsAgentPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.35.1/docs/data-sources/vcs_agent_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.35.1/docs/data-sources/vcs_agent_pool spacelift_vcs_agent_pool} Data Source
  *
  * @param scope The scope in which to define this construct
