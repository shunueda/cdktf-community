// https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/variables_ssh_keys
...
export interface DataBuddyVariablesSshKeysConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/variables_ssh_keys#action_id DataBuddyVariablesSshKeys#action_id}
  */
  readonly actionId?: number;
  /**
  * The workspace's URL handle
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/variables_ssh_keys#domain DataBuddyVariablesSshKeys#domain}
  */
  readonly domain: string;
  /**
  * The variable's key regular expression to match
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/variables_ssh_keys#key_regex DataBuddyVariablesSshKeys#key_regex}
  */
  readonly keyRegex?: string;
  /**
  * Get only from provided pipeline
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/variables_ssh_keys#pipeline_id DataBuddyVariablesSshKeys#pipeline_id}
  */
  readonly pipelineId?: number;
  /**
  * Get only from provided project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/variables_ssh_keys#project_name DataBuddyVariablesSshKeys#project_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/variables_ssh_keys buddy_variables_ssh_keys}
*/
export class DataBuddyVariablesSshKeys extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBuddyVariablesSshKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/variables_ssh_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/variables_ssh_keys buddy_variables_ssh_keys} Data Source
  *
  * @param scope The scope in which to define this construct
