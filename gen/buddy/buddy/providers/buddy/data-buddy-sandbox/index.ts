// https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/sandbox
...
export interface DataBuddySandboxConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/sandbox#domain DataBuddySandbox#domain}
  */
  readonly domain: string;
  /**
  * The sandbox's ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/sandbox#sandbox_id DataBuddySandbox#sandbox_id}
  */
  readonly sandboxId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/sandbox buddy_sandbox}
*/
export class DataBuddySandbox extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBuddySandbox that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/sandbox#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/sandbox buddy_sandbox} Data Source
  *
  * @param scope The scope in which to define this construct
