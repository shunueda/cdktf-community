// https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/group_members
...
export interface DataBuddyGroupMembersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/group_members#domain DataBuddyGroupMembers#domain}
  */
  readonly domain: string;
  /**
  * The group's ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/group_members#group_id DataBuddyGroupMembers#group_id}
  */
  readonly groupId: number;
  /**
  * The member's name regular expression to match
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/group_members#name_regex DataBuddyGroupMembers#name_regex}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/group_members buddy_group_members}
*/
export class DataBuddyGroupMembers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBuddyGroupMembers that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/group_members#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/group_members buddy_group_members} Data Source
  *
  * @param scope The scope in which to define this construct
