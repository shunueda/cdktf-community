// https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/member
...
export interface MemberConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/member#admin Member#admin}
  */
  readonly admin?: boolean | cdktf.IResolvable;
  /**
  * The permission's ID with which the member will be assigned to new projects
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/member#auto_assign_permission_set_id Member#auto_assign_permission_set_id}
  */
  readonly autoAssignPermissionSetId?: number;
  /**
  * Defines whether or not to automatically assign member to new projects
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/member#auto_assign_to_new_projects Member#auto_assign_to_new_projects}
  */
  readonly autoAssignToNewProjects?: boolean | cdktf.IResolvable;
  /**
  * The workspace's URL handle
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/member#domain Member#domain}
  */
  readonly domain: string;
  /**
  * The member's email
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/member#email Member#email}
  */
  readonly email: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/member buddy_member}
*/
export class Member extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Member that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/member buddy_member} Resource
  *
  * @param scope The scope in which to define this construct
