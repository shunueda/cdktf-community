// https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/webhook
...
export interface WebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/webhook#domain Webhook#domain}
  */
  readonly domain: string;
  /**
  * The webhook's event's list. Allowed: `PUSH`, `EXECUTION_STARTED`, `EXECUTION_SUCCESSFUL`, `EXECUTION_FAILED`, `EXECUTION_FINISHED`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/webhook#events Webhook#events}
  */
  readonly events: string[];
  /**
  * To which projects the webhook should be assigned. If left empty all projects will be used
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/webhook#projects Webhook#projects}
  */
  readonly projects: string[];
  /**
  * The webhook's secret value sent in the payload
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/webhook#secret_key Webhook#secret_key}
  */
  readonly secretKey?: string;
  /**
  * The webhook's target URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/webhook#target_url Webhook#target_url}
  */
  readonly targetUrl: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/webhook buddy_webhook}
*/
export class Webhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Webhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/webhook buddy_webhook} Resource
  *
  * @param scope The scope in which to define this construct
