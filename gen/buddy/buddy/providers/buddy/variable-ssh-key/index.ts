// https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/variable_ssh_key
...
export interface VariableSshKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/variable_ssh_key#action_id VariableSshKey#action_id}
  */
  readonly actionId?: number;
  /**
  * The variable's description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/variable_ssh_key#description VariableSshKey#description}
  */
  readonly description?: string;
  /**
  * The workspace's URL handle
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/variable_ssh_key#domain VariableSshKey#domain}
  */
  readonly domain: string;
  /**
  * The variable's file permission in an action's container
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/variable_ssh_key#file_chmod VariableSshKey#file_chmod}
  */
  readonly fileChmod: string;
  /**
  * The variable's path in the action's container
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/variable_ssh_key#file_path VariableSshKey#file_path}
  */
  readonly filePath: string;
  /**
  * Should the variable's be copied to an action's container in **file_path** (`CONTAINER`, `NONE`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/variable_ssh_key#file_place VariableSshKey#file_place}
  */
  readonly filePlace: string;
  /**
  * The variable's name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/variable_ssh_key#key VariableSshKey#key}
  */
  readonly key: string;
  /**
  * The variable's pipeline ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/variable_ssh_key#pipeline_id VariableSshKey#pipeline_id}
  */
  readonly pipelineId?: number;
  /**
  * The variable's project name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/variable_ssh_key#project_name VariableSshKey#project_name}
  */
  readonly projectName?: string;
  /**
  * The variable's value
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/variable_ssh_key#value VariableSshKey#value}
  */
  readonly value: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/variable_ssh_key buddy_variable_ssh_key}
*/
export class VariableSshKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VariableSshKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/variable_ssh_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/variable_ssh_key buddy_variable_ssh_key} Resource
  *
  * @param scope The scope in which to define this construct
