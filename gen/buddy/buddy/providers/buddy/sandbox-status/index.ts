// https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sandbox_status
...
export interface SandboxStatusConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sandbox_status#domain SandboxStatus#domain}
  */
  readonly domain: string;
  /**
  * The sandbox's ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sandbox_status#sandbox_id SandboxStatus#sandbox_id}
  */
  readonly sandboxId: string;
  /**
  * The sandbox's status to achive
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sandbox_status#status SandboxStatus#status}
  */
  readonly status: string;
  /**
  * Wait until sandbox is in required status
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sandbox_status#wait_for_status SandboxStatus#wait_for_status}
  */
  readonly waitForStatus?: boolean | cdktf.IResolvable;
  /**
  * Seconds to wait until sandbox is in required status
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sandbox_status#wait_for_status_timeout SandboxStatus#wait_for_status_timeout}
  */
  readonly waitForStatusTimeout?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sandbox_status buddy_sandbox_status}
*/
export class SandboxStatus extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SandboxStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sandbox_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sandbox_status buddy_sandbox_status} Resource
  *
  * @param scope The scope in which to define this construct
