// https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs
...
export interface BuddyProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs#base_url BuddyProvider#base_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs#insecure BuddyProvider#insecure}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs#timeout BuddyProvider#timeout}
  */
  readonly timeout?: number;
  /**
  * The OAuth2 token or Personal Access Token. Can be specified with the `BUDDY_TOKEN` environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs#token BuddyProvider#token}
  */
  readonly token?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs#alias BuddyProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs buddy}
*/
export class BuddyProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing BuddyProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs buddy} Resource
  *
  * @param scope The scope in which to define this construct
