// https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/projects
...
export interface DataBuddyProjectsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/projects#display_name_regex DataBuddyProjects#display_name_regex}
  */
  readonly displayNameRegex?: string;
  /**
  * The workspace's URL handle
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/projects#domain DataBuddyProjects#domain}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/projects#membership DataBuddyProjects#membership}
  */
  readonly membership?: boolean | cdktf.IResolvable;
  /**
  * The project's name regular expression to match
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/projects#name_regex DataBuddyProjects#name_regex}
  */
  readonly nameRegex?: string;
  /**
  * Filter projects by status (`ACTIVE`, `CLOSED`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/projects#status DataBuddyProjects#status}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/projects buddy_projects}
*/
export class DataBuddyProjects extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBuddyProjects that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/projects#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/projects buddy_projects} Data Source
  *
  * @param scope The scope in which to define this construct
