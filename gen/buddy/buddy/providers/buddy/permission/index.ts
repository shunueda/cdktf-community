// https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/permission
...
export interface PermissionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/permission#description Permission#description}
  */
  readonly description?: string;
  /**
  * The workspace's URL handle
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/permission#domain Permission#domain}
  */
  readonly domain: string;
  /**
  * The permission's name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/permission#name Permission#name}
  */
  readonly name: string;
  /**
  * The permission's access level to pipelines. Allowed: `DENIED`, `READ_ONLY`, `RUN_ONLY`, `READ_WRITE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/permission#pipeline_access_level Permission#pipeline_access_level}
  */
  readonly pipelineAccessLevel: string;
  /**
  * The permission's access level to team. Allowed: `READ_ONLY`, `MANAGE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/permission#project_team_access_level Permission#project_team_access_level}
  */
  readonly projectTeamAccessLevel?: string;
  /**
  * The permission's access level to repository. Allowed: `READ_ONLY`, `READ_WRITE`, `MANAGE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/permission#repository_access_level Permission#repository_access_level}
  */
  readonly repositoryAccessLevel: string;
  /**
  * The permission's access level to sandboxes. Allowed: `DENIED`, `READ_ONLY`, `READ_WRITE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/permission#sandbox_access_level Permission#sandbox_access_level}
  */
  readonly sandboxAccessLevel: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/permission buddy_permission}
*/
export class Permission extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Permission that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/permission buddy_permission} Resource
  *
  * @param scope The scope in which to define this construct
