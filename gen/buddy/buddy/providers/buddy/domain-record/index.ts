// https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/domain_record
...
export interface DomainRecordConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/domain_record#continent DomainRecord#continent}
  */
  readonly continent?: { [key: string]: string[] } | cdktf.IResolvable;
  /**
  * The record's geolocation country list
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/domain_record#country DomainRecord#country}
  */
  readonly country?: { [key: string]: string[] } | cdktf.IResolvable;
  /**
  * The record's full domain name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/domain_record#domain DomainRecord#domain}
  */
  readonly domain: string;
  /**
  * The domain's ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/domain_record#domain_id DomainRecord#domain_id}
  */
  readonly domainId: string;
  /**
  * The record's routing type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/domain_record#routing DomainRecord#routing}
  */
  readonly routing?: string;
  /**
  * The record's ttl
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/domain_record#ttl DomainRecord#ttl}
  */
  readonly ttl?: number;
  /**
  * The record's type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/domain_record#type DomainRecord#type}
  */
  readonly type: string;
  /**
  * The record's value list
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/domain_record#value DomainRecord#value}
  */
  readonly value: string[];
  /**
  * The workspace's URL handle
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/domain_record#workspace_domain DomainRecord#workspace_domain}
  */
  readonly workspaceDomain: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/domain_record buddy_domain_record}
*/
export class DomainRecord extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DomainRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/domain_record#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/domain_record buddy_domain_record} Resource
  *
  * @param scope The scope in which to define this construct
