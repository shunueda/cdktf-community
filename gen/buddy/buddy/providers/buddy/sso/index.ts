// https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sso
...
export interface SsoConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sso#certificate Sso#certificate}
  */
  readonly certificate?: string;
  /**
  * The OIDC application's Client ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sso#client_id Sso#client_id}
  */
  readonly clientId?: string;
  /**
  * The OIDC application's Client Secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sso#client_secret Sso#client_secret}
  */
  readonly clientSecret?: string;
  /**
  * The SAML digest algorithm. Allowed: `sha1`, `sha256`, `sha512`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sso#digest Sso#digest}
  */
  readonly digest?: string;
  /**
  * The workspace's URL handle
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sso#domain Sso#domain}
  */
  readonly domain: string;
  /**
  * The identity provider issuer url
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sso#issuer Sso#issuer}
  */
  readonly issuer: string;
  /**
  * Enable mandatory SAML SSO authentication for all workspace members
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sso#require_for_all Sso#require_for_all}
  */
  readonly requireForAll?: boolean | cdktf.IResolvable;
  /**
  * The SAML signature algorithm. Allowed: `sha1`, `sha256`, `sha512`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sso#signature Sso#signature}
  */
  readonly signature?: string;
  /**
  * The identity provider single sign-on url
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sso#sso_url Sso#sso_url}
  */
  readonly ssoUrl?: string;
  /**
  * The SSO type. Allowed: `SAML`, `OIDC`. Default: `SAML`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sso#type Sso#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sso buddy_sso}
*/
export class Sso extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Sso that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sso#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/resources/sso buddy_sso} Resource
  *
  * @param scope The scope in which to define this construct
