// https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/webhooks
...
export interface DataBuddyWebhooksConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/webhooks#domain DataBuddyWebhooks#domain}
  */
  readonly domain: string;
  /**
  * The webhook's target_url regular expression to match
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/webhooks#target_url_regex DataBuddyWebhooks#target_url_regex}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/webhooks buddy_webhooks}
*/
export class DataBuddyWebhooks extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBuddyWebhooks that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/webhooks#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.36.0/docs/data-sources/webhooks buddy_webhooks} Data Source
  *
  * @param scope The scope in which to define this construct
