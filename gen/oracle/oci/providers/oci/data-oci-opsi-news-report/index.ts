// https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/opsi_news_report
...
export interface DataOciOpsiNewsReportConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/opsi_news_report#news_report_id DataOciOpsiNewsReport#news_report_id}
  */
...
export function dataOciOpsiNewsReportContentTypesToHclTerraform(struct?: DataOciOpsiNewsReportContentTypes): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/opsi_news_report oci_opsi_news_report}
*/
export class DataOciOpsiNewsReport extends cdktf.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataOciOpsiNewsReport to import
  * @param importFromId The id of the existing DataOciOpsiNewsReport that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/opsi_news_report#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataOciOpsiNewsReport to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/opsi_news_report oci_opsi_news_report} Data Source
  *
  * @param scope The scope in which to define this construct
