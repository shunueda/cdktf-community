// https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_key_store
...
export interface DatabaseKeyStoreConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_key_store#compartment_id DatabaseKeyStore#compartment_id}
  */
  readonly compartmentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_key_store#confirm_details_trigger DatabaseKeyStore#confirm_details_trigger}
  */
  readonly confirmDetailsTrigger?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_key_store#defined_tags DatabaseKeyStore#defined_tags}
  */
  readonly definedTags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_key_store#display_name DatabaseKeyStore#display_name}
  */
  readonly displayName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_key_store#freeform_tags DatabaseKeyStore#freeform_tags}
  */
  readonly freeformTags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_key_store#id DatabaseKeyStore#id}
  *
...
export interface DatabaseKeyStoreAssociatedLongTermBackups {
}

export function databaseKeyStoreAssociatedLongTermBackupsToTerraform(struct?: DatabaseKeyStoreAssociatedLongTermBackups): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function databaseKeyStoreAssociatedLongTermBackupsToHclTerraform(struct?: DatabaseKeyStoreAssociatedLongTermBackups): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DatabaseKeyStoreAssociatedLongTermBackupsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DatabaseKeyStoreAssociatedLongTermBackups | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DatabaseKeyStoreAssociatedLongTermBackups | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DatabaseKeyStoreAssociatedLongTermBackupsList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DatabaseKeyStoreAssociatedLongTermBackupsOutputReference {
    return new DatabaseKeyStoreAssociatedLongTermBackupsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DatabaseKeyStoreTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_key_store#create DatabaseKeyStore#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_key_store#delete DatabaseKeyStore#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_key_store#update DatabaseKeyStore#update}
  */
...
export interface DatabaseKeyStoreTypeDetails {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_key_store#admin_username DatabaseKeyStore#admin_username}
  */
  readonly adminUsername: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_key_store#connection_ips DatabaseKeyStore#connection_ips}
  */
  readonly connectionIps: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_key_store#secret_id DatabaseKeyStore#secret_id}
  */
  readonly secretId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_key_store#type DatabaseKeyStore#type}
  */
  readonly type: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_key_store#vault_id DatabaseKeyStore#vault_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_key_store oci_database_key_store}
*/
export class DatabaseKeyStore extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabaseKeyStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_key_store#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_key_store oci_database_key_store} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _associatedLongTermBackups = new DatabaseKeyStoreAssociatedLongTermBackupsList(this, "associated_long_term_backups", false);
