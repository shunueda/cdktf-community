// https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_external_container_database_management
...
export interface DatabaseExternalContainerDatabaseManagementConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_external_container_database_management#enable_management DatabaseExternalContainerDatabaseManagement#enable_management}
  */
  readonly enableManagement: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_external_container_database_management#external_container_database_id DatabaseExternalContainerDatabaseManagement#external_container_database_id}
  */
  readonly externalContainerDatabaseId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_external_container_database_management#external_database_connector_id DatabaseExternalContainerDatabaseManagement#external_database_connector_id}
  */
  readonly externalDatabaseConnectorId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_external_container_database_management#id DatabaseExternalContainerDatabaseManagement#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_external_container_database_management#license_model DatabaseExternalContainerDatabaseManagement#license_model}
  */
...
export interface DatabaseExternalContainerDatabaseManagementTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_external_container_database_management#create DatabaseExternalContainerDatabaseManagement#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_external_container_database_management#delete DatabaseExternalContainerDatabaseManagement#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_external_container_database_management#update DatabaseExternalContainerDatabaseManagement#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_external_container_database_management oci_database_external_container_database_management}
*/
export class DatabaseExternalContainerDatabaseManagement extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabaseExternalContainerDatabaseManagement that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_external_container_database_management#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/resources/database_external_container_database_management oci_database_external_container_database_management} Resource
  *
  * @param scope The scope in which to define this construct
