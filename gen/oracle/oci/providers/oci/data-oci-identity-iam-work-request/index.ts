// https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/identity_iam_work_request
...
export interface DataOciIdentityIamWorkRequestConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/identity_iam_work_request#iam_work_request_id DataOciIdentityIamWorkRequest#iam_work_request_id}
  */
  readonly iamWorkRequestId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/identity_iam_work_request#id DataOciIdentityIamWorkRequest#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/identity_iam_work_request oci_identity_iam_work_request}
*/
export class DataOciIdentityIamWorkRequest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciIdentityIamWorkRequest that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/identity_iam_work_request#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/identity_iam_work_request oci_identity_iam_work_request} Data Source
  *
  * @param scope The scope in which to define this construct
