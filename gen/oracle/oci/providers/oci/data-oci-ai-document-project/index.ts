// https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/ai_document_project
...
export interface DataOciAiDocumentProjectConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/ai_document_project#project_id DataOciAiDocumentProject#project_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/ai_document_project oci_ai_document_project}
*/
export class DataOciAiDocumentProject extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciAiDocumentProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/ai_document_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/ai_document_project oci_ai_document_project} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataOciAiDocumentProjectConfig
  */
  public constructor(scope: Construct, id: string, config: DataOciAiDocumentProjectConfig) {
    super(scope, id, {
