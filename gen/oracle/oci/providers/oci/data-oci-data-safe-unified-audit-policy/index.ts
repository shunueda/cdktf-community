// https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/data_safe_unified_audit_policy
...
export interface DataOciDataSafeUnifiedAuditPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/data_safe_unified_audit_policy#unified_audit_policy_id DataOciDataSafeUnifiedAuditPolicy#unified_audit_policy_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/data_safe_unified_audit_policy oci_data_safe_unified_audit_policy}
*/
export class DataOciDataSafeUnifiedAuditPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataSafeUnifiedAuditPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/data_safe_unified_audit_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/data_safe_unified_audit_policy oci_data_safe_unified_audit_policy} Data Source
  *
  * @param scope The scope in which to define this construct
