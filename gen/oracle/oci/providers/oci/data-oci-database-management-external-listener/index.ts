// https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/database_management_external_listener
...
export interface DataOciDatabaseManagementExternalListenerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/database_management_external_listener#external_listener_id DataOciDatabaseManagementExternalListener#external_listener_id}
  */
  readonly externalListenerId: string;
}
export interface DataOciDatabaseManagementExternalListenerEndpoints {
}

export function dataOciDatabaseManagementExternalListenerEndpointsToTerraform(struct?: DataOciDatabaseManagementExternalListenerEndpoints): any {
...
export class DataOciDatabaseManagementExternalListenerEndpointsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataOciDatabaseManagementExternalListenerEndpoints | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataOciDatabaseManagementExternalListenerEndpoints | undefined) {
    if (value === undefined) {
...
export class DataOciDatabaseManagementExternalListenerEndpointsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataOciDatabaseManagementExternalListenerEndpointsOutputReference {
    return new DataOciDatabaseManagementExternalListenerEndpointsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataOciDatabaseManagementExternalListenerServicedAsms {
}

export function dataOciDatabaseManagementExternalListenerServicedAsmsToTerraform(struct?: DataOciDatabaseManagementExternalListenerServicedAsms): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataOciDatabaseManagementExternalListenerServicedAsmsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataOciDatabaseManagementExternalListenerServicedAsms | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataOciDatabaseManagementExternalListenerServicedAsms | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataOciDatabaseManagementExternalListenerServicedAsmsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataOciDatabaseManagementExternalListenerServicedAsmsOutputReference {
    return new DataOciDatabaseManagementExternalListenerServicedAsmsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataOciDatabaseManagementExternalListenerServicedDatabases {
}

export function dataOciDatabaseManagementExternalListenerServicedDatabasesToTerraform(struct?: DataOciDatabaseManagementExternalListenerServicedDatabases): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataOciDatabaseManagementExternalListenerServicedDatabasesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataOciDatabaseManagementExternalListenerServicedDatabases | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataOciDatabaseManagementExternalListenerServicedDatabases | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataOciDatabaseManagementExternalListenerServicedDatabasesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataOciDatabaseManagementExternalListenerServicedDatabasesOutputReference {
    return new DataOciDatabaseManagementExternalListenerServicedDatabasesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/database_management_external_listener oci_database_management_external_listener}
*/
export class DataOciDatabaseManagementExternalListener extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseManagementExternalListener that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/database_management_external_listener#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/database_management_external_listener oci_database_management_external_listener} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataOciDatabaseManagementExternalListenerConfig
  */
  public constructor(scope: Construct, id: string, config: DataOciDatabaseManagementExternalListenerConfig) {
    super(scope, id, {
  ...
  private _endpoints = new DataOciDatabaseManagementExternalListenerEndpointsList(this, "endpoints", false);
  ...
  private _servicedAsms = new DataOciDatabaseManagementExternalListenerServicedAsmsList(this, "serviced_asms", false);
  public get servicedAsms() {
    return this._servicedAsms;
  }

  // serviced_databases - computed: true, optional: false, required: false
  private _servicedDatabases = new DataOciDatabaseManagementExternalListenerServicedDatabasesList(this, "serviced_databases", false);
