// https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/database_cloud_exadata_infrastructure
...
export interface DataOciDatabaseCloudExadataInfrastructureConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/database_cloud_exadata_infrastructure#cloud_exadata_infrastructure_id DataOciDatabaseCloudExadataInfrastructure#cloud_exadata_infrastructure_id}
  */
...
export interface DataOciDatabaseCloudExadataInfrastructureExascaleConfig {
}

export function dataOciDatabaseCloudExadataInfrastructureExascaleConfigToTerraform(struct?: DataOciDatabaseCloudExadataInfrastructureExascaleConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataOciDatabaseCloudExadataInfrastructureExascaleConfigToHclTerraform(struct?: DataOciDatabaseCloudExadataInfrastructureExascaleConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataOciDatabaseCloudExadataInfrastructureExascaleConfigOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataOciDatabaseCloudExadataInfrastructureExascaleConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataOciDatabaseCloudExadataInfrastructureExascaleConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataOciDatabaseCloudExadataInfrastructureExascaleConfigList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataOciDatabaseCloudExadataInfrastructureExascaleConfigOutputReference {
    return new DataOciDatabaseCloudExadataInfrastructureExascaleConfigOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/database_cloud_exadata_infrastructure oci_database_cloud_exadata_infrastructure}
*/
export class DataOciDatabaseCloudExadataInfrastructure extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseCloudExadataInfrastructure that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/database_cloud_exadata_infrastructure#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.23.0/docs/data-sources/database_cloud_exadata_infrastructure oci_database_cloud_exadata_infrastructure} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _exascaleConfig = new DataOciDatabaseCloudExadataInfrastructureExascaleConfigList(this, "exascale_config", false);
