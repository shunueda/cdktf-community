// https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/deployment_access
...
export interface DeploymentAccessConfig extends cdktf.TerraformMetaArguments {
  ...
  * Account ID (UUID)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/deployment_access#account_id DeploymentAccess#account_id}
  */
  readonly accountId?: string;
  /**
  * Deployment ID (UUID)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/deployment_access#deployment_id DeploymentAccess#deployment_id}
  */
  readonly deploymentId: string;
  /**
  * List of actor IDs with manage access to the Deployment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/deployment_access#manage_actor_ids DeploymentAccess#manage_actor_ids}
  */
  readonly manageActorIds?: string[];
  /**
  * List of team IDs with manage access to the Deployment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/deployment_access#manage_team_ids DeploymentAccess#manage_team_ids}
  */
  readonly manageTeamIds?: string[];
  /**
  * List of actor IDs with run access to the Deployment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/deployment_access#run_actor_ids DeploymentAccess#run_actor_ids}
  */
  readonly runActorIds?: string[];
  /**
  * List of team IDs with run access to the Deployment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/deployment_access#run_team_ids DeploymentAccess#run_team_ids}
  */
  readonly runTeamIds?: string[];
  /**
  * List of actor IDs with view access to the Deployment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/deployment_access#view_actor_ids DeploymentAccess#view_actor_ids}
  */
  readonly viewActorIds?: string[];
  /**
  * List of team IDs with view access to the Deployment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/deployment_access#view_team_ids DeploymentAccess#view_team_ids}
  */
  readonly viewTeamIds?: string[];
  /**
  * Workspace ID (UUID)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/deployment_access#workspace_id DeploymentAccess#workspace_id}
  */
  readonly workspaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/deployment_access prefect_deployment_access}
*/
export class DeploymentAccess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DeploymentAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/deployment_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/deployment_access prefect_deployment_access} Resource
  *
  * @param scope The scope in which to define this construct
