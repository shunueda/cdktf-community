// https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/account
...
export interface AccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/account#billing_email Account#billing_email}
  */
  readonly billingEmail?: string;
  /**
  * The list of domain names for enabling SSO in Prefect Cloud.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/account#domain_names Account#domain_names}
  */
  readonly domainNames?: string[];
  /**
  * Unique handle of the account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/account#handle Account#handle}
  */
  readonly handle: string;
  /**
  * An optional for an external url associated with the account, e.g. https://prefect.io/
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/account#link Account#link}
  */
  readonly link?: string;
  /**
  * An optional physical location for the account, e.g. Washington, D.C.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/account#location Account#location}
  */
  readonly location?: string;
  /**
  * Name of the account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/account#name Account#name}
  */
  readonly name: string;
  /**
  * Group of settings related to accounts
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/account#settings Account#settings}
  */
...
export interface AccountSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/account#ai_log_summaries Account#ai_log_summaries}
  */
  readonly aiLogSummaries?: boolean | cdktf.IResolvable;
  /**
  * Whether or not this account allows public workspaces
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/account#allow_public_workspaces Account#allow_public_workspaces}
  */
  readonly allowPublicWorkspaces?: boolean | cdktf.IResolvable;
  /**
  * Whether to enable the use of managed work pools
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/account#managed_execution Account#managed_execution}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/account prefect_account}
*/
export class Account extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Account that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs/resources/account prefect_account} Resource
  *
  * @param scope The scope in which to define this construct
