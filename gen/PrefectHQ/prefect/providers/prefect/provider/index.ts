// https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs
...
export interface PrefectProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs#account_id PrefectProvider#account_id}
  */
  readonly accountId?: string;
  /**
  * Prefect Cloud API key. Can also be set via the `PREFECT_API_KEY` environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs#api_key PrefectProvider#api_key}
  */
  readonly apiKey?: string;
  /**
  * Prefect basic auth key. Can also be set via the `PREFECT_BASIC_AUTH_KEY` environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs#basic_auth_key PrefectProvider#basic_auth_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs#csrf_enabled PrefectProvider#csrf_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs#endpoint PrefectProvider#endpoint}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs#profile PrefectProvider#profile}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs#profile_file PrefectProvider#profile_file}
  */
  readonly profileFile?: string;
  /**
  * Default Prefect Cloud Workspace ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs#workspace_id PrefectProvider#workspace_id}
  */
  readonly workspaceId?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs#alias PrefectProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs prefect}
*/
export class PrefectProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing PrefectProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.89.0/docs prefect} Resource
  *
  * @param scope The scope in which to define this construct
