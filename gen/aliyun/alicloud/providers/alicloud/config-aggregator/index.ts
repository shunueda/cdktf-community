// https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/config_aggregator
...
export interface ConfigAggregatorConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/config_aggregator#aggregator_name ConfigAggregator#aggregator_name}
  */
  readonly aggregatorName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/config_aggregator#aggregator_type ConfigAggregator#aggregator_type}
  */
  readonly aggregatorType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/config_aggregator#description ConfigAggregator#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/config_aggregator#id ConfigAggregator#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/config_aggregator#aggregator_accounts ConfigAggregator#aggregator_accounts}
  */
  readonly aggregatorAccounts?: ConfigAggregatorAggregatorAccounts[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/config_aggregator#timeouts ConfigAggregator#timeouts}
  */
  readonly timeouts?: ConfigAggregatorTimeouts;
}
export interface ConfigAggregatorAggregatorAccounts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/config_aggregator#account_id ConfigAggregator#account_id}
  */
  readonly accountId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/config_aggregator#account_name ConfigAggregator#account_name}
  */
  readonly accountName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/config_aggregator#account_type ConfigAggregator#account_type}
  */
...
export interface ConfigAggregatorTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/config_aggregator#create ConfigAggregator#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/config_aggregator alicloud_config_aggregator}
*/
export class ConfigAggregator extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigAggregator that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/config_aggregator#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/config_aggregator alicloud_config_aggregator} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _aggregatorAccounts = new ConfigAggregatorAggregatorAccountsList(this, "aggregator_accounts", true);
