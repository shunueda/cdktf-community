// https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_primary_endpoint
...
export interface PolardbPrimaryEndpointConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_primary_endpoint#connection_prefix PolardbPrimaryEndpoint#connection_prefix}
  */
  readonly connectionPrefix?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_primary_endpoint#db_cluster_id PolardbPrimaryEndpoint#db_cluster_id}
  */
  readonly dbClusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_primary_endpoint#db_endpoint_description PolardbPrimaryEndpoint#db_endpoint_description}
  */
  readonly dbEndpointDescription?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_primary_endpoint#id PolardbPrimaryEndpoint#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_primary_endpoint#net_type PolardbPrimaryEndpoint#net_type}
  */
  readonly netType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_primary_endpoint#port PolardbPrimaryEndpoint#port}
  */
  readonly port?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_primary_endpoint#ssl_auto_rotate PolardbPrimaryEndpoint#ssl_auto_rotate}
  */
  readonly sslAutoRotate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_primary_endpoint#ssl_enabled PolardbPrimaryEndpoint#ssl_enabled}
  */
  readonly sslEnabled?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_primary_endpoint alicloud_polardb_primary_endpoint}
*/
export class PolardbPrimaryEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolardbPrimaryEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_primary_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_primary_endpoint alicloud_polardb_primary_endpoint} Resource
  *
  * @param scope The scope in which to define this construct
