// https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/esa_compression_rule
...
export interface EsaCompressionRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/esa_compression_rule#brotli EsaCompressionRule#brotli}
  */
  readonly brotli?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/esa_compression_rule#gzip EsaCompressionRule#gzip}
  */
  readonly gzip?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/esa_compression_rule#id EsaCompressionRule#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/esa_compression_rule#rule EsaCompressionRule#rule}
  */
  readonly rule?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/esa_compression_rule#rule_enable EsaCompressionRule#rule_enable}
  */
  readonly ruleEnable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/esa_compression_rule#rule_name EsaCompressionRule#rule_name}
  */
  readonly ruleName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/esa_compression_rule#site_id EsaCompressionRule#site_id}
  */
  readonly siteId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/esa_compression_rule#site_version EsaCompressionRule#site_version}
  */
  readonly siteVersion?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/esa_compression_rule#zstd EsaCompressionRule#zstd}
  */
  readonly zstd?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/esa_compression_rule#timeouts EsaCompressionRule#timeouts}
  */
  readonly timeouts?: EsaCompressionRuleTimeouts;
}
export interface EsaCompressionRuleTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/esa_compression_rule#create EsaCompressionRule#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/esa_compression_rule#delete EsaCompressionRule#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/esa_compression_rule#update EsaCompressionRule#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/esa_compression_rule alicloud_esa_compression_rule}
*/
export class EsaCompressionRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EsaCompressionRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/esa_compression_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/esa_compression_rule alicloud_esa_compression_rule} Resource
  *
  * @param scope The scope in which to define this construct
