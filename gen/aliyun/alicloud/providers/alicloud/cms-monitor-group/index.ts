// https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/cms_monitor_group
...
export interface CmsMonitorGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/cms_monitor_group#contact_groups CmsMonitorGroup#contact_groups}
  */
  readonly contactGroups?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/cms_monitor_group#id CmsMonitorGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/cms_monitor_group#monitor_group_name CmsMonitorGroup#monitor_group_name}
  */
  readonly monitorGroupName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/cms_monitor_group#resource_group_id CmsMonitorGroup#resource_group_id}
  */
  readonly resourceGroupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/cms_monitor_group#resource_group_name CmsMonitorGroup#resource_group_name}
  */
  readonly resourceGroupName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/cms_monitor_group#tags CmsMonitorGroup#tags}
  */
  readonly tags?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/cms_monitor_group alicloud_cms_monitor_group}
*/
export class CmsMonitorGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CmsMonitorGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/cms_monitor_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/cms_monitor_group alicloud_cms_monitor_group} Resource
  *
  * @param scope The scope in which to define this construct
