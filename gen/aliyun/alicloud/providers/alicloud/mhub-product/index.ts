// https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/mhub_product
...
export interface MhubProductConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/mhub_product#id MhubProduct#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/mhub_product#product_name MhubProduct#product_name}
  */
  readonly productName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/mhub_product alicloud_mhub_product}
*/
export class MhubProduct extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MhubProduct that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/mhub_product#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/mhub_product alicloud_mhub_product} Resource
  *
  * @param scope The scope in which to define this construct
