// https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_snat_entry
...
export interface SagSnatEntryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_snat_entry#cidr_block SagSnatEntry#cidr_block}
  */
  readonly cidrBlock: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_snat_entry#id SagSnatEntry#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_snat_entry#sag_id SagSnatEntry#sag_id}
  */
  readonly sagId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_snat_entry#snat_ip SagSnatEntry#snat_ip}
  */
  readonly snatIp: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_snat_entry alicloud_sag_snat_entry}
*/
export class SagSnatEntry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SagSnatEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_snat_entry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_snat_entry alicloud_sag_snat_entry} Resource
  *
  * @param scope The scope in which to define this construct
