// https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_endpoint
...
export interface PolardbEndpointConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_endpoint#auto_add_new_nodes PolardbEndpoint#auto_add_new_nodes}
  */
  readonly autoAddNewNodes?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_endpoint#connection_prefix PolardbEndpoint#connection_prefix}
  */
  readonly connectionPrefix?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_endpoint#db_cluster_id PolardbEndpoint#db_cluster_id}
  */
  readonly dbClusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_endpoint#db_endpoint_description PolardbEndpoint#db_endpoint_description}
  */
  readonly dbEndpointDescription?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_endpoint#endpoint_config PolardbEndpoint#endpoint_config}
  */
  readonly endpointConfig?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_endpoint#endpoint_type PolardbEndpoint#endpoint_type}
  */
  readonly endpointType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_endpoint#id PolardbEndpoint#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_endpoint#net_type PolardbEndpoint#net_type}
  */
  readonly netType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_endpoint#nodes PolardbEndpoint#nodes}
  */
  readonly nodes?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_endpoint#port PolardbEndpoint#port}
  */
  readonly port?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_endpoint#read_write_mode PolardbEndpoint#read_write_mode}
  */
  readonly readWriteMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_endpoint#ssl_auto_rotate PolardbEndpoint#ssl_auto_rotate}
  */
  readonly sslAutoRotate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_endpoint#ssl_enabled PolardbEndpoint#ssl_enabled}
  */
  readonly sslEnabled?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_endpoint alicloud_polardb_endpoint}
*/
export class PolardbEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolardbEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/polardb_endpoint alicloud_polardb_endpoint} Resource
  *
  * @param scope The scope in which to define this construct
