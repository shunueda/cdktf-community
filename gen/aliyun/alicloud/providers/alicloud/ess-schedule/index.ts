// https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/ess_schedule
...
export interface EssScheduleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/ess_schedule#description EssSchedule#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/ess_schedule#desired_capacity EssSchedule#desired_capacity}
  */
  readonly desiredCapacity?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/ess_schedule#id EssSchedule#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/ess_schedule#launch_expiration_time EssSchedule#launch_expiration_time}
  */
  readonly launchExpirationTime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/ess_schedule#launch_time EssSchedule#launch_time}
  */
  readonly launchTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/ess_schedule#max_value EssSchedule#max_value}
  */
  readonly maxValue?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/ess_schedule#min_value EssSchedule#min_value}
  */
  readonly minValue?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/ess_schedule#recurrence_end_time EssSchedule#recurrence_end_time}
  */
  readonly recurrenceEndTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/ess_schedule#recurrence_type EssSchedule#recurrence_type}
  */
  readonly recurrenceType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/ess_schedule#recurrence_value EssSchedule#recurrence_value}
  */
  readonly recurrenceValue?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/ess_schedule#scaling_group_id EssSchedule#scaling_group_id}
  */
  readonly scalingGroupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/ess_schedule#scheduled_action EssSchedule#scheduled_action}
  */
  readonly scheduledAction?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/ess_schedule#scheduled_task_name EssSchedule#scheduled_task_name}
  */
  readonly scheduledTaskName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/ess_schedule#task_enabled EssSchedule#task_enabled}
  */
  readonly taskEnabled?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/ess_schedule alicloud_ess_schedule}
*/
export class EssSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EssSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/ess_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/ess_schedule alicloud_ess_schedule} Resource
  *
  * @param scope The scope in which to define this construct
