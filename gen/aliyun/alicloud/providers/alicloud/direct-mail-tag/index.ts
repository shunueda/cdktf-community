// https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/direct_mail_tag
...
export interface DirectMailTagConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/direct_mail_tag#id DirectMailTag#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/direct_mail_tag#tag_name DirectMailTag#tag_name}
  */
  readonly tagName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/direct_mail_tag alicloud_direct_mail_tag}
*/
export class DirectMailTag extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DirectMailTag that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/direct_mail_tag#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/direct_mail_tag alicloud_direct_mail_tag} Resource
  *
  * @param scope The scope in which to define this construct
