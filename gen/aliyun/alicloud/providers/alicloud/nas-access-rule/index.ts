// https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/nas_access_rule
...
export interface NasAccessRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/nas_access_rule#access_group_name NasAccessRule#access_group_name}
  */
  readonly accessGroupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/nas_access_rule#file_system_type NasAccessRule#file_system_type}
  */
  readonly fileSystemType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/nas_access_rule#id NasAccessRule#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/nas_access_rule#ipv6_source_cidr_ip NasAccessRule#ipv6_source_cidr_ip}
  */
  readonly ipv6SourceCidrIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/nas_access_rule#priority NasAccessRule#priority}
  */
  readonly priority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/nas_access_rule#rw_access_type NasAccessRule#rw_access_type}
  */
  readonly rwAccessType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/nas_access_rule#source_cidr_ip NasAccessRule#source_cidr_ip}
  */
  readonly sourceCidrIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/nas_access_rule#user_access_type NasAccessRule#user_access_type}
  */
  readonly userAccessType?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/nas_access_rule#timeouts NasAccessRule#timeouts}
  */
  readonly timeouts?: NasAccessRuleTimeouts;
}
export interface NasAccessRuleTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/nas_access_rule#create NasAccessRule#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/nas_access_rule#delete NasAccessRule#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/nas_access_rule#update NasAccessRule#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/nas_access_rule alicloud_nas_access_rule}
*/
export class NasAccessRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NasAccessRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/nas_access_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/nas_access_rule alicloud_nas_access_rule} Resource
  *
  * @param scope The scope in which to define this construct
