// https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_qos_policy
...
export interface SagQosPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_qos_policy#description SagQosPolicy#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_qos_policy#dest_cidr SagQosPolicy#dest_cidr}
  */
  readonly destCidr: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_qos_policy#dest_port_range SagQosPolicy#dest_port_range}
  */
  readonly destPortRange: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_qos_policy#end_time SagQosPolicy#end_time}
  */
  readonly endTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_qos_policy#id SagQosPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_qos_policy#ip_protocol SagQosPolicy#ip_protocol}
  */
  readonly ipProtocol: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_qos_policy#name SagQosPolicy#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_qos_policy#priority SagQosPolicy#priority}
  */
  readonly priority: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_qos_policy#qos_id SagQosPolicy#qos_id}
  */
  readonly qosId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_qos_policy#source_cidr SagQosPolicy#source_cidr}
  */
  readonly sourceCidr: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_qos_policy#source_port_range SagQosPolicy#source_port_range}
  */
  readonly sourcePortRange: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_qos_policy#start_time SagQosPolicy#start_time}
  */
  readonly startTime?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_qos_policy alicloud_sag_qos_policy}
*/
export class SagQosPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SagQosPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_qos_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/sag_qos_policy alicloud_sag_qos_policy} Resource
  *
  * @param scope The scope in which to define this construct
