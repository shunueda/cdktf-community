// https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/dts_synchronization_instance
...
export interface DtsSynchronizationInstanceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/dts_synchronization_instance#auto_pay DtsSynchronizationInstance#auto_pay}
  */
  readonly autoPay?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/dts_synchronization_instance#auto_start DtsSynchronizationInstance#auto_start}
  */
  readonly autoStart?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/dts_synchronization_instance#compute_unit DtsSynchronizationInstance#compute_unit}
  */
  readonly computeUnit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/dts_synchronization_instance#database_count DtsSynchronizationInstance#database_count}
  */
  readonly databaseCount?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/dts_synchronization_instance#destination_endpoint_engine_name DtsSynchronizationInstance#destination_endpoint_engine_name}
  */
  readonly destinationEndpointEngineName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/dts_synchronization_instance#destination_endpoint_region DtsSynchronizationInstance#destination_endpoint_region}
  */
  readonly destinationEndpointRegion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/dts_synchronization_instance#id DtsSynchronizationInstance#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/dts_synchronization_instance#instance_class DtsSynchronizationInstance#instance_class}
  */
  readonly instanceClass?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/dts_synchronization_instance#payment_duration DtsSynchronizationInstance#payment_duration}
  */
  readonly paymentDuration?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/dts_synchronization_instance#payment_duration_unit DtsSynchronizationInstance#payment_duration_unit}
  */
  readonly paymentDurationUnit?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/dts_synchronization_instance#payment_type DtsSynchronizationInstance#payment_type}
  */
  readonly paymentType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/dts_synchronization_instance#quantity DtsSynchronizationInstance#quantity}
  */
  readonly quantity?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/dts_synchronization_instance#source_endpoint_engine_name DtsSynchronizationInstance#source_endpoint_engine_name}
  */
  readonly sourceEndpointEngineName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/dts_synchronization_instance#source_endpoint_region DtsSynchronizationInstance#source_endpoint_region}
  */
  readonly sourceEndpointRegion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/dts_synchronization_instance#sync_architecture DtsSynchronizationInstance#sync_architecture}
  */
  readonly syncArchitecture?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/dts_synchronization_instance alicloud_dts_synchronization_instance}
*/
export class DtsSynchronizationInstance extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alicloud_dts_synchronization_instance";
  ...
  * @param importFromId The id of the existing DtsSynchronizationInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/dts_synchronization_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alicloud_dts_synchronization_instance", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.261.0/docs/resources/dts_synchronization_instance alicloud_dts_synchronization_instance} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  public get autoStart() {
    return this.getStringAttribute('auto_start');
  }
  public set autoStart(value: string) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      auto_start: cdktf.stringToTerraform(this._autoStart),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      auto_start: {
        value: cdktf.stringToHclTerraform(this._autoStart),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
