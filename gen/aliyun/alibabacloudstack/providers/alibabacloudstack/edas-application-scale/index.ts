// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/edas_application_scale
...
export interface EdasApplicationScaleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/edas_application_scale#app_id EdasApplicationScale#app_id}
  */
  readonly appId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/edas_application_scale#deploy_group EdasApplicationScale#deploy_group}
  */
  readonly deployGroup: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/edas_application_scale#ecu_info EdasApplicationScale#ecu_info}
  */
  readonly ecuInfo: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/edas_application_scale#force_status EdasApplicationScale#force_status}
  */
  readonly forceStatus?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/edas_application_scale#id EdasApplicationScale#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/edas_application_scale alibabacloudstack_edas_application_scale}
*/
export class EdasApplicationScale extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_edas_application_scale";
  ...
  * @param importFromId The id of the existing EdasApplicationScale that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/edas_application_scale#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_edas_application_scale", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/edas_application_scale alibabacloudstack_edas_application_scale} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: EdasApplicationScaleConfig) {
    super(scope, id, {
      terraformResourceType: 'alibabacloudstack_edas_application_scale',
