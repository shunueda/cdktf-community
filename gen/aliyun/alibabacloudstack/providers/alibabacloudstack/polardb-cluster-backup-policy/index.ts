// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardb_cluster_backup_policy
...
export interface PolardbClusterBackupPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardb_cluster_backup_policy#data_level1_backup_period PolardbClusterBackupPolicy#data_level1_backup_period}
  */
  readonly dataLevel1BackupPeriod?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardb_cluster_backup_policy#data_level1_backup_retention_period PolardbClusterBackupPolicy#data_level1_backup_retention_period}
  */
  readonly dataLevel1BackupRetentionPeriod?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardb_cluster_backup_policy#data_level1_backup_time PolardbClusterBackupPolicy#data_level1_backup_time}
  */
  readonly dataLevel1BackupTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardb_cluster_backup_policy#db_cluster_id PolardbClusterBackupPolicy#db_cluster_id}
  */
  readonly dbClusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardb_cluster_backup_policy#id PolardbClusterBackupPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardb_cluster_backup_policy#log_backup_retention_period PolardbClusterBackupPolicy#log_backup_retention_period}
  */
  readonly logBackupRetentionPeriod?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardb_cluster_backup_policy alibabacloudstack_polardb_cluster_backup_policy}
*/
export class PolardbClusterBackupPolicy extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardb_cluster_backup_policy alibabacloudstack_polardb_cluster_backup_policy} Resource
  *
  * @param scope The scope in which to define this construct
