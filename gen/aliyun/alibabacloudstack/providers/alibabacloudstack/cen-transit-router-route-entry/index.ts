// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_route_entry
...
export interface CenTransitRouterRouteEntryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_route_entry#id CenTransitRouterRouteEntry#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_route_entry#transit_router_route_entry_description CenTransitRouterRouteEntry#transit_router_route_entry_description}
  */
  readonly transitRouterRouteEntryDescription?: string;
  /**
  * Destination CIDR block of the route entry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_route_entry#transit_router_route_entry_destination_cidr_block CenTransitRouterRouteEntry#transit_router_route_entry_destination_cidr_block}
  */
  readonly transitRouterRouteEntryDestinationCidrBlock: string;
  /**
  * Name of the route entry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_route_entry#transit_router_route_entry_name CenTransitRouterRouteEntry#transit_router_route_entry_name}
  */
  readonly transitRouterRouteEntryName?: string;
  /**
  * Next hop ID of the route entry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_route_entry#transit_router_route_entry_next_hop_id CenTransitRouterRouteEntry#transit_router_route_entry_next_hop_id}
  */
  readonly transitRouterRouteEntryNextHopId?: string;
  /**
  * Next hop type of the route entry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_route_entry#transit_router_route_entry_next_hop_type CenTransitRouterRouteEntry#transit_router_route_entry_next_hop_type}
  */
  readonly transitRouterRouteEntryNextHopType: string;
  /**
  * ID of the route table.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_route_entry#transit_router_route_table_id CenTransitRouterRouteEntry#transit_router_route_table_id}
  */
  readonly transitRouterRouteTableId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_route_entry alibabacloudstack_cen_transit_router_route_entry}
*/
export class CenTransitRouterRouteEntry extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_cen_transit_router_route_entry";
  ...
  * @param importFromId The id of the existing CenTransitRouterRouteEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_route_entry#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_cen_transit_router_route_entry", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_route_entry alibabacloudstack_cen_transit_router_route_entry} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: CenTransitRouterRouteEntryConfig) {
    super(scope, id, {
      terraformResourceType: 'alibabacloudstack_cen_transit_router_route_entry',
