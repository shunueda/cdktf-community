// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardb_backup
...
export interface PolardbBackupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardb_backup#backup_method PolardbBackup#backup_method}
  */
  readonly backupMethod?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardb_backup#backup_strategy PolardbBackup#backup_strategy}
  */
  readonly backupStrategy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardb_backup#backup_type PolardbBackup#backup_type}
  */
  readonly backupType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardb_backup#db_instance_id PolardbBackup#db_instance_id}
  */
  readonly dbInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardb_backup#id PolardbBackup#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardb_backup alibabacloudstack_polardb_backup}
*/
export class PolardbBackup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolardbBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardb_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardb_backup alibabacloudstack_polardb_backup} Resource
  *
  * @param scope The scope in which to define this construct
