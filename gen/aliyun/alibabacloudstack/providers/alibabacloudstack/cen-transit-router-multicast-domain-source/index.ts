// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_multicast_domain_source
...
export interface CenTransitRouterMulticastDomainSourceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_multicast_domain_source#connect_attachment_id CenTransitRouterMulticastDomainSource#connect_attachment_id}
  */
  readonly connectAttachmentId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_multicast_domain_source#connect_peer_id CenTransitRouterMulticastDomainSource#connect_peer_id}
  */
  readonly connectPeerId?: string;
  /**
  * Multicast IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_multicast_domain_source#group_ip_address CenTransitRouterMulticastDomainSource#group_ip_address}
  */
  readonly groupIpAddress: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_multicast_domain_source#id CenTransitRouterMulticastDomainSource#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_multicast_domain_source#network_interface_id CenTransitRouterMulticastDomainSource#network_interface_id}
  */
  readonly networkInterfaceId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_multicast_domain_source#resource_type CenTransitRouterMulticastDomainSource#resource_type}
  */
  readonly resourceType: string;
  /**
  * Forwarding router multicast domain ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_multicast_domain_source#transit_router_multicast_domain_id CenTransitRouterMulticastDomainSource#transit_router_multicast_domain_id}
  */
  readonly transitRouterMulticastDomainId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_multicast_domain_source#vswitch_id CenTransitRouterMulticastDomainSource#vswitch_id}
  */
  readonly vswitchId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_multicast_domain_source alibabacloudstack_cen_transit_router_multicast_domain_source}
*/
export class CenTransitRouterMulticastDomainSource extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_cen_transit_router_multicast_domain_source";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_cen_transit_router_multicast_domain_source", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_multicast_domain_source alibabacloudstack_cen_transit_router_multicast_domain_source} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: CenTransitRouterMulticastDomainSourceConfig) {
    super(scope, id, {
      terraformResourceType: 'alibabacloudstack_cen_transit_router_multicast_domain_source',
