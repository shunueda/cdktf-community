// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_route_table_propagation
...
export interface CenTransitRouterRouteTablePropagationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_route_table_propagation#id CenTransitRouterRouteTablePropagation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_route_table_propagation#transit_router_attachment_id CenTransitRouterRouteTablePropagation#transit_router_attachment_id}
  */
  readonly transitRouterAttachmentId: string;
  /**
  * The ID of the transit router route table.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_route_table_propagation#transit_router_route_table_id CenTransitRouterRouteTablePropagation#transit_router_route_table_id}
  */
  readonly transitRouterRouteTableId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_route_table_propagation alibabacloudstack_cen_transit_router_route_table_propagation}
*/
export class CenTransitRouterRouteTablePropagation extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_cen_transit_router_route_table_propagation";
  ...
  * @param importFromId The id of the existing CenTransitRouterRouteTablePropagation that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_route_table_propagation#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_cen_transit_router_route_table_propagation", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/cen_transit_router_route_table_propagation alibabacloudstack_cen_transit_router_route_table_propagation} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: CenTransitRouterRouteTablePropagationConfig) {
    super(scope, id, {
      terraformResourceType: 'alibabacloudstack_cen_transit_router_route_table_propagation',
