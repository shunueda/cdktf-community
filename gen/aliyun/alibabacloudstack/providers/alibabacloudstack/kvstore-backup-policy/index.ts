// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/kvstore_backup_policy
...
export interface KvstoreBackupPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/kvstore_backup_policy#backup_period KvstoreBackupPolicy#backup_period}
  */
  readonly backupPeriod?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/kvstore_backup_policy#backup_time KvstoreBackupPolicy#backup_time}
  */
  readonly backupTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/kvstore_backup_policy#id KvstoreBackupPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/kvstore_backup_policy#instance_id KvstoreBackupPolicy#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/kvstore_backup_policy#preferred_backup_period KvstoreBackupPolicy#preferred_backup_period}
  */
  readonly preferredBackupPeriod?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/kvstore_backup_policy#preferred_backup_time KvstoreBackupPolicy#preferred_backup_time}
  */
  readonly preferredBackupTime?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/kvstore_backup_policy alibabacloudstack_kvstore_backup_policy}
*/
export class KvstoreBackupPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KvstoreBackupPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/kvstore_backup_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/kvstore_backup_policy alibabacloudstack_kvstore_backup_policy} Resource
  *
  * @param scope The scope in which to define this construct
