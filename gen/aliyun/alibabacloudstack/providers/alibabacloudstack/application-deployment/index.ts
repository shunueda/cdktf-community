// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/application_deployment
...
export interface ApplicationDeploymentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/application_deployment#app_id ApplicationDeployment#app_id}
  */
  readonly appId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/application_deployment#group_id ApplicationDeployment#group_id}
  */
  readonly groupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/application_deployment#id ApplicationDeployment#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/application_deployment#package_version ApplicationDeployment#package_version}
  */
  readonly packageVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/application_deployment#war_url ApplicationDeployment#war_url}
  */
  readonly warUrl: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/application_deployment alibabacloudstack_application_deployment}
*/
export class ApplicationDeployment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/application_deployment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/application_deployment alibabacloudstack_application_deployment} Resource
  *
  * @param scope The scope in which to define this construct
