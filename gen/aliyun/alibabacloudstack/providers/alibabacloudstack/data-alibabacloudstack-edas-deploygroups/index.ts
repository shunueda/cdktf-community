// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/data-sources/edas_deploygroups
...
export interface DataAlibabacloudstackEdasDeploygroupsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/data-sources/edas_deploygroups#app_id DataAlibabacloudstackEdasDeploygroups#app_id}
  */
  readonly appId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/data-sources/edas_deploygroups#id DataAlibabacloudstackEdasDeploygroups#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/data-sources/edas_deploygroups#name_regex DataAlibabacloudstackEdasDeploygroups#name_regex}
  */
  readonly nameRegex?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/data-sources/edas_deploygroups#output_file DataAlibabacloudstackEdasDeploygroups#output_file}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/data-sources/edas_deploygroups alibabacloudstack_edas_deploygroups}
*/
export class DataAlibabacloudstackEdasDeploygroups extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_edas_deploygroups";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_edas_deploygroups", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/data-sources/edas_deploygroups alibabacloudstack_edas_deploygroups} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAlibabacloudstackEdasDeploygroupsConfig) {
    super(scope, id, {
      terraformResourceType: 'alibabacloudstack_edas_deploygroups',
