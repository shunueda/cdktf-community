// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/ascm_user_role_binding
...
export interface AscmUserRoleBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/ascm_user_role_binding#id AscmUserRoleBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/ascm_user_role_binding#login_name AscmUserRoleBinding#login_name}
  */
  readonly loginName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/ascm_user_role_binding#role_ids AscmUserRoleBinding#role_ids}
  */
  readonly roleIds?: number[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/ascm_user_role_binding alibabacloudstack_ascm_user_role_binding}
*/
export class AscmUserRoleBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AscmUserRoleBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/ascm_user_role_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/ascm_user_role_binding alibabacloudstack_ascm_user_role_binding} Resource
  *
  * @param scope The scope in which to define this construct
