// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardbx_backup
...
export interface PolardbxBackupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardbx_backup#backup_type PolardbxBackup#backup_type}
  */
  readonly backupType?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardbx_backup#id PolardbxBackup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardbx_backup#instance_id PolardbxBackup#instance_id}
  */
  readonly instanceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardbx_backup alibabacloudstack_polardbx_backup}
*/
export class PolardbxBackup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolardbxBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardbx_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.18/docs/resources/polardbx_backup alibabacloudstack_polardbx_backup} Resource
  *
  * @param scope The scope in which to define this construct
