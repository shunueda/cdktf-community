// https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server
...
export interface HttpServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#agents HttpServer#agents}
  */
  readonly agents: string[];
  /**
  * List of alert rules IDs to apply to the test (get `ruleId` from `/alerts/rules` endpoint. If `alertsEnabled` is set to `true` and `alertRules` is not included on test creation or update, applicable user default alert rules will be used)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#alert_rules HttpServer#alert_rules}
  */
  readonly alertRules?: string[];
  /**
  * Set to 'true' to enable alerts, or 'false' to disable alerts. The default value is 'true'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#alerts_enabled HttpServer#alerts_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#allow_unsafe_legacy_renegotiation HttpServer#allow_unsafe_legacy_renegotiation}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#auth_type HttpServer#auth_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#bandwidth_measurements HttpServer#bandwidth_measurements}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#bgp_measurements HttpServer#bgp_measurements}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#client_certificate HttpServer#client_certificate}
  */
  readonly clientCertificate?: string;
  /**
  * Indicates whether network data to the proxy should be collected.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#collect_proxy_network_data HttpServer#collect_proxy_network_data}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#content_regex HttpServer#content_regex}
  */
  readonly contentRegex?: string;
  /**
  * A description of the alert rule. Defaults to an empty string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#description HttpServer#description}
  */
  readonly description?: string;
  /**
  * The valid HTTP response code you’re interested in retrieving.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#desired_status_code HttpServer#desired_status_code}
  */
  readonly desiredStatusCode?: string;
  /**
  * Adds distributed tracing headers to API requests using B3 and W3C standards.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#distributed_tracing HttpServer#distributed_tracing}
  */
  readonly distributedTracing?: boolean | cdktf.IResolvable;
  /**
  * The IP address to use for DNS override.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#dns_override HttpServer#dns_override}
  */
  readonly dnsOverride?: string;
  /**
  * Specify the maximum number of bytes to download from the target object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#download_limit HttpServer#download_limit}
  */
  readonly downloadLimit?: number;
  /**
  * Enables or disables the test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#enabled HttpServer#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Sets packets rate sent to measure the network in packets per second.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#fixed_packet_rate HttpServer#fixed_packet_rate}
  */
  readonly fixedPacketRate?: number;
  /**
  * Follow HTTP/301 or HTTP/302 redirect directives. Defaults to 'true'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#follow_redirects HttpServer#follow_redirects}
  */
  readonly followRedirects?: boolean | cdktf.IResolvable;
  /**
  * ["header: value", "header2: value"] The array of header strings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#headers HttpServer#headers}
  */
  readonly headers?: string[];
  /**
  * The target time for HTTP server completion, specified in milliseconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#http_target_time HttpServer#http_target_time}
  */
  readonly httpTargetTime?: number;
  /**
  * The target time for HTTP server limits, specified in seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#http_time_limit HttpServer#http_time_limit}
  */
  readonly httpTimeLimit?: number;
  /**
  * Set to 2 for the default HTTP version (prefer HTTP/2), or 1 for HTTP/1.1 only.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#http_version HttpServer#http_version}
  */
  readonly httpVersion?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#id HttpServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#include_headers HttpServer#include_headers}
  */
  readonly includeHeaders?: boolean | cdktf.IResolvable;
  /**
  * The interval to run the test on, in seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#interval HttpServer#interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#ipv6_policy HttpServer#ipv6_policy}
  */
  readonly ipv6Policy?: string;
  /**
  * Contains list of BGP monitor IDs (get `monitorId` from `/monitors` endpoint)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#monitors HttpServer#monitors}
  */
  readonly monitors?: string[];
  /**
  * Measure MTU sizes on the network from agents to the target.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#mtu_measurements HttpServer#mtu_measurements}
  */
  readonly mtuMeasurements?: boolean | cdktf.IResolvable;
  /**
  * Set to 'true' to enable network measurements.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#network_measurements HttpServer#network_measurements}
  */
  readonly networkMeasurements?: boolean | cdktf.IResolvable;
  /**
  * The number of path traces.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#num_path_traces HttpServer#num_path_traces}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#override_agent_proxy HttpServer#override_agent_proxy}
  */
  readonly overrideAgentProxy?: boolean | cdktf.IResolvable;
  /**
  * ID of the proxy to be used if the default proxy is overridden.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#override_proxy_id HttpServer#override_proxy_id}
  */
  readonly overrideProxyId?: string;
  /**
  * The password to be used to authenticate with the destination server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#password HttpServer#password}
  */
  readonly password?: string;
  /**
  * [classic or in-session] Choose 'inSession' to perform the path trace within a TCP session. Default value is 'classic'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#path_trace_mode HttpServer#path_trace_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#post_body HttpServer#post_body}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#probe_mode HttpServer#probe_mode}
  */
  readonly probeMode?: string;
  /**
  * The protocol used by dependent network tests (end-to-end, path trace, PMTUD). Default value is tcp.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#protocol HttpServer#protocol}
  */
  readonly protocol?: string;
  /**
  * Indicates whether agents should randomize the start time in each test round.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#randomized_start_time HttpServer#randomized_start_time}
  */
  readonly randomizedStartTime?: boolean | cdktf.IResolvable;
  /**
  * List of accounts
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#shared_with_accounts HttpServer#shared_with_accounts}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#ssl_version_id HttpServer#ssl_version_id}
  */
  readonly sslVersionId?: string;
  /**
  * The name of the test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#test_name HttpServer#test_name}
  */
  readonly testName?: string;
  /**
  * The target URL for the test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#url HttpServer#url}
  */
  readonly url: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#use_ntlm HttpServer#use_ntlm}
  */
  readonly useNtlm?: boolean | cdktf.IResolvable;
  /**
  * Enable to automatically add all available Public BGP Monitors to the test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#use_public_bgp HttpServer#use_public_bgp}
  */
  readonly usePublicBgp?: boolean | cdktf.IResolvable;
  /**
  * The user-agent string to be provided during the test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#user_agent HttpServer#user_agent}
  */
  readonly userAgent?: string;
  /**
  * The username to be used to authenticate with the destination server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#username HttpServer#username}
  */
  readonly username?: string;
  /**
  * Set whether to ignore certificate errors. Set to 'false' to ignore certificate errors. The default value is 'true'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#verify_certificate HttpServer#verify_certificate}
  */
  readonly verifyCertificate?: boolean | cdktf.IResolvable;
  /**
  * agent_interfaces block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#agent_interfaces HttpServer#agent_interfaces}
  */
  readonly agentInterfaces?: HttpServerAgentInterfaces[] | cdktf.IResolvable;
  /**
  * custom_headers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#custom_headers HttpServer#custom_headers}
  */
  readonly customHeaders?: HttpServerCustomHeaders[] | cdktf.IResolvable;
  /**
  * oauth block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#oauth HttpServer#oauth}
  */
...
export interface HttpServerAgentInterfaces {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#agent_id HttpServer#agent_id}
  */
  readonly agentId?: string;
  /**
  * IP address of the agent interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#ip_address HttpServer#ip_address}
  */
...
export interface HttpServerCustomHeaders {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#all HttpServer#all}
  */
  readonly all?: { [key: string]: string };
  /**
  * Use these HTTP headers for the specified domains.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#domains HttpServer#domains}
  */
  readonly domains?: { [key: string]: string };
  /**
  * Use these HTTP headers for root server request.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#root HttpServer#root}
  */
...
export interface HttpServerOauth {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#config_id HttpServer#config_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#request_method HttpServer#request_method}
  */
  readonly requestMethod?: string;
  /**
  * Target for the test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#test_url HttpServer#test_url}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server thousandeyes_http_server}
*/
export class HttpServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HttpServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/http_server thousandeyes_http_server} Resource
  *
  * @param scope The scope in which to define this construct
