// https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load
...
export interface PageLoadConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#agents PageLoad#agents}
  */
  readonly agents: string[];
  /**
  * List of alert rules IDs to apply to the test (get `ruleId` from `/alerts/rules` endpoint. If `alertsEnabled` is set to `true` and `alertRules` is not included on test creation or update, applicable user default alert rules will be used)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#alert_rules PageLoad#alert_rules}
  */
  readonly alertRules?: string[];
  /**
  * Set to 'true' to enable alerts, or 'false' to disable alerts. The default value is 'true'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#alerts_enabled PageLoad#alerts_enabled}
  */
  readonly alertsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Set true to use the agent's geolocation by the web page.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#allow_geolocation PageLoad#allow_geolocation}
  */
  readonly allowGeolocation?: boolean | cdktf.IResolvable;
  /**
  * Set true allow the use of a fake mic and camera in the browser.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#allow_mic_and_camera PageLoad#allow_mic_and_camera}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#allow_unsafe_legacy_renegotiation PageLoad#allow_unsafe_legacy_renegotiation}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#auth_type PageLoad#auth_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#bandwidth_measurements PageLoad#bandwidth_measurements}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#bgp_measurements PageLoad#bgp_measurements}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#block_domains PageLoad#block_domains}
  */
  readonly blockDomains?: string;
  /**
  * Set one of the available browser language that you want to use to configure the browser.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#browser_language PageLoad#browser_language}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#client_certificate PageLoad#client_certificate}
  */
  readonly clientCertificate?: string;
  /**
  * Indicates whether network data to the proxy should be collected.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#collect_proxy_network_data PageLoad#collect_proxy_network_data}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#content_regex PageLoad#content_regex}
  */
  readonly contentRegex?: string;
  /**
  * A description of the alert rule. Defaults to an empty string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#description PageLoad#description}
  */
  readonly description?: string;
  /**
  * The valid HTTP response code you’re interested in retrieving.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#desired_status_code PageLoad#desired_status_code}
  */
  readonly desiredStatusCode?: string;
  /**
  * Enables or disables screenshots on error. Set true to not capture
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#disable_screenshot PageLoad#disable_screenshot}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#distributed_tracing PageLoad#distributed_tracing}
  */
  readonly distributedTracing?: boolean | cdktf.IResolvable;
  /**
  * The IP address to use for DNS override.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#dns_override PageLoad#dns_override}
  */
  readonly dnsOverride?: string;
  /**
  * Specify the maximum number of bytes to download from the target object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#download_limit PageLoad#download_limit}
  */
  readonly downloadLimit?: number;
  /**
  * ID of the emulated device, if one was given when the test was created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#emulated_device_id PageLoad#emulated_device_id}
  */
  readonly emulatedDeviceId?: string;
  /**
  * Enables or disables the test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#enabled PageLoad#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Sets packets rate sent to measure the network in packets per second.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#fixed_packet_rate PageLoad#fixed_packet_rate}
  */
  readonly fixedPacketRate?: number;
  /**
  * Follow HTTP/301 or HTTP/302 redirect directives. Defaults to 'true'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#follow_redirects PageLoad#follow_redirects}
  */
  readonly followRedirects?: boolean | cdktf.IResolvable;
  /**
  * The interval to run the HTTP server test on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#http_interval PageLoad#http_interval}
  */
  readonly httpInterval: number;
  /**
  * The target time for HTTP server completion, specified in milliseconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#http_target_time PageLoad#http_target_time}
  */
  readonly httpTargetTime?: number;
  /**
  * The target time for HTTP server limits, specified in seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#http_time_limit PageLoad#http_time_limit}
  */
  readonly httpTimeLimit?: number;
  /**
  * Set to 2 for the default HTTP version (prefer HTTP/2), or 1 for HTTP/1.1 only.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#http_version PageLoad#http_version}
  */
  readonly httpVersion?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#id PageLoad#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#identify_agent_traffic_with_user_agent PageLoad#identify_agent_traffic_with_user_agent}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#include_headers PageLoad#include_headers}
  */
  readonly includeHeaders?: boolean | cdktf.IResolvable;
  /**
  * The interval to run the test on, in seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#interval PageLoad#interval}
  */
  readonly interval: number;
  /**
  * Contains list of BGP monitor IDs (get `monitorId` from `/monitors` endpoint)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#monitors PageLoad#monitors}
  */
  readonly monitors?: string[];
  /**
  * Measure MTU sizes on the network from agents to the target.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#mtu_measurements PageLoad#mtu_measurements}
  */
  readonly mtuMeasurements?: boolean | cdktf.IResolvable;
  /**
  * Set to 'true' to enable network measurements.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#network_measurements PageLoad#network_measurements}
  */
  readonly networkMeasurements?: boolean | cdktf.IResolvable;
  /**
  * The number of path traces.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#num_path_traces PageLoad#num_path_traces}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#override_agent_proxy PageLoad#override_agent_proxy}
  */
  readonly overrideAgentProxy?: boolean | cdktf.IResolvable;
  /**
  * ID of the proxy to be used if the default proxy is overridden.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#override_proxy_id PageLoad#override_proxy_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#page_load_target_time PageLoad#page_load_target_time}
  */
  readonly pageLoadTargetTime?: number;
  /**
  * Page load time limit. Must be larger than the `httpTimeLimit`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#page_load_time_limit PageLoad#page_load_time_limit}
  */
  readonly pageLoadTimeLimit?: number;
  /**
  * [normal, eager or none] Defines page loading strategy. Defaults to 'none'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#page_loading_strategy PageLoad#page_loading_strategy}
  */
  readonly pageLoadingStrategy?: string;
  /**
  * The password to be used to authenticate with the destination server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#password PageLoad#password}
  */
  readonly password?: string;
  /**
  * [classic or in-session] Choose 'inSession' to perform the path trace within a TCP session. Default value is 'classic'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#path_trace_mode PageLoad#path_trace_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#probe_mode PageLoad#probe_mode}
  */
  readonly probeMode?: string;
  /**
  * The protocol used by dependent network tests (end-to-end, path trace, PMTUD). Default value is tcp.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#protocol PageLoad#protocol}
  */
  readonly protocol?: string;
  /**
  * Indicates whether agents should randomize the start time in each test round.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#randomized_start_time PageLoad#randomized_start_time}
  */
  readonly randomizedStartTime?: boolean | cdktf.IResolvable;
  /**
  * List of accounts
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#shared_with_accounts PageLoad#shared_with_accounts}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#ssl_version_id PageLoad#ssl_version_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#subinterval PageLoad#subinterval}
  */
  readonly subinterval?: number;
  /**
  * The name of the test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#test_name PageLoad#test_name}
  */
  readonly testName?: string;
  /**
  * The target URL for the test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#url PageLoad#url}
  */
  readonly url: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#use_ntlm PageLoad#use_ntlm}
  */
  readonly useNtlm?: boolean | cdktf.IResolvable;
  /**
  * Enable to automatically add all available Public BGP Monitors to the test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#use_public_bgp PageLoad#use_public_bgp}
  */
  readonly usePublicBgp?: boolean | cdktf.IResolvable;
  /**
  * The user-agent string to be provided during the test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#user_agent PageLoad#user_agent}
  */
  readonly userAgent?: string;
  /**
  * The username to be used to authenticate with the destination server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#username PageLoad#username}
  */
  readonly username?: string;
  /**
  * Set whether to ignore certificate errors. Set to 'false' to ignore certificate errors. The default value is 'true'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#verify_certificate PageLoad#verify_certificate}
  */
  readonly verifyCertificate?: boolean | cdktf.IResolvable;
  /**
  * agent_interfaces block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#agent_interfaces PageLoad#agent_interfaces}
  */
  readonly agentInterfaces?: PageLoadAgentInterfaces[] | cdktf.IResolvable;
  /**
  * custom_headers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#custom_headers PageLoad#custom_headers}
  */
...
export interface PageLoadAgentInterfaces {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#agent_id PageLoad#agent_id}
  */
  readonly agentId?: string;
  /**
  * IP address of the agent interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#ip_address PageLoad#ip_address}
  */
...
export interface PageLoadCustomHeaders {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#all PageLoad#all}
  */
  readonly all?: { [key: string]: string };
  /**
  * Use these HTTP headers for the specified domains.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#domains PageLoad#domains}
  */
  readonly domains?: { [key: string]: string };
  /**
  * Use these HTTP headers for root server request.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#root PageLoad#root}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load thousandeyes_page_load}
*/
export class PageLoad extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PageLoad that should be imported. Refer to the {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/page_load thousandeyes_page_load} Resource
  *
  * @param scope The scope in which to define this construct
