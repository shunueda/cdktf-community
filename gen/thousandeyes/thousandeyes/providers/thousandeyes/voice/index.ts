// https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice
...
export interface VoiceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#agents Voice#agents}
  */
  readonly agents: string[];
  /**
  * List of alert rules IDs to apply to the test (get `ruleId` from `/alerts/rules` endpoint. If `alertsEnabled` is set to `true` and `alertRules` is not included on test creation or update, applicable user default alert rules will be used)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#alert_rules Voice#alert_rules}
  */
  readonly alertRules?: string[];
  /**
  * Set to 'true' to enable alerts, or 'false' to disable alerts. The default value is 'true'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#alerts_enabled Voice#alerts_enabled}
  */
  readonly alertsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Enable BGP measurements. Set to true for enabled, false for disabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#bgp_measurements Voice#bgp_measurements}
  */
  readonly bgpMeasurements?: boolean | cdktf.IResolvable;
  /**
  * The unique ID of the codec to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#codec_id Voice#codec_id}
  */
  readonly codecId?: string;
  /**
  * A description of the alert rule. Defaults to an empty string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#description Voice#description}
  */
  readonly description?: string;
  /**
  * The DSCP ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#dscp_id Voice#dscp_id}
  */
  readonly dscpId?: string;
  /**
  * The duration of the test, in seconds (5 to 30).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#duration Voice#duration}
  */
  readonly duration?: number;
  /**
  * Enables or disables the test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#enabled Voice#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#id Voice#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#interval Voice#interval}
  */
  readonly interval: number;
  /**
  * The de-jitter buffer size, in seconds (0 to 150).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#jitter_buffer Voice#jitter_buffer}
  */
  readonly jitterBuffer?: number;
  /**
  * Contains list of BGP monitor IDs (get `monitorId` from `/monitors` endpoint)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#monitors Voice#monitors}
  */
  readonly monitors?: string[];
  /**
  * The number of path traces.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#num_path_traces Voice#num_path_traces}
  */
  readonly numPathTraces?: number;
  /**
  * Indicates whether agents should randomize the start time in each test round.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#randomized_start_time Voice#randomized_start_time}
  */
  readonly randomizedStartTime?: boolean | cdktf.IResolvable;
  /**
  * List of accounts
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#shared_with_accounts Voice#shared_with_accounts}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#target_agent_id Voice#target_agent_id}
  */
  readonly targetAgentId: string;
  /**
  * The name of the test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#test_name Voice#test_name}
  */
  readonly testName?: string;
  /**
  * Enable to automatically add all available Public BGP Monitors to the test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#use_public_bgp Voice#use_public_bgp}
  */
  readonly usePublicBgp?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice thousandeyes_voice}
*/
export class Voice extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Voice that should be imported. Refer to the {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/voice thousandeyes_voice} Resource
  *
  * @param scope The scope in which to define this construct
