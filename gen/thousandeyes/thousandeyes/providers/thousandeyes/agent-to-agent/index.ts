// https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent
...
export interface AgentToAgentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#agents AgentToAgent#agents}
  */
  readonly agents: string[];
  /**
  * List of alert rules IDs to apply to the test (get `ruleId` from `/alerts/rules` endpoint. If `alertsEnabled` is set to `true` and `alertRules` is not included on test creation or update, applicable user default alert rules will be used)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#alert_rules AgentToAgent#alert_rules}
  */
  readonly alertRules?: string[];
  /**
  * Set to 'true' to enable alerts, or 'false' to disable alerts. The default value is 'true'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#alerts_enabled AgentToAgent#alerts_enabled}
  */
  readonly alertsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Enable BGP measurements. Set to true for enabled, false for disabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#bgp_measurements AgentToAgent#bgp_measurements}
  */
  readonly bgpMeasurements?: boolean | cdktf.IResolvable;
  /**
  * A description of the alert rule. Defaults to an empty string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#description AgentToAgent#description}
  */
  readonly description?: string;
  /**
  * [to-target, from-target, bidirectional] The direction of the test (affects how results are shown).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#direction AgentToAgent#direction}
  */
  readonly direction: string;
  /**
  * The DSCP ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#dscp_id AgentToAgent#dscp_id}
  */
  readonly dscpId?: string;
  /**
  * Enables or disables the test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#enabled AgentToAgent#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Sets packets rate sent to measure the network in packets per second.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#fixed_packet_rate AgentToAgent#fixed_packet_rate}
  */
  readonly fixedPacketRate?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#id AgentToAgent#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#interval AgentToAgent#interval}
  */
  readonly interval: number;
  /**
  * Contains list of BGP monitor IDs (get `monitorId` from `/monitors` endpoint)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#monitors AgentToAgent#monitors}
  */
  readonly monitors?: string[];
  /**
  * The maximum segment size, in bytes. Value can be from 30 to 1400.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#mss AgentToAgent#mss}
  */
  readonly mss?: number;
  /**
  * The number of path traces.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#num_path_traces AgentToAgent#num_path_traces}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#path_trace_mode AgentToAgent#path_trace_mode}
  */
  readonly pathTraceMode?: string;
  /**
  * The target port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#port AgentToAgent#port}
  */
  readonly port?: number;
  /**
  * [tcp or udp] The protocol for agent to agent tests. Defaults to 'tcp'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#protocol AgentToAgent#protocol}
  */
  readonly protocol?: string;
  /**
  * Indicates whether agents should randomize the start time in each test round.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#randomized_start_time AgentToAgent#randomized_start_time}
  */
  readonly randomizedStartTime?: boolean | cdktf.IResolvable;
  /**
  * List of accounts
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#shared_with_accounts AgentToAgent#shared_with_accounts}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#target_agent_id AgentToAgent#target_agent_id}
  */
  readonly targetAgentId: string;
  /**
  * The name of the test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#test_name AgentToAgent#test_name}
  */
  readonly testName?: string;
  /**
  * The throughput duration in milliseconds. The default value is 10000.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#throughput_duration AgentToAgent#throughput_duration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#throughput_measurements AgentToAgent#throughput_measurements}
  */
  readonly throughputMeasurements?: boolean | cdktf.IResolvable;
  /**
  * Defines the throughput rate. Fo UDP tests only.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#throughput_rate AgentToAgent#throughput_rate}
  */
  readonly throughputRate?: number;
  /**
  * Enable to automatically add all available Public BGP Monitors to the test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#use_public_bgp AgentToAgent#use_public_bgp}
  */
  readonly usePublicBgp?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent thousandeyes_agent_to_agent}
*/
export class AgentToAgent extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AgentToAgent that should be imported. Refer to the {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.0/docs/resources/agent_to_agent thousandeyes_agent_to_agent} Resource
  *
  * @param scope The scope in which to define this construct
