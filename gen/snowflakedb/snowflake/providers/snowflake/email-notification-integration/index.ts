// https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/email_notification_integration
...
export class EmailNotificationIntegration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmailNotificationIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/email_notification_integration#import import section} in the documentation of this resource for the id to use
