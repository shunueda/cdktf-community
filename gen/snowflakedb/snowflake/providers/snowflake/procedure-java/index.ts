// https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/procedure_java
...
export class ProcedureJava extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProcedureJava that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/procedure_java#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _timeouts = new ProcedureJavaTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: ProcedureJavaTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: procedureJavaTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ProcedureJavaTimeouts",
      },
    };
