// https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/procedure_scala
...
export class ProcedureScala extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProcedureScala that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/procedure_scala#import import section} in the documentation of this resource for the id to use
