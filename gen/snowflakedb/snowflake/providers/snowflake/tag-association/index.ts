// https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/tag_association
...
export class TagAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TagAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/tag_association#import import section} in the documentation of this resource for the id to use
