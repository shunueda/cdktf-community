// https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/row_access_policy
...
export class RowAccessPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RowAccessPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/row_access_policy#import import section} in the documentation of this resource for the id to use
