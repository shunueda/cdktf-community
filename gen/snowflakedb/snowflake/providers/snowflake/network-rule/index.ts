// https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/network_rule
...
export class NetworkRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/network_rule#import import section} in the documentation of this resource for the id to use
