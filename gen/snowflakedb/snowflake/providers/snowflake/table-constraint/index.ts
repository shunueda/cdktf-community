// https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/table_constraint
...
export class TableConstraint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TableConstraint that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/table_constraint#import import section} in the documentation of this resource for the id to use
