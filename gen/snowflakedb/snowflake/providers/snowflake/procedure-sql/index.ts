// https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/procedure_sql
...
export class ProcedureSql extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProcedureSql that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/procedure_sql#import import section} in the documentation of this resource for the id to use
