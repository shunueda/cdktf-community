// https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/user_public_keys
...
export class UserPublicKeys extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserPublicKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/user_public_keys#import import section} in the documentation of this resource for the id to use
