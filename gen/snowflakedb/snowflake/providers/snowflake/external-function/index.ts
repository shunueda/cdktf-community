// https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/external_function
...
export class ExternalFunction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ExternalFunction that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/external_function#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _timeouts = new ExternalFunctionTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: ExternalFunctionTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: externalFunctionTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ExternalFunctionTimeouts",
      },
    };
