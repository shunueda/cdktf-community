// https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/grant_application_role
...
export class GrantApplicationRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GrantApplicationRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/grant_application_role#import import section} in the documentation of this resource for the id to use
