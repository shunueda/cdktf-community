// https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/network_policy
...
export class NetworkPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/network_policy#import import section} in the documentation of this resource for the id to use
