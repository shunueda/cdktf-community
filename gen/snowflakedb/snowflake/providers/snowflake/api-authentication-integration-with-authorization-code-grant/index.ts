// https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/api_authentication_integration_with_authorization_code_grant
...
export class ApiAuthenticationIntegrationWithAuthorizationCodeGrant extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiAuthenticationIntegrationWithAuthorizationCodeGrant that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/api_authentication_integration_with_authorization_code_grant#import import section} in the documentation of this resource for the id to use
