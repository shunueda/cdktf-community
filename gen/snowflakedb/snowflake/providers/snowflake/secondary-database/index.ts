// https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/secondary_database
...
export class SecondaryDatabase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecondaryDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/secondary_database#import import section} in the documentation of this resource for the id to use
