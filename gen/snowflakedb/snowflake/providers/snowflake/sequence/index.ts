// https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/sequence
...
export class Sequence extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Sequence that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/sequence#import import section} in the documentation of this resource for the id to use
