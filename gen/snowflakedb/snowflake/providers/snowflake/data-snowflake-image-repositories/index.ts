// https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/data-sources/image_repositories
...
export class DataSnowflakeImageRepositoriesImageRepositoriesShowOutputOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSnowflakeImageRepositoriesImageRepositoriesShowOutput | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSnowflakeImageRepositoriesImageRepositoriesShowOutput | undefined) {
    if (value === undefined) {
...
export class DataSnowflakeImageRepositoriesImageRepositoriesShowOutputList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSnowflakeImageRepositoriesImageRepositoriesShowOutputOutputReference {
    return new DataSnowflakeImageRepositoriesImageRepositoriesShowOutputOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSnowflakeImageRepositoriesImageRepositoriesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataSnowflakeImageRepositoriesImageRepositories | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSnowflakeImageRepositoriesImageRepositories | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _showOutput = new DataSnowflakeImageRepositoriesImageRepositoriesShowOutputList(this, "show_output", false);
  public get showOutput() {
    return this._showOutput;
  }
}

export class DataSnowflakeImageRepositoriesImageRepositoriesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSnowflakeImageRepositoriesImageRepositoriesOutputReference {
    return new DataSnowflakeImageRepositoriesImageRepositoriesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSnowflakeImageRepositoriesInOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataSnowflakeImageRepositoriesIn | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DataSnowflakeImageRepositoriesIn | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class DataSnowflakeImageRepositories extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "snowflake_image_repositories";
  ...
  * @param importFromId The id of the existing DataSnowflakeImageRepositories that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/data-sources/image_repositories#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "snowflake_image_repositories", importId: importFromId, provider });
      }
  ...
  */
  public constructor(scope: Construct, id: string, config: DataSnowflakeImageRepositoriesConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'snowflake_image_repositories',
  ...
  // image_repositories - computed: true, optional: false, required: false
  private _imageRepositories = new DataSnowflakeImageRepositoriesImageRepositoriesList(this, "image_repositories", false);
  public get imageRepositories() {
  ...
  private _in = new DataSnowflakeImageRepositoriesInOutputReference(this, "in");
  public get in() {
    return this._in;
  }
  public putIn(value: DataSnowflakeImageRepositoriesIn) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      in: dataSnowflakeImageRepositoriesInToTerraform(this._in.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      in: {
        value: dataSnowflakeImageRepositoriesInToHclTerraform(this._in.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataSnowflakeImageRepositoriesInList",
      },
    };
