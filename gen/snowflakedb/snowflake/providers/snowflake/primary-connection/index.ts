// https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/primary_connection
...
export class PrimaryConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrimaryConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/primary_connection#import import section} in the documentation of this resource for the id to use
