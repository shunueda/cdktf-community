// https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/grant_account_role
...
export class GrantAccountRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GrantAccountRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs/resources/grant_account_role#import import section} in the documentation of this resource for the id to use
