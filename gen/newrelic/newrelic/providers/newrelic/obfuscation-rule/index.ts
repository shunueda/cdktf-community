// https://registry.terraform.io/providers/newrelic/newrelic/3.73.0/docs/resources/obfuscation_rule
...
export class ObfuscationRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ObfuscationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.73.0/docs/resources/obfuscation_rule#import import section} in the documentation of this resource for the id to use
