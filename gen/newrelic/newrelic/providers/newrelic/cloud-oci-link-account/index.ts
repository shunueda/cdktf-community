// https://registry.terraform.io/providers/newrelic/newrelic/3.73.0/docs/resources/cloud_oci_link_account
...
export interface CloudOciLinkAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly ociSvcUserName: string;
  /**
...
export class CloudOciLinkAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudOciLinkAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.73.0/docs/resources/cloud_oci_link_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: CloudOciLinkAccountConfig) {
    ...
    this._ociSvcUserName = config.ociSvcUserName;
  ...
  // oci_svc_user_name - computed: false, optional: false, required: true
  private _ociSvcUserName?: string; 
  public get ociSvcUserName() {
    return this.getStringAttribute('oci_svc_user_name');
  }
  public set ociSvcUserName(value: string) {
    this._ociSvcUserName = value;
  }
  // Temporarily expose input value. Use with caution.
  public get ociSvcUserNameInput() {
    return this._ociSvcUserName;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      oci_svc_user_name: cdktf.stringToTerraform(this._ociSvcUserName),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      oci_svc_user_name: {
        value: cdktf.stringToHclTerraform(this._ociSvcUserName),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
