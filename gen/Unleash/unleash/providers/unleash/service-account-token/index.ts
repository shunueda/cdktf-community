// https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/service_account_token
...
export interface ServiceAccountTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/service_account_token#description ServiceAccountToken#description}
  */
  readonly description: string;
  /**
  * The expiration date of the service account token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/service_account_token#expires_at ServiceAccountToken#expires_at}
  */
  readonly expiresAt: string;
  /**
  * The ID of the service account this token is bound to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/service_account_token#service_account_id ServiceAccountToken#service_account_id}
  */
  readonly serviceAccountId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/service_account_token unleash_service_account_token}
*/
export class ServiceAccountToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceAccountToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/service_account_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/service_account_token unleash_service_account_token} Resource
  *
  * @param scope The scope in which to define this construct
