// https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/saml
...
export interface SamlConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/saml#auto_create Saml#auto_create}
  */
  readonly autoCreate?: boolean | cdktf.IResolvable;
  /**
  * The x509 certificate used by the SAML provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/saml#certificate Saml#certificate}
  */
  readonly certificate: string;
  /**
  * The default root role give to a user when that user is created. Only used if auto_create is set to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/saml#default_root_role Saml#default_root_role}
  */
  readonly defaultRootRole?: number;
  /**
  * Whether SAML is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/saml#enabled Saml#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * The SAML entity ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/saml#entity_id Saml#entity_id}
  */
  readonly entityId: string;
  /**
  * The SAML sign-on URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/saml#sign_on_url Saml#sign_on_url}
  */
  readonly signOnUrl: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/saml unleash_saml}
*/
export class Saml extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Saml that should be imported. Refer to the {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/saml#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/saml unleash_saml} Resource
  *
  * @param scope The scope in which to define this construct
