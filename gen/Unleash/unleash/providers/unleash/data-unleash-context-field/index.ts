// https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/data-sources/context_field
...
export interface DataUnleashContextFieldConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/data-sources/context_field#description DataUnleashContextField#description}
  */
  readonly description?: string;
  /**
  * Legal values for this context field. If not set, then any value is available for this context field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/data-sources/context_field#legal_values DataUnleashContextField#legal_values}
  */
  readonly legalValues?: DataUnleashContextFieldLegalValues[] | cdktf.IResolvable;
  /**
  * The name of the context field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/data-sources/context_field#name DataUnleashContextField#name}
  */
  readonly name: string;
  /**
  * Whether this field is available for custom stickiness
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/data-sources/context_field#stickiness DataUnleashContextField#stickiness}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/data-sources/context_field unleash_context_field}
*/
export class DataUnleashContextField extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataUnleashContextField that should be imported. Refer to the {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/data-sources/context_field#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/data-sources/context_field unleash_context_field} Data Source
  *
  * @param scope The scope in which to define this construct
