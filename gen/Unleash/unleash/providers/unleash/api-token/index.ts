// https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/api_token
...
export interface ApiTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/api_token#environment ApiToken#environment}
  */
  readonly environment?: string;
  /**
  * When the token expires
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/api_token#expires_at ApiToken#expires_at}
  */
  readonly expiresAt?: string;
  /**
  * A project the token belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/api_token#project ApiToken#project}
  */
  readonly project?: string;
  /**
  * The list of projects this token has access to. If the token has access to specific projects they will be listed here. If the token has access to all projects it will be represented as `[*]`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/api_token#projects ApiToken#projects}
  */
  readonly projects?: string[];
  /**
  * The name of the token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/api_token#token_name ApiToken#token_name}
  */
  readonly tokenName?: string;
  /**
  * The type of the token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/api_token#type ApiToken#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/api_token unleash_api_token}
*/
export class ApiToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/api_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/api_token unleash_api_token} Resource
  *
  * @param scope The scope in which to define this construct
