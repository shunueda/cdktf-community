// https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/service_account
...
export interface ServiceAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/service_account#name ServiceAccount#name}
  */
  readonly name: string;
  /**
  * The root role ID for the service account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/service_account#root_role ServiceAccount#root_role}
  */
  readonly rootRole: number;
  /**
  * The username for the service account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/service_account#username ServiceAccount#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/service_account unleash_service_account}
*/
export class ServiceAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/service_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/service_account unleash_service_account} Resource
  *
  * @param scope The scope in which to define this construct
