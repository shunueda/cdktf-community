// https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/oidc
...
export interface OidcConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/oidc#auto_create Oidc#auto_create}
  */
  readonly autoCreate?: boolean | cdktf.IResolvable;
  /**
  * The OIDC public identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/oidc#client_id Oidc#client_id}
  */
  readonly clientId: string;
  /**
  * The default root role give to a user when that user is created. Only used if auto_create is set to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/oidc#default_root_role Oidc#default_root_role}
  */
  readonly defaultRootRole?: number;
  /**
  * A URL pointing to the .well-known configuration of the OIDC provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/oidc#discover_url Oidc#discover_url}
  */
  readonly discoverUrl: string;
  /**
  * Whether or not OIDC is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/oidc#enabled Oidc#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * The OIDC secret.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/oidc#secret Oidc#secret}
  */
  readonly secret: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/oidc unleash_oidc}
*/
export class Oidc extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Oidc that should be imported. Refer to the {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/oidc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/oidc unleash_oidc} Resource
  *
  * @param scope The scope in which to define this construct
