// https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/context_field
...
export interface ContextFieldConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/context_field#description ContextField#description}
  */
  readonly description?: string;
  /**
  * Legal values for this context field. If not set, then any value is available for this context field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/context_field#legal_values ContextField#legal_values}
  */
  readonly legalValues?: ContextFieldLegalValues[] | cdktf.IResolvable;
  /**
  * The name of the context field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/context_field#name ContextField#name}
  */
  readonly name: string;
  /**
  * Whether this field is available for custom stickiness. Defaults to false if not set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/context_field#stickiness ContextField#stickiness}
  */
...
export interface ContextFieldLegalValues {
  ...
  * The allowed value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/context_field#value ContextField#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/context_field unleash_context_field}
*/
export class ContextField extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContextField that should be imported. Refer to the {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/context_field#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/resources/context_field unleash_context_field} Resource
  *
  * @param scope The scope in which to define this construct
