// https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs
...
export interface UnleashProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs#authorization UnleashProvider#authorization}
  */
  readonly authorization?: string;
  /**
  * Unleash base URL (everything before `/api`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs#base_url UnleashProvider#base_url}
  */
  readonly baseUrl?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs#alias UnleashProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs unleash}
*/
export class UnleashProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing UnleashProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs unleash} Resource
  *
  * @param scope The scope in which to define this construct
