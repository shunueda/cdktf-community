// https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/data-sources/project_environment
...
export interface DataUnleashProjectEnvironmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/data-sources/project_environment#environment_name DataUnleashProjectEnvironment#environment_name}
  */
  readonly environmentName: string;
  /**
  * Project identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/data-sources/project_environment#project_id DataUnleashProjectEnvironment#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/data-sources/project_environment unleash_project_environment}
*/
export class DataUnleashProjectEnvironment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataUnleashProjectEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/data-sources/project_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/unleash/unleash/3.1.0/docs/data-sources/project_environment unleash_project_environment} Data Source
  *
  * @param scope The scope in which to define this construct
