// https://registry.terraform.io/providers/redislabs/rediscloud/2.7.0/docs/data-sources/subscription
...
export interface DataRediscloudSubscriptionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.0/docs/data-sources/subscription#id DataRediscloudSubscription#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.0/docs/data-sources/subscription#name DataRediscloudSubscription#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.0/docs/data-sources/subscription rediscloud_subscription}
*/
export class DataRediscloudSubscription extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRediscloudSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.0/docs/data-sources/subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.0/docs/data-sources/subscription rediscloud_subscription} Data Source
  *
  * @param scope The scope in which to define this construct
