// https://registry.terraform.io/providers/redislabs/rediscloud/2.7.0/docs/data-sources/database
...
export interface DataRediscloudDatabaseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.0/docs/data-sources/database#db_id DataRediscloudDatabase#db_id}
  */
  readonly dbId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.0/docs/data-sources/database#id DataRediscloudDatabase#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.0/docs/data-sources/database#name DataRediscloudDatabase#name}
  */
  readonly name?: string;
  /**
  * The protocol of the database to filter returned databases
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.0/docs/data-sources/database#protocol DataRediscloudDatabase#protocol}
  */
  readonly protocol?: string;
  /**
  * The region of the database to filter returned databases
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.0/docs/data-sources/database#region DataRediscloudDatabase#region}
  */
  readonly region?: string;
  /**
  * ID of the subscription that the database belongs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.0/docs/data-sources/database#subscription_id DataRediscloudDatabase#subscription_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.0/docs/data-sources/database rediscloud_database}
*/
export class DataRediscloudDatabase extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRediscloudDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.0/docs/data-sources/database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.0/docs/data-sources/database rediscloud_database} Data Source
  *
  * @param scope The scope in which to define this construct
