// https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/data-sources/kafka_user_v4_instance
...
export interface DataInstaclustrKafkaUserV4InstanceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Authentication mechanisms supported for KafkaClusters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/data-sources/kafka_user_v4_instance#auth_mechanism DataInstaclustrKafkaUserV4Instance#auth_mechanism}
  */
  readonly authMechanism?: string;
  /**
  * ID of the Kafka cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/data-sources/kafka_user_v4_instance#cluster_id DataInstaclustrKafkaUserV4Instance#cluster_id}
  */
  readonly clusterId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/data-sources/kafka_user_v4_instance#id DataInstaclustrKafkaUserV4Instance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/data-sources/kafka_user_v4_instance#override_existing_user DataInstaclustrKafkaUserV4Instance#override_existing_user}
  */
  readonly overrideExistingUser?: boolean | cdktf.IResolvable;
  /**
  * Password for the Kafka user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/data-sources/kafka_user_v4_instance#password DataInstaclustrKafkaUserV4Instance#password}
  */
  readonly password?: string;
  /**
  * Scram Mechanism for SASL authentication. Valid values: SCRAM-SHA-256, SCRAM-SHA-512
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/data-sources/kafka_user_v4_instance#sasl_scram_mechanism DataInstaclustrKafkaUserV4Instance#sasl_scram_mechanism}
  */
  readonly saslScramMechanism?: string;
  /**
  * Username of the Kafka user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/data-sources/kafka_user_v4_instance#username DataInstaclustrKafkaUserV4Instance#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/data-sources/kafka_user_v4_instance instaclustr_kafka_user_v4_instance}
*/
export class DataInstaclustrKafkaUserV4Instance extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "instaclustr_kafka_user_v4_instance";
  ...
  * @param importFromId The id of the existing DataInstaclustrKafkaUserV4Instance that should be imported. Refer to the {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/data-sources/kafka_user_v4_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "instaclustr_kafka_user_v4_instance", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/data-sources/kafka_user_v4_instance instaclustr_kafka_user_v4_instance} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataInstaclustrKafkaUserV4InstanceConfig
  */
  public constructor(scope: Construct, id: string, config: DataInstaclustrKafkaUserV4InstanceConfig) {
    super(scope, id, {
