// https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2
...
export interface PostgresqlClusterV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Indicates if the cluster is currently performing any restructuring operation such as being created or resized
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#current_cluster_operation_status PostgresqlClusterV2#current_cluster_operation_status}
  */
  readonly currentClusterOperationStatus?: string;
  /**
  * Password of the default user created for the PostgreSQL cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#default_user_password PostgresqlClusterV2#default_user_password}
  */
  readonly defaultUserPassword?: string;
  /**
  * A description of the cluster
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#description PostgresqlClusterV2#description}
  */
  readonly description?: string;
  /**
  * List of PostgreSQL extensions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#extensions PostgresqlClusterV2#extensions}
  */
  readonly extensions?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#id PostgresqlClusterV2#id}
  *
  ...
  * Name of the cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#name PostgresqlClusterV2#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#pci_compliance_mode PostgresqlClusterV2#pci_compliance_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#postgresql_version PostgresqlClusterV2#postgresql_version}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#private_network_cluster PostgresqlClusterV2#private_network_cluster}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#sla_tier PostgresqlClusterV2#sla_tier}
  */
  readonly slaTier: string;
  /**
  * Status of the cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#status PostgresqlClusterV2#status}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#synchronous_mode_strict PostgresqlClusterV2#synchronous_mode_strict}
  */
  readonly synchronousModeStrict: boolean | cdktf.IResolvable;
  /**
  * data_centre block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#data_centre PostgresqlClusterV2#data_centre}
  */
  readonly dataCentre: PostgresqlClusterV2DataCentre[] | cdktf.IResolvable;
  /**
  * resize_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#resize_settings PostgresqlClusterV2#resize_settings}
  */
  readonly resizeSettings?: PostgresqlClusterV2ResizeSettings[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#timeouts PostgresqlClusterV2#timeouts}
  */
  readonly timeouts?: PostgresqlClusterV2Timeouts;
  /**
  * two_factor_delete block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#two_factor_delete PostgresqlClusterV2#two_factor_delete}
  */
  readonly twoFactorDelete?: PostgresqlClusterV2TwoFactorDelete[] | cdktf.IResolvable;
}
export interface PostgresqlClusterV2DataCentreAwsSettings {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#custom_virtual_network_id PostgresqlClusterV2#custom_virtual_network_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#ebs_encryption_key PostgresqlClusterV2#ebs_encryption_key}
  */
  readonly ebsEncryptionKey?: string;
}

export function postgresqlClusterV2DataCentreAwsSettingsToTerraform(struct?: PostgresqlClusterV2DataCentreAwsSettings | cdktf.IResolvable): any {
...
export function postgresqlClusterV2DataCentreAwsSettingsToHclTerraform(struct?: PostgresqlClusterV2DataCentreAwsSettings | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PostgresqlClusterV2DataCentreAwsSettingsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PostgresqlClusterV2DataCentreAwsSettings | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: PostgresqlClusterV2DataCentreAwsSettings | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class PostgresqlClusterV2DataCentreAwsSettingsList extends cdktf.ComplexList {
  public internalValue? : PostgresqlClusterV2DataCentreAwsSettings[] | cdktf.IResolvable
  ...
  */
  public get(index: number): PostgresqlClusterV2DataCentreAwsSettingsOutputReference {
    return new PostgresqlClusterV2DataCentreAwsSettingsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface PostgresqlClusterV2DataCentreAzureSettings {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#resource_group PostgresqlClusterV2#resource_group}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#storage_network PostgresqlClusterV2#storage_network}
  */
  readonly storageNetwork?: string;
}

export function postgresqlClusterV2DataCentreAzureSettingsToTerraform(struct?: PostgresqlClusterV2DataCentreAzureSettings | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function postgresqlClusterV2DataCentreAzureSettingsToHclTerraform(struct?: PostgresqlClusterV2DataCentreAzureSettings | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PostgresqlClusterV2DataCentreAzureSettingsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): PostgresqlClusterV2DataCentreAzureSettings | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PostgresqlClusterV2DataCentreAzureSettings | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._customVirtualNetworkId = undefined;
...
export class PostgresqlClusterV2DataCentreAzureSettingsList extends cdktf.ComplexList {
  public internalValue? : PostgresqlClusterV2DataCentreAzureSettings[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): PostgresqlClusterV2DataCentreAzureSettingsOutputReference {
    return new PostgresqlClusterV2DataCentreAzureSettingsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface PostgresqlClusterV2DataCentreDeletedNodes {
  /**
  * Deletion time of the node as a UTC timestamp
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#deletion_time PostgresqlClusterV2#deletion_time}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#node_roles PostgresqlClusterV2#node_roles}
  */
  readonly nodeRoles?: string[];
  /**
  * Size of the node.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#node_size PostgresqlClusterV2#node_size}
  */
  readonly nodeSize?: string;
  /**
  * Private IP address of the node.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#private_address PostgresqlClusterV2#private_address}
  */
  readonly privateAddress?: string;
  /**
  * Public IP address of the node.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#public_address PostgresqlClusterV2#public_address}
  */
  readonly publicAddress?: string;
  /**
  * Rack name in which the node is located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#rack PostgresqlClusterV2#rack}
  */
  readonly rack?: string;
  /**
  * Start time of the node as a UTC timestamp
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#start_time PostgresqlClusterV2#start_time}
  */
...
export function postgresqlClusterV2DataCentreDeletedNodesToTerraform(struct?: PostgresqlClusterV2DataCentreDeletedNodes | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function postgresqlClusterV2DataCentreDeletedNodesToHclTerraform(struct?: PostgresqlClusterV2DataCentreDeletedNodes | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PostgresqlClusterV2DataCentreDeletedNodesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): PostgresqlClusterV2DataCentreDeletedNodes | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PostgresqlClusterV2DataCentreDeletedNodes | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class PostgresqlClusterV2DataCentreDeletedNodesList extends cdktf.ComplexList {
  public internalValue? : PostgresqlClusterV2DataCentreDeletedNodes[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): PostgresqlClusterV2DataCentreDeletedNodesOutputReference {
    return new PostgresqlClusterV2DataCentreDeletedNodesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface PostgresqlClusterV2DataCentreGcpSettings {
  /**
...
export function postgresqlClusterV2DataCentreGcpSettingsToTerraform(struct?: PostgresqlClusterV2DataCentreGcpSettings | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function postgresqlClusterV2DataCentreGcpSettingsToHclTerraform(struct?: PostgresqlClusterV2DataCentreGcpSettings | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PostgresqlClusterV2DataCentreGcpSettingsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): PostgresqlClusterV2DataCentreGcpSettings | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PostgresqlClusterV2DataCentreGcpSettings | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._customVirtualNetworkId = undefined;
...
export class PostgresqlClusterV2DataCentreGcpSettingsList extends cdktf.ComplexList {
  public internalValue? : PostgresqlClusterV2DataCentreGcpSettings[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): PostgresqlClusterV2DataCentreGcpSettingsOutputReference {
    return new PostgresqlClusterV2DataCentreGcpSettingsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface PostgresqlClusterV2DataCentreInterDataCentreReplication {
  /**
  * Is this Data centre considered to be the primary (only required if multiple data centres defined).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#is_primary_data_centre PostgresqlClusterV2#is_primary_data_centre}
  */
  readonly isPrimaryDataCentre: boolean | cdktf.IResolvable;
}

export function postgresqlClusterV2DataCentreInterDataCentreReplicationToTerraform(struct?: PostgresqlClusterV2DataCentreInterDataCentreReplication | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function postgresqlClusterV2DataCentreInterDataCentreReplicationToHclTerraform(struct?: PostgresqlClusterV2DataCentreInterDataCentreReplication | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PostgresqlClusterV2DataCentreInterDataCentreReplicationOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): PostgresqlClusterV2DataCentreInterDataCentreReplication | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PostgresqlClusterV2DataCentreInterDataCentreReplication | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  // is_primary_data_centre - computed: false, optional: false, required: true
...
export class PostgresqlClusterV2DataCentreInterDataCentreReplicationList extends cdktf.ComplexList {
  public internalValue? : PostgresqlClusterV2DataCentreInterDataCentreReplication[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): PostgresqlClusterV2DataCentreInterDataCentreReplicationOutputReference {
    return new PostgresqlClusterV2DataCentreInterDataCentreReplicationOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface PostgresqlClusterV2DataCentreIntraDataCentreReplication {
  /**
  * Create the PostgreSQL cluster with the selected replication mode, see [PostgreSQL replication mode] (https://www.instaclustr.com/support/documentation/postgresql/options/replication-mode/).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#replication_mode PostgresqlClusterV2#replication_mode}
  */
  readonly replicationMode: string;
}

export function postgresqlClusterV2DataCentreIntraDataCentreReplicationToTerraform(struct?: PostgresqlClusterV2DataCentreIntraDataCentreReplication | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function postgresqlClusterV2DataCentreIntraDataCentreReplicationToHclTerraform(struct?: PostgresqlClusterV2DataCentreIntraDataCentreReplication | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PostgresqlClusterV2DataCentreIntraDataCentreReplicationOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): PostgresqlClusterV2DataCentreIntraDataCentreReplication | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PostgresqlClusterV2DataCentreIntraDataCentreReplication | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class PostgresqlClusterV2DataCentreIntraDataCentreReplicationList extends cdktf.ComplexList {
  public internalValue? : PostgresqlClusterV2DataCentreIntraDataCentreReplication[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): PostgresqlClusterV2DataCentreIntraDataCentreReplicationOutputReference {
    return new PostgresqlClusterV2DataCentreIntraDataCentreReplicationOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface PostgresqlClusterV2DataCentreNodes {
  /**
  * Deletion time of the node as a UTC timestamp
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#deletion_time PostgresqlClusterV2#deletion_time}
...
export function postgresqlClusterV2DataCentreNodesToTerraform(struct?: PostgresqlClusterV2DataCentreNodes | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function postgresqlClusterV2DataCentreNodesToHclTerraform(struct?: PostgresqlClusterV2DataCentreNodes | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PostgresqlClusterV2DataCentreNodesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): PostgresqlClusterV2DataCentreNodes | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PostgresqlClusterV2DataCentreNodes | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._deletionTime = undefined;
...
export class PostgresqlClusterV2DataCentreNodesList extends cdktf.ComplexList {
  public internalValue? : PostgresqlClusterV2DataCentreNodes[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): PostgresqlClusterV2DataCentreNodesOutputReference {
    return new PostgresqlClusterV2DataCentreNodesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface PostgresqlClusterV2DataCentrePgBouncer {
  /**
  * Version of Pg Bouncer to run on the cluster. Available versions: <ul> <li>`1.24.1`</li> </ul>
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#pg_bouncer_version PostgresqlClusterV2#pg_bouncer_version}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#pool_mode PostgresqlClusterV2#pool_mode}
  */
  readonly poolMode: string;
}

export function postgresqlClusterV2DataCentrePgBouncerToTerraform(struct?: PostgresqlClusterV2DataCentrePgBouncer | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function postgresqlClusterV2DataCentrePgBouncerToHclTerraform(struct?: PostgresqlClusterV2DataCentrePgBouncer | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PostgresqlClusterV2DataCentrePgBouncerOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): PostgresqlClusterV2DataCentrePgBouncer | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PostgresqlClusterV2DataCentrePgBouncer | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  // pg_bouncer_version - computed: false, optional: false, required: true
  ...
  // pool_mode - computed: false, optional: false, required: true
...
export class PostgresqlClusterV2DataCentrePgBouncerList extends cdktf.ComplexList {
  public internalValue? : PostgresqlClusterV2DataCentrePgBouncer[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): PostgresqlClusterV2DataCentrePgBouncerOutputReference {
    return new PostgresqlClusterV2DataCentrePgBouncerOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface PostgresqlClusterV2DataCentrePrivateConnectivityAwsPrivateLink {
  /**
  * The endpoint service name for the private link
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#endpoint_service_name PostgresqlClusterV2#endpoint_service_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#use_aws_private_link PostgresqlClusterV2#use_aws_private_link}
  */
  readonly useAwsPrivateLink?: boolean | cdktf.IResolvable;
}

export function postgresqlClusterV2DataCentrePrivateConnectivityAwsPrivateLinkToTerraform(struct?: PostgresqlClusterV2DataCentrePrivateConnectivityAwsPrivateLink | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function postgresqlClusterV2DataCentrePrivateConnectivityAwsPrivateLinkToHclTerraform(struct?: PostgresqlClusterV2DataCentrePrivateConnectivityAwsPrivateLink | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PostgresqlClusterV2DataCentrePrivateConnectivityAwsPrivateLinkOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): PostgresqlClusterV2DataCentrePrivateConnectivityAwsPrivateLink | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PostgresqlClusterV2DataCentrePrivateConnectivityAwsPrivateLink | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class PostgresqlClusterV2DataCentrePrivateConnectivityAwsPrivateLinkList extends cdktf.ComplexList {
  public internalValue? : PostgresqlClusterV2DataCentrePrivateConnectivityAwsPrivateLink[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): PostgresqlClusterV2DataCentrePrivateConnectivityAwsPrivateLinkOutputReference {
    return new PostgresqlClusterV2DataCentrePrivateConnectivityAwsPrivateLinkOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface PostgresqlClusterV2DataCentrePrivateConnectivityAzurePrivateLink {
  /**
  * The alias for the private link service
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#alias PostgresqlClusterV2#alias}
  */
  readonly alias?: string;
  /**
  * Flag to indicate that Azure Private Link is to be used for this cluster data Centre
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#use_azure_private_link PostgresqlClusterV2#use_azure_private_link}
  */
  readonly useAzurePrivateLink?: boolean | cdktf.IResolvable;
}

export function postgresqlClusterV2DataCentrePrivateConnectivityAzurePrivateLinkToTerraform(struct?: PostgresqlClusterV2DataCentrePrivateConnectivityAzurePrivateLink | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function postgresqlClusterV2DataCentrePrivateConnectivityAzurePrivateLinkToHclTerraform(struct?: PostgresqlClusterV2DataCentrePrivateConnectivityAzurePrivateLink | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PostgresqlClusterV2DataCentrePrivateConnectivityAzurePrivateLinkOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): PostgresqlClusterV2DataCentrePrivateConnectivityAzurePrivateLink | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PostgresqlClusterV2DataCentrePrivateConnectivityAzurePrivateLink | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  // use_azure_private_link - computed: false, optional: true, required: false
...
export class PostgresqlClusterV2DataCentrePrivateConnectivityAzurePrivateLinkList extends cdktf.ComplexList {
  public internalValue? : PostgresqlClusterV2DataCentrePrivateConnectivityAzurePrivateLink[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): PostgresqlClusterV2DataCentrePrivateConnectivityAzurePrivateLinkOutputReference {
    return new PostgresqlClusterV2DataCentrePrivateConnectivityAzurePrivateLinkOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface PostgresqlClusterV2DataCentrePrivateConnectivity {
  /**
  * aws_private_link block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#aws_private_link PostgresqlClusterV2#aws_private_link}
  */
  readonly awsPrivateLink?: PostgresqlClusterV2DataCentrePrivateConnectivityAwsPrivateLink[] | cdktf.IResolvable;
  /**
  * azure_private_link block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#azure_private_link PostgresqlClusterV2#azure_private_link}
  */
  readonly azurePrivateLink?: PostgresqlClusterV2DataCentrePrivateConnectivityAzurePrivateLink[] | cdktf.IResolvable;
}

export function postgresqlClusterV2DataCentrePrivateConnectivityToTerraform(struct?: PostgresqlClusterV2DataCentrePrivateConnectivity | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    aws_private_link: cdktf.listMapper(postgresqlClusterV2DataCentrePrivateConnectivityAwsPrivateLinkToTerraform, true)(struct!.awsPrivateLink),
    azure_private_link: cdktf.listMapper(postgresqlClusterV2DataCentrePrivateConnectivityAzurePrivateLinkToTerraform, true)(struct!.azurePrivateLink),
  }
}


export function postgresqlClusterV2DataCentrePrivateConnectivityToHclTerraform(struct?: PostgresqlClusterV2DataCentrePrivateConnectivity | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    aws_private_link: {
      value: cdktf.listMapperHcl(postgresqlClusterV2DataCentrePrivateConnectivityAwsPrivateLinkToHclTerraform, true)(struct!.awsPrivateLink),
      isBlock: true,
      type: "list",
      storageClassType: "PostgresqlClusterV2DataCentrePrivateConnectivityAwsPrivateLinkList",
    },
    azure_private_link: {
      value: cdktf.listMapperHcl(postgresqlClusterV2DataCentrePrivateConnectivityAzurePrivateLinkToHclTerraform, true)(struct!.azurePrivateLink),
      isBlock: true,
      type: "list",
      storageClassType: "PostgresqlClusterV2DataCentrePrivateConnectivityAzurePrivateLinkList",
    },
  };
...
export class PostgresqlClusterV2DataCentrePrivateConnectivityOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): PostgresqlClusterV2DataCentrePrivateConnectivity | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PostgresqlClusterV2DataCentrePrivateConnectivity | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  private _awsPrivateLink = new PostgresqlClusterV2DataCentrePrivateConnectivityAwsPrivateLinkList(this, "aws_private_link", false);
  public get awsPrivateLink() {
    return this._awsPrivateLink;
  }
  public putAwsPrivateLink(value: PostgresqlClusterV2DataCentrePrivateConnectivityAwsPrivateLink[] | cdktf.IResolvable) {
  ...
  private _azurePrivateLink = new PostgresqlClusterV2DataCentrePrivateConnectivityAzurePrivateLinkList(this, "azure_private_link", false);
  public get azurePrivateLink() {
    return this._azurePrivateLink;
  }
  public putAzurePrivateLink(value: PostgresqlClusterV2DataCentrePrivateConnectivityAzurePrivateLink[] | cdktf.IResolvable) {
...
export class PostgresqlClusterV2DataCentrePrivateConnectivityList extends cdktf.ComplexList {
  public internalValue? : PostgresqlClusterV2DataCentrePrivateConnectivity[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): PostgresqlClusterV2DataCentrePrivateConnectivityOutputReference {
    return new PostgresqlClusterV2DataCentrePrivateConnectivityOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface PostgresqlClusterV2DataCentreTag {
  /**
  * Key of the tag for the Data Centre.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#key PostgresqlClusterV2#key}
  */
  readonly key: string;
  /**
  * Value of the tag for the Data Centre.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#value PostgresqlClusterV2#value}
  */
  readonly value?: string;
}

export function postgresqlClusterV2DataCentreTagToTerraform(struct?: PostgresqlClusterV2DataCentreTag | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function postgresqlClusterV2DataCentreTagToHclTerraform(struct?: PostgresqlClusterV2DataCentreTag | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PostgresqlClusterV2DataCentreTagOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): PostgresqlClusterV2DataCentreTag | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PostgresqlClusterV2DataCentreTag | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._key = undefined;
...
export class PostgresqlClusterV2DataCentreTagList extends cdktf.ComplexList {
  public internalValue? : PostgresqlClusterV2DataCentreTag[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): PostgresqlClusterV2DataCentreTagOutputReference {
    return new PostgresqlClusterV2DataCentreTagOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface PostgresqlClusterV2DataCentre {
  /**
  * Enable client to cluster Encryption.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#client_to_cluster_encryption PostgresqlClusterV2#client_to_cluster_encryption}
  */
  readonly clientToClusterEncryption: boolean | cdktf.IResolvable;
  /**
  * Name of a cloud provider service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#cloud_provider PostgresqlClusterV2#cloud_provider}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#custom_subject_alternative_names PostgresqlClusterV2#custom_subject_alternative_names}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#load_balancer PostgresqlClusterV2#load_balancer}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#load_balancer_endpoint PostgresqlClusterV2#load_balancer_endpoint}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#network PostgresqlClusterV2#network}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#number_of_nodes PostgresqlClusterV2#number_of_nodes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#provider_account_name PostgresqlClusterV2#provider_account_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#region PostgresqlClusterV2#region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#zero_inbound_access PostgresqlClusterV2#zero_inbound_access}
  */
  readonly zeroInboundAccess?: boolean | cdktf.IResolvable;
  /**
  * aws_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#aws_settings PostgresqlClusterV2#aws_settings}
  */
  readonly awsSettings?: PostgresqlClusterV2DataCentreAwsSettings[] | cdktf.IResolvable;
  /**
  * azure_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#azure_settings PostgresqlClusterV2#azure_settings}
  */
  readonly azureSettings?: PostgresqlClusterV2DataCentreAzureSettings[] | cdktf.IResolvable;
  /**
  * deleted_nodes block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#deleted_nodes PostgresqlClusterV2#deleted_nodes}
  */
  readonly deletedNodes?: PostgresqlClusterV2DataCentreDeletedNodes[] | cdktf.IResolvable;
  /**
  * gcp_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#gcp_settings PostgresqlClusterV2#gcp_settings}
  */
  readonly gcpSettings?: PostgresqlClusterV2DataCentreGcpSettings[] | cdktf.IResolvable;
  /**
  * inter_data_centre_replication block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#inter_data_centre_replication PostgresqlClusterV2#inter_data_centre_replication}
  */
  readonly interDataCentreReplication?: PostgresqlClusterV2DataCentreInterDataCentreReplication[] | cdktf.IResolvable;
  /**
  * intra_data_centre_replication block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#intra_data_centre_replication PostgresqlClusterV2#intra_data_centre_replication}
  */
  readonly intraDataCentreReplication: PostgresqlClusterV2DataCentreIntraDataCentreReplication[] | cdktf.IResolvable;
  /**
  * nodes block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#nodes PostgresqlClusterV2#nodes}
  */
  readonly nodes?: PostgresqlClusterV2DataCentreNodes[] | cdktf.IResolvable;
  /**
  * pg_bouncer block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#pg_bouncer PostgresqlClusterV2#pg_bouncer}
  */
  readonly pgBouncer?: PostgresqlClusterV2DataCentrePgBouncer[] | cdktf.IResolvable;
  /**
  * private_connectivity block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#private_connectivity PostgresqlClusterV2#private_connectivity}
  */
  readonly privateConnectivity?: PostgresqlClusterV2DataCentrePrivateConnectivity[] | cdktf.IResolvable;
  /**
  * tag block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#tag PostgresqlClusterV2#tag}
  */
  readonly tag?: PostgresqlClusterV2DataCentreTag[] | cdktf.IResolvable;
}

export function postgresqlClusterV2DataCentreToTerraform(struct?: PostgresqlClusterV2DataCentre | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    aws_settings: cdktf.listMapper(postgresqlClusterV2DataCentreAwsSettingsToTerraform, true)(struct!.awsSettings),
    azure_settings: cdktf.listMapper(postgresqlClusterV2DataCentreAzureSettingsToTerraform, true)(struct!.azureSettings),
    deleted_nodes: cdktf.listMapper(postgresqlClusterV2DataCentreDeletedNodesToTerraform, true)(struct!.deletedNodes),
    gcp_settings: cdktf.listMapper(postgresqlClusterV2DataCentreGcpSettingsToTerraform, true)(struct!.gcpSettings),
    inter_data_centre_replication: cdktf.listMapper(postgresqlClusterV2DataCentreInterDataCentreReplicationToTerraform, true)(struct!.interDataCentreReplication),
    intra_data_centre_replication: cdktf.listMapper(postgresqlClusterV2DataCentreIntraDataCentreReplicationToTerraform, true)(struct!.intraDataCentreReplication),
    nodes: cdktf.listMapper(postgresqlClusterV2DataCentreNodesToTerraform, true)(struct!.nodes),
    pg_bouncer: cdktf.listMapper(postgresqlClusterV2DataCentrePgBouncerToTerraform, true)(struct!.pgBouncer),
    private_connectivity: cdktf.listMapper(postgresqlClusterV2DataCentrePrivateConnectivityToTerraform, true)(struct!.privateConnectivity),
    tag: cdktf.listMapper(postgresqlClusterV2DataCentreTagToTerraform, true)(struct!.tag),
  }
}


export function postgresqlClusterV2DataCentreToHclTerraform(struct?: PostgresqlClusterV2DataCentre | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    aws_settings: {
      value: cdktf.listMapperHcl(postgresqlClusterV2DataCentreAwsSettingsToHclTerraform, true)(struct!.awsSettings),
      isBlock: true,
      type: "list",
      storageClassType: "PostgresqlClusterV2DataCentreAwsSettingsList",
    },
    azure_settings: {
      value: cdktf.listMapperHcl(postgresqlClusterV2DataCentreAzureSettingsToHclTerraform, true)(struct!.azureSettings),
      isBlock: true,
      type: "list",
      storageClassType: "PostgresqlClusterV2DataCentreAzureSettingsList",
    },
    deleted_nodes: {
      value: cdktf.listMapperHcl(postgresqlClusterV2DataCentreDeletedNodesToHclTerraform, true)(struct!.deletedNodes),
      isBlock: true,
      type: "list",
      storageClassType: "PostgresqlClusterV2DataCentreDeletedNodesList",
    },
    gcp_settings: {
      value: cdktf.listMapperHcl(postgresqlClusterV2DataCentreGcpSettingsToHclTerraform, true)(struct!.gcpSettings),
      isBlock: true,
      type: "list",
      storageClassType: "PostgresqlClusterV2DataCentreGcpSettingsList",
    },
    inter_data_centre_replication: {
      value: cdktf.listMapperHcl(postgresqlClusterV2DataCentreInterDataCentreReplicationToHclTerraform, true)(struct!.interDataCentreReplication),
      isBlock: true,
      type: "list",
      storageClassType: "PostgresqlClusterV2DataCentreInterDataCentreReplicationList",
    },
    intra_data_centre_replication: {
      value: cdktf.listMapperHcl(postgresqlClusterV2DataCentreIntraDataCentreReplicationToHclTerraform, true)(struct!.intraDataCentreReplication),
      isBlock: true,
      type: "list",
      storageClassType: "PostgresqlClusterV2DataCentreIntraDataCentreReplicationList",
    },
    nodes: {
      value: cdktf.listMapperHcl(postgresqlClusterV2DataCentreNodesToHclTerraform, true)(struct!.nodes),
      isBlock: true,
      type: "list",
      storageClassType: "PostgresqlClusterV2DataCentreNodesList",
    },
    pg_bouncer: {
      value: cdktf.listMapperHcl(postgresqlClusterV2DataCentrePgBouncerToHclTerraform, true)(struct!.pgBouncer),
      isBlock: true,
      type: "list",
      storageClassType: "PostgresqlClusterV2DataCentrePgBouncerList",
    },
    private_connectivity: {
      value: cdktf.listMapperHcl(postgresqlClusterV2DataCentrePrivateConnectivityToHclTerraform, true)(struct!.privateConnectivity),
      isBlock: true,
      type: "list",
      storageClassType: "PostgresqlClusterV2DataCentrePrivateConnectivityList",
    },
    tag: {
      value: cdktf.listMapperHcl(postgresqlClusterV2DataCentreTagToHclTerraform, true)(struct!.tag),
      isBlock: true,
      type: "list",
      storageClassType: "PostgresqlClusterV2DataCentreTagList",
    },
  };
...
export class PostgresqlClusterV2DataCentreOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): PostgresqlClusterV2DataCentre | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PostgresqlClusterV2DataCentre | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  private _awsSettings = new PostgresqlClusterV2DataCentreAwsSettingsList(this, "aws_settings", false);
  public get awsSettings() {
    return this._awsSettings;
  }
  public putAwsSettings(value: PostgresqlClusterV2DataCentreAwsSettings[] | cdktf.IResolvable) {
  ...
  private _azureSettings = new PostgresqlClusterV2DataCentreAzureSettingsList(this, "azure_settings", false);
  public get azureSettings() {
    return this._azureSettings;
  }
  public putAzureSettings(value: PostgresqlClusterV2DataCentreAzureSettings[] | cdktf.IResolvable) {
  ...
  private _deletedNodes = new PostgresqlClusterV2DataCentreDeletedNodesList(this, "deleted_nodes", false);
  public get deletedNodes() {
    return this._deletedNodes;
  }
  public putDeletedNodes(value: PostgresqlClusterV2DataCentreDeletedNodes[] | cdktf.IResolvable) {
  ...
  private _gcpSettings = new PostgresqlClusterV2DataCentreGcpSettingsList(this, "gcp_settings", false);
  public get gcpSettings() {
    return this._gcpSettings;
  }
  public putGcpSettings(value: PostgresqlClusterV2DataCentreGcpSettings[] | cdktf.IResolvable) {
  ...
  private _interDataCentreReplication = new PostgresqlClusterV2DataCentreInterDataCentreReplicationList(this, "inter_data_centre_replication", false);
  public get interDataCentreReplication() {
    return this._interDataCentreReplication;
  }
  public putInterDataCentreReplication(value: PostgresqlClusterV2DataCentreInterDataCentreReplication[] | cdktf.IResolvable) {
  ...
  // intra_data_centre_replication - computed: false, optional: false, required: true
  private _intraDataCentreReplication = new PostgresqlClusterV2DataCentreIntraDataCentreReplicationList(this, "intra_data_centre_replication", false);
  public get intraDataCentreReplication() {
    return this._intraDataCentreReplication;
  }
  public putIntraDataCentreReplication(value: PostgresqlClusterV2DataCentreIntraDataCentreReplication[] | cdktf.IResolvable) {
  ...
  private _nodes = new PostgresqlClusterV2DataCentreNodesList(this, "nodes", false);
  public get nodes() {
    return this._nodes;
  }
  public putNodes(value: PostgresqlClusterV2DataCentreNodes[] | cdktf.IResolvable) {
  ...
  private _pgBouncer = new PostgresqlClusterV2DataCentrePgBouncerList(this, "pg_bouncer", false);
  public get pgBouncer() {
    return this._pgBouncer;
  }
  public putPgBouncer(value: PostgresqlClusterV2DataCentrePgBouncer[] | cdktf.IResolvable) {
  ...
  private _privateConnectivity = new PostgresqlClusterV2DataCentrePrivateConnectivityList(this, "private_connectivity", false);
  public get privateConnectivity() {
    return this._privateConnectivity;
  }
  public putPrivateConnectivity(value: PostgresqlClusterV2DataCentrePrivateConnectivity[] | cdktf.IResolvable) {
  ...
  private _tag = new PostgresqlClusterV2DataCentreTagList(this, "tag", false);
  public get tag() {
    return this._tag;
  }
  public putTag(value: PostgresqlClusterV2DataCentreTag[] | cdktf.IResolvable) {
...
export class PostgresqlClusterV2DataCentreList extends cdktf.ComplexList {
  public internalValue? : PostgresqlClusterV2DataCentre[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): PostgresqlClusterV2DataCentreOutputReference {
    return new PostgresqlClusterV2DataCentreOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface PostgresqlClusterV2ResizeSettings {
  /**
  * Number of concurrent nodes to resize during a resize operation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#concurrency PostgresqlClusterV2#concurrency}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#notify_support_contacts PostgresqlClusterV2#notify_support_contacts}
  */
  readonly notifySupportContacts?: boolean | cdktf.IResolvable;
}

export function postgresqlClusterV2ResizeSettingsToTerraform(struct?: PostgresqlClusterV2ResizeSettings | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function postgresqlClusterV2ResizeSettingsToHclTerraform(struct?: PostgresqlClusterV2ResizeSettings | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PostgresqlClusterV2ResizeSettingsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): PostgresqlClusterV2ResizeSettings | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PostgresqlClusterV2ResizeSettings | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class PostgresqlClusterV2ResizeSettingsList extends cdktf.ComplexList {
  public internalValue? : PostgresqlClusterV2ResizeSettings[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): PostgresqlClusterV2ResizeSettingsOutputReference {
    return new PostgresqlClusterV2ResizeSettingsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface PostgresqlClusterV2Timeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#create PostgresqlClusterV2#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#default PostgresqlClusterV2#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#update PostgresqlClusterV2#update}
  */
  readonly update?: string;
}

export function postgresqlClusterV2TimeoutsToTerraform(struct?: PostgresqlClusterV2Timeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function postgresqlClusterV2TimeoutsToHclTerraform(struct?: PostgresqlClusterV2Timeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PostgresqlClusterV2TimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): PostgresqlClusterV2Timeouts | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PostgresqlClusterV2Timeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export interface PostgresqlClusterV2TwoFactorDelete {
  /**
  * The email address which will be contacted when the cluster is requested to be deleted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#confirmation_email PostgresqlClusterV2#confirmation_email}
  */
  readonly confirmationEmail: string;
  /**
  * The phone number which will be contacted when the cluster is requested to be delete.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#confirmation_phone_number PostgresqlClusterV2#confirmation_phone_number}
  */
  readonly confirmationPhoneNumber?: string;
}

export function postgresqlClusterV2TwoFactorDeleteToTerraform(struct?: PostgresqlClusterV2TwoFactorDelete | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function postgresqlClusterV2TwoFactorDeleteToHclTerraform(struct?: PostgresqlClusterV2TwoFactorDelete | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PostgresqlClusterV2TwoFactorDeleteOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): PostgresqlClusterV2TwoFactorDelete | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PostgresqlClusterV2TwoFactorDelete | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class PostgresqlClusterV2TwoFactorDeleteList extends cdktf.ComplexList {
  public internalValue? : PostgresqlClusterV2TwoFactorDelete[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): PostgresqlClusterV2TwoFactorDeleteOutputReference {
    return new PostgresqlClusterV2TwoFactorDeleteOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2 instaclustr_postgresql_cluster_v2}
*/
export class PostgresqlClusterV2 extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "instaclustr_postgresql_cluster_v2";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a PostgresqlClusterV2 resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the PostgresqlClusterV2 to import
  * @param importFromId The id of the existing PostgresqlClusterV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the PostgresqlClusterV2 to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "instaclustr_postgresql_cluster_v2", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.22/docs/resources/postgresql_cluster_v2 instaclustr_postgresql_cluster_v2} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options PostgresqlClusterV2Config
  */
  public constructor(scope: Construct, id: string, config: PostgresqlClusterV2Config) {
    super(scope, id, {
      terraformResourceType: 'instaclustr_postgresql_cluster_v2',
  ...
  // postgresql_version - computed: false, optional: false, required: true
  ...
  // synchronous_mode_strict - computed: false, optional: false, required: true
  ...
  private _dataCentre = new PostgresqlClusterV2DataCentreList(this, "data_centre", false);
  public get dataCentre() {
    return this._dataCentre;
  }
  public putDataCentre(value: PostgresqlClusterV2DataCentre[] | cdktf.IResolvable) {
  ...
  private _resizeSettings = new PostgresqlClusterV2ResizeSettingsList(this, "resize_settings", false);
  public get resizeSettings() {
    return this._resizeSettings;
  }
  public putResizeSettings(value: PostgresqlClusterV2ResizeSettings[] | cdktf.IResolvable) {
  ...
  private _timeouts = new PostgresqlClusterV2TimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: PostgresqlClusterV2Timeouts) {
  ...
  private _twoFactorDelete = new PostgresqlClusterV2TwoFactorDeleteList(this, "two_factor_delete", false);
  public get twoFactorDelete() {
    return this._twoFactorDelete;
  }
  public putTwoFactorDelete(value: PostgresqlClusterV2TwoFactorDelete[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      data_centre: cdktf.listMapper(postgresqlClusterV2DataCentreToTerraform, true)(this._dataCentre.internalValue),
      resize_settings: cdktf.listMapper(postgresqlClusterV2ResizeSettingsToTerraform, true)(this._resizeSettings.internalValue),
      timeouts: postgresqlClusterV2TimeoutsToTerraform(this._timeouts.internalValue),
      two_factor_delete: cdktf.listMapper(postgresqlClusterV2TwoFactorDeleteToTerraform, true)(this._twoFactorDelete.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      data_centre: {
        value: cdktf.listMapperHcl(postgresqlClusterV2DataCentreToHclTerraform, true)(this._dataCentre.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "PostgresqlClusterV2DataCentreList",
      },
      resize_settings: {
        value: cdktf.listMapperHcl(postgresqlClusterV2ResizeSettingsToHclTerraform, true)(this._resizeSettings.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "PostgresqlClusterV2ResizeSettingsList",
      },
      timeouts: {
        value: postgresqlClusterV2TimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "PostgresqlClusterV2Timeouts",
      },
      two_factor_delete: {
        value: cdktf.listMapperHcl(postgresqlClusterV2TwoFactorDeleteToHclTerraform, true)(this._twoFactorDelete.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "PostgresqlClusterV2TwoFactorDeleteList",
      },
    };
