// https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search
...
export interface ItsiKpiBaseSearchConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#actions ItsiKpiBaseSearch#actions}
  */
  readonly actions?: string;
  /**
  * Contains the number of seconds of lag to apply to the alert search, max is 30 minutes (1799 seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#alert_lag ItsiKpiBaseSearch#alert_lag}
  */
  readonly alertLag: string;
  /**
  * User specified interval to run the KPI search in minutes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#alert_period ItsiKpiBaseSearch#alert_period}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#base_search ItsiKpiBaseSearch#base_search}
  */
  readonly baseSearch: string;
  /**
  * General description for this KPI base search.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#description ItsiKpiBaseSearch#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#entity_alias_filtering_fields ItsiKpiBaseSearch#entity_alias_filtering_fields}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#entity_breakdown_id_fields ItsiKpiBaseSearch#entity_breakdown_id_fields}
  */
  readonly entityBreakdownIdFields: string;
  /**
  * Fields from this KPI's search events that will be mapped to the alias fields defined in entities for the service containing this KPI. This field enables the KPI search to tie the aliases of entities to the fields from the KPI events in identifying entities at search time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#entity_id_fields ItsiKpiBaseSearch#entity_id_fields}
  */
  readonly entityIdFields: string;
  /**
  * Determines if search breaks down by entities. See KPI definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#is_entity_breakdown ItsiKpiBaseSearch#is_entity_breakdown}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#is_service_entity_filter ItsiKpiBaseSearch#is_service_entity_filter}
  */
  readonly isServiceEntityFilter: boolean | cdktf.IResolvable;
  /**
  * Used to further split metrics. Hidden in the UI.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#metric_qualifier ItsiKpiBaseSearch#metric_qualifier}
  */
  readonly metricQualifier?: string;
  /**
  * Value in minutes. This determines how far back each time window is during KPI search runs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#search_alert_earliest ItsiKpiBaseSearch#search_alert_earliest}
  */
  readonly searchAlertEarliest: string;
  /**
  * The team the object belongs to. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#sec_grp ItsiKpiBaseSearch#sec_grp}
  */
  readonly secGrp?: string;
  /**
  * Source of DA used for this search. See KPI Threshold Templates.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#source_itsi_da ItsiKpiBaseSearch#source_itsi_da}
  */
  readonly sourceItsiDa?: string;
  /**
  * Name of this KPI base search.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#title ItsiKpiBaseSearch#title}
  */
  readonly title: string;
  /**
  * metrics block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#metrics ItsiKpiBaseSearch#metrics}
  */
  readonly metrics?: ItsiKpiBaseSearchMetrics[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#timeouts ItsiKpiBaseSearch#timeouts}
  */
...
export interface ItsiKpiBaseSearchMetrics {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#aggregate_statop ItsiKpiBaseSearch#aggregate_statop}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#entity_statop ItsiKpiBaseSearch#entity_statop}
  */
  readonly entityStatop: string;
  /**
  * How to fill missing data
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#fill_gaps ItsiKpiBaseSearch#fill_gaps}
  */
  readonly fillGaps: string;
  /**
  * Custom value to fill data gaps.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#gap_custom_alert_value ItsiKpiBaseSearch#gap_custom_alert_value}
  */
  readonly gapCustomAlertValue?: number;
  /**
  * Severity level assigned for data gaps (info, normal, low, medium, high, critical, or unknown).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#gap_severity ItsiKpiBaseSearch#gap_severity}
  */
  readonly gapSeverity?: string;
  /**
  * Severity color assigned for data gaps.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#gap_severity_color ItsiKpiBaseSearch#gap_severity_color}
  */
  readonly gapSeverityColor?: string;
  /**
  * Severity light color assigned for data gaps.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#gap_severity_color_light ItsiKpiBaseSearch#gap_severity_color_light}
  */
  readonly gapSeverityColorLight?: string;
  /**
  * Severity value assigned for data gaps.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#gap_severity_value ItsiKpiBaseSearch#gap_severity_value}
  */
  readonly gapSeverityValue?: string;
  /**
  * The field on which the statistical operation runs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#threshold_field ItsiKpiBaseSearch#threshold_field}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#unit ItsiKpiBaseSearch#unit}
  */
...
export interface ItsiKpiBaseSearchTimeouts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#create ItsiKpiBaseSearch#create}
  */
  readonly create?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#delete ItsiKpiBaseSearch#delete}
  */
  readonly delete?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Read operations occur during any refresh or planning operation when refresh is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#read ItsiKpiBaseSearch#read}
  */
  readonly read?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#update ItsiKpiBaseSearch#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search itsi_kpi_base_search}
*/
export class ItsiKpiBaseSearch extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ItsiKpiBaseSearch that should be imported. Refer to the {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_kpi_base_search itsi_kpi_base_search} Resource
  *
  * @param scope The scope in which to define this construct
