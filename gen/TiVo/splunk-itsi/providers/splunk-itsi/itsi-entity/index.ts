// https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_entity
...
export interface ItsiEntityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_entity#aliases ItsiEntity#aliases}
  */
  readonly aliases?: { [key: string]: string };
  /**
  * User defined description of the entity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_entity#description ItsiEntity#description}
  */
  readonly description?: string;
  /**
  * A set of _key values for each entity type associated with the entity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_entity#entity_type_ids ItsiEntity#entity_type_ids}
  */
  readonly entityTypeIds?: string[];
  /**
  * Map of Field/Value pairs that provide information/description for the entity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_entity#info ItsiEntity#info}
  */
  readonly info?: { [key: string]: string };
  /**
  * Name of the entity. Can be any unique value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_entity#title ItsiEntity#title}
  */
  readonly title: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_entity#timeouts ItsiEntity#timeouts}
  */
...
export interface ItsiEntityTimeouts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_entity#create ItsiEntity#create}
  */
  readonly create?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_entity#delete ItsiEntity#delete}
  */
  readonly delete?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Read operations occur during any refresh or planning operation when refresh is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_entity#read ItsiEntity#read}
  */
  readonly read?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_entity#update ItsiEntity#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_entity itsi_entity}
*/
export class ItsiEntity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ItsiEntity that should be imported. Refer to the {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_entity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/resources/itsi_entity itsi_entity} Resource
  *
  * @param scope The scope in which to define this construct
