// https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/data-sources/itsi_splunk_search
...
export interface DataItsiSplunkSearchConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/data-sources/itsi_splunk_search#join_fields DataItsiSplunkSearch#join_fields}
  */
  readonly joinFields?: string[];
  /**
  * Number of searches that could be run in parallel per data source.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/data-sources/itsi_splunk_search#search_concurrency DataItsiSplunkSearch#search_concurrency}
  */
  readonly searchConcurrency?: number;
  /**
  * search block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/data-sources/itsi_splunk_search#search DataItsiSplunkSearch#search}
  */
  readonly search?: DataItsiSplunkSearchSearch[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/data-sources/itsi_splunk_search#timeouts DataItsiSplunkSearch#timeouts}
  */
...
export interface DataItsiSplunkSearchSearch {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/data-sources/itsi_splunk_search#allow_no_results DataItsiSplunkSearch#allow_no_results}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/data-sources/itsi_splunk_search#allow_partial_results DataItsiSplunkSearch#allow_partial_results}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/data-sources/itsi_splunk_search#earliest_time DataItsiSplunkSearch#earliest_time}
  */
  readonly earliestTime?: string;
  /**
  * Specify a time string. Sets the latest (exclusive), respectively, time bounds for the search.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/data-sources/itsi_splunk_search#latest_time DataItsiSplunkSearch#latest_time}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/data-sources/itsi_splunk_search#query DataItsiSplunkSearch#query}
  */
  readonly query: string;
  /**
  * The Splunk app in which the search query should be performed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/data-sources/itsi_splunk_search#splunk_app DataItsiSplunkSearch#splunk_app}
  */
  readonly splunkApp?: string;
  /**
  * The Splunk user in the context of which the search query should be performed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/data-sources/itsi_splunk_search#splunk_user DataItsiSplunkSearch#splunk_user}
  */
  readonly splunkUser?: string;
  /**
  * HTTP timeout in seconds. 0 means no timeout.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/data-sources/itsi_splunk_search#timeout DataItsiSplunkSearch#timeout}
  */
...
export interface DataItsiSplunkSearchTimeouts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/data-sources/itsi_splunk_search#read DataItsiSplunkSearch#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/data-sources/itsi_splunk_search itsi_splunk_search}
*/
export class DataItsiSplunkSearch extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataItsiSplunkSearch that should be imported. Refer to the {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/data-sources/itsi_splunk_search#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tivo/splunk-itsi/2.2.3/docs/data-sources/itsi_splunk_search itsi_splunk_search} Data Source
  *
  * @param scope The scope in which to define this construct
