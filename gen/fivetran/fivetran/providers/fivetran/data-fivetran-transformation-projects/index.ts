// https://registry.terraform.io/providers/fivetran/fivetran/1.9.11/docs/data-sources/transformation_projects
...
/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.11/docs/data-sources/transformation_projects fivetran_transformation_projects}
*/
export class DataFivetranTransformationProjects extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFivetranTransformationProjects that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.11/docs/data-sources/transformation_projects#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.11/docs/data-sources/transformation_projects fivetran_transformation_projects} Data Source
  *
  * @param scope The scope in which to define this construct
