// https://registry.terraform.io/providers/fivetran/fivetran/1.9.11/docs/data-sources/transformation
...
export interface DataFivetranTransformationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.11/docs/data-sources/transformation#id DataFivetranTransformation#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.11/docs/data-sources/transformation fivetran_transformation}
*/
export class DataFivetranTransformation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFivetranTransformation that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.11/docs/data-sources/transformation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.11/docs/data-sources/transformation fivetran_transformation} Data Source
  *
  * @param scope The scope in which to define this construct
