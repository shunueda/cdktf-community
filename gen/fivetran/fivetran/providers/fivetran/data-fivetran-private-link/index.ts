// https://registry.terraform.io/providers/fivetran/fivetran/1.9.11/docs/data-sources/private_link
...
export interface DataFivetranPrivateLinkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.11/docs/data-sources/private_link#id DataFivetranPrivateLink#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.11/docs/data-sources/private_link fivetran_private_link}
*/
export class DataFivetranPrivateLink extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFivetranPrivateLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.11/docs/data-sources/private_link#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fivetran/fivetran/1.9.11/docs/data-sources/private_link fivetran_private_link} Data Source
  *
  * @param scope The scope in which to define this construct
