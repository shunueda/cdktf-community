// https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/log_timeline
...
export interface LogTimelineConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/log_timeline#default_connection LogTimeline#default_connection}
  */
  readonly defaultConnection?: string;
  /**
  * Description of the chart (Optional)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/log_timeline#description LogTimeline#description}
  */
  readonly description?: string;
  /**
  * Seconds since epoch to end the visualization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/log_timeline#end_time LogTimeline#end_time}
  */
  readonly endTime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/log_timeline#id LogTimeline#id}
  *
  ...
  * Name of the chart
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/log_timeline#name LogTimeline#name}
  */
  readonly name: string;
  /**
  * Signalflow program text for the chart. More info at "https://developers.signalfx.com/docs/signalflow-overview"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/log_timeline#program_text LogTimeline#program_text}
  */
  readonly programText: string;
  /**
  * Seconds since epoch to start the visualization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/log_timeline#start_time LogTimeline#start_time}
  */
  readonly startTime?: number;
  /**
  * Tags associated with the resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/log_timeline#tags LogTimeline#tags}
  */
  readonly tags?: string[];
  /**
  * Seconds to display in the visualization. This is a rolling range from the current time. Example: 3600 = `-1h`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/log_timeline#time_range LogTimeline#time_range}
  */
  readonly timeRange?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/log_timeline signalfx_log_timeline}
*/
export class LogTimeline extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogTimeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/log_timeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/log_timeline signalfx_log_timeline} Resource
  *
  * @param scope The scope in which to define this construct
