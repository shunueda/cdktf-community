// https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/service_now_integration
...
export interface ServiceNowIntegrationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/service_now_integration#alert_resolved_payload_template ServiceNowIntegration#alert_resolved_payload_template}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/service_now_integration#alert_triggered_payload_template ServiceNowIntegration#alert_triggered_payload_template}
  */
  readonly alertTriggeredPayloadTemplate?: string;
  /**
  * Whether the integration is enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/service_now_integration#enabled ServiceNowIntegration#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/service_now_integration#id ServiceNowIntegration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/service_now_integration#instance_name ServiceNowIntegration#instance_name}
  */
  readonly instanceName: string;
  /**
  * The type of issue in standard ITIL terminology. The allowed values are `Incident` and `Problem`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/service_now_integration#issue_type ServiceNowIntegration#issue_type}
  */
  readonly issueType: string;
  /**
  * Name of the integration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/service_now_integration#name ServiceNowIntegration#name}
  */
  readonly name: string;
  /**
  * Password used to authenticate the ServiceNow integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/service_now_integration#password ServiceNowIntegration#password}
  */
  readonly password: string;
  /**
  * User name used to authenticate the ServiceNow integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/service_now_integration#username ServiceNowIntegration#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/service_now_integration signalfx_service_now_integration}
*/
export class ServiceNowIntegration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceNowIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/service_now_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/service_now_integration signalfx_service_now_integration} Resource
  *
  * @param scope The scope in which to define this construct
