// https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/automated_archival_settings
...
export interface AutomatedArchivalSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/automated_archival_settings#enabled AutomatedArchivalSettings#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/automated_archival_settings#grace_period AutomatedArchivalSettings#grace_period}
  */
  readonly gracePeriod: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/automated_archival_settings#id AutomatedArchivalSettings#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/automated_archival_settings#lookback_period AutomatedArchivalSettings#lookback_period}
  */
  readonly lookbackPeriod: string;
  /**
  * Org limit for the number of rulesets that can be created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/automated_archival_settings#ruleset_limit AutomatedArchivalSettings#ruleset_limit}
  */
  readonly rulesetLimit?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/automated_archival_settings signalfx_automated_archival_settings}
*/
export class AutomatedArchivalSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AutomatedArchivalSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/automated_archival_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/automated_archival_settings signalfx_automated_archival_settings} Resource
  *
  * @param scope The scope in which to define this construct
