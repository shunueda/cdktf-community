// https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/webhook_integration
...
export interface WebhookIntegrationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/webhook_integration#enabled WebhookIntegration#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/webhook_integration#id WebhookIntegration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/webhook_integration#method WebhookIntegration#method}
  */
  readonly method?: string;
  /**
  * Name of the integration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/webhook_integration#name WebhookIntegration#name}
  */
  readonly name: string;
  /**
  * Template for the payload to be sent with the webhook request in JSON format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/webhook_integration#payload_template WebhookIntegration#payload_template}
  */
  readonly payloadTemplate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/webhook_integration#shared_secret WebhookIntegration#shared_secret}
  */
  readonly sharedSecret?: string;
  /**
  * Webhook URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/webhook_integration#url WebhookIntegration#url}
  */
  readonly url?: string;
  /**
  * headers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/webhook_integration#headers WebhookIntegration#headers}
  */
  readonly headers?: WebhookIntegrationHeaders[] | cdktf.IResolvable;
}
export interface WebhookIntegrationHeaders {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/webhook_integration#header_key WebhookIntegration#header_key}
  */
  readonly headerKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/webhook_integration#header_value WebhookIntegration#header_value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/webhook_integration signalfx_webhook_integration}
*/
export class WebhookIntegration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WebhookIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/webhook_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/webhook_integration signalfx_webhook_integration} Resource
  *
  * @param scope The scope in which to define this construct
