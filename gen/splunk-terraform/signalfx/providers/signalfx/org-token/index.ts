// https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token
...
export interface OrgTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token#auth_scopes OrgToken#auth_scopes}
  */
  readonly authScopes?: string[];
  /**
  * Description of the token (Optional)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token#description OrgToken#description}
  */
  readonly description?: string;
  /**
  * Flag that controls enabling the token. If set to `true`, the token is disabled, and you can't use it for authentication. Defaults to `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token#disabled OrgToken#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token#id OrgToken#id}
  *
  ...
  * Name of the token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token#name OrgToken#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token#notifications OrgToken#notifications}
  */
  readonly notifications?: string[];
  /**
  * dpm_limits block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token#dpm_limits OrgToken#dpm_limits}
  */
  readonly dpmLimits?: OrgTokenDpmLimits;
  /**
  * host_or_usage_limits block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token#host_or_usage_limits OrgToken#host_or_usage_limits}
  */
...
export interface OrgTokenDpmLimits {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token#dpm_limit OrgToken#dpm_limit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token#dpm_notification_threshold OrgToken#dpm_notification_threshold}
  */
...
export interface OrgTokenHostOrUsageLimits {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token#container_limit OrgToken#container_limit}
  */
  readonly containerLimit?: number;
  /**
  * Notification threshold for containers
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token#container_notification_threshold OrgToken#container_notification_threshold}
  */
  readonly containerNotificationThreshold?: number;
  /**
  * Max number of custom metrics that can be sent with this token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token#custom_metrics_limit OrgToken#custom_metrics_limit}
  */
  readonly customMetricsLimit?: number;
  /**
  * Notification threshold for custom metrics
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token#custom_metrics_notification_threshold OrgToken#custom_metrics_notification_threshold}
  */
  readonly customMetricsNotificationThreshold?: number;
  /**
  * Max number of high-res metrics that can be sent with this token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token#high_res_metrics_limit OrgToken#high_res_metrics_limit}
  */
  readonly highResMetricsLimit?: number;
  /**
  * Notification threshold for high-res metrics
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token#high_res_metrics_notification_threshold OrgToken#high_res_metrics_notification_threshold}
  */
  readonly highResMetricsNotificationThreshold?: number;
  /**
  * Max number of hosts that can use this token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token#host_limit OrgToken#host_limit}
  */
  readonly hostLimit?: number;
  /**
  * Notification threshold for hosts
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token#host_notification_threshold OrgToken#host_notification_threshold}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token signalfx_org_token}
*/
export class OrgToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.2/docs/resources/org_token signalfx_org_token} Resource
  *
  * @param scope The scope in which to define this construct
