// https://registry.terraform.io/providers/portainer/portainer/1.14.1/docs/resources/user
...
export interface UserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.14.1/docs/resources/user#api_key_description User#api_key_description}
  */
  readonly apiKeyDescription?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.14.1/docs/resources/user#generate_api_key User#generate_api_key}
  */
  readonly generateApiKey?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.14.1/docs/resources/user#id User#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.14.1/docs/resources/user#ldap_user User#ldap_user}
  */
  readonly ldapUser?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.14.1/docs/resources/user#password User#password}
  */
  readonly password?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.14.1/docs/resources/user#role User#role}
  */
  readonly role?: number;
  /**
  * Optional Portainer team ID. Only applicable for standard users (role = 2).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.14.1/docs/resources/user#team_id User#team_id}
  */
  readonly teamId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.14.1/docs/resources/user#username User#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.14.1/docs/resources/user portainer_user}
*/
export class User extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing User that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.14.1/docs/resources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.14.1/docs/resources/user portainer_user} Resource
  *
  * @param scope The scope in which to define this construct
