// https://registry.terraform.io/providers/portainer/portainer/1.14.1/docs/resources/backup
...
export interface BackupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.14.1/docs/resources/backup#id Backup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.14.1/docs/resources/backup#output_path Backup#output_path}
  */
  readonly outputPath: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.14.1/docs/resources/backup#password Backup#password}
  */
  readonly password: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.14.1/docs/resources/backup portainer_backup}
*/
export class Backup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Backup that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.14.1/docs/resources/backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.14.1/docs/resources/backup portainer_backup} Resource
  *
  * @param scope The scope in which to define this construct
