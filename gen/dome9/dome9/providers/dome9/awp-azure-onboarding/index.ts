// https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/awp_azure_onboarding
...
export interface AwpAzureOnboardingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/awp_azure_onboarding#centralized_cloud_account_id AwpAzureOnboarding#centralized_cloud_account_id}
  */
  readonly centralizedCloudAccountId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/awp_azure_onboarding#cloudguard_account_id AwpAzureOnboarding#cloudguard_account_id}
  */
  readonly cloudguardAccountId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/awp_azure_onboarding#id AwpAzureOnboarding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/awp_azure_onboarding#management_group_id AwpAzureOnboarding#management_group_id}
  */
  readonly managementGroupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/awp_azure_onboarding#scan_mode AwpAzureOnboarding#scan_mode}
  */
  readonly scanMode: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/awp_azure_onboarding#should_create_policy AwpAzureOnboarding#should_create_policy}
  */
  readonly shouldCreatePolicy?: boolean | cdktf.IResolvable;
  /**
  * agentless_account_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/awp_azure_onboarding#agentless_account_settings AwpAzureOnboarding#agentless_account_settings}
  */
...
export interface AwpAzureOnboardingAgentlessAccountSettings {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/awp_azure_onboarding#custom_tags AwpAzureOnboarding#custom_tags}
  */
  readonly customTags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/awp_azure_onboarding#disabled_regions AwpAzureOnboarding#disabled_regions}
  */
  readonly disabledRegions?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/awp_azure_onboarding#in_account_scanner_vpc AwpAzureOnboarding#in_account_scanner_vpc}
  */
  readonly inAccountScannerVpc?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/awp_azure_onboarding#max_concurrent_scans_per_region AwpAzureOnboarding#max_concurrent_scans_per_region}
  */
  readonly maxConcurrentScansPerRegion?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/awp_azure_onboarding#scan_machine_interval_in_hours AwpAzureOnboarding#scan_machine_interval_in_hours}
  */
  readonly scanMachineIntervalInHours?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/awp_azure_onboarding#skip_function_apps_scan AwpAzureOnboarding#skip_function_apps_scan}
  */
  readonly skipFunctionAppsScan?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/awp_azure_onboarding#sse_cmk_encrypted_disks_scan AwpAzureOnboarding#sse_cmk_encrypted_disks_scan}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/awp_azure_onboarding dome9_awp_azure_onboarding}
*/
export class AwpAzureOnboarding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwpAzureOnboarding that should be imported. Refer to the {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/awp_azure_onboarding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/awp_azure_onboarding dome9_awp_azure_onboarding} Resource
  *
  * @param scope The scope in which to define this construct
