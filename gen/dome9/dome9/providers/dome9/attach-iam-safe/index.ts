// https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/attach_iam_safe
...
export interface AttachIamSafeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/attach_iam_safe#aws_cloud_account_id AttachIamSafe#aws_cloud_account_id}
  */
  readonly awsCloudAccountId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/attach_iam_safe#aws_group_arn AttachIamSafe#aws_group_arn}
  */
  readonly awsGroupArn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/attach_iam_safe#aws_policy_arn AttachIamSafe#aws_policy_arn}
  */
  readonly awsPolicyArn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/attach_iam_safe#id AttachIamSafe#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/attach_iam_safe dome9_attach_iam_safe}
*/
export class AttachIamSafe extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AttachIamSafe that should be imported. Refer to the {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/attach_iam_safe#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/attach_iam_safe dome9_attach_iam_safe} Resource
  *
  * @param scope The scope in which to define this construct
