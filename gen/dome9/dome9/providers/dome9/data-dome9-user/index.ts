// https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/user
...
export interface DataDome9UserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/user#id DataDome9User#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/user dome9_user}
*/
export class DataDome9User extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDome9User that should be imported. Refer to the {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/user dome9_user} Data Source
  *
  * @param scope The scope in which to define this construct
