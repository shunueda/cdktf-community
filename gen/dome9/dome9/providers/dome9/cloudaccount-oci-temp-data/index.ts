// https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/cloudaccount_oci_temp_data
...
export interface CloudaccountOciTempDataConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/cloudaccount_oci_temp_data#home_region CloudaccountOciTempData#home_region}
  */
  readonly homeRegion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/cloudaccount_oci_temp_data#id CloudaccountOciTempData#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/cloudaccount_oci_temp_data#name CloudaccountOciTempData#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/cloudaccount_oci_temp_data#tenancy_id CloudaccountOciTempData#tenancy_id}
  */
  readonly tenancyId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/cloudaccount_oci_temp_data#tenant_administrator_email_address CloudaccountOciTempData#tenant_administrator_email_address}
  */
  readonly tenantAdministratorEmailAddress: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/cloudaccount_oci_temp_data dome9_cloudaccount_oci_temp_data}
*/
export class CloudaccountOciTempData extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudaccountOciTempData that should be imported. Refer to the {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/cloudaccount_oci_temp_data#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/cloudaccount_oci_temp_data dome9_cloudaccount_oci_temp_data} Resource
  *
  * @param scope The scope in which to define this construct
