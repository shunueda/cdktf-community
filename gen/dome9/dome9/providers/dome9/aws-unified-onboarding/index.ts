// https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_unified_onboarding
...
export interface AwsUnifiedOnboardingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_unified_onboarding#cloud_vendor AwsUnifiedOnboarding#cloud_vendor}
  */
  readonly cloudVendor?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_unified_onboarding#enable_stack_modify AwsUnifiedOnboarding#enable_stack_modify}
  */
  readonly enableStackModify?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_unified_onboarding#full_protection AwsUnifiedOnboarding#full_protection}
  */
  readonly fullProtection?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_unified_onboarding#id AwsUnifiedOnboarding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_unified_onboarding#intelligence_configurations AwsUnifiedOnboarding#intelligence_configurations}
  */
  readonly intelligenceConfigurations?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_unified_onboarding#onboard_type AwsUnifiedOnboarding#onboard_type}
  */
  readonly onboardType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_unified_onboarding#posture_management_configuration AwsUnifiedOnboarding#posture_management_configuration}
  */
  readonly postureManagementConfiguration?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_unified_onboarding#serverless_configuration AwsUnifiedOnboarding#serverless_configuration}
  */
  readonly serverlessConfiguration?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_unified_onboarding dome9_aws_unified_onboarding}
*/
export class AwsUnifiedOnboarding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsUnifiedOnboarding that should be imported. Refer to the {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_unified_onboarding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_unified_onboarding dome9_aws_unified_onboarding} Resource
  *
  * @param scope The scope in which to define this construct
