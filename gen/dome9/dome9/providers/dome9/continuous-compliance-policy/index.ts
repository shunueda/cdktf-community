// https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/continuous_compliance_policy
...
export interface ContinuousCompliancePolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/continuous_compliance_policy#id ContinuousCompliancePolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/continuous_compliance_policy#notification_ids ContinuousCompliancePolicy#notification_ids}
  */
  readonly notificationIds: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/continuous_compliance_policy#ruleset_id ContinuousCompliancePolicy#ruleset_id}
  */
  readonly rulesetId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/continuous_compliance_policy#target_id ContinuousCompliancePolicy#target_id}
  */
  readonly targetId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/continuous_compliance_policy#target_type ContinuousCompliancePolicy#target_type}
  */
  readonly targetType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/continuous_compliance_policy dome9_continuous_compliance_policy}
*/
export class ContinuousCompliancePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContinuousCompliancePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/continuous_compliance_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/continuous_compliance_policy dome9_continuous_compliance_policy} Resource
  *
  * @param scope The scope in which to define this construct
