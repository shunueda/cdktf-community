// https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/admission_control_policy
...
export interface AdmissionControlPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/admission_control_policy#action AdmissionControlPolicy#action}
  */
  readonly action: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/admission_control_policy#id AdmissionControlPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/admission_control_policy#notification_ids AdmissionControlPolicy#notification_ids}
  */
  readonly notificationIds: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/admission_control_policy#ruleset_id AdmissionControlPolicy#ruleset_id}
  */
  readonly rulesetId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/admission_control_policy#target_id AdmissionControlPolicy#target_id}
  */
  readonly targetId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/admission_control_policy#target_type AdmissionControlPolicy#target_type}
  */
  readonly targetType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/admission_control_policy dome9_admission_control_policy}
*/
export class AdmissionControlPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AdmissionControlPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/admission_control_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/admission_control_policy dome9_admission_control_policy} Resource
  *
  * @param scope The scope in which to define this construct
