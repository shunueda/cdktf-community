// https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/image_assurance_policy
...
export interface ImageAssurancePolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/image_assurance_policy#admission_control_action ImageAssurancePolicy#admission_control_action}
  */
  readonly admissionControlAction?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/image_assurance_policy#admission_control_unscanned_action ImageAssurancePolicy#admission_control_unscanned_action}
  */
  readonly admissionControlUnscannedAction?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/image_assurance_policy#id ImageAssurancePolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/image_assurance_policy#notification_ids ImageAssurancePolicy#notification_ids}
  */
  readonly notificationIds: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/image_assurance_policy#ruleset_id ImageAssurancePolicy#ruleset_id}
  */
  readonly rulesetId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/image_assurance_policy#target_id ImageAssurancePolicy#target_id}
  */
  readonly targetId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/image_assurance_policy#target_type ImageAssurancePolicy#target_type}
  */
  readonly targetType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/image_assurance_policy dome9_image_assurance_policy}
*/
export class ImageAssurancePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ImageAssurancePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/image_assurance_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/image_assurance_policy dome9_image_assurance_policy} Resource
  *
  * @param scope The scope in which to define this construct
