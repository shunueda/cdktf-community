// https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/integration
...
export interface DataDome9IntegrationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/integration#id DataDome9Integration#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/integration dome9_integration}
*/
export class DataDome9Integration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDome9Integration that should be imported. Refer to the {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/integration dome9_integration} Data Source
  *
  * @param scope The scope in which to define this construct
