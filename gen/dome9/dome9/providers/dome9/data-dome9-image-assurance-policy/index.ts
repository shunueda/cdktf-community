// https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/image_assurance_policy
...
export interface DataDome9ImageAssurancePolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/image_assurance_policy#id DataDome9ImageAssurancePolicy#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/image_assurance_policy dome9_image_assurance_policy}
*/
export class DataDome9ImageAssurancePolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDome9ImageAssurancePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/image_assurance_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/image_assurance_policy dome9_image_assurance_policy} Data Source
  *
  * @param scope The scope in which to define this construct
