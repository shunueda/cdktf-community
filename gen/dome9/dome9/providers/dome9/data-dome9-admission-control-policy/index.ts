// https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/admission_control_policy
...
export interface DataDome9AdmissionControlPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/admission_control_policy#id DataDome9AdmissionControlPolicy#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/admission_control_policy dome9_admission_control_policy}
*/
export class DataDome9AdmissionControlPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDome9AdmissionControlPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/admission_control_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/data-sources/admission_control_policy dome9_admission_control_policy} Data Source
  *
  * @param scope The scope in which to define this construct
