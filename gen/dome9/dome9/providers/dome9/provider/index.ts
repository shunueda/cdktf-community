// https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs
...
export interface Dome9ProviderConfig {
  ...
  * dome9 base url
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs#base_url Dome9Provider#base_url}
  */
  readonly baseUrl?: string;
  /**
  * dome9 access id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs#dome9_access_id Dome9Provider#dome9_access_id}
  */
  readonly dome9AccessId: string;
  /**
  * dome9 api secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs#dome9_secret_key Dome9Provider#dome9_secret_key}
  */
  readonly dome9SecretKey: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs#alias Dome9Provider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs dome9}
*/
export class Dome9Provider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing Dome9Provider that should be imported. Refer to the {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs dome9} Resource
  *
  * @param scope The scope in which to define this construct
