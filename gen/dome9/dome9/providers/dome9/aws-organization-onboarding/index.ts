// https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_organization_onboarding
...
export interface AwsOrganizationOnboardingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_organization_onboarding#api_key AwsOrganizationOnboarding#api_key}
  */
  readonly apiKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_organization_onboarding#aws_organization_name AwsOrganizationOnboarding#aws_organization_name}
  */
  readonly awsOrganizationName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_organization_onboarding#enable_stack_modify AwsOrganizationOnboarding#enable_stack_modify}
  */
  readonly enableStackModify?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_organization_onboarding#id AwsOrganizationOnboarding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_organization_onboarding#role_arn AwsOrganizationOnboarding#role_arn}
  */
  readonly roleArn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_organization_onboarding#secret AwsOrganizationOnboarding#secret}
  */
  readonly secret: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_organization_onboarding#stack_set_arn AwsOrganizationOnboarding#stack_set_arn}
  */
  readonly stackSetArn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_organization_onboarding#type AwsOrganizationOnboarding#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_organization_onboarding dome9_aws_organization_onboarding}
*/
export class AwsOrganizationOnboarding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsOrganizationOnboarding that should be imported. Refer to the {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_organization_onboarding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dome9/dome9/1.40.3/docs/resources/aws_organization_onboarding dome9_aws_organization_onboarding} Resource
  *
  * @param scope The scope in which to define this construct
