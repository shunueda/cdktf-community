// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/osquery_enrollment
...
export interface OsqueryEnrollmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/osquery_enrollment#configuration_id OsqueryEnrollment#configuration_id}
  */
  readonly configurationId: number;
  /**
  * The `ID` of the meta business unit the machine will be assigned to at enrollment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/osquery_enrollment#meta_business_unit_id OsqueryEnrollment#meta_business_unit_id}
  */
  readonly metaBusinessUnitId: number;
  /**
  * Osquery release to include in the enrollment artifacts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/osquery_enrollment#osquery_release OsqueryEnrollment#osquery_release}
  */
  readonly osqueryRelease?: string;
  /**
  * The number of time the enrollment can be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/osquery_enrollment#quota OsqueryEnrollment#quota}
  */
  readonly quota?: number;
  /**
  * The serial numbers the enrollment is restricted to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/osquery_enrollment#serial_numbers OsqueryEnrollment#serial_numbers}
  */
  readonly serialNumbers?: string[];
  /**
  * The `ID`s of the tags that the machine will get at enrollment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/osquery_enrollment#tag_ids OsqueryEnrollment#tag_ids}
  */
  readonly tagIds?: number[];
  /**
  * The `UDID`s the enrollment is restricted to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/osquery_enrollment#udids OsqueryEnrollment#udids}
  */
  readonly udids?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/osquery_enrollment zentral_osquery_enrollment}
*/
export class OsqueryEnrollment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OsqueryEnrollment that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/osquery_enrollment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/osquery_enrollment zentral_osquery_enrollment} Resource
  *
  * @param scope The scope in which to define this construct
