// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/monolith_manifest
...
export interface MonolithManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/monolith_manifest#meta_business_unit_id MonolithManifest#meta_business_unit_id}
  */
  readonly metaBusinessUnitId: number;
  /**
  * Name of the manifest.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/monolith_manifest#name MonolithManifest#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/monolith_manifest zentral_monolith_manifest}
*/
export class MonolithManifest extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonolithManifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/monolith_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/monolith_manifest zentral_monolith_manifest} Resource
  *
  * @param scope The scope in which to define this construct
