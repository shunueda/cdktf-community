// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/munki_enrollment
...
export interface MunkiEnrollmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/munki_enrollment#configuration_id MunkiEnrollment#configuration_id}
  */
  readonly configurationId: number;
  /**
  * The `ID` of the meta business unit the machine will be assigned to at enrollment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/munki_enrollment#meta_business_unit_id MunkiEnrollment#meta_business_unit_id}
  */
  readonly metaBusinessUnitId: number;
  /**
  * The number of time the enrollment can be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/munki_enrollment#quota MunkiEnrollment#quota}
  */
  readonly quota?: number;
  /**
  * The serial numbers the enrollment is restricted to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/munki_enrollment#serial_numbers MunkiEnrollment#serial_numbers}
  */
  readonly serialNumbers?: string[];
  /**
  * The `ID`s of the tags that the machine will get at enrollment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/munki_enrollment#tag_ids MunkiEnrollment#tag_ids}
  */
  readonly tagIds?: number[];
  /**
  * The `UDID`s the enrollment is restricted to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/munki_enrollment#udids MunkiEnrollment#udids}
  */
  readonly udids?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/munki_enrollment zentral_munki_enrollment}
*/
export class MunkiEnrollment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MunkiEnrollment that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/munki_enrollment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/resources/munki_enrollment zentral_munki_enrollment} Resource
  *
  * @param scope The scope in which to define this construct
