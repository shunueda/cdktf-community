// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/data-sources/meta_business_unit
...
export interface DataZentralMetaBusinessUnitConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/data-sources/meta_business_unit#id DataZentralMetaBusinessUnit#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/data-sources/meta_business_unit#name DataZentralMetaBusinessUnit#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/data-sources/meta_business_unit zentral_meta_business_unit}
*/
export class DataZentralMetaBusinessUnit extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZentralMetaBusinessUnit that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/data-sources/meta_business_unit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/data-sources/meta_business_unit zentral_meta_business_unit} Data Source
  *
  * @param scope The scope in which to define this construct
