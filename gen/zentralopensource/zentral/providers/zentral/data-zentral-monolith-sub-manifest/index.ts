// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/data-sources/monolith_sub_manifest
...
export interface DataZentralMonolithSubManifestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/data-sources/monolith_sub_manifest#id DataZentralMonolithSubManifest#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/data-sources/monolith_sub_manifest#name DataZentralMonolithSubManifest#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/data-sources/monolith_sub_manifest zentral_monolith_sub_manifest}
*/
export class DataZentralMonolithSubManifest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZentralMonolithSubManifest that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/data-sources/monolith_sub_manifest#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/data-sources/monolith_sub_manifest zentral_monolith_sub_manifest} Data Source
  *
  * @param scope The scope in which to define this construct
