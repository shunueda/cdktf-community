// https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/data-sources/mdm_artifact
...
export interface DataZentralMdmArtifactConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/data-sources/mdm_artifact#id DataZentralMdmArtifact#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/data-sources/mdm_artifact#name DataZentralMdmArtifact#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/data-sources/mdm_artifact zentral_mdm_artifact}
*/
export class DataZentralMdmArtifact extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZentralMdmArtifact that should be imported. Refer to the {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/data-sources/mdm_artifact#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zentralopensource/zentral/0.1.63/docs/data-sources/mdm_artifact zentral_mdm_artifact} Data Source
  *
  * @param scope The scope in which to define this construct
