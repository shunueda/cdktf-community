// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_mgmt_update
...
export interface SystemHaMgmtUpdateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_mgmt_update#id SystemHaMgmtUpdate#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_mgmt_update#mgmt_interface SystemHaMgmtUpdate#mgmt_interface}
  */
  readonly mgmtInterface?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_mgmt_update#mgmt_ip SystemHaMgmtUpdate#mgmt_ip}
  */
  readonly mgmtIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_mgmt_update#mgmt_ip_allowaccess SystemHaMgmtUpdate#mgmt_ip_allowaccess}
  */
  readonly mgmtIpAllowaccess?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_mgmt_update#mgmt_status SystemHaMgmtUpdate#mgmt_status}
  */
  readonly mgmtStatus: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_mgmt_update fortiadc_system_ha_mgmt_update}
*/
export class SystemHaMgmtUpdate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemHaMgmtUpdate that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_mgmt_update#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_mgmt_update fortiadc_system_ha_mgmt_update} Resource
  *
  * @param scope The scope in which to define this construct
