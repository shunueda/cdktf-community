// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_child_remote_ip_monitor_list
...
export interface SystemHaChildRemoteIpMonitorListConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_child_remote_ip_monitor_list#health_check_interval SystemHaChildRemoteIpMonitorList#health_check_interval}
  */
  readonly healthCheckInterval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_child_remote_ip_monitor_list#health_check_retry SystemHaChildRemoteIpMonitorList#health_check_retry}
  */
  readonly healthCheckRetry?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_child_remote_ip_monitor_list#health_check_timeout SystemHaChildRemoteIpMonitorList#health_check_timeout}
  */
  readonly healthCheckTimeout?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_child_remote_ip_monitor_list#id SystemHaChildRemoteIpMonitorList#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_child_remote_ip_monitor_list#mkey SystemHaChildRemoteIpMonitorList#mkey}
  */
  readonly mkey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_child_remote_ip_monitor_list#remote_address SystemHaChildRemoteIpMonitorList#remote_address}
  */
  readonly remoteAddress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_child_remote_ip_monitor_list#source_port SystemHaChildRemoteIpMonitorList#source_port}
  */
  readonly sourcePort?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_child_remote_ip_monitor_list#vdom SystemHaChildRemoteIpMonitorList#vdom}
  */
  readonly vdom?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_child_remote_ip_monitor_list fortiadc_system_ha_child_remote_ip_monitor_list}
*/
export class SystemHaChildRemoteIpMonitorList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemHaChildRemoteIpMonitorList that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_child_remote_ip_monitor_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_ha_child_remote_ip_monitor_list fortiadc_system_ha_child_remote_ip_monitor_list} Resource
  *
  * @param scope The scope in which to define this construct
