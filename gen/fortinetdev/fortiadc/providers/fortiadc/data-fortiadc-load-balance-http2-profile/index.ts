// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_http2_profile
...
export interface DataFortiadcLoadBalanceHttp2ProfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_http2_profile#id DataFortiadcLoadBalanceHttp2Profile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_http2_profile#mkey DataFortiadcLoadBalanceHttp2Profile#mkey}
  */
  readonly mkey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_http2_profile#vdom DataFortiadcLoadBalanceHttp2Profile#vdom}
  */
  readonly vdom?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_http2_profile fortiadc_load_balance_http2_profile}
*/
export class DataFortiadcLoadBalanceHttp2Profile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFortiadcLoadBalanceHttp2Profile that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_http2_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_http2_profile fortiadc_load_balance_http2_profile} Data Source
  *
  * @param scope The scope in which to define this construct
