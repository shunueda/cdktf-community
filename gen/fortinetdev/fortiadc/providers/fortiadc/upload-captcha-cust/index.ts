// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/upload_captcha_cust
...
export interface UploadCaptchaCustConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/upload_captcha_cust#custom_page UploadCaptchaCust#custom_page}
  */
  readonly customPage?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/upload_captcha_cust#errorpagefile UploadCaptchaCust#errorpagefile}
  */
  readonly errorpagefile: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/upload_captcha_cust#id UploadCaptchaCust#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/upload_captcha_cust#max_block_period UploadCaptchaCust#max_block_period}
  */
  readonly maxBlockPeriod?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/upload_captcha_cust#max_picture_changes UploadCaptchaCust#max_picture_changes}
  */
  readonly maxPictureChanges?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/upload_captcha_cust#max_retry_times UploadCaptchaCust#max_retry_times}
  */
  readonly maxRetryTimes?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/upload_captcha_cust#max_valid_period UploadCaptchaCust#max_valid_period}
  */
  readonly maxValidPeriod?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/upload_captcha_cust#max_verify_period UploadCaptchaCust#max_verify_period}
  */
  readonly maxVerifyPeriod?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/upload_captcha_cust#mkey UploadCaptchaCust#mkey}
  */
  readonly mkey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/upload_captcha_cust#pic_difficulty UploadCaptchaCust#pic_difficulty}
  */
  readonly picDifficulty?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/upload_captcha_cust#update UploadCaptchaCust#update}
  */
  readonly update?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/upload_captcha_cust#vdom UploadCaptchaCust#vdom}
  */
  readonly vdom?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/upload_captcha_cust#vpath UploadCaptchaCust#vpath}
  */
  readonly vpath?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/upload_captcha_cust fortiadc_upload_captcha_cust}
*/
export class UploadCaptchaCust extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UploadCaptchaCust that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/upload_captcha_cust#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/upload_captcha_cust fortiadc_upload_captcha_cust} Resource
  *
  * @param scope The scope in which to define this construct
