// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/security_ips_profile
...
export interface DataFortiadcSecurityIpsProfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/security_ips_profile#id DataFortiadcSecurityIpsProfile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/security_ips_profile#ips_profile_name DataFortiadcSecurityIpsProfile#ips_profile_name}
  */
  readonly ipsProfileName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/security_ips_profile#vdom DataFortiadcSecurityIpsProfile#vdom}
  */
  readonly vdom?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/security_ips_profile fortiadc_security_ips_profile}
*/
export class DataFortiadcSecurityIpsProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFortiadcSecurityIpsProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/security_ips_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/security_ips_profile fortiadc_security_ips_profile} Data Source
  *
  * @param scope The scope in which to define this construct
