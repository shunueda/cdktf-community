// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_dns_vdom
...
export interface SystemDnsVdomConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_dns_vdom#dns_overide SystemDnsVdom#dns_overide}
  */
  readonly dnsOveride?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_dns_vdom#id SystemDnsVdom#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_dns_vdom#ip_primary SystemDnsVdom#ip_primary}
  */
  readonly ipPrimary?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_dns_vdom#ip_second SystemDnsVdom#ip_second}
  */
  readonly ipSecond?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_dns_vdom#vdom SystemDnsVdom#vdom}
  */
  readonly vdom: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_dns_vdom fortiadc_system_dns_vdom}
*/
export class SystemDnsVdom extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemDnsVdom that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_dns_vdom#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_dns_vdom fortiadc_system_dns_vdom} Resource
  *
  * @param scope The scope in which to define this construct
