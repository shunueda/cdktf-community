// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/user_adfs_publish
...
export interface UserAdfsPublishConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/user_adfs_publish#backend_server_url UserAdfsPublish#backend_server_url}
  */
  readonly backendServerUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/user_adfs_publish#external_url UserAdfsPublish#external_url}
  */
  readonly externalUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/user_adfs_publish#id UserAdfsPublish#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/user_adfs_publish#mkey UserAdfsPublish#mkey}
  */
  readonly mkey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/user_adfs_publish#preauth UserAdfsPublish#preauth}
  */
  readonly preauth?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/user_adfs_publish#proxy UserAdfsPublish#proxy}
  */
  readonly proxy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/user_adfs_publish#relying_party UserAdfsPublish#relying_party}
  */
  readonly relyingParty?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/user_adfs_publish#status UserAdfsPublish#status}
  */
  readonly status?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/user_adfs_publish#vdom UserAdfsPublish#vdom}
  */
  readonly vdom?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/user_adfs_publish fortiadc_user_adfs_publish}
*/
export class UserAdfsPublish extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserAdfsPublish that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/user_adfs_publish#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/user_adfs_publish fortiadc_user_adfs_publish} Resource
  *
  * @param scope The scope in which to define this construct
