// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_traffic_group
...
export interface SystemTrafficGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_traffic_group#failover_order SystemTrafficGroup#failover_order}
  */
  readonly failoverOrder?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_traffic_group#id SystemTrafficGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_traffic_group#mkey SystemTrafficGroup#mkey}
  */
  readonly mkey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_traffic_group#network_failover SystemTrafficGroup#network_failover}
  */
  readonly networkFailover?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_traffic_group#preempt SystemTrafficGroup#preempt}
  */
  readonly preempt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_traffic_group#vdom SystemTrafficGroup#vdom}
  */
  readonly vdom?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_traffic_group fortiadc_system_traffic_group}
*/
export class SystemTrafficGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemTrafficGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_traffic_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_traffic_group fortiadc_system_traffic_group} Resource
  *
  * @param scope The scope in which to define this construct
