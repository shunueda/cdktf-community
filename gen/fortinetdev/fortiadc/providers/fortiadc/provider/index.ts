// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs
...
export interface FortiadcProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#cabundlecontent FortiadcProvider#cabundlecontent}
  */
  readonly cabundlecontent?: string;
  /**
  * CA Bundle file
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#cabundlefile FortiadcProvider#cabundlefile}
  */
  readonly cabundlefile?: string;
  /**
  * CA certtificate(Optional)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#cacert FortiadcProvider#cacert}
  */
  readonly cacert?: string;
  /**
  * User certificate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#clientcert FortiadcProvider#clientcert}
  */
  readonly clientcert?: string;
  /**
  * User private key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#clientkey FortiadcProvider#clientkey}
  */
  readonly clientkey?: string;
  /**
  * CA Bundle file
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#fmg_cabundlefile FortiadcProvider#fmg_cabundlefile}
  */
  readonly fmgCabundlefile?: string;
  /**
  * Hostname/IP address of the FortiManager to connect to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#fmg_hostname FortiadcProvider#fmg_hostname}
  */
  readonly fmgHostname?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#fmg_insecure FortiadcProvider#fmg_insecure}
  */
  readonly fmgInsecure?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#fmg_passwd FortiadcProvider#fmg_passwd}
  */
  readonly fmgPasswd?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#fmg_username FortiadcProvider#fmg_username}
  */
  readonly fmgUsername?: string;
  /**
  * The hostname/IP address of the FortiOS to be connected
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#hostname FortiadcProvider#hostname}
  */
  readonly hostname?: string;
  /**
  * HTTP proxy address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#http_proxy FortiadcProvider#http_proxy}
  */
  readonly httpProxy?: string;
  /**
  * HTTPS proxy address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#https_proxy FortiadcProvider#https_proxy}
  */
  readonly httpsProxy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#insecure FortiadcProvider#insecure}
  */
  readonly insecure?: boolean | cdktf.IResolvable;
  /**
  * NO proxy address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#no_proxy FortiadcProvider#no_proxy}
  */
  readonly noProxy?: string;
  /**
  * Enable/disable peer authentication, can be 'enable' or 'disable'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#peerauth FortiadcProvider#peerauth}
  */
  readonly peerauth?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#token FortiadcProvider#token}
  */
  readonly token?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#vdom FortiadcProvider#vdom}
  */
  readonly vdom?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#alias FortiadcProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs fortiadc}
*/
export class FortiadcProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing FortiadcProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs fortiadc} Resource
  *
  * @param scope The scope in which to define this construct
