// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/firewall_nat_snat
...
export interface FirewallNatSnatConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/firewall_nat_snat#from FirewallNatSnat#from}
  */
  readonly from?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/firewall_nat_snat#id FirewallNatSnat#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/firewall_nat_snat#mkey FirewallNatSnat#mkey}
  */
  readonly mkey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/firewall_nat_snat#out_interface FirewallNatSnat#out_interface}
  */
  readonly outInterface?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/firewall_nat_snat#status FirewallNatSnat#status}
  */
  readonly status?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/firewall_nat_snat#to FirewallNatSnat#to}
  */
  readonly to?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/firewall_nat_snat#traffic_group FirewallNatSnat#traffic_group}
  */
  readonly trafficGroup?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/firewall_nat_snat#trans_to_ip FirewallNatSnat#trans_to_ip}
  */
  readonly transToIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/firewall_nat_snat#trans_to_ip_end FirewallNatSnat#trans_to_ip_end}
  */
  readonly transToIpEnd?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/firewall_nat_snat#trans_to_ip_start FirewallNatSnat#trans_to_ip_start}
  */
  readonly transToIpStart?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/firewall_nat_snat#trans_to_type FirewallNatSnat#trans_to_type}
  */
  readonly transToType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/firewall_nat_snat#vdom FirewallNatSnat#vdom}
  */
  readonly vdom?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/firewall_nat_snat fortiadc_firewall_nat_snat}
*/
export class FirewallNatSnat extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FirewallNatSnat that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/firewall_nat_snat#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/firewall_nat_snat fortiadc_firewall_nat_snat} Resource
  *
  * @param scope The scope in which to define this construct
