// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_time_manual
...
export interface DataFortiadcSystemTimeManualConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_time_manual#id DataFortiadcSystemTimeManual#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_time_manual fortiadc_system_time_manual}
*/
export class DataFortiadcSystemTimeManual extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFortiadcSystemTimeManual that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_time_manual#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_time_manual fortiadc_system_time_manual} Data Source
  *
  * @param scope The scope in which to define this construct
