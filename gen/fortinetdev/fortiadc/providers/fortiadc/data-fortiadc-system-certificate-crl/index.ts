// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_certificate_crl
...
export interface DataFortiadcSystemCertificateCrlConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_certificate_crl#id DataFortiadcSystemCertificateCrl#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_certificate_crl#mkey DataFortiadcSystemCertificateCrl#mkey}
  */
  readonly mkey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_certificate_crl#vdom DataFortiadcSystemCertificateCrl#vdom}
  */
  readonly vdom?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_certificate_crl fortiadc_system_certificate_crl}
*/
export class DataFortiadcSystemCertificateCrl extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFortiadcSystemCertificateCrl that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_certificate_crl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_certificate_crl fortiadc_system_certificate_crl} Data Source
  *
  * @param scope The scope in which to define this construct
