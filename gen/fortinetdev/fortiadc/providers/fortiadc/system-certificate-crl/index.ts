// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_certificate_crl
...
export interface SystemCertificateCrlConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_certificate_crl#ca_id SystemCertificateCrl#ca_id}
  */
  readonly caId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_certificate_crl#crldp_status SystemCertificateCrl#crldp_status}
  */
  readonly crldpStatus?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_certificate_crl#id SystemCertificateCrl#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_certificate_crl#ldap_server SystemCertificateCrl#ldap_server}
  */
  readonly ldapServer?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_certificate_crl#mkey SystemCertificateCrl#mkey}
  */
  readonly mkey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_certificate_crl#update_ahead_time SystemCertificateCrl#update_ahead_time}
  */
  readonly updateAheadTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_certificate_crl#update_interval SystemCertificateCrl#update_interval}
  */
  readonly updateInterval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_certificate_crl#use_ca_id SystemCertificateCrl#use_ca_id}
  */
  readonly useCaId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_certificate_crl#vdom SystemCertificateCrl#vdom}
  */
  readonly vdom?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_certificate_crl fortiadc_system_certificate_crl}
*/
export class SystemCertificateCrl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemCertificateCrl that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_certificate_crl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_certificate_crl fortiadc_system_certificate_crl} Resource
  *
  * @param scope The scope in which to define this construct
