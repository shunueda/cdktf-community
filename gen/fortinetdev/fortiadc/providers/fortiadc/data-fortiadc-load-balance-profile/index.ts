// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_profile
...
export interface DataFortiadcLoadBalanceProfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_profile#id DataFortiadcLoadBalanceProfile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_profile#mkey DataFortiadcLoadBalanceProfile#mkey}
  */
  readonly mkey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_profile#vdom DataFortiadcLoadBalanceProfile#vdom}
  */
  readonly vdom?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_profile fortiadc_load_balance_profile}
*/
export class DataFortiadcLoadBalanceProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFortiadcLoadBalanceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_profile fortiadc_load_balance_profile} Data Source
  *
  * @param scope The scope in which to define this construct
