// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/router_bgp
...
export interface RouterBgpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/router_bgp#always_compare_med RouterBgp#always_compare_med}
  */
  readonly alwaysCompareMed?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/router_bgp#as RouterBgp#as}
  */
  readonly as?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/router_bgp#bestpath_cmp_routerid RouterBgp#bestpath_cmp_routerid}
  */
  readonly bestpathCmpRouterid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/router_bgp#deterministic_med RouterBgp#deterministic_med}
  */
  readonly deterministicMed?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/router_bgp#id RouterBgp#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/router_bgp#redistribute_connected RouterBgp#redistribute_connected}
  */
  readonly redistributeConnected?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/router_bgp#redistribute_connected6 RouterBgp#redistribute_connected6}
  */
  readonly redistributeConnected6?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/router_bgp#redistribute_ospf RouterBgp#redistribute_ospf}
  */
  readonly redistributeOspf?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/router_bgp#redistribute_static RouterBgp#redistribute_static}
  */
  readonly redistributeStatic?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/router_bgp#redistribute_static6 RouterBgp#redistribute_static6}
  */
  readonly redistributeStatic6?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/router_bgp#router_id RouterBgp#router_id}
  */
  readonly routerId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/router_bgp fortiadc_router_bgp}
*/
export class RouterBgp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RouterBgp that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/router_bgp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/router_bgp fortiadc_router_bgp} Resource
  *
  * @param scope The scope in which to define this construct
