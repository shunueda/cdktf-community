// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_persistence
...
export interface DataFortiadcLoadBalancePersistenceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_persistence#id DataFortiadcLoadBalancePersistence#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_persistence#mkey DataFortiadcLoadBalancePersistence#mkey}
  */
  readonly mkey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_persistence#vdom DataFortiadcLoadBalancePersistence#vdom}
  */
  readonly vdom?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_persistence fortiadc_load_balance_persistence}
*/
export class DataFortiadcLoadBalancePersistence extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFortiadcLoadBalancePersistence that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_persistence#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_persistence fortiadc_load_balance_persistence} Data Source
  *
  * @param scope The scope in which to define this construct
