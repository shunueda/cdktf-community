// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/security_waf_profile
...
export interface DataFortiadcSecurityWafProfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/security_waf_profile#id DataFortiadcSecurityWafProfile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/security_waf_profile#mkey DataFortiadcSecurityWafProfile#mkey}
  */
  readonly mkey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/security_waf_profile#vdom DataFortiadcSecurityWafProfile#vdom}
  */
  readonly vdom?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/security_waf_profile fortiadc_security_waf_profile}
*/
export class DataFortiadcSecurityWafProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFortiadcSecurityWafProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/security_waf_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/security_waf_profile fortiadc_security_waf_profile} Data Source
  *
  * @param scope The scope in which to define this construct
