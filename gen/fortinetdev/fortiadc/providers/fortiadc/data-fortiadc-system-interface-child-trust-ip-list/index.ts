// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_interface_child_trust_ip_list
...
export interface DataFortiadcSystemInterfaceChildTrustIpListConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_interface_child_trust_ip_list#id DataFortiadcSystemInterfaceChildTrustIpList#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_interface_child_trust_ip_list#name DataFortiadcSystemInterfaceChildTrustIpList#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_interface_child_trust_ip_list#pkey DataFortiadcSystemInterfaceChildTrustIpList#pkey}
  */
  readonly pkey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_interface_child_trust_ip_list#vdom DataFortiadcSystemInterfaceChildTrustIpList#vdom}
  */
  readonly vdom?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_interface_child_trust_ip_list fortiadc_system_interface_child_trust_ip_list}
*/
export class DataFortiadcSystemInterfaceChildTrustIpList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFortiadcSystemInterfaceChildTrustIpList that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_interface_child_trust_ip_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/system_interface_child_trust_ip_list fortiadc_system_interface_child_trust_ip_list} Data Source
  *
  * @param scope The scope in which to define this construct
