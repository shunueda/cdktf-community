// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_pagespeed
...
export interface LoadBalancePagespeedConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_pagespeed#file_cache_max_inode LoadBalancePagespeed#file_cache_max_inode}
  */
  readonly fileCacheMaxInode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_pagespeed#file_cache_max_size LoadBalancePagespeed#file_cache_max_size}
  */
  readonly fileCacheMaxSize?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_pagespeed#id LoadBalancePagespeed#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_pagespeed#mkey LoadBalancePagespeed#mkey}
  */
  readonly mkey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_pagespeed#pagespeed_profile_id LoadBalancePagespeed#pagespeed_profile_id}
  */
  readonly pagespeedProfileId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_pagespeed#vdom LoadBalancePagespeed#vdom}
  */
  readonly vdom?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_pagespeed fortiadc_load_balance_pagespeed}
*/
export class LoadBalancePagespeed extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoadBalancePagespeed that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_pagespeed#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_pagespeed fortiadc_load_balance_pagespeed} Resource
  *
  * @param scope The scope in which to define this construct
