// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_time_manual
...
export interface SystemTimeManualConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_time_manual#dst SystemTimeManual#dst}
  */
  readonly dst: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_time_manual#hour SystemTimeManual#hour}
  */
  readonly hour?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_time_manual#id SystemTimeManual#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_time_manual#mday SystemTimeManual#mday}
  */
  readonly mday?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_time_manual#minute SystemTimeManual#minute}
  */
  readonly minute?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_time_manual#month SystemTimeManual#month}
  */
  readonly month?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_time_manual#ntpserver SystemTimeManual#ntpserver}
  */
  readonly ntpserver?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_time_manual#ntpsync SystemTimeManual#ntpsync}
  */
  readonly ntpsync: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_time_manual#second SystemTimeManual#second}
  */
  readonly second?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_time_manual#syncinterval SystemTimeManual#syncinterval}
  */
  readonly syncinterval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_time_manual#tz SystemTimeManual#tz}
  */
  readonly tz: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_time_manual#year SystemTimeManual#year}
  */
  readonly year?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_time_manual fortiadc_system_time_manual}
*/
export class SystemTimeManual extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemTimeManual that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_time_manual#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/system_time_manual fortiadc_system_time_manual} Resource
  *
  * @param scope The scope in which to define this construct
