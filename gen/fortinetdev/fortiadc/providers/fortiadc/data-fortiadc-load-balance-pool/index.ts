// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_pool
...
export interface DataFortiadcLoadBalancePoolConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_pool#id DataFortiadcLoadBalancePool#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_pool#mkey DataFortiadcLoadBalancePool#mkey}
  */
  readonly mkey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_pool#vdom DataFortiadcLoadBalancePool#vdom}
  */
  readonly vdom?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_pool fortiadc_load_balance_pool}
*/
export class DataFortiadcLoadBalancePool extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFortiadcLoadBalancePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/data-sources/load_balance_pool fortiadc_load_balance_pool} Data Source
  *
  * @param scope The scope in which to define this construct
