// https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_caching
...
export interface LoadBalanceCachingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_caching#id LoadBalanceCaching#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_caching#max_age LoadBalanceCaching#max_age}
  */
  readonly maxAge?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_caching#max_cache_size LoadBalanceCaching#max_cache_size}
  */
  readonly maxCacheSize?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_caching#max_entries LoadBalanceCaching#max_entries}
  */
  readonly maxEntries?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_caching#max_object_size LoadBalanceCaching#max_object_size}
  */
  readonly maxObjectSize?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_caching#mkey LoadBalanceCaching#mkey}
  */
  readonly mkey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_caching#vdom LoadBalanceCaching#vdom}
  */
  readonly vdom?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_caching fortiadc_load_balance_caching}
*/
export class LoadBalanceCaching extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoadBalanceCaching that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_caching#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiadc/1.3.0/docs/resources/load_balance_caching fortiadc_load_balance_caching} Resource
  *
  * @param scope The scope in which to define this construct
