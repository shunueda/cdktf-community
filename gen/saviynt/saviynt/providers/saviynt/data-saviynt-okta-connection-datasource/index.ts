// https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/okta_connection_datasource
...
export interface DataSaviyntOktaConnectionDatasourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/okta_connection_datasource#authenticate DataSaviyntOktaConnectionDatasource#authenticate}
  */
  readonly authenticate: boolean | cdktf.IResolvable;
  /**
  * The key of the connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/okta_connection_datasource#connection_key DataSaviyntOktaConnectionDatasource#connection_key}
  */
  readonly connectionKey?: number;
  /**
  * The name of the connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/okta_connection_datasource#connection_name DataSaviyntOktaConnectionDatasource#connection_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/okta_connection_datasource saviynt_okta_connection_datasource}
*/
export class DataSaviyntOktaConnectionDatasource extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSaviyntOktaConnectionDatasource that should be imported. Refer to the {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/okta_connection_datasource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/okta_connection_datasource saviynt_okta_connection_datasource} Data Source
  *
  * @param scope The scope in which to define this construct
