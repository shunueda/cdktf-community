// https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource
...
export interface AdsiConnectionResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#account_attribute AdsiConnectionResource#account_attribute}
  */
  readonly accountAttribute?: string;
  /**
  * Rule to generate account name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#accountnamerule AdsiConnectionResource#accountnamerule}
  */
  readonly accountnamerule?: string;
  /**
  * Configuration to Add nested group hierarchy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#addaccessentitlementjson AdsiConnectionResource#addaccessentitlementjson}
  */
  readonly addaccessentitlementjson?: string;
  /**
  * Configuration to ADD Access (cross domain/forest group membership) to an account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#addaccessjson AdsiConnectionResource#addaccessjson}
  */
  readonly addaccessjson?: string;
  /**
  * Evaluate the uniqueness of an attribute
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#checkforunique AdsiConnectionResource#checkforunique}
  */
  readonly checkforunique?: string;
  /**
  * Name of the connection. Example: "Active Directory_Doc"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#connection_name AdsiConnectionResource#connection_name}
  */
  readonly connectionName: string;
  /**
  * ADSI remote agent Connection URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#connection_url AdsiConnectionResource#connection_url}
  */
  readonly connectionUrl: string;
  /**
  * Specify the attributes values which will be used to Create the New Account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#createaccountjson AdsiConnectionResource#createaccountjson}
  */
  readonly createaccountjson?: string;
  /**
  * Configuration to Create a Group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#creategroupjson AdsiConnectionResource#creategroupjson}
  */
  readonly creategroupjson?: string;
  /**
  * Specify the Field Value which will be used to Create the New Service Account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#createserviceaccountjson AdsiConnectionResource#createserviceaccountjson}
  */
  readonly createserviceaccountjson?: string;
  /**
  * Custom configuration JSON
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#customconfigjson AdsiConnectionResource#customconfigjson}
  */
  readonly customconfigjson?: string;
  /**
  * Default SAV Role to be assigned to all the new users that gets imported via User Import
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#default_user_role AdsiConnectionResource#default_user_role}
  */
  readonly defaultUserRole?: string;
  /**
  * Default SAV roles for managing the connection. Example: "ROLE_ORG"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#defaultsavroles AdsiConnectionResource#defaultsavroles}
  */
  readonly defaultsavroles?: string;
  /**
  * Description for the connection. Example: "ORG_AD"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#description AdsiConnectionResource#description}
  */
  readonly description?: string;
  /**
  * Specify the actions and attributes updates to be performed for disabling an account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#disableaccountjson AdsiConnectionResource#disableaccountjson}
  */
  readonly disableaccountjson?: string;
  /**
  * Email template for notifications. Example: "New Account Task Creation"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#email_template AdsiConnectionResource#email_template}
  */
  readonly emailTemplate?: string;
  /**
  * Specify the actions and attribute updates to be performed for enabling an account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#enableaccountjson AdsiConnectionResource#enableaccountjson}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#endpoints_filter AdsiConnectionResource#endpoints_filter}
  */
  readonly endpointsFilter?: string;
  /**
  * Account attribute that contains group membership
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#entitlement_attribute AdsiConnectionResource#entitlement_attribute}
  */
  readonly entitlementAttribute?: string;
  /**
  * Forest List (Comma Separated) which we need to manage
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#forestlist AdsiConnectionResource#forestlist}
  */
  readonly forestlist: string;
  /**
  * Map AD group attribute to EIC entitlement attribute for import
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#group_import_mapping AdsiConnectionResource#group_import_mapping}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#group_search_base_dn AdsiConnectionResource#group_search_base_dn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#import_nested_membership AdsiConnectionResource#import_nested_membership}
  */
  readonly importNestedMembership?: string;
  /**
  * Specify this parameter to transform the data during user import.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#modifyuserdatajson AdsiConnectionResource#modifyuserdatajson}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#objectfilter AdsiConnectionResource#objectfilter}
  */
  readonly objectfilter?: string;
  /**
  * Page size defines the number of objects to be returned from each AD operation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#page_size AdsiConnectionResource#page_size}
  */
  readonly pageSize?: string;
  /**
  * JSON to specify Bootstrap Config.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#pam_config AdsiConnectionResource#pam_config}
  */
  readonly pamConfig?: string;
  /**
  * Service account password. Set the password. It is a compulsory field. Either this or password_wo need to be set
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#password AdsiConnectionResource#password}
  */
  readonly password?: string;
  /**
  * Service account password. Set the password_wo. It is a compulsory field. Either this or password need to be set
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#password_wo AdsiConnectionResource#password_wo}
  */
  readonly passwordWo?: string;
  /**
  * ADSI remote agent Provisioning URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#provisioning_url AdsiConnectionResource#provisioning_url}
  */
  readonly provisioningUrl?: string;
  /**
  * Configuration to Remove nested group hierarchy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#removeaccessentitlementjson AdsiConnectionResource#removeaccessentitlementjson}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#removeaccessjson AdsiConnectionResource#removeaccessjson}
  */
  readonly removeaccessjson?: string;
  /**
  * Specify the actions to be performed for deleting an account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#removeaccountjson AdsiConnectionResource#removeaccountjson}
  */
  readonly removeaccountjson?: string;
  /**
  * Configuration to Delete a Group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#removegroupjson AdsiConnectionResource#removegroupjson}
  */
  readonly removegroupjson?: string;
  /**
  * Specify the actions to be performed while deleting a service account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#removeserviceaccountjson AdsiConnectionResource#removeserviceaccountjson}
  */
  readonly removeserviceaccountjson?: string;
  /**
  * Configuration to Reset and Change Password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#resetandchangepasswrdjson AdsiConnectionResource#resetandchangepasswrdjson}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#save_in_vault AdsiConnectionResource#save_in_vault}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#searchfilter AdsiConnectionResource#searchfilter}
  */
  readonly searchfilter?: string;
  /**
  * Account status and threshold related config
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#status_threshold_config AdsiConnectionResource#status_threshold_config}
  */
  readonly statusThresholdConfig?: string;
  /**
  * JSON configuration to specify Users status
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#statuskeyjson AdsiConnectionResource#statuskeyjson}
  */
  readonly statuskeyjson?: string;
  /**
  * Specify the attributes values which will be used to Update existing Account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#updateaccountjson AdsiConnectionResource#updateaccountjson}
  */
  readonly updateaccountjson?: string;
  /**
  * Configuration to Update a Group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#updategroupjson AdsiConnectionResource#updategroupjson}
  */
  readonly updategroupjson?: string;
  /**
  * Specify the Field Value which will be used to update the existing Service Account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#updateserviceaccountjson AdsiConnectionResource#updateserviceaccountjson}
  */
  readonly updateserviceaccountjson?: string;
  /**
  * Specify the attribute Value which will be used to Update existing User
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#updateuserjson AdsiConnectionResource#updateuserjson}
  */
  readonly updateuserjson?: string;
  /**
  * Primary/root domain URL list (comma Separated)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#url AdsiConnectionResource#url}
  */
  readonly url: string;
  /**
  * Map EIC and AD attributes for user import (AD attributes must be in lower case)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#user_attribute AdsiConnectionResource#user_attribute}
  */
  readonly userAttribute?: string;
  /**
  * Service account username
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#username AdsiConnectionResource#username}
  */
  readonly username: string;
  /**
  * JSON string specifying vault configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#vault_configuration AdsiConnectionResource#vault_configuration}
  */
  readonly vaultConfiguration?: string;
  /**
  * Specifies the type of vault connection being used (e.g., 'Hashicorp'). Example: "Hashicorp"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#vault_connection AdsiConnectionResource#vault_connection}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#wo_version AdsiConnectionResource#wo_version}
  */
  readonly woVersion?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource saviynt_adsi_connection_resource}
*/
export class AdsiConnectionResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AdsiConnectionResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/resources/adsi_connection_resource saviynt_adsi_connection_resource} Resource
  *
  * @param scope The scope in which to define this construct
