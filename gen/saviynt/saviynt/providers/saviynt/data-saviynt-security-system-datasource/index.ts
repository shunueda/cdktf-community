// https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/security_system_datasource
...
export interface DataSaviyntSecuritySystemDatasourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/security_system_datasource#authenticate DataSaviyntSecuritySystemDatasource#authenticate}
  */
  readonly authenticate: boolean | cdktf.IResolvable;
  /**
  * Filter security systems by connection type (e.g., AD, REST, DB).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/security_system_datasource#connection_type DataSaviyntSecuritySystemDatasource#connection_type}
  */
  readonly connectionType?: string;
  /**
  * Filter security systems by connection name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/security_system_datasource#connectionname DataSaviyntSecuritySystemDatasource#connectionname}
  */
  readonly connectionname?: string;
  /**
  * Maximum number of security systems to return in the response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/security_system_datasource#max DataSaviyntSecuritySystemDatasource#max}
  */
  readonly max?: number;
  /**
  * Number of security systems to skip before returning results (for pagination).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/security_system_datasource#offset DataSaviyntSecuritySystemDatasource#offset}
  */
  readonly offset?: number;
  /**
  * Name of the security systeme.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/security_system_datasource#systemname DataSaviyntSecuritySystemDatasource#systemname}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/security_system_datasource saviynt_security_system_datasource}
*/
export class DataSaviyntSecuritySystemDatasource extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSaviyntSecuritySystemDatasource that should be imported. Refer to the {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/security_system_datasource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/security_system_datasource saviynt_security_system_datasource} Data Source
  *
  * @param scope The scope in which to define this construct
