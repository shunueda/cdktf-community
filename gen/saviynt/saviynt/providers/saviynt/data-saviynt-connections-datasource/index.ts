// https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/connections_datasource
...
export interface DataSaviyntConnectionsDatasourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/connections_datasource#authenticate DataSaviyntConnectionsDatasource#authenticate}
  */
  readonly authenticate: boolean | cdktf.IResolvable;
  /**
  * Filter by connection name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/connections_datasource#connection_name DataSaviyntConnectionsDatasource#connection_name}
  */
  readonly connectionName?: string;
  /**
  * Filter by connection type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/connections_datasource#connection_type DataSaviyntConnectionsDatasource#connection_type}
  */
  readonly connectionType?: string;
  /**
  * Maximum number of connections to retrieve
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/connections_datasource#max DataSaviyntConnectionsDatasource#max}
  */
  readonly max?: string;
  /**
  * Offset for pagination
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/connections_datasource#offset DataSaviyntConnectionsDatasource#offset}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/connections_datasource saviynt_connections_datasource}
*/
export class DataSaviyntConnectionsDatasource extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSaviyntConnectionsDatasource that should be imported. Refer to the {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/connections_datasource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.12/docs/data-sources/connections_datasource saviynt_connections_datasource} Data Source
  *
  * @param scope The scope in which to define this construct
