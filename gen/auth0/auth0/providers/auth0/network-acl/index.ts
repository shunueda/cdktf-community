// https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl
...
export interface NetworkAclConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#active NetworkAcl#active}
  */
  readonly active: boolean | cdktf.IResolvable;
  /**
  * The description of the Network ACL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#description NetworkAcl#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#id NetworkAcl#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#priority NetworkAcl#priority}
  */
  readonly priority: number;
  /**
  * rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#rule NetworkAcl#rule}
  */
...
export interface NetworkAclRuleAction {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#allow NetworkAcl#allow}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#block NetworkAcl#block}
  */
  readonly block?: boolean | cdktf.IResolvable;
  /**
  * If true, logs the request. When using log action, no other properties should be set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#log NetworkAcl#log}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#redirect NetworkAcl#redirect}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#redirect_uri NetworkAcl#redirect_uri}
  */
...
export interface NetworkAclRuleMatch {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#asns NetworkAcl#asns}
  */
  readonly asns?: number[];
  /**
  * Geo Country Codes. Must contain between 1 and 10 unique items.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#geo_country_codes NetworkAcl#geo_country_codes}
  */
  readonly geoCountryCodes?: string[];
  /**
  * Geo Subdivision Codes. Must contain between 1 and 10 unique items.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#geo_subdivision_codes NetworkAcl#geo_subdivision_codes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#ipv4_cidrs NetworkAcl#ipv4_cidrs}
  */
  readonly ipv4Cidrs?: string[];
  /**
  * IPv6 CIDRs. Must contain between 1 and 10 unique items. Can be IPv6 addresses or CIDR blocks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#ipv6_cidrs NetworkAcl#ipv6_cidrs}
  */
  readonly ipv6Cidrs?: string[];
  /**
  * JA3 Fingerprints. Must contain between 1 and 10 unique items.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#ja3_fingerprints NetworkAcl#ja3_fingerprints}
  */
  readonly ja3Fingerprints?: string[];
  /**
  * JA4 Fingerprints. Must contain between 1 and 10 unique items.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#ja4_fingerprints NetworkAcl#ja4_fingerprints}
  */
  readonly ja4Fingerprints?: string[];
  /**
  * User Agents. Must contain between 1 and 10 unique items.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#user_agents NetworkAcl#user_agents}
  */
...
export interface NetworkAclRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#scope NetworkAcl#scope}
  */
  readonly scope: string;
  /**
  * action block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#action NetworkAcl#action}
  */
  readonly action: NetworkAclRuleAction;
  /**
  * match block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#match NetworkAcl#match}
  */
  readonly match?: NetworkAclRuleMatch;
  /**
  * not_match block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#not_match NetworkAcl#not_match}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl auth0_network_acl}
*/
export class NetworkAcl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/network_acl auth0_network_acl} Resource
  *
  * @param scope The scope in which to define this construct
