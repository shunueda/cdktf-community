// https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/action
...
export interface DataAuth0ActionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/action#id DataAuth0Action#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/action#name DataAuth0Action#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/action auth0_action}
*/
export class DataAuth0Action extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0Action that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/action#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/action auth0_action} Data Source
  *
  * @param scope The scope in which to define this construct
