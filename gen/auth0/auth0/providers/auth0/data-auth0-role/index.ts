// https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/role
...
export interface DataAuth0RoleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/role#id DataAuth0Role#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/role#name DataAuth0Role#name}
  */
  readonly name?: string;
  /**
  * The ID of the role. If not provided, `name` must be set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/role#role_id DataAuth0Role#role_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/role auth0_role}
*/
export class DataAuth0Role extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0Role that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/role auth0_role} Data Source
  *
  * @param scope The scope in which to define this construct
