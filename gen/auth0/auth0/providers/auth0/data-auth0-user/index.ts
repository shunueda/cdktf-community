// https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/user
...
export interface DataAuth0UserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/user#custom_domain_header DataAuth0User#custom_domain_header}
  */
  readonly customDomainHeader?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/user#id DataAuth0User#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/user#query DataAuth0User#query}
  */
  readonly query?: string;
  /**
  * ID of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/user#user_id DataAuth0User#user_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/user auth0_user}
*/
export class DataAuth0User extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0User that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/data-sources/user auth0_user} Data Source
  *
  * @param scope The scope in which to define this construct
