// https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/prompt_partials
...
export interface PromptPartialsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/prompt_partials#form_content_end PromptPartials#form_content_end}
  */
  readonly formContentEnd?: string;
  /**
  * Content that goes at the start of the form.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/prompt_partials#form_content_start PromptPartials#form_content_start}
  */
  readonly formContentStart?: string;
  /**
  * Footer content for the end of the footer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/prompt_partials#form_footer_end PromptPartials#form_footer_end}
  */
  readonly formFooterEnd?: string;
  /**
  * Footer content for the start of the footer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/prompt_partials#form_footer_start PromptPartials#form_footer_start}
  */
  readonly formFooterStart?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/prompt_partials#id PromptPartials#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/prompt_partials#prompt PromptPartials#prompt}
  */
  readonly prompt: string;
  /**
  * Actions that go at the end of secondary actions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/prompt_partials#secondary_actions_end PromptPartials#secondary_actions_end}
  */
  readonly secondaryActionsEnd?: string;
  /**
  * Actions that go at the start of secondary actions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/prompt_partials#secondary_actions_start PromptPartials#secondary_actions_start}
  */
  readonly secondaryActionsStart?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/prompt_partials auth0_prompt_partials}
*/
export class PromptPartials extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PromptPartials that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/prompt_partials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.32.0/docs/resources/prompt_partials auth0_prompt_partials} Resource
  *
  * @param scope The scope in which to define this construct
