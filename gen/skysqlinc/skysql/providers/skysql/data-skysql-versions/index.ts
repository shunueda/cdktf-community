// https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/data-sources/versions
...
export interface DataSkysqlVersionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/data-sources/versions#topology DataSkysqlVersions#topology}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/data-sources/versions skysql_versions}
*/
export class DataSkysqlVersions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSkysqlVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/data-sources/versions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/data-sources/versions skysql_versions} Data Source
  *
  * @param scope The scope in which to define this construct
