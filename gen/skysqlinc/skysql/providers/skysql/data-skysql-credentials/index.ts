// https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/data-sources/credentials
...
export interface DataSkysqlCredentialsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/data-sources/credentials#service_id DataSkysqlCredentials#service_id}
  */
  readonly serviceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/data-sources/credentials skysql_credentials}
*/
export class DataSkysqlCredentials extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSkysqlCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/data-sources/credentials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/data-sources/credentials skysql_credentials} Data Source
  *
  * @param scope The scope in which to define this construct
