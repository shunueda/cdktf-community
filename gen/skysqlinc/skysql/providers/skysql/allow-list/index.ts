// https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/allow_list
...
export interface AllowListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/allow_list#allow_list AllowList#allow_list}
  */
  readonly allowList: AllowListAllowListStruct[] | cdktf.IResolvable;
  /**
  * The ID of the service to manage the allow list for
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/allow_list#service_id AllowList#service_id}
  */
  readonly serviceId: string;
  /**
  * If true, the provider will wait for the service to be updated before returning. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/allow_list#wait_for_creation AllowList#wait_for_creation}
  */
  readonly waitForCreation?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/allow_list#timeouts AllowList#timeouts}
  */
...
export interface AllowListAllowListStruct {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/allow_list#comment AllowList#comment}
  */
  readonly comment?: string;
  /**
  * The IP address to allow access to the service. The IP must be in a valid CIDR format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/allow_list#ip AllowList#ip}
  */
  readonly ip: string;
}
...
export interface AllowListTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/allow_list#create AllowList#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/allow_list skysql_allow_list}
*/
export class AllowList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AllowList that should be imported. Refer to the {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/allow_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/allow_list skysql_allow_list} Resource
  *
  * @param scope The scope in which to define this construct
