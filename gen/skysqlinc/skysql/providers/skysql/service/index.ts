// https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service
...
export interface ServiceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#allow_list Service#allow_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#architecture Service#architecture}
  */
  readonly architecture?: string;
  /**
  * The availability zone of the service
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#availability_zone Service#availability_zone}
  */
  readonly availabilityZone?: string;
  /**
  * The cloud provider to create the service in. Valid values are: aws or gcp
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#cloud_provider Service#cloud_provider}
  */
  readonly cloudProvider: string;
  /**
  * Whether to enable deletion protection. Valid values are: true or false. Default is true
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#deletion_protection Service#deletion_protection}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#endpoint_allowed_accounts Service#endpoint_allowed_accounts}
  */
  readonly endpointAllowedAccounts?: string[];
  /**
  * The endpoint mechanism to use. Valid values are: privateconnect or nlb
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#endpoint_mechanism Service#endpoint_mechanism}
  */
  readonly endpointMechanism?: string;
  /**
  * Whether the service is active
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#is_active Service#is_active}
  */
  readonly isActive?: boolean | cdktf.IResolvable;
  /**
  * The number of MaxScale nodes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#maxscale_nodes Service#maxscale_nodes}
  */
  readonly maxscaleNodes?: number;
  /**
  * The size of the MaxScale nodes. Valid values are: sky-2x4, sky-2x8 etc
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#maxscale_size Service#maxscale_size}
  */
  readonly maxscaleSize?: string;
  /**
  * The name of the service
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#name Service#name}
  */
  readonly name: string;
  /**
  * The number of nodes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#nodes Service#nodes}
  */
  readonly nodes?: number;
  /**
  * Whether to enable NoSQL. Valid values are: true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#nosql_enabled Service#nosql_enabled}
  */
  readonly nosqlEnabled?: boolean | cdktf.IResolvable;
  /**
  * The primary host of the service
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#primary_host Service#primary_host}
  */
  readonly primaryHost?: string;
  /**
  * The ID of the project to create the service in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#project_id Service#project_id}
  */
  readonly projectId?: string;
  /**
  * The region to create the service in. Value should be valid for a specific cloud provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#region Service#region}
  */
  readonly region: string;
  /**
  * Whether to enable global replication. Valid values are: true or false. Works for xpand-direct topology only
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#replication_enabled Service#replication_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#service_type Service#service_type}
  */
  readonly serviceType: string;
  /**
  * The size of the service. Valid values are: sky-2x4, sky-2x8 etc
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#size Service#size}
  */
  readonly size?: string;
  /**
  * Whether to enable SSL. Valid values are: true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#ssl_enabled Service#ssl_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#storage Service#storage}
  */
  readonly storage?: number;
  /**
  * Tags associated with the service. Note: The API will automatically overwrite 'tags.name' with the service name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#tags Service#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * The topology of the service. Valid values are: es-single, es-replica, xpand, csdw and sa
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#topology Service#topology}
  */
  readonly topology: string;
  /**
  * The software version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#version Service#version}
  */
  readonly version?: string;
  /**
  * The volume IOPS. This is only applicable for AWS
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#volume_iops Service#volume_iops}
  */
  readonly volumeIops?: number;
  /**
  * The volume Throughput. This is only applicable for AWS
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#volume_throughput Service#volume_throughput}
  */
  readonly volumeThroughput?: number;
  /**
  * The volume type. Valid values are: gp3 and io1. This is only applicable for AWS
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#volume_type Service#volume_type}
  */
  readonly volumeType?: string;
  /**
  * Whether to wait for the service to be created. Valid values are: true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#wait_for_creation Service#wait_for_creation}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#wait_for_deletion Service#wait_for_deletion}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#wait_for_update Service#wait_for_update}
  */
  readonly waitForUpdate?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#timeouts Service#timeouts}
  */
...
export interface ServiceAllowListStruct {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#comment Service#comment}
  */
  readonly comment?: string;
  /**
  * The IP address to allow access to the service. The IP must be in a valid CIDR format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#ip Service#ip}
  */
  readonly ip: string;
}
...
export interface ServiceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#create Service#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#delete Service#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#update Service#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service skysql_service}
*/
export class Service extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Service that should be imported. Refer to the {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/skysqlinc/skysql/3.1.5/docs/resources/service skysql_service} Resource
  *
  * @param scope The scope in which to define this construct
