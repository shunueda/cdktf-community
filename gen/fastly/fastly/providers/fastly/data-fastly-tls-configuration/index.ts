// https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_configuration
...
export interface DataFastlyTlsConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_configuration#default DataFastlyTlsConfiguration#default}
  */
  readonly default?: boolean | cdktf.IResolvable;
  /**
  * HTTP protocols available on the TLS configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_configuration#http_protocols DataFastlyTlsConfiguration#http_protocols}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_configuration#id DataFastlyTlsConfiguration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_configuration#name DataFastlyTlsConfiguration#name}
  */
  readonly name?: string;
  /**
  * TLS protocols available on the TLS configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_configuration#tls_protocols DataFastlyTlsConfiguration#tls_protocols}
  */
  readonly tlsProtocols?: string[];
  /**
  * Whether the configuration should support the `PLATFORM` or `CUSTOM` TLS service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_configuration#tls_service DataFastlyTlsConfiguration#tls_service}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_configuration fastly_tls_configuration}
*/
export class DataFastlyTlsConfiguration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFastlyTlsConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_configuration fastly_tls_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
