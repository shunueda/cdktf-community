// https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule
...
export interface NgwafWorkspaceRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#description NgwafWorkspaceRule#description}
  */
  readonly description: string;
  /**
  * Whether the rule is currently enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#enabled NgwafWorkspaceRule#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Logical operator to apply to group conditions. Accepted values are `any` and `all`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#group_operator NgwafWorkspaceRule#group_operator}
  */
  readonly groupOperator?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#id NgwafWorkspaceRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#request_logging NgwafWorkspaceRule#request_logging}
  */
  readonly requestLogging?: string;
  /**
  * The type of the rule. Accepted values are `request`, `signal`, `rate_limit`, and `templated_signal`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#type NgwafWorkspaceRule#type}
  */
  readonly type: string;
  /**
  * The ID of the workspace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#workspace_id NgwafWorkspaceRule#workspace_id}
  */
  readonly workspaceId: string;
  /**
  * action block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#action NgwafWorkspaceRule#action}
  */
  readonly action: NgwafWorkspaceRuleAction[] | cdktf.IResolvable;
  /**
  * condition block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#condition NgwafWorkspaceRule#condition}
  */
  readonly condition?: NgwafWorkspaceRuleCondition[] | cdktf.IResolvable;
  /**
  * group_condition block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#group_condition NgwafWorkspaceRule#group_condition}
  */
  readonly groupCondition?: NgwafWorkspaceRuleGroupCondition[] | cdktf.IResolvable;
  /**
  * multival_condition block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#multival_condition NgwafWorkspaceRule#multival_condition}
  */
  readonly multivalCondition?: NgwafWorkspaceRuleMultivalCondition[] | cdktf.IResolvable;
  /**
  * rate_limit block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#rate_limit NgwafWorkspaceRule#rate_limit}
  */
...
export interface NgwafWorkspaceRuleAction {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#allow_interactive NgwafWorkspaceRule#allow_interactive}
  */
  readonly allowInteractive?: boolean | cdktf.IResolvable;
  /**
  * specifies the type of deception (used when `type = deception`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#deception_type NgwafWorkspaceRule#deception_type}
  */
  readonly deceptionType?: string;
  /**
  * Redirect target (used when `type = redirect`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#redirect_url NgwafWorkspaceRule#redirect_url}
  */
  readonly redirectUrl?: string;
  /**
  * Response code used with redirect.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#response_code NgwafWorkspaceRule#response_code}
  */
  readonly responseCode?: number;
  /**
  * Signal name to exclude (used when `type = exclude_signal`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#signal NgwafWorkspaceRule#signal}
  */
...
export interface NgwafWorkspaceRuleCondition {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#field NgwafWorkspaceRule#field}
  */
  readonly field: string;
  /**
  * Operator to apply (e.g., `equals`, `contains`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#operator NgwafWorkspaceRule#operator}
  */
  readonly operator: string;
  /**
  * The value to test the field against.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#value NgwafWorkspaceRule#value}
  */
...
export interface NgwafWorkspaceRuleRateLimitClientIdentifiers {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#key NgwafWorkspaceRule#key}
  */
  readonly key?: string;
  /**
  * Name for the Client Identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#name NgwafWorkspaceRule#name}
  */
...
export interface NgwafWorkspaceRuleRateLimit {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#duration NgwafWorkspaceRule#duration}
  */
  readonly duration: number;
  /**
  * Time interval for the rate limit in seconds. Accepted values are 60, 600, and 3600.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#interval NgwafWorkspaceRule#interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#threshold NgwafWorkspaceRule#threshold}
  */
  readonly threshold: number;
  /**
  * client_identifiers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#client_identifiers NgwafWorkspaceRule#client_identifiers}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule fastly_ngwaf_workspace_rule}
*/
export class NgwafWorkspaceRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NgwafWorkspaceRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/ngwaf_workspace_rule fastly_ngwaf_workspace_rule} Resource
  *
  * @param scope The scope in which to define this construct
