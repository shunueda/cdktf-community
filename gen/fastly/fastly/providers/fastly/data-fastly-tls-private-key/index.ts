// https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_private_key
...
export interface DataFastlyTlsPrivateKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_private_key#created_at DataFastlyTlsPrivateKey#created_at}
  */
  readonly createdAt?: string;
  /**
  * Fastly private key ID. Conflicts with all the other filters
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_private_key#id DataFastlyTlsPrivateKey#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_private_key#key_length DataFastlyTlsPrivateKey#key_length}
  */
  readonly keyLength?: number;
  /**
  * The algorithm used to generate the private key. Must be RSA.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_private_key#key_type DataFastlyTlsPrivateKey#key_type}
  */
  readonly keyType?: string;
  /**
  * The human-readable name assigned to the private key when uploaded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_private_key#name DataFastlyTlsPrivateKey#name}
  */
  readonly name?: string;
  /**
  * A hash of the associated public key, useful for safely identifying it.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_private_key#public_key_sha1 DataFastlyTlsPrivateKey#public_key_sha1}
  */
  readonly publicKeySha1?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_private_key fastly_tls_private_key}
*/
export class DataFastlyTlsPrivateKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFastlyTlsPrivateKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_private_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_private_key fastly_tls_private_key} Data Source
  *
  * @param scope The scope in which to define this construct
