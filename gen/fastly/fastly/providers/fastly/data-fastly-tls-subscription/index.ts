// https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_subscription
...
export interface DataFastlyTlsSubscriptionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_subscription#certificate_authority DataFastlyTlsSubscription#certificate_authority}
  */
  readonly certificateAuthority?: string;
  /**
  * ID of TLS configuration used to terminate TLS traffic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_subscription#configuration_id DataFastlyTlsSubscription#configuration_id}
  */
  readonly configurationId?: string;
  /**
  * List of domains on which to enable TLS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_subscription#domains DataFastlyTlsSubscription#domains}
  */
  readonly domains?: string[];
  /**
  * ID of TLS subscription. Conflicts with all the other filters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_subscription#id DataFastlyTlsSubscription#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_subscription fastly_tls_subscription}
*/
export class DataFastlyTlsSubscription extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFastlyTlsSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/data-sources/tls_subscription fastly_tls_subscription} Data Source
  *
  * @param scope The scope in which to define this construct
