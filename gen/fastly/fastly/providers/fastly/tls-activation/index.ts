// https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/tls_activation
...
export interface TlsActivationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/tls_activation#certificate_id TlsActivation#certificate_id}
  */
  readonly certificateId: string;
  /**
  * ID of TLS configuration to be used to terminate TLS traffic, or use the default one if missing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/tls_activation#configuration_id TlsActivation#configuration_id}
  */
  readonly configurationId?: string;
  /**
  * Domain to enable TLS on. Must be assigned to an existing Fastly Service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/tls_activation#domain TlsActivation#domain}
  */
  readonly domain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/tls_activation#id TlsActivation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/tls_activation#mutual_authentication_id TlsActivation#mutual_authentication_id}
  */
  readonly mutualAuthenticationId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/tls_activation fastly_tls_activation}
*/
export class TlsActivation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TlsActivation that should be imported. Refer to the {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/tls_activation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fastly/fastly/8.3.2/docs/resources/tls_activation fastly_tls_activation} Resource
  *
  * @param scope The scope in which to define this construct
