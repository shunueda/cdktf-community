// https://registry.terraform.io/providers/selectel/selectel/6.8.0/docs/resources/iam_saml_federation_certificate_v1
...
export interface IamSamlFederationCertificateV1Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/6.8.0/docs/resources/iam_saml_federation_certificate_v1#data IamSamlFederationCertificateV1#data}
  */
  readonly data: string;
  /**
  * Description of the Certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/6.8.0/docs/resources/iam_saml_federation_certificate_v1#description IamSamlFederationCertificateV1#description}
  */
  readonly description?: string;
  /**
  * Federation ID to create Certificate for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/6.8.0/docs/resources/iam_saml_federation_certificate_v1#federation_id IamSamlFederationCertificateV1#federation_id}
  */
  readonly federationId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/6.8.0/docs/resources/iam_saml_federation_certificate_v1#id IamSamlFederationCertificateV1#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/6.8.0/docs/resources/iam_saml_federation_certificate_v1#name IamSamlFederationCertificateV1#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/selectel/selectel/6.8.0/docs/resources/iam_saml_federation_certificate_v1 selectel_iam_saml_federation_certificate_v1}
*/
export class IamSamlFederationCertificateV1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamSamlFederationCertificateV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/selectel/selectel/6.8.0/docs/resources/iam_saml_federation_certificate_v1#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/selectel/selectel/6.8.0/docs/resources/iam_saml_federation_certificate_v1 selectel_iam_saml_federation_certificate_v1} Resource
  *
  * @param scope The scope in which to define this construct
