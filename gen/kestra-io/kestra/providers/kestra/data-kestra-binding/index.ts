// https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/data-sources/binding
...
export interface DataKestraBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  * The binding id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/data-sources/binding#binding_id DataKestraBinding#binding_id}
  */
  readonly bindingId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/data-sources/binding#id DataKestraBinding#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/data-sources/binding kestra_binding}
*/
export class DataKestraBinding extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKestraBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/data-sources/binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/data-sources/binding kestra_binding} Data Source
  *
  * @param scope The scope in which to define this construct
