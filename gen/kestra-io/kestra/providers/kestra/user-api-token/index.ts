// https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/user_api_token
...
export interface UserApiTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/user_api_token#description UserApiToken#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/user_api_token#extended UserApiToken#extended}
  */
  readonly extended?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/user_api_token#id UserApiToken#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/user_api_token#max_age UserApiToken#max_age}
  */
  readonly maxAge: string;
  /**
  * The API token display name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/user_api_token#name UserApiToken#name}
  */
  readonly name: string;
  /**
  * The ID of the user owning the API Token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/user_api_token#user_id UserApiToken#user_id}
  */
  readonly userId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/user_api_token kestra_user_api_token}
*/
export class UserApiToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserApiToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/user_api_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/user_api_token kestra_user_api_token} Resource
  *
  * @param scope The scope in which to define this construct
