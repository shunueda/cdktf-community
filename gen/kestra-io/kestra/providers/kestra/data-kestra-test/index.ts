// https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/data-sources/test
...
export interface DataKestraTestConfig extends cdktf.TerraformMetaArguments {
  ...
  * The Test namespace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/data-sources/test#namespace DataKestraTest#namespace}
  */
  readonly namespace: string;
  /**
  * The Test id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/data-sources/test#test_id DataKestraTest#test_id}
  */
  readonly testId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/data-sources/test kestra_test}
*/
export class DataKestraTest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKestraTest that should be imported. Refer to the {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/data-sources/test#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/data-sources/test kestra_test} Data Source
  *
  * @param scope The scope in which to define this construct
