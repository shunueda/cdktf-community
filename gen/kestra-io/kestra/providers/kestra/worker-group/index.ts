// https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/worker_group
...
export interface WorkerGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/worker_group#allowed_tenants WorkerGroup#allowed_tenants}
  */
  readonly allowedTenants?: string[];
  /**
  * The worker group description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/worker_group#description WorkerGroup#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/worker_group#id WorkerGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/worker_group#key WorkerGroup#key}
  */
  readonly key: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/worker_group kestra_worker_group}
*/
export class WorkerGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkerGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/worker_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/worker_group kestra_worker_group} Resource
  *
  * @param scope The scope in which to define this construct
