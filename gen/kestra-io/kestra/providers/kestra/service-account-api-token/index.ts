// https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/service_account_api_token
...
export interface ServiceAccountApiTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/service_account_api_token#description ServiceAccountApiToken#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/service_account_api_token#extended ServiceAccountApiToken#extended}
  */
  readonly extended?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/service_account_api_token#id ServiceAccountApiToken#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/service_account_api_token#max_age ServiceAccountApiToken#max_age}
  */
  readonly maxAge: string;
  /**
  * The API token display name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/service_account_api_token#name ServiceAccountApiToken#name}
  */
  readonly name: string;
  /**
  * The ID of the Service Account owning the API Token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/service_account_api_token#service_account_id ServiceAccountApiToken#service_account_id}
  */
  readonly serviceAccountId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/service_account_api_token kestra_service_account_api_token}
*/
export class ServiceAccountApiToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceAccountApiToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/service_account_api_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/service_account_api_token kestra_service_account_api_token} Resource
  *
  * @param scope The scope in which to define this construct
