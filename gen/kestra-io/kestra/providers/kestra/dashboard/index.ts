// https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/dashboard
...
export interface DashboardConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/dashboard#source_code Dashboard#source_code}
  */
  readonly sourceCode: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/dashboard kestra_dashboard}
*/
export class Dashboard extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Dashboard that should be imported. Refer to the {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/dashboard#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/dashboard kestra_dashboard} Resource
  *
  * @param scope The scope in which to define this construct
