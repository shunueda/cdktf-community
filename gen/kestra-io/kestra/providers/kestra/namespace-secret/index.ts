// https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/namespace_secret
...
export interface NamespaceSecretConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/namespace_secret#id NamespaceSecret#id}
  *
  ...
  * The namespace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/namespace_secret#namespace NamespaceSecret#namespace}
  */
  readonly namespace: string;
  /**
  * The namespace secret description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/namespace_secret#secret_description NamespaceSecret#secret_description}
  */
  readonly secretDescription?: string;
  /**
  * The namespace secret key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/namespace_secret#secret_key NamespaceSecret#secret_key}
  */
  readonly secretKey: string;
  /**
  * The namespace secret description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/namespace_secret#secret_tags NamespaceSecret#secret_tags}
  */
  readonly secretTags?: { [key: string]: string };
  /**
  * The namespace secret value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/namespace_secret#secret_value NamespaceSecret#secret_value}
  */
  readonly secretValue: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/namespace_secret kestra_namespace_secret}
*/
export class NamespaceSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NamespaceSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/namespace_secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.1/docs/resources/namespace_secret kestra_namespace_secret} Resource
  *
  * @param scope The scope in which to define this construct
