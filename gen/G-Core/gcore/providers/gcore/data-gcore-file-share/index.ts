// https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/file_share
...
export interface DataGcoreFileShareConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/file_share#id DataGcoreFileShare#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/file_share#name DataGcoreFileShare#name}
  */
  readonly name: string;
  /**
  * Project ID, only one of project_id or project_name should be set
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/file_share#project_id DataGcoreFileShare#project_id}
  */
  readonly projectId?: number;
  /**
  * Project name, only one of project_id or project_name should be set
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/file_share#project_name DataGcoreFileShare#project_name}
  */
  readonly projectName?: string;
  /**
  * Region ID, only one of region_id or region_name should be set
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/file_share#region_id DataGcoreFileShare#region_id}
  */
  readonly regionId?: number;
  /**
  * Region name, only one of region_id or region_name should be set
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/file_share#region_name DataGcoreFileShare#region_name}
  */
  readonly regionName?: string;
  /**
  * share_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/file_share#share_settings DataGcoreFileShare#share_settings}
  */
...
export interface DataGcoreFileShareShareSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/file_share#allowed_characters DataGcoreFileShare#allowed_characters}
  */
  readonly allowedCharacters?: string;
  /**
  * Affects the maximum limit of file path component name length.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/file_share#path_length DataGcoreFileShare#path_length}
  */
  readonly pathLength?: string;
  /**
  * Indicates if root squash is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/file_share#root_squash DataGcoreFileShare#root_squash}
  */
  readonly rootSquash?: boolean | cdktf.IResolvable;
  /**
  * The type of the file share (standard or vast).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/file_share#type_name DataGcoreFileShare#type_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/file_share gcore_file_share}
*/
export class DataGcoreFileShare extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGcoreFileShare that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/file_share#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/file_share gcore_file_share} Data Source
  *
  * @param scope The scope in which to define this construct
