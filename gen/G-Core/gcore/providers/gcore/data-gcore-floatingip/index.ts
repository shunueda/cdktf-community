// https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/floatingip
...
export interface DataGcoreFloatingipConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/floatingip#fixed_ip_address DataGcoreFloatingip#fixed_ip_address}
  */
  readonly fixedIpAddress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/floatingip#floating_ip_address DataGcoreFloatingip#floating_ip_address}
  */
  readonly floatingIpAddress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/floatingip#id DataGcoreFloatingip#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/floatingip#metadata_k DataGcoreFloatingip#metadata_k}
  */
  readonly metadataK?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/floatingip#metadata_kv DataGcoreFloatingip#metadata_kv}
  */
  readonly metadataKv?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/floatingip#port_id DataGcoreFloatingip#port_id}
  */
  readonly portId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/floatingip#project_id DataGcoreFloatingip#project_id}
  */
  readonly projectId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/floatingip#project_name DataGcoreFloatingip#project_name}
  */
  readonly projectName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/floatingip#region_id DataGcoreFloatingip#region_id}
  */
  readonly regionId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/floatingip#region_name DataGcoreFloatingip#region_name}
  */
...
export interface DataGcoreFloatingipTags {
}

export function dataGcoreFloatingipTagsToTerraform(struct?: DataGcoreFloatingipTags): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataGcoreFloatingipTagsToHclTerraform(struct?: DataGcoreFloatingipTags): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataGcoreFloatingipTagsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataGcoreFloatingipTags | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGcoreFloatingipTags | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataGcoreFloatingipTagsList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataGcoreFloatingipTagsOutputReference {
    return new DataGcoreFloatingipTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/floatingip gcore_floatingip}
*/
export class DataGcoreFloatingip extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGcoreFloatingip that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/floatingip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcore/0.31.1/docs/data-sources/floatingip gcore_floatingip} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _tags = new DataGcoreFloatingipTagsList(this, "tags", false);
  public get tags() {
    return this._tags;
  }
