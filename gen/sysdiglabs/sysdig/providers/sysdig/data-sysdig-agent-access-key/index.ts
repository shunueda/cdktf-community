// https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/data-sources/agent_access_key
...
export interface DataSysdigAgentAccessKeyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/data-sources/agent_access_key#id DataSysdigAgentAccessKey#id}
  *
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/data-sources/agent_access_key#timeouts DataSysdigAgentAccessKey#timeouts}
  */
  readonly timeouts?: DataSysdigAgentAccessKeyTimeouts;
}
export interface DataSysdigAgentAccessKeyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/data-sources/agent_access_key#read DataSysdigAgentAccessKey#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/data-sources/agent_access_key sysdig_agent_access_key}
*/
export class DataSysdigAgentAccessKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSysdigAgentAccessKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/data-sources/agent_access_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/data-sources/agent_access_key sysdig_agent_access_key} Data Source
  *
  * @param scope The scope in which to define this construct
