// https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/group_mapping_config
...
export interface GroupMappingConfigAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/group_mapping_config#different_team_same_role_strategy GroupMappingConfigA#different_team_same_role_strategy}
  */
  readonly differentTeamSameRoleStrategy: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/group_mapping_config#id GroupMappingConfigA#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/group_mapping_config#no_mapping_strategy GroupMappingConfigA#no_mapping_strategy}
  */
  readonly noMappingStrategy: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/group_mapping_config#timeouts GroupMappingConfigA#timeouts}
  */
  readonly timeouts?: GroupMappingConfigTimeouts;
}
export interface GroupMappingConfigTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/group_mapping_config#create GroupMappingConfigA#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/group_mapping_config#delete GroupMappingConfigA#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/group_mapping_config#read GroupMappingConfigA#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/group_mapping_config#update GroupMappingConfigA#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/group_mapping_config sysdig_group_mapping_config}
*/
export class GroupMappingConfigA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GroupMappingConfigA that should be imported. Refer to the {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/group_mapping_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/group_mapping_config sysdig_group_mapping_config} Resource
  *
  * @param scope The scope in which to define this construct
