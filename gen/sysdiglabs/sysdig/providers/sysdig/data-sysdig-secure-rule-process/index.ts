// https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/data-sources/secure_rule_process
...
export interface DataSysdigSecureRuleProcessConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/data-sources/secure_rule_process#name DataSysdigSecureRuleProcess#name}
  */
  readonly name: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/data-sources/secure_rule_process#timeouts DataSysdigSecureRuleProcess#timeouts}
  */
  readonly timeouts?: DataSysdigSecureRuleProcessTimeouts;
}
export interface DataSysdigSecureRuleProcessTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/data-sources/secure_rule_process#read DataSysdigSecureRuleProcess#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/data-sources/secure_rule_process sysdig_secure_rule_process}
*/
export class DataSysdigSecureRuleProcess extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSysdigSecureRuleProcess that should be imported. Refer to the {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/data-sources/secure_rule_process#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/data-sources/secure_rule_process sysdig_secure_rule_process} Data Source
  *
  * @param scope The scope in which to define this construct
