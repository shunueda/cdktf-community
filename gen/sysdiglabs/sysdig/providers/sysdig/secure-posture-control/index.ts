// https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/secure_posture_control
...
export interface SecurePostureControlConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/secure_posture_control#description SecurePostureControl#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/secure_posture_control#name SecurePostureControl#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/secure_posture_control#rego SecurePostureControl#rego}
  */
  readonly rego: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/secure_posture_control#remediation_details SecurePostureControl#remediation_details}
  */
  readonly remediationDetails: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/secure_posture_control#resource_kind SecurePostureControl#resource_kind}
  */
  readonly resourceKind: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/secure_posture_control#severity SecurePostureControl#severity}
  */
  readonly severity: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/secure_posture_control#timeouts SecurePostureControl#timeouts}
  */
  readonly timeouts?: SecurePostureControlTimeouts;
}
export interface SecurePostureControlTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/secure_posture_control#create SecurePostureControl#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/secure_posture_control sysdig_secure_posture_control}
*/
export class SecurePostureControl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurePostureControl that should be imported. Refer to the {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/secure_posture_control#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.0.1/docs/resources/secure_posture_control sysdig_secure_posture_control} Resource
  *
  * @param scope The scope in which to define this construct
