// https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter
...
export interface DataCoderParameterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#default DataCoderParameter#default}
  */
  readonly default?: string;
  /**
  * Describe what this parameter does.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#description DataCoderParameter#description}
  */
  readonly description?: string;
  /**
  * The displayed name of the parameter as it will appear in the interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#display_name DataCoderParameter#display_name}
  */
  readonly displayName?: string;
  /**
  * The value of an ephemeral parameter will not be preserved between consecutive workspace builds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#ephemeral DataCoderParameter#ephemeral}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#form_type DataCoderParameter#form_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#icon DataCoderParameter#icon}
  */
  readonly icon?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#id DataCoderParameter#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#mutable DataCoderParameter#mutable}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#name DataCoderParameter#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#order DataCoderParameter#order}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#styling DataCoderParameter#styling}
  */
  readonly styling?: string;
  /**
  * The type of this parameter. Must be one of: `"string"`, `"number"`, `"bool"`, `"list(string)"`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#type DataCoderParameter#type}
  */
  readonly type?: string;
  /**
  * option block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#option DataCoderParameter#option}
  */
  readonly option?: DataCoderParameterOption[] | cdktf.IResolvable;
  /**
  * validation block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#validation DataCoderParameter#validation}
  */
...
export interface DataCoderParameterOption {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#value DataCoderParameter#value}
  */
...
export interface DataCoderParameterValidation {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#error DataCoderParameter#error}
  */
  readonly error?: string;
  /**
  * The maximum value of a number parameter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#max DataCoderParameter#max}
  */
  readonly max?: number;
  /**
  * The minimum value of a number parameter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#min DataCoderParameter#min}
  */
  readonly min?: number;
  /**
  * Number monotonicity, either increasing or decreasing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#monotonic DataCoderParameter#monotonic}
  */
  readonly monotonic?: string;
  /**
  * A regex for the input parameter to match against.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#regex DataCoderParameter#regex}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter coder_parameter}
*/
export class DataCoderParameter extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCoderParameter that should be imported. Refer to the {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/parameter coder_parameter} Data Source
  *
  * @param scope The scope in which to define this construct
