// https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/workspace
...
/**
* Represents a {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/workspace coder_workspace}
*/
export class DataCoderWorkspace extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCoderWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/workspace coder_workspace} Data Source
  *
  * @param scope The scope in which to define this construct
