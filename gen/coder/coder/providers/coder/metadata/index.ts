// https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/metadata
...
export interface MetadataConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/metadata#daily_cost Metadata#daily_cost}
  */
  readonly dailyCost?: number;
  /**
  * Hide the resource from the UI.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/metadata#hide Metadata#hide}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/metadata#icon Metadata#icon}
  */
  readonly icon?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/metadata#id Metadata#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/metadata#resource_id Metadata#resource_id}
  */
  readonly resourceId: string;
  /**
  * item block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/metadata#item Metadata#item}
  */
...
export interface MetadataItem {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/metadata#key Metadata#key}
  */
  readonly key: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/metadata#sensitive Metadata#sensitive}
  */
  readonly sensitive?: boolean | cdktf.IResolvable;
  /**
  * The value of this metadata item. Supports basic Markdown, including hyperlinks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/metadata#value Metadata#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/metadata coder_metadata}
*/
export class Metadata extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Metadata that should be imported. Refer to the {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/metadata#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/metadata coder_metadata} Resource
  *
  * @param scope The scope in which to define this construct
