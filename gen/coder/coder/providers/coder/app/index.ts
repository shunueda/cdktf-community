// https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app
...
export interface AppConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app#agent_id App#agent_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app#command App#command}
  */
  readonly command?: string;
  /**
  * A display name to identify the app. Defaults to the slug.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app#display_name App#display_name}
  */
  readonly displayName?: string;
  /**
  * Specifies whether `url` is opened on the client machine instead of proxied through the workspace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app#external App#external}
  */
  readonly external?: boolean | cdktf.IResolvable;
  /**
  * The name of a group that this app belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app#group App#group}
  */
  readonly group?: string;
  /**
  * Determines if the app is visible in the UI (minimum Coder version: v2.16).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app#hidden App#hidden}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app#icon App#icon}
  */
  readonly icon?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app#id App#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app#open_in App#open_in}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app#order App#order}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app#share App#share}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app#slug App#slug}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app#subdomain App#subdomain}
  */
  readonly subdomain?: boolean | cdktf.IResolvable;
  /**
  * Markdown text that is displayed when hovering over workspace apps.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app#tooltip App#tooltip}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app#url App#url}
  */
  readonly url?: string;
  /**
  * healthcheck block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app#healthcheck App#healthcheck}
  */
...
export interface AppHealthcheck {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app#interval App#interval}
  */
  readonly interval: number;
  /**
  * Number of consecutive heathcheck failures before returning an unhealthy status.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app#threshold App#threshold}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app coder_app}
*/
export class App extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing App that should be imported. Refer to the {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/resources/app coder_app} Resource
  *
  * @param scope The scope in which to define this construct
