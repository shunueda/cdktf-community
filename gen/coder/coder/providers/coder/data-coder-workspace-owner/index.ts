// https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/workspace_owner
...
/**
* Represents a {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/workspace_owner coder_workspace_owner}
*/
export class DataCoderWorkspaceOwner extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCoderWorkspaceOwner that should be imported. Refer to the {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/workspace_owner#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/coder/coder/2.12.0/docs/data-sources/workspace_owner coder_workspace_owner} Data Source
  *
  * @param scope The scope in which to define this construct
