// https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/secret_sync_azure_app_configuration
...
export interface SecretSyncAzureAppConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/secret_sync_azure_app_configuration#auto_sync_enabled SecretSyncAzureAppConfiguration#auto_sync_enabled}
  */
  readonly autoSyncEnabled?: boolean | cdktf.IResolvable;
  /**
  * The ID of the azure Connection to use for syncing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/secret_sync_azure_app_configuration#connection_id SecretSyncAzureAppConfiguration#connection_id}
  */
  readonly connectionId: string;
  /**
  * An optional description for the Azure App Configuration sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/secret_sync_azure_app_configuration#description SecretSyncAzureAppConfiguration#description}
  */
  readonly description?: string;
  /**
  * The destination configuration for the secret sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/secret_sync_azure_app_configuration#destination_config SecretSyncAzureAppConfiguration#destination_config}
  */
  readonly destinationConfig: SecretSyncAzureAppConfigurationDestinationConfig;
  /**
  * The slug of the project environment to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/secret_sync_azure_app_configuration#environment SecretSyncAzureAppConfiguration#environment}
  */
  readonly environment: string;
  /**
  * The name of the Azure App Configuration sync to create. Must be slug-friendly.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/secret_sync_azure_app_configuration#name SecretSyncAzureAppConfiguration#name}
  */
  readonly name: string;
  /**
  * The ID of the Infisical project to create the sync in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/secret_sync_azure_app_configuration#project_id SecretSyncAzureAppConfiguration#project_id}
  */
  readonly projectId: string;
  /**
  * The folder path to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/secret_sync_azure_app_configuration#secret_path SecretSyncAzureAppConfiguration#secret_path}
  */
  readonly secretPath: string;
  /**
  * Parameters to modify how secrets are synced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/secret_sync_azure_app_configuration#sync_options SecretSyncAzureAppConfiguration#sync_options}
  */
...
export interface SecretSyncAzureAppConfigurationDestinationConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/secret_sync_azure_app_configuration#configuration_url SecretSyncAzureAppConfiguration#configuration_url}
  */
  readonly configurationUrl: string;
  /**
  * The label to attach to secrets created in Azure App Configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/secret_sync_azure_app_configuration#label SecretSyncAzureAppConfiguration#label}
  */
...
export interface SecretSyncAzureAppConfigurationSyncOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/secret_sync_azure_app_configuration#disable_secret_deletion SecretSyncAzureAppConfiguration#disable_secret_deletion}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/secret_sync_azure_app_configuration#initial_sync_behavior SecretSyncAzureAppConfiguration#initial_sync_behavior}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/secret_sync_azure_app_configuration#key_schema SecretSyncAzureAppConfiguration#key_schema}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/secret_sync_azure_app_configuration infisical_secret_sync_azure_app_configuration}
*/
export class SecretSyncAzureAppConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretSyncAzureAppConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/secret_sync_azure_app_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/secret_sync_azure_app_configuration infisical_secret_sync_azure_app_configuration} Resource
  *
  * @param scope The scope in which to define this construct
