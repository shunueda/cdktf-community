// https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/project_identity
...
export interface ProjectIdentityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/project_identity#identity_id ProjectIdentity#identity_id}
  */
  readonly identityId: string;
  /**
  * The id of the project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/project_identity#project_id ProjectIdentity#project_id}
  */
  readonly projectId: string;
  /**
  * The roles assigned to the project identity
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/project_identity#roles ProjectIdentity#roles}
  */
...
export function projectIdentityIdentityToTerraform(struct?: ProjectIdentityIdentity): any {
...
export function projectIdentityIdentityToHclTerraform(struct?: ProjectIdentityIdentity): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ProjectIdentityIdentityOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ProjectIdentityIdentity | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: ProjectIdentityIdentity | undefined) {
    if (value === undefined) {
...
export interface ProjectIdentityRoles {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/project_identity#custom_role_id ProjectIdentity#custom_role_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/project_identity#is_temporary ProjectIdentity#is_temporary}
  */
  readonly isTemporary?: boolean | cdktf.IResolvable;
  /**
  * The slug of the role
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/project_identity#role_slug ProjectIdentity#role_slug}
  */
  readonly roleSlug: string;
  /**
  * ISO time for which temporary access will end. Computed based on temporary_range and temporary_access_start_time
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/project_identity#temporary_access_end_time ProjectIdentity#temporary_access_end_time}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/project_identity#temporary_access_start_time ProjectIdentity#temporary_access_start_time}
  */
  readonly temporaryAccessStartTime?: string;
  /**
  * Type of temporary access given. Types: relative. Default: relative
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/project_identity#temporary_mode ProjectIdentity#temporary_mode}
  */
  readonly temporaryMode?: string;
  /**
  * TTL for the temporary time. Eg: 1m, 1h, 1d. Default: 1h
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/project_identity#temporary_range ProjectIdentity#temporary_range}
  */
  readonly temporaryRange?: string;
}

export function projectIdentityRolesToTerraform(struct?: ProjectIdentityRoles | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function projectIdentityRolesToHclTerraform(struct?: ProjectIdentityRoles | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ProjectIdentityRolesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ProjectIdentityRoles | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ProjectIdentityRoles | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class ProjectIdentityRolesList extends cdktf.ComplexList {
  public internalValue? : ProjectIdentityRoles[] | cdktf.IResolvable
  ...
  */
  public get(index: number): ProjectIdentityRolesOutputReference {
    return new ProjectIdentityRolesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/project_identity infisical_project_identity}
*/
export class ProjectIdentity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/project_identity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.41/docs/resources/project_identity infisical_project_identity} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ProjectIdentityConfig
  */
  public constructor(scope: Construct, id: string, config: ProjectIdentityConfig) {
    super(scope, id, {
  ...
  private _identity = new ProjectIdentityIdentityOutputReference(this, "identity");
  public get identity() {
  ...
  private _roles = new ProjectIdentityRolesList(this, "roles", false);
  public get roles() {
    return this._roles;
  }
  public putRoles(value: ProjectIdentityRoles[] | cdktf.IResolvable) {
