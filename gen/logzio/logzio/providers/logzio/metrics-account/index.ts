// https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/metrics_account
...
export interface MetricsAccountConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/metrics_account#account_name MetricsAccount#account_name}
  */
  readonly accountName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/metrics_account#authorized_accounts MetricsAccount#authorized_accounts}
  */
  readonly authorizedAccounts?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/metrics_account#email MetricsAccount#email}
  */
  readonly email: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/metrics_account#id MetricsAccount#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/metrics_account#plan_uts MetricsAccount#plan_uts}
  */
  readonly planUts?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/metrics_account logzio_metrics_account}
*/
export class MetricsAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MetricsAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/metrics_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/metrics_account logzio_metrics_account} Resource
  *
  * @param scope The scope in which to define this construct
