// https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/subaccount
...
export interface SubaccountConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/subaccount#accessible Subaccount#accessible}
  */
  readonly accessible?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/subaccount#account_name Subaccount#account_name}
  */
  readonly accountName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/subaccount#doc_size_setting Subaccount#doc_size_setting}
  */
  readonly docSizeSetting?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/subaccount#email Subaccount#email}
  */
  readonly email: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/subaccount#flexible Subaccount#flexible}
  */
  readonly flexible?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/subaccount#frequency_minutes Subaccount#frequency_minutes}
  */
  readonly frequencyMinutes?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/subaccount#id Subaccount#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/subaccount#max_daily_gb Subaccount#max_daily_gb}
  */
  readonly maxDailyGb?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/subaccount#reserved_daily_gb Subaccount#reserved_daily_gb}
  */
  readonly reservedDailyGb?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/subaccount#retention_days Subaccount#retention_days}
  */
  readonly retentionDays: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/subaccount#searchable Subaccount#searchable}
  */
  readonly searchable?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/subaccount#sharing_objects_accounts Subaccount#sharing_objects_accounts}
  */
  readonly sharingObjectsAccounts?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/subaccount#snap_search_retention_days Subaccount#snap_search_retention_days}
  */
  readonly snapSearchRetentionDays?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/subaccount#soft_limit_gb Subaccount#soft_limit_gb}
  */
  readonly softLimitGb?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/subaccount#utilization_enabled Subaccount#utilization_enabled}
  */
  readonly utilizationEnabled?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/subaccount logzio_subaccount}
*/
export class Subaccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Subaccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/subaccount#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/subaccount logzio_subaccount} Resource
  *
  * @param scope The scope in which to define this construct
