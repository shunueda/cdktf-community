// https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs
...
export interface LogzioProviderConfig {
  ...
  * Your API token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs#api_token LogzioProvider#api_token}
  */
  readonly apiToken: string;
  /**
  * Custom API URL to override the default Logz.io API endpoint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs#custom_api_url LogzioProvider#custom_api_url}
  */
  readonly customApiUrl?: string;
  /**
  * Your logz.io region
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs#region LogzioProvider#region}
  */
  readonly region?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs#alias LogzioProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs logzio}
*/
export class LogzioProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing LogzioProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs logzio} Resource
  *
  * @param scope The scope in which to define this construct
