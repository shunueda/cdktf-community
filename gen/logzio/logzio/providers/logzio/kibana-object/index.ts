// https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/kibana_object
...
export interface KibanaObjectConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/kibana_object#data KibanaObject#data}
  */
  readonly data: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/kibana_object#id KibanaObject#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/kibana_object#kibana_version KibanaObject#kibana_version}
  */
  readonly kibanaVersion: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/kibana_object logzio_kibana_object}
*/
export class KibanaObject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KibanaObject that should be imported. Refer to the {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/kibana_object#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/kibana_object logzio_kibana_object} Resource
  *
  * @param scope The scope in which to define this construct
