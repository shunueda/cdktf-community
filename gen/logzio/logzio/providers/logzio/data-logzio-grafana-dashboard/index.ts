// https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/grafana_dashboard
...
export interface DataLogzioGrafanaDashboardConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/grafana_dashboard#dashboard_uid DataLogzioGrafanaDashboard#dashboard_uid}
  */
  readonly dashboardUid: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/grafana_dashboard#id DataLogzioGrafanaDashboard#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/grafana_dashboard logzio_grafana_dashboard}
*/
export class DataLogzioGrafanaDashboard extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLogzioGrafanaDashboard that should be imported. Refer to the {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/grafana_dashboard#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/grafana_dashboard logzio_grafana_dashboard} Data Source
  *
  * @param scope The scope in which to define this construct
