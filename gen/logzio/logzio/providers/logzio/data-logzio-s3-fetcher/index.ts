// https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/s3_fetcher
...
export interface DataLogzioS3FetcherConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/s3_fetcher#aws_access_key DataLogzioS3Fetcher#aws_access_key}
  */
  readonly awsAccessKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/s3_fetcher#aws_arn DataLogzioS3Fetcher#aws_arn}
  */
  readonly awsArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/s3_fetcher#fetcher_id DataLogzioS3Fetcher#fetcher_id}
  */
  readonly fetcherId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/s3_fetcher#id DataLogzioS3Fetcher#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/s3_fetcher#prefix DataLogzioS3Fetcher#prefix}
  */
  readonly prefix?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/s3_fetcher logzio_s3_fetcher}
*/
export class DataLogzioS3Fetcher extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLogzioS3Fetcher that should be imported. Refer to the {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/s3_fetcher#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/s3_fetcher logzio_s3_fetcher} Data Source
  *
  * @param scope The scope in which to define this construct
