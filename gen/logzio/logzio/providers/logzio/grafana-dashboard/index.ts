// https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/grafana_dashboard
...
export interface GrafanaDashboardConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/grafana_dashboard#dashboard_json GrafanaDashboard#dashboard_json}
  */
  readonly dashboardJson: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/grafana_dashboard#folder_uid GrafanaDashboard#folder_uid}
  */
  readonly folderUid: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/grafana_dashboard#id GrafanaDashboard#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/grafana_dashboard#message GrafanaDashboard#message}
  */
  readonly message?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/grafana_dashboard#overwrite GrafanaDashboard#overwrite}
  */
  readonly overwrite?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/grafana_dashboard logzio_grafana_dashboard}
*/
export class GrafanaDashboard extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GrafanaDashboard that should be imported. Refer to the {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/grafana_dashboard#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/resources/grafana_dashboard logzio_grafana_dashboard} Resource
  *
  * @param scope The scope in which to define this construct
