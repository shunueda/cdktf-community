// https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/restore_logs
...
export interface DataLogzioRestoreLogsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/restore_logs#id DataLogzioRestoreLogs#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/restore_logs#restore_operation_id DataLogzioRestoreLogs#restore_operation_id}
  */
  readonly restoreOperationId?: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/restore_logs#timeouts DataLogzioRestoreLogs#timeouts}
  */
  readonly timeouts?: DataLogzioRestoreLogsTimeouts;
}
export interface DataLogzioRestoreLogsTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/restore_logs#read DataLogzioRestoreLogs#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/restore_logs logzio_restore_logs}
*/
export class DataLogzioRestoreLogs extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLogzioRestoreLogs that should be imported. Refer to the {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/restore_logs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/logzio/logzio/1.25.0/docs/data-sources/restore_logs logzio_restore_logs} Data Source
  *
  * @param scope The scope in which to define this construct
