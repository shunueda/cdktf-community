// https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/oidc
...
export interface OidcConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/oidc#claims Oidc#claims}
  */
  readonly claims: { [key: string]: string };
  /**
  * Whether the provider settings should be used for incoming OIDC requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/oidc#enabled Oidc#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/oidc#id Oidc#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/oidc#mapping_claim Oidc#mapping_claim}
  */
  readonly mappingClaim?: string;
  /**
  * The name of the provider settings are being configured for
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/oidc#name Oidc#name}
  */
  readonly name: string;
  /**
  * Namespace to which this OIDC config belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/oidc#namespace Oidc#namespace}
  */
  readonly namespace: string;
  /**
  * The URL from the provider that serves as the base for the OpenID configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/oidc#provider_url Oidc#provider_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/oidc#service_accounts Oidc#service_accounts}
  */
  readonly serviceAccounts?: string[];
  /**
  * dynamic_mappings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/oidc#dynamic_mappings Oidc#dynamic_mappings}
  */
...
export interface OidcDynamicMappings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/oidc#claim_value Oidc#claim_value}
  */
  readonly claimValue: string;
  /**
  * Service account slug mapped to the claim value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/oidc#service_account Oidc#service_account}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/oidc cloudsmith_oidc}
*/
export class Oidc extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Oidc that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/oidc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/oidc cloudsmith_oidc} Resource
  *
  * @param scope The scope in which to define this construct
