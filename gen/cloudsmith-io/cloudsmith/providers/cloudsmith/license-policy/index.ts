// https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/license_policy
...
export interface LicensePolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/license_policy#allow_unknown_licenses LicensePolicy#allow_unknown_licenses}
  */
  readonly allowUnknownLicenses?: boolean | cdktf.IResolvable;
  /**
  * The description of the license policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/license_policy#description LicensePolicy#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/license_policy#id LicensePolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/license_policy#name LicensePolicy#name}
  */
  readonly name: string;
  /**
  * On violation of the license policy, quarantine violating packages.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/license_policy#on_violation_quarantine LicensePolicy#on_violation_quarantine}
  */
  readonly onViolationQuarantine?: boolean | cdktf.IResolvable;
  /**
  * Organization to which this policy belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/license_policy#organization LicensePolicy#organization}
  */
  readonly organization: string;
  /**
  * A search / filter string of packages to include in the policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/license_policy#package_query_string LicensePolicy#package_query_string}
  */
  readonly packageQueryString?: string;
  /**
  * The licenses to deny.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/license_policy#spdx_identifiers LicensePolicy#spdx_identifiers}
  */
  readonly spdxIdentifiers: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/license_policy cloudsmith_license_policy}
*/
export class LicensePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LicensePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/license_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/license_policy cloudsmith_license_policy} Resource
  *
  * @param scope The scope in which to define this construct
