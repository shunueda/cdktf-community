// https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/namespace
...
export interface DataCloudsmithNamespaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/namespace#id DataCloudsmithNamespace#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/namespace#slug DataCloudsmithNamespace#slug}
  */
  readonly slug: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/namespace cloudsmith_namespace}
*/
export class DataCloudsmithNamespace extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudsmithNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/namespace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/namespace cloudsmith_namespace} Data Source
  *
  * @param scope The scope in which to define this construct
