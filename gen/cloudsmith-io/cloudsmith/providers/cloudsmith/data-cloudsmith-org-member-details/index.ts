// https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/org_member_details
...
export interface DataCloudsmithOrgMemberDetailsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/org_member_details#id DataCloudsmithOrgMemberDetails#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/org_member_details#member DataCloudsmithOrgMemberDetails#member}
  */
  readonly member: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/org_member_details#organization DataCloudsmithOrgMemberDetails#organization}
  */
  readonly organization: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/org_member_details cloudsmith_org_member_details}
*/
export class DataCloudsmithOrgMemberDetails extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudsmithOrgMemberDetails that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/org_member_details#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/org_member_details cloudsmith_org_member_details} Data Source
  *
  * @param scope The scope in which to define this construct
