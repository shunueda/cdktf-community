// https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream
...
export interface RepositoryUpstreamConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#auth_certificate RepositoryUpstream#auth_certificate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#auth_certificate_key RepositoryUpstream#auth_certificate_key}
  */
  readonly authCertificateKey?: string;
  /**
  * The authentication mode to use when accessing this upstream.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#auth_mode RepositoryUpstream#auth_mode}
  */
  readonly authMode?: string;
  /**
  * Secret to provide with requests to upstream.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#auth_secret RepositoryUpstream#auth_secret}
  */
  readonly authSecret?: string;
  /**
  * Username to provide with requests to upstream.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#auth_username RepositoryUpstream#auth_username}
  */
  readonly authUsername?: string;
  /**
  * (deb only) The component to fetch from the upstream.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#component RepositoryUpstream#component}
  */
  readonly component?: string;
  /**
  * (rpm only) The distribution version that packages found on this upstream will be associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#distro_version RepositoryUpstream#distro_version}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#distro_versions RepositoryUpstream#distro_versions}
  */
  readonly distroVersions?: string[];
  /**
  * The key for extra header #1 to send to upstream.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#extra_header_1 RepositoryUpstream#extra_header_1}
  */
  readonly extraHeader1?: string;
  /**
  * The key for extra header #2 to send to upstream.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#extra_header_2 RepositoryUpstream#extra_header_2}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#extra_value_1 RepositoryUpstream#extra_value_1}
  */
  readonly extraValue1?: string;
  /**
  * The value for extra header #2 to send to upstream. This is stored as plaintext, and is NOT encrypted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#extra_value_2 RepositoryUpstream#extra_value_2}
  */
  readonly extraValue2?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#id RepositoryUpstream#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#include_sources RepositoryUpstream#include_sources}
  */
  readonly includeSources?: boolean | cdktf.IResolvable;
  /**
  * Whether or not this upstream is active and ready for requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#is_active RepositoryUpstream#is_active}
  */
  readonly isActive?: boolean | cdktf.IResolvable;
  /**
  * The mode that this upstream should operate in. Upstream sources can be used to proxy resolved packages, as well as operate in a proxy/cache or cache only mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#mode RepositoryUpstream#mode}
  */
  readonly mode?: string;
  /**
  * A descriptive name for this upstream source. A shortened version of this name will be used for tagging cached packages retrieved from this upstream.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#name RepositoryUpstream#name}
  */
  readonly name: string;
  /**
  * The Organization to which the Upstream belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#namespace RepositoryUpstream#namespace}
  */
  readonly namespace: string;
  /**
  * Upstream sources are selected for resolving requests by sequential order (1..n), followed by creation date.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#priority RepositoryUpstream#priority}
  */
  readonly priority?: number;
  /**
  * The Repository to which the Upstream belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#repository RepositoryUpstream#repository}
  */
  readonly repository: string;
  /**
  * (deb only) The distribution to fetch from the upstream.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#upstream_distribution RepositoryUpstream#upstream_distribution}
  */
  readonly upstreamDistribution?: string;
  /**
  * The type of Upstream (docker, nuget, python, ...)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#upstream_type RepositoryUpstream#upstream_type}
  */
  readonly upstreamType: string;
  /**
  * The URL for this upstream source. This must be a fully qualified URL including any path elements required to reach the root of the repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#upstream_url RepositoryUpstream#upstream_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#verify_ssl RepositoryUpstream#verify_ssl}
  */
  readonly verifySsl?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream cloudsmith_repository_upstream}
*/
export class RepositoryUpstream extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RepositoryUpstream that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_upstream cloudsmith_repository_upstream} Resource
  *
  * @param scope The scope in which to define this construct
