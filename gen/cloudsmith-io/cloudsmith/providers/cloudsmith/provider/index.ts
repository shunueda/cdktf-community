// https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs
...
export interface CloudsmithProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs#api_host CloudsmithProvider#api_host}
  */
  readonly apiHost?: string;
  /**
  * The API key for authenticating with the Cloudsmith API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs#api_key CloudsmithProvider#api_key}
  */
  readonly apiKey: string;
  /**
  * Additional HTTP headers to include in API requests
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs#headers CloudsmithProvider#headers}
  */
  readonly headers?: { [key: string]: string };
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs#alias CloudsmithProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs cloudsmith}
*/
export class CloudsmithProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing CloudsmithProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs cloudsmith} Resource
  *
  * @param scope The scope in which to define this construct
