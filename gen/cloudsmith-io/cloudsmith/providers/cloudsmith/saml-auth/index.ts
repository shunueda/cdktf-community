// https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/saml_auth
...
export interface SamlAuthConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/saml_auth#id SamlAuth#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/saml_auth#organization SamlAuth#organization}
  */
  readonly organization: string;
  /**
  * Enable SAML authentication for the organization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/saml_auth#saml_auth_enabled SamlAuth#saml_auth_enabled}
  */
  readonly samlAuthEnabled: boolean | cdktf.IResolvable;
  /**
  * Enforce SAML authentication for the organization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/saml_auth#saml_auth_enforced SamlAuth#saml_auth_enforced}
  */
  readonly samlAuthEnforced: boolean | cdktf.IResolvable;
  /**
  * Inline SAML metadata XML
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/saml_auth#saml_metadata_inline SamlAuth#saml_metadata_inline}
  */
  readonly samlMetadataInline?: string;
  /**
  * URL to fetch SAML metadata
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/saml_auth#saml_metadata_url SamlAuth#saml_metadata_url}
  */
  readonly samlMetadataUrl?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/saml_auth cloudsmith_saml_auth}
*/
export class SamlAuth extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SamlAuth that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/saml_auth#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/saml_auth cloudsmith_saml_auth} Resource
  *
  * @param scope The scope in which to define this construct
