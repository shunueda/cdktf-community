// https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_geo_ip_rules
...
export interface RepositoryGeoIpRulesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_geo_ip_rules#cidr_allow RepositoryGeoIpRules#cidr_allow}
  */
  readonly cidrAllow?: string[];
  /**
  * The list of IP Addresses for which to deny access, expressed in CIDR notation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_geo_ip_rules#cidr_deny RepositoryGeoIpRules#cidr_deny}
  */
  readonly cidrDeny?: string[];
  /**
  * The list of countries for which to allow access, expressed in ISO 3166-1 country codes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_geo_ip_rules#country_code_allow RepositoryGeoIpRules#country_code_allow}
  */
  readonly countryCodeAllow?: string[];
  /**
  * The list of countries for which to deny access, expressed in ISO 3166-1 country codes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_geo_ip_rules#country_code_deny RepositoryGeoIpRules#country_code_deny}
  */
  readonly countryCodeDeny?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_geo_ip_rules#id RepositoryGeoIpRules#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_geo_ip_rules#namespace RepositoryGeoIpRules#namespace}
  */
  readonly namespace: string;
  /**
  * Repository to which these Geo/IP rules belong.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_geo_ip_rules#repository RepositoryGeoIpRules#repository}
  */
  readonly repository: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_geo_ip_rules cloudsmith_repository_geo_ip_rules}
*/
export class RepositoryGeoIpRules extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RepositoryGeoIpRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_geo_ip_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_geo_ip_rules cloudsmith_repository_geo_ip_rules} Resource
  *
  * @param scope The scope in which to define this construct
