// https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_retention_rule
...
export interface RepositoryRetentionRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_retention_rule#id RepositoryRetentionRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_retention_rule#namespace RepositoryRetentionRule#namespace}
  */
  readonly namespace: string;
  /**
  * The name of the repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_retention_rule#repository RepositoryRetentionRule#repository}
  */
  readonly repository: string;
  /**
  * The maximum number of packages to retain. Must be between 0 and 10000.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_retention_rule#retention_count_limit RepositoryRetentionRule#retention_count_limit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_retention_rule#retention_days_limit RepositoryRetentionRule#retention_days_limit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_retention_rule#retention_enabled RepositoryRetentionRule#retention_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_retention_rule#retention_group_by_format RepositoryRetentionRule#retention_group_by_format}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_retention_rule#retention_group_by_name RepositoryRetentionRule#retention_group_by_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_retention_rule#retention_group_by_package_type RepositoryRetentionRule#retention_group_by_package_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_retention_rule#retention_package_query_string RepositoryRetentionRule#retention_package_query_string}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_retention_rule#retention_size_limit RepositoryRetentionRule#retention_size_limit}
  */
  readonly retentionSizeLimit?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_retention_rule cloudsmith_repository_retention_rule}
*/
export class RepositoryRetentionRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RepositoryRetentionRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_retention_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/resources/repository_retention_rule cloudsmith_repository_retention_rule} Resource
  *
  * @param scope The scope in which to define this construct
