// https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/package
...
export interface DataCloudsmithPackageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/package#download DataCloudsmithPackage#download}
  */
  readonly download?: boolean | cdktf.IResolvable;
  /**
  * The directory where the file will be downloaded if download is set to true
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/package#download_dir DataCloudsmithPackage#download_dir}
  */
  readonly downloadDir?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/package#id DataCloudsmithPackage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/package#identifier DataCloudsmithPackage#identifier}
  */
  readonly identifier: string;
  /**
  * Ignore checksums for the package
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/package#ignore_checksums DataCloudsmithPackage#ignore_checksums}
  */
  readonly ignoreChecksums?: boolean | cdktf.IResolvable;
  /**
  * The namespace of the package
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/package#namespace DataCloudsmithPackage#namespace}
  */
  readonly namespace: string;
  /**
  * The repository of the package
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/package#repository DataCloudsmithPackage#repository}
  */
  readonly repository: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/package cloudsmith_package}
*/
export class DataCloudsmithPackage extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudsmithPackage that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/package#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudsmith-io/cloudsmith/0.0.65/docs/data-sources/package cloudsmith_package} Data Source
  *
  * @param scope The scope in which to define this construct
