// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_jwt
...
export interface OrgIdpJwtConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_jwt#auto_register OrgIdpJwt#auto_register}
  */
  readonly autoRegister: boolean | cdktf.IResolvable;
  /**
  * the name of the header where the JWT is sent in, default is authorization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_jwt#header_name OrgIdpJwt#header_name}
  */
  readonly headerName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_jwt#id OrgIdpJwt#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_jwt#issuer OrgIdpJwt#issuer}
  */
  readonly issuer: string;
  /**
  * the endpoint where the jwt can be extracted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_jwt#jwt_endpoint OrgIdpJwt#jwt_endpoint}
  */
  readonly jwtEndpoint: string;
  /**
  * the endpoint to the key (JWK) which are used to sign the JWT with
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_jwt#keys_endpoint OrgIdpJwt#keys_endpoint}
  */
  readonly keysEndpoint: string;
  /**
  * Name of the IDP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_jwt#name OrgIdpJwt#name}
  */
  readonly name: string;
  /**
  * ID of the organization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_jwt#org_id OrgIdpJwt#org_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_jwt#styling_type OrgIdpJwt#styling_type}
  */
  readonly stylingType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_jwt zitadel_org_idp_jwt}
*/
export class OrgIdpJwt extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgIdpJwt that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_jwt#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_jwt zitadel_org_idp_jwt} Resource
  *
  * @param scope The scope in which to define this construct
