// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/idp_github_es
...
export interface IdpGithubEsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/idp_github_es#authorization_endpoint IdpGithubEs#authorization_endpoint}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/idp_github_es#auto_linking IdpGithubEs#auto_linking}
  */
  readonly autoLinking?: string;
  /**
  * client id generated by the identity provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/idp_github_es#client_id IdpGithubEs#client_id}
  */
  readonly clientId: string;
  /**
  * client secret generated by the identity provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/idp_github_es#client_secret IdpGithubEs#client_secret}
  */
  readonly clientSecret: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/idp_github_es#id IdpGithubEs#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/idp_github_es#is_auto_creation IdpGithubEs#is_auto_creation}
  */
  readonly isAutoCreation: boolean | cdktf.IResolvable;
  /**
  * enable if a the ZITADEL account fields should be updated automatically on each login
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/idp_github_es#is_auto_update IdpGithubEs#is_auto_update}
  */
  readonly isAutoUpdate: boolean | cdktf.IResolvable;
  /**
  * enable if users should be able to create a new account in ZITADEL when using an external account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/idp_github_es#is_creation_allowed IdpGithubEs#is_creation_allowed}
  */
  readonly isCreationAllowed: boolean | cdktf.IResolvable;
  /**
  * enable if users should be able to link an existing ZITADEL user with an external account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/idp_github_es#is_linking_allowed IdpGithubEs#is_linking_allowed}
  */
  readonly isLinkingAllowed: boolean | cdktf.IResolvable;
  /**
  * Name of the IDP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/idp_github_es#name IdpGithubEs#name}
  */
  readonly name?: string;
  /**
  * the scopes requested by ZITADEL during the request on the identity provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/idp_github_es#scopes IdpGithubEs#scopes}
  */
  readonly scopes?: string[];
  /**
  * the providers token endpoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/idp_github_es#token_endpoint IdpGithubEs#token_endpoint}
  */
  readonly tokenEndpoint: string;
  /**
  * the providers user endpoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/idp_github_es#user_endpoint IdpGithubEs#user_endpoint}
  */
  readonly userEndpoint: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/idp_github_es zitadel_idp_github_es}
*/
export class IdpGithubEs extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdpGithubEs that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/idp_github_es#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/idp_github_es zitadel_idp_github_es} Resource
  *
  * @param scope The scope in which to define this construct
