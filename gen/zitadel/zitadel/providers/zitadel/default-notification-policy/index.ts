// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_notification_policy
...
export interface DefaultNotificationPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_notification_policy#id DefaultNotificationPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_notification_policy#password_change DefaultNotificationPolicy#password_change}
  */
  readonly passwordChange: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_notification_policy zitadel_default_notification_policy}
*/
export class DefaultNotificationPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DefaultNotificationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_notification_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_notification_policy zitadel_default_notification_policy} Resource
  *
  * @param scope The scope in which to define this construct
