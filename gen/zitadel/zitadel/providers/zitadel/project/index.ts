// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project
...
export interface ProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project#has_project_check Project#has_project_check}
  */
  readonly hasProjectCheck?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project#id Project#id}
  *
  ...
  * Name of the project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project#name Project#name}
  */
  readonly name: string;
  /**
  * ID of the organization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project#org_id Project#org_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project#private_labeling_setting Project#private_labeling_setting}
  */
  readonly privateLabelingSetting?: string;
  /**
  * describes if roles of user should be added in token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project#project_role_assertion Project#project_role_assertion}
  */
  readonly projectRoleAssertion?: boolean | cdktf.IResolvable;
  /**
  * ZITADEL checks if the user has at least one on this project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project#project_role_check Project#project_role_check}
  */
  readonly projectRoleCheck?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project zitadel_project}
*/
export class Project extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Project that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project zitadel_project} Resource
  *
  * @param scope The scope in which to define this construct
