// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_saml
...
export interface OrgIdpSamlConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_saml#auto_linking OrgIdpSaml#auto_linking}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_saml#binding OrgIdpSaml#binding}
  */
  readonly binding?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_saml#id OrgIdpSaml#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_saml#is_auto_creation OrgIdpSaml#is_auto_creation}
  */
  readonly isAutoCreation: boolean | cdktf.IResolvable;
  /**
  * enable if a the ZITADEL account fields should be updated automatically on each login
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_saml#is_auto_update OrgIdpSaml#is_auto_update}
  */
  readonly isAutoUpdate: boolean | cdktf.IResolvable;
  /**
  * enable if users should be able to create a new account in ZITADEL when using an external account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_saml#is_creation_allowed OrgIdpSaml#is_creation_allowed}
  */
  readonly isCreationAllowed: boolean | cdktf.IResolvable;
  /**
  * enable if users should be able to link an existing ZITADEL user with an external account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_saml#is_linking_allowed OrgIdpSaml#is_linking_allowed}
  */
  readonly isLinkingAllowed: boolean | cdktf.IResolvable;
  /**
  * The metadata XML as plain string
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_saml#metadata_xml OrgIdpSaml#metadata_xml}
  */
  readonly metadataXml: string;
  /**
  * Name of the IDP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_saml#name OrgIdpSaml#name}
  */
  readonly name?: string;
  /**
  * ID of the organization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_saml#org_id OrgIdpSaml#org_id}
  */
  readonly orgId?: string;
  /**
  * Whether the SAML IDP requires signed requests
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_saml#with_signed_request OrgIdpSaml#with_signed_request}
  */
  readonly withSignedRequest?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_saml zitadel_org_idp_saml}
*/
export class OrgIdpSaml extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgIdpSaml that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_saml#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/org_idp_saml zitadel_org_idp_saml} Resource
  *
  * @param scope The scope in which to define this construct
