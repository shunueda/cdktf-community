// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/sms_provider_http
...
export interface SmsProviderHttpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/sms_provider_http#description SmsProviderHttp#description}
  */
  readonly description?: string;
  /**
  * Http endpoint which is used to send the SMS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/sms_provider_http#endpoint SmsProviderHttp#endpoint}
  */
  readonly endpoint: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/sms_provider_http#id SmsProviderHttp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/sms_provider_http#set_active SmsProviderHttp#set_active}
  */
  readonly setActive?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/sms_provider_http zitadel_sms_provider_http}
*/
export class SmsProviderHttp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SmsProviderHttp that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/sms_provider_http#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/sms_provider_http zitadel_sms_provider_http} Resource
  *
  * @param scope The scope in which to define this construct
