// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_password_age_policy
...
export interface DefaultPasswordAgePolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_password_age_policy#expire_warn_days DefaultPasswordAgePolicy#expire_warn_days}
  */
  readonly expireWarnDays: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_password_age_policy#id DefaultPasswordAgePolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_password_age_policy#max_age_days DefaultPasswordAgePolicy#max_age_days}
  */
  readonly maxAgeDays: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_password_age_policy zitadel_default_password_age_policy}
*/
export class DefaultPasswordAgePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DefaultPasswordAgePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_password_age_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_password_age_policy zitadel_default_password_age_policy} Resource
  *
  * @param scope The scope in which to define this construct
