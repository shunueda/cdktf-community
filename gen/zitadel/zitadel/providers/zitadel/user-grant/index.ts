// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/user_grant
...
export interface UserGrantConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/user_grant#id UserGrant#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/user_grant#org_id UserGrant#org_id}
  */
  readonly orgId?: string;
  /**
  * ID of the granted project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/user_grant#project_grant_id UserGrant#project_grant_id}
  */
  readonly projectGrantId?: string;
  /**
  * ID of the project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/user_grant#project_id UserGrant#project_id}
  */
  readonly projectId?: string;
  /**
  * List of roles granted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/user_grant#role_keys UserGrant#role_keys}
  */
  readonly roleKeys?: string[];
  /**
  * ID of the user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/user_grant#user_id UserGrant#user_id}
  */
  readonly userId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/user_grant zitadel_user_grant}
*/
export class UserGrant extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserGrant that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/user_grant#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/user_grant zitadel_user_grant} Resource
  *
  * @param scope The scope in which to define this construct
