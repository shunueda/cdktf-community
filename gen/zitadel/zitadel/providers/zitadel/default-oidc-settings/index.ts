// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_oidc_settings
...
export interface DefaultOidcSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_oidc_settings#access_token_lifetime DefaultOidcSettings#access_token_lifetime}
  */
  readonly accessTokenLifetime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_oidc_settings#id DefaultOidcSettings#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_oidc_settings#id_token_lifetime DefaultOidcSettings#id_token_lifetime}
  */
  readonly idTokenLifetime: string;
  /**
  * expiration duration of refresh tokens
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_oidc_settings#refresh_token_expiration DefaultOidcSettings#refresh_token_expiration}
  */
  readonly refreshTokenExpiration: string;
  /**
  * expiration duration of idle refresh tokens
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_oidc_settings#refresh_token_idle_expiration DefaultOidcSettings#refresh_token_idle_expiration}
  */
  readonly refreshTokenIdleExpiration: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_oidc_settings zitadel_default_oidc_settings}
*/
export class DefaultOidcSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DefaultOidcSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_oidc_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_oidc_settings zitadel_default_oidc_settings} Resource
  *
  * @param scope The scope in which to define this construct
