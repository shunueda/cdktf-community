// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_azure_ad
...
export interface DataZitadelIdpAzureAdConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_azure_ad#id DataZitadelIdpAzureAd#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_azure_ad zitadel_idp_azure_ad}
*/
export class DataZitadelIdpAzureAd extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZitadelIdpAzureAd that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_azure_ad#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_azure_ad zitadel_idp_azure_ad} Data Source
  *
  * @param scope The scope in which to define this construct
