// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/lockout_policy
...
export interface LockoutPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/lockout_policy#id LockoutPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/lockout_policy#max_password_attempts LockoutPolicy#max_password_attempts}
  */
  readonly maxPasswordAttempts: number;
  /**
  * ID of the organization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/lockout_policy#org_id LockoutPolicy#org_id}
  */
  readonly orgId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/lockout_policy zitadel_lockout_policy}
*/
export class LockoutPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LockoutPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/lockout_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/lockout_policy zitadel_lockout_policy} Resource
  *
  * @param scope The scope in which to define this construct
