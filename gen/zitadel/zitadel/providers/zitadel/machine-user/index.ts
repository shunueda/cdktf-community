// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/machine_user
...
export interface MachineUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/machine_user#access_token_type MachineUser#access_token_type}
  */
  readonly accessTokenType?: string;
  /**
  * Description of the user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/machine_user#description MachineUser#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/machine_user#id MachineUser#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/machine_user#name MachineUser#name}
  */
  readonly name: string;
  /**
  * ID of the organization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/machine_user#org_id MachineUser#org_id}
  */
  readonly orgId?: string;
  /**
  * Username
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/machine_user#user_name MachineUser#user_name}
  */
  readonly userName: string;
  /**
  * Generate machine secret, only applicable if creation or change from false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/machine_user#with_secret MachineUser#with_secret}
  */
  readonly withSecret?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/machine_user zitadel_machine_user}
*/
export class MachineUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MachineUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/machine_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/machine_user zitadel_machine_user} Resource
  *
  * @param scope The scope in which to define this construct
