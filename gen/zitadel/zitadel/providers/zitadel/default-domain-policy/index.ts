// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_domain_policy
...
export interface DefaultDomainPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_domain_policy#id DefaultDomainPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_domain_policy#smtp_sender_address_matches_instance_domain DefaultDomainPolicy#smtp_sender_address_matches_instance_domain}
  */
  readonly smtpSenderAddressMatchesInstanceDomain: boolean | cdktf.IResolvable;
  /**
  * User login must be domain
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_domain_policy#user_login_must_be_domain DefaultDomainPolicy#user_login_must_be_domain}
  */
  readonly userLoginMustBeDomain: boolean | cdktf.IResolvable;
  /**
  * Validate organization domains
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_domain_policy#validate_org_domains DefaultDomainPolicy#validate_org_domains}
  */
  readonly validateOrgDomains: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_domain_policy zitadel_default_domain_policy}
*/
export class DefaultDomainPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DefaultDomainPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_domain_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_domain_policy zitadel_default_domain_policy} Resource
  *
  * @param scope The scope in which to define this construct
