// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_github_es
...
export interface DataZitadelIdpGithubEsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_github_es#id DataZitadelIdpGithubEs#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_github_es zitadel_idp_github_es}
*/
export class DataZitadelIdpGithubEs extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZitadelIdpGithubEs that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_github_es#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_github_es zitadel_idp_github_es} Data Source
  *
  * @param scope The scope in which to define this construct
