// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_ldap
...
export interface DataZitadelIdpLdapConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_ldap#id DataZitadelIdpLdap#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_ldap zitadel_idp_ldap}
*/
export class DataZitadelIdpLdap extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZitadelIdpLdap that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_ldap#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_ldap zitadel_idp_ldap} Data Source
  *
  * @param scope The scope in which to define this construct
