// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project_grant
...
export interface ProjectGrantConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project_grant#granted_org_id ProjectGrant#granted_org_id}
  */
  readonly grantedOrgId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project_grant#id ProjectGrant#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project_grant#org_id ProjectGrant#org_id}
  */
  readonly orgId?: string;
  /**
  * ID of the project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project_grant#project_id ProjectGrant#project_id}
  */
  readonly projectId: string;
  /**
  * List of roles granted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project_grant#role_keys ProjectGrant#role_keys}
  */
  readonly roleKeys?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project_grant zitadel_project_grant}
*/
export class ProjectGrant extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectGrant that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project_grant#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/project_grant zitadel_project_grant} Resource
  *
  * @param scope The scope in which to define this construct
