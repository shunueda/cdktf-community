// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user
...
export interface HumanUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user#display_name HumanUser#display_name}
  */
  readonly displayName?: string;
  /**
  * Email of the user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user#email HumanUser#email}
  */
  readonly email: string;
  /**
  * First name of the user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user#first_name HumanUser#first_name}
  */
  readonly firstName: string;
  /**
  * Gender of the user, supported values: GENDER_UNSPECIFIED, GENDER_FEMALE, GENDER_MALE, GENDER_DIVERSE
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user#gender HumanUser#gender}
  */
  readonly gender?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user#id HumanUser#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user#initial_hashed_password HumanUser#initial_hashed_password}
  */
  readonly initialHashedPassword?: string;
  /**
  * Initially set password for the user, not changeable after creation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user#initial_password HumanUser#initial_password}
  */
  readonly initialPassword?: string;
  /**
  * Whether the user has to change the password on first login.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user#initial_skip_password_change HumanUser#initial_skip_password_change}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user#is_email_verified HumanUser#is_email_verified}
  */
  readonly isEmailVerified?: boolean | cdktf.IResolvable;
  /**
  * Is the phone verified of the user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user#is_phone_verified HumanUser#is_phone_verified}
  */
  readonly isPhoneVerified?: boolean | cdktf.IResolvable;
  /**
  * Last name of the user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user#last_name HumanUser#last_name}
  */
  readonly lastName: string;
  /**
  * Nick name of the user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user#nick_name HumanUser#nick_name}
  */
  readonly nickName?: string;
  /**
  * ID of the organization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user#org_id HumanUser#org_id}
  */
  readonly orgId?: string;
  /**
  * Phone of the user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user#phone HumanUser#phone}
  */
  readonly phone?: string;
  /**
  * Preferred language of the user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user#preferred_language HumanUser#preferred_language}
  */
  readonly preferredLanguage?: string;
  /**
  * Username
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user#user_name HumanUser#user_name}
  */
  readonly userName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user zitadel_human_user}
*/
export class HumanUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HumanUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/human_user zitadel_human_user} Resource
  *
  * @param scope The scope in which to define this construct
