// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc
...
export interface ApplicationOidcConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#access_token_role_assertion ApplicationOidc#access_token_role_assertion}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#access_token_type ApplicationOidc#access_token_type}
  */
  readonly accessTokenType?: string;
  /**
  * Additional origins
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#additional_origins ApplicationOidc#additional_origins}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#app_type ApplicationOidc#app_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#auth_method_type ApplicationOidc#auth_method_type}
  */
  readonly authMethodType?: string;
  /**
  * Clockskew
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#clock_skew ApplicationOidc#clock_skew}
  */
  readonly clockSkew?: string;
  /**
  * Dev mode
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#dev_mode ApplicationOidc#dev_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#grant_types ApplicationOidc#grant_types}
  */
  readonly grantTypes: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#id ApplicationOidc#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#id_token_role_assertion ApplicationOidc#id_token_role_assertion}
  */
  readonly idTokenRoleAssertion?: boolean | cdktf.IResolvable;
  /**
  * Token userinfo assertion
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#id_token_userinfo_assertion ApplicationOidc#id_token_userinfo_assertion}
  */
  readonly idTokenUserinfoAssertion?: boolean | cdktf.IResolvable;
  /**
  * Name of the application
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#name ApplicationOidc#name}
  */
  readonly name: string;
  /**
  * ID of the organization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#org_id ApplicationOidc#org_id}
  */
  readonly orgId?: string;
  /**
  * Post logout redirect URIs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#post_logout_redirect_uris ApplicationOidc#post_logout_redirect_uris}
  */
  readonly postLogoutRedirectUris?: string[];
  /**
  * ID of the project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#project_id ApplicationOidc#project_id}
  */
  readonly projectId: string;
  /**
  * RedirectURIs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#redirect_uris ApplicationOidc#redirect_uris}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#response_types ApplicationOidc#response_types}
  */
  readonly responseTypes: string[];
  /**
  * Skip the successful login page on native apps and directly redirect the user to the callback.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#skip_native_app_success_page ApplicationOidc#skip_native_app_success_page}
  */
  readonly skipNativeAppSuccessPage?: boolean | cdktf.IResolvable;
  /**
  * Version, supported values: OIDC_VERSION_1_0
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#version ApplicationOidc#version}
  */
  readonly version?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc zitadel_application_oidc}
*/
export class ApplicationOidc extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationOidc that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/application_oidc zitadel_application_oidc} Resource
  *
  * @param scope The scope in which to define this construct
