// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_password_complexity_policy
...
export interface DefaultPasswordComplexityPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_password_complexity_policy#has_lowercase DefaultPasswordComplexityPolicy#has_lowercase}
  */
  readonly hasLowercase: boolean | cdktf.IResolvable;
  /**
  * defines if the password MUST contain a number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_password_complexity_policy#has_number DefaultPasswordComplexityPolicy#has_number}
  */
  readonly hasNumber: boolean | cdktf.IResolvable;
  /**
  * defines if the password MUST contain a symbol. E.g. "$"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_password_complexity_policy#has_symbol DefaultPasswordComplexityPolicy#has_symbol}
  */
  readonly hasSymbol: boolean | cdktf.IResolvable;
  /**
  * defines if the password MUST contain an upper case letter
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_password_complexity_policy#has_uppercase DefaultPasswordComplexityPolicy#has_uppercase}
  */
  readonly hasUppercase: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_password_complexity_policy#id DefaultPasswordComplexityPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_password_complexity_policy#min_length DefaultPasswordComplexityPolicy#min_length}
  */
  readonly minLength: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_password_complexity_policy zitadel_default_password_complexity_policy}
*/
export class DefaultPasswordComplexityPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DefaultPasswordComplexityPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_password_complexity_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_password_complexity_policy zitadel_default_password_complexity_policy} Resource
  *
  * @param scope The scope in which to define this construct
