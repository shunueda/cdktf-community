// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_gitlab
...
export interface DataZitadelIdpGitlabConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_gitlab#id DataZitadelIdpGitlab#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_gitlab zitadel_idp_gitlab}
*/
export class DataZitadelIdpGitlab extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZitadelIdpGitlab that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_gitlab#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/idp_gitlab zitadel_idp_gitlab} Data Source
  *
  * @param scope The scope in which to define this construct
