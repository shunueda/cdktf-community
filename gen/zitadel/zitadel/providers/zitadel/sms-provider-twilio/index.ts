// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/sms_provider_twilio
...
export interface SmsProviderTwilioConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/sms_provider_twilio#id SmsProviderTwilio#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/sms_provider_twilio#sender_number SmsProviderTwilio#sender_number}
  */
  readonly senderNumber: string;
  /**
  * Set the SMS provider as active after creating/updating.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/sms_provider_twilio#set_active SmsProviderTwilio#set_active}
  */
  readonly setActive?: boolean | cdktf.IResolvable;
  /**
  * SID used to communicate with Twilio.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/sms_provider_twilio#sid SmsProviderTwilio#sid}
  */
  readonly sid: string;
  /**
  * Token used to communicate with Twilio.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/sms_provider_twilio#token SmsProviderTwilio#token}
  */
  readonly token: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/sms_provider_twilio zitadel_sms_provider_twilio}
*/
export class SmsProviderTwilio extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SmsProviderTwilio that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/sms_provider_twilio#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/sms_provider_twilio zitadel_sms_provider_twilio} Resource
  *
  * @param scope The scope in which to define this construct
