// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_lockout_policy
...
export interface DefaultLockoutPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_lockout_policy#id DefaultLockoutPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_lockout_policy#max_password_attempts DefaultLockoutPolicy#max_password_attempts}
  */
  readonly maxPasswordAttempts: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_lockout_policy zitadel_default_lockout_policy}
*/
export class DefaultLockoutPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DefaultLockoutPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_lockout_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_lockout_policy zitadel_default_lockout_policy} Resource
  *
  * @param scope The scope in which to define this construct
