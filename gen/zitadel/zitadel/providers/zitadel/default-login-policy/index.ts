// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy
...
export interface DefaultLoginPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#allow_domain_discovery DefaultLoginPolicy#allow_domain_discovery}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#allow_external_idp DefaultLoginPolicy#allow_external_idp}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#allow_register DefaultLoginPolicy#allow_register}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#default_redirect_uri DefaultLoginPolicy#default_redirect_uri}
  */
  readonly defaultRedirectUri: string;
  /**
  * defines if user can additionally (to the loginname) be identified by their verified email address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#disable_login_with_email DefaultLoginPolicy#disable_login_with_email}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#disable_login_with_phone DefaultLoginPolicy#disable_login_with_phone}
  */
  readonly disableLoginWithPhone?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#external_login_check_lifetime DefaultLoginPolicy#external_login_check_lifetime}
  */
  readonly externalLoginCheckLifetime: string;
  /**
  * defines if a user MUST use a multi factor to log in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#force_mfa DefaultLoginPolicy#force_mfa}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#force_mfa_local_only DefaultLoginPolicy#force_mfa_local_only}
  */
  readonly forceMfaLocalOnly: boolean | cdktf.IResolvable;
  /**
  * defines if password reset link should be shown in the login screen
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#hide_password_reset DefaultLoginPolicy#hide_password_reset}
  */
  readonly hidePasswordReset: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#id DefaultLoginPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#idps DefaultLoginPolicy#idps}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#ignore_unknown_usernames DefaultLoginPolicy#ignore_unknown_usernames}
  */
  readonly ignoreUnknownUsernames: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#mfa_init_skip_lifetime DefaultLoginPolicy#mfa_init_skip_lifetime}
  */
  readonly mfaInitSkipLifetime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#multi_factor_check_lifetime DefaultLoginPolicy#multi_factor_check_lifetime}
  */
  readonly multiFactorCheckLifetime: string;
  /**
  * allowed multi factors
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#multi_factors DefaultLoginPolicy#multi_factors}
  */
  readonly multiFactors?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#password_check_lifetime DefaultLoginPolicy#password_check_lifetime}
  */
  readonly passwordCheckLifetime: string;
  /**
  * defines if passwordless is allowed for users
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#passwordless_type DefaultLoginPolicy#passwordless_type}
  */
  readonly passwordlessType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#second_factor_check_lifetime DefaultLoginPolicy#second_factor_check_lifetime}
  */
  readonly secondFactorCheckLifetime: string;
  /**
  * allowed second factors
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#second_factors DefaultLoginPolicy#second_factors}
  */
  readonly secondFactors?: string[];
  /**
  * defines if a user is allowed to login with his username and password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#user_login DefaultLoginPolicy#user_login}
  */
  readonly userLogin: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy zitadel_default_login_policy}
*/
export class DefaultLoginPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DefaultLoginPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/default_login_policy zitadel_default_login_policy} Resource
  *
  * @param scope The scope in which to define this construct
