// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/smtp_config
...
export interface SmtpConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/smtp_config#host SmtpConfig#host}
  */
  readonly host: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/smtp_config#id SmtpConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/smtp_config#password SmtpConfig#password}
  */
  readonly password?: string;
  /**
  * Address to reply to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/smtp_config#reply_to_address SmtpConfig#reply_to_address}
  */
  readonly replyToAddress?: string;
  /**
  * Address used to send emails.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/smtp_config#sender_address SmtpConfig#sender_address}
  */
  readonly senderAddress: string;
  /**
  * Sender name used to send emails.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/smtp_config#sender_name SmtpConfig#sender_name}
  */
  readonly senderName: string;
  /**
  * Set the SMTP configuration active after creating/updating.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/smtp_config#set_active SmtpConfig#set_active}
  */
  readonly setActive?: boolean | cdktf.IResolvable;
  /**
  * TLS used to communicate with your SMTP server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/smtp_config#tls SmtpConfig#tls}
  */
  readonly tls?: boolean | cdktf.IResolvable;
  /**
  * User used to communicate with your SMTP server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/smtp_config#user SmtpConfig#user}
  */
  readonly user?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/smtp_config zitadel_smtp_config}
*/
export class SmtpConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SmtpConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/smtp_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/resources/smtp_config zitadel_smtp_config} Resource
  *
  * @param scope The scope in which to define this construct
