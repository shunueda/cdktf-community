// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/org_jwt_idp
...
export interface DataZitadelOrgJwtIdpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/org_jwt_idp#id DataZitadelOrgJwtIdp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/org_jwt_idp#idp_id DataZitadelOrgJwtIdp#idp_id}
  */
  readonly idpId: string;
  /**
  * ID of the organization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/org_jwt_idp#org_id DataZitadelOrgJwtIdp#org_id}
  */
  readonly orgId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/org_jwt_idp zitadel_org_jwt_idp}
*/
export class DataZitadelOrgJwtIdp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZitadelOrgJwtIdp that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/org_jwt_idp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs/data-sources/org_jwt_idp zitadel_org_jwt_idp} Data Source
  *
  * @param scope The scope in which to define this construct
