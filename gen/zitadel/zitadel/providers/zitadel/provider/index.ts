// https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs
...
export interface ZitadelProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs#domain ZitadelProvider#domain}
  */
  readonly domain: string;
  /**
  * Use insecure connection
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs#insecure ZitadelProvider#insecure}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs#jwt_file ZitadelProvider#jwt_file}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs#jwt_profile_file ZitadelProvider#jwt_profile_file}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs#jwt_profile_json ZitadelProvider#jwt_profile_json}
  */
  readonly jwtProfileJson?: string;
  /**
  * Used port if not the default ports 80 or 443 are configured
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs#port ZitadelProvider#port}
  */
  readonly port?: string;
  /**
  * Path to the file containing credentials to connect to ZITADEL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs#token ZitadelProvider#token}
  */
  readonly token?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs#alias ZitadelProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs zitadel}
*/
export class ZitadelProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing ZitadelProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.2.0/docs zitadel} Resource
  *
  * @param scope The scope in which to define this construct
