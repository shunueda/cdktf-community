// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input
...
export interface DbaasLogsInputConfig extends cdktf.TerraformMetaArguments {
  ...
  * IP blocks
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#allowed_networks DbaasLogsInput#allowed_networks}
  */
  readonly allowedNetworks?: string[];
  /**
  * Whether the workload is auto-scaled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#autoscale DbaasLogsInput#autoscale}
  */
  readonly autoscale?: boolean | cdktf.IResolvable;
  /**
  * Input description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#description DbaasLogsInput#description}
  */
  readonly description: string;
  /**
  * Input engine ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#engine_id DbaasLogsInput#engine_id}
  */
  readonly engineId: string;
  /**
  * Port
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#exposed_port DbaasLogsInput#exposed_port}
  */
  readonly exposedPort?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#id DbaasLogsInput#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#max_scale_instance DbaasLogsInput#max_scale_instance}
  */
  readonly maxScaleInstance?: number;
  /**
  * Minimum number of instances in auto-scaled mode
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#min_scale_instance DbaasLogsInput#min_scale_instance}
  */
  readonly minScaleInstance?: number;
  /**
  * Number of instance running
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#nb_instance DbaasLogsInput#nb_instance}
  */
  readonly nbInstance?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#service_name DbaasLogsInput#service_name}
  */
  readonly serviceName: string;
  /**
  * Associated Graylog stream
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#stream_id DbaasLogsInput#stream_id}
  */
  readonly streamId: string;
  /**
  * Input title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#title DbaasLogsInput#title}
  */
  readonly title: string;
  /**
  * configuration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#configuration DbaasLogsInput#configuration}
  */
...
export interface DbaasLogsInputConfigurationFlowgger {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#log_format DbaasLogsInput#log_format}
  */
  readonly logFormat: string;
  /**
  * Indicates how messages are delimited
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#log_framing DbaasLogsInput#log_framing}
  */
...
export interface DbaasLogsInputConfigurationLogstash {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#filter_section DbaasLogsInput#filter_section}
  */
  readonly filterSection?: string;
  /**
  * The filter section of logstash.conf
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#input_section DbaasLogsInput#input_section}
  */
  readonly inputSection: string;
  /**
  * The list of customs Grok patterns
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#pattern_section DbaasLogsInput#pattern_section}
  */
...
export interface DbaasLogsInputConfiguration {
  ...
  * flowgger block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#flowgger DbaasLogsInput#flowgger}
  */
  readonly flowgger?: DbaasLogsInputConfigurationFlowgger;
  /**
  * logstash block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#logstash DbaasLogsInput#logstash}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input ovh_dbaas_logs_input}
*/
export class DbaasLogsInput extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbaasLogsInput that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_input ovh_dbaas_logs_input} Resource
  *
  * @param scope The scope in which to define this construct
