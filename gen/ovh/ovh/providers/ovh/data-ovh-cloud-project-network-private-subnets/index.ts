// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/cloud_project_network_private_subnets
...
export interface DataOvhCloudProjectNetworkPrivateSubnetsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/cloud_project_network_private_subnets#network_id DataOvhCloudProjectNetworkPrivateSubnets#network_id}
  */
  readonly networkId: string;
  /**
  * Service name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/cloud_project_network_private_subnets#service_name DataOvhCloudProjectNetworkPrivateSubnets#service_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/cloud_project_network_private_subnets ovh_cloud_project_network_private_subnets}
*/
export class DataOvhCloudProjectNetworkPrivateSubnets extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhCloudProjectNetworkPrivateSubnets that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/cloud_project_network_private_subnets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/cloud_project_network_private_subnets ovh_cloud_project_network_private_subnets} Data Source
  *
  * @param scope The scope in which to define this construct
