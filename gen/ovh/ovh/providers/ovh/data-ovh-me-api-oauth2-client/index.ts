// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/me_api_oauth2_client
...
export interface DataOvhMeApiOauth2ClientConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/me_api_oauth2_client#client_id DataOvhMeApiOauth2Client#client_id}
  */
  readonly clientId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/me_api_oauth2_client#id DataOvhMeApiOauth2Client#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/me_api_oauth2_client ovh_me_api_oauth2_client}
*/
export class DataOvhMeApiOauth2Client extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhMeApiOauth2Client that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/me_api_oauth2_client#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/me_api_oauth2_client ovh_me_api_oauth2_client} Data Source
  *
  * @param scope The scope in which to define this construct
