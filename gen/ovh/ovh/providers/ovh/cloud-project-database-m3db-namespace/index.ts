// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace
...
export interface CloudProjectDatabaseM3DbNamespaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace#cluster_id CloudProjectDatabaseM3DbNamespace#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace#id CloudProjectDatabaseM3DbNamespace#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace#name CloudProjectDatabaseM3DbNamespace#name}
  */
  readonly name: string;
  /**
  * Resolution for an aggregated namespace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace#resolution CloudProjectDatabaseM3DbNamespace#resolution}
  */
  readonly resolution: string;
  /**
  * Controls how long we wait before expiring stale data
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace#retention_block_data_expiration_duration CloudProjectDatabaseM3DbNamespace#retention_block_data_expiration_duration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace#retention_block_size_duration CloudProjectDatabaseM3DbNamespace#retention_block_size_duration}
  */
  readonly retentionBlockSizeDuration?: string;
  /**
  * Controls how far into the future writes to the namespace will be accepted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace#retention_buffer_future_duration CloudProjectDatabaseM3DbNamespace#retention_buffer_future_duration}
  */
  readonly retentionBufferFutureDuration?: string;
  /**
  * Controls how far into the past writes to the namespace will be accepted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace#retention_buffer_past_duration CloudProjectDatabaseM3DbNamespace#retention_buffer_past_duration}
  */
  readonly retentionBufferPastDuration?: string;
  /**
  * Controls the duration of time that M3DB will retain data for the namespace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace#retention_period_duration CloudProjectDatabaseM3DbNamespace#retention_period_duration}
  */
  readonly retentionPeriodDuration?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace#service_name CloudProjectDatabaseM3DbNamespace#service_name}
  */
  readonly serviceName: string;
  /**
  * Defines whether M3db will create snapshot files for this namespace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace#snapshot_enabled CloudProjectDatabaseM3DbNamespace#snapshot_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace#writes_to_commit_log_enabled CloudProjectDatabaseM3DbNamespace#writes_to_commit_log_enabled}
  */
  readonly writesToCommitLogEnabled?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace#timeouts CloudProjectDatabaseM3DbNamespace#timeouts}
  */
  readonly timeouts?: CloudProjectDatabaseM3DbNamespaceTimeouts;
}
export interface CloudProjectDatabaseM3DbNamespaceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace#create CloudProjectDatabaseM3DbNamespace#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace#delete CloudProjectDatabaseM3DbNamespace#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace#update CloudProjectDatabaseM3DbNamespace#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace ovh_cloud_project_database_m3db_namespace}
*/
export class CloudProjectDatabaseM3DbNamespace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudProjectDatabaseM3DbNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_m3db_namespace ovh_cloud_project_database_m3db_namespace} Resource
  *
  * @param scope The scope in which to define this construct
