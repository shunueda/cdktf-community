// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dedicated_server_update
...
export interface DedicatedServerUpdateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dedicated_server_update#boot_id DedicatedServerUpdate#boot_id}
  */
  readonly bootId?: number;
  /**
  * The boot script of your dedicated server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dedicated_server_update#boot_script DedicatedServerUpdate#boot_script}
  */
  readonly bootScript?: string;
  /**
  * Display name of the dedicated server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dedicated_server_update#display_name DedicatedServerUpdate#display_name}
  */
  readonly displayName?: string;
  /**
  * The path of the EFI bootloader.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dedicated_server_update#efi_bootloader_path DedicatedServerUpdate#efi_bootloader_path}
  */
  readonly efiBootloaderPath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dedicated_server_update#id DedicatedServerUpdate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dedicated_server_update#monitoring DedicatedServerUpdate#monitoring}
  */
  readonly monitoring?: boolean | cdktf.IResolvable;
  /**
  * The internal name of your dedicated server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dedicated_server_update#service_name DedicatedServerUpdate#service_name}
  */
  readonly serviceName: string;
  /**
  * error, hacked, hackedBlocked, ok
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dedicated_server_update#state DedicatedServerUpdate#state}
  */
  readonly state?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dedicated_server_update ovh_dedicated_server_update}
*/
export class DedicatedServerUpdate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DedicatedServerUpdate that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dedicated_server_update#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dedicated_server_update ovh_dedicated_server_update} Resource
  *
  * @param scope The scope in which to define this construct
