// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_index
...
export interface DbaasLogsOutputOpensearchIndexConfig extends cdktf.TerraformMetaArguments {
  ...
  * Index description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_index#description DbaasLogsOutputOpensearchIndex#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_index#id DbaasLogsOutputOpensearchIndex#id}
  *
  ...
  * Number of shard
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_index#nb_shard DbaasLogsOutputOpensearchIndex#nb_shard}
  */
  readonly nbShard: number;
  /**
  * The service name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_index#service_name DbaasLogsOutputOpensearchIndex#service_name}
  */
  readonly serviceName: string;
  /**
  * Index suffix
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_index#suffix DbaasLogsOutputOpensearchIndex#suffix}
  */
  readonly suffix: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_index ovh_dbaas_logs_output_opensearch_index}
*/
export class DbaasLogsOutputOpensearchIndex extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbaasLogsOutputOpensearchIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_index#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_index ovh_dbaas_logs_output_opensearch_index} Resource
  *
  * @param scope The scope in which to define this construct
