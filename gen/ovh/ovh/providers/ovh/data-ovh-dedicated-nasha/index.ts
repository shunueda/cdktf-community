// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dedicated_nasha
...
export interface DataOvhDedicatedNashaConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dedicated_nasha#id DataOvhDedicatedNasha#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dedicated_nasha#service_name DataOvhDedicatedNasha#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dedicated_nasha ovh_dedicated_nasha}
*/
export class DataOvhDedicatedNasha extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhDedicatedNasha that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dedicated_nasha#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dedicated_nasha ovh_dedicated_nasha} Data Source
  *
  * @param scope The scope in which to define this construct
