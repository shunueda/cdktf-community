// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/storage_efs_share_acl
...
export interface StorageEfsShareAclConfig extends cdktf.TerraformMetaArguments {
  ...
  * Rule access level
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/storage_efs_share_acl#access_level StorageEfsShareAcl#access_level}
  */
  readonly accessLevel: string;
  /**
  * Rule destination
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/storage_efs_share_acl#access_to StorageEfsShareAcl#access_to}
  */
  readonly accessTo: string;
  /**
  * Service name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/storage_efs_share_acl#service_name StorageEfsShareAcl#service_name}
  */
  readonly serviceName: string;
  /**
  * Share ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/storage_efs_share_acl#share_id StorageEfsShareAcl#share_id}
  */
  readonly shareId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/storage_efs_share_acl ovh_storage_efs_share_acl}
*/
export class StorageEfsShareAcl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageEfsShareAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/storage_efs_share_acl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/storage_efs_share_acl ovh_storage_efs_share_acl} Resource
  *
  * @param scope The scope in which to define this construct
