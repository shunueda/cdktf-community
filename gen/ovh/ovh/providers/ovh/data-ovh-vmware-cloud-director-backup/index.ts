// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/vmware_cloud_director_backup
...
export interface DataOvhVmwareCloudDirectorBackupConfig extends cdktf.TerraformMetaArguments {
  ...
  * Backup ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/vmware_cloud_director_backup#backup_id DataOvhVmwareCloudDirectorBackup#backup_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/vmware_cloud_director_backup ovh_vmware_cloud_director_backup}
*/
export class DataOvhVmwareCloudDirectorBackup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhVmwareCloudDirectorBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/vmware_cloud_director_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/vmware_cloud_director_backup ovh_vmware_cloud_director_backup} Data Source
  *
  * @param scope The scope in which to define this construct
