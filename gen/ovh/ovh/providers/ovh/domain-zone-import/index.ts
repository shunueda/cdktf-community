// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/domain_zone_import
...
export interface DomainZoneImportConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/domain_zone_import#zone_file DomainZoneImport#zone_file}
  */
  readonly zoneFile: string;
  /**
  * Zone name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/domain_zone_import#zone_name DomainZoneImport#zone_name}
  */
  readonly zoneName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/domain_zone_import ovh_domain_zone_import}
*/
export class DomainZoneImport extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DomainZoneImport that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/domain_zone_import#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/domain_zone_import ovh_domain_zone_import} Resource
  *
  * @param scope The scope in which to define this construct
