// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_credential
...
export interface OkmsCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_credential#certificate_type OkmsCredential#certificate_type}
  */
  readonly certificateType?: string;
  /**
  * Valid Certificate Signing Request
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_credential#csr OkmsCredential#csr}
  */
  readonly csr?: string;
  /**
  * Description of the credential (max 200)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_credential#description OkmsCredential#description}
  */
  readonly description?: string;
  /**
  * List of identity URNs associated with the credential (max 25)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_credential#identity_urns OkmsCredential#identity_urns}
  */
  readonly identityUrns: string[];
  /**
  * Name of the credential (max 50)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_credential#name OkmsCredential#name}
  */
  readonly name: string;
  /**
  * Okms ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_credential#okms_id OkmsCredential#okms_id}
  */
  readonly okmsId: string;
  /**
  * Validity in days (default 365, max 365)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_credential#validity OkmsCredential#validity}
  */
  readonly validity?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_credential ovh_okms_credential}
*/
export class OkmsCredential extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OkmsCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_credential ovh_okms_credential} Resource
  *
  * @param scope The scope in which to define this construct
