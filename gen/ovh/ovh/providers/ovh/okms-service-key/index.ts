// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_service_key
...
export interface OkmsServiceKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  * Context of the key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_service_key#context OkmsServiceKey#context}
  */
  readonly context?: string;
  /**
  * Curve type for Elliptic Curve (EC) keys
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_service_key#curve OkmsServiceKey#curve}
  */
  readonly curve?: string;
  /**
  * Key name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_service_key#name OkmsServiceKey#name}
  */
  readonly name: string;
  /**
  * Okms ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_service_key#okms_id OkmsServiceKey#okms_id}
  */
  readonly okmsId: string;
  /**
  * The operations for which the key is intended to be used
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_service_key#operations OkmsServiceKey#operations}
  */
  readonly operations: string[];
  /**
  * Size of the key to be created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_service_key#size OkmsServiceKey#size}
  */
  readonly size?: number;
  /**
  * Type of the key to be created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_service_key#type OkmsServiceKey#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_service_key ovh_okms_service_key}
*/
export class OkmsServiceKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OkmsServiceKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_service_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/okms_service_key ovh_okms_service_key} Resource
  *
  * @param scope The scope in which to define this construct
