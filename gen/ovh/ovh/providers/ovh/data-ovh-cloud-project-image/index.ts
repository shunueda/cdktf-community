// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/cloud_project_image
...
export interface DataOvhCloudProjectImageConfig extends cdktf.TerraformMetaArguments {
  ...
  * Image ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/cloud_project_image#image_id DataOvhCloudProjectImage#image_id}
  */
  readonly imageId: string;
  /**
  * Service name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/cloud_project_image#service_name DataOvhCloudProjectImage#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/cloud_project_image ovh_cloud_project_image}
*/
export class DataOvhCloudProjectImage extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhCloudProjectImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/cloud_project_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/cloud_project_image ovh_cloud_project_image} Data Source
  *
  * @param scope The scope in which to define this construct
