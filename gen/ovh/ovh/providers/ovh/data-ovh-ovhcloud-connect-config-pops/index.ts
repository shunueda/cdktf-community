// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/ovhcloud_connect_config_pops
...
export interface DataOvhOvhcloudConnectConfigPopsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Service name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/ovhcloud_connect_config_pops#service_name DataOvhOvhcloudConnectConfigPops#service_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/ovhcloud_connect_config_pops ovh_ovhcloud_connect_config_pops}
*/
export class DataOvhOvhcloudConnectConfigPops extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhOvhcloudConnectConfigPops that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/ovhcloud_connect_config_pops#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/ovhcloud_connect_config_pops ovh_ovhcloud_connect_config_pops} Data Source
  *
  * @param scope The scope in which to define this construct
