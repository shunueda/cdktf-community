// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/okms_resource
...
export interface DataOvhOkmsResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  * OKMS ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/okms_resource#id DataOvhOkmsResource#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/okms_resource ovh_okms_resource}
*/
export class DataOvhOkmsResource extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhOkmsResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/okms_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/okms_resource ovh_okms_resource} Data Source
  *
  * @param scope The scope in which to define this construct
