// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_dedicated_cloud
...
export interface VrackDedicatedCloudConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_dedicated_cloud#dedicated_cloud VrackDedicatedCloud#dedicated_cloud}
  */
  readonly dedicatedCloud: string;
  /**
  * The internal name of your vrack
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_dedicated_cloud#service_name VrackDedicatedCloud#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_dedicated_cloud ovh_vrack_dedicated_cloud}
*/
export class VrackDedicatedCloud extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VrackDedicatedCloud that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_dedicated_cloud#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_dedicated_cloud ovh_vrack_dedicated_cloud} Resource
  *
  * @param scope The scope in which to define this construct
