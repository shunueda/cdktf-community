// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_cluster_retention
...
export interface DataOvhDbaasLogsClusterRetentionConfig extends cdktf.TerraformMetaArguments {
  ...
  * Cluster ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_cluster_retention#cluster_id DataOvhDbaasLogsClusterRetention#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Indexed duration expressed in ISO-8601 format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_cluster_retention#duration DataOvhDbaasLogsClusterRetention#duration}
  */
  readonly duration?: string;
  /**
  * Retention ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_cluster_retention#retention_id DataOvhDbaasLogsClusterRetention#retention_id}
  */
  readonly retentionId?: string;
  /**
  * Retention type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_cluster_retention#retention_type DataOvhDbaasLogsClusterRetention#retention_type}
  */
  readonly retentionType?: string;
  /**
  * Service name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_cluster_retention#service_name DataOvhDbaasLogsClusterRetention#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_cluster_retention ovh_dbaas_logs_cluster_retention}
*/
export class DataOvhDbaasLogsClusterRetention extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhDbaasLogsClusterRetention that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_cluster_retention#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_cluster_retention ovh_dbaas_logs_cluster_retention} Data Source
  *
  * @param scope The scope in which to define this construct
