// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_alias
...
export interface DbaasLogsOutputOpensearchAliasConfig extends cdktf.TerraformMetaArguments {
  ...
  * Alias description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_alias#description DbaasLogsOutputOpensearchAlias#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_alias#id DbaasLogsOutputOpensearchAlias#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_alias#indexes DbaasLogsOutputOpensearchAlias#indexes}
  */
  readonly indexes?: string[];
  /**
  * Number of index
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_alias#nb_index DbaasLogsOutputOpensearchAlias#nb_index}
  */
  readonly nbIndex?: number;
  /**
  * Number of shard
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_alias#nb_stream DbaasLogsOutputOpensearchAlias#nb_stream}
  */
  readonly nbStream?: number;
  /**
  * The service name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_alias#service_name DbaasLogsOutputOpensearchAlias#service_name}
  */
  readonly serviceName: string;
  /**
  * Streams attached to alias
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_alias#streams DbaasLogsOutputOpensearchAlias#streams}
  */
  readonly streams?: string[];
  /**
  * Alias suffix
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_alias#suffix DbaasLogsOutputOpensearchAlias#suffix}
  */
  readonly suffix: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_alias ovh_dbaas_logs_output_opensearch_alias}
*/
export class DbaasLogsOutputOpensearchAlias extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbaasLogsOutputOpensearchAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_alias#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_output_opensearch_alias ovh_dbaas_logs_output_opensearch_alias} Resource
  *
  * @param scope The scope in which to define this construct
