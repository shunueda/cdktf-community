// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/storage_efs
...
export interface DataOvhStorageEfsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Service name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/storage_efs#service_name DataOvhStorageEfs#service_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/storage_efs ovh_storage_efs}
*/
export class DataOvhStorageEfs extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhStorageEfs that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/storage_efs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/storage_efs ovh_storage_efs} Data Source
  *
  * @param scope The scope in which to define this construct
