// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/domain_zone_dynhost_login
...
export interface DomainZoneDynhostLoginConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/domain_zone_dynhost_login#login_suffix DomainZoneDynhostLogin#login_suffix}
  */
  readonly loginSuffix: string;
  /**
  * Password of the login
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/domain_zone_dynhost_login#password DomainZoneDynhostLogin#password}
  */
  readonly password: string;
  /**
  * Subdomain that the login will be allowed to update (use * to allow all)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/domain_zone_dynhost_login#sub_domain DomainZoneDynhostLogin#sub_domain}
  */
  readonly subDomain: string;
  /**
  * Zone name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/domain_zone_dynhost_login#zone_name DomainZoneDynhostLogin#zone_name}
  */
  readonly zoneName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/domain_zone_dynhost_login ovh_domain_zone_dynhost_login}
*/
export class DomainZoneDynhostLogin extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DomainZoneDynhostLogin that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/domain_zone_dynhost_login#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/domain_zone_dynhost_login ovh_domain_zone_dynhost_login} Resource
  *
  * @param scope The scope in which to define this construct
