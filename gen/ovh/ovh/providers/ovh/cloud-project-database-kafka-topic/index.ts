// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_kafka_topic
...
export interface CloudProjectDatabaseKafkaTopicConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_kafka_topic#cluster_id CloudProjectDatabaseKafkaTopic#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_kafka_topic#id CloudProjectDatabaseKafkaTopic#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_kafka_topic#min_insync_replicas CloudProjectDatabaseKafkaTopic#min_insync_replicas}
  */
  readonly minInsyncReplicas?: number;
  /**
  * Name of the topic
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_kafka_topic#name CloudProjectDatabaseKafkaTopic#name}
  */
  readonly name: string;
  /**
  * Number of partitions for this topic
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_kafka_topic#partitions CloudProjectDatabaseKafkaTopic#partitions}
  */
  readonly partitions?: number;
  /**
  * Number of replication for this topic
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_kafka_topic#replication CloudProjectDatabaseKafkaTopic#replication}
  */
  readonly replication?: number;
  /**
  * Number of bytes for the retention of the data for this topic
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_kafka_topic#retention_bytes CloudProjectDatabaseKafkaTopic#retention_bytes}
  */
  readonly retentionBytes?: number;
  /**
  * Number of hours for the retention of the data for this topic
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_kafka_topic#retention_hours CloudProjectDatabaseKafkaTopic#retention_hours}
  */
  readonly retentionHours?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_kafka_topic#service_name CloudProjectDatabaseKafkaTopic#service_name}
  */
  readonly serviceName: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_kafka_topic#timeouts CloudProjectDatabaseKafkaTopic#timeouts}
  */
  readonly timeouts?: CloudProjectDatabaseKafkaTopicTimeouts;
}
export interface CloudProjectDatabaseKafkaTopicTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_kafka_topic#create CloudProjectDatabaseKafkaTopic#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_kafka_topic#delete CloudProjectDatabaseKafkaTopic#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_kafka_topic ovh_cloud_project_database_kafka_topic}
*/
export class CloudProjectDatabaseKafkaTopic extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudProjectDatabaseKafkaTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_kafka_topic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_database_kafka_topic ovh_cloud_project_database_kafka_topic} Resource
  *
  * @param scope The scope in which to define this construct
