// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_output_graylog_stream
...
export interface DataOvhDbaasLogsOutputGraylogStreamConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_output_graylog_stream#id DataOvhDbaasLogsOutputGraylogStream#id}
  *
  ...
  * The service name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_output_graylog_stream#service_name DataOvhDbaasLogsOutputGraylogStream#service_name}
  */
  readonly serviceName: string;
  /**
  * Stream name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_output_graylog_stream#title DataOvhDbaasLogsOutputGraylogStream#title}
  */
  readonly title: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_output_graylog_stream ovh_dbaas_logs_output_graylog_stream}
*/
export class DataOvhDbaasLogsOutputGraylogStream extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhDbaasLogsOutputGraylogStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_output_graylog_stream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_output_graylog_stream ovh_dbaas_logs_output_graylog_stream} Data Source
  *
  * @param scope The scope in which to define this construct
