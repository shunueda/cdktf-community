// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_instance_snapshot
...
export interface CloudProjectInstanceSnapshotConfig extends cdktf.TerraformMetaArguments {
  ...
  * Instance ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_instance_snapshot#instance_id CloudProjectInstanceSnapshot#instance_id}
  */
  readonly instanceId: string;
  /**
  * Image name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_instance_snapshot#name CloudProjectInstanceSnapshot#name}
  */
  readonly name: string;
  /**
  * Service name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_instance_snapshot#service_name CloudProjectInstanceSnapshot#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_instance_snapshot ovh_cloud_project_instance_snapshot}
*/
export class CloudProjectInstanceSnapshot extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudProjectInstanceSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_instance_snapshot#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_instance_snapshot ovh_cloud_project_instance_snapshot} Resource
  *
  * @param scope The scope in which to define this construct
