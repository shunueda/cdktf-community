// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/okms_credential
...
export interface DataOvhOkmsCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/okms_credential#id DataOvhOkmsCredential#id}
  *
  ...
  * Okms ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/okms_credential#okms_id DataOvhOkmsCredential#okms_id}
  */
  readonly okmsId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/okms_credential ovh_okms_credential}
*/
export class DataOvhOkmsCredential extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhOkmsCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/okms_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/okms_credential ovh_okms_credential} Data Source
  *
  * @param scope The scope in which to define this construct
