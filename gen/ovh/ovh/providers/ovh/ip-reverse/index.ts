// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_reverse
...
export interface IpReverseConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_reverse#id IpReverse#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_reverse#ip IpReverse#ip}
  */
  readonly ip: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_reverse#ip_reverse IpReverse#ip_reverse}
  */
  readonly ipReverse: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_reverse#readiness_timeout_duration IpReverse#readiness_timeout_duration}
  */
  readonly readinessTimeoutDuration?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_reverse#reverse IpReverse#reverse}
  */
  readonly reverse: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_reverse ovh_ip_reverse}
*/
export class IpReverse extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpReverse that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_reverse#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_reverse ovh_ip_reverse} Resource
  *
  * @param scope The scope in which to define this construct
