// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_mitigation
...
export interface IpMitigationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_mitigation#ip IpMitigation#ip}
  */
  readonly ip: string;
  /**
  * IPv4 address (e.g., 192.0.2.0)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_mitigation#ip_on_mitigation IpMitigation#ip_on_mitigation}
  */
  readonly ipOnMitigation: string;
  /**
  * Set on true if your ip is on permanent mitigation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_mitigation#permanent IpMitigation#permanent}
  */
  readonly permanent?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_mitigation ovh_ip_mitigation}
*/
export class IpMitigation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpMitigation that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_mitigation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_mitigation ovh_ip_mitigation} Resource
  *
  * @param scope The scope in which to define this construct
