// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_firewall_rule
...
export interface IpFirewallRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_firewall_rule#action IpFirewallRule#action}
  */
  readonly action: string;
  /**
  * Destination port for your rule. Only with TCP/UDP protocol
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_firewall_rule#destination_port IpFirewallRule#destination_port}
  */
  readonly destinationPort?: number;
  /**
  * Fragments option
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_firewall_rule#fragments IpFirewallRule#fragments}
  */
  readonly fragments?: boolean | cdktf.IResolvable;
  /**
  * IP (v4 or v6) CIDR notation (e.g., 192.0.2.0/24)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_firewall_rule#ip IpFirewallRule#ip}
  */
  readonly ip: string;
  /**
  * IPv4 address (e.g., 192.0.2.0)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_firewall_rule#ip_on_firewall IpFirewallRule#ip_on_firewall}
  */
  readonly ipOnFirewall: string;
  /**
  * Possible values for protocol
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_firewall_rule#protocol IpFirewallRule#protocol}
  */
  readonly protocol: string;
  /**
  * Possible values for action
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_firewall_rule#sequence IpFirewallRule#sequence}
  */
  readonly sequence: number;
  /**
  * IPv4 CIDR notation (e.g., 192.0.2.0/24)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_firewall_rule#source IpFirewallRule#source}
  */
  readonly source?: string;
  /**
  * Source port for your rule. Only with TCP/UDP protocol
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_firewall_rule#source_port IpFirewallRule#source_port}
  */
  readonly sourcePort?: number;
  /**
  * TCP option on your rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_firewall_rule#tcp_option IpFirewallRule#tcp_option}
  */
  readonly tcpOption?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_firewall_rule ovh_ip_firewall_rule}
*/
export class IpFirewallRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpFirewallRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_firewall_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/ip_firewall_rule ovh_ip_firewall_rule} Resource
  *
  * @param scope The scope in which to define this construct
