// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs
...
export interface OvhProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs#access_token OvhProvider#access_token}
  */
  readonly accessToken?: string;
  /**
  * Specify the API request rate limit, X operations by seconds (default: unlimited)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs#api_rate_limit OvhProvider#api_rate_limit}
  */
  readonly apiRateLimit?: number;
  /**
  * The OVH API Application Key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs#application_key OvhProvider#application_key}
  */
  readonly applicationKey?: string;
  /**
  * The OVH API Application Secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs#application_secret OvhProvider#application_secret}
  */
  readonly applicationSecret?: string;
  /**
  * OAuth 2.0 application's ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs#client_id OvhProvider#client_id}
  */
  readonly clientId?: string;
  /**
  * OAuth 2.0 application's secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs#client_secret OvhProvider#client_secret}
  */
  readonly clientSecret?: string;
  /**
  * The OVH API Consumer Key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs#consumer_key OvhProvider#consumer_key}
  */
  readonly consumerKey?: string;
  /**
  * The OVH API endpoint to target (ex: "ovh-eu")
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs#endpoint OvhProvider#endpoint}
  */
  readonly endpoint?: string;
  /**
  * Extra information to append to the user-agent
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs#user_agent_extra OvhProvider#user_agent_extra}
  */
  readonly userAgentExtra?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs#alias OvhProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs ovh}
*/
export class OvhProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing OvhProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs ovh} Resource
  *
  * @param scope The scope in which to define this construct
