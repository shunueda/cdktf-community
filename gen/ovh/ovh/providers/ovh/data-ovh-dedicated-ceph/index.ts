// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dedicated_ceph
...
export interface DataOvhDedicatedCephConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dedicated_ceph#ceph_version DataOvhDedicatedCeph#ceph_version}
  */
  readonly cephVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dedicated_ceph#id DataOvhDedicatedCeph#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dedicated_ceph#service_name DataOvhDedicatedCeph#service_name}
  */
  readonly serviceName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dedicated_ceph#status DataOvhDedicatedCeph#status}
  */
  readonly status?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dedicated_ceph ovh_dedicated_ceph}
*/
export class DataOvhDedicatedCeph extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhDedicatedCeph that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dedicated_ceph#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dedicated_ceph ovh_dedicated_ceph} Data Source
  *
  * @param scope The scope in which to define this construct
