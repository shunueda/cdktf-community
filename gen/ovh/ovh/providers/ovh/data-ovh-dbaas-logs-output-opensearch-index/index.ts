// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_output_opensearch_index
...
export interface DataOvhDbaasLogsOutputOpensearchIndexConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_output_opensearch_index#id DataOvhDbaasLogsOutputOpensearchIndex#id}
  *
  ...
  * Index name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_output_opensearch_index#name DataOvhDbaasLogsOutputOpensearchIndex#name}
  */
  readonly name: string;
  /**
  * Number of shard
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_output_opensearch_index#nb_shard DataOvhDbaasLogsOutputOpensearchIndex#nb_shard}
  */
  readonly nbShard?: number;
  /**
  * The service name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_output_opensearch_index#service_name DataOvhDbaasLogsOutputOpensearchIndex#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_output_opensearch_index ovh_dbaas_logs_output_opensearch_index}
*/
export class DataOvhDbaasLogsOutputOpensearchIndex extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhDbaasLogsOutputOpensearchIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_output_opensearch_index#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/dbaas_logs_output_opensearch_index ovh_dbaas_logs_output_opensearch_index} Data Source
  *
  * @param scope The scope in which to define this construct
