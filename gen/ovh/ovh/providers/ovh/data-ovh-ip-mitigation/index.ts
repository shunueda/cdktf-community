// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/ip_mitigation
...
export interface DataOvhIpMitigationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/ip_mitigation#ip DataOvhIpMitigation#ip}
  */
  readonly ip: string;
  /**
  * IPv4 address (e.g., 192.0.2.0)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/ip_mitigation#ip_on_mitigation DataOvhIpMitigation#ip_on_mitigation}
  */
  readonly ipOnMitigation: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/ip_mitigation ovh_ip_mitigation}
*/
export class DataOvhIpMitigation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhIpMitigation that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/ip_mitigation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/ip_mitigation ovh_ip_mitigation} Data Source
  *
  * @param scope The scope in which to define this construct
