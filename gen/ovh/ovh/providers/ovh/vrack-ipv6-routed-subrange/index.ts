// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_ipv6_routed_subrange
...
export interface VrackIpv6RoutedSubrangeConfig extends cdktf.TerraformMetaArguments {
  ...
  * Your IP v6 block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_ipv6_routed_subrange#block VrackIpv6RoutedSubrange#block}
  */
  readonly block: string;
  /**
  * IPv6 address (e.g., 2001:41d0:1:1994::1)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_ipv6_routed_subrange#nexthop VrackIpv6RoutedSubrange#nexthop}
  */
  readonly nexthop: string;
  /**
  * IPv6 CIDR notation (e.g., 2001:41d0::/128)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_ipv6_routed_subrange#routed_subrange VrackIpv6RoutedSubrange#routed_subrange}
  */
  readonly routedSubrange: string;
  /**
  * The internal name of your vrack
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_ipv6_routed_subrange#service_name VrackIpv6RoutedSubrange#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_ipv6_routed_subrange ovh_vrack_ipv6_routed_subrange}
*/
export class VrackIpv6RoutedSubrange extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VrackIpv6RoutedSubrange that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_ipv6_routed_subrange#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_ipv6_routed_subrange ovh_vrack_ipv6_routed_subrange} Resource
  *
  * @param scope The scope in which to define this construct
