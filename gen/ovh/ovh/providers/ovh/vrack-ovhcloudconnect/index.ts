// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_ovhcloudconnect
...
export interface VrackOvhcloudconnectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_ovhcloudconnect#ovh_cloud_connect VrackOvhcloudconnect#ovh_cloud_connect}
  */
  readonly ovhCloudConnect: string;
  /**
  * The internal name of your vrack
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_ovhcloudconnect#service_name VrackOvhcloudconnect#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_ovhcloudconnect ovh_vrack_ovhcloudconnect}
*/
export class VrackOvhcloudconnect extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VrackOvhcloudconnect that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_ovhcloudconnect#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/vrack_ovhcloudconnect ovh_vrack_ovhcloudconnect} Resource
  *
  * @param scope The scope in which to define this construct
