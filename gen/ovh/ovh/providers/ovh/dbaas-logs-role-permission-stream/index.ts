// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_role_permission_stream
...
export interface DbaasLogsRolePermissionStreamConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_role_permission_stream#id DbaasLogsRolePermissionStream#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_role_permission_stream#role_id DbaasLogsRolePermissionStream#role_id}
  */
  readonly roleId: string;
  /**
  * Service name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_role_permission_stream#service_name DbaasLogsRolePermissionStream#service_name}
  */
  readonly serviceName: string;
  /**
  * Graylog stream ID to be associated as a permission
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_role_permission_stream#stream_id DbaasLogsRolePermissionStream#stream_id}
  */
  readonly streamId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_role_permission_stream ovh_dbaas_logs_role_permission_stream}
*/
export class DbaasLogsRolePermissionStream extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbaasLogsRolePermissionStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_role_permission_stream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/dbaas_logs_role_permission_stream ovh_dbaas_logs_role_permission_stream} Resource
  *
  * @param scope The scope in which to define this construct
