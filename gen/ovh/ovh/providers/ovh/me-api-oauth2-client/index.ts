// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/me_api_oauth2_client
...
export interface MeApiOauth2ClientConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/me_api_oauth2_client#callback_urls MeApiOauth2Client#callback_urls}
  */
  readonly callbackUrls?: string[];
  /**
  * A description of your oauth2 client.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/me_api_oauth2_client#description MeApiOauth2Client#description}
  */
  readonly description: string;
  /**
  * OAuth2 flow type implemented for this oauth2 client. Can be either AUTHORIZATION_CODE or CLIENT_CREDENTIALS
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/me_api_oauth2_client#flow MeApiOauth2Client#flow}
  */
  readonly flow: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/me_api_oauth2_client#id MeApiOauth2Client#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/me_api_oauth2_client#name MeApiOauth2Client#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/me_api_oauth2_client ovh_me_api_oauth2_client}
*/
export class MeApiOauth2Client extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MeApiOauth2Client that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/me_api_oauth2_client#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/me_api_oauth2_client ovh_me_api_oauth2_client} Resource
  *
  * @param scope The scope in which to define this construct
