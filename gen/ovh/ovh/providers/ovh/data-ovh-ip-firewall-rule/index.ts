// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/ip_firewall_rule
...
export interface DataOvhIpFirewallRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/ip_firewall_rule#ip DataOvhIpFirewallRule#ip}
  */
  readonly ip: string;
  /**
  * IPv4 address (e.g., 192.0.2.0)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/ip_firewall_rule#ip_on_firewall DataOvhIpFirewallRule#ip_on_firewall}
  */
  readonly ipOnFirewall: string;
  /**
  * Possible values for action
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/ip_firewall_rule#sequence DataOvhIpFirewallRule#sequence}
  */
  readonly sequence: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/ip_firewall_rule ovh_ip_firewall_rule}
*/
export class DataOvhIpFirewallRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhIpFirewallRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/ip_firewall_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/data-sources/ip_firewall_rule ovh_ip_firewall_rule} Data Source
  *
  * @param scope The scope in which to define this construct
