// https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_failover_ip_attach
...
export interface CloudProjectFailoverIpAttachConfig extends cdktf.TerraformMetaArguments {
  ...
  * IP block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_failover_ip_attach#block CloudProjectFailoverIpAttach#block}
  */
  readonly block?: string;
  /**
  * Ip continent
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_failover_ip_attach#continent_code CloudProjectFailoverIpAttach#continent_code}
  */
  readonly continentCode?: string;
  /**
  * Ip location
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_failover_ip_attach#geo_loc CloudProjectFailoverIpAttach#geo_loc}
  */
  readonly geoLoc?: string;
  /**
  * Ip
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_failover_ip_attach#ip CloudProjectFailoverIpAttach#ip}
  */
  readonly ip?: string;
  /**
  * Instance where ip is routed to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_failover_ip_attach#routed_to CloudProjectFailoverIpAttach#routed_to}
  */
  readonly routedTo?: string;
  /**
  * The service name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_failover_ip_attach#service_name CloudProjectFailoverIpAttach#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_failover_ip_attach ovh_cloud_project_failover_ip_attach}
*/
export class CloudProjectFailoverIpAttach extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudProjectFailoverIpAttach that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_failover_ip_attach#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.8.0/docs/resources/cloud_project_failover_ip_attach ovh_cloud_project_failover_ip_attach} Resource
  *
  * @param scope The scope in which to define this construct
