// https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster
...
export interface DwAwsClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#crn DwAwsCluster#crn}
  */
  readonly crn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#custom_registry_options DwAwsCluster#custom_registry_options}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#custom_subdomain DwAwsCluster#custom_subdomain}
  */
  readonly customSubdomain?: string;
  /**
  * The number of days to retain database backups.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#database_backup_retention_days DwAwsCluster#database_backup_retention_days}
  */
  readonly databaseBackupRetentionDays?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#instance_settings DwAwsCluster#instance_settings}
  */
  readonly instanceSettings?: DwAwsClusterInstanceSettings;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#network_settings DwAwsCluster#network_settings}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#node_role_cdw_managed_policy_arn DwAwsCluster#node_role_cdw_managed_policy_arn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#polling_options DwAwsCluster#polling_options}
  */
...
export interface DwAwsClusterCustomRegistryOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#registry_type DwAwsCluster#registry_type}
  */
  readonly registryType: string;
  /**
  * The URL of the registry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#repository_url DwAwsCluster#repository_url}
  */
...
export interface DwAwsClusterInstanceSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#additional_instance_types DwAwsCluster#additional_instance_types}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#compute_instance_types DwAwsCluster#compute_instance_types}
  */
  readonly computeInstanceTypes?: string[];
  /**
  * The custom AMI ID to use for worker nodes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#custom_ami_id DwAwsCluster#custom_ami_id}
  */
  readonly customAmiId?: string;
  /**
  * Whether to use spot instances for worker nodes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#enable_spot_instances DwAwsCluster#enable_spot_instances}
  */
...
export function dwAwsClusterInstanceSettingsToTerraform(struct?: DwAwsClusterInstanceSettings | cdktf.IResolvable): any {
  ...
  return {
    ...
    compute_instance_types: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.computeInstanceTypes),
...
export function dwAwsClusterInstanceSettingsToHclTerraform(struct?: DwAwsClusterInstanceSettings | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    compute_instance_types: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.computeInstanceTypes),
      isBlock: false,
      type: "list",
      storageClassType: "stringList",
    },
...
export class DwAwsClusterInstanceSettingsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DwAwsClusterInstanceSettings | cdktf.IResolvable | undefined {
    ...
    if (this._computeInstanceTypes !== undefined) {
      hasAnyValues = true;
      internalValueResult.computeInstanceTypes = this._computeInstanceTypes;
    }
  ...
  public set internalValue(value: DwAwsClusterInstanceSettings | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      ...
      this._computeInstanceTypes = undefined;
      ...
      this._computeInstanceTypes = value.computeInstanceTypes;
  ...
  // compute_instance_types - computed: false, optional: true, required: false
  private _computeInstanceTypes?: string[]; 
  public get computeInstanceTypes() {
    return this.getListAttribute('compute_instance_types');
  }
  public set computeInstanceTypes(value: string[]) {
    this._computeInstanceTypes = value;
  }
  public resetComputeInstanceTypes() {
    this._computeInstanceTypes = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get computeInstanceTypesInput() {
    return this._computeInstanceTypes;
  }
...
export interface DwAwsClusterNetworkSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#enable_private_eks DwAwsCluster#enable_private_eks}
  */
  readonly enablePrivateEks?: boolean | cdktf.IResolvable;
  /**
  * The list of subnet IDs for the load balancer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#load_balancer_subnet_ids DwAwsCluster#load_balancer_subnet_ids}
  */
  readonly loadBalancerSubnetIds: string[];
  /**
  * Whether to use overlay network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#use_overlay_network DwAwsCluster#use_overlay_network}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#use_private_load_balancer DwAwsCluster#use_private_load_balancer}
  */
  readonly usePrivateLoadBalancer: boolean | cdktf.IResolvable;
  /**
  * Whether to use public IP addresses for worker nodes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#use_public_worker_node DwAwsCluster#use_public_worker_node}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#whitelist_k8s_cluster_access_ip_cidrs DwAwsCluster#whitelist_k8s_cluster_access_ip_cidrs}
  */
  readonly whitelistK8SClusterAccessIpCidrs?: string[];
  /**
  * The list of IP CIDRs to allow access for workload endpoints.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#whitelist_workload_access_ip_cidrs DwAwsCluster#whitelist_workload_access_ip_cidrs}
  */
  readonly whitelistWorkloadAccessIpCidrs?: string[];
  /**
  * The list of subnet IDs for worker nodes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#worker_subnet_ids DwAwsCluster#worker_subnet_ids}
  */
...
export interface DwAwsClusterPollingOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#async DwAwsCluster#async}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#call_failure_threshold DwAwsCluster#call_failure_threshold}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#polling_timeout DwAwsCluster#polling_timeout}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster cdp_dw_aws_cluster}
*/
export class DwAwsCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DwAwsCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/dw_aws_cluster cdp_dw_aws_cluster} Resource
  *
  * @param scope The scope in which to define this construct
