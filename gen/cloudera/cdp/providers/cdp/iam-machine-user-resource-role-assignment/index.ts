// https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user_resource_role_assignment
...
export interface IamMachineUserResourceRoleAssignmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user_resource_role_assignment#machine_user IamMachineUserResourceRoleAssignment#machine_user}
  */
  readonly machineUser: string;
  /**
  * The resource for which the resource role rights are granted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user_resource_role_assignment#resource_crn IamMachineUserResourceRoleAssignment#resource_crn}
  */
  readonly resourceCrn: string;
  /**
  * The CRN of the resource role to assign to the machine user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user_resource_role_assignment#resource_role_crn IamMachineUserResourceRoleAssignment#resource_role_crn}
  */
  readonly resourceRoleCrn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user_resource_role_assignment cdp_iam_machine_user_resource_role_assignment}
*/
export class IamMachineUserResourceRoleAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamMachineUserResourceRoleAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user_resource_role_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user_resource_role_assignment cdp_iam_machine_user_resource_role_assignment} Resource
  *
  * @param scope The scope in which to define this construct
