// https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/data-sources/environments_keytab
...
export interface DataCdpEnvironmentsKeytabConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/data-sources/environments_keytab#actor_crn DataCdpEnvironmentsKeytab#actor_crn}
  */
  readonly actorCrn?: string;
  /**
  * The name or CRN of the environment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/data-sources/environments_keytab#environment DataCdpEnvironmentsKeytab#environment}
  */
  readonly environment: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/data-sources/environments_keytab cdp_environments_keytab}
*/
export class DataCdpEnvironmentsKeytab extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCdpEnvironmentsKeytab that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/data-sources/environments_keytab#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/data-sources/environments_keytab cdp_environments_keytab} Data Source
  *
  * @param scope The scope in which to define this construct
