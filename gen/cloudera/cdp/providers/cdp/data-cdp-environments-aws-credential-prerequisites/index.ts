// https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/data-sources/environments_aws_credential_prerequisites
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/data-sources/environments_aws_credential_prerequisites cdp_environments_aws_credential_prerequisites}
*/
export class DataCdpEnvironmentsAwsCredentialPrerequisites extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCdpEnvironmentsAwsCredentialPrerequisites that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/data-sources/environments_aws_credential_prerequisites#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/data-sources/environments_aws_credential_prerequisites cdp_environments_aws_credential_prerequisites} Data Source
  *
  * @param scope The scope in which to define this construct
