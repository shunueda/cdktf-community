// https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/recipe
...
export interface RecipeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/recipe#content Recipe#content}
  */
  readonly content: string;
  /**
  * The description of the recipe. The description can have a maximum of 1000 characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/recipe#description Recipe#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/recipe#name Recipe#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/recipe#type Recipe#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/recipe cdp_recipe}
*/
export class Recipe extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Recipe that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/recipe#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/recipe cdp_recipe} Resource
  *
  * @param scope The scope in which to define this construct
