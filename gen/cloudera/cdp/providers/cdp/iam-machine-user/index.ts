// https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user
...
export interface IamMachineUserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user#name IamMachineUser#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user#workload_password IamMachineUser#workload_password}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user cdp_iam_machine_user}
*/
export class IamMachineUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamMachineUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user cdp_iam_machine_user} Resource
  *
  * @param scope The scope in which to define this construct
