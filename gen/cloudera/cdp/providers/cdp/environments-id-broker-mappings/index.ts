// https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_id_broker_mappings
...
export interface EnvironmentsIdBrokerMappingsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_id_broker_mappings#data_access_role EnvironmentsIdBrokerMappings#data_access_role}
  */
  readonly dataAccessRole?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_id_broker_mappings#environment_crn EnvironmentsIdBrokerMappings#environment_crn}
  */
  readonly environmentCrn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_id_broker_mappings#environment_name EnvironmentsIdBrokerMappings#environment_name}
  */
  readonly environmentName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_id_broker_mappings#mappings EnvironmentsIdBrokerMappings#mappings}
  */
  readonly mappings?: EnvironmentsIdBrokerMappingsMappings[] | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_id_broker_mappings#ranger_audit_role EnvironmentsIdBrokerMappings#ranger_audit_role}
  */
  readonly rangerAuditRole: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_id_broker_mappings#ranger_cloud_access_authorizer_role EnvironmentsIdBrokerMappings#ranger_cloud_access_authorizer_role}
  */
  readonly rangerCloudAccessAuthorizerRole?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_id_broker_mappings#set_empty_mappings EnvironmentsIdBrokerMappings#set_empty_mappings}
  */
  readonly setEmptyMappings?: boolean | cdktf.IResolvable;
}
export interface EnvironmentsIdBrokerMappingsMappings {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_id_broker_mappings#accessor_crn EnvironmentsIdBrokerMappings#accessor_crn}
  */
  readonly accessorCrn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_id_broker_mappings#role EnvironmentsIdBrokerMappings#role}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_id_broker_mappings cdp_environments_id_broker_mappings}
*/
export class EnvironmentsIdBrokerMappings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EnvironmentsIdBrokerMappings that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_id_broker_mappings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_id_broker_mappings cdp_environments_id_broker_mappings} Resource
  *
  * @param scope The scope in which to define this construct
