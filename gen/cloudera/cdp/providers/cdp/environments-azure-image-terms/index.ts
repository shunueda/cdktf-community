// https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_azure_image_terms
...
export interface EnvironmentsAzureImageTermsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_azure_image_terms#accepted EnvironmentsAzureImageTerms#accepted}
  */
  readonly accepted: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_azure_image_terms cdp_environments_azure_image_terms}
*/
export class EnvironmentsAzureImageTerms extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EnvironmentsAzureImageTerms that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_azure_image_terms#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_azure_image_terms cdp_environments_azure_image_terms} Resource
  *
  * @param scope The scope in which to define this construct
