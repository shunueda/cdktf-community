// https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_group
...
export interface IamGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_group#group_name IamGroup#group_name}
  */
  readonly groupName: string;
  /**
  * Whether group membership is synced when a user logs in. The default is to sync group membership.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_group#sync_membership_on_user_login IamGroup#sync_membership_on_user_login}
  */
  readonly syncMembershipOnUserLogin?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_group cdp_iam_group}
*/
export class IamGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_group cdp_iam_group} Resource
  *
  * @param scope The scope in which to define this construct
