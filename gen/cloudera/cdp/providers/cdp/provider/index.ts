// https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs
...
export interface CdpProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs#cdp_access_key_id CdpProvider#cdp_access_key_id}
  */
  readonly cdpAccessKeyId?: string;
  /**
  * CDP configuration file. Defaults to `~/.cdp/config`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs#cdp_config_file CdpProvider#cdp_config_file}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs#cdp_endpoint_url CdpProvider#cdp_endpoint_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs#cdp_private_key CdpProvider#cdp_private_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs#cdp_profile CdpProvider#cdp_profile}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs#cdp_region CdpProvider#cdp_region}
  */
  readonly cdpRegion?: string;
  /**
  * CDP shared credentials file. Defaults to `~/.cdp/credentials`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs#cdp_shared_credentials_file CdpProvider#cdp_shared_credentials_file}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs#endpoint_url CdpProvider#endpoint_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs#local_environment CdpProvider#local_environment}
  */
  readonly localEnvironment?: boolean | cdktf.IResolvable;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs#alias CdpProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs cdp}
*/
export class CdpProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing CdpProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs cdp} Resource
  *
  * @param scope The scope in which to define this construct
