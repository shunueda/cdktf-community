// https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_aws_credential
...
export interface EnvironmentsAwsCredentialConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_aws_credential#credential_name EnvironmentsAwsCredential#credential_name}
  */
  readonly credentialName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_aws_credential#description EnvironmentsAwsCredential#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_aws_credential#role_arn EnvironmentsAwsCredential#role_arn}
  */
  readonly roleArn: string;
  /**
  * Whether to skip organizational policy decision checks or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_aws_credential#skip_org_policy_decisions EnvironmentsAwsCredential#skip_org_policy_decisions}
  */
  readonly skipOrgPolicyDecisions?: boolean | cdktf.IResolvable;
  /**
  * Whether to verify permissions upon saving or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_aws_credential#verify_permissions EnvironmentsAwsCredential#verify_permissions}
  */
  readonly verifyPermissions?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_aws_credential cdp_environments_aws_credential}
*/
export class EnvironmentsAwsCredential extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EnvironmentsAwsCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_aws_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_aws_credential cdp_environments_aws_credential} Resource
  *
  * @param scope The scope in which to define this construct
