// https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user_group_assignment
...
export interface IamMachineUserGroupAssignmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user_group_assignment#group IamMachineUserGroupAssignment#group}
  */
  readonly group: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user_group_assignment#machine_user IamMachineUserGroupAssignment#machine_user}
  */
  readonly machineUser: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user_group_assignment cdp_iam_machine_user_group_assignment}
*/
export class IamMachineUserGroupAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamMachineUserGroupAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user_group_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user_group_assignment cdp_iam_machine_user_group_assignment} Resource
  *
  * @param scope The scope in which to define this construct
