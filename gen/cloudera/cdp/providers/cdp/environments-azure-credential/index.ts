// https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_azure_credential
...
export interface EnvironmentsAzureCredentialConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_azure_credential#app_based EnvironmentsAzureCredential#app_based}
  */
  readonly appBased: EnvironmentsAzureCredentialAppBased;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_azure_credential#credential_name EnvironmentsAzureCredential#credential_name}
  */
  readonly credentialName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_azure_credential#description EnvironmentsAzureCredential#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_azure_credential#subscription_id EnvironmentsAzureCredential#subscription_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_azure_credential#tenant_id EnvironmentsAzureCredential#tenant_id}
  */
...
export interface EnvironmentsAzureCredentialAppBased {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_azure_credential#application_id EnvironmentsAzureCredential#application_id}
  */
  readonly applicationId: string;
  /**
  * The client secret key (also referred to as application password) for the registered application.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_azure_credential#secret_key EnvironmentsAzureCredential#secret_key}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_azure_credential cdp_environments_azure_credential}
*/
export class EnvironmentsAzureCredential extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EnvironmentsAzureCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_azure_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/environments_azure_credential cdp_environments_azure_credential} Resource
  *
  * @param scope The scope in which to define this construct
