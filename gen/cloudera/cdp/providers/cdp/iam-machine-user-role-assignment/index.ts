// https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user_role_assignment
...
export interface IamMachineUserRoleAssignmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user_role_assignment#machine_user IamMachineUserRoleAssignment#machine_user}
  */
  readonly machineUser: string;
  /**
  * The role to assign to the machine user. Can be the role’s name or CRN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user_role_assignment#role IamMachineUserRoleAssignment#role}
  */
  readonly role: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user_role_assignment cdp_iam_machine_user_role_assignment}
*/
export class IamMachineUserRoleAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamMachineUserRoleAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user_role_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudera/cdp/0.10.7/docs/resources/iam_machine_user_role_assignment cdp_iam_machine_user_role_assignment} Resource
  *
  * @param scope The scope in which to define this construct
