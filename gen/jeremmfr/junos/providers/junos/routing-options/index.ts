// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options
...
export interface RoutingOptionsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#clean_on_destroy RoutingOptions#clean_on_destroy}
  */
  readonly cleanOnDestroy?: boolean | cdktf.IResolvable;
  /**
  * Disable management of `forwarding-table export` in this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#forwarding_table_export_configure_singly RoutingOptions#forwarding_table_export_configure_singly}
  */
  readonly forwardingTableExportConfigureSingly?: boolean | cdktf.IResolvable;
  /**
  * Export policy for instance RIBs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#instance_export RoutingOptions#instance_export}
  */
  readonly instanceExport?: string[];
  /**
  * Import policy for instance RIBs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#instance_import RoutingOptions#instance_import}
  */
  readonly instanceImport?: string[];
  /**
  * IPv6 router identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#ipv6_router_id RoutingOptions#ipv6_router_id}
  */
  readonly ipv6RouterId?: string;
  /**
  * Router identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#router_id RoutingOptions#router_id}
  */
  readonly routerId?: string;
  /**
  * autonomous_system block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#autonomous_system RoutingOptions#autonomous_system}
  */
  readonly autonomousSystem?: RoutingOptionsAutonomousSystem;
  /**
  * forwarding_table block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#forwarding_table RoutingOptions#forwarding_table}
  */
  readonly forwardingTable?: RoutingOptionsForwardingTable;
  /**
  * graceful_restart block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#graceful_restart RoutingOptions#graceful_restart}
  */
...
export interface RoutingOptionsAutonomousSystem {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#asdot_notation RoutingOptions#asdot_notation}
  */
  readonly asdotNotation?: boolean | cdktf.IResolvable;
  /**
  * Maximum number of times this AS can be in an AS path.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#loops RoutingOptions#loops}
  */
  readonly loops?: number;
  /**
  * Autonomous system number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#number RoutingOptions#number}
  */
...
export interface RoutingOptionsForwardingTable {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#chain_composite_max_label_count RoutingOptions#chain_composite_max_label_count}
  */
  readonly chainCompositeMaxLabelCount?: number;
  /**
  * Next-hop chaining mode -> Ingress LSP nexthop settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#chained_composite_next_hop_ingress RoutingOptions#chained_composite_next_hop_ingress}
  */
  readonly chainedCompositeNextHopIngress?: string[];
  /**
  * Next-hop chaining mode -> Transit LSP nexthops settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#chained_composite_next_hop_transit RoutingOptions#chained_composite_next_hop_transit}
  */
  readonly chainedCompositeNextHopTransit?: string[];
  /**
  * Dynamic next-hop mode for EVPN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#dynamic_list_next_hop RoutingOptions#dynamic_list_next_hop}
  */
  readonly dynamicListNextHop?: boolean | cdktf.IResolvable;
  /**
  * Enable fast reroute for ECMP next hops.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#ecmp_fast_reroute RoutingOptions#ecmp_fast_reroute}
  */
  readonly ecmpFastReroute?: boolean | cdktf.IResolvable;
  /**
  * Export policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#export RoutingOptions#export}
  */
  readonly export?: string[];
  /**
  * Install indirect next hops in Packet Forwarding Engine.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#indirect_next_hop RoutingOptions#indirect_next_hop}
  */
  readonly indirectNextHop?: boolean | cdktf.IResolvable;
  /**
  * Request acknowledgements for Indirect next hop changes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#indirect_next_hop_change_acknowledgements RoutingOptions#indirect_next_hop_change_acknowledgements}
  */
  readonly indirectNextHopChangeAcknowledgements?: boolean | cdktf.IResolvable;
  /**
  * Kernel nexthop ack timeout interval.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#krt_nexthop_ack_timeout RoutingOptions#krt_nexthop_ack_timeout}
  */
  readonly krtNexthopAckTimeout?: number;
  /**
  * Don't enable fast reroute for ECMP next hops.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#no_ecmp_fast_reroute RoutingOptions#no_ecmp_fast_reroute}
  */
  readonly noEcmpFastReroute?: boolean | cdktf.IResolvable;
  /**
  * Don't install indirect next hops in Packet Forwarding Engine.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#no_indirect_next_hop RoutingOptions#no_indirect_next_hop}
  */
  readonly noIndirectNextHop?: boolean | cdktf.IResolvable;
  /**
  * Don't request acknowledgements for Indirect next hop changes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#no_indirect_next_hop_change_acknowledgements RoutingOptions#no_indirect_next_hop_change_acknowledgements}
  */
  readonly noIndirectNextHopChangeAcknowledgements?: boolean | cdktf.IResolvable;
  /**
  * Time to hold inherited routes from FIB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#remnant_holdtime RoutingOptions#remnant_holdtime}
  */
  readonly remnantHoldtime?: number;
  /**
  * Unicast reverse path (RP) verification.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#unicast_reverse_path RoutingOptions#unicast_reverse_path}
  */
...
export interface RoutingOptionsGracefulRestart {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#disable RoutingOptions#disable}
  */
  readonly disable?: boolean | cdktf.IResolvable;
  /**
  * Maximum time for which router is in graceful restart.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#restart_duration RoutingOptions#restart_duration}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options junos_routing_options}
*/
export class RoutingOptions extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RoutingOptions that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_options junos_routing_options} Resource
  *
  * @param scope The scope in which to define this construct
