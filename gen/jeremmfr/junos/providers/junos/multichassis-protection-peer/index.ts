// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/multichassis_protection_peer
...
export interface MultichassisProtectionPeerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/multichassis_protection_peer#icl_down_delay MultichassisProtectionPeer#icl_down_delay}
  */
  readonly iclDownDelay?: number;
  /**
  * Inter-Chassis protection link.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/multichassis_protection_peer#interface MultichassisProtectionPeer#interface}
  */
  readonly interface: string;
  /**
  * IP address for this peer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/multichassis_protection_peer#ip_address MultichassisProtectionPeer#ip_address}
  */
  readonly ipAddress: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/multichassis_protection_peer junos_multichassis_protection_peer}
*/
export class MultichassisProtectionPeer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MultichassisProtectionPeer that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/multichassis_protection_peer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/multichassis_protection_peer junos_multichassis_protection_peer} Resource
  *
  * @param scope The scope in which to define this construct
