// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/routes
...
export interface DataJunosRoutesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/routes#table_name DataJunosRoutes#table_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/routes junos_routes}
*/
export class DataJunosRoutes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataJunosRoutes that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/routes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/routes junos_routes} Data Source
  *
  * @param scope The scope in which to define this construct
