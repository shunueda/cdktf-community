// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address
...
export interface SecurityZoneBookAddressConfig extends cdktf.TerraformMetaArguments {
  ...
  * CIDR of address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address#cidr SecurityZoneBookAddress#cidr}
  */
  readonly cidr?: string;
  /**
  * Description of address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address#description SecurityZoneBookAddress#description}
  */
  readonly description?: string;
  /**
  * IPv4 dns address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address#dns_ipv4_only SecurityZoneBookAddress#dns_ipv4_only}
  */
  readonly dnsIpv4Only?: boolean | cdktf.IResolvable;
  /**
  * IPv6 dns address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address#dns_ipv6_only SecurityZoneBookAddress#dns_ipv6_only}
  */
  readonly dnsIpv6Only?: boolean | cdktf.IResolvable;
  /**
  * DNS address name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address#dns_name SecurityZoneBookAddress#dns_name}
  */
  readonly dnsName?: string;
  /**
  * The name of address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address#name SecurityZoneBookAddress#name}
  */
  readonly name: string;
  /**
  * Lower limit of address range.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address#range_from SecurityZoneBookAddress#range_from}
  */
  readonly rangeFrom?: string;
  /**
  * Upper limit of address range.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address#range_to SecurityZoneBookAddress#range_to}
  */
  readonly rangeTo?: string;
  /**
  * Numeric IPv4 wildcard address in the form of `a.d.d.r/netmask`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address#wildcard SecurityZoneBookAddress#wildcard}
  */
  readonly wildcard?: string;
  /**
  * The name of security zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address#zone SecurityZoneBookAddress#zone}
  */
  readonly zone: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address junos_security_zone_book_address}
*/
export class SecurityZoneBookAddress extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityZoneBookAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address junos_security_zone_book_address} Resource
  *
  * @param scope The scope in which to define this construct
