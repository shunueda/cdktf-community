// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/interface_logical
...
export interface DataJunosInterfaceLogicalConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/interface_logical#config_interface DataJunosInterfaceLogical#config_interface}
  */
  readonly configInterface?: string;
  /**
  * Regex string to filter lines and find only one interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/interface_logical#match DataJunosInterfaceLogical#match}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/interface_logical junos_interface_logical}
*/
export class DataJunosInterfaceLogical extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataJunosInterfaceLogical that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/interface_logical#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/interface_logical junos_interface_logical} Data Source
  *
  * @param scope The scope in which to define this construct
