// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_as_path_group
...
export interface PolicyoptionsAsPathGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_as_path_group#dynamic_db PolicyoptionsAsPathGroup#dynamic_db}
  */
  readonly dynamicDb?: boolean | cdktf.IResolvable;
  /**
  * Name to identify AS path group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_as_path_group#name PolicyoptionsAsPathGroup#name}
  */
  readonly name: string;
  /**
  * as_path block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_as_path_group#as_path PolicyoptionsAsPathGroup#as_path}
  */
...
export interface PolicyoptionsAsPathGroupAsPath {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_as_path_group#path PolicyoptionsAsPathGroup#path}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_as_path_group junos_policyoptions_as_path_group}
*/
export class PolicyoptionsAsPathGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyoptionsAsPathGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_as_path_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_as_path_group junos_policyoptions_as_path_group} Resource
  *
  * @param scope The scope in which to define this construct
