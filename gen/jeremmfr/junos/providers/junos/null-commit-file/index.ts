// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/null_commit_file
...
export interface NullCommitFileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/null_commit_file#append_lines NullCommitFile#append_lines}
  */
  readonly appendLines?: string[];
  /**
  * Truncate file after successful commit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/null_commit_file#clear_file_after_commit NullCommitFile#clear_file_after_commit}
  */
  readonly clearFileAfterCommit?: boolean | cdktf.IResolvable;
  /**
  * The path of the file to load.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/null_commit_file#filename NullCommitFile#filename}
  */
  readonly filename: string;
  /**
  * Any value that, when changed, will force the resource to be replaced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/null_commit_file#triggers NullCommitFile#triggers}
  */
  readonly triggers?: { [key: string]: any };
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/null_commit_file junos_null_commit_file}
*/
export class NullCommitFile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NullCommitFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/null_commit_file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/null_commit_file junos_null_commit_file} Resource
  *
  * @param scope The scope in which to define this construct
