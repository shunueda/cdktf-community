// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/switch_options
...
export interface SwitchOptionsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/switch_options#clean_on_destroy SwitchOptions#clean_on_destroy}
  */
  readonly cleanOnDestroy?: boolean | cdktf.IResolvable;
  /**
  * Configure static remote VXLAN tunnel endpoints.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/switch_options#remote_vtep_list SwitchOptions#remote_vtep_list}
  */
  readonly remoteVtepList?: string[];
  /**
  * Configure static ipv6 remote VXLAN tunnel endpoints.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/switch_options#remote_vtep_v6_list SwitchOptions#remote_vtep_v6_list}
  */
  readonly remoteVtepV6List?: string[];
  /**
  * Service ID required if multi-chassis AE is part of a bridge-domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/switch_options#service_id SwitchOptions#service_id}
  */
  readonly serviceId?: number;
  /**
  * Source layer-3 IFL for VXLAN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/switch_options#vtep_source_interface SwitchOptions#vtep_source_interface}
  */
  readonly vtepSourceInterface?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/switch_options junos_switch_options}
*/
export class SwitchOptions extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SwitchOptions that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/switch_options#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/switch_options junos_switch_options} Resource
  *
  * @param scope The scope in which to define this construct
