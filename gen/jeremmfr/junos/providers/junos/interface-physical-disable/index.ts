// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/interface_physical_disable
...
export interface InterfacePhysicalDisableConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/interface_physical_disable#name InterfacePhysicalDisable#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/interface_physical_disable junos_interface_physical_disable}
*/
export class InterfacePhysicalDisable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterfacePhysicalDisable that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/interface_physical_disable#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/interface_physical_disable junos_interface_physical_disable} Resource
  *
  * @param scope The scope in which to define this construct
