// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_storm_control_profile
...
export interface ForwardingoptionsStormControlProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_storm_control_profile#action_shutdown ForwardingoptionsStormControlProfile#action_shutdown}
  */
  readonly actionShutdown?: boolean | cdktf.IResolvable;
  /**
  * Storm control profile name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_storm_control_profile#name ForwardingoptionsStormControlProfile#name}
  */
  readonly name: string;
  /**
  * all block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_storm_control_profile#all ForwardingoptionsStormControlProfile#all}
  */
...
export interface ForwardingoptionsStormControlProfileAll {
  ...
  * Link bandwidth (kbps)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_storm_control_profile#bandwidth_level ForwardingoptionsStormControlProfile#bandwidth_level}
  */
  readonly bandwidthLevel?: number;
  /**
  * Percentage of link bandwidth.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_storm_control_profile#bandwidth_percentage ForwardingoptionsStormControlProfile#bandwidth_percentage}
  */
  readonly bandwidthPercentage?: number;
  /**
  * Burst size (bytes).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_storm_control_profile#burst_size ForwardingoptionsStormControlProfile#burst_size}
  */
  readonly burstSize?: number;
  /**
  * Disable broadcast storm control.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_storm_control_profile#no_broadcast ForwardingoptionsStormControlProfile#no_broadcast}
  */
  readonly noBroadcast?: boolean | cdktf.IResolvable;
  /**
  * Disable multicast storm control.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_storm_control_profile#no_multicast ForwardingoptionsStormControlProfile#no_multicast}
  */
  readonly noMulticast?: boolean | cdktf.IResolvable;
  /**
  * Disable registered multicast storm control.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_storm_control_profile#no_registered_multicast ForwardingoptionsStormControlProfile#no_registered_multicast}
  */
  readonly noRegisteredMulticast?: boolean | cdktf.IResolvable;
  /**
  * Disable unknown unicast storm control.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_storm_control_profile#no_unknown_unicast ForwardingoptionsStormControlProfile#no_unknown_unicast}
  */
  readonly noUnknownUnicast?: boolean | cdktf.IResolvable;
  /**
  * Disable unregistered multicast storm control.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_storm_control_profile#no_unregistered_multicast ForwardingoptionsStormControlProfile#no_unregistered_multicast}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_storm_control_profile junos_forwardingoptions_storm_control_profile}
*/
export class ForwardingoptionsStormControlProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ForwardingoptionsStormControlProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_storm_control_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_storm_control_profile junos_forwardingoptions_storm_control_profile} Resource
  *
  * @param scope The scope in which to define this construct
