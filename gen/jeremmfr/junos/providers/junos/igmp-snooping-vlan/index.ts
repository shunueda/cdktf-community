// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan
...
export interface IgmpSnoopingVlanConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan#immediate_leave IgmpSnoopingVlan#immediate_leave}
  */
  readonly immediateLeave?: boolean | cdktf.IResolvable;
  /**
  * Enable L2 querier mode with source address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan#l2_querier_source_address IgmpSnoopingVlan#l2_querier_source_address}
  */
  readonly l2QuerierSourceAddress?: string;
  /**
  * VLAN name or `all`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan#name IgmpSnoopingVlan#name}
  */
  readonly name: string;
  /**
  * Enable proxy mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan#proxy IgmpSnoopingVlan#proxy}
  */
  readonly proxy?: boolean | cdktf.IResolvable;
  /**
  * Source IP address to use for proxy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan#proxy_source_address IgmpSnoopingVlan#proxy_source_address}
  */
  readonly proxySourceAddress?: string;
  /**
  * When to send host query messages (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan#query_interval IgmpSnoopingVlan#query_interval}
  */
  readonly queryInterval?: number;
  /**
  * When to send group query messages (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan#query_last_member_interval IgmpSnoopingVlan#query_last_member_interval}
  */
  readonly queryLastMemberInterval?: string;
  /**
  * How long to wait for a host query response (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan#query_response_interval IgmpSnoopingVlan#query_response_interval}
  */
  readonly queryResponseInterval?: string;
  /**
  * Expected packet loss on a subnet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan#robust_count IgmpSnoopingVlan#robust_count}
  */
  readonly robustCount?: number;
  /**
  * Routing instance for igmp-snooping protocol if not root level.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan#routing_instance IgmpSnoopingVlan#routing_instance}
  */
  readonly routingInstance?: string;
  /**
  * interface block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan#interface IgmpSnoopingVlan#interface}
  */
...
export interface IgmpSnoopingVlanInterfaceStaticGroup {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan#address IgmpSnoopingVlan#address}
  */
  readonly address: string;
  /**
  * IP multicast source address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan#source IgmpSnoopingVlan#source}
  */
...
export interface IgmpSnoopingVlanInterface {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan#group_limit IgmpSnoopingVlan#group_limit}
  */
  readonly groupLimit?: number;
  /**
  * Enable interface to be treated as host-side interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan#host_only_interface IgmpSnoopingVlan#host_only_interface}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan#multicast_router_interface IgmpSnoopingVlan#multicast_router_interface}
  */
  ...
  * static_group block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan#static_group IgmpSnoopingVlan#static_group}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan junos_igmp_snooping_vlan}
*/
export class IgmpSnoopingVlan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IgmpSnoopingVlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/igmp_snooping_vlan junos_igmp_snooping_vlan} Resource
  *
  * @param scope The scope in which to define this construct
