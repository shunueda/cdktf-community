// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan_group
...
export interface VstpVlanGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan_group#backup_bridge_priority VstpVlanGroup#backup_bridge_priority}
  */
  readonly backupBridgePriority?: string;
  /**
  * Priority of the bridge.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan_group#bridge_priority VstpVlanGroup#bridge_priority}
  */
  readonly bridgePriority?: string;
  /**
  * Time spent in listening or learning state (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan_group#forward_delay VstpVlanGroup#forward_delay}
  */
  readonly forwardDelay?: number;
  /**
  * Time interval between configuration BPDUs (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan_group#hello_time VstpVlanGroup#hello_time}
  */
  readonly helloTime?: number;
  /**
  * Maximum age of received protocol bpdu (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan_group#max_age VstpVlanGroup#max_age}
  */
  readonly maxAge?: number;
  /**
  * VLAN group name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan_group#name VstpVlanGroup#name}
  */
  readonly name: string;
  /**
  * Routing instance for vstp protocol if not root level.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan_group#routing_instance VstpVlanGroup#routing_instance}
  */
  readonly routingInstance?: string;
  /**
  * System identifier to represent this node.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan_group#system_identifier VstpVlanGroup#system_identifier}
  */
  readonly systemIdentifier?: string;
  /**
  *  VLAN IDs or VLAN ID ranges.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan_group#vlan VstpVlanGroup#vlan}
  */
  readonly vlan: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan_group junos_vstp_vlan_group}
*/
export class VstpVlanGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VstpVlanGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan_group junos_vstp_vlan_group} Resource
  *
  * @param scope The scope in which to define this construct
