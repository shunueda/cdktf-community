// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/application_sets
...
export interface DataJunosApplicationSetsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/application_sets#match_application_sets DataJunosApplicationSets#match_application_sets}
  */
  readonly matchApplicationSets?: string[];
  /**
  * List of applications to apply a filter on application-sets.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/application_sets#match_applications DataJunosApplicationSets#match_applications}
  */
  readonly matchApplications?: string[];
  /**
  * A regexp to apply a filter on application-sets name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/application_sets#match_name DataJunosApplicationSets#match_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/application_sets junos_application_sets}
*/
export class DataJunosApplicationSets extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataJunosApplicationSets that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/application_sets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/application_sets junos_application_sets} Data Source
  *
  * @param scope The scope in which to define this construct
