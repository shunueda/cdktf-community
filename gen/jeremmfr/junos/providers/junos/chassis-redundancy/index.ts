// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/chassis_redundancy
...
export interface ChassisRedundancyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/chassis_redundancy#failover_disk_read_threshold ChassisRedundancy#failover_disk_read_threshold}
  */
  readonly failoverDiskReadThreshold?: number;
  /**
  * To failover, write threshold (ms) on disk underperform monitoring.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/chassis_redundancy#failover_disk_write_threshold ChassisRedundancy#failover_disk_write_threshold}
  */
  readonly failoverDiskWriteThreshold?: number;
  /**
  * Prevent gstatd from initiating failovers in response to slow disks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/chassis_redundancy#failover_not_on_disk_underperform ChassisRedundancy#failover_not_on_disk_underperform}
  */
  readonly failoverNotOnDiskUnderperform?: boolean | cdktf.IResolvable;
  /**
  * Failover on disk failure.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/chassis_redundancy#failover_on_disk_failure ChassisRedundancy#failover_on_disk_failure}
  */
  readonly failoverOnDiskFailure?: boolean | cdktf.IResolvable;
  /**
  * Failover on loss of keepalives.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/chassis_redundancy#failover_on_loss_of_keepalives ChassisRedundancy#failover_on_loss_of_keepalives}
  */
  readonly failoverOnLossOfKeepalives?: boolean | cdktf.IResolvable;
  /**
  * Enable graceful switchover on supported hardware.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/chassis_redundancy#graceful_switchover ChassisRedundancy#graceful_switchover}
  */
  readonly gracefulSwitchover?: boolean | cdktf.IResolvable;
  /**
  * Time before Routing Engine failover (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/chassis_redundancy#keepalive_time ChassisRedundancy#keepalive_time}
  */
  readonly keepaliveTime?: number;
  /**
  * routing_engine block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/chassis_redundancy#routing_engine ChassisRedundancy#routing_engine}
  */
...
export interface ChassisRedundancyRoutingEngine {
  ...
  * Define role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/chassis_redundancy#role ChassisRedundancy#role}
  */
  readonly role: string;
  /**
  * Routing Engine slot number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/chassis_redundancy#slot ChassisRedundancy#slot}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/chassis_redundancy junos_chassis_redundancy}
*/
export class ChassisRedundancy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChassisRedundancy that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/chassis_redundancy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/chassis_redundancy junos_chassis_redundancy} Resource
  *
  * @param scope The scope in which to define this construct
