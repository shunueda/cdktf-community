// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_dynamic_address_name
...
export interface SecurityDynamicAddressNameConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_dynamic_address_name#description SecurityDynamicAddressName#description}
  */
  readonly description?: string;
  /**
  * Security dynamic address name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_dynamic_address_name#name SecurityDynamicAddressName#name}
  */
  readonly name: string;
  /**
  * Name of feed in feed-server for this dynamic address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_dynamic_address_name#profile_feed_name SecurityDynamicAddressName#profile_feed_name}
  */
  readonly profileFeedName?: string;
  /**
  * Trigger session scan when the IP address is added.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_dynamic_address_name#session_scan SecurityDynamicAddressName#session_scan}
  */
  readonly sessionScan?: boolean | cdktf.IResolvable;
  /**
  * profile_category block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_dynamic_address_name#profile_category SecurityDynamicAddressName#profile_category}
  */
...
export interface SecurityDynamicAddressNameProfileCategoryProperty {
  ...
  * String value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_dynamic_address_name#string SecurityDynamicAddressName#string}
  */
...
export interface SecurityDynamicAddressNameProfileCategory {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_dynamic_address_name#feed SecurityDynamicAddressName#feed}
  */
  ...
  * property block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_dynamic_address_name#property SecurityDynamicAddressName#property}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_dynamic_address_name junos_security_dynamic_address_name}
*/
export class SecurityDynamicAddressName extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityDynamicAddressName that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_dynamic_address_name#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_dynamic_address_name junos_security_dynamic_address_name} Resource
  *
  * @param scope The scope in which to define this construct
