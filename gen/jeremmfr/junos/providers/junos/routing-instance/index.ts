// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance
...
export interface RoutingInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#as RoutingInstance#as}
  */
  readonly as?: string;
  /**
  * Configure `route-distinguisher` and `vrf-*` options in other resource (like `junos_evpn`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#configure_rd_vrfopts_singly RoutingInstance#configure_rd_vrfopts_singly}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#configure_type_singly RoutingInstance#configure_type_singly}
  */
  readonly configureTypeSingly?: boolean | cdktf.IResolvable;
  /**
  * Text description of routing instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#description RoutingInstance#description}
  */
  readonly description?: string;
  /**
  * Export policy for instance RIBs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#instance_export RoutingInstance#instance_export}
  */
  readonly instanceExport?: string[];
  /**
  * Import policy for instance RIBs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#instance_import RoutingInstance#instance_import}
  */
  readonly instanceImport?: string[];
  /**
  * The name of routing instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#name RoutingInstance#name}
  */
  readonly name: string;
  /**
  * Configure static remote VXLAN tunnel endpoints.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#remote_vtep_list RoutingInstance#remote_vtep_list}
  */
  readonly remoteVtepList?: string[];
  /**
  * Configure static ipv6 remote VXLAN tunnel endpoints.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#remote_vtep_v6_list RoutingInstance#remote_vtep_v6_list}
  */
  readonly remoteVtepV6List?: string[];
  /**
  * Route distinguisher for this instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#route_distinguisher RoutingInstance#route_distinguisher}
  */
  readonly routeDistinguisher?: string;
  /**
  * Router identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#router_id RoutingInstance#router_id}
  */
  readonly routerId?: string;
  /**
  * Type of routing instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#type RoutingInstance#type}
  */
  readonly type?: string;
  /**
  * Export policy for VRF instance RIBs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#vrf_export RoutingInstance#vrf_export}
  */
  readonly vrfExport?: string[];
  /**
  * Import policy for VRF instance RIBs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#vrf_import RoutingInstance#vrf_import}
  */
  readonly vrfImport?: string[];
  /**
  * Target community to use in import and export.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#vrf_target RoutingInstance#vrf_target}
  */
  readonly vrfTarget?: string;
  /**
  * Auto derive import and export target community from BGP AS & L2.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#vrf_target_auto RoutingInstance#vrf_target_auto}
  */
  readonly vrfTargetAuto?: boolean | cdktf.IResolvable;
  /**
  * Target community to use when marking routes on export.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#vrf_target_export RoutingInstance#vrf_target_export}
  */
  readonly vrfTargetExport?: string;
  /**
  * Target community to use when filtering on import.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#vrf_target_import RoutingInstance#vrf_target_import}
  */
  readonly vrfTargetImport?: string;
  /**
  * Source layer-3 IFL for VXLAN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#vtep_source_interface RoutingInstance#vtep_source_interface}
  */
  readonly vtepSourceInterface?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance junos_routing_instance}
*/
export class RoutingInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RoutingInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/routing_instance junos_routing_instance} Resource
  *
  * @param scope The scope in which to define this construct
