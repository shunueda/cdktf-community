// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_policy_tunnel_pair_policy
...
export interface SecurityPolicyTunnelPairPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_policy_tunnel_pair_policy#policy_a_to_b SecurityPolicyTunnelPairPolicy#policy_a_to_b}
  */
  readonly policyAToB: string;
  /**
  * The name of policy when from zone zone_b to zone zone_a.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_policy_tunnel_pair_policy#policy_b_to_a SecurityPolicyTunnelPairPolicy#policy_b_to_a}
  */
  readonly policyBToA: string;
  /**
  * The name of first zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_policy_tunnel_pair_policy#zone_a SecurityPolicyTunnelPairPolicy#zone_a}
  */
  readonly zoneA: string;
  /**
  * The name of second zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_policy_tunnel_pair_policy#zone_b SecurityPolicyTunnelPairPolicy#zone_b}
  */
  readonly zoneB: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_policy_tunnel_pair_policy junos_security_policy_tunnel_pair_policy}
*/
export class SecurityPolicyTunnelPairPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityPolicyTunnelPairPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_policy_tunnel_pair_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_policy_tunnel_pair_policy junos_security_policy_tunnel_pair_policy} Resource
  *
  * @param scope The scope in which to define this construct
