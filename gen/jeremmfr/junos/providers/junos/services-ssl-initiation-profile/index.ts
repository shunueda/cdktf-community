// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_ssl_initiation_profile
...
export interface ServicesSslInitiationProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_ssl_initiation_profile#client_certificate ServicesSslInitiationProfile#client_certificate}
  */
  readonly clientCertificate?: string;
  /**
  * Custom cipher list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_ssl_initiation_profile#custom_ciphers ServicesSslInitiationProfile#custom_ciphers}
  */
  readonly customCiphers?: string[];
  /**
  * Enable flow tracing for the profile.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_ssl_initiation_profile#enable_flow_tracing ServicesSslInitiationProfile#enable_flow_tracing}
  */
  readonly enableFlowTracing?: boolean | cdktf.IResolvable;
  /**
  * Enable SSL session cache.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_ssl_initiation_profile#enable_session_cache ServicesSslInitiationProfile#enable_session_cache}
  */
  readonly enableSessionCache?: boolean | cdktf.IResolvable;
  /**
  * Profile name (Profile identifier).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_ssl_initiation_profile#name ServicesSslInitiationProfile#name}
  */
  readonly name: string;
  /**
  * Select preferred ciphers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_ssl_initiation_profile#preferred_ciphers ServicesSslInitiationProfile#preferred_ciphers}
  */
  readonly preferredCiphers?: string;
  /**
  * Protocol SSL version accepted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_ssl_initiation_profile#protocol_version ServicesSslInitiationProfile#protocol_version}
  */
  readonly protocolVersion?: string;
  /**
  * List of trusted certificate authority profiles.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_ssl_initiation_profile#trusted_ca ServicesSslInitiationProfile#trusted_ca}
  */
  readonly trustedCa?: string[];
  /**
  * actions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_ssl_initiation_profile#actions ServicesSslInitiationProfile#actions}
  */
...
export interface ServicesSslInitiationProfileActions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_ssl_initiation_profile#crl_disable ServicesSslInitiationProfile#crl_disable}
  */
  readonly crlDisable?: boolean | cdktf.IResolvable;
  /**
  * Action if CRL information is not present.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_ssl_initiation_profile#crl_if_not_present ServicesSslInitiationProfile#crl_if_not_present}
  */
  readonly crlIfNotPresent?: string;
  /**
  * Ignore 'Hold Instruction Code' present in the CRL entry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_ssl_initiation_profile#crl_ignore_hold_instruction_code ServicesSslInitiationProfile#crl_ignore_hold_instruction_code}
  */
  readonly crlIgnoreHoldInstructionCode?: boolean | cdktf.IResolvable;
  /**
  * Ignore server authentication failure.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_ssl_initiation_profile#ignore_server_auth_failure ServicesSslInitiationProfile#ignore_server_auth_failure}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_ssl_initiation_profile junos_services_ssl_initiation_profile}
*/
export class ServicesSslInitiationProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicesSslInitiationProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_ssl_initiation_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_ssl_initiation_profile junos_services_ssl_initiation_profile} Resource
  *
  * @param scope The scope in which to define this construct
