// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_tacplus_server
...
export interface SystemTacplusServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_tacplus_server#address SystemTacplusServer#address}
  */
  readonly address: string;
  /**
  * TACACS+ authentication server port number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_tacplus_server#port SystemTacplusServer#port}
  */
  readonly port?: number;
  /**
  * Routing instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_tacplus_server#routing_instance SystemTacplusServer#routing_instance}
  */
  readonly routingInstance?: string;
  /**
  * Shared secret with the authentication server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_tacplus_server#secret SystemTacplusServer#secret}
  */
  readonly secret?: string;
  /**
  * Optimize TCP connection attempts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_tacplus_server#single_connection SystemTacplusServer#single_connection}
  */
  readonly singleConnection?: boolean | cdktf.IResolvable;
  /**
  * Use specified address as source address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_tacplus_server#source_address SystemTacplusServer#source_address}
  */
  readonly sourceAddress?: string;
  /**
  * Request timeout period.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_tacplus_server#timeout SystemTacplusServer#timeout}
  */
  readonly timeout?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_tacplus_server junos_system_tacplus_server}
*/
export class SystemTacplusServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemTacplusServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_tacplus_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_tacplus_server junos_system_tacplus_server} Resource
  *
  * @param scope The scope in which to define this construct
