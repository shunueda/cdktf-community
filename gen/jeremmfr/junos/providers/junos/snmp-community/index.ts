// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_community
...
export interface SnmpCommunityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_community#authorization_read_only SnmpCommunity#authorization_read_only}
  */
  readonly authorizationReadOnly?: boolean | cdktf.IResolvable;
  /**
  * Allow read and write access.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_community#authorization_read_write SnmpCommunity#authorization_read_write}
  */
  readonly authorizationReadWrite?: boolean | cdktf.IResolvable;
  /**
  * The name of client list or prefix list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_community#client_list_name SnmpCommunity#client_list_name}
  */
  readonly clientListName?: string;
  /**
  * List of source address prefix ranges to accept.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_community#clients SnmpCommunity#clients}
  */
  readonly clients?: string[];
  /**
  * The name of snmp community.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_community#name SnmpCommunity#name}
  */
  readonly name: string;
  /**
  * View name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_community#view SnmpCommunity#view}
  */
  readonly view?: string;
  /**
  * routing_instance block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_community#routing_instance SnmpCommunity#routing_instance}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_community junos_snmp_community}
*/
export class SnmpCommunity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SnmpCommunity that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_community#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_community junos_snmp_community} Resource
  *
  * @param scope The scope in which to define this construct
