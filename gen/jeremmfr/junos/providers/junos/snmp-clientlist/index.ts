// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_clientlist
...
export interface SnmpClientlistConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_clientlist#name SnmpClientlist#name}
  */
  readonly name: string;
  /**
  * Address or prefix.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_clientlist#prefix SnmpClientlist#prefix}
  */
  readonly prefix?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_clientlist junos_snmp_clientlist}
*/
export class SnmpClientlist extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SnmpClientlist that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_clientlist#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_clientlist junos_snmp_clientlist} Resource
  *
  * @param scope The scope in which to define this construct
