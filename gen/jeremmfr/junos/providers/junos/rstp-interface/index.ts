// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp_interface
...
export interface RstpInterfaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp_interface#access_trunk RstpInterface#access_trunk}
  */
  readonly accessTrunk?: boolean | cdktf.IResolvable;
  /**
  * Generate an alarm on BPDU expiry (Loop Protect).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp_interface#bpdu_timeout_action_alarm RstpInterface#bpdu_timeout_action_alarm}
  */
  readonly bpduTimeoutActionAlarm?: boolean | cdktf.IResolvable;
  /**
  * Block the interface on BPDU expiry (Loop Protect).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp_interface#bpdu_timeout_action_block RstpInterface#bpdu_timeout_action_block}
  */
  readonly bpduTimeoutActionBlock?: boolean | cdktf.IResolvable;
  /**
  * Cost of the interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp_interface#cost RstpInterface#cost}
  */
  readonly cost?: number;
  /**
  * Port is an edge port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp_interface#edge RstpInterface#edge}
  */
  readonly edge?: boolean | cdktf.IResolvable;
  /**
  * Interface mode (P2P or shared).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp_interface#mode RstpInterface#mode}
  */
  readonly mode?: string;
  /**
  * Interface name or `all`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp_interface#name RstpInterface#name}
  */
  readonly name: string;
  /**
  * Do not allow the interface to become root (Root Protect).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp_interface#no_root_port RstpInterface#no_root_port}
  */
  readonly noRootPort?: boolean | cdktf.IResolvable;
  /**
  * Interface priority (in increments of 16).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp_interface#priority RstpInterface#priority}
  */
  readonly priority?: number;
  /**
  * Routing instance for rstp protocol if not root level.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp_interface#routing_instance RstpInterface#routing_instance}
  */
  readonly routingInstance?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp_interface junos_rstp_interface}
*/
export class RstpInterface extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RstpInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp_interface#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp_interface junos_rstp_interface} Resource
  *
  * @param scope The scope in which to define this construct
