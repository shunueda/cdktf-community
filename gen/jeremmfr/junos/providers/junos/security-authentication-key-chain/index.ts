// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_authentication_key_chain
...
export interface SecurityAuthenticationKeyChainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_authentication_key_chain#description SecurityAuthenticationKeyChain#description}
  */
  readonly description?: string;
  /**
  * Name of authentication key chain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_authentication_key_chain#name SecurityAuthenticationKeyChain#name}
  */
  readonly name: string;
  /**
  * Clock skew tolerance (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_authentication_key_chain#tolerance SecurityAuthenticationKeyChain#tolerance}
  */
  readonly tolerance?: number;
  /**
  * key block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_authentication_key_chain#key SecurityAuthenticationKeyChain#key}
  */
...
export interface SecurityAuthenticationKeyChainKey {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_authentication_key_chain#algorithm SecurityAuthenticationKeyChain#algorithm}
  */
  readonly algorithm?: string;
  /**
  * Cryptographic algorithm for TCP-AO Traffic key and MAC digest generation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_authentication_key_chain#ao_cryptographic_algorithm SecurityAuthenticationKeyChain#ao_cryptographic_algorithm}
  */
  readonly aoCryptographicAlgorithm?: string;
  /**
  * Recv id for TCP-AO entry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_authentication_key_chain#ao_recv_id SecurityAuthenticationKeyChain#ao_recv_id}
  */
  readonly aoRecvId?: number;
  /**
  * Send id for TCP-AO entry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_authentication_key_chain#ao_send_id SecurityAuthenticationKeyChain#ao_send_id}
  */
  readonly aoSendId?: number;
  /**
  * Include TCP-AO option within message header.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_authentication_key_chain#ao_tcp_ao_option SecurityAuthenticationKeyChain#ao_tcp_ao_option}
  */
  readonly aoTcpAoOption?: string;
  /**
  * Authentication element identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_authentication_key_chain#id SecurityAuthenticationKeyChain#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_authentication_key_chain#key_name SecurityAuthenticationKeyChain#key_name}
  */
  readonly keyName?: string;
  /**
  * Protocol's transmission encoding format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_authentication_key_chain#options SecurityAuthenticationKeyChain#options}
  */
  readonly options?: string;
  /**
  * Authentication key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_authentication_key_chain#secret SecurityAuthenticationKeyChain#secret}
  */
  readonly secret: string;
  /**
  * Start time for key transmission (YYYY-MM-DD.HH:MM:SS).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_authentication_key_chain#start_time SecurityAuthenticationKeyChain#start_time}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_authentication_key_chain junos_security_authentication_key_chain}
*/
export class SecurityAuthenticationKeyChain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityAuthenticationKeyChain that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_authentication_key_chain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_authentication_key_chain junos_security_authentication_key_chain} Resource
  *
  * @param scope The scope in which to define this construct
