// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/security_zone
...
export interface DataJunosSecurityZoneConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/security_zone#name DataJunosSecurityZone#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/security_zone junos_security_zone}
*/
export class DataJunosSecurityZone extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataJunosSecurityZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/security_zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/security_zone junos_security_zone} Data Source
  *
  * @param scope The scope in which to define this construct
