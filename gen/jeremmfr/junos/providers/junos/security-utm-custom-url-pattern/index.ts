// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_url_pattern
...
export interface SecurityUtmCustomUrlPatternConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_url_pattern#name SecurityUtmCustomUrlPattern#name}
  */
  readonly name: string;
  /**
  * List of url for security utm custom-object url-pattern.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_url_pattern#value SecurityUtmCustomUrlPattern#value}
  */
  readonly value: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_url_pattern junos_security_utm_custom_url_pattern}
*/
export class SecurityUtmCustomUrlPattern extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityUtmCustomUrlPattern that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_url_pattern#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_url_pattern junos_security_utm_custom_url_pattern} Resource
  *
  * @param scope The scope in which to define this construct
