// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_usm_user
...
export interface SnmpV3UsmUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_usm_user#authentication_key SnmpV3UsmUser#authentication_key}
  */
  readonly authenticationKey?: string;
  /**
  * User's authentication password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_usm_user#authentication_password SnmpV3UsmUser#authentication_password}
  */
  readonly authenticationPassword?: string;
  /**
  * Define authentication type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_usm_user#authentication_type SnmpV3UsmUser#authentication_type}
  */
  readonly authenticationType?: string;
  /**
  * Remote engine id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_usm_user#engine_id SnmpV3UsmUser#engine_id}
  */
  readonly engineId?: string;
  /**
  * Local or remote engine user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_usm_user#engine_type SnmpV3UsmUser#engine_type}
  */
  readonly engineType?: string;
  /**
  * The name of snmp v3 USM user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_usm_user#name SnmpV3UsmUser#name}
  */
  readonly name: string;
  /**
  * Encrypted key used for user privacy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_usm_user#privacy_key SnmpV3UsmUser#privacy_key}
  */
  readonly privacyKey?: string;
  /**
  * User's privacy password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_usm_user#privacy_password SnmpV3UsmUser#privacy_password}
  */
  readonly privacyPassword?: string;
  /**
  * Define privacy type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_usm_user#privacy_type SnmpV3UsmUser#privacy_type}
  */
  readonly privacyType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_usm_user junos_snmp_v3_usm_user}
*/
export class SnmpV3UsmUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SnmpV3UsmUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_usm_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_usm_user junos_snmp_v3_usm_user} Resource
  *
  * @param scope The scope in which to define this construct
