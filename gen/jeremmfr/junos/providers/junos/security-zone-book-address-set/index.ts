// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address_set
...
export interface SecurityZoneBookAddressSetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address_set#address SecurityZoneBookAddressSet#address}
  */
  readonly address?: string[];
  /**
  * List of address-set names.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address_set#address_set SecurityZoneBookAddressSet#address_set}
  */
  readonly addressSet?: string[];
  /**
  * Description of address-set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address_set#description SecurityZoneBookAddressSet#description}
  */
  readonly description?: string;
  /**
  * The name of address-set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address_set#name SecurityZoneBookAddressSet#name}
  */
  readonly name: string;
  /**
  * The name of security zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address_set#zone SecurityZoneBookAddressSet#zone}
  */
  readonly zone: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address_set junos_security_zone_book_address_set}
*/
export class SecurityZoneBookAddressSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityZoneBookAddressSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_zone_book_address_set junos_security_zone_book_address_set} Resource
  *
  * @param scope The scope in which to define this construct
