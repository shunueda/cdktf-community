// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rib_group
...
export interface RibGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rib_group#export_rib RibGroup#export_rib}
  */
  readonly exportRib?: string;
  /**
  * List of policy for import route.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rib_group#import_policy RibGroup#import_policy}
  */
  readonly importPolicy?: string[];
  /**
  * List of import routing table.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rib_group#import_rib RibGroup#import_rib}
  */
  readonly importRib?: string[];
  /**
  * The name of rib group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rib_group#name RibGroup#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rib_group junos_rib_group}
*/
export class RibGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RibGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rib_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rib_group junos_rib_group} Resource
  *
  * @param scope The scope in which to define this construct
