// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_interface
...
export interface VstpInterfaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_interface#access_trunk VstpInterface#access_trunk}
  */
  readonly accessTrunk?: boolean | cdktf.IResolvable;
  /**
  * Generate an alarm on BPDU expiry (Loop Protect).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_interface#bpdu_timeout_action_alarm VstpInterface#bpdu_timeout_action_alarm}
  */
  readonly bpduTimeoutActionAlarm?: boolean | cdktf.IResolvable;
  /**
  * Block the interface on BPDU expiry (Loop Protect).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_interface#bpdu_timeout_action_block VstpInterface#bpdu_timeout_action_block}
  */
  readonly bpduTimeoutActionBlock?: boolean | cdktf.IResolvable;
  /**
  * Cost of the interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_interface#cost VstpInterface#cost}
  */
  readonly cost?: number;
  /**
  * Port is an edge port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_interface#edge VstpInterface#edge}
  */
  readonly edge?: boolean | cdktf.IResolvable;
  /**
  * Interface mode (P2P or shared).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_interface#mode VstpInterface#mode}
  */
  readonly mode?: string;
  /**
  * Interface name or `all`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_interface#name VstpInterface#name}
  */
  readonly name: string;
  /**
  * Do not allow the interface to become root (Root Protect).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_interface#no_root_port VstpInterface#no_root_port}
  */
  readonly noRootPort?: boolean | cdktf.IResolvable;
  /**
  * Interface priority (in increments of 16).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_interface#priority VstpInterface#priority}
  */
  readonly priority?: number;
  /**
  * Routing instance for vstp protocol if not root level.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_interface#routing_instance VstpInterface#routing_instance}
  */
  readonly routingInstance?: string;
  /**
  * Configure interface in VSTP vlan.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_interface#vlan VstpInterface#vlan}
  */
  readonly vlan?: string;
  /**
  * Configure interface in VSTP vlan-group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_interface#vlan_group VstpInterface#vlan_group}
  */
  readonly vlanGroup?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_interface junos_vstp_interface}
*/
export class VstpInterface extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VstpInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_interface#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_interface junos_vstp_interface} Resource
  *
  * @param scope The scope in which to define this construct
