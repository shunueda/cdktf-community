// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp
...
export interface RstpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp#backup_bridge_priority Rstp#backup_bridge_priority}
  */
  readonly backupBridgePriority?: string;
  /**
  * Block BPDU on all interfaces configured as edge (BPDU Protect).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp#bpdu_block_on_edge Rstp#bpdu_block_on_edge}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp#bpdu_destination_mac_address_provider_bridge_group Rstp#bpdu_destination_mac_address_provider_bridge_group}
  */
  readonly bpduDestinationMacAddressProviderBridgeGroup?: boolean | cdktf.IResolvable;
  /**
  * Priority of the bridge.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp#bridge_priority Rstp#bridge_priority}
  */
  readonly bridgePriority?: string;
  /**
  * Disable STP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp#disable Rstp#disable}
  */
  readonly disable?: boolean | cdktf.IResolvable;
  /**
  * Extended system identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp#extended_system_id Rstp#extended_system_id}
  */
  readonly extendedSystemId?: number;
  /**
  * Force protocol version STP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp#force_version_stp Rstp#force_version_stp}
  */
  readonly forceVersionStp?: boolean | cdktf.IResolvable;
  /**
  * Time spent in listening or learning state (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp#forward_delay Rstp#forward_delay}
  */
  readonly forwardDelay?: number;
  /**
  * Time interval between configuration BPDUs (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp#hello_time Rstp#hello_time}
  */
  readonly helloTime?: number;
  /**
  * Maximum age of received protocol bpdu (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp#max_age Rstp#max_age}
  */
  readonly maxAge?: number;
  /**
  * Hold time before switching to primary priority when core domain becomes up (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp#priority_hold_time Rstp#priority_hold_time}
  */
  readonly priorityHoldTime?: number;
  /**
  * Routing instance for rstp protocol if not root level.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp#routing_instance Rstp#routing_instance}
  */
  readonly routingInstance?: string;
  /**
  * System identifier to represent this node.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp#system_identifier Rstp#system_identifier}
  */
  readonly systemIdentifier?: string;
  /**
  * Enable VPLS MAC flush on root protected CE interface receiving topology change.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp#vpls_flush_on_topology_change Rstp#vpls_flush_on_topology_change}
  */
  readonly vplsFlushOnTopologyChange?: boolean | cdktf.IResolvable;
  /**
  * system_id block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp#system_id Rstp#system_id}
  */
...
export interface RstpSystemId {
  ...
  * System ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp#id Rstp#id}
  *
  ...
  * Peer ID (IP Address).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp#ip_address Rstp#ip_address}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp junos_rstp}
*/
export class Rstp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Rstp that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/rstp junos_rstp} Resource
  *
  * @param scope The scope in which to define this construct
