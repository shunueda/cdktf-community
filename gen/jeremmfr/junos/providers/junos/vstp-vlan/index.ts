// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan
...
export interface VstpVlanConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan#backup_bridge_priority VstpVlan#backup_bridge_priority}
  */
  readonly backupBridgePriority?: string;
  /**
  * Priority of the bridge.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan#bridge_priority VstpVlan#bridge_priority}
  */
  readonly bridgePriority?: string;
  /**
  * Time spent in listening or learning state (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan#forward_delay VstpVlan#forward_delay}
  */
  readonly forwardDelay?: number;
  /**
  * Time interval between configuration BPDUs (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan#hello_time VstpVlan#hello_time}
  */
  readonly helloTime?: number;
  /**
  * Maximum age of received protocol bpdu (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan#max_age VstpVlan#max_age}
  */
  readonly maxAge?: number;
  /**
  * Routing instance for vstp protocol if not root level.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan#routing_instance VstpVlan#routing_instance}
  */
  readonly routingInstance?: string;
  /**
  * System identifier to represent this node.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan#system_identifier VstpVlan#system_identifier}
  */
  readonly systemIdentifier?: string;
  /**
  * VLAN id or `all`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan#vlan_id VstpVlan#vlan_id}
  */
  readonly vlanId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan junos_vstp_vlan}
*/
export class VstpVlan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VstpVlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp_vlan junos_vstp_vlan} Resource
  *
  * @param scope The scope in which to define this construct
