// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/eventoptions_destination
...
export interface EventoptionsDestinationConfig extends cdktf.TerraformMetaArguments {
  ...
  * Destination name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/eventoptions_destination#name EventoptionsDestination#name}
  */
  readonly name: string;
  /**
  * Delay before transferring files (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/eventoptions_destination#transfer_delay EventoptionsDestination#transfer_delay}
  */
  readonly transferDelay?: number;
  /**
  * archive_site block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/eventoptions_destination#archive_site EventoptionsDestination#archive_site}
  */
...
export interface EventoptionsDestinationArchiveSite {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/eventoptions_destination#password EventoptionsDestination#password}
  */
  readonly password?: string;
  /**
  * URL of destination for file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/eventoptions_destination#url EventoptionsDestination#url}
  */
  readonly url: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/eventoptions_destination junos_eventoptions_destination}
*/
export class EventoptionsDestination extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EventoptionsDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/eventoptions_destination#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/eventoptions_destination junos_eventoptions_destination} Resource
  *
  * @param scope The scope in which to define this construct
