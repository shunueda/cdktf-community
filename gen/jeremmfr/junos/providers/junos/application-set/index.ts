// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/application_set
...
export interface ApplicationSetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/application_set#application_set ApplicationSet#application_set}
  */
  readonly applicationSet?: string[];
  /**
  * Application to be included in the set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/application_set#applications ApplicationSet#applications}
  */
  readonly applications?: string[];
  /**
  * Description for application-set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/application_set#description ApplicationSet#description}
  */
  readonly description?: string;
  /**
  * Application set name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/application_set#name ApplicationSet#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/application_set junos_application_set}
*/
export class ApplicationSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/application_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/application_set junos_application_set} Resource
  *
  * @param scope The scope in which to define this construct
