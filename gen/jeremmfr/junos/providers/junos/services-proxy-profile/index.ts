// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_proxy_profile
...
export interface ServicesProxyProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  * Proxy profile name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_proxy_profile#name ServicesProxyProfile#name}
  */
  readonly name: string;
  /**
  * Proxy server name or IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_proxy_profile#protocol_http_host ServicesProxyProfile#protocol_http_host}
  */
  readonly protocolHttpHost: string;
  /**
  * Proxy server port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_proxy_profile#protocol_http_port ServicesProxyProfile#protocol_http_port}
  */
  readonly protocolHttpPort?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_proxy_profile junos_services_proxy_profile}
*/
export class ServicesProxyProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicesProxyProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_proxy_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/services_proxy_profile junos_services_proxy_profile} Resource
  *
  * @param scope The scope in which to define this construct
