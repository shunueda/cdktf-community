// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_prefix_list
...
export interface PolicyoptionsPrefixListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_prefix_list#apply_path PolicyoptionsPrefixList#apply_path}
  */
  readonly applyPath?: string;
  /**
  * Object may exist in dynamic database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_prefix_list#dynamic_db PolicyoptionsPrefixList#dynamic_db}
  */
  readonly dynamicDb?: boolean | cdktf.IResolvable;
  /**
  * Prefix list name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_prefix_list#name PolicyoptionsPrefixList#name}
  */
  readonly name: string;
  /**
  * Address prefixes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_prefix_list#prefix PolicyoptionsPrefixList#prefix}
  */
  readonly prefix?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_prefix_list junos_policyoptions_prefix_list}
*/
export class PolicyoptionsPrefixList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyoptionsPrefixList that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_prefix_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_prefix_list junos_policyoptions_prefix_list} Resource
  *
  * @param scope The scope in which to define this construct
