// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_proposal
...
export interface SecurityIkeProposalConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_proposal#authentication_algorithm SecurityIkeProposal#authentication_algorithm}
  */
  readonly authenticationAlgorithm?: string;
  /**
  * Authentication method.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_proposal#authentication_method SecurityIkeProposal#authentication_method}
  */
  readonly authenticationMethod?: string;
  /**
  * Text description of IKE proposal.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_proposal#description SecurityIkeProposal#description}
  */
  readonly description?: string;
  /**
  * Diffie-Hellman Group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_proposal#dh_group SecurityIkeProposal#dh_group}
  */
  readonly dhGroup?: string;
  /**
  * Encryption algorithm.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_proposal#encryption_algorithm SecurityIkeProposal#encryption_algorithm}
  */
  readonly encryptionAlgorithm?: string;
  /**
  * Lifetime, in seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_proposal#lifetime_seconds SecurityIkeProposal#lifetime_seconds}
  */
  readonly lifetimeSeconds?: number;
  /**
  * The name of IKE proposal.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_proposal#name SecurityIkeProposal#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_proposal junos_security_ike_proposal}
*/
export class SecurityIkeProposal extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityIkeProposal that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_proposal#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_proposal junos_security_ike_proposal} Resource
  *
  * @param scope The scope in which to define this construct
