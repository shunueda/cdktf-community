// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_idp_custom_attack_group
...
export interface SecurityIdpCustomAttackGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_idp_custom_attack_group#member SecurityIdpCustomAttackGroup#member}
  */
  readonly member: string[];
  /**
  * Custom attack group name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_idp_custom_attack_group#name SecurityIdpCustomAttackGroup#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_idp_custom_attack_group junos_security_idp_custom_attack_group}
*/
export class SecurityIdpCustomAttackGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityIdpCustomAttackGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_idp_custom_attack_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_idp_custom_attack_group junos_security_idp_custom_attack_group} Resource
  *
  * @param scope The scope in which to define this construct
