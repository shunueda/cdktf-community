// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_community
...
export interface SnmpV3CommunityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_community#community_index SnmpV3Community#community_index}
  */
  readonly communityIndex: string;
  /**
  * SNMPv1/v2c community name (default is same as community-index).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_community#community_name SnmpV3Community#community_name}
  */
  readonly communityName?: string;
  /**
  * Context used when performing access control.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_community#context SnmpV3Community#context}
  */
  readonly context?: string;
  /**
  * Security name used when performing access control.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_community#security_name SnmpV3Community#security_name}
  */
  readonly securityName: string;
  /**
  * Tag identifier for set of targets allowed to use this community string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_community#tag SnmpV3Community#tag}
  */
  readonly tag?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_community junos_snmp_v3_community}
*/
export class SnmpV3Community extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SnmpV3Community that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_community#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/snmp_v3_community junos_snmp_v3_community} Resource
  *
  * @param scope The scope in which to define this construct
