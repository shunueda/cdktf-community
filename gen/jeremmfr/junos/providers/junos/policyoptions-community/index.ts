// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_community
...
export interface PolicyoptionsCommunityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_community#dynamic_db PolicyoptionsCommunity#dynamic_db}
  */
  readonly dynamicDb?: boolean | cdktf.IResolvable;
  /**
  * Invert the result of the community expression matching.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_community#invert_match PolicyoptionsCommunity#invert_match}
  */
  readonly invertMatch?: boolean | cdktf.IResolvable;
  /**
  * Community members.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_community#members PolicyoptionsCommunity#members}
  */
  readonly members?: string[];
  /**
  * Name to identify BGP community.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_community#name PolicyoptionsCommunity#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_community junos_policyoptions_community}
*/
export class PolicyoptionsCommunity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyoptionsCommunity that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_community#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/policyoptions_community junos_policyoptions_community} Resource
  *
  * @param scope The scope in which to define this construct
