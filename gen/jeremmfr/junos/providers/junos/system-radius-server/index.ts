// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_radius_server
...
export interface SystemRadiusServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_radius_server#accounting_port SystemRadiusServer#accounting_port}
  */
  readonly accountingPort?: number;
  /**
  * Accounting retry attempts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_radius_server#accounting_retry SystemRadiusServer#accounting_retry}
  */
  readonly accountingRetry?: number;
  /**
  * Accounting request timeout period.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_radius_server#accounting_timeout SystemRadiusServer#accounting_timeout}
  */
  readonly accountingTimeout?: number;
  /**
  * RADIUS server address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_radius_server#address SystemRadiusServer#address}
  */
  readonly address: string;
  /**
  * RADIUS client dynamic request port number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_radius_server#dynamic_request_port SystemRadiusServer#dynamic_request_port}
  */
  readonly dynamicRequestPort?: number;
  /**
  * Maximum requests in flight to server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_radius_server#max_outstanding_requests SystemRadiusServer#max_outstanding_requests}
  */
  readonly maxOutstandingRequests?: number;
  /**
  * RADIUS server authentication port number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_radius_server#port SystemRadiusServer#port}
  */
  readonly port?: number;
  /**
  * RADIUS server preauthentication port number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_radius_server#preauthentication_port SystemRadiusServer#preauthentication_port}
  */
  readonly preauthenticationPort?: number;
  /**
  * Shared secret with the RADIUS server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_radius_server#preauthentication_secret SystemRadiusServer#preauthentication_secret}
  */
  readonly preauthenticationSecret?: string;
  /**
  * Retry attempts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_radius_server#retry SystemRadiusServer#retry}
  */
  readonly retry?: number;
  /**
  * Routing instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_radius_server#routing_instance SystemRadiusServer#routing_instance}
  */
  readonly routingInstance?: string;
  /**
  * Shared secret with the RADIUS server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_radius_server#secret SystemRadiusServer#secret}
  */
  readonly secret: string;
  /**
  * Use specified address as source address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_radius_server#source_address SystemRadiusServer#source_address}
  */
  readonly sourceAddress?: string;
  /**
  * Request timeout period.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_radius_server#timeout SystemRadiusServer#timeout}
  */
  readonly timeout?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_radius_server junos_system_radius_server}
*/
export class SystemRadiusServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemRadiusServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_radius_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_radius_server junos_system_radius_server} Resource
  *
  * @param scope The scope in which to define this construct
