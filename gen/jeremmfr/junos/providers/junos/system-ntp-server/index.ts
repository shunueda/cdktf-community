// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_ntp_server
...
export interface SystemNtpServerConfig extends cdktf.TerraformMetaArguments {
  ...
  * Address of server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_ntp_server#address SystemNtpServer#address}
  */
  readonly address: string;
  /**
  * Authentication key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_ntp_server#key SystemNtpServer#key}
  */
  readonly key?: number;
  /**
  * Prefer this peer_serv.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_ntp_server#prefer SystemNtpServer#prefer}
  */
  readonly prefer?: boolean | cdktf.IResolvable;
  /**
  * Routing instance through which server is reachable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_ntp_server#routing_instance SystemNtpServer#routing_instance}
  */
  readonly routingInstance?: string;
  /**
  * NTP version to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_ntp_server#version SystemNtpServer#version}
  */
  readonly version?: number;
  /**
  * nts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_ntp_server#nts SystemNtpServer#nts}
  */
...
export interface SystemNtpServerNts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_ntp_server#remote_identity_distinguished_name_container SystemNtpServer#remote_identity_distinguished_name_container}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_ntp_server#remote_identity_distinguished_name_wildcard SystemNtpServer#remote_identity_distinguished_name_wildcard}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_ntp_server#remote_identity_hostname SystemNtpServer#remote_identity_hostname}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_ntp_server junos_system_ntp_server}
*/
export class SystemNtpServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemNtpServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_ntp_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_ntp_server junos_system_ntp_server} Resource
  *
  * @param scope The scope in which to define this construct
