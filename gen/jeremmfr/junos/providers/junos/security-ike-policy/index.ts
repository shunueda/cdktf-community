// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_policy
...
export interface SecurityIkePolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_policy#description SecurityIkePolicy#description}
  */
  readonly description?: string;
  /**
  * IKE mode for Phase 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_policy#mode SecurityIkePolicy#mode}
  */
  readonly mode?: string;
  /**
  * The name of IKE policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_policy#name SecurityIkePolicy#name}
  */
  readonly name: string;
  /**
  * Preshared key with format as hexadecimal.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_policy#pre_shared_key_hexa SecurityIkePolicy#pre_shared_key_hexa}
  */
  readonly preSharedKeyHexa?: string;
  /**
  * Preshared key wit format as text.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_policy#pre_shared_key_text SecurityIkePolicy#pre_shared_key_text}
  */
  readonly preSharedKeyText?: string;
  /**
  * Types of default IKE proposal-set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_policy#proposal_set SecurityIkePolicy#proposal_set}
  */
  readonly proposalSet?: string;
  /**
  * IKE proposals list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_policy#proposals SecurityIkePolicy#proposals}
  */
  readonly proposals?: string[];
  /**
  * Re-auth Peer after reauth-frequency times hard lifetime. (0-100)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_policy#reauth_frequency SecurityIkePolicy#reauth_frequency}
  */
  readonly reauthFrequency?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_policy junos_security_ike_policy}
*/
export class SecurityIkePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityIkePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_ike_policy junos_security_ike_policy} Resource
  *
  * @param scope The scope in which to define this construct
