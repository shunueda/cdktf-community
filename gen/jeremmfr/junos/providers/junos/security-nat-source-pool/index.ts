// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_nat_source_pool
...
export interface SecurityNatSourcePoolConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_nat_source_pool#address SecurityNatSourcePool#address}
  */
  readonly address: string[];
  /**
  * Type of address pooling.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_nat_source_pool#address_pooling SecurityNatSourcePool#address_pooling}
  */
  readonly addressPooling?: string;
  /**
  * Text description of pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_nat_source_pool#description SecurityNatSourcePool#description}
  */
  readonly description?: string;
  /**
  * Pool name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_nat_source_pool#name SecurityNatSourcePool#name}
  */
  readonly name: string;
  /**
  * Lower threshold at which an SNMP trap is triggered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_nat_source_pool#pool_utilization_alarm_clear_threshold SecurityNatSourcePool#pool_utilization_alarm_clear_threshold}
  */
  readonly poolUtilizationAlarmClearThreshold?: number;
  /**
  * Upper threshold at which an SNMP trap is triggered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_nat_source_pool#pool_utilization_alarm_raise_threshold SecurityNatSourcePool#pool_utilization_alarm_raise_threshold}
  */
  readonly poolUtilizationAlarmRaiseThreshold?: number;
  /**
  * Do not perform port translation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_nat_source_pool#port_no_translation SecurityNatSourcePool#port_no_translation}
  */
  readonly portNoTranslation?: boolean | cdktf.IResolvable;
  /**
  * Port overloading factor for each IP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_nat_source_pool#port_overloading_factor SecurityNatSourcePool#port_overloading_factor}
  */
  readonly portOverloadingFactor?: number;
  /**
  * Range of port to source nat.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_nat_source_pool#port_range SecurityNatSourcePool#port_range}
  */
  readonly portRange?: string;
  /**
  * Name of routing instance to switch instance with nat.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_nat_source_pool#routing_instance SecurityNatSourcePool#routing_instance}
  */
  readonly routingInstance?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_nat_source_pool junos_security_nat_source_pool}
*/
export class SecurityNatSourcePool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityNatSourcePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_nat_source_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_nat_source_pool junos_security_nat_source_pool} Resource
  *
  * @param scope The scope in which to define this construct
