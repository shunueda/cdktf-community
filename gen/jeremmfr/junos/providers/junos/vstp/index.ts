// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp
...
export interface VstpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp#bpdu_block_on_edge Vstp#bpdu_block_on_edge}
  */
  readonly bpduBlockOnEdge?: boolean | cdktf.IResolvable;
  /**
  * Disable STP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp#disable Vstp#disable}
  */
  readonly disable?: boolean | cdktf.IResolvable;
  /**
  * Force protocol version STP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp#force_version_stp Vstp#force_version_stp}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp#priority_hold_time Vstp#priority_hold_time}
  */
  readonly priorityHoldTime?: number;
  /**
  * Routing instance for vstp protocol if not root level.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp#routing_instance Vstp#routing_instance}
  */
  readonly routingInstance?: string;
  /**
  * Enable VPLS MAC flush on root protected CE interface receiving topology change.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp#vpls_flush_on_topology_change Vstp#vpls_flush_on_topology_change}
  */
  readonly vplsFlushOnTopologyChange?: boolean | cdktf.IResolvable;
  /**
  * system_id block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp#system_id Vstp#system_id}
  */
...
export interface VstpSystemId {
  ...
  * System ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp#id Vstp#id}
  *
  ...
  * Peer ID (IP Address).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp#ip_address Vstp#ip_address}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp junos_vstp}
*/
export class Vstp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Vstp that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/vstp junos_vstp} Resource
  *
  * @param scope The scope in which to define this construct
