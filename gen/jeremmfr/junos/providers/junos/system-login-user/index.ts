// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_login_user
...
export interface SystemLoginUserConfig extends cdktf.TerraformMetaArguments {
  ...
  * Login class.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_login_user#class SystemLoginUser#class}
  */
  readonly class: string;
  /**
  * Cli prompt name for this user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_login_user#cli_prompt SystemLoginUser#cli_prompt}
  */
  readonly cliPrompt?: string;
  /**
  * Full name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_login_user#full_name SystemLoginUser#full_name}
  */
  readonly fullName?: string;
  /**
  * The name of system login user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_login_user#name SystemLoginUser#name}
  */
  readonly name: string;
  /**
  * User identifier (uid).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_login_user#uid SystemLoginUser#uid}
  */
  readonly uid?: number;
  /**
  * authentication block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_login_user#authentication SystemLoginUser#authentication}
  */
...
export interface SystemLoginUserAuthentication {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_login_user#encrypted_password SystemLoginUser#encrypted_password}
  */
  readonly encryptedPassword?: string;
  /**
  * Disables ssh public key based authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_login_user#no_public_keys SystemLoginUser#no_public_keys}
  */
  readonly noPublicKeys?: boolean | cdktf.IResolvable;
  /**
  * Plain text password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_login_user#plain_text_password SystemLoginUser#plain_text_password}
  */
  readonly plainTextPassword?: string;
  /**
  * Secure shell (ssh) public key string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_login_user#ssh_public_keys SystemLoginUser#ssh_public_keys}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_login_user junos_system_login_user}
*/
export class SystemLoginUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemLoginUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_login_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_login_user junos_system_login_user} Resource
  *
  * @param scope The scope in which to define this construct
