// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_message
...
export interface SecurityUtmCustomMessageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_message#content SecurityUtmCustomMessage#content}
  */
  readonly content?: string;
  /**
  * Name of custom page file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_message#custom_page_file SecurityUtmCustomMessage#custom_page_file}
  */
  readonly customPageFile?: string;
  /**
  * The name of security utm custom-object custom-message.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_message#name SecurityUtmCustomMessage#name}
  */
  readonly name: string;
  /**
  * Type of custom message.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_message#type SecurityUtmCustomMessage#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_message junos_security_utm_custom_message}
*/
export class SecurityUtmCustomMessage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityUtmCustomMessage that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_message#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_message junos_security_utm_custom_message} Resource
  *
  * @param scope The scope in which to define this construct
