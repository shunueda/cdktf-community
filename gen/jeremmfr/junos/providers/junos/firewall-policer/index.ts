// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer
...
export interface FirewallPolicerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer#filter_specific FirewallPolicer#filter_specific}
  */
  readonly filterSpecific?: boolean | cdktf.IResolvable;
  /**
  * Policer uses logical interface bandwidth.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer#logical_bandwidth_policer FirewallPolicer#logical_bandwidth_policer}
  */
  readonly logicalBandwidthPolicer?: boolean | cdktf.IResolvable;
  /**
  * Policer is logical interface policer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer#logical_interface_policer FirewallPolicer#logical_interface_policer}
  */
  readonly logicalInterfacePolicer?: boolean | cdktf.IResolvable;
  /**
  * Policer name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer#name FirewallPolicer#name}
  */
  readonly name: string;
  /**
  * Policer is physical interface policer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer#physical_interface_policer FirewallPolicer#physical_interface_policer}
  */
  readonly physicalInterfacePolicer?: boolean | cdktf.IResolvable;
  /**
  * Share policer bandwidth among bundle links.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer#shared_bandwidth_policer FirewallPolicer#shared_bandwidth_policer}
  */
  readonly sharedBandwidthPolicer?: boolean | cdktf.IResolvable;
  /**
  * if_exceeding block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer#if_exceeding FirewallPolicer#if_exceeding}
  */
  readonly ifExceeding?: FirewallPolicerIfExceeding;
  /**
  * if_exceeding_pps block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer#if_exceeding_pps FirewallPolicer#if_exceeding_pps}
  */
  readonly ifExceedingPps?: FirewallPolicerIfExceedingPps;
  /**
  * then block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer#then FirewallPolicer#then}
  */
...
export interface FirewallPolicerIfExceeding {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer#bandwidth_limit FirewallPolicer#bandwidth_limit}
  */
  readonly bandwidthLimit?: string;
  /**
  * Bandwidth limit in percentage (1..100 percent).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer#bandwidth_percent FirewallPolicer#bandwidth_percent}
  */
  readonly bandwidthPercent?: number;
  /**
  * Burst size limit in bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer#burst_size_limit FirewallPolicer#burst_size_limit}
  */
...
export interface FirewallPolicerIfExceedingPps {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer#packet_burst FirewallPolicer#packet_burst}
  */
  readonly packetBurst?: string;
  /**
  * PPS limit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer#pps_limit FirewallPolicer#pps_limit}
  */
...
export interface FirewallPolicerThen {
  ...
  * Discard the packet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer#discard FirewallPolicer#discard}
  */
  readonly discard?: boolean | cdktf.IResolvable;
  /**
  * Classify packet to forwarding class.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer#forwarding_class FirewallPolicer#forwarding_class}
  */
  readonly forwardingClass?: string;
  /**
  * Packet's loss priority.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer#loss_priority FirewallPolicer#loss_priority}
  */
  readonly lossPriority?: string;
  /**
  * Discard packets only if both congested and over threshold.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer#out_of_profile FirewallPolicer#out_of_profile}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer junos_firewall_policer}
*/
export class FirewallPolicer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FirewallPolicer that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/firewall_policer junos_firewall_policer} Resource
  *
  * @param scope The scope in which to define this construct
