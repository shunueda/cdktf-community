// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/eventoptions_generate_event
...
export interface EventoptionsGenerateEventConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/eventoptions_generate_event#name EventoptionsGenerateEvent#name}
  */
  readonly name: string;
  /**
  * Avoid event generation delay propagating to next event.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/eventoptions_generate_event#no_drift EventoptionsGenerateEvent#no_drift}
  */
  readonly noDrift?: boolean | cdktf.IResolvable;
  /**
  * Start-time to generate event.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/eventoptions_generate_event#start_time EventoptionsGenerateEvent#start_time}
  */
  readonly startTime?: string;
  /**
  * Frequency for generating the event.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/eventoptions_generate_event#time_interval EventoptionsGenerateEvent#time_interval}
  */
  readonly timeInterval?: number;
  /**
  * Time of day at which to generate event.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/eventoptions_generate_event#time_of_day EventoptionsGenerateEvent#time_of_day}
  */
  readonly timeOfDay?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/eventoptions_generate_event junos_eventoptions_generate_event}
*/
export class EventoptionsGenerateEvent extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EventoptionsGenerateEvent that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/eventoptions_generate_event#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/eventoptions_generate_event junos_eventoptions_generate_event} Resource
  *
  * @param scope The scope in which to define this construct
