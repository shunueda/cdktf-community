// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/interface_logical_info
...
export interface DataJunosInterfaceLogicalInfoConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/interface_logical_info#name DataJunosInterfaceLogicalInfo#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/interface_logical_info junos_interface_logical_info}
*/
export class DataJunosInterfaceLogicalInfo extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataJunosInterfaceLogicalInfo that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/interface_logical_info#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/interface_logical_info junos_interface_logical_info} Data Source
  *
  * @param scope The scope in which to define this construct
