// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/interface_physical
...
export interface DataJunosInterfacePhysicalConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/interface_physical#config_interface DataJunosInterfacePhysical#config_interface}
  */
  readonly configInterface?: string;
  /**
  * Regex string to filter lines and find only one interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/interface_physical#match DataJunosInterfacePhysical#match}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/interface_physical junos_interface_physical}
*/
export class DataJunosInterfacePhysical extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataJunosInterfacePhysical that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/interface_physical#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/data-sources/interface_physical junos_interface_physical} Data Source
  *
  * @param scope The scope in which to define this construct
