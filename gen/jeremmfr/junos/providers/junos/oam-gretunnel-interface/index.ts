// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/oam_gretunnel_interface
...
export interface OamGretunnelInterfaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/oam_gretunnel_interface#hold_time OamGretunnelInterface#hold_time}
  */
  readonly holdTime?: number;
  /**
  * Keepalive time (1..50 seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/oam_gretunnel_interface#keepalive_time OamGretunnelInterface#keepalive_time}
  */
  readonly keepaliveTime?: number;
  /**
  * Name of interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/oam_gretunnel_interface#name OamGretunnelInterface#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/oam_gretunnel_interface junos_oam_gretunnel_interface}
*/
export class OamGretunnelInterface extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OamGretunnelInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/oam_gretunnel_interface#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/oam_gretunnel_interface junos_oam_gretunnel_interface} Resource
  *
  * @param scope The scope in which to define this construct
