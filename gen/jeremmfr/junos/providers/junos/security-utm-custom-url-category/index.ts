// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_url_category
...
export interface SecurityUtmCustomUrlCategoryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_url_category#name SecurityUtmCustomUrlCategory#name}
  */
  readonly name: string;
  /**
  * List of url patterns for security utm custom-object custom-url-category.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_url_category#value SecurityUtmCustomUrlCategory#value}
  */
  readonly value: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_url_category junos_security_utm_custom_url_category}
*/
export class SecurityUtmCustomUrlCategory extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityUtmCustomUrlCategory that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_url_category#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/security_utm_custom_url_category junos_security_utm_custom_url_category} Resource
  *
  * @param scope The scope in which to define this construct
