// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user
...
export interface SystemSyslogUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#allow_duplicates SystemSyslogUser#allow_duplicates}
  */
  readonly allowDuplicates?: boolean | cdktf.IResolvable;
  /**
  * All facilities sseverity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#any_severity SystemSyslogUser#any_severity}
  */
  readonly anySeverity?: string;
  /**
  * Authorization system severity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#authorization_severity SystemSyslogUser#authorization_severity}
  */
  readonly authorizationSeverity?: string;
  /**
  * Configuration change log severity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#changelog_severity SystemSyslogUser#changelog_severity}
  */
  readonly changelogSeverity?: string;
  /**
  * Configuration conflict log severity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#conflictlog_severity SystemSyslogUser#conflictlog_severity}
  */
  readonly conflictlogSeverity?: string;
  /**
  * Various system processes severity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#daemon_severity SystemSyslogUser#daemon_severity}
  */
  readonly daemonSeverity?: string;
  /**
  * Dynamic flow capture severity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#dfc_severity SystemSyslogUser#dfc_severity}
  */
  readonly dfcSeverity?: string;
  /**
  * Local external applications severity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#external_severity SystemSyslogUser#external_severity}
  */
  readonly externalSeverity?: string;
  /**
  * Firewall filtering system severity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#firewall_severity SystemSyslogUser#firewall_severity}
  */
  readonly firewallSeverity?: string;
  /**
  * FTP process severity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#ftp_severity SystemSyslogUser#ftp_severity}
  */
  readonly ftpSeverity?: string;
  /**
  * Commands executed by the UI severity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#interactivecommands_severity SystemSyslogUser#interactivecommands_severity}
  */
  readonly interactivecommandsSeverity?: string;
  /**
  * Kernel severity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#kernel_severity SystemSyslogUser#kernel_severity}
  */
  readonly kernelSeverity?: string;
  /**
  * Regular expression for lines to be logged.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#match SystemSyslogUser#match}
  */
  readonly match?: string;
  /**
  * Matching string(s) for lines to be logged.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#match_strings SystemSyslogUser#match_strings}
  */
  readonly matchStrings?: string[];
  /**
  * NTP process severity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#ntp_severity SystemSyslogUser#ntp_severity}
  */
  readonly ntpSeverity?: string;
  /**
  * Packet Forwarding Engine severity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#pfe_severity SystemSyslogUser#pfe_severity}
  */
  readonly pfeSeverity?: string;
  /**
  * Security related severity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#security_severity SystemSyslogUser#security_severity}
  */
  readonly securitySeverity?: string;
  /**
  * User processes severity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#user_severity SystemSyslogUser#user_severity}
  */
  readonly userSeverity?: string;
  /**
  * Name of user to notify (or `*` for all).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#username SystemSyslogUser#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user junos_system_syslog_user}
*/
export class SystemSyslogUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemSyslogUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/system_syslog_user junos_system_syslog_user} Resource
  *
  * @param scope The scope in which to define this construct
