// https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_evpn_vxlan
...
export interface ForwardingoptionsEvpnVxlanConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_evpn_vxlan#routing_instance ForwardingoptionsEvpnVxlan#routing_instance}
  */
  readonly routingInstance?: string;
  /**
  * Create VTEP tunnels to EVPN PE.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_evpn_vxlan#shared_tunnels ForwardingoptionsEvpnVxlan#shared_tunnels}
  */
  readonly sharedTunnels?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_evpn_vxlan junos_forwardingoptions_evpn_vxlan}
*/
export class ForwardingoptionsEvpnVxlan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ForwardingoptionsEvpnVxlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_evpn_vxlan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.14.0/docs/resources/forwardingoptions_evpn_vxlan junos_forwardingoptions_evpn_vxlan} Resource
  *
  * @param scope The scope in which to define this construct
