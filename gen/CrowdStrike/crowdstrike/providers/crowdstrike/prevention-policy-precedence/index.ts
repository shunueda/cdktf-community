// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.39/docs/resources/prevention_policy_precedence
...
export interface PreventionPolicyPrecedenceConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.39/docs/resources/prevention_policy_precedence#enforcement PreventionPolicyPrecedence#enforcement}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.39/docs/resources/prevention_policy_precedence#ids PreventionPolicyPrecedence#ids}
  */
  readonly ids: string[];
  /**
  * That platform of the prevention policies. (Windows, Mac, Linux)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.39/docs/resources/prevention_policy_precedence#platform_name PreventionPolicyPrecedence#platform_name}
  */
  readonly platformName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.39/docs/resources/prevention_policy_precedence crowdstrike_prevention_policy_precedence}
*/
export class PreventionPolicyPrecedence extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "crowdstrike_prevention_policy_precedence";
  ...
  * @param importFromId The id of the existing PreventionPolicyPrecedence that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.39/docs/resources/prevention_policy_precedence#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "crowdstrike_prevention_policy_precedence", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.39/docs/resources/prevention_policy_precedence crowdstrike_prevention_policy_precedence} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options PreventionPolicyPrecedenceConfig
  */
  public constructor(scope: Construct, id: string, config: PreventionPolicyPrecedenceConfig) {
    super(scope, id, {
