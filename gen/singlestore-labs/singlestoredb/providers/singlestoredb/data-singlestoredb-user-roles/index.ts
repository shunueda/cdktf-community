// https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/data-sources/user_roles
...
export interface DataSinglestoredbUserRolesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/data-sources/user_roles#user_id DataSinglestoredbUserRoles#user_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/data-sources/user_roles singlestoredb_user_roles}
*/
export class DataSinglestoredbUserRoles extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSinglestoredbUserRoles that should be imported. Refer to the {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/data-sources/user_roles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/data-sources/user_roles singlestoredb_user_roles} Data Source
  *
  * @param scope The scope in which to define this construct
