// https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/resources/workspace_group
...
export interface WorkspaceGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/resources/workspace_group#admin_password WorkspaceGroup#admin_password}
  */
  readonly adminPassword?: string;
  /**
  * The name of the cloud provider used to resolve region. Possible values are 'AWS', 'GCP', and 'Azure'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/resources/workspace_group#cloud_provider WorkspaceGroup#cloud_provider}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/resources/workspace_group#deployment_type WorkspaceGroup#deployment_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/resources/workspace_group#expires_at WorkspaceGroup#expires_at}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/resources/workspace_group#firewall_ranges WorkspaceGroup#firewall_ranges}
  */
  readonly firewallRanges: string[];
  /**
  * Enables deployment across two Availability Zones.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/resources/workspace_group#high_availability_two_zones WorkspaceGroup#high_availability_two_zones}
  */
  readonly highAvailabilityTwoZones?: boolean | cdktf.IResolvable;
  /**
  * Name of the workspace group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/resources/workspace_group#name WorkspaceGroup#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/resources/workspace_group#opt_in_preview_feature WorkspaceGroup#opt_in_preview_feature}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/resources/workspace_group#region_id WorkspaceGroup#region_id}
  */
  readonly regionId?: string;
  /**
  * The region code name used to resolve region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/resources/workspace_group#region_name WorkspaceGroup#region_name}
  */
  readonly regionName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/resources/workspace_group singlestoredb_workspace_group}
*/
export class WorkspaceGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkspaceGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/resources/workspace_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/resources/workspace_group singlestoredb_workspace_group} Resource
  *
  * @param scope The scope in which to define this construct
