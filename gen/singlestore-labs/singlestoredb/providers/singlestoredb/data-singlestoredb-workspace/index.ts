// https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/data-sources/workspace
...
export interface DataSinglestoredbWorkspaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/data-sources/workspace#id DataSinglestoredbWorkspace#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/data-sources/workspace singlestoredb_workspace}
*/
export class DataSinglestoredbWorkspace extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSinglestoredbWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/data-sources/workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.5/docs/data-sources/workspace singlestoredb_workspace} Data Source
  *
  * @param scope The scope in which to define this construct
