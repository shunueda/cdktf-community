...
export interface GraphConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Type, one of: normal, stacked, pie, exploded
  *
  ...
  */
  ...
  /**
  * Y Axis Max Type, one of: fixed, item, calculated
  *
  ...
  */
  ...
  /**
  * Y Axis Min Type, one of: fixed, item, calculated
  *
...
export interface GraphItem {
  ...
  */
  ...
  /**
  * Draw Type, one of: dashed, gradient, line, filled, bold, dot
  *
  ...
  */
  ...
  /**
  * Function, one of: all, last, min, average, max
  *
