// https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp
...
export interface ItemSnmpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Application IDs to associate this item with
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#applications ItemSnmp#applications}
  */
  readonly applications?: string[];
  /**
  * Item Delay period
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#delay ItemSnmp#delay}
  */
  readonly delay?: string;
  /**
  * Item History
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#history ItemSnmp#history}
  */
  readonly history?: string;
  /**
  * Host ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#hostid ItemSnmp#hostid}
  */
  readonly hostid: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#id ItemSnmp#id}
  *
  ...
  * Host Interface ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#interfaceid ItemSnmp#interfaceid}
  */
  readonly interfaceid?: string;
  /**
  * Item KEY
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#key ItemSnmp#key}
  */
  readonly key: string;
  /**
  * Item Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#name ItemSnmp#name}
  */
  readonly name: string;
  /**
  * Authentication Passphrase (v3 only)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#snmp3_authpassphrase ItemSnmp#snmp3_authpassphrase}
  */
  readonly snmp3Authpassphrase?: string;
  /**
  * Authentication Protocol (v3 only), one of: md5, sha
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#snmp3_authprotocol ItemSnmp#snmp3_authprotocol}
  */
  readonly snmp3Authprotocol?: string;
  /**
  * Context Name (v3 only)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#snmp3_contextname ItemSnmp#snmp3_contextname}
  */
  readonly snmp3Contextname?: string;
  /**
  * Priv Passphrase (v3 only)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#snmp3_privpassphrase ItemSnmp#snmp3_privpassphrase}
  */
  readonly snmp3Privpassphrase?: string;
  /**
  * Priv Protocol (v3 only), one of: aes, des
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#snmp3_privprotocol ItemSnmp#snmp3_privprotocol}
  */
  readonly snmp3Privprotocol?: string;
  /**
  * Security Level (v3 only), one of: authpriv, noauthnopriv, authnopriv
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#snmp3_securitylevel ItemSnmp#snmp3_securitylevel}
  */
  readonly snmp3Securitylevel?: string;
  /**
  * Security Name (v3 only)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#snmp3_securityname ItemSnmp#snmp3_securityname}
  */
  readonly snmp3Securityname?: string;
  /**
  * SNMP Community (v1/v2 only)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#snmp_community ItemSnmp#snmp_community}
  */
  readonly snmpCommunity?: string;
  /**
  * SNMP OID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#snmp_oid ItemSnmp#snmp_oid}
  */
  readonly snmpOid: string;
  /**
  * SNMP Version, one of: 1, 2, 3
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#snmp_version ItemSnmp#snmp_version}
  */
  readonly snmpVersion?: string;
  /**
  * Item Trends
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#trends ItemSnmp#trends}
  */
  readonly trends?: string;
  /**
  * Item Value Type, one of: float, character, log, unsigned, text
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#valuetype ItemSnmp#valuetype}
  */
  readonly valuetype: string;
  /**
  * preprocessor block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#preprocessor ItemSnmp#preprocessor}
  */
  readonly preprocessor?: ItemSnmpPreprocessor[] | cdktf.IResolvable;
  /**
  * tag block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#tag ItemSnmp#tag}
  */
  readonly tag?: ItemSnmpTag[] | cdktf.IResolvable;
}
export interface ItemSnmpPreprocessor {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#error_handler ItemSnmp#error_handler}
  */
  readonly errorHandler?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#error_handler_params ItemSnmp#error_handler_params}
  */
  readonly errorHandlerParams?: string;
  /**
  * Preprocessor parameters
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#params ItemSnmp#params}
  */
  readonly params?: string[];
  /**
  * Preprocessor type, zabbix identifier number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#type ItemSnmp#type}
  */
  readonly type: string;
}

export function itemSnmpPreprocessorToTerraform(struct?: ItemSnmpPreprocessor | cdktf.IResolvable): any {
...
export function itemSnmpPreprocessorToHclTerraform(struct?: ItemSnmpPreprocessor | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ItemSnmpPreprocessorOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ItemSnmpPreprocessor | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ItemSnmpPreprocessor | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ItemSnmpPreprocessorList extends cdktf.ComplexList {
  public internalValue? : ItemSnmpPreprocessor[] | cdktf.IResolvable
  ...
  */
  public get(index: number): ItemSnmpPreprocessorOutputReference {
    return new ItemSnmpPreprocessorOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface ItemSnmpTag {
  ...
  * Tag Value
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#value ItemSnmp#value}
  */
  readonly value?: string;
}

export function itemSnmpTagToTerraform(struct?: ItemSnmpTag | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function itemSnmpTagToHclTerraform(struct?: ItemSnmpTag | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ItemSnmpTagOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): ItemSnmpTag | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: ItemSnmpTag | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._key = undefined;
...
export class ItemSnmpTagList extends cdktf.ComplexList {
  public internalValue? : ItemSnmpTag[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): ItemSnmpTagOutputReference {
    return new ItemSnmpTagOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp zabbix_item_snmp}
*/
export class ItemSnmp extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "zabbix_item_snmp";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a ItemSnmp resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the ItemSnmp to import
  * @param importFromId The id of the existing ItemSnmp that should be imported. Refer to the {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ItemSnmp to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "zabbix_item_snmp", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tpretz/zabbix/0.17.0/docs/resources/item_snmp zabbix_item_snmp} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ItemSnmpConfig
  */
  public constructor(scope: Construct, id: string, config: ItemSnmpConfig) {
    super(scope, id, {
      terraformResourceType: 'zabbix_item_snmp',
  ...
  private _preprocessor = new ItemSnmpPreprocessorList(this, "preprocessor", false);
  public get preprocessor() {
    return this._preprocessor;
  }
  public putPreprocessor(value: ItemSnmpPreprocessor[] | cdktf.IResolvable) {
  ...
  private _tag = new ItemSnmpTagList(this, "tag", true);
  public get tag() {
    return this._tag;
  }
  public putTag(value: ItemSnmpTag[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      preprocessor: cdktf.listMapper(itemSnmpPreprocessorToTerraform, true)(this._preprocessor.internalValue),
      tag: cdktf.listMapper(itemSnmpTagToTerraform, true)(this._tag.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      preprocessor: {
        value: cdktf.listMapperHcl(itemSnmpPreprocessorToHclTerraform, true)(this._preprocessor.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ItemSnmpPreprocessorList",
      },
      tag: {
        value: cdktf.listMapperHcl(itemSnmpTagToHclTerraform, true)(this._tag.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "ItemSnmpTagList",
      },
    };
