// https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ngt_insert_iso_v2
...
export interface NgtInsertIsoV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ngt_insert_iso_v2#capablities NgtInsertIsoV2#capablities}
  */
  readonly capablities?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ngt_insert_iso_v2#ext_id NgtInsertIsoV2#ext_id}
  */
  readonly extId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ngt_insert_iso_v2#id NgtInsertIsoV2#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ngt_insert_iso_v2#is_config_only NgtInsertIsoV2#is_config_only}
  */
  readonly isConfigOnly?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ngt_insert_iso_v2 nutanix_ngt_insert_iso_v2}
*/
export class NgtInsertIsoV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NgtInsertIsoV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ngt_insert_iso_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ngt_insert_iso_v2 nutanix_ngt_insert_iso_v2} Resource
  *
  * @param scope The scope in which to define this construct
