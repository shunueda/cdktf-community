// https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs
...
export interface NutanixProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs#endpoint NutanixProvider#endpoint}
  */
  readonly endpoint?: string;
  /**
  * endpoint for foundation VM (eg. Foundation VM IP)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs#foundation_endpoint NutanixProvider#foundation_endpoint}
  */
  readonly foundationEndpoint?: string;
  /**
  * Port for foundation VM
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs#foundation_port NutanixProvider#foundation_port}
  */
  readonly foundationPort?: string;
  /**
  * Explicitly allow the provider to perform "insecure" SSL requests. If omitted,default value is `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs#insecure NutanixProvider#insecure}
  */
  readonly insecure?: boolean | cdktf.IResolvable;
  /**
  * endpoint for Era VM (era ip)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs#ndb_endpoint NutanixProvider#ndb_endpoint}
  */
  readonly ndbEndpoint?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs#ndb_password NutanixProvider#ndb_password}
  */
  readonly ndbPassword?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs#ndb_username NutanixProvider#ndb_username}
  */
  readonly ndbUsername?: string;
  /**
  * Password for provided user name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs#password NutanixProvider#password}
  */
  readonly password?: string;
  /**
  * Port for Nutanix Prism.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs#port NutanixProvider#port}
  */
  readonly port?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs#proxy_url NutanixProvider#proxy_url}
  */
  readonly proxyUrl?: string;
  /**
  * Use session authentification instead of basic auth for each request
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs#session_auth NutanixProvider#session_auth}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs#username NutanixProvider#username}
  */
  readonly username?: string;
  /**
  * Set if you know that the creation o update of a resource may take long time (minutes)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs#wait_timeout NutanixProvider#wait_timeout}
  */
  readonly waitTimeout?: number;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs#alias NutanixProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs nutanix}
*/
export class NutanixProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing NutanixProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs nutanix} Resource
  *
  * @param scope The scope in which to define this construct
