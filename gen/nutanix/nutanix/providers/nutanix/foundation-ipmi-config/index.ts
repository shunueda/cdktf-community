// https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/foundation_ipmi_config
...
export interface FoundationIpmiConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/foundation_ipmi_config#id FoundationIpmiConfig#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/foundation_ipmi_config#ipmi_gateway FoundationIpmiConfig#ipmi_gateway}
  */
  readonly ipmiGateway: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/foundation_ipmi_config#ipmi_netmask FoundationIpmiConfig#ipmi_netmask}
  */
  readonly ipmiNetmask: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/foundation_ipmi_config#ipmi_password FoundationIpmiConfig#ipmi_password}
  */
  readonly ipmiPassword: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/foundation_ipmi_config#ipmi_user FoundationIpmiConfig#ipmi_user}
  */
  readonly ipmiUser: string;
  /**
  * blocks block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/foundation_ipmi_config#blocks FoundationIpmiConfig#blocks}
  */
  readonly blocks: FoundationIpmiConfigBlocks[] | cdktf.IResolvable;
}
export interface FoundationIpmiConfigBlocksNodes {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/foundation_ipmi_config#ipmi_configure_now FoundationIpmiConfig#ipmi_configure_now}
  */
  readonly ipmiConfigureNow: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/foundation_ipmi_config#ipmi_ip FoundationIpmiConfig#ipmi_ip}
  */
  readonly ipmiIp: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/foundation_ipmi_config#ipmi_mac FoundationIpmiConfig#ipmi_mac}
  */
...
export interface FoundationIpmiConfigBlocks {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/foundation_ipmi_config#block_id FoundationIpmiConfig#block_id}
  */
  readonly blockId?: string;
  /**
  * nodes block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/foundation_ipmi_config#nodes FoundationIpmiConfig#nodes}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/foundation_ipmi_config nutanix_foundation_ipmi_config}
*/
export class FoundationIpmiConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FoundationIpmiConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/foundation_ipmi_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/foundation_ipmi_config nutanix_foundation_ipmi_config} Resource
  *
  * @param scope The scope in which to define this construct
