// https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_sla
...
export interface NdbSlaConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_sla#continuous_retention NdbSla#continuous_retention}
  */
  readonly continuousRetention?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_sla#daily_retention NdbSla#daily_retention}
  */
  readonly dailyRetention?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_sla#description NdbSla#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_sla#id NdbSla#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_sla#monthly_retention NdbSla#monthly_retention}
  */
  readonly monthlyRetention?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_sla#name NdbSla#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_sla#quarterly_retention NdbSla#quarterly_retention}
  */
  readonly quarterlyRetention?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_sla#weekly_retention NdbSla#weekly_retention}
  */
  readonly weeklyRetention?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_sla#yearly_retention NdbSla#yearly_retention}
  */
  readonly yearlyRetention?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_sla nutanix_ndb_sla}
*/
export class NdbSla extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NdbSla that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_sla#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_sla nutanix_ndb_sla} Resource
  *
  * @param scope The scope in which to define this construct
