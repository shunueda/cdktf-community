// https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_clone_refresh
...
export interface NdbCloneRefreshConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_clone_refresh#clone_id NdbCloneRefresh#clone_id}
  */
  readonly cloneId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_clone_refresh#id NdbCloneRefresh#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_clone_refresh#snapshot_id NdbCloneRefresh#snapshot_id}
  */
  readonly snapshotId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_clone_refresh#timezone NdbCloneRefresh#timezone}
  */
  readonly timezone?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_clone_refresh#user_pitr_timestamp NdbCloneRefresh#user_pitr_timestamp}
  */
  readonly userPitrTimestamp?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_clone_refresh#timeouts NdbCloneRefresh#timeouts}
  */
  readonly timeouts?: NdbCloneRefreshTimeouts;
}
export interface NdbCloneRefreshTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_clone_refresh#create NdbCloneRefresh#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_clone_refresh nutanix_ndb_clone_refresh}
*/
export class NdbCloneRefresh extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NdbCloneRefresh that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_clone_refresh#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/ndb_clone_refresh nutanix_ndb_clone_refresh} Resource
  *
  * @param scope The scope in which to define this construct
