// https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip
...
export interface FloatingIpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip#api_version FloatingIp#api_version}
  */
  readonly apiVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip#external_subnet_reference_name FloatingIp#external_subnet_reference_name}
  */
  readonly externalSubnetReferenceName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip#external_subnet_reference_uuid FloatingIp#external_subnet_reference_uuid}
  */
  readonly externalSubnetReferenceUuid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip#id FloatingIp#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip#private_ip FloatingIp#private_ip}
  */
  readonly privateIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip#vm_nic_reference_uuid FloatingIp#vm_nic_reference_uuid}
  */
  readonly vmNicReferenceUuid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip#vpc_reference_name FloatingIp#vpc_reference_name}
  */
  readonly vpcReferenceName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip#vpc_reference_uuid FloatingIp#vpc_reference_uuid}
  */
  readonly vpcReferenceUuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip nutanix_floating_ip}
*/
export class FloatingIp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FloatingIp that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip nutanix_floating_ip} Resource
  *
  * @param scope The scope in which to define this construct
