// https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/user_groups
...
export interface UserGroupsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/user_groups#id UserGroups#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/user_groups#owner_reference UserGroups#owner_reference}
  */
  readonly ownerReference?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/user_groups#project_reference UserGroups#project_reference}
  */
  readonly projectReference?: { [key: string]: string };
  /**
  * categories block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/user_groups#categories UserGroups#categories}
  */
  readonly categories?: UserGroupsCategories[] | cdktf.IResolvable;
  /**
  * directory_service_ou block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/user_groups#directory_service_ou UserGroups#directory_service_ou}
  */
  readonly directoryServiceOu?: UserGroupsDirectoryServiceOu[] | cdktf.IResolvable;
  /**
  * directory_service_user_group block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/user_groups#directory_service_user_group UserGroups#directory_service_user_group}
  */
  readonly directoryServiceUserGroup?: UserGroupsDirectoryServiceUserGroup[] | cdktf.IResolvable;
  /**
  * saml_user_group block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/user_groups#saml_user_group UserGroups#saml_user_group}
  */
  readonly samlUserGroup?: UserGroupsSamlUserGroup[] | cdktf.IResolvable;
}
export interface UserGroupsCategories {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/user_groups#name UserGroups#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/user_groups#value UserGroups#value}
  */
...
export interface UserGroupsDirectoryServiceOu {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/user_groups#distinguished_name UserGroups#distinguished_name}
  */
...
export interface UserGroupsSamlUserGroup {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/user_groups#idp_uuid UserGroups#idp_uuid}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/user_groups nutanix_user_groups}
*/
export class UserGroups extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/user_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/user_groups nutanix_user_groups} Resource
  *
  * @param scope The scope in which to define this construct
