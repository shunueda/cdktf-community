...
export interface TemplateV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/template_v2#id TemplateV2#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/template_v2#template_description TemplateV2#template_description}
  */
  readonly templateDescription?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/template_v2#template_name TemplateV2#template_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/template_v2#guest_update_status TemplateV2#guest_update_status}
  */
  readonly guestUpdateStatus?: TemplateV2GuestUpdateStatus[] | cdktf.IResolvable;
  /**
  * template_version_spec block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/template_v2#template_version_spec TemplateV2#template_version_spec}
  */
  readonly templateVersionSpec: TemplateV2TemplateVersionSpec;
  /**
  * updated_by block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/template_v2#updated_by TemplateV2#updated_by}
  */
  readonly updatedBy?: TemplateV2UpdatedBy[] | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/template_v2 nutanix_template_v2}
*/
export class TemplateV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TemplateV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/template_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/template_v2 nutanix_template_v2} Resource
  *
  * @param scope The scope in which to define this construct
