...
export interface FloatingIpV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip_v2#description FloatingIpV2#description}
  */
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip_v2#external_subnet_reference FloatingIpV2#external_subnet_reference}
  */
  readonly externalSubnetReference?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip_v2#id FloatingIpV2#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip_v2#load_balancer_session_reference FloatingIpV2#load_balancer_session_reference}
  */
  readonly loadBalancerSessionReference?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip_v2#name FloatingIpV2#name}
  */
  ...
  * association block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip_v2#association FloatingIpV2#association}
  */
  readonly association?: FloatingIpV2Association[] | cdktf.IResolvable;
  /**
  * external_subnet block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip_v2#external_subnet FloatingIpV2#external_subnet}
  */
  readonly externalSubnet?: FloatingIpV2ExternalSubnet[] | cdktf.IResolvable;
  /**
  * floating_ip block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip_v2#floating_ip FloatingIpV2#floating_ip}
  */
  readonly floatingIp?: FloatingIpV2FloatingIp[] | cdktf.IResolvable;
  /**
  * vm_nic block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip_v2#vm_nic FloatingIpV2#vm_nic}
  */
  readonly vmNic?: FloatingIpV2VmNic[] | cdktf.IResolvable;
  /**
  * vpc block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip_v2#vpc FloatingIpV2#vpc}
  */
  readonly vpc?: FloatingIpV2Vpc[] | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip_v2 nutanix_floating_ip_v2}
*/
export class FloatingIpV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FloatingIpV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/floating_ip_v2 nutanix_floating_ip_v2} Resource
  *
  * @param scope The scope in which to define this construct
