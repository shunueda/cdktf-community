// https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/lcm_upgrade_v2
...
export interface LcmUpgradeV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/lcm_upgrade_v2#auto_handle_flags LcmUpgradeV2#auto_handle_flags}
  */
  readonly autoHandleFlags?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/lcm_upgrade_v2#id LcmUpgradeV2#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/lcm_upgrade_v2#max_wait_time_in_secs LcmUpgradeV2#max_wait_time_in_secs}
  */
  readonly maxWaitTimeInSecs?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/lcm_upgrade_v2#skipped_precheck_flags LcmUpgradeV2#skipped_precheck_flags}
  */
  readonly skippedPrecheckFlags?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/lcm_upgrade_v2#x_cluster_id LcmUpgradeV2#x_cluster_id}
  */
  readonly xClusterId?: string;
  /**
  * entity_update_specs block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/lcm_upgrade_v2#entity_update_specs LcmUpgradeV2#entity_update_specs}
  */
  readonly entityUpdateSpecs?: LcmUpgradeV2EntityUpdateSpecs[] | cdktf.IResolvable;
  /**
  * management_server block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/lcm_upgrade_v2#management_server LcmUpgradeV2#management_server}
  */
  readonly managementServer?: LcmUpgradeV2ManagementServer;
}
export interface LcmUpgradeV2EntityUpdateSpecs {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/lcm_upgrade_v2#entity_uuid LcmUpgradeV2#entity_uuid}
  */
  readonly entityUuid: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/lcm_upgrade_v2#to_version LcmUpgradeV2#to_version}
  */
...
export interface LcmUpgradeV2ManagementServer {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/lcm_upgrade_v2#hypervisor_type LcmUpgradeV2#hypervisor_type}
  */
  readonly hypervisorType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/lcm_upgrade_v2#ip LcmUpgradeV2#ip}
  */
  readonly ip: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/lcm_upgrade_v2#password LcmUpgradeV2#password}
  */
  readonly password: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/lcm_upgrade_v2#username LcmUpgradeV2#username}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/lcm_upgrade_v2 nutanix_lcm_upgrade_v2}
*/
export class LcmUpgradeV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LcmUpgradeV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/lcm_upgrade_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/lcm_upgrade_v2 nutanix_lcm_upgrade_v2} Resource
  *
  * @param scope The scope in which to define this construct
