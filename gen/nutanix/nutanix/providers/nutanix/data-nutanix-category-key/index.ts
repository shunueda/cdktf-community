// https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/category_key
...
export interface DataNutanixCategoryKeyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/category_key#id DataNutanixCategoryKey#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/category_key#name DataNutanixCategoryKey#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/category_key nutanix_category_key}
*/
export class DataNutanixCategoryKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNutanixCategoryKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/category_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/category_key nutanix_category_key} Data Source
  *
  * @param scope The scope in which to define this construct
