// https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/vm_network_device_migrate_v2
...
export interface VmNetworkDeviceMigrateV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/vm_network_device_migrate_v2#ext_id VmNetworkDeviceMigrateV2#ext_id}
  */
  readonly extId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/vm_network_device_migrate_v2#id VmNetworkDeviceMigrateV2#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/vm_network_device_migrate_v2#migrate_type VmNetworkDeviceMigrateV2#migrate_type}
  */
  readonly migrateType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/vm_network_device_migrate_v2#vm_ext_id VmNetworkDeviceMigrateV2#vm_ext_id}
  */
  readonly vmExtId: string;
  /**
  * ip_address block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/vm_network_device_migrate_v2#ip_address VmNetworkDeviceMigrateV2#ip_address}
  */
  readonly ipAddress?: VmNetworkDeviceMigrateV2IpAddress[] | cdktf.IResolvable;
  /**
  * subnet block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/vm_network_device_migrate_v2#subnet VmNetworkDeviceMigrateV2#subnet}
  */
  readonly subnet: VmNetworkDeviceMigrateV2Subnet[] | cdktf.IResolvable;
}
export interface VmNetworkDeviceMigrateV2IpAddress {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/vm_network_device_migrate_v2#prefix_length VmNetworkDeviceMigrateV2#prefix_length}
  */
  readonly prefixLength?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/vm_network_device_migrate_v2#value VmNetworkDeviceMigrateV2#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/vm_network_device_migrate_v2 nutanix_vm_network_device_migrate_v2}
*/
export class VmNetworkDeviceMigrateV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VmNetworkDeviceMigrateV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/vm_network_device_migrate_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/resources/vm_network_device_migrate_v2 nutanix_vm_network_device_migrate_v2} Resource
  *
  * @param scope The scope in which to define this construct
