// https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/volume_groups_v2
...
export interface DataNutanixVolumeGroupsV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/volume_groups_v2#expand DataNutanixVolumeGroupsV2#expand}
  */
  readonly expand?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/volume_groups_v2#filter DataNutanixVolumeGroupsV2#filter}
  */
  readonly filter?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/volume_groups_v2#id DataNutanixVolumeGroupsV2#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/volume_groups_v2#limit DataNutanixVolumeGroupsV2#limit}
  */
  readonly limit?: number;
  /**
  * A URL query parameter that allows clients to specify the sort criteria for the returned list of objects. Resources can be sorted in ascending order using asc or descending order using desc. If asc or desc are not specified, the resources will be sorted in ascending order by default. For example, '$orderby=templateName desc' would get all templates sorted by templateName in descending order. The orderby can be applied to the following fields: clusterReference, extId, name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/volume_groups_v2#orderby DataNutanixVolumeGroupsV2#orderby}
  */
  readonly orderby?: string;
  /**
  * A URL query parameter that specifies the page number of the result set. It must be a positive integer between 0 and the maximum number of pages that are available for that resource. Any number out of this range might lead to no results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/volume_groups_v2#page DataNutanixVolumeGroupsV2#page}
  */
  readonly page?: number;
  /**
  * A URL query parameter that allows clients to request a specific set of properties for each entity or complex type. Expression specified with the $select must conform to the OData V4.01 URL conventions. If a $select expression consists of a single select item that is an asterisk (i.e., *), then all properties on the matching resource will be returned. The select can be applied to the following fields: clusterReference, extId, name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/volume_groups_v2#select DataNutanixVolumeGroupsV2#select}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/volume_groups_v2 nutanix_volume_groups_v2}
*/
export class DataNutanixVolumeGroupsV2 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNutanixVolumeGroupsV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/volume_groups_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/volume_groups_v2 nutanix_volume_groups_v2} Data Source
  *
  * @param scope The scope in which to define this construct
