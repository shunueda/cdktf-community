// https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/ndb_time_machines
...
export interface DataNutanixNdbTimeMachinesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/ndb_time_machines#id DataNutanixNdbTimeMachines#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/ndb_time_machines nutanix_ndb_time_machines}
*/
export class DataNutanixNdbTimeMachines extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNutanixNdbTimeMachines that should be imported. Refer to the {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/ndb_time_machines#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nutanix/nutanix/2.3.1/docs/data-sources/ndb_time_machines nutanix_ndb_time_machines} Data Source
  *
  * @param scope The scope in which to define this construct
