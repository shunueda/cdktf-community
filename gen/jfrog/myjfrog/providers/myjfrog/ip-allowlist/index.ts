// https://registry.terraform.io/providers/jfrog/myjfrog/1.0.1/docs/resources/ip_allowlist
...
export interface IpAllowlistConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/myjfrog/1.0.1/docs/resources/ip_allowlist#ips IpAllowlist#ips}
  */
  readonly ips: string[];
  /**
  * Name of the server. If your JFrog URL is `myserver.jfrog.io`, the `server_name` is `myserver`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/myjfrog/1.0.1/docs/resources/ip_allowlist#server_name IpAllowlist#server_name}
  */
  readonly serverName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/myjfrog/1.0.1/docs/resources/ip_allowlist myjfrog_ip_allowlist}
*/
export class IpAllowlist extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpAllowlist that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/myjfrog/1.0.1/docs/resources/ip_allowlist#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/myjfrog/1.0.1/docs/resources/ip_allowlist myjfrog_ip_allowlist} Resource
  *
  * @param scope The scope in which to define this construct
