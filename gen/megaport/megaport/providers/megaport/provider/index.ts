// https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs
...
export interface MegaportProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs#accept_purchase_terms MegaportProvider#accept_purchase_terms}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs#access_key MegaportProvider#access_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs#cancel_at_end_of_term MegaportProvider#cancel_at_end_of_term}
  */
  readonly cancelAtEndOfTerm?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs#environment MegaportProvider#environment}
  */
  readonly environment?: string;
  /**
  * The API secret key. Can also be set using the environment variable MEGAPORT_SECRET_KEY
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs#secret_key MegaportProvider#secret_key}
  */
  readonly secretKey?: string;
  /**
  * The time to wait in minutes for creating and updating resources in Megaport API. Default value is 10.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs#wait_time MegaportProvider#wait_time}
  */
  readonly waitTime?: number;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs#alias MegaportProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs megaport}
*/
export class MegaportProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing MegaportProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs megaport} Resource
  *
  * @param scope The scope in which to define this construct
