// https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs/resources/mcr_prefix_filter_list
...
export interface McrPrefixFilterListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs/resources/mcr_prefix_filter_list#address_family McrPrefixFilterList#address_family}
  */
  readonly addressFamily: string;
  /**
  * Description of the prefix filter list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs/resources/mcr_prefix_filter_list#description McrPrefixFilterList#description}
  */
  readonly description: string;
  /**
  * Entries in the prefix filter list. Must contain between 1 and 200 entries.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs/resources/mcr_prefix_filter_list#entries McrPrefixFilterList#entries}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs/resources/mcr_prefix_filter_list#mcr_id McrPrefixFilterList#mcr_id}
  */
...
export interface McrPrefixFilterListEntries {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs/resources/mcr_prefix_filter_list#action McrPrefixFilterList#action}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs/resources/mcr_prefix_filter_list#ge McrPrefixFilterList#ge}
  */
  readonly ge?: number;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs/resources/mcr_prefix_filter_list#le McrPrefixFilterList#le}
  */
  readonly le?: number;
  /**
  * The network address of the prefix filter list entry in CIDR notation (e.g., '10.0.1.0/24').
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs/resources/mcr_prefix_filter_list#prefix McrPrefixFilterList#prefix}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs/resources/mcr_prefix_filter_list megaport_mcr_prefix_filter_list}
*/
export class McrPrefixFilterList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing McrPrefixFilterList that should be imported. Refer to the {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs/resources/mcr_prefix_filter_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/megaport/megaport/1.4.4/docs/resources/mcr_prefix_filter_list megaport_mcr_prefix_filter_list} Resource
  *
  * @param scope The scope in which to define this construct
