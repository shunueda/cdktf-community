// https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration
...
export interface OrgConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration#address_1 OrgConfiguration#address_1}
  */
  readonly address1?: string;
  /**
  * Secondary address of org
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration#address_2 OrgConfiguration#address_2}
  */
  readonly address2?: string;
  /**
  * User ID representing the billing contact
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration#billing_contact_user OrgConfiguration#billing_contact_user}
  */
  readonly billingContactUser?: string;
  /**
  * City of org
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration#city OrgConfiguration#city}
  */
  readonly city?: string;
  /**
  * Name of org
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration#company_name OrgConfiguration#company_name}
  */
  readonly companyName: string;
  /**
  * Country of org
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration#country OrgConfiguration#country}
  */
  readonly country?: string;
  /**
  * Support link of org
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration#end_user_support_help_url OrgConfiguration#end_user_support_help_url}
  */
  readonly endUserSupportHelpUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration#id OrgConfiguration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration#logo OrgConfiguration#logo}
  */
  readonly logo?: string;
  /**
  * Indicates whether the org's users receive Okta Communication emails
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration#opt_out_communication_emails OrgConfiguration#opt_out_communication_emails}
  */
  readonly optOutCommunicationEmails?: boolean | cdktf.IResolvable;
  /**
  * Support help phone of org
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration#phone_number OrgConfiguration#phone_number}
  */
  readonly phoneNumber?: string;
  /**
  * Postal code of org
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration#postal_code OrgConfiguration#postal_code}
  */
  readonly postalCode?: string;
  /**
  * State of org
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration#state OrgConfiguration#state}
  */
  readonly state?: string;
  /**
  * Support help phone of org
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration#support_phone_number OrgConfiguration#support_phone_number}
  */
  readonly supportPhoneNumber?: string;
  /**
  * User ID representing the technical contact
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration#technical_contact_user OrgConfiguration#technical_contact_user}
  */
  readonly technicalContactUser?: string;
  /**
  * The org's website
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration#website OrgConfiguration#website}
  */
  readonly website?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration okta_org_configuration}
*/
export class OrgConfiguration extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the OrgConfiguration to import
  * @param importFromId The id of the existing OrgConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the OrgConfiguration to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "okta_org_configuration", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/org_configuration okta_org_configuration} Resource
  *
  * @param scope The scope in which to define this construct
