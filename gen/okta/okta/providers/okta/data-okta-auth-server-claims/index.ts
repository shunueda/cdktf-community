// https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/auth_server_claims
...
export interface DataOktaAuthServerClaimsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Auth server ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/auth_server_claims#auth_server_id DataOktaAuthServerClaims#auth_server_id}
  */
  readonly authServerId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/auth_server_claims#id DataOktaAuthServerClaims#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/auth_server_claims okta_auth_server_claims}
*/
export class DataOktaAuthServerClaims extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaAuthServerClaims that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/auth_server_claims#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/auth_server_claims okta_auth_server_claims} Data Source
  *
  * @param scope The scope in which to define this construct
