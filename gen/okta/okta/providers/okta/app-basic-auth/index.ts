// https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth
...
export interface AppBasicAuthConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#accessibility_error_redirect_url AppBasicAuth#accessibility_error_redirect_url}
  */
  readonly accessibilityErrorRedirectUrl?: string;
  /**
  * Custom login page URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#accessibility_login_redirect_url AppBasicAuth#accessibility_login_redirect_url}
  */
  readonly accessibilityLoginRedirectUrl?: string;
  /**
  * Enable self service. Default is `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#accessibility_self_service AppBasicAuth#accessibility_self_service}
  */
  readonly accessibilitySelfService?: boolean | cdktf.IResolvable;
  /**
  * Application notes for admins.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#admin_note AppBasicAuth#admin_note}
  */
  readonly adminNote?: string;
  /**
  * Displays specific appLinks for the app. The value for each application link should be boolean.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#app_links_json AppBasicAuth#app_links_json}
  */
  readonly appLinksJson?: string;
  /**
  * The URL of the authenticating site for this app.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#auth_url AppBasicAuth#auth_url}
  */
  readonly authUrl: string;
  /**
  * Display auto submit toolbar
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#auto_submit_toolbar AppBasicAuth#auto_submit_toolbar}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#credentials_scheme AppBasicAuth#credentials_scheme}
  */
  readonly credentialsScheme?: string;
  /**
  * Application notes for end users.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#enduser_note AppBasicAuth#enduser_note}
  */
  readonly enduserNote?: string;
  /**
  * Do not display application icon on mobile app
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#hide_ios AppBasicAuth#hide_ios}
  */
  readonly hideIos?: boolean | cdktf.IResolvable;
  /**
  * Do not display application icon to users
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#hide_web AppBasicAuth#hide_web}
  */
  readonly hideWeb?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#id AppBasicAuth#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#label AppBasicAuth#label}
  */
  readonly label: string;
  /**
  * Local file path to the logo. The file must be in PNG, JPG, or GIF format, and less than 1 MB in size.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#logo AppBasicAuth#logo}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#reveal_password AppBasicAuth#reveal_password}
  */
  readonly revealPassword?: boolean | cdktf.IResolvable;
  /**
  * Shared password, required for certain schemes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#shared_password AppBasicAuth#shared_password}
  */
  readonly sharedPassword?: string;
  /**
  * Shared username, required for certain schemes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#shared_username AppBasicAuth#shared_username}
  */
  readonly sharedUsername?: string;
  /**
  * Status of application. By default, it is `ACTIVE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#status AppBasicAuth#status}
  */
  readonly status?: string;
  /**
  * The URL of the sign-in page for this app.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#url AppBasicAuth#url}
  */
  readonly url: string;
  /**
  * Username template. Default: `${source.login}`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#user_name_template AppBasicAuth#user_name_template}
  */
  readonly userNameTemplate?: string;
  /**
  * Push username on update. Valid values: `PUSH`, `DONT_PUSH` and `NOT_CONFIGURED`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#user_name_template_push_status AppBasicAuth#user_name_template_push_status}
  */
  readonly userNameTemplatePushStatus?: string;
  /**
  * Username template suffix
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#user_name_template_suffix AppBasicAuth#user_name_template_suffix}
  */
  readonly userNameTemplateSuffix?: string;
  /**
  * Username template type. Default: `BUILT_IN`. Valid values: `NONE`, `CUSTOM`, `BUILT_IN`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#user_name_template_type AppBasicAuth#user_name_template_type}
  */
  readonly userNameTemplateType?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#timeouts AppBasicAuth#timeouts}
  */
  readonly timeouts?: AppBasicAuthTimeouts;
}
export interface AppBasicAuthTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#create AppBasicAuth#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#read AppBasicAuth#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#update AppBasicAuth#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth okta_app_basic_auth}
*/
export class AppBasicAuth extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppBasicAuth that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_basic_auth okta_app_basic_auth} Resource
  *
  * @param scope The scope in which to define this construct
