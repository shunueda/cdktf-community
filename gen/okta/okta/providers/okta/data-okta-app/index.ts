// https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/app
...
export interface DataOktaAppConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/app#active_only DataOktaApp#active_only}
  */
  readonly activeOnly?: boolean | cdktf.IResolvable;
  /**
  * Id of application to retrieve, conflicts with label and label_prefix.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/app#id DataOktaApp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/app#label DataOktaApp#label}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/app#label_prefix DataOktaApp#label_prefix}
  */
  readonly labelPrefix?: string;
  /**
  * Ignore groups sync. This is a temporary solution until 'groups' field is supported in all the app-like resources
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/app#skip_groups DataOktaApp#skip_groups}
  */
  readonly skipGroups?: boolean | cdktf.IResolvable;
  /**
  * Ignore users sync. This is a temporary solution until 'users' field is supported in all the app-like resources
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/app#skip_users DataOktaApp#skip_users}
  */
  readonly skipUsers?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/app okta_app}
*/
export class DataOktaApp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/app okta_app} Data Source
  *
  * @param scope The scope in which to define this construct
