// https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/policy_rule_password
...
export interface PolicyRulePasswordConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/policy_rule_password#id PolicyRulePassword#id}
  *
  ...
  * Policy Rule Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/policy_rule_password#name PolicyRulePassword#name}
  */
  readonly name: string;
  /**
  * Network selection mode: `ANYWHERE`, `ZONE`, `ON_NETWORK`, or `OFF_NETWORK`. Default: `ANYWHERE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/policy_rule_password#network_connection PolicyRulePassword#network_connection}
  */
  readonly networkConnection?: string;
  /**
  * Required if `network_connection` = `ZONE`. Indicates the network zones to exclude.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/policy_rule_password#network_excludes PolicyRulePassword#network_excludes}
  */
  readonly networkExcludes?: string[];
  /**
  * Required if `network_connection` = `ZONE`. Indicates the network zones to include.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/policy_rule_password#network_includes PolicyRulePassword#network_includes}
  */
  readonly networkIncludes?: string[];
  /**
  * Allow or deny a user to change their password: `ALLOW` or `DENY`. Default: `ALLOW`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/policy_rule_password#password_change PolicyRulePassword#password_change}
  */
  readonly passwordChange?: string;
  /**
  * Allow or deny a user to reset their password: `ALLOW` or `DENY`. Default: `ALLOW`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/policy_rule_password#password_reset PolicyRulePassword#password_reset}
  */
  readonly passwordReset?: string;
  /**
  * Allow or deny a user to unlock. Default: `DENY`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/policy_rule_password#password_unlock PolicyRulePassword#password_unlock}
  */
  readonly passwordUnlock?: string;
  /**
  * Policy ID of the Rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/policy_rule_password#policy_id PolicyRulePassword#policy_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/policy_rule_password#priority PolicyRulePassword#priority}
  */
  readonly priority?: number;
  /**
  * Policy Rule Status: `ACTIVE` or `INACTIVE`. Default: `ACTIVE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/policy_rule_password#status PolicyRulePassword#status}
  */
  readonly status?: string;
  /**
  * Set of User IDs to Exclude
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/policy_rule_password#users_excluded PolicyRulePassword#users_excluded}
  */
  readonly usersExcluded?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/policy_rule_password okta_policy_rule_password}
*/
export class PolicyRulePassword extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyRulePassword that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/policy_rule_password#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/policy_rule_password okta_policy_rule_password} Resource
  *
  * @param scope The scope in which to define this construct
