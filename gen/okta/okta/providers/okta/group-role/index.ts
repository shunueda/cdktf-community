// https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/group_role
...
export interface GroupRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/group_role#disable_notifications GroupRole#disable_notifications}
  */
  readonly disableNotifications?: boolean | cdktf.IResolvable;
  /**
  * ID of group to attach admin roles to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/group_role#group_id GroupRole#group_id}
  */
  readonly groupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/group_role#id GroupRole#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/group_role#resource_set_id GroupRole#resource_set_id}
  */
  readonly resourceSetId?: string;
  /**
  * Role ID. Required for role_type = `CUSTOM`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/group_role#role_id GroupRole#role_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/group_role#role_type GroupRole#role_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/group_role#target_app_list GroupRole#target_app_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/group_role#target_group_list GroupRole#target_group_list}
  */
  readonly targetGroupList?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/group_role okta_group_role}
*/
export class GroupRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GroupRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/group_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/group_role okta_group_role} Resource
  *
  * @param scope The scope in which to define this construct
