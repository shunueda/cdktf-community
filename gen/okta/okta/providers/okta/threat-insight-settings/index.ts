// https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/threat_insight_settings
...
export interface ThreatInsightSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/threat_insight_settings#action ThreatInsightSettings#action}
  */
  readonly action: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/threat_insight_settings#id ThreatInsightSettings#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/threat_insight_settings#network_excludes ThreatInsightSettings#network_excludes}
  */
  readonly networkExcludes?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/threat_insight_settings okta_threat_insight_settings}
*/
export class ThreatInsightSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ThreatInsightSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/threat_insight_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/threat_insight_settings okta_threat_insight_settings} Resource
  *
  * @param scope The scope in which to define this construct
