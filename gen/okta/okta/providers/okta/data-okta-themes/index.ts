// https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/themes
...
export interface DataOktaThemesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Brand ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/themes#brand_id DataOktaThemes#brand_id}
  */
  readonly brandId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/themes#id DataOktaThemes#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/themes okta_themes}
*/
export class DataOktaThemes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaThemes that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/themes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/themes okta_themes} Data Source
  *
  * @param scope The scope in which to define this construct
