// https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/catalog_entry_user_access_request_fields
...
export interface DataOktaCatalogEntryUserAccessRequestFieldsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/catalog_entry_user_access_request_fields#entry_id DataOktaCatalogEntryUserAccessRequestFields#entry_id}
  */
  readonly entryId: string;
  /**
  * The ID of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/catalog_entry_user_access_request_fields#user_id DataOktaCatalogEntryUserAccessRequestFields#user_id}
  */
  readonly userId: string;
  /**
  * data block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/catalog_entry_user_access_request_fields#data DataOktaCatalogEntryUserAccessRequestFields#data}
  */
...
export interface DataOktaCatalogEntryUserAccessRequestFieldsData {
  ...
  * choices block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/catalog_entry_user_access_request_fields#choices DataOktaCatalogEntryUserAccessRequestFields#choices}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/catalog_entry_user_access_request_fields okta_catalog_entry_user_access_request_fields}
*/
export class DataOktaCatalogEntryUserAccessRequestFields extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaCatalogEntryUserAccessRequestFields that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/catalog_entry_user_access_request_fields#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/data-sources/catalog_entry_user_access_request_fields okta_catalog_entry_user_access_request_fields} Data Source
  *
  * @param scope The scope in which to define this construct
