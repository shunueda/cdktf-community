// https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark
...
export interface AppBookmarkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#accessibility_error_redirect_url AppBookmark#accessibility_error_redirect_url}
  */
  readonly accessibilityErrorRedirectUrl?: string;
  /**
  * Custom login page URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#accessibility_login_redirect_url AppBookmark#accessibility_login_redirect_url}
  */
  readonly accessibilityLoginRedirectUrl?: string;
  /**
  * Enable self service. Default is `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#accessibility_self_service AppBookmark#accessibility_self_service}
  */
  readonly accessibilitySelfService?: boolean | cdktf.IResolvable;
  /**
  * Application notes for admins.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#admin_note AppBookmark#admin_note}
  */
  readonly adminNote?: string;
  /**
  * Displays specific appLinks for the app. The value for each application link should be boolean.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#app_links_json AppBookmark#app_links_json}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#authentication_policy AppBookmark#authentication_policy}
  */
  readonly authenticationPolicy?: string;
  /**
  * Display auto submit toolbar
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#auto_submit_toolbar AppBookmark#auto_submit_toolbar}
  */
  readonly autoSubmitToolbar?: boolean | cdktf.IResolvable;
  /**
  * Application notes for end users.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#enduser_note AppBookmark#enduser_note}
  */
  readonly enduserNote?: string;
  /**
  * Do not display application icon on mobile app
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#hide_ios AppBookmark#hide_ios}
  */
  readonly hideIos?: boolean | cdktf.IResolvable;
  /**
  * Do not display application icon to users
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#hide_web AppBookmark#hide_web}
  */
  readonly hideWeb?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#id AppBookmark#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#label AppBookmark#label}
  */
  readonly label: string;
  /**
  * Local file path to the logo. The file must be in PNG, JPG, or GIF format, and less than 1 MB in size.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#logo AppBookmark#logo}
  */
  readonly logo?: string;
  /**
  * Would you like Okta to add an integration for this app?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#request_integration AppBookmark#request_integration}
  */
  readonly requestIntegration?: boolean | cdktf.IResolvable;
  /**
  * Status of application. By default, it is `ACTIVE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#status AppBookmark#status}
  */
  readonly status?: string;
  /**
  * The URL of the bookmark.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#url AppBookmark#url}
  */
  readonly url: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#timeouts AppBookmark#timeouts}
  */
  readonly timeouts?: AppBookmarkTimeouts;
}
export interface AppBookmarkTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#create AppBookmark#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#read AppBookmark#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#update AppBookmark#update}
  */
  readonly update?: string;
}

export function appBookmarkTimeoutsToTerraform(struct?: AppBookmarkTimeouts | cdktf.IResolvable): any {
...
export class AppBookmarkTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AppBookmarkTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: AppBookmarkTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark okta_app_bookmark}
*/
export class AppBookmark extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the AppBookmark to import
  * @param importFromId The id of the existing AppBookmark that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AppBookmark to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "okta_app_bookmark", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.3.0/docs/resources/app_bookmark okta_app_bookmark} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AppBookmarkConfig
  */
  public constructor(scope: Construct, id: string, config: AppBookmarkConfig) {
    super(scope, id, {
  ...
  // request_integration - computed: false, optional: true, required: false
  private _requestIntegration?: boolean | cdktf.IResolvable; 
  public get requestIntegration() {
    return this.getBooleanAttribute('request_integration');
  }
  public set requestIntegration(value: boolean | cdktf.IResolvable) {
    this._requestIntegration = value;
  }
  public resetRequestIntegration() {
    this._requestIntegration = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get requestIntegrationInput() {
    return this._requestIntegration;
  }
  ...
  private _timeouts = new AppBookmarkTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
