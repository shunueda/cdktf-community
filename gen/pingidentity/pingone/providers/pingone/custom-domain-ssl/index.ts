// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/custom_domain_ssl
...
export interface CustomDomainSslConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/custom_domain_ssl#certificate_pem_file CustomDomainSsl#certificate_pem_file}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/custom_domain_ssl#custom_domain_id CustomDomainSsl#custom_domain_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/custom_domain_ssl#environment_id CustomDomainSsl#environment_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/custom_domain_ssl#intermediate_certificates_pem_file CustomDomainSsl#intermediate_certificates_pem_file}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/custom_domain_ssl#private_key_pem_file CustomDomainSsl#private_key_pem_file}
  */
  readonly privateKeyPemFile: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/custom_domain_ssl pingone_custom_domain_ssl}
*/
export class CustomDomainSsl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomDomainSsl that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/custom_domain_ssl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/custom_domain_ssl pingone_custom_domain_ssl} Resource
  *
  * @param scope The scope in which to define this construct
