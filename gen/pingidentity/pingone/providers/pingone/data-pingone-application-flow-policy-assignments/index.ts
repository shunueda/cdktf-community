// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/application_flow_policy_assignments
...
export interface DataPingoneApplicationFlowPolicyAssignmentsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/application_flow_policy_assignments#application_id DataPingoneApplicationFlowPolicyAssignments#application_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/application_flow_policy_assignments#environment_id DataPingoneApplicationFlowPolicyAssignments#environment_id}
  */
  readonly environmentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/application_flow_policy_assignments pingone_application_flow_policy_assignments}
*/
export class DataPingoneApplicationFlowPolicyAssignments extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPingoneApplicationFlowPolicyAssignments that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/application_flow_policy_assignments#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/application_flow_policy_assignments pingone_application_flow_policy_assignments} Data Source
  *
  * @param scope The scope in which to define this construct
