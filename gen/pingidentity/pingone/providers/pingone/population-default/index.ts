// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population_default
...
export interface PopulationDefaultConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population_default#alternative_identifiers PopulationDefault#alternative_identifiers}
  */
  readonly alternativeIdentifiers?: string[];
  /**
  * A description to apply to the default population.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population_default#description PopulationDefault#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population_default#environment_id PopulationDefault#environment_id}
  */
  readonly environmentId: string;
  /**
  * The name to apply to the default population.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population_default#name PopulationDefault#name}
  */
  readonly name: string;
  /**
  * The object reference to the password policy resource. This is an optional property. Conflicts with `password_policy_id`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population_default#password_policy PopulationDefault#password_policy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population_default#password_policy_id PopulationDefault#password_policy_id}
  */
  readonly passwordPolicyId?: string;
  /**
  * The language locale for the population. If absent, the environment default is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population_default#preferred_language PopulationDefault#preferred_language}
  */
  readonly preferredLanguage?: string;
  /**
  * The object reference to the theme resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population_default#theme PopulationDefault#theme}
  */
...
export interface PopulationDefaultPasswordPolicy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population_default#id PopulationDefault#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population_default pingone_population_default}
*/
export class PopulationDefault extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PopulationDefault that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population_default#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population_default pingone_population_default} Resource
  *
  * @param scope The scope in which to define this construct
