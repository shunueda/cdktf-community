// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme
...
export interface BrandingThemeConfig extends cdktf.TerraformMetaArguments {
  /**
  * The background color for the theme. It must be a valid hexadecimal color code.  Exactly one of the following must be defined: `background_image`, `background_color`, `use_default_background`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme#background_color BrandingTheme#background_color}
  */
  readonly backgroundColor?: string;
  /**
  * A single object that specifies the HREF and ID for the background image.  Exactly one of the following must be defined: `background_image`, `background_color`, `use_default_background`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme#background_image BrandingTheme#background_image}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme#body_text_color BrandingTheme#body_text_color}
  */
  readonly bodyTextColor: string;
  /**
  * The button color for the theme. It must be a valid hexadecimal color code.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme#button_color BrandingTheme#button_color}
  */
  readonly buttonColor: string;
  /**
  * The button text color for the branding theme. It must be a valid hexadecimal color code.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme#button_text_color BrandingTheme#button_text_color}
  */
  readonly buttonTextColor: string;
  /**
  * The card color for the branding theme. It must be a valid hexadecimal color code.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme#card_color BrandingTheme#card_color}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme#environment_id BrandingTheme#environment_id}
  */
  readonly environmentId: string;
  /**
  * The text to be displayed in the footer of the branding theme.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme#footer_text BrandingTheme#footer_text}
  */
  readonly footerText?: string;
  /**
  * The heading text color for the branding theme. It must be a valid hexadecimal color code.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme#heading_text_color BrandingTheme#heading_text_color}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme#link_text_color BrandingTheme#link_text_color}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme#logo BrandingTheme#logo}
  */
  readonly logo?: BrandingThemeLogo;
  /**
  * A string that specifies the unique name of the branding theme.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme#name BrandingTheme#name}
  */
  readonly name: string;
  /**
  * The template name of the branding theme associated with the environment.  Options are `default`, `focus`, `mural`, `slate`, `split`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme#template BrandingTheme#template}
  */
  readonly template: string;
  /**
  * A boolean to specify that the background should be set to the theme template's default.  Exactly one of the following must be defined: `background_image`, `background_color`, `use_default_background`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme#use_default_background BrandingTheme#use_default_background}
  */
...
export interface BrandingThemeBackgroundImage {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme#href BrandingTheme#href}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme#id BrandingTheme#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme pingone_branding_theme}
*/
export class BrandingTheme extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BrandingTheme that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/branding_theme pingone_branding_theme} Resource
  *
  * @param scope The scope in which to define this construct
