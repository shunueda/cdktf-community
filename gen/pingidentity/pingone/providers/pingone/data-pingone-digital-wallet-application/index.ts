// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/digital_wallet_application
...
export interface DataPingoneDigitalWalletApplicationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/digital_wallet_application#application_id DataPingoneDigitalWalletApplication#application_id}
  */
  readonly applicationId?: string;
  /**
  * Identifier (UUID) associated with the credential digital wallet application.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/digital_wallet_application#digital_wallet_id DataPingoneDigitalWalletApplication#digital_wallet_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/digital_wallet_application#environment_id DataPingoneDigitalWalletApplication#environment_id}
  */
  readonly environmentId: string;
  /**
  * The name associated with the digital wallet application.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/digital_wallet_application#name DataPingoneDigitalWalletApplication#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/digital_wallet_application pingone_digital_wallet_application}
*/
export class DataPingoneDigitalWalletApplication extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPingoneDigitalWalletApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/digital_wallet_application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/digital_wallet_application pingone_digital_wallet_application} Data Source
  *
  * @param scope The scope in which to define this construct
