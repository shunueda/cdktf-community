// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/authorize_decision_endpoint
...
export interface AuthorizeDecisionEndpointConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/authorize_decision_endpoint#alternate_id AuthorizeDecisionEndpoint#alternate_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/authorize_decision_endpoint#authorization_version_id AuthorizeDecisionEndpoint#authorization_version_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/authorize_decision_endpoint#description AuthorizeDecisionEndpoint#description}
  */
  readonly description?: string;
  /**
  * The ID of the environment to create the decision endpoint in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/authorize_decision_endpoint#environment_id AuthorizeDecisionEndpoint#environment_id}
  */
  readonly environmentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/authorize_decision_endpoint#id AuthorizeDecisionEndpoint#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/authorize_decision_endpoint#name AuthorizeDecisionEndpoint#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/authorize_decision_endpoint#record_recent_requests AuthorizeDecisionEndpoint#record_recent_requests}
  */
  readonly recordRecentRequests: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/authorize_decision_endpoint pingone_authorize_decision_endpoint}
*/
export class AuthorizeDecisionEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuthorizeDecisionEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/authorize_decision_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/authorize_decision_endpoint pingone_authorize_decision_endpoint} Resource
  *
  * @param scope The scope in which to define this construct
