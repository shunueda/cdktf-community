// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/digital_wallet_application
...
export interface DigitalWalletApplicationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/digital_wallet_application#app_open_url DigitalWalletApplication#app_open_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/digital_wallet_application#application_id DigitalWalletApplication#application_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/digital_wallet_application#environment_id DigitalWalletApplication#environment_id}
  */
  readonly environmentId: string;
  /**
  * The name associated with the digital wallet application.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/digital_wallet_application#name DigitalWalletApplication#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/digital_wallet_application pingone_digital_wallet_application}
*/
export class DigitalWalletApplication extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DigitalWalletApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/digital_wallet_application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/digital_wallet_application pingone_digital_wallet_application} Resource
  *
  * @param scope The scope in which to define this construct
