// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/resource
...
export interface DataPingoneResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/resource#environment_id DataPingoneResource#environment_id}
  */
  readonly environmentId: string;
  /**
  * The name of the resource.  Exactly one of the following must be defined: `resource_id`, `name`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/resource#name DataPingoneResource#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/resource#resource_id DataPingoneResource#resource_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/resource pingone_resource}
*/
export class DataPingoneResource extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPingoneResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/resource pingone_resource} Data Source
  *
  * @param scope The scope in which to define this construct
