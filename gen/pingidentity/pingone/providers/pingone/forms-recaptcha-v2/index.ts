// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/forms_recaptcha_v2
...
export interface FormsRecaptchaV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/forms_recaptcha_v2#environment_id FormsRecaptchaV2#environment_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/forms_recaptcha_v2#secret_key FormsRecaptchaV2#secret_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/forms_recaptcha_v2#site_key FormsRecaptchaV2#site_key}
  */
  readonly siteKey: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/forms_recaptcha_v2 pingone_forms_recaptcha_v2}
*/
export class FormsRecaptchaV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FormsRecaptchaV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/forms_recaptcha_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/forms_recaptcha_v2 pingone_forms_recaptcha_v2} Resource
  *
  * @param scope The scope in which to define this construct
