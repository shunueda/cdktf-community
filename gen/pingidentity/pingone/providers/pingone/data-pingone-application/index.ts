// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/application
...
export interface DataPingoneApplicationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/application#application_id DataPingoneApplication#application_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/application#environment_id DataPingoneApplication#environment_id}
  */
  readonly environmentId: string;
  /**
  * The name of the application.  Exactly one of the following must be defined: `application_id`, `name`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/application#name DataPingoneApplication#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/application pingone_application}
*/
export class DataPingoneApplication extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPingoneApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/application pingone_application} Data Source
  *
  * @param scope The scope in which to define this construct
