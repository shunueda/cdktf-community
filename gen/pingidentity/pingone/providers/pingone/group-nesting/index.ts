// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/group_nesting
...
export interface GroupNestingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/group_nesting#environment_id GroupNesting#environment_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/group_nesting#group_id GroupNesting#group_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/group_nesting#nested_group_id GroupNesting#nested_group_id}
  */
  readonly nestedGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/group_nesting pingone_group_nesting}
*/
export class GroupNesting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GroupNesting that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/group_nesting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/group_nesting pingone_group_nesting} Resource
  *
  * @param scope The scope in which to define this construct
