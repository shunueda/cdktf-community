// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/agreement_enable
...
export interface AgreementEnableConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/agreement_enable#agreement_id AgreementEnable#agreement_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/agreement_enable#enabled AgreementEnable#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/agreement_enable#environment_id AgreementEnable#environment_id}
  */
  readonly environmentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/agreement_enable pingone_agreement_enable}
*/
export class AgreementEnable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AgreementEnable that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/agreement_enable#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/agreement_enable pingone_agreement_enable} Resource
  *
  * @param scope The scope in which to define this construct
