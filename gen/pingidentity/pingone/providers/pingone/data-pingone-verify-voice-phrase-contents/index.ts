// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/verify_voice_phrase_contents
...
export interface DataPingoneVerifyVoicePhraseContentsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/verify_voice_phrase_contents#environment_id DataPingoneVerifyVoicePhraseContents#environment_id}
  */
  readonly environmentId: string;
  /**
  * The identifier (UUID) of the `voice_phrase` associated with the `voice_phrase_content` configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/verify_voice_phrase_contents#voice_phrase_id DataPingoneVerifyVoicePhraseContents#voice_phrase_id}
  */
  readonly voicePhraseId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/verify_voice_phrase_contents pingone_verify_voice_phrase_contents}
*/
export class DataPingoneVerifyVoicePhraseContents extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPingoneVerifyVoicePhraseContents that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/verify_voice_phrase_contents#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/verify_voice_phrase_contents pingone_verify_voice_phrase_contents} Data Source
  *
  * @param scope The scope in which to define this construct
