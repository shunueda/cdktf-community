// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/environments
...
export interface DataPingoneEnvironmentsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/environments#scim_filter DataPingoneEnvironments#scim_filter}
  */
  readonly scimFilter: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/environments pingone_environments}
*/
export class DataPingoneEnvironments extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPingoneEnvironments that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/environments#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/environments pingone_environments} Data Source
  *
  * @param scope The scope in which to define this construct
