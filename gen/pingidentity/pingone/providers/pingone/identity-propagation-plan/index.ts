// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/identity_propagation_plan
...
export interface IdentityPropagationPlanConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/identity_propagation_plan#environment_id IdentityPropagationPlan#environment_id}
  */
  readonly environmentId: string;
  /**
  * A string that specifies the unique name of the identity propagation plan.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/identity_propagation_plan#name IdentityPropagationPlan#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/identity_propagation_plan pingone_identity_propagation_plan}
*/
export class IdentityPropagationPlan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityPropagationPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/identity_propagation_plan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/identity_propagation_plan pingone_identity_propagation_plan} Resource
  *
  * @param scope The scope in which to define this construct
