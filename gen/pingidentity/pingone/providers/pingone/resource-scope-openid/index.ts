// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/resource_scope_openid
...
export interface ResourceScopeOpenidConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/resource_scope_openid#description ResourceScopeOpenid#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/resource_scope_openid#environment_id ResourceScopeOpenid#environment_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/resource_scope_openid#mapped_claims ResourceScopeOpenid#mapped_claims}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/resource_scope_openid#name ResourceScopeOpenid#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/resource_scope_openid pingone_resource_scope_openid}
*/
export class ResourceScopeOpenid extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ResourceScopeOpenid that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/resource_scope_openid#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/resource_scope_openid pingone_resource_scope_openid} Resource
  *
  * @param scope The scope in which to define this construct
