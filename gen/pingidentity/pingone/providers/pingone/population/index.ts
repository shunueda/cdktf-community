// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population
...
export interface PopulationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population#alternative_identifiers Population#alternative_identifiers}
  */
  readonly alternativeIdentifiers?: string[];
  /**
  * A string that specifies the description of the population.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population#description Population#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population#environment_id Population#environment_id}
  */
  readonly environmentId: string;
  /**
  * A string that specifies the population name, which must be provided and must be unique within an environment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population#name Population#name}
  */
  readonly name: string;
  /**
  * The object reference to the password policy resource. This is an optional property. Conflicts with `password_policy_id`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population#password_policy Population#password_policy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population#password_policy_id Population#password_policy_id}
  */
  readonly passwordPolicyId?: string;
  /**
  * The language locale for the population. If absent, the environment default is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population#preferred_language Population#preferred_language}
  */
  readonly preferredLanguage?: string;
  /**
  * The object reference to the theme resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population#theme Population#theme}
  */
...
export interface PopulationPasswordPolicy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population#id Population#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population pingone_population}
*/
export class Population extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Population that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/population pingone_population} Resource
  *
  * @param scope The scope in which to define this construct
