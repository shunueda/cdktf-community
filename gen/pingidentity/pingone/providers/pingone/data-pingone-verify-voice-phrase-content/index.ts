// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/verify_voice_phrase_content
...
export interface DataPingoneVerifyVoicePhraseContentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/verify_voice_phrase_content#environment_id DataPingoneVerifyVoicePhraseContent#environment_id}
  */
  readonly environmentId: string;
  /**
  * Identifier (UUID) associated with the voice phrase content.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/verify_voice_phrase_content#voice_phrase_content_id DataPingoneVerifyVoicePhraseContent#voice_phrase_content_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/verify_voice_phrase_content#voice_phrase_id DataPingoneVerifyVoicePhraseContent#voice_phrase_id}
  */
  readonly voicePhraseId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/verify_voice_phrase_content pingone_verify_voice_phrase_content}
*/
export class DataPingoneVerifyVoicePhraseContent extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPingoneVerifyVoicePhraseContent that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/verify_voice_phrase_content#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/verify_voice_phrase_content pingone_verify_voice_phrase_content} Data Source
  *
  * @param scope The scope in which to define this construct
