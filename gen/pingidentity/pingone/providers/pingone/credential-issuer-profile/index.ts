// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/credential_issuer_profile
...
export interface CredentialIssuerProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/credential_issuer_profile#environment_id CredentialIssuerProfile#environment_id}
  */
  readonly environmentId: string;
  /**
  * The name of the credential issuer. The name is included in the metadata of an issued verifiable credential.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/credential_issuer_profile#name CredentialIssuerProfile#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/credential_issuer_profile#timeouts CredentialIssuerProfile#timeouts}
  */
...
export interface CredentialIssuerProfileTimeouts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/credential_issuer_profile#create CredentialIssuerProfile#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/credential_issuer_profile pingone_credential_issuer_profile}
*/
export class CredentialIssuerProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CredentialIssuerProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/credential_issuer_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/credential_issuer_profile pingone_credential_issuer_profile} Resource
  *
  * @param scope The scope in which to define this construct
