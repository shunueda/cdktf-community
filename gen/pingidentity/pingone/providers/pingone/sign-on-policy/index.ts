// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/sign_on_policy
...
export interface SignOnPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/sign_on_policy#description SignOnPolicy#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/sign_on_policy#environment_id SignOnPolicy#environment_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/sign_on_policy#name SignOnPolicy#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/sign_on_policy pingone_sign_on_policy}
*/
export class SignOnPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SignOnPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/sign_on_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/sign_on_policy pingone_sign_on_policy} Resource
  *
  * @param scope The scope in which to define this construct
