// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/phone_delivery_settings_list
...
export interface DataPingonePhoneDeliverySettingsListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/phone_delivery_settings_list#environment_id DataPingonePhoneDeliverySettingsList#environment_id}
  */
  readonly environmentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/phone_delivery_settings_list pingone_phone_delivery_settings_list}
*/
export class DataPingonePhoneDeliverySettingsList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPingonePhoneDeliverySettingsList that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/phone_delivery_settings_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/phone_delivery_settings_list pingone_phone_delivery_settings_list} Data Source
  *
  * @param scope The scope in which to define this construct
