// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/application_resource_grant
...
export interface ApplicationResourceGrantConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/application_resource_grant#application_id ApplicationResourceGrant#application_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/application_resource_grant#custom_resource_id ApplicationResourceGrant#custom_resource_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/application_resource_grant#environment_id ApplicationResourceGrant#environment_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/application_resource_grant#resource_type ApplicationResourceGrant#resource_type}
  */
  readonly resourceType: string;
  /**
  * A list of IDs of the scopes associated with this grant.  Values must be valid PingOne resource IDs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/application_resource_grant#scopes ApplicationResourceGrant#scopes}
  */
  readonly scopes: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/application_resource_grant pingone_application_resource_grant}
*/
export class ApplicationResourceGrant extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationResourceGrant that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/application_resource_grant#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/application_resource_grant pingone_application_resource_grant} Resource
  *
  * @param scope The scope in which to define this construct
