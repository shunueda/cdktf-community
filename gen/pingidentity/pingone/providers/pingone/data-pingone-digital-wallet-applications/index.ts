// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/digital_wallet_applications
...
export interface DataPingoneDigitalWalletApplicationsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/digital_wallet_applications#environment_id DataPingoneDigitalWalletApplications#environment_id}
  */
  readonly environmentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/digital_wallet_applications pingone_digital_wallet_applications}
*/
export class DataPingoneDigitalWalletApplications extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPingoneDigitalWalletApplications that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/digital_wallet_applications#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/digital_wallet_applications pingone_digital_wallet_applications} Data Source
  *
  * @param scope The scope in which to define this construct
