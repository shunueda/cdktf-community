// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/trusted_email_address
...
export interface TrustedEmailAddressConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/trusted_email_address#email_address TrustedEmailAddress#email_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/trusted_email_address#email_domain_id TrustedEmailAddress#email_domain_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/trusted_email_address#environment_id TrustedEmailAddress#environment_id}
  */
  readonly environmentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/trusted_email_address pingone_trusted_email_address}
*/
export class TrustedEmailAddress extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TrustedEmailAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/trusted_email_address#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/trusted_email_address pingone_trusted_email_address} Resource
  *
  * @param scope The scope in which to define this construct
