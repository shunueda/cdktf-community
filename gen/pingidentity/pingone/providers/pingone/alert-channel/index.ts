// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/alert_channel
...
export interface AlertChannelConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/alert_channel#addresses AlertChannel#addresses}
  */
  readonly addresses: string[];
  /**
  * A string that specifies the name to assign to the alert channel.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/alert_channel#alert_name AlertChannel#alert_name}
  */
  readonly alertName?: string;
  /**
  * A string that specifies the alert channel type. Currently, this must be `EMAIL`.  Options are `EMAIL`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/alert_channel#channel_type AlertChannel#channel_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/alert_channel#environment_id AlertChannel#environment_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/alert_channel#exclude_alert_types AlertChannel#exclude_alert_types}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/alert_channel#include_alert_types AlertChannel#include_alert_types}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/alert_channel#include_severities AlertChannel#include_severities}
  */
  readonly includeSeverities: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/alert_channel pingone_alert_channel}
*/
export class AlertChannel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AlertChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/alert_channel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/alert_channel pingone_alert_channel} Resource
  *
  * @param scope The scope in which to define this construct
