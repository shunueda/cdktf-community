// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/user_group_assignment
...
export interface UserGroupAssignmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/user_group_assignment#environment_id UserGroupAssignment#environment_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/user_group_assignment#group_id UserGroupAssignment#group_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/user_group_assignment#user_id UserGroupAssignment#user_id}
  */
  readonly userId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/user_group_assignment pingone_user_group_assignment}
*/
export class UserGroupAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserGroupAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/user_group_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/user_group_assignment pingone_user_group_assignment} Resource
  *
  * @param scope The scope in which to define this construct
