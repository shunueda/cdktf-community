// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/application_sign_on_policy_assignment
...
export interface ApplicationSignOnPolicyAssignmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/application_sign_on_policy_assignment#application_id ApplicationSignOnPolicyAssignment#application_id}
  */
  readonly applicationId: string;
  /**
  * The ID of the environment to create the application sign-on policy assignment in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/application_sign_on_policy_assignment#environment_id ApplicationSignOnPolicyAssignment#environment_id}
  */
  readonly environmentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/application_sign_on_policy_assignment#id ApplicationSignOnPolicyAssignment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/application_sign_on_policy_assignment#priority ApplicationSignOnPolicyAssignment#priority}
  */
  readonly priority: number;
  /**
  * The ID of the sign-on policy resource to associate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/application_sign_on_policy_assignment#sign_on_policy_id ApplicationSignOnPolicyAssignment#sign_on_policy_id}
  */
  readonly signOnPolicyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/application_sign_on_policy_assignment pingone_application_sign_on_policy_assignment}
*/
export class ApplicationSignOnPolicyAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationSignOnPolicyAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/application_sign_on_policy_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/application_sign_on_policy_assignment pingone_application_sign_on_policy_assignment} Resource
  *
  * @param scope The scope in which to define this construct
