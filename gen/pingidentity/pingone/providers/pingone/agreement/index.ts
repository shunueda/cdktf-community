// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/agreement
...
export interface AgreementConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/agreement#description Agreement#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/agreement#environment_id Agreement#environment_id}
  */
  readonly environmentId: string;
  /**
  * A string that specifies the name of the agreement to configure.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/agreement#name Agreement#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/agreement#reconsent_period_days Agreement#reconsent_period_days}
  */
  readonly reconsentPeriodDays?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/agreement pingone_agreement}
*/
export class Agreement extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Agreement that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/agreement#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/agreement pingone_agreement} Resource
  *
  * @param scope The scope in which to define this construct
