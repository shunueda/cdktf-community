// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/group_role_assignment
...
export interface GroupRoleAssignmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * The ID of the environment that contains the group to assign the admin role to.  Must be a valid PingOne resource ID.  This field is immutable and will trigger a replace plan if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/group_role_assignment#environment_id GroupRoleAssignment#environment_id}
  */
  readonly environmentId: string;
  /**
  * The ID of an group to assign an admin role to.  Must be a valid PingOne resource ID.  This field is immutable and will trigger a replace plan if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/group_role_assignment#group_id GroupRoleAssignment#group_id}
  */
  readonly groupId: string;
  /**
  * The ID of an admin role to assign to the group.  Must be a valid PingOne resource ID.  This field is immutable and will trigger a replace plan if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/group_role_assignment#role_id GroupRoleAssignment#role_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/group_role_assignment#scope_application_id GroupRoleAssignment#scope_application_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/group_role_assignment#scope_environment_id GroupRoleAssignment#scope_environment_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/group_role_assignment#scope_organization_id GroupRoleAssignment#scope_organization_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/group_role_assignment#scope_population_id GroupRoleAssignment#scope_population_id}
  */
  readonly scopePopulationId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/group_role_assignment pingone_group_role_assignment}
*/
export class GroupRoleAssignment extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "pingone_group_role_assignment";
  ...
  * @param importFromId The id of the existing GroupRoleAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/group_role_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "pingone_group_role_assignment", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/group_role_assignment pingone_group_role_assignment} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: GroupRoleAssignmentConfig) {
    super(scope, id, {
      terraformResourceType: 'pingone_group_role_assignment',
