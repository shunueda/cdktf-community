// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/custom_domain
...
export interface CustomDomainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/custom_domain#domain_name CustomDomain#domain_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/custom_domain#environment_id CustomDomain#environment_id}
  */
  readonly environmentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/custom_domain pingone_custom_domain}
*/
export class CustomDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/custom_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/custom_domain pingone_custom_domain} Resource
  *
  * @param scope The scope in which to define this construct
