// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/certificate_signing_response
...
export interface CertificateSigningResponseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/certificate_signing_response#environment_id CertificateSigningResponse#environment_id}
  */
  readonly environmentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/certificate_signing_response#id CertificateSigningResponse#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/certificate_signing_response#key_id CertificateSigningResponse#key_id}
  */
  readonly keyId: string;
  /**
  * A PEM encoded file that has been provided by the signing authority in response to the key's CSR.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/certificate_signing_response#pem_ca_response_file CertificateSigningResponse#pem_ca_response_file}
  */
  readonly pemCaResponseFile: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/certificate_signing_response pingone_certificate_signing_response}
*/
export class CertificateSigningResponse extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CertificateSigningResponse that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/certificate_signing_response#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/resources/certificate_signing_response pingone_certificate_signing_response} Resource
  *
  * @param scope The scope in which to define this construct
