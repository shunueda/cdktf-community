// https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/credential_issuer_profile
...
export interface DataPingoneCredentialIssuerProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/credential_issuer_profile#environment_id DataPingoneCredentialIssuerProfile#environment_id}
  */
  readonly environmentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/credential_issuer_profile pingone_credential_issuer_profile}
*/
export class DataPingoneCredentialIssuerProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPingoneCredentialIssuerProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/credential_issuer_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pingidentity/pingone/1.13.0/docs/data-sources/credential_issuer_profile pingone_credential_issuer_profile} Data Source
  *
  * @param scope The scope in which to define this construct
