// https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.5/docs
...
export interface PrismasaseVmwareProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.5/docs#prismasase_deployment_token PrismasaseVmwareProvider#prismasase_deployment_token}
  */
  readonly prismasaseDeploymentToken: string;
  /**
  * The private region name for the deployment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.5/docs#prismasase_private_location_name PrismasaseVmwareProvider#prismasase_private_location_name}
  */
  readonly prismasasePrivateLocationName: string;
  /**
  * The tenant ID for the deployment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.5/docs#prismasase_tenant_id PrismasaseVmwareProvider#prismasase_tenant_id}
  */
  readonly prismasaseTenantId: string;
  /**
  * The hostname of the VMware ESXi server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.5/docs#vcenter_hostname PrismasaseVmwareProvider#vcenter_hostname}
  */
  readonly vcenterHostname: string;
  /**
  * The password for VMware ESXi server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.5/docs#vcenter_password PrismasaseVmwareProvider#vcenter_password}
  */
  readonly vcenterPassword: string;
  /**
  * The username for VMware ESXi server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.5/docs#vcenter_username PrismasaseVmwareProvider#vcenter_username}
  */
  readonly vcenterUsername: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.5/docs#alias PrismasaseVmwareProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.5/docs prismasase-vmware}
*/
export class PrismasaseVmwareProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing PrismasaseVmwareProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.5/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.5/docs prismasase-vmware} Resource
  *
  * @param scope The scope in which to define this construct
