// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/resources/address
...
export interface AddressConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/resources/address#description Address#description}
  */
  readonly description?: string;
  /**
  * The device in which the resource is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/resources/address#device Address#device}
  */
  readonly device?: string;
  /**
  * The folder in which the resource is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/resources/address#folder Address#folder}
  */
  readonly folder?: string;
  /**
  * Fully qualified domain name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/resources/address#fqdn Address#fqdn}
  */
  readonly fqdn?: string;
  /**
  * IP address with or without CIDR notation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/resources/address#ip_netmask Address#ip_netmask}
  */
  readonly ipNetmask?: string;
  /**
  * Ip range
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/resources/address#ip_range Address#ip_range}
  */
  readonly ipRange?: string;
  /**
  * IP wildcard mask
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/resources/address#ip_wildcard Address#ip_wildcard}
  */
  readonly ipWildcard?: string;
  /**
  * The name of the address object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/resources/address#name Address#name}
  */
  readonly name: string;
  /**
  * The snippet in which the resource is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/resources/address#snippet Address#snippet}
  */
  readonly snippet?: string;
  /**
  * Tags assocaited with the address object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/resources/address#tag Address#tag}
  */
  readonly tag?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/resources/address scm_address}
*/
export class Address extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Address that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/resources/address#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/resources/address scm_address} Resource
  *
  * @param scope The scope in which to define this construct
