// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/data-sources/nat_rule_list
...
export interface DataScmNatRuleListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/data-sources/nat_rule_list#device DataScmNatRuleList#device}
  */
  readonly device?: string;
  /**
  * The folder of the item. Default: Shared.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/data-sources/nat_rule_list#folder DataScmNatRuleList#folder}
  */
  readonly folder?: string;
  /**
  * The max number of items to return. Default: 200.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/data-sources/nat_rule_list#limit DataScmNatRuleList#limit}
  */
  readonly limit?: number;
  /**
  * The name of the item.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/data-sources/nat_rule_list#name DataScmNatRuleList#name}
  */
  readonly name?: string;
  /**
  * The offset of the first item to return.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/data-sources/nat_rule_list#offset DataScmNatRuleList#offset}
  */
  readonly offset?: number;
  /**
  * The snippet of the item.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/data-sources/nat_rule_list#snippet DataScmNatRuleList#snippet}
  */
  readonly snippet?: string;
}
export interface DataScmNatRuleListDataDnsRewrite {
}

export function dataScmNatRuleListDataDnsRewriteToTerraform(struct?: DataScmNatRuleListDataDnsRewrite): any {
...
export function dataScmNatRuleListDataDnsRewriteToHclTerraform(struct?: DataScmNatRuleListDataDnsRewrite): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataScmNatRuleListDataDnsRewriteOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataScmNatRuleListDataDnsRewrite | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataScmNatRuleListDataDnsRewrite | undefined) {
    if (value === undefined) {
...
export interface DataScmNatRuleListDataSourceTranslationFallback {
}

export function dataScmNatRuleListDataSourceTranslationFallbackToTerraform(struct?: DataScmNatRuleListDataSourceTranslationFallback): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataScmNatRuleListDataSourceTranslationFallbackToHclTerraform(struct?: DataScmNatRuleListDataSourceTranslationFallback): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataScmNatRuleListDataSourceTranslationFallbackOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataScmNatRuleListDataSourceTranslationFallback | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataScmNatRuleListDataSourceTranslationFallback | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataScmNatRuleListDataSourceTranslationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _fallback = new DataScmNatRuleListDataSourceTranslationFallbackOutputReference(this, "fallback");
  public get fallback() {
...
export interface DataScmNatRuleListData {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/data-sources/nat_rule_list#id DataScmNatRuleList#id}
  *
...
export class DataScmNatRuleListDataOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _dnsRewrite = new DataScmNatRuleListDataDnsRewriteOutputReference(this, "dns_rewrite");
...
/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/data-sources/nat_rule_list scm_nat_rule_list}
*/
export class DataScmNatRuleList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScmNatRuleList that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/data-sources/nat_rule_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/data-sources/nat_rule_list scm_nat_rule_list} Data Source
  *
  * @param scope The scope in which to define this construct
