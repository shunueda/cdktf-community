// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/data-sources/anti_spyware_signature
...
export interface DataScmAntiSpywareSignatureConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/data-sources/anti_spyware_signature#id DataScmAntiSpywareSignature#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/data-sources/anti_spyware_signature scm_anti_spyware_signature}
*/
export class DataScmAntiSpywareSignature extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScmAntiSpywareSignature that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/data-sources/anti_spyware_signature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.2/docs/data-sources/anti_spyware_signature scm_anti_spyware_signature} Data Source
  *
  * @param scope The scope in which to define this construct
