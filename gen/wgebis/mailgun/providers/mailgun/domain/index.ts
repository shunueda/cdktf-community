...
export interface DomainConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/wgebis/mailgun/0.7.7/docs/resources/domain#click_tracking Domain#click_tracking}
  */
  readonly clickTracking?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/wgebis/mailgun/0.7.7/docs/resources/domain#dkim_key_size Domain#dkim_key_size}
  */
  readonly dkimKeySize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/wgebis/mailgun/0.7.7/docs/resources/domain#dkim_selector Domain#dkim_selector}
  */
  readonly dkimSelector?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/wgebis/mailgun/0.7.7/docs/resources/domain#force_dkim_authority Domain#force_dkim_authority}
  */
  readonly forceDkimAuthority?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/wgebis/mailgun/0.7.7/docs/resources/domain#id Domain#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/wgebis/mailgun/0.7.7/docs/resources/domain#name Domain#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/wgebis/mailgun/0.7.7/docs/resources/domain#open_tracking Domain#open_tracking}
  */
  readonly openTracking?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/wgebis/mailgun/0.7.7/docs/resources/domain#region Domain#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/wgebis/mailgun/0.7.7/docs/resources/domain#smtp_password Domain#smtp_password}
  */
  readonly smtpPassword?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/wgebis/mailgun/0.7.7/docs/resources/domain#spam_action Domain#spam_action}
  */
  readonly spamAction?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/wgebis/mailgun/0.7.7/docs/resources/domain#web_scheme Domain#web_scheme}
  */
  readonly webScheme?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/wgebis/mailgun/0.7.7/docs/resources/domain#wildcard Domain#wildcard}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/wgebis/mailgun/0.7.7/docs/resources/domain mailgun_domain}
*/
export class Domain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Domain that should be imported. Refer to the {@link https://registry.terraform.io/providers/wgebis/mailgun/0.7.7/docs/resources/domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/wgebis/mailgun/0.7.7/docs/resources/domain mailgun_domain} Resource
  *
  * @param scope The scope in which to define this construct
