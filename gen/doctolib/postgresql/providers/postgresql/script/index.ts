// https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/script
...
export interface ScriptConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/script#backoff_delay Script#backoff_delay}
  */
  readonly backoffDelay?: number;
  /**
  * List of SQL commands to execute
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/script#commands Script#commands}
  */
  readonly commands: string[];
  /**
  * The database to execute commands in (defaults to provider's configured database)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/script#database Script#database}
  */
  readonly database?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/script#id Script#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/script#timeout Script#timeout}
  */
  readonly timeout?: number;
  /**
  * Number of tries for a failing command
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/script#tries Script#tries}
  */
  readonly tries?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/script postgresql_script}
*/
export class Script extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Script that should be imported. Refer to the {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/script#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/script postgresql_script} Resource
  *
  * @param scope The scope in which to define this construct
