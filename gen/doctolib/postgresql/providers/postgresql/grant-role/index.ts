// https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/grant_role
...
export interface GrantRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/grant_role#grant_role GrantRole#grant_role}
  */
  readonly grantRole: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/grant_role#id GrantRole#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/grant_role#role GrantRole#role}
  */
  readonly role: string;
  /**
  * Permit the grant recipient to grant it to others
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/grant_role#with_admin_option GrantRole#with_admin_option}
  */
  readonly withAdminOption?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/grant_role postgresql_grant_role}
*/
export class GrantRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GrantRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/grant_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/grant_role postgresql_grant_role} Resource
  *
  * @param scope The scope in which to define this construct
