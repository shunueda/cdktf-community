// https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/alter_role
...
export interface AlterRoleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/alter_role#id AlterRole#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/alter_role#parameter_key AlterRole#parameter_key}
  */
  readonly parameterKey: string;
  /**
  * The value of the parameter which is being set
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/alter_role#parameter_value AlterRole#parameter_value}
  */
  readonly parameterValue: string;
  /**
  * The name of the role to alter the attributes of
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/alter_role#role_name AlterRole#role_name}
  */
  readonly roleName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/alter_role postgresql_alter_role}
*/
export class AlterRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AlterRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/alter_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/doctolib/postgresql/2.26.1/docs/resources/alter_role postgresql_alter_role} Resource
  *
  * @param scope The scope in which to define this construct
