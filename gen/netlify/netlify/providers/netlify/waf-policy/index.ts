// https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/waf_policy
...
export interface WafPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/waf_policy#description WafPolicy#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/waf_policy#name WafPolicy#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/waf_policy#rule_sets WafPolicy#rule_sets}
  */
  readonly ruleSets: WafPolicyRuleSets[] | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/waf_policy#team_id WafPolicy#team_id}
  */
...
export interface WafPolicyRuleSetsRuleOverrides {
  ...
  * log_only or none
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/waf_policy#action WafPolicy#action}
  */
...
export interface WafPolicyRuleSets {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/waf_policy#category_thresholds WafPolicy#category_thresholds}
  */
  readonly categoryThresholds?: { [key: string]: number };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/waf_policy#excluded_patterns WafPolicy#excluded_patterns}
  */
  readonly excludedPatterns?: string[];
  /**
  * The managed ID of the rule set. Currently, only crs-basic is supported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/waf_policy#managed_id WafPolicy#managed_id}
  */
  readonly managedId: string;
  /**
  * Recommended default value is 5
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/waf_policy#overall_threshold WafPolicy#overall_threshold}
  */
  readonly overallThreshold: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/waf_policy#passive_mode WafPolicy#passive_mode}
  */
  readonly passiveMode: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/waf_policy#rule_overrides WafPolicy#rule_overrides}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/waf_policy netlify_waf_policy}
*/
export class WafPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/waf_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/waf_policy netlify_waf_policy} Resource
  *
  * @param scope The scope in which to define this construct
