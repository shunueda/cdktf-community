// https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/data-sources/dns_zone
...
export interface DataNetlifyDnsZoneConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/data-sources/dns_zone#id DataNetlifyDnsZone#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/data-sources/dns_zone#name DataNetlifyDnsZone#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/data-sources/dns_zone netlify_dns_zone}
*/
export class DataNetlifyDnsZone extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNetlifyDnsZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/data-sources/dns_zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/data-sources/dns_zone netlify_dns_zone} Data Source
  *
  * @param scope The scope in which to define this construct
