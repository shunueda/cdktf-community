// https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs
...
export interface NetlifyProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs#default_team_id NetlifyProvider#default_team_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs#default_team_slug NetlifyProvider#default_team_slug}
  */
  readonly defaultTeamSlug?: string;
  /**
  * Defaults to: https://api.netlify.com
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs#endpoint NetlifyProvider#endpoint}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs#token NetlifyProvider#token}
  */
  readonly token?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs#alias NetlifyProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs netlify}
*/
export class NetlifyProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing NetlifyProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs netlify} Resource
  *
  * @param scope The scope in which to define this construct
