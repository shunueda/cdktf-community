// https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/log_drain
...
export interface LogDrainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/log_drain#destination LogDrain#destination}
  */
  readonly destination: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/log_drain#exclude_pii LogDrain#exclude_pii}
  */
  readonly excludePii: boolean | cdktf.IResolvable;
  /**
  * json or ndjson
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/log_drain#format LogDrain#format}
  */
  readonly format?: string;
  /**
  * One or more of user_traffic, functions, edge_functions, waf_logs, and deploys
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/log_drain#log_types LogDrain#log_types}
  */
  readonly logTypes: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/log_drain#service_config LogDrain#service_config}
  */
  readonly serviceConfig: LogDrainServiceConfig;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/log_drain#site_id LogDrain#site_id}
  */
  readonly siteId: string;
}
export interface LogDrainServiceConfig {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/log_drain#authorization_header LogDrain#authorization_header}
  */
  readonly authorizationHeader?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/log_drain#bucket_name LogDrain#bucket_name}
  */
  readonly bucketName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/log_drain#bucket_region LogDrain#bucket_region}
  */
  readonly bucketRegion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/log_drain#integration_name LogDrain#integration_name}
  */
  readonly integrationName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/log_drain#path LogDrain#path}
  */
  readonly path?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/log_drain#tags LogDrain#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/log_drain#url LogDrain#url}
  */
  readonly url?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/log_drain#verification_filename LogDrain#verification_filename}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/log_drain netlify_log_drain}
*/
export class LogDrain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogDrain that should be imported. Refer to the {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/log_drain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/log_drain netlify_log_drain} Resource
  *
  * @param scope The scope in which to define this construct
