// https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/dns_zone
...
export interface DnsZoneConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/dns_zone#name DnsZone#name}
  */
  readonly name: string;
  /**
  * Required if a default team was not configured in the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/dns_zone#team_slug DnsZone#team_slug}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/dns_zone netlify_dns_zone}
*/
export class DnsZone extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/dns_zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/dns_zone netlify_dns_zone} Resource
  *
  * @param scope The scope in which to define this construct
