// https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/data-sources/sites
...
export interface DataNetlifySitesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/data-sources/sites#team_slug DataNetlifySites#team_slug}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/data-sources/sites netlify_sites}
*/
export class DataNetlifySites extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNetlifySites that should be imported. Refer to the {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/data-sources/sites#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/data-sources/sites netlify_sites} Data Source
  *
  * @param scope The scope in which to define this construct
