// https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/data-sources/managed_waf_rules
...
export interface DataNetlifyManagedWafRulesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/data-sources/managed_waf_rules#team_id DataNetlifyManagedWafRules#team_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/data-sources/managed_waf_rules netlify_managed_waf_rules}
*/
export class DataNetlifyManagedWafRules extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNetlifyManagedWafRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/data-sources/managed_waf_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/data-sources/managed_waf_rules netlify_managed_waf_rules} Data Source
  *
  * @param scope The scope in which to define this construct
