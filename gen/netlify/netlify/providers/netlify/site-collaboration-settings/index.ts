// https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/site_collaboration_settings
...
export interface SiteCollaborationSettingsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/site_collaboration_settings#netlify_drawer_in_branch_deploys SiteCollaborationSettings#netlify_drawer_in_branch_deploys}
  */
  readonly netlifyDrawerInBranchDeploys: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/site_collaboration_settings#netlify_drawer_in_deploy_previews SiteCollaborationSettings#netlify_drawer_in_deploy_previews}
  */
  readonly netlifyDrawerInDeployPreviews: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/site_collaboration_settings#netlify_heads_up_display SiteCollaborationSettings#netlify_heads_up_display}
  */
  readonly netlifyHeadsUpDisplay: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/site_collaboration_settings#site_id SiteCollaborationSettings#site_id}
  */
  readonly siteId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/site_collaboration_settings netlify_site_collaboration_settings}
*/
export class SiteCollaborationSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SiteCollaborationSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/site_collaboration_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netlify/netlify/0.2.3/docs/resources/site_collaboration_settings netlify_site_collaboration_settings} Resource
  *
  * @param scope The scope in which to define this construct
