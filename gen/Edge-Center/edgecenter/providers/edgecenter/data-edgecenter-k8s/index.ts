// https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/data-sources/k8s
...
export interface DataEdgecenterK8SConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/data-sources/k8s#cluster_id DataEdgecenterK8S#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/data-sources/k8s#id DataEdgecenterK8S#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/data-sources/k8s#project_id DataEdgecenterK8S#project_id}
  */
  readonly projectId?: number;
  /**
  * The name of the project. Either 'project_id' or 'project_name' must be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/data-sources/k8s#project_name DataEdgecenterK8S#project_name}
  */
  readonly projectName?: string;
  /**
  * The uuid of the region. Either 'region_id' or 'region_name' must be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/data-sources/k8s#region_id DataEdgecenterK8S#region_id}
  */
  readonly regionId?: number;
  /**
  * The name of the region. Either 'region_id' or 'region_name' must be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/data-sources/k8s#region_name DataEdgecenterK8S#region_name}
  */
...
export function dataEdgecenterK8SPoolToTerraform(struct?: DataEdgecenterK8SPool): any {
...
export function dataEdgecenterK8SPoolToHclTerraform(struct?: DataEdgecenterK8SPool): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataEdgecenterK8SPoolOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataEdgecenterK8SPool | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataEdgecenterK8SPool | undefined) {
    if (value === undefined) {
...
export class DataEdgecenterK8SPoolList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataEdgecenterK8SPoolOutputReference {
    return new DataEdgecenterK8SPoolOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/data-sources/k8s edgecenter_k8s}
*/
export class DataEdgecenterK8S extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEdgecenterK8S that should be imported. Refer to the {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/data-sources/k8s#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/data-sources/k8s edgecenter_k8s} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataEdgecenterK8SConfig
  */
  public constructor(scope: Construct, id: string, config: DataEdgecenterK8SConfig) {
    super(scope, id, {
  ...
  private _pool = new DataEdgecenterK8SPoolList(this, "pool", false);
  public get pool() {
    return this._pool;
  }
