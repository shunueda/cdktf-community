// https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener
...
export interface LblistenerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#allowed_cidrs Lblistener#allowed_cidrs}
  */
  readonly allowedCidrs?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#id Lblistener#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#insert_x_forwarded Lblistener#insert_x_forwarded}
  */
  readonly insertXForwarded?: boolean | cdktf.IResolvable;
  /**
  * The timestamp of the last update (use with update context).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#last_updated Lblistener#last_updated}
  */
  readonly lastUpdated?: string;
  /**
  * The uuid for the load balancer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#loadbalancer_id Lblistener#loadbalancer_id}
  */
  readonly loadbalancerId: string;
  /**
  * The name of the load balancer listener.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#name Lblistener#name}
  */
  readonly name: string;
  /**
  * The uuid of the project. Either 'project_id' or 'project_name' must be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#project_id Lblistener#project_id}
  */
  readonly projectId?: number;
  /**
  * The name of the project. Either 'project_id' or 'project_name' must be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#project_name Lblistener#project_name}
  */
  readonly projectName?: string;
  /**
  * Available values are 'TCP', 'UDP', 'HTTP', 'HTTPS' and 'TERMINATED_HTTPS'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#protocol Lblistener#protocol}
  */
  readonly protocol: string;
  /**
  * The port on which the protocol is bound.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#protocol_port Lblistener#protocol_port}
  */
  readonly protocolPort: number;
  /**
  * The uuid of the region. Either 'region_id' or 'region_name' must be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#region_id Lblistener#region_id}
  */
  readonly regionId?: number;
  /**
  * The name of the region. Either 'region_id' or 'region_name' must be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#region_name Lblistener#region_name}
  */
  readonly regionName?: string;
  /**
  * The identifier for the associated secret, typically used for SSL configurations.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#secret_id Lblistener#secret_id}
  */
  readonly secretId?: string;
  /**
  * List of secret identifiers used for Server Name Indication (SNI).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#sni_secret_id Lblistener#sni_secret_id}
  */
  readonly sniSecretId?: string[];
  /**
  * The timeout for the frontend client inactivity (in milliseconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#timeout_client_data Lblistener#timeout_client_data}
  */
  readonly timeoutClientData?: number;
  /**
  * The timeout for the backend member connection (in milliseconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#timeout_member_connect Lblistener#timeout_member_connect}
  */
  readonly timeoutMemberConnect?: number;
  /**
  * The timeout for the backend member inactivity (in milliseconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#timeout_member_data Lblistener#timeout_member_data}
  */
  readonly timeoutMemberData?: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#timeouts Lblistener#timeouts}
  */
  readonly timeouts?: LblistenerTimeouts;
}
export interface LblistenerTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#create Lblistener#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#delete Lblistener#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener edgecenter_lblistener}
*/
export class Lblistener extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Lblistener that should be imported. Refer to the {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/edge-center/edgecenter/0.10.3/docs/resources/lblistener edgecenter_lblistener} Resource
  *
  * @param scope The scope in which to define this construct
