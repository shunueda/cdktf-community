// https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git
...
export interface BootstrapGitConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#cluster_domain BootstrapGit#cluster_domain}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#components BootstrapGit#components}
  */
  readonly components?: string[];
  /**
  * List of extra components to include in the install manifests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#components_extra BootstrapGit#components_extra}
  */
  readonly componentsExtra?: string[];
  /**
  * Delete manifests from git repository. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#delete_git_manifests BootstrapGit#delete_git_manifests}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#disable_secret_creation BootstrapGit#disable_secret_creation}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#embedded_manifests BootstrapGit#embedded_manifests}
  */
  readonly embeddedManifests?: boolean | cdktf.IResolvable;
  /**
  * Kubernetes secret name used for pulling the toolkit images from a private registry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#image_pull_secret BootstrapGit#image_pull_secret}
  */
  readonly imagePullSecret?: string;
  /**
  * Interval at which to reconcile from bootstrap repository. Defaults to `1m0s`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#interval BootstrapGit#interval}
  */
  readonly interval?: string;
  /**
  * Keep the namespace after uninstalling Flux components. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#keep_namespace BootstrapGit#keep_namespace}
  */
  readonly keepNamespace?: boolean | cdktf.IResolvable;
  /**
  * Kustomization to override configuration set by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#kustomization_override BootstrapGit#kustomization_override}
  */
  readonly kustomizationOverride?: string;
  /**
  * Log level for toolkit components. Defaults to `info`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#log_level BootstrapGit#log_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#manifests_path BootstrapGit#manifests_path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#namespace BootstrapGit#namespace}
  */
  readonly namespace?: string;
  /**
  * Deny ingress access to the toolkit controllers from other namespaces using network policies. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#network_policy BootstrapGit#network_policy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#path BootstrapGit#path}
  */
  readonly path?: string;
  /**
  * Configures the GitRepository source to initialize and include Git submodules in the artifact it produces.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#recurse_submodules BootstrapGit#recurse_submodules}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#registry BootstrapGit#registry}
  */
  readonly registry?: string;
  /**
  * Container registry credentials in the format 'user:password'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#registry_credentials BootstrapGit#registry_credentials}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#secret_name BootstrapGit#secret_name}
  */
  readonly secretName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#timeouts BootstrapGit#timeouts}
  */
  readonly timeouts?: BootstrapGitTimeouts;
  /**
  * List of toleration keys used to schedule the components pods onto nodes with matching taints.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#toleration_keys BootstrapGit#toleration_keys}
  */
  readonly tolerationKeys?: string[];
  /**
  * Flux version. Defaults to `v2.7.2`. Has no effect when `embedded_manifests` is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#version BootstrapGit#version}
  */
  readonly version?: string;
  /**
  * If true watch for custom resources in all namespaces. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#watch_all_namespaces BootstrapGit#watch_all_namespaces}
  */
...
export interface BootstrapGitTimeouts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#create BootstrapGit#create}
  */
  readonly create?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#delete BootstrapGit#delete}
  */
  readonly delete?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Read operations occur during any refresh or planning operation when refresh is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#read BootstrapGit#read}
  */
  readonly read?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#update BootstrapGit#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git flux_bootstrap_git}
*/
export class BootstrapGit extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BootstrapGit that should be imported. Refer to the {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.3/docs/resources/bootstrap_git flux_bootstrap_git} Resource
  *
  * @param scope The scope in which to define this construct
