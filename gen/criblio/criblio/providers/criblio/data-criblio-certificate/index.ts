// https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/certificate
...
export interface DataCriblioCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  * Unique ID to GET
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/certificate#id DataCriblioCertificate#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/certificate criblio_certificate}
*/
export class DataCriblioCertificate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/certificate criblio_certificate} Data Source
  *
  * @param scope The scope in which to define this construct
