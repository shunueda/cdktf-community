// https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/certificates
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/certificates criblio_certificates}
*/
export class DataCriblioCertificates extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioCertificates that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/certificates#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/certificates criblio_certificates} Data Source
  *
  * @param scope The scope in which to define this construct
