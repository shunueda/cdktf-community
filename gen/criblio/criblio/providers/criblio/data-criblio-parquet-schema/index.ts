// https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/parquet_schema
...
export interface DataCriblioParquetSchemaConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/parquet_schema#group_id DataCriblioParquetSchema#group_id}
  */
  readonly groupId: string;
  /**
  * Unique ID to GET
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/parquet_schema#id DataCriblioParquetSchema#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/parquet_schema criblio_parquet_schema}
*/
export class DataCriblioParquetSchema extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioParquetSchema that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/parquet_schema#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/parquet_schema criblio_parquet_schema} Data Source
  *
  * @param scope The scope in which to define this construct
