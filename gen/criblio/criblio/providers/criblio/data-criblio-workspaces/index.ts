// https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/workspaces
...
export interface DataCriblioWorkspacesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/workspaces#organization_id DataCriblioWorkspaces#organization_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/workspaces criblio_workspaces}
*/
export class DataCriblioWorkspaces extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioWorkspaces that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/workspaces#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/workspaces criblio_workspaces} Data Source
  *
  * @param scope The scope in which to define this construct
