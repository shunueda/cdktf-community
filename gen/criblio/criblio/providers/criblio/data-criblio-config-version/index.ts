// https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/config_version
...
export interface DataCriblioConfigVersionConfig extends cdktf.TerraformMetaArguments {
  ...
  * Group ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/config_version#id DataCriblioConfigVersion#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/config_version criblio_config_version}
*/
export class DataCriblioConfigVersion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioConfigVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/config_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/config_version criblio_config_version} Data Source
  *
  * @param scope The scope in which to define this construct
