// https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/sources
...
export interface DataCriblioSourcesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/sources#group_id DataCriblioSources#group_id}
  */
  readonly groupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/sources criblio_sources}
*/
export class DataCriblioSources extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioSources that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/sources#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/sources criblio_sources} Data Source
  *
  * @param scope The scope in which to define this construct
