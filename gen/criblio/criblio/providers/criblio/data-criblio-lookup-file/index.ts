// https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/lookup_file
...
export interface DataCriblioLookupFileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/lookup_file#group_id DataCriblioLookupFile#group_id}
  */
  readonly groupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/lookup_file criblio_lookup_file}
*/
export class DataCriblioLookupFile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioLookupFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/lookup_file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/lookup_file criblio_lookup_file} Data Source
  *
  * @param scope The scope in which to define this construct
