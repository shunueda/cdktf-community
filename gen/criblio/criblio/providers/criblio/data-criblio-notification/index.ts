// https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/notification
...
export interface DataCriblioNotificationConfig extends cdktf.TerraformMetaArguments {
  ...
  * Unique ID to GET
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/notification#id DataCriblioNotification#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/notification criblio_notification}
*/
export class DataCriblioNotification extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/notification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/notification criblio_notification} Data Source
  *
  * @param scope The scope in which to define this construct
