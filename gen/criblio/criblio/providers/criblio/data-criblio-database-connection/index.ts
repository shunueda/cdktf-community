// https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/database_connection
...
export interface DataCriblioDatabaseConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/database_connection#group_id DataCriblioDatabaseConnection#group_id}
  */
  readonly groupId: string;
  /**
  * Unique ID to GET
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/database_connection#id DataCriblioDatabaseConnection#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/database_connection criblio_database_connection}
*/
export class DataCriblioDatabaseConnection extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioDatabaseConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/database_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.18.8/docs/data-sources/database_connection criblio_database_connection} Data Source
  *
  * @param scope The scope in which to define this construct
