// https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/user
...
export interface DataTailscaleUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/user#id DataTailscaleUser#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/user#login_name DataTailscaleUser#login_name}
  */
  readonly loginName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/user tailscale_user}
*/
export class DataTailscaleUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTailscaleUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/user tailscale_user} Data Source
  *
  * @param scope The scope in which to define this construct
