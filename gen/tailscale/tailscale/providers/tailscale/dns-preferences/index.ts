// https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/dns_preferences
...
export interface DnsPreferencesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/dns_preferences#id DnsPreferences#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/dns_preferences#magic_dns DnsPreferences#magic_dns}
  */
  readonly magicDns: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/dns_preferences tailscale_dns_preferences}
*/
export class DnsPreferences extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsPreferences that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/dns_preferences#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/dns_preferences tailscale_dns_preferences} Resource
  *
  * @param scope The scope in which to define this construct
