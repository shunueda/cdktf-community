// https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/posture_integration
...
export interface PostureIntegrationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/posture_integration#client_id PostureIntegration#client_id}
  */
  readonly clientId?: string;
  /**
  * The secret (auth key, token, etc.) used to authenticate with the provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/posture_integration#client_secret PostureIntegration#client_secret}
  */
  readonly clientSecret: string;
  /**
  * Identifies which of the provider's clouds to integrate with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/posture_integration#cloud_id PostureIntegration#cloud_id}
  */
  readonly cloudId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/posture_integration#id PostureIntegration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/posture_integration#posture_provider PostureIntegration#posture_provider}
  */
  readonly postureProvider: string;
  /**
  * The Microsoft Intune directory (tenant) ID. For other providers, this is left blank.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/posture_integration#tenant_id PostureIntegration#tenant_id}
  */
  readonly tenantId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/posture_integration tailscale_posture_integration}
*/
export class PostureIntegration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PostureIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/posture_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/posture_integration tailscale_posture_integration} Resource
  *
  * @param scope The scope in which to define this construct
