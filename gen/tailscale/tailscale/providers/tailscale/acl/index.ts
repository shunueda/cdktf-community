// https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/acl
...
export interface AclConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/acl#acl Acl#acl}
  */
  readonly acl: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/acl#id Acl#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/acl#overwrite_existing_content Acl#overwrite_existing_content}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/acl#reset_acl_on_destroy Acl#reset_acl_on_destroy}
  */
  readonly resetAclOnDestroy?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/acl tailscale_acl}
*/
export class Acl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Acl that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/acl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/acl tailscale_acl} Resource
  *
  * @param scope The scope in which to define this construct
