// https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/dns_search_paths
...
export interface DnsSearchPathsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/dns_search_paths#id DnsSearchPaths#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/dns_search_paths#search_paths DnsSearchPaths#search_paths}
  */
  readonly searchPaths: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/dns_search_paths tailscale_dns_search_paths}
*/
export class DnsSearchPaths extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsSearchPaths that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/dns_search_paths#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/dns_search_paths tailscale_dns_search_paths} Resource
  *
  * @param scope The scope in which to define this construct
