// https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/oauth_client
...
export interface OauthClientConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/oauth_client#description OauthClient#description}
  */
  readonly description?: string;
  /**
  * Scopes to grant to the client. See https://tailscale.com/kb/1215/ for a list of available scopes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/oauth_client#scopes OauthClient#scopes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/oauth_client#tags OauthClient#tags}
  */
  readonly tags?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/oauth_client tailscale_oauth_client}
*/
export class OauthClient extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OauthClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/oauth_client#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/oauth_client tailscale_oauth_client} Resource
  *
  * @param scope The scope in which to define this construct
