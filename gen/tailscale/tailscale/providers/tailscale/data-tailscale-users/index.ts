// https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/users
...
export interface DataTailscaleUsersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/users#id DataTailscaleUsers#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/users#role DataTailscaleUsers#role}
  */
  readonly role?: string;
  /**
  * Filters the users list to elements whose type is the provided value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/users#type DataTailscaleUsers#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/users tailscale_users}
*/
export class DataTailscaleUsers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTailscaleUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/users#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/users tailscale_users} Data Source
  *
  * @param scope The scope in which to define this construct
