// https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_settings
...
export interface TailnetSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_settings#acls_external_link TailnetSettings#acls_external_link}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_settings#acls_externally_managed_on TailnetSettings#acls_externally_managed_on}
  */
  readonly aclsExternallyManagedOn?: boolean | cdktf.IResolvable;
  /**
  * Whether device approval is enabled for the tailnet
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_settings#devices_approval_on TailnetSettings#devices_approval_on}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_settings#devices_auto_updates_on TailnetSettings#devices_auto_updates_on}
  */
  readonly devicesAutoUpdatesOn?: boolean | cdktf.IResolvable;
  /**
  * The key expiry duration for devices on this tailnet
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_settings#devices_key_duration_days TailnetSettings#devices_key_duration_days}
  */
  readonly devicesKeyDurationDays?: number;
  /**
  * Whether provisioning of HTTPS certificates is enabled for the tailnet
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_settings#https_enabled TailnetSettings#https_enabled}
  */
  readonly httpsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_settings#id TailnetSettings#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_settings#network_flow_logging_on TailnetSettings#network_flow_logging_on}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_settings#posture_identity_collection_on TailnetSettings#posture_identity_collection_on}
  */
  readonly postureIdentityCollectionOn?: boolean | cdktf.IResolvable;
  /**
  * Whether regional routing is enabled for the tailnet
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_settings#regional_routing_on TailnetSettings#regional_routing_on}
  */
  readonly regionalRoutingOn?: boolean | cdktf.IResolvable;
  /**
  * Whether user approval is enabled for this tailnet
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_settings#users_approval_on TailnetSettings#users_approval_on}
  */
  readonly usersApprovalOn?: boolean | cdktf.IResolvable;
  /**
  * Which user roles are allowed to join external tailnets
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_settings#users_role_allowed_to_join_external_tailnet TailnetSettings#users_role_allowed_to_join_external_tailnet}
  */
  readonly usersRoleAllowedToJoinExternalTailnet?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_settings tailscale_tailnet_settings}
*/
export class TailnetSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TailnetSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_settings tailscale_tailnet_settings} Resource
  *
  * @param scope The scope in which to define this construct
