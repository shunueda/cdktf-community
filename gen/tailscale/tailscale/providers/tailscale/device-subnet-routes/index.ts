// https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/device_subnet_routes
...
export interface DeviceSubnetRoutesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/device_subnet_routes#device_id DeviceSubnetRoutes#device_id}
  */
  readonly deviceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/device_subnet_routes#id DeviceSubnetRoutes#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/device_subnet_routes#routes DeviceSubnetRoutes#routes}
  */
  readonly routes: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/device_subnet_routes tailscale_device_subnet_routes}
*/
export class DeviceSubnetRoutes extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DeviceSubnetRoutes that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/device_subnet_routes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/device_subnet_routes tailscale_device_subnet_routes} Resource
  *
  * @param scope The scope in which to define this construct
