// https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/device_authorization
...
export interface DeviceAuthorizationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/device_authorization#authorized DeviceAuthorization#authorized}
  */
  readonly authorized: boolean | cdktf.IResolvable;
  /**
  * The device to set as authorized
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/device_authorization#device_id DeviceAuthorization#device_id}
  */
  readonly deviceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/device_authorization#id DeviceAuthorization#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/device_authorization tailscale_device_authorization}
*/
export class DeviceAuthorization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DeviceAuthorization that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/device_authorization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/device_authorization tailscale_device_authorization} Resource
  *
  * @param scope The scope in which to define this construct
