// https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration
...
export interface LogstreamConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration#compression_format LogstreamConfiguration#compression_format}
  */
  readonly compressionFormat?: string;
  /**
  * The type of system to which logs are being streamed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration#destination_type LogstreamConfiguration#destination_type}
  */
  readonly destinationType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration#id LogstreamConfiguration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration#log_type LogstreamConfiguration#log_type}
  */
  readonly logType: string;
  /**
  * The S3 access key ID. Required if destination_type is s3 and s3_authentication_type is 'accesskey'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration#s3_access_key_id LogstreamConfiguration#s3_access_key_id}
  */
  readonly s3AccessKeyId?: string;
  /**
  * What type of authentication to use for S3. Required if destination_type is 's3'. Tailscale recommends using 'rolearn'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration#s3_authentication_type LogstreamConfiguration#s3_authentication_type}
  */
  readonly s3AuthenticationType?: string;
  /**
  * The S3 bucket name. Required if destination_type is 's3'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration#s3_bucket LogstreamConfiguration#s3_bucket}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration#s3_external_id LogstreamConfiguration#s3_external_id}
  */
  readonly s3ExternalId?: string;
  /**
  * An optional S3 key prefix to prepend to the auto-generated S3 key name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration#s3_key_prefix LogstreamConfiguration#s3_key_prefix}
  */
  readonly s3KeyPrefix?: string;
  /**
  * The region in which the S3 bucket is located. Required if destination_type is 's3'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration#s3_region LogstreamConfiguration#s3_region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration#s3_role_arn LogstreamConfiguration#s3_role_arn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration#s3_secret_access_key LogstreamConfiguration#s3_secret_access_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration#token LogstreamConfiguration#token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration#upload_period_minutes LogstreamConfiguration#upload_period_minutes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration#url LogstreamConfiguration#url}
  */
  readonly url?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration#user LogstreamConfiguration#user}
  */
  readonly user?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration tailscale_logstream_configuration}
*/
export class LogstreamConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogstreamConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/logstream_configuration tailscale_logstream_configuration} Resource
  *
  * @param scope The scope in which to define this construct
