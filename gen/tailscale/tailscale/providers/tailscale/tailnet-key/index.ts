// https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_key
...
export interface TailnetKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_key#description TailnetKey#description}
  */
  readonly description?: string;
  /**
  * Indicates if the key is ephemeral. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_key#ephemeral TailnetKey#ephemeral}
  */
  readonly ephemeral?: boolean | cdktf.IResolvable;
  /**
  * The expiry of the key in seconds. Defaults to `7776000` (90 days).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_key#expiry TailnetKey#expiry}
  */
  readonly expiry?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_key#id TailnetKey#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_key#preauthorized TailnetKey#preauthorized}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_key#recreate_if_invalid TailnetKey#recreate_if_invalid}
  */
  readonly recreateIfInvalid?: string;
  /**
  * Indicates if the key is reusable or single-use. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_key#reusable TailnetKey#reusable}
  */
  readonly reusable?: boolean | cdktf.IResolvable;
  /**
  * List of tags to apply to the machines authenticated by the key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_key#tags TailnetKey#tags}
  */
  readonly tags?: string[];
  /**
  * ID of the user who created this key, empty for keys created by OAuth clients.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_key#user_id TailnetKey#user_id}
  */
  readonly userId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_key tailscale_tailnet_key}
*/
export class TailnetKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TailnetKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/resources/tailnet_key tailscale_tailnet_key} Resource
  *
  * @param scope The scope in which to define this construct
