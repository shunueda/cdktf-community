// https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/4via6
...
export interface DataTailscale4Via6Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/4via6#cidr DataTailscale4Via6#cidr}
  */
  readonly cidr: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/4via6#id DataTailscale4Via6#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/4via6#site DataTailscale4Via6#site}
  */
  readonly site: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/4via6 tailscale_4via6}
*/
export class DataTailscale4Via6 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTailscale4Via6 that should be imported. Refer to the {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/4via6#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tailscale/tailscale/0.23.0/docs/data-sources/4via6 tailscale_4via6} Data Source
  *
  * @param scope The scope in which to define this construct
