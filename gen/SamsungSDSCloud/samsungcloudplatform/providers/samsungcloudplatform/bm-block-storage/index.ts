// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/bm_block_storage
...
export interface BmBlockStorageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/bm_block_storage#bm_server_ids BmBlockStorage#bm_server_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/bm_block_storage#encrypted BmBlockStorage#encrypted}
  */
  readonly encrypted?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/bm_block_storage#id BmBlockStorage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/bm_block_storage#name BmBlockStorage#name}
  */
  readonly name: string;
  /**
  * You can use by selecting SSD or HDD based storage.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/bm_block_storage#product_name BmBlockStorage#product_name}
  */
  readonly productName?: string;
  /**
  * schedule for snapshot
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/bm_block_storage#snap_shot_schedule BmBlockStorage#snap_shot_schedule}
  */
  readonly snapShotSchedule?: { [key: string]: string };
  /**
  * snapshot capacity rate(100 ~ 500)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/bm_block_storage#snapshot_capacity_rate BmBlockStorage#snapshot_capacity_rate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/bm_block_storage#snapshot_policy BmBlockStorage#snapshot_policy}
  */
  readonly snapshotPolicy?: boolean | cdktf.IResolvable;
  /**
  * The storage size(GB) of the block storage to create. (10 to  16384 GB)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/bm_block_storage#storage_size_gb BmBlockStorage#storage_size_gb}
  */
  readonly storageSizeGb: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/bm_block_storage#tags BmBlockStorage#tags}
  */
  readonly tags?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/bm_block_storage samsungcloudplatform_bm_block_storage}
*/
export class BmBlockStorage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BmBlockStorage that should be imported. Refer to the {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/bm_block_storage#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/bm_block_storage samsungcloudplatform_bm_block_storage} Resource
  *
  * @param scope The scope in which to define this construct
