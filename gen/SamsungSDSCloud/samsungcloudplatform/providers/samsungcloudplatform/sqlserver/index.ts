// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver
...
export interface SqlserverConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#audit_enabled Sqlserver#audit_enabled}
  */
  readonly auditEnabled: boolean | cdktf.IResolvable;
  /**
  * Contract : None, 1-year, 3-year
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#contract_period Sqlserver#contract_period}
  */
  readonly contractPeriod: string;
  /**
  * Commands that specify how to sort and compare data
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#database_collation Sqlserver#database_collation}
  */
  readonly databaseCollation: string;
  /**
  * Database Name List
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#database_names Sqlserver#database_names}
  */
  readonly databaseNames: string[];
  /**
  * Port number of this database. (1024 to 65535)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#database_port Sqlserver#database_port}
  */
  readonly databasePort: number;
  /**
  * MS SQL Server Database Service name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#database_service_name Sqlserver#database_service_name}
  */
  readonly databaseServiceName: string;
  /**
  * User account id of database. (2 to 20 alpha-numerics)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#database_user_name Sqlserver#database_user_name}
  */
  readonly databaseUserName: string;
  /**
  * User account password of database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#database_user_password Sqlserver#database_user_password}
  */
  readonly databaseUserPassword: string;
  /**
  * Whether to use storage encryption.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#encryption_enabled Sqlserver#encryption_enabled}
  */
  readonly encryptionEnabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#id Sqlserver#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#image_id Sqlserver#image_id}
  */
  readonly imageId: string;
  /**
  * License key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#license Sqlserver#license}
  */
  readonly license: string;
  /**
  * Whether to use nat.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#nat_enabled Sqlserver#nat_enabled}
  */
  readonly natEnabled?: boolean | cdktf.IResolvable;
  /**
  * Public IP for NAT. If it is null, it is automatically allocated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#nat_public_ip_id Sqlserver#nat_public_ip_id}
  */
  readonly natPublicIpId?: string;
  /**
  * Next contract : None, 1-year, 3-year
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#next_contract_period Sqlserver#next_contract_period}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#security_group_ids Sqlserver#security_group_ids}
  */
  readonly securityGroupIds: string[];
  /**
  * Whether to use storage encryption.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#server_type Sqlserver#server_type}
  */
  readonly serverType: string;
  /**
  * Service Zone Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#service_zone_id Sqlserver#service_zone_id}
  */
  readonly serviceZoneId: string;
  /**
  * Name of database cluster. (3 to 20 characters only)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#sqlserver_cluster_name Sqlserver#sqlserver_cluster_name}
  */
  readonly sqlserverClusterName: string;
  /**
  * MS SQL Server cluster state
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#sqlserver_cluster_state Sqlserver#sqlserver_cluster_state}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#subnet_id Sqlserver#subnet_id}
  */
  readonly subnetId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#tags Sqlserver#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Timezone setting of this database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#timezone Sqlserver#timezone}
  */
  readonly timezone: string;
  /**
  * backup block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#backup Sqlserver#backup}
  */
  readonly backup?: SqlserverBackup;
  /**
  * block_storages block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#block_storages Sqlserver#block_storages}
  */
  readonly blockStorages: SqlserverBlockStorages[] | cdktf.IResolvable;
  /**
  * sqlserver_active_directory block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#sqlserver_active_directory Sqlserver#sqlserver_active_directory}
  */
  readonly sqlserverActiveDirectory?: SqlserverSqlserverActiveDirectory[] | cdktf.IResolvable;
  /**
  * sqlserver_servers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#sqlserver_servers Sqlserver#sqlserver_servers}
  */
  readonly sqlserverServers: SqlserverSqlserverServers[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#timeouts Sqlserver#timeouts}
  */
...
export interface SqlserverBackup {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#archive_backup_schedule_frequency Sqlserver#archive_backup_schedule_frequency}
  */
  readonly archiveBackupScheduleFrequency: string;
  /**
  * Backup File Retention Day.(7D <= day <= 35D) 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#backup_retention_period Sqlserver#backup_retention_period}
  */
  readonly backupRetentionPeriod: string;
  /**
  * The time at which the backup starts. (from 0 to 23)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#backup_start_hour Sqlserver#backup_start_hour}
  */
  readonly backupStartHour: number;
  /**
  * Full backup schedule(Day). (MONDAY to SUNDAY)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#full_backup_day_of_week Sqlserver#full_backup_day_of_week}
  */
  readonly fullBackupDayOfWeek: string;
  /**
  * Object storage ID where backup files will be stored.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#object_storage_id Sqlserver#object_storage_id}
  */
...
export interface SqlserverBlockStorages {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#block_storage_size Sqlserver#block_storage_size}
  */
  readonly blockStorageSize: number;
  /**
  * Storage product name. (SSD|HDD)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#block_storage_type Sqlserver#block_storage_type}
  */
...
export interface SqlserverSqlserverActiveDirectory {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#ad_server_user_id Sqlserver#ad_server_user_id}
  */
  readonly adServerUserId?: string;
  /**
  * Active Directory Server User password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#ad_server_user_password Sqlserver#ad_server_user_password}
  */
  readonly adServerUserPassword?: string;
  /**
  * Active Directory DNS Server IPs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#dns_server_ips Sqlserver#dns_server_ips}
  */
  readonly dnsServerIps?: string[];
  /**
  * Active Directory Domain name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#domain_name Sqlserver#domain_name}
  */
  readonly domainName?: string;
  /**
  * Active Directory NetBios name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#domain_net_bios_name Sqlserver#domain_net_bios_name}
  */
  readonly domainNetBiosName?: string;
  /**
  * Active Directory Failover Cluster name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#failover_cluster_name Sqlserver#failover_cluster_name}
  */
...
export interface SqlserverSqlserverServers {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#availability_zone_name Sqlserver#availability_zone_name}
  */
  readonly availabilityZoneName?: string;
  /**
  * Server role type Enter 'ACTIVE' for a single server configuration. (ACTIVE | PRIMARY | SECONDARY)",
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#server_role_type Sqlserver#server_role_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#sqlserver_server_name Sqlserver#sqlserver_server_name}
  */
...
export interface SqlserverTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#create Sqlserver#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#delete Sqlserver#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#update Sqlserver#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver samsungcloudplatform_sqlserver}
*/
export class Sqlserver extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Sqlserver that should be imported. Refer to the {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/sqlserver samsungcloudplatform_sqlserver} Resource
  *
  * @param scope The scope in which to define this construct
