// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/subnet_public_ip
...
export interface SubnetPublicIpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/subnet_public_ip#id SubnetPublicIp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/subnet_public_ip#public_ip_address_id SubnetPublicIp#public_ip_address_id}
  */
  readonly publicIpAddressId: string;
  /**
  * Target Subnet id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/subnet_public_ip#subnet_id SubnetPublicIp#subnet_id}
  */
  readonly subnetId: string;
  /**
  * subnet Virtual ip id. (Reserved Virtual ip id)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/subnet_public_ip#vip_id SubnetPublicIp#vip_id}
  */
  readonly vipId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/subnet_public_ip samsungcloudplatform_subnet_public_ip}
*/
export class SubnetPublicIp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SubnetPublicIp that should be imported. Refer to the {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/subnet_public_ip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/subnet_public_ip samsungcloudplatform_subnet_public_ip} Resource
  *
  * @param scope The scope in which to define this construct
