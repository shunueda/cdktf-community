// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway
...
export interface TransitGatewayConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway#bandwidth_gbps TransitGateway#bandwidth_gbps}
  */
  readonly bandwidthGbps: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway#id TransitGateway#id}
  *
  ...
  * Region Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway#region TransitGateway#region}
  */
  readonly region: string;
  /**
  * Transit Gateway description. (Up to 50 characters)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway#transit_gateway_description TransitGateway#transit_gateway_description}
  */
  readonly transitGatewayDescription?: string;
  /**
  * Transit Gateway Name. ( 3 to 20 characters consist of alphabets and numbers)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway#transit_gateway_name TransitGateway#transit_gateway_name}
  */
  readonly transitGatewayName: string;
  /**
  * Option for Uplink
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway#uplink_enabled TransitGateway#uplink_enabled}
  */
  readonly uplinkEnabled?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway samsungcloudplatform_transit_gateway}
*/
export class TransitGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransitGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway samsungcloudplatform_transit_gateway} Resource
  *
  * @param scope The scope in which to define this construct
