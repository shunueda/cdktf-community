// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service
...
export interface LbServiceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#app_profile_id LbService#app_profile_id}
  */
  readonly appProfileId: string;
  /**
  * SSL client certification id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#client_certificate_id LbService#client_certificate_id}
  */
  readonly clientCertificateId?: string;
  /**
  * SSL client security level.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#client_ssl_security_level LbService#client_ssl_security_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#forwarding_ports LbService#forwarding_ports}
  */
  readonly forwardingPorts?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#id LbService#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#layer_type LbService#layer_type}
  */
  readonly layerType: string;
  /**
  * Target Load-Balancer id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#lb_id LbService#lb_id}
  */
  readonly lbId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#lb_service_ip_id LbService#lb_service_ip_id}
  */
  readonly lbServiceIpId?: string;
  /**
  * Name of Load-Balancer Service. (3 to 20 characters with dash in middle)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#name LbService#name}
  */
  readonly name: string;
  /**
  * Wheter to use NAT IP (public IP) or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#nat_active LbService#nat_active}
  */
  readonly natActive?: boolean | cdktf.IResolvable;
  /**
  * Persistence option. (DISABLED, SOURCE_IP, COOKIE)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#persistence LbService#persistence}
  */
  readonly persistence: string;
  /**
  * Persistence target profile id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#persistence_profile_id LbService#persistence_profile_id}
  */
  readonly persistenceProfileId?: string;
  /**
  * Servicing protocol. (TCP, HTTP, HTTPS)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#protocol LbService#protocol}
  */
  readonly protocol: string;
  /**
  * NAT IP attached to LB service IP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#public_ip_id LbService#public_ip_id}
  */
  readonly publicIpId?: string;
  /**
  * SSL server certification id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#server_certificate_id LbService#server_certificate_id}
  */
  readonly serverCertificateId?: string;
  /**
  * SSL server security level.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#server_ssl_security_level LbService#server_ssl_security_level}
  */
  readonly serverSslSecurityLevel?: string;
  /**
  * Servicing IP address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#service_ipv4 LbService#service_ipv4}
  */
  readonly serviceIpv4?: string;
  /**
  * Servicing port numbers. Multiple ports can be inserted using comma and dash. (e.g. 8000-8100,8200)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#service_ports LbService#service_ports}
  */
  readonly servicePorts: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#tags LbService#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#use_access_log LbService#use_access_log}
  */
  readonly useAccessLog?: boolean | cdktf.IResolvable;
  /**
  * lb_rules block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#lb_rules LbService#lb_rules}
  */
  readonly lbRules?: LbServiceLbRules[] | cdktf.IResolvable;
}
export interface LbServiceLbRules {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#lb_rule_seq LbService#lb_rule_seq}
  */
  readonly lbRuleSeq: number;
  /**
  * Target server-group id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#lb_server_group_id LbService#lb_server_group_id}
  */
  readonly lbServerGroupId?: string;
  /**
  * Pattern URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#pattern_url LbService#pattern_url}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service samsungcloudplatform_lb_service}
*/
export class LbService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LbService that should be imported. Refer to the {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_service samsungcloudplatform_lb_service} Resource
  *
  * @param scope The scope in which to define this construct
