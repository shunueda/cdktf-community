// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_profile
...
export interface LbProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_profile#category LbProfile#category}
  */
  readonly category: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_profile#id LbProfile#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_profile#layer_type LbProfile#layer_type}
  */
  readonly layerType?: string;
  /**
  * Target Load Balancer id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_profile#lb_id LbProfile#lb_id}
  */
  readonly lbId: string;
  /**
  * Name of profile. (3 to 20 with dash in middle)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_profile#name LbProfile#name}
  */
  readonly name: string;
  /**
  * Persistence type. (SOURCE_IP, COOKIE) (Only persistence category)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_profile#persistence_type LbProfile#persistence_type}
  */
  readonly persistenceType?: string;
  /**
  * HTTP redirection option.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_profile#redirect_type LbProfile#redirect_type}
  */
  readonly redirectType?: string;
  /**
  * Request header size (Only application category with L7 layer. Recommend: 1024). (1 to 65536)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_profile#request_header_size LbProfile#request_header_size}
  */
  readonly requestHeaderSize?: number;
  /**
  * Response header size (Only application category with L7 layer. Recommend: 4096). (1 to 65536)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_profile#response_header_size LbProfile#response_header_size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_profile#response_timeout LbProfile#response_timeout}
  */
  readonly responseTimeout?: number;
  /**
  * Session timeout value (Only application category. Recommend: 300). (30 to 5400)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_profile#session_timeout LbProfile#session_timeout}
  */
  readonly sessionTimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_profile#tags LbProfile#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Forwarded for value (Only application category with L7 layer). (None, INSERT, REPLACE)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_profile#x_forwarded_for LbProfile#x_forwarded_for}
  */
  readonly xForwardedFor?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_profile samsungcloudplatform_lb_profile}
*/
export class LbProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LbProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_profile samsungcloudplatform_lb_profile} Resource
  *
  * @param scope The scope in which to define this construct
