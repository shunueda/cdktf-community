// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/firewall_rule
...
export interface FirewallRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/firewall_rule#action FirewallRule#action}
  */
  readonly action: string;
  /**
  * Rule description. (0 to 100 characters)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/firewall_rule#description FirewallRule#description}
  */
  readonly description?: string;
  /**
  * Destination ip addresses list
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/firewall_rule#destination_addresses_ipv4 FirewallRule#destination_addresses_ipv4}
  */
  readonly destinationAddressesIpv4: string[];
  /**
  * Rule direction. (IN, OUT, IN_OUT)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/firewall_rule#direction FirewallRule#direction}
  */
  readonly direction: string;
  /**
  * Rule enabled state.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/firewall_rule#enabled FirewallRule#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Firewall id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/firewall_rule#firewall_id FirewallRule#firewall_id}
  */
  readonly firewallId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/firewall_rule#id FirewallRule#id}
  *
  ...
  * Location Rule id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/firewall_rule#location_rule_id FirewallRule#location_rule_id}
  */
  readonly locationRuleId?: string;
  /**
  * Rule location type. (FIRST, BEFORE, AFTER, LAST)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/firewall_rule#rule_location_type FirewallRule#rule_location_type}
  */
  readonly ruleLocationType?: string;
  /**
  * Source ip addresses list
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/firewall_rule#source_addresses_ipv4 FirewallRule#source_addresses_ipv4}
  */
  readonly sourceAddressesIpv4: string[];
  /**
  * service block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/firewall_rule#service FirewallRule#service}
  */
...
export interface FirewallRuleService {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/firewall_rule#type FirewallRule#type}
  */
  readonly type: string;
  /**
  * Port value
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/firewall_rule#value FirewallRule#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/firewall_rule samsungcloudplatform_firewall_rule}
*/
export class FirewallRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FirewallRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/firewall_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/firewall_rule samsungcloudplatform_firewall_rule} Resource
  *
  * @param scope The scope in which to define this construct
