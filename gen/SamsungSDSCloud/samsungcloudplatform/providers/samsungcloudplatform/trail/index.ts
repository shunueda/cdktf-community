// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/trail
...
export interface TrailConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/trail#description Trail#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/trail#id Trail#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/trail#is_logging_target_all_region Trail#is_logging_target_all_region}
  */
  readonly isLoggingTargetAllRegion: boolean | cdktf.IResolvable;
  /**
  * Whether to log all resources
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/trail#is_logging_target_all_resource Trail#is_logging_target_all_resource}
  */
  readonly isLoggingTargetAllResource: boolean | cdktf.IResolvable;
  /**
  * Whether for all users
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/trail#is_logging_target_all_user Trail#is_logging_target_all_user}
  */
  readonly isLoggingTargetAllUser: boolean | cdktf.IResolvable;
  /**
  * Logging target regions list
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/trail#logging_target_regions Trail#logging_target_regions}
  */
  readonly loggingTargetRegions?: string[];
  /**
  * Logging target resource ID list
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/trail#logging_target_resource_ids Trail#logging_target_resource_ids}
  */
  readonly loggingTargetResourceIds?: string[];
  /**
  * Logging target user ID list
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/trail#logging_target_users Trail#logging_target_users}
  */
  readonly loggingTargetUsers?: string[];
  /**
  * Trail name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/trail#name Trail#name}
  */
  readonly name: string;
  /**
  * Object storage bucket ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/trail#obs_bucket_id Trail#obs_bucket_id}
  */
  readonly obsBucketId: string;
  /**
  * Trail save type. JSON or CSV
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/trail#save_type Trail#save_type}
  */
  readonly saveType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/trail#state Trail#state}
  */
  readonly state?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/trail#tags Trail#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Use trail verification
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/trail#use_verification Trail#use_verification}
  */
  readonly useVerification?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/trail samsungcloudplatform_trail}
*/
export class Trail extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Trail that should be imported. Refer to the {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/trail#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/trail samsungcloudplatform_trail} Resource
  *
  * @param scope The scope in which to define this construct
