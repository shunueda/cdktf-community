// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/data-sources/bm_server
...
export interface DataSamsungcloudplatformBmServerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/data-sources/bm_server#id DataSamsungcloudplatformBmServer#id}
  *
  ...
  * Server Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/data-sources/bm_server#server_id DataSamsungcloudplatformBmServer#server_id}
  */
  readonly serverId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/data-sources/bm_server samsungcloudplatform_bm_server}
*/
export class DataSamsungcloudplatformBmServer extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataSamsungcloudplatformBmServer resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataSamsungcloudplatformBmServer to import
  * @param importFromId The id of the existing DataSamsungcloudplatformBmServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/data-sources/bm_server#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataSamsungcloudplatformBmServer to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/data-sources/bm_server samsungcloudplatform_bm_server} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataSamsungcloudplatformBmServerConfig
  */
  public constructor(scope: Construct, id: string, config: DataSamsungcloudplatformBmServerConfig) {
    super(scope, id, {
  ...
  // bare_metal_local_subnet_id - computed: true, optional: false, required: false
  public get bareMetalLocalSubnetId() {
    return this.getStringAttribute('bare_metal_local_subnet_id');
  }

  // bare_metal_local_subnet_ip_address - computed: true, optional: false, required: false
  public get bareMetalLocalSubnetIpAddress() {
    return this.getStringAttribute('bare_metal_local_subnet_ip_address');
  }
  ...
  // public_nat_status - computed: true, optional: false, required: false
  public get publicNatStatus() {
    return this.getStringAttribute('public_nat_status');
  }
