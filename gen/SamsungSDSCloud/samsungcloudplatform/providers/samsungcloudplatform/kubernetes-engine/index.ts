// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine
...
export interface KubernetesEngineConfig extends cdktf.TerraformMetaArguments {
  ...
  * CIFS volume id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine#cifs_volume_id KubernetesEngine#cifs_volume_id}
  */
  readonly cifsVolumeId?: string;
  /**
  * Enable cloud logging
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine#cloud_logging_enabled KubernetesEngine#cloud_logging_enabled}
  */
  readonly cloudLoggingEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine#id KubernetesEngine#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine#kubernetes_version KubernetesEngine#kubernetes_version}
  */
  readonly kubernetesVersion: string;
  /**
  * Load balancer ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine#load_balancer_id KubernetesEngine#load_balancer_id}
  */
  readonly loadBalancerId?: string;
  /**
  * Kubernetes engine name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine#name KubernetesEngine#name}
  */
  readonly name: string;
  /**
  * List of comma separated IP addresses (CIDR or Single IP) for access control
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine#public_acl_ip_address KubernetesEngine#public_acl_ip_address}
  */
  readonly publicAclIpAddress?: string;
  /**
  * Security group ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine#security_group_id KubernetesEngine#security_group_id}
  */
  readonly securityGroupId: string;
  /**
  * Subnet ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine#subnet_id KubernetesEngine#subnet_id}
  */
  readonly subnetId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine#tags KubernetesEngine#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * File storage volume ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine#volume_id KubernetesEngine#volume_id}
  */
  readonly volumeId: string;
  /**
  * VPC ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine#vpc_id KubernetesEngine#vpc_id}
  */
  readonly vpcId: string;
  /**
  * private_acl_resources block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine#private_acl_resources KubernetesEngine#private_acl_resources}
  */
...
export interface KubernetesEnginePrivateAclResources {
  ...
  * Resource ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine#resource_id KubernetesEngine#resource_id}
  */
  readonly resourceId?: string;
  /**
  * Resource Type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine#resource_type KubernetesEngine#resource_type}
  */
  readonly resourceType?: string;
  /**
  * Resource Value
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine#resource_value KubernetesEngine#resource_value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine samsungcloudplatform_kubernetes_engine}
*/
export class KubernetesEngine extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesEngine that should be imported. Refer to the {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/kubernetes_engine samsungcloudplatform_kubernetes_engine} Resource
  *
  * @param scope The scope in which to define this construct
