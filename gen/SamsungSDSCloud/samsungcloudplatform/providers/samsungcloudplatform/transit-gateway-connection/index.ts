// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway_connection
...
export interface TransitGatewayConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  * Approver VPC ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway_connection#approver_vpc_id TransitGatewayConnection#approver_vpc_id}
  */
  readonly approverVpcId: string;
  /**
  * Activate Firewall or not
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway_connection#firewall_enable TransitGatewayConnection#firewall_enable}
  */
  readonly firewallEnable: boolean | cdktf.IResolvable;
  /**
  * Activate Firewall Logging or not
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway_connection#firewall_loggable TransitGatewayConnection#firewall_loggable}
  */
  readonly firewallLoggable?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway_connection#id TransitGatewayConnection#id}
  *
  ...
  * Requester TGW ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway_connection#requester_transit_gateway_id TransitGatewayConnection#requester_transit_gateway_id}
  */
  readonly requesterTransitGatewayId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway_connection#tags TransitGatewayConnection#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * TGW - VPC Connection description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway_connection#transit_gateway_connection_description TransitGatewayConnection#transit_gateway_connection_description}
  */
  readonly transitGatewayConnectionDescription?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway_connection samsungcloudplatform_transit_gateway_connection}
*/
export class TransitGatewayConnection extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/transit_gateway_connection samsungcloudplatform_transit_gateway_connection} Resource
  *
  * @param scope The scope in which to define this construct
