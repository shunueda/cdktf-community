// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage
...
export interface FileStorageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#cifs_password FileStorage#cifs_password}
  */
  readonly cifsPassword?: string;
  /**
  * Snapshot schedule dayOfWeek must be one of "SUN", "MON", "TUE", "WED", "THU", "FRI" or "SAT"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#day_of_week FileStorage#day_of_week}
  */
  readonly dayOfWeek?: string;
  /**
  * File Storage Disk Type (HDD, SSD, HP_SSD)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#disk_type FileStorage#disk_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#file_storage_name FileStorage#file_storage_name}
  */
  readonly fileStorageName: string;
  /**
  * File Storage Protocol (NFS, CIFS)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#file_storage_protocol FileStorage#file_storage_protocol}
  */
  readonly fileStorageProtocol: string;
  /**
  * File Unit Recovery
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#file_unit_recovery_enabled FileStorage#file_unit_recovery_enabled}
  */
  readonly fileUnitRecoveryEnabled?: boolean | cdktf.IResolvable;
  /**
  * Snapshot schedule frequency must be one of "DAILY" or "WEEKLY"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#frequency FileStorage#frequency}
  */
  readonly frequency?: string;
  /**
  * Snapshot schedule hour (0 to 23)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#hour FileStorage#hour}
  */
  readonly hour?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#id FileStorage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#multi_availability_zone FileStorage#multi_availability_zone}
  */
  readonly multiAvailabilityZone?: boolean | cdktf.IResolvable;
  /**
  * Product Names
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#product_names FileStorage#product_names}
  */
  readonly productNames: string[];
  /**
  * Service Zone ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#service_zone_id FileStorage#service_zone_id}
  */
  readonly serviceZoneId: string;
  /**
  * Snapshot retention count
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#snapshot_retention_count FileStorage#snapshot_retention_count}
  */
  readonly snapshotRetentionCount?: number;
  /**
  * Snapshot schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#snapshot_schedule FileStorage#snapshot_schedule}
  */
  readonly snapshotSchedule?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#tags FileStorage#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * VPC Endpoint Information
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#vpc_endpoint_info FileStorage#vpc_endpoint_info}
  */
  readonly vpcEndpointInfo?: string;
  /**
  * VPC Endpoint Volume Pool ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#vpc_endpoint_volume_pool_id FileStorage#vpc_endpoint_volume_pool_id}
  */
  readonly vpcEndpointVolumePoolId?: string;
  /**
  * link_objects block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#link_objects FileStorage#link_objects}
  */
  readonly linkObjects?: FileStorageLinkObjects[] | cdktf.IResolvable;
  /**
  * unlink_objects block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#unlink_objects FileStorage#unlink_objects}
  */
...
export interface FileStorageLinkObjects {
  ...
  * Link object ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#link_object_id FileStorage#link_object_id}
  */
  readonly linkObjectId?: string;
  /**
  * Type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#type FileStorage#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage samsungcloudplatform_file_storage}
*/
export class FileStorage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FileStorage that should be imported. Refer to the {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/file_storage samsungcloudplatform_file_storage} Resource
  *
  * @param scope The scope in which to define this construct
