// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group
...
export interface LbServerGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#algorithm LbServerGroup#algorithm}
  */
  readonly algorithm: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#id LbServerGroup#id}
  *
  ...
  * Load-Balancer id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#lb_id LbServerGroup#lb_id}
  */
  readonly lbId: string;
  /**
  * Monitor count
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#monitor_count LbServerGroup#monitor_count}
  */
  readonly monitorCount: number;
  /**
  * Monitor http method. (Only HTTP monitor_protocol. GET, POST)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#monitor_http_method LbServerGroup#monitor_http_method}
  */
  readonly monitorHttpMethod?: string;
  /**
  * Request body content. (Only POST monitor_http_method. 0 to 300 byte characters)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#monitor_http_request_body LbServerGroup#monitor_http_request_body}
  */
  readonly monitorHttpRequestBody?: string;
  /**
  * Response body content. (Only HTTP monitor_protocol. 0 to 300 byte characters)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#monitor_http_response_body LbServerGroup#monitor_http_response_body}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#monitor_http_url LbServerGroup#monitor_http_url}
  */
  readonly monitorHttpUrl?: string;
  /**
  * Monitor http version. (Only HTTP monitor_protocol. 1.0, 1.1)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#monitor_http_version LbServerGroup#monitor_http_version}
  */
  readonly monitorHttpVersion?: string;
  /**
  * Monitor interval time(s)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#monitor_interval_sec LbServerGroup#monitor_interval_sec}
  */
  readonly monitorIntervalSec: number;
  /**
  * Monitor port
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#monitor_port LbServerGroup#monitor_port}
  */
  readonly monitorPort: number;
  /**
  * Monitor protocol
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#monitor_protocol LbServerGroup#monitor_protocol}
  */
  readonly monitorProtocol: string;
  /**
  * Monitor timeout second
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#monitor_timeout_sec LbServerGroup#monitor_timeout_sec}
  */
  readonly monitorTimeoutSec: number;
  /**
  * Load-Balancer server group name. (3 to 20 characters with dash in middle)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#name LbServerGroup#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#tags LbServerGroup#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * server_group_member block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#server_group_member LbServerGroup#server_group_member}
  */
...
export interface LbServerGroupServerGroupMember {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#join_state LbServerGroup#join_state}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#object_id LbServerGroup#object_id}
  */
  readonly objectId?: string;
  /**
  * Target object ip
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#object_ip_address LbServerGroup#object_ip_address}
  */
  readonly objectIpAddress?: string;
  /**
  * Target object port for manual setting. (1 to 65535)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#object_port LbServerGroup#object_port}
  */
  readonly objectPort?: number;
  /**
  * Target object type. (INSTANCE, BAREMETAL, MANUAL)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#object_type LbServerGroup#object_type}
  */
  readonly objectType: string;
  /**
  * Balancing weight. This is used with when weighted algorithm is set. (1 to 256)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#weight LbServerGroup#weight}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group samsungcloudplatform_lb_server_group}
*/
export class LbServerGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LbServerGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.13.0/docs/resources/lb_server_group samsungcloudplatform_lb_server_group} Resource
  *
  * @param scope The scope in which to define this construct
