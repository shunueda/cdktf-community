// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_vpc
...
export interface ZecVpcConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_vpc#cidr_block ZecVpc#cidr_block}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_vpc#enable_ipv6 ZecVpc#enable_ipv6}
  */
  readonly enableIpv6?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_vpc#id ZecVpc#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_vpc#mtu ZecVpc#mtu}
  */
  readonly mtu?: number;
  /**
  * The name of the global VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_vpc#name ZecVpc#name}
  */
  readonly name?: string;
  /**
  * The resource group id the global VPC belongs to, default to ID of Default Resource Group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_vpc#resource_group_id ZecVpc#resource_group_id}
  */
  readonly resourceGroupId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_vpc zenlayercloud_zec_vpc}
*/
export class ZecVpc extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZecVpc that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_vpc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_vpc zenlayercloud_zec_vpc} Resource
  *
  * @param scope The scope in which to define this construct
