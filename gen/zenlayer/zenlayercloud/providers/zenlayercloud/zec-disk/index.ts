// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_disk
...
export interface ZecDiskConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_disk#availability_zone ZecDisk#availability_zone}
  */
  readonly availabilityZone: string;
  /**
  * The category of disk.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_disk#disk_category ZecDisk#disk_category}
  */
  readonly diskCategory?: string;
  /**
  * The name of the disk.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_disk#disk_name ZecDisk#disk_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_disk#disk_size ZecDisk#disk_size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_disk#force_delete ZecDisk#force_delete}
  */
  readonly forceDelete?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_disk#id ZecDisk#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_disk#resource_group_id ZecDisk#resource_group_id}
  */
  readonly resourceGroupId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_disk zenlayercloud_zec_disk}
*/
export class ZecDisk extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZecDisk that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_disk#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/resources/zec_disk zenlayercloud_zec_disk} Resource
  *
  * @param scope The scope in which to define this construct
