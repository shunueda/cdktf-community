// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/data-sources/zec_eips
...
export interface DataZenlayercloudZecEipsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/data-sources/zec_eips#associated_id DataZenlayercloudZecEips#associated_id}
  */
  readonly associatedId?: string;
  /**
  * The ID of cidr that the EIP allocated from to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/data-sources/zec_eips#cidr_ids DataZenlayercloudZecEips#cidr_ids}
  */
  readonly cidrIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/data-sources/zec_eips#id DataZenlayercloudZecEips#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/data-sources/zec_eips#ids DataZenlayercloudZecEips#ids}
  */
  readonly ids?: string[];
  /**
  * Indicates whether it is the default EIP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/data-sources/zec_eips#is_default DataZenlayercloudZecEips#is_default}
  */
  readonly isDefault?: string;
  /**
  * A regex string to apply to the elastic IP list returned.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/data-sources/zec_eips#name_regex DataZenlayercloudZecEips#name_regex}
  */
  readonly nameRegex?: string;
  /**
  * The private ipv4 address that the EIP attached to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/data-sources/zec_eips#private_ip_address DataZenlayercloudZecEips#private_ip_address}
  */
  readonly privateIpAddress?: string;
  /**
  * The elastic ipv4 address to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/data-sources/zec_eips#public_ip_address DataZenlayercloudZecEips#public_ip_address}
  */
  readonly publicIpAddress?: string;
  /**
  * The region ID that the elastic IP locates at.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/data-sources/zec_eips#region_id DataZenlayercloudZecEips#region_id}
  */
  readonly regionId?: string;
  /**
  * Resource group ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/data-sources/zec_eips#resource_group_id DataZenlayercloudZecEips#resource_group_id}
  */
  readonly resourceGroupId?: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/data-sources/zec_eips#result_output_file DataZenlayercloudZecEips#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Status of the elastic IP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/data-sources/zec_eips#status DataZenlayercloudZecEips#status}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/data-sources/zec_eips zenlayercloud_zec_eips}
*/
export class DataZenlayercloudZecEips extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZenlayercloudZecEips that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/data-sources/zec_eips#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.7/docs/data-sources/zec_eips zenlayercloud_zec_eips} Data Source
  *
  * @param scope The scope in which to define this construct
