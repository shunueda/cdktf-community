// https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/traffic_forwarding_static_ip
...
export interface TrafficForwardingStaticIpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/traffic_forwarding_static_ip#comment TrafficForwardingStaticIp#comment}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/traffic_forwarding_static_ip#geo_override TrafficForwardingStaticIp#geo_override}
  */
  readonly geoOverride?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/traffic_forwarding_static_ip#id TrafficForwardingStaticIp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/traffic_forwarding_static_ip#ip_address TrafficForwardingStaticIp#ip_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/traffic_forwarding_static_ip#latitude TrafficForwardingStaticIp#latitude}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/traffic_forwarding_static_ip#longitude TrafficForwardingStaticIp#longitude}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/traffic_forwarding_static_ip#routable_ip TrafficForwardingStaticIp#routable_ip}
  */
  readonly routableIp?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/traffic_forwarding_static_ip zia_traffic_forwarding_static_ip}
*/
export class TrafficForwardingStaticIp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TrafficForwardingStaticIp that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/traffic_forwarding_static_ip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/traffic_forwarding_static_ip zia_traffic_forwarding_static_ip} Resource
  *
  * @param scope The scope in which to define this construct
