// https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/bandwidth_control_rule
...
export interface BandwidthControlRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/bandwidth_control_rule#description BandwidthControlRule#description}
  */
  readonly description?: string;
  /**
  * The maximum percentage of a location's bandwidth you want to be guaranteed for each selected bandwidth control rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/bandwidth_control_rule#max_bandwidth BandwidthControlRule#max_bandwidth}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/bandwidth_control_rule#min_bandwidth BandwidthControlRule#min_bandwidth}
  */
  readonly minBandwidth?: number;
  /**
  * The bandwidth control rule name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/bandwidth_control_rule#name BandwidthControlRule#name}
  */
  readonly name?: string;
  /**
  * The order of the bandwidth control rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/bandwidth_control_rule#order BandwidthControlRule#order}
  */
  readonly order: number;
  /**
  * Supported Protocol criteria
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/bandwidth_control_rule#protocols BandwidthControlRule#protocols}
  */
  readonly protocols: string[];
  /**
  * Admin rank of the Bandwidth Control policy rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/bandwidth_control_rule#rank BandwidthControlRule#rank}
  */
  readonly rank?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/bandwidth_control_rule#state BandwidthControlRule#state}
  */
  readonly state?: string;
  /**
  * bandwidth_classes block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/bandwidth_control_rule#bandwidth_classes BandwidthControlRule#bandwidth_classes}
  */
  readonly bandwidthClasses?: BandwidthControlRuleBandwidthClasses;
  /**
  * labels block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/bandwidth_control_rule#labels BandwidthControlRule#labels}
  */
  readonly labels?: BandwidthControlRuleLabels;
  /**
  * location_groups block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/bandwidth_control_rule#location_groups BandwidthControlRule#location_groups}
  */
  readonly locationGroups?: BandwidthControlRuleLocationGroups;
  /**
  * locations block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/bandwidth_control_rule#locations BandwidthControlRule#locations}
  */
  readonly locations?: BandwidthControlRuleLocations;
  /**
  * time_windows block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/bandwidth_control_rule#time_windows BandwidthControlRule#time_windows}
  */
  readonly timeWindows?: BandwidthControlRuleTimeWindows;
}
export interface BandwidthControlRuleBandwidthClasses {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/bandwidth_control_rule#id BandwidthControlRule#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/bandwidth_control_rule zia_bandwidth_control_rule}
*/
export class BandwidthControlRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BandwidthControlRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/bandwidth_control_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zscaler/zia/4.5.2/docs/resources/bandwidth_control_rule zia_bandwidth_control_rule} Resource
  *
  * @param scope The scope in which to define this construct
