// https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/routing_bfd_configuration
...
export interface RoutingBfdConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/routing_bfd_configuration#___path___ RoutingBfdConfiguration#___path___}
  */
  readonly path?: string;
  /**
  * Name of the address list in which users IP address will be added.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/routing_bfd_configuration#address_list RoutingBfdConfiguration#address_list}
  */
  readonly addressList?: string;
  /**
  * Set of IP (v4 or v6) addresses or CIDR networks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/routing_bfd_configuration#addresses RoutingBfdConfiguration#addresses}
  */
  readonly addresses?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/routing_bfd_configuration#disabled RoutingBfdConfiguration#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/routing_bfd_configuration#forbid_bfd RoutingBfdConfiguration#forbid_bfd}
  */
  readonly forbidBfd?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/routing_bfd_configuration#id RoutingBfdConfiguration#id}
  *
  ...
  * List of interfaces.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/routing_bfd_configuration#interfaces RoutingBfdConfiguration#interfaces}
  */
  readonly interfaces?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/routing_bfd_configuration#min_rx RoutingBfdConfiguration#min_rx}
  */
  readonly minRx?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/routing_bfd_configuration#min_tx RoutingBfdConfiguration#min_tx}
  */
  readonly minTx?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/routing_bfd_configuration#multiplier RoutingBfdConfiguration#multiplier}
  */
  readonly multiplier?: number;
  /**
  * The VRF table this resource operates on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/routing_bfd_configuration#vrf RoutingBfdConfiguration#vrf}
  */
  readonly vrf?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/routing_bfd_configuration routeros_routing_bfd_configuration}
*/
export class RoutingBfdConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RoutingBfdConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/routing_bfd_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/routing_bfd_configuration routeros_routing_bfd_configuration} Resource
  *
  * @param scope The scope in which to define this construct
