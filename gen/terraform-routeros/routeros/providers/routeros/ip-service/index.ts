// https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_service
...
export interface IpServiceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_service#___path___ IpService#___path___}
  */
  readonly path?: string;
  /**
  * List of IP/IPv6 prefixes from which the service is accessible.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_service#address IpService#address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_service#certificate IpService#certificate}
  */
  readonly certificate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_service#disabled IpService#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_service#id IpService#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_service#max_sessions IpService#max_sessions}
  */
  readonly maxSessions?: number;
  /**
  * The name of the service whose settings will be changed ( api, api-ssl, ftp, ssh, telnet, winbox, www, www-ssl ).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_service#numbers IpService#numbers}
  */
  readonly numbers: string;
  /**
  * The port particular service listens on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_service#port IpService#port}
  */
  readonly port: number;
  /**
  * Specifies which TLS versions to allow by a particular service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_service#tls_version IpService#tls_version}
  */
  readonly tlsVersion?: string;
  /**
  * The VRF table this resource operates on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_service#vrf IpService#vrf}
  */
  readonly vrf?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_service routeros_ip_service}
*/
export class IpService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpService that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_service routeros_ip_service} Resource
  *
  * @param scope The scope in which to define this construct
