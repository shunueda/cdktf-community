// https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_security_multi_passphrase
...
export interface WifiSecurityMultiPassphraseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_security_multi_passphrase#___path___ WifiSecurityMultiPassphrase#___path___}
  */
  readonly path?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_security_multi_passphrase#comment WifiSecurityMultiPassphrase#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_security_multi_passphrase#disabled WifiSecurityMultiPassphrase#disabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_security_multi_passphrase#expires WifiSecurityMultiPassphrase#expires}
  */
  readonly expires?: string;
  /**
  * Assigning the group to a security profile or an access list, will enable use of all passphrases defined under it.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_security_multi_passphrase#group WifiSecurityMultiPassphrase#group}
  */
  readonly group: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_security_multi_passphrase#id WifiSecurityMultiPassphrase#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_security_multi_passphrase#isolation WifiSecurityMultiPassphrase#isolation}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_security_multi_passphrase#passphrase WifiSecurityMultiPassphrase#passphrase}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_security_multi_passphrase#vlan_id WifiSecurityMultiPassphrase#vlan_id}
  */
  readonly vlanId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_security_multi_passphrase routeros_wifi_security_multi_passphrase}
*/
export class WifiSecurityMultiPassphrase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WifiSecurityMultiPassphrase that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_security_multi_passphrase#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_security_multi_passphrase routeros_wifi_security_multi_passphrase} Resource
  *
  * @param scope The scope in which to define this construct
