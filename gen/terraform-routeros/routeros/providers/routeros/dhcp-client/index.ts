// https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client
...
export interface DhcpClientConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client#___path___ DhcpClient#___path___}
  */
  readonly path?: string;
  /**
  * Whether to install default route in routing table received from DHCP server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client#add_default_route DhcpClient#add_default_route}
  */
  readonly addDefaultRoute?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client#allow_reconfigure DhcpClient#allow_reconfigure}
  */
  readonly allowReconfigure?: boolean | cdktf.IResolvable;
  /**
  * Method on how to check gateway reachability.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client#check_gateway DhcpClient#check_gateway}
  */
  readonly checkGateway?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client#comment DhcpClient#comment}
  */
  readonly comment?: string;
  /**
  * Distance of default route. Applicable if add-default-route is set to yes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client#default_route_distance DhcpClient#default_route_distance}
  */
  readonly defaultRouteDistance?: number;
  /**
  * Default route tables.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client#default_route_tables DhcpClient#default_route_tables}
  */
  readonly defaultRouteTables?: string[];
  /**
  * Options that are sent to the DHCP server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client#dhcp_options DhcpClient#dhcp_options}
  */
  readonly dhcpOptions?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client#disabled DhcpClient#disabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client#dscp DhcpClient#dscp}
  */
  readonly dscp?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client#id DhcpClient#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client#interface DhcpClient#interface}
  */
  readonly interface: string;
  /**
  * A script.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client#script DhcpClient#script}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client#use_broadcast DhcpClient#use_broadcast}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client#use_peer_dns DhcpClient#use_peer_dns}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client#use_peer_ntp DhcpClient#use_peer_ntp}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client#use_reconfigure DhcpClient#use_reconfigure}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client#vlan_priority DhcpClient#vlan_priority}
  */
  readonly vlanPriority?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client routeros_dhcp_client}
*/
export class DhcpClient extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DhcpClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/dhcp_client routeros_dhcp_client} Resource
  *
  * @param scope The scope in which to define this construct
