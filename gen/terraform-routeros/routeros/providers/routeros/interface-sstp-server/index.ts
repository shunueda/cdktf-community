// https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_sstp_server
...
export interface InterfaceSstpServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_sstp_server#___path___ InterfaceSstpServer#___path___}
  */
  readonly path?: string;
  /**
  * Authentication algorithm.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_sstp_server#authentication InterfaceSstpServer#authentication}
  */
  readonly authentication?: string[];
  /**
  * Name of the certificate in use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_sstp_server#certificate InterfaceSstpServer#certificate}
  */
  readonly certificate?: string;
  /**
  * Allowed ciphers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_sstp_server#ciphers InterfaceSstpServer#ciphers}
  */
  readonly ciphers?: string;
  /**
  * Default profile to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_sstp_server#default_profile InterfaceSstpServer#default_profile}
  */
  readonly defaultProfile?: string;
  /**
  * Enables/disables service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_sstp_server#enabled InterfaceSstpServer#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_sstp_server#id InterfaceSstpServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_sstp_server#keepalive_timeout InterfaceSstpServer#keepalive_timeout}
  */
  readonly keepaliveTimeout?: string;
  /**
  * Maximum Receive Unit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_sstp_server#max_mru InterfaceSstpServer#max_mru}
  */
  readonly maxMru?: number;
  /**
  * Maximum Transmission Unit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_sstp_server#max_mtu InterfaceSstpServer#max_mtu}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_sstp_server#mrru InterfaceSstpServer#mrru}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_sstp_server#pfs InterfaceSstpServer#pfs}
  */
  readonly pfs?: boolean | cdktf.IResolvable;
  /**
  * Sets port used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_sstp_server#port InterfaceSstpServer#port}
  */
  readonly port?: string;
  /**
  * Specifies which TLS versions to allow.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_sstp_server#tls_version InterfaceSstpServer#tls_version}
  */
  readonly tlsVersion?: string;
  /**
  * SSTP server will verify client certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_sstp_server#verify_client_certificate InterfaceSstpServer#verify_client_certificate}
  */
  readonly verifyClientCertificate?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_sstp_server routeros_interface_sstp_server}
*/
export class InterfaceSstpServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterfaceSstpServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_sstp_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_sstp_server routeros_interface_sstp_server} Resource
  *
  * @param scope The scope in which to define this construct
