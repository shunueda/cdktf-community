// https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/snmp
...
export interface SnmpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/snmp#___path___ Snmp#___path___}
  */
  readonly path?: string;
  /**
  * Contact information.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/snmp#contact Snmp#contact}
  */
  readonly contact?: string;
  /**
  * Used to disable/enable SNMP service
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/snmp#enabled Snmp#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Unique identifier for an SNMPv3 engine by configuring the suffix of the engine ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/snmp#engine_id_suffix Snmp#engine_id_suffix}
  */
  readonly engineIdSuffix?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/snmp#id Snmp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/snmp#location Snmp#location}
  */
  readonly location?: string;
  /**
  * Force the router to always use the same IP source address for all of the SNMP messages.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/snmp#src_address Snmp#src_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/snmp#trap_community Snmp#trap_community}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/snmp#trap_generators Snmp#trap_generators}
  */
  readonly trapGenerators?: string;
  /**
  * List of interfaces that traps are going to be sent out.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/snmp#trap_interfaces Snmp#trap_interfaces}
  */
  readonly trapInterfaces?: string;
  /**
  * IP (IPv4 or IPv6) addresses of SNMP data collectors that have to receive the trap.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/snmp#trap_target Snmp#trap_target}
  */
  readonly trapTarget?: string[];
  /**
  * Version of SNMP protocol to use for trap.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/snmp#trap_version Snmp#trap_version}
  */
  readonly trapVersion?: number;
  /**
  * The VRF table this resource operates on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/snmp#vrf Snmp#vrf}
  */
  readonly vrf?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/snmp routeros_snmp}
*/
export class Snmp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Snmp that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/snmp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/snmp routeros_snmp} Resource
  *
  * @param scope The scope in which to define this construct
