// https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_ipsec_peer
...
export interface IpIpsecPeerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_ipsec_peer#___path___ IpIpsecPeer#___path___}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_ipsec_peer#address IpIpsecPeer#address}
  */
  readonly address?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_ipsec_peer#comment IpIpsecPeer#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_ipsec_peer#disabled IpIpsecPeer#disabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_ipsec_peer#exchange_mode IpIpsecPeer#exchange_mode}
  */
  readonly exchangeMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_ipsec_peer#id IpIpsecPeer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_ipsec_peer#local_address IpIpsecPeer#local_address}
  */
  readonly localAddress?: string;
  /**
  * Peer name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_ipsec_peer#name IpIpsecPeer#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_ipsec_peer#passive IpIpsecPeer#passive}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_ipsec_peer#port IpIpsecPeer#port}
  */
  readonly port?: number;
  /**
  * Name of the profile template that will be used during IKE negotiation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_ipsec_peer#profile IpIpsecPeer#profile}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_ipsec_peer#send_initial_contact IpIpsecPeer#send_initial_contact}
  */
  readonly sendInitialContact?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_ipsec_peer routeros_ip_ipsec_peer}
*/
export class IpIpsecPeer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpIpsecPeer that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_ipsec_peer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/ip_ipsec_peer routeros_ip_ipsec_peer} Resource
  *
  * @param scope The scope in which to define this construct
