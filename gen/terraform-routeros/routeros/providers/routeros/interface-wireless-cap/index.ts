// https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_cap
...
export interface InterfaceWirelessCapConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_cap#___path___ InterfaceWirelessCap#___path___}
  */
  readonly path?: string;
  /**
  * <em>A set of transformations for field names. This is an internal service field, setting a value is not required.</em>
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_cap#___skip___ InterfaceWirelessCap#___skip___}
  */
  readonly skip?: string;
  /**
  * Bridge interface to add the interface as a bridge port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_cap#bridge InterfaceWirelessCap#bridge}
  */
  readonly bridge?: string;
  /**
  * List of Manager IP addresses that CAP will attempt to contact during discovery.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_cap#caps_man_addresses InterfaceWirelessCap#caps_man_addresses}
  */
  readonly capsManAddresses?: string[];
  /**
  * List of manager certificate common names that CAP will connect to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_cap#caps_man_certificate_common_names InterfaceWirelessCap#caps_man_certificate_common_names}
  */
  readonly capsManCertificateCommonNames?: string[];
  /**
  * An ordered list of CAPs Manager names that the CAP will connect to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_cap#caps_man_names InterfaceWirelessCap#caps_man_names}
  */
  readonly capsManNames?: string[];
  /**
  * Certificate to use for authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_cap#certificate InterfaceWirelessCap#certificate}
  */
  readonly certificate?: string;
  /**
  * List of interfaces over which CAP should attempt to discover CAPs Manager.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_cap#discovery_interfaces InterfaceWirelessCap#discovery_interfaces}
  */
  readonly discoveryInterfaces?: string[];
  /**
  * Disable or enable the CAP functionality.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_cap#enabled InterfaceWirelessCap#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_cap#id InterfaceWirelessCap#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_cap#interfaces InterfaceWirelessCap#interfaces}
  */
  readonly interfaces?: string[];
  /**
  * Lock CAP to the first CAPsMAN it connects to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_cap#lock_to_caps_man InterfaceWirelessCap#lock_to_caps_man}
  */
  readonly lockToCapsMan?: boolean | cdktf.IResolvable;
  /**
  * An option that creates static virtual interfaces.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_cap#static_virtual InterfaceWirelessCap#static_virtual}
  */
  readonly staticVirtual?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_cap routeros_interface_wireless_cap}
*/
export class InterfaceWirelessCap extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterfaceWirelessCap that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_cap#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_cap routeros_interface_wireless_cap} Resource
  *
  * @param scope The scope in which to define this construct
