// https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/capsman_security
...
export interface CapsmanSecurityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/capsman_security#___path___ CapsmanSecurity#___path___}
  */
  readonly path?: string;
  /**
  * Specify the type of Authentication from wpa-psk, wpa2-psk, wpa-eap or wpa2-eap.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/capsman_security#authentication_types CapsmanSecurity#authentication_types}
  */
  readonly authenticationTypes?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/capsman_security#comment CapsmanSecurity#comment}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/capsman_security#disable_pmkid CapsmanSecurity#disable_pmkid}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/capsman_security#eap_methods CapsmanSecurity#eap_methods}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/capsman_security#eap_radius_accounting CapsmanSecurity#eap_radius_accounting}
  */
  readonly eapRadiusAccounting?: boolean | cdktf.IResolvable;
  /**
  * Set type of unicast encryption algorithm used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/capsman_security#encryption CapsmanSecurity#encryption}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/capsman_security#group_encryption CapsmanSecurity#group_encryption}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/capsman_security#group_key_update CapsmanSecurity#group_key_update}
  */
  readonly groupKeyUpdate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/capsman_security#id CapsmanSecurity#id}
  *
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/capsman_security#name CapsmanSecurity#name}
  */
  readonly name: string;
  /**
  * WPA or WPA2 pre-shared key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/capsman_security#passphrase CapsmanSecurity#passphrase}
  */
  readonly passphrase?: string;
  /**
  * Access Point always needs a certificate when security.tls-mode is set to value other than no-certificates.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/capsman_security#tls_certificate CapsmanSecurity#tls_certificate}
  */
  readonly tlsCertificate?: string;
  /**
  * This property has effect only when security.eap-methods contains eap-tls.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/capsman_security#tls_mode CapsmanSecurity#tls_mode}
  */
  readonly tlsMode?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/capsman_security routeros_capsman_security}
*/
export class CapsmanSecurity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CapsmanSecurity that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/capsman_security#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/capsman_security routeros_capsman_security} Resource
  *
  * @param scope The scope in which to define this construct
