// https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_channel
...
export interface WifiChannelConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_channel#___path___ WifiChannel#___path___}
  */
  readonly path?: string;
  /**
  * Frequency band and wireless standard that will be used by the AP. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_channel#band WifiChannel#band}
  */
  readonly band?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_channel#comment WifiChannel#comment}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_channel#deprioritize_unii_3_4 WifiChannel#deprioritize_unii_3_4}
  */
  readonly deprioritizeUnii34?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_channel#disabled WifiChannel#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Channel frequency value or range in MHz on which AP or station will operate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_channel#frequency WifiChannel#frequency}
  */
  readonly frequency?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_channel#id WifiChannel#id}
  *
  ...
  * Name of the channel.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_channel#name WifiChannel#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_channel#reselect_interval WifiChannel#reselect_interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_channel#reselect_time WifiChannel#reselect_time}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_channel#secondary_frequency WifiChannel#secondary_frequency}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_channel#skip_dfs_channels WifiChannel#skip_dfs_channels}
  */
  readonly skipDfsChannels?: string;
  /**
  * Channel width.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_channel#width WifiChannel#width}
  */
  readonly width?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_channel routeros_wifi_channel}
*/
export class WifiChannel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WifiChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_channel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/wifi_channel routeros_wifi_channel} Resource
  *
  * @param scope The scope in which to define this construct
