// https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/system_led
...
export interface SystemLedConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/system_led#___path___ SystemLed#___path___}
  */
  readonly path?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/system_led#disabled SystemLed#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/system_led#id SystemLed#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/system_led#interface SystemLed#interface}
  */
  readonly interface?: string;
  /**
  * An option to set the LED name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/system_led#leds SystemLed#leds}
  */
  readonly leds?: string[];
  /**
  * An option to set the signal strength threshold for the modem LED.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/system_led#modem_signal_treshold SystemLed#modem_signal_treshold}
  */
  readonly modemSignalTreshold?: number;
  /**
  * An option to set the LED type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/system_led#type SystemLed#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/system_led routeros_system_led}
*/
export class SystemLed extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemLed that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/system_led#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/system_led routeros_system_led} Resource
  *
  * @param scope The scope in which to define this construct
