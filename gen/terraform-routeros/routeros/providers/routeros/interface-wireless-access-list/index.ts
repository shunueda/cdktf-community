// https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list
...
export interface InterfaceWirelessAccessListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#___path___ InterfaceWirelessAccessList#___path___}
  */
  readonly path?: string;
  /**
  * Option which permits client's signal to be out of the range always or for some time interval.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#allow_signal_out_of_range InterfaceWirelessAccessList#allow_signal_out_of_range}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#ap_tx_limit InterfaceWirelessAccessList#ap_tx_limit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#authentication InterfaceWirelessAccessList#authentication}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#client_tx_limit InterfaceWirelessAccessList#client_tx_limit}
  */
  readonly clientTxLimit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#comment InterfaceWirelessAccessList#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#disabled InterfaceWirelessAccessList#disabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#forwarding InterfaceWirelessAccessList#forwarding}
  */
  readonly forwarding?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#id InterfaceWirelessAccessList#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#interface InterfaceWirelessAccessList#interface}
  */
  readonly interface?: string;
  /**
  * Rule matches client with the specified MAC address. Value 00:00:00:00:00:00 matches always.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#mac_address InterfaceWirelessAccessList#mac_address}
  */
  readonly macAddress?: string;
  /**
  * Management protection shared secret.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#management_protection_key InterfaceWirelessAccessList#management_protection_key}
  */
  readonly managementProtectionKey?: string;
  /**
  * Only for `WEP` modes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#private_algo InterfaceWirelessAccessList#private_algo}
  */
  readonly privateAlgo?: string;
  /**
  * Only for `WEP` modes (HEX).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#private_key InterfaceWirelessAccessList#private_key}
  */
  readonly privateKey?: string;
  /**
  * Used in `WPA PSK` mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#private_pre_shared_key InterfaceWirelessAccessList#private_pre_shared_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#signal_range InterfaceWirelessAccessList#signal_range}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#time InterfaceWirelessAccessList#time}
  */
  readonly time?: string;
  /**
  * VLAN ID to use if doing VLAN tagging.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#vlan_id InterfaceWirelessAccessList#vlan_id}
  */
  readonly vlanId?: number;
  /**
  * VLAN tagging mode specifies if traffic coming from client should get tagged (and untagged when going to client).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#vlan_mode InterfaceWirelessAccessList#vlan_mode}
  */
  readonly vlanMode?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list routeros_interface_wireless_access_list}
*/
export class InterfaceWirelessAccessList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterfaceWirelessAccessList that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.89.0/docs/resources/interface_wireless_access_list routeros_interface_wireless_access_list} Resource
  *
  * @param scope The scope in which to define this construct
