// https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/addon
...
export interface DataHerokuAddonConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/addon#name DataHerokuAddon#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/addon heroku_addon}
*/
export class DataHerokuAddon extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHerokuAddon that should be imported. Refer to the {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/addon#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/addon heroku_addon} Data Source
  *
  * @param scope The scope in which to define this construct
