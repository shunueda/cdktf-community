// https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/review_app_config
...
export interface ReviewAppConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/review_app_config#automatic_review_apps ReviewAppConfig#automatic_review_apps}
  */
  readonly automaticReviewApps?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/review_app_config#base_name ReviewAppConfig#base_name}
  */
  readonly baseName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/review_app_config#destroy_stale_apps ReviewAppConfig#destroy_stale_apps}
  */
  readonly destroyStaleApps?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/review_app_config#id ReviewAppConfig#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/review_app_config#org_repo ReviewAppConfig#org_repo}
  */
  readonly orgRepo: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/review_app_config#pipeline_id ReviewAppConfig#pipeline_id}
  */
  readonly pipelineId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/review_app_config#stale_days ReviewAppConfig#stale_days}
  */
  readonly staleDays?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/review_app_config#wait_for_ci ReviewAppConfig#wait_for_ci}
  */
  readonly waitForCi?: boolean | cdktf.IResolvable;
  /**
  * deploy_target block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/review_app_config#deploy_target ReviewAppConfig#deploy_target}
  */
...
export interface ReviewAppConfigDeployTarget {
  ...
  */
  readonly id: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/review_app_config#type ReviewAppConfig#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/review_app_config heroku_review_app_config}
*/
export class ReviewAppConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ReviewAppConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/review_app_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/review_app_config heroku_review_app_config} Resource
  *
  * @param scope The scope in which to define this construct
