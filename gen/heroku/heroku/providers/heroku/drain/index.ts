// https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/drain
...
export interface DrainConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/drain#app_id Drain#app_id}
  */
  readonly appId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/drain#id Drain#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/drain#sensitive_url Drain#sensitive_url}
  */
  readonly sensitiveUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/drain#url Drain#url}
  */
  readonly url?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/drain heroku_drain}
*/
export class Drain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Drain that should be imported. Refer to the {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/drain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/drain heroku_drain} Resource
  *
  * @param scope The scope in which to define this construct
