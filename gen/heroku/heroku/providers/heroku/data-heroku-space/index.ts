// https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/space
...
export interface DataHerokuSpaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/space#cidr DataHerokuSpace#cidr}
  */
  readonly cidr?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/space#data_cidr DataHerokuSpace#data_cidr}
  */
  readonly dataCidr?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/space#id DataHerokuSpace#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/space#name DataHerokuSpace#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/space heroku_space}
*/
export class DataHerokuSpace extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHerokuSpace that should be imported. Refer to the {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/space#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/space heroku_space} Data Source
  *
  * @param scope The scope in which to define this construct
