// https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/pipeline
...
export interface DataHerokuPipelineConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/pipeline#id DataHerokuPipeline#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/pipeline#name DataHerokuPipeline#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/pipeline heroku_pipeline}
*/
export class DataHerokuPipeline extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHerokuPipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/pipeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/pipeline heroku_pipeline} Data Source
  *
  * @param scope The scope in which to define this construct
