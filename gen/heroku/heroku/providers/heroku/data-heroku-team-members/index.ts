// https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/team_members
...
export interface DataHerokuTeamMembersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/team_members#id DataHerokuTeamMembers#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/team_members#roles DataHerokuTeamMembers#roles}
  */
  readonly roles: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/team_members#team DataHerokuTeamMembers#team}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/team_members heroku_team_members}
*/
export class DataHerokuTeamMembers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHerokuTeamMembers that should be imported. Refer to the {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/team_members#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/team_members heroku_team_members} Data Source
  *
  * @param scope The scope in which to define this construct
