// https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/space_peering_info
...
export interface DataHerokuSpacePeeringInfoConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/space_peering_info#id DataHerokuSpacePeeringInfo#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/space_peering_info#name DataHerokuSpacePeeringInfo#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/space_peering_info heroku_space_peering_info}
*/
export class DataHerokuSpacePeeringInfo extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHerokuSpacePeeringInfo that should be imported. Refer to the {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/space_peering_info#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/space_peering_info heroku_space_peering_info} Data Source
  *
  * @param scope The scope in which to define this construct
