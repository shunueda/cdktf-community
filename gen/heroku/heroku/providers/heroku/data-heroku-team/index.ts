// https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/team
...
export interface DataHerokuTeamConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/team#id DataHerokuTeam#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/team#name DataHerokuTeam#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/team heroku_team}
*/
export class DataHerokuTeam extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHerokuTeam that should be imported. Refer to the {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/team#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/data-sources/team heroku_team} Data Source
  *
  * @param scope The scope in which to define this construct
