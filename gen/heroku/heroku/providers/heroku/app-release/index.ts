// https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/app_release
...
export interface AppReleaseConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/app_release#app_id AppRelease#app_id}
  */
  readonly appId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/app_release#description AppRelease#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/app_release#id AppRelease#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/app_release#oci_image AppRelease#oci_image}
  */
  readonly ociImage?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/app_release#slug_id AppRelease#slug_id}
  */
  readonly slugId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/app_release heroku_app_release}
*/
export class AppRelease extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppRelease that should be imported. Refer to the {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/app_release#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/app_release heroku_app_release} Resource
  *
  * @param scope The scope in which to define this construct
