// https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/telemetry_drain
...
export interface TelemetryDrainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/telemetry_drain#endpoint TelemetryDrain#endpoint}
  */
  readonly endpoint: string;
  /**
  * Transport type for OpenTelemetry consumer (otlphttp or otlp)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/telemetry_drain#exporter_type TelemetryDrain#exporter_type}
  */
  readonly exporterType: string;
  /**
  * Headers to send to your OpenTelemetry consumer
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/telemetry_drain#headers TelemetryDrain#headers}
  */
  readonly headers: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/telemetry_drain#id TelemetryDrain#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/telemetry_drain#owner_id TelemetryDrain#owner_id}
  */
  readonly ownerId: string;
  /**
  * Type of owner (app or space)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/telemetry_drain#owner_type TelemetryDrain#owner_type}
  */
  readonly ownerType: string;
  /**
  * OpenTelemetry signals to send (traces, metrics, logs)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/telemetry_drain#signals TelemetryDrain#signals}
  */
  readonly signals: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/telemetry_drain heroku_telemetry_drain}
*/
export class TelemetryDrain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TelemetryDrain that should be imported. Refer to the {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/telemetry_drain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/telemetry_drain heroku_telemetry_drain} Resource
  *
  * @param scope The scope in which to define this construct
