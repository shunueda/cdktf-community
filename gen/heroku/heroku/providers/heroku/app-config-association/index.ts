// https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/app_config_association
...
export interface AppConfigAssociationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/app_config_association#app_id AppConfigAssociation#app_id}
  */
  readonly appId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/app_config_association#id AppConfigAssociation#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/app_config_association#sensitive_vars AppConfigAssociation#sensitive_vars}
  */
  readonly sensitiveVars?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/app_config_association#vars AppConfigAssociation#vars}
  */
  readonly vars?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/app_config_association heroku_app_config_association}
*/
export class AppConfigAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConfigAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/app_config_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/app_config_association heroku_app_config_association} Resource
  *
  * @param scope The scope in which to define this construct
