// https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs
...
export interface HerokuProviderConfig {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs#api_key HerokuProvider#api_key}
  */
  readonly apiKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs#email HerokuProvider#email}
  */
  readonly email?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs#headers HerokuProvider#headers}
  */
  readonly headers?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs#url HerokuProvider#url}
  */
  readonly url?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs#alias HerokuProvider#alias}
  */
  readonly alias?: string;
  /**
  * customizations block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs#customizations HerokuProvider#customizations}
  */
  readonly customizations?: HerokuProviderCustomizations[] | cdktf.IResolvable;
  /**
  * delays block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs#delays HerokuProvider#delays}
  */
  readonly delays?: HerokuProviderDelays;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs#timeouts HerokuProvider#timeouts}
  */
  readonly timeouts?: HerokuProviderTimeouts;
}
export interface HerokuProviderCustomizations {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs#set_addon_config_vars_in_state HerokuProvider#set_addon_config_vars_in_state}
  */
  readonly setAddonConfigVarsInState?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs#set_app_all_config_vars_in_state HerokuProvider#set_app_all_config_vars_in_state}
  */
...
export interface HerokuProviderDelays {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs#post_app_create_delay HerokuProvider#post_app_create_delay}
  */
  readonly postAppCreateDelay?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs#post_domain_create_delay HerokuProvider#post_domain_create_delay}
  */
  readonly postDomainCreateDelay?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs#post_space_create_delay HerokuProvider#post_space_create_delay}
  */
...
export interface HerokuProviderTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs#addon_create_timeout HerokuProvider#addon_create_timeout}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs heroku}
*/
export class HerokuProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing HerokuProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs heroku} Resource
  *
  * @param scope The scope in which to define this construct
