// https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/space_peering_connection_accepter
...
export interface SpacePeeringConnectionAccepterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/space_peering_connection_accepter#id SpacePeeringConnectionAccepter#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/space_peering_connection_accepter#space SpacePeeringConnectionAccepter#space}
  */
  readonly space: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/space_peering_connection_accepter#vpc_peering_connection_id SpacePeeringConnectionAccepter#vpc_peering_connection_id}
  */
  readonly vpcPeeringConnectionId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/space_peering_connection_accepter heroku_space_peering_connection_accepter}
*/
export class SpacePeeringConnectionAccepter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpacePeeringConnectionAccepter that should be imported. Refer to the {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/space_peering_connection_accepter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/heroku/heroku/5.3.1/docs/resources/space_peering_connection_accepter heroku_space_peering_connection_accepter} Resource
  *
  * @param scope The scope in which to define this construct
