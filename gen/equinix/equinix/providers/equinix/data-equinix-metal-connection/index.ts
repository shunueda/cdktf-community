// https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/metal_connection
...
export interface DataEquinixMetalConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/metal_connection#connection_id DataEquinixMetalConnection#connection_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/metal_connection equinix_metal_connection}
*/
export class DataEquinixMetalConnection extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEquinixMetalConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/metal_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/metal_connection equinix_metal_connection} Data Source
  *
  * @param scope The scope in which to define this construct
