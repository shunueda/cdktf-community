// https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/network_device_software
...
export interface DataEquinixNetworkDeviceSoftwareConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/network_device_software#device_type DataEquinixNetworkDeviceSoftware#device_type}
  */
  readonly deviceType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/network_device_software#id DataEquinixNetworkDeviceSoftware#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/network_device_software#most_recent DataEquinixNetworkDeviceSoftware#most_recent}
  */
  readonly mostRecent?: boolean | cdktf.IResolvable;
  /**
  * Limits returned versions to those that are supported by given software package codes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/network_device_software#packages DataEquinixNetworkDeviceSoftware#packages}
  */
  readonly packages?: string[];
  /**
  * Boolean value to limit query results to stable versions only
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/network_device_software#stable DataEquinixNetworkDeviceSoftware#stable}
  */
  readonly stable?: boolean | cdktf.IResolvable;
  /**
  * A regex string to apply on returned versions and filter search results
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/network_device_software#version_regex DataEquinixNetworkDeviceSoftware#version_regex}
  */
  readonly versionRegex?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/network_device_software equinix_network_device_software}
*/
export class DataEquinixNetworkDeviceSoftware extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEquinixNetworkDeviceSoftware that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/network_device_software#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/network_device_software equinix_network_device_software} Data Source
  *
  * @param scope The scope in which to define this construct
