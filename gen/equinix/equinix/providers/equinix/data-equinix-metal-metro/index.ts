// https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/metal_metro
...
export interface DataEquinixMetalMetroConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/metal_metro#code DataEquinixMetalMetro#code}
  */
  readonly code: string;
  /**
  * capacity block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/metal_metro#capacity DataEquinixMetalMetro#capacity}
  */
...
export interface DataEquinixMetalMetroCapacity {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/metal_metro#plan DataEquinixMetalMetro#plan}
  */
  readonly plan: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/metal_metro#quantity DataEquinixMetalMetro#quantity}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/metal_metro equinix_metal_metro}
*/
export class DataEquinixMetalMetro extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEquinixMetalMetro that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/metal_metro#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/metal_metro equinix_metal_metro} Data Source
  *
  * @param scope The scope in which to define this construct
