// https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/fabric_stream
...
export interface DataEquinixFabricStreamConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/fabric_stream#stream_id DataEquinixFabricStream#stream_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/fabric_stream equinix_fabric_stream}
*/
export class DataEquinixFabricStream extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEquinixFabricStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/fabric_stream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/fabric_stream equinix_fabric_stream} Data Source
  *
  * @param scope The scope in which to define this construct
