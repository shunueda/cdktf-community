// https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/fabric_metro
...
export interface DataEquinixFabricMetroConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/fabric_metro#metro_code DataEquinixFabricMetro#metro_code}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/fabric_metro equinix_fabric_metro}
*/
export class DataEquinixFabricMetro extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEquinixFabricMetro that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/fabric_metro#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.5.0/docs/data-sources/fabric_metro equinix_fabric_metro} Data Source
  *
  * @param scope The scope in which to define this construct
