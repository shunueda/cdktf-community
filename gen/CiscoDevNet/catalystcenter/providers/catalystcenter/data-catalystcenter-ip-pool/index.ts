// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/ip_pool
...
export interface DataCatalystcenterIpPoolConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/ip_pool#id DataCatalystcenterIpPool#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/ip_pool catalystcenter_ip_pool}
*/
export class DataCatalystcenterIpPool extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCatalystcenterIpPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/ip_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/ip_pool catalystcenter_ip_pool} Data Source
  *
  * @param scope The scope in which to define this construct
