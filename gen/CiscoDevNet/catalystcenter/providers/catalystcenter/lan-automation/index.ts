// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation
...
export interface LanAutomationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#discovered_device_site_name_hierarchy LanAutomation#discovered_device_site_name_hierarchy}
  */
  readonly discoveredDeviceSiteNameHierarchy: string;
  /**
  * List of specific devices that will be LAN Automated in this session
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#discovery_devices LanAutomation#discovery_devices}
  */
  ...
  *   - Default value: `2`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#discovery_level LanAutomation#discovery_level}
  */
  ...
  *   - Range: `20`-`10080`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#discovery_timeout LanAutomation#discovery_timeout}
  */
  readonly discoveryTimeout?: number;
  /**
  * File ID of the CSV file containing the host name list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#host_name_file_id LanAutomation#host_name_file_id}
  */
  readonly hostNameFileId?: string;
  /**
  * Host name prefix which shall be assigned to the discovered device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#host_name_prefix LanAutomation#host_name_prefix}
  */
  readonly hostNamePrefix?: string;
  /**
  * The list of IP pools with its name and role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#ip_pools LanAutomation#ip_pools}
  */
  readonly ipPools: LanAutomationIpPools[] | cdktf.IResolvable;
  /**
  * ISIS domain password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#isis_domain_password LanAutomation#isis_domain_password}
  */
  readonly isisDomainPassword?: string;
  /**
  * To enable underlay native multicast.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#multicast_enabled LanAutomation#multicast_enabled}
  */
  readonly multicastEnabled?: boolean | cdktf.IResolvable;
  /**
  * Secondary seed management IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#peer_device_management_ip_address LanAutomation#peer_device_management_ip_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#primary_device_interface_names LanAutomation#primary_device_interface_names}
  */
  readonly primaryDeviceInterfaceNames: string[];
  /**
  * Primary seed management IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#primary_device_management_ip_address LanAutomation#primary_device_management_ip_address}
  */
  readonly primaryDeviceManagementIpAddress: string;
  /**
  * Advertise LAN Automation summary route into BGP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#redistribute_isis_to_bgp LanAutomation#redistribute_isis_to_bgp}
  */
...
export interface LanAutomationDiscoveryDevices {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#device_host_name LanAutomation#device_host_name}
  */
  readonly deviceHostName?: string;
  /**
  * Management IP Address of the device
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#device_management_ip_address LanAutomation#device_management_ip_address}
  */
  readonly deviceManagementIpAddress?: string;
  /**
  * Serial number of the device
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#device_serial_number LanAutomation#device_serial_number}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#device_site_name_hierarchy LanAutomation#device_site_name_hierarchy}
  */
...
export interface LanAutomationIpPools {
  ...
  * Name of the IP pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#ip_pool_name LanAutomation#ip_pool_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#ip_pool_role LanAutomation#ip_pool_role}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation catalystcenter_lan_automation}
*/
export class LanAutomation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LanAutomation that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/lan_automation catalystcenter_lan_automation} Resource
  *
  * @param scope The scope in which to define this construct
