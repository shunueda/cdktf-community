// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/timezone_settings
...
export interface DataCatalystcenterTimezoneSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  * The site ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/timezone_settings#site_id DataCatalystcenterTimezoneSettings#site_id}
  */
  readonly siteId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/timezone_settings catalystcenter_timezone_settings}
*/
export class DataCatalystcenterTimezoneSettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCatalystcenterTimezoneSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/timezone_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/timezone_settings catalystcenter_timezone_settings} Data Source
  *
  * @param scope The scope in which to define this construct
