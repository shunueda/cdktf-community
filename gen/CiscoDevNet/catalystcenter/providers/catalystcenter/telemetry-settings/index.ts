// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/telemetry_settings
...
export interface TelemetrySettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/telemetry_settings#enable_netflow_collector_on_devices TelemetrySettings#enable_netflow_collector_on_devices}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/telemetry_settings#enable_wired_data_collection TelemetrySettings#enable_wired_data_collection}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/telemetry_settings#enable_wireless_telemetry TelemetrySettings#enable_wireless_telemetry}
  */
  readonly enableWirelessTelemetry: boolean | cdktf.IResolvable;
  /**
  * External syslog servers
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/telemetry_settings#external_syslog_servers TelemetrySettings#external_syslog_servers}
  */
  readonly externalSyslogServers?: string[];
  /**
  * External SNMP trap servers
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/telemetry_settings#external_trap_servers TelemetrySettings#external_trap_servers}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/telemetry_settings#netflow_collector TelemetrySettings#netflow_collector}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/telemetry_settings#netflow_collector_ip_address TelemetrySettings#netflow_collector_ip_address}
  */
  ...
  *   - Range: `1`-`65535`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/telemetry_settings#netflow_collector_port TelemetrySettings#netflow_collector_port}
  */
  readonly netflowCollectorPort?: number;
  /**
  * The site ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/telemetry_settings#site_id TelemetrySettings#site_id}
  */
  readonly siteId: string;
  /**
  * Enable this server as a destination server for syslog messages
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/telemetry_settings#use_builtin_syslog_server TelemetrySettings#use_builtin_syslog_server}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/telemetry_settings#use_builtin_trap_server TelemetrySettings#use_builtin_trap_server}
  */
  readonly useBuiltinTrapServer: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/telemetry_settings catalystcenter_telemetry_settings}
*/
export class TelemetrySettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TelemetrySettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/telemetry_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/telemetry_settings catalystcenter_telemetry_settings} Resource
  *
  * @param scope The scope in which to define this construct
