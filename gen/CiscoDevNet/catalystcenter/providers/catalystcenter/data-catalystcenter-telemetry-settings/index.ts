// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/telemetry_settings
...
export interface DataCatalystcenterTelemetrySettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  * The site ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/telemetry_settings#site_id DataCatalystcenterTelemetrySettings#site_id}
  */
  readonly siteId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/telemetry_settings catalystcenter_telemetry_settings}
*/
export class DataCatalystcenterTelemetrySettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCatalystcenterTelemetrySettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/telemetry_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/telemetry_settings catalystcenter_telemetry_settings} Data Source
  *
  * @param scope The scope in which to define this construct
