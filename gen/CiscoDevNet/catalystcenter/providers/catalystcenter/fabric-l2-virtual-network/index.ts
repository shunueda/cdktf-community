// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_l2_virtual_network
...
export interface FabricL2VirtualNetworkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_l2_virtual_network#associated_l3_virtual_network_name FabricL2VirtualNetwork#associated_l3_virtual_network_name}
  */
  readonly associatedL3VirtualNetworkName?: string;
  /**
  * Set to true to enable wireless. Default is false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_l2_virtual_network#fabric_enabled_wireless FabricL2VirtualNetwork#fabric_enabled_wireless}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_l2_virtual_network#fabric_id FabricL2VirtualNetwork#fabric_id}
  */
  ...
  *   - Choices: `DATA`, `VOICE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_l2_virtual_network#traffic_type FabricL2VirtualNetwork#traffic_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_l2_virtual_network#vlan_id FabricL2VirtualNetwork#vlan_id}
  */
  readonly vlanId?: number;
  /**
  * Name of the VLAN of the layer 2 virtual network. Must contain only alphanumeric characters, underscores, and hyphens
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_l2_virtual_network#vlan_name FabricL2VirtualNetwork#vlan_name}
  */
  readonly vlanName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_l2_virtual_network catalystcenter_fabric_l2_virtual_network}
*/
export class FabricL2VirtualNetwork extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FabricL2VirtualNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_l2_virtual_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_l2_virtual_network catalystcenter_fabric_l2_virtual_network} Resource
  *
  * @param scope The scope in which to define this construct
