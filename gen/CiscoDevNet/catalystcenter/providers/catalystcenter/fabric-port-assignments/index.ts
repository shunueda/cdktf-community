// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_port_assignments
...
export interface FabricPortAssignmentsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_port_assignments#fabric_id FabricPortAssignments#fabric_id}
  */
  readonly fabricId: string;
  /**
  * Network device ID of the port assignment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_port_assignments#network_device_id FabricPortAssignments#network_device_id}
  */
  readonly networkDeviceId: string;
  /**
  * List of port assignments in SD-Access fabric
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_port_assignments#port_assignments FabricPortAssignments#port_assignments}
  */
...
export interface FabricPortAssignmentsPortAssignments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_port_assignments#authenticate_template_name FabricPortAssignments#authenticate_template_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_port_assignments#connected_device_type FabricPortAssignments#connected_device_type}
  */
  readonly connectedDeviceType: string;
  /**
  * Data VLAN name of the port assignment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_port_assignments#data_vlan_name FabricPortAssignments#data_vlan_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_port_assignments#interface_description FabricPortAssignments#interface_description}
  */
  readonly interfaceDescription?: string;
  /**
  * Interface name of the port assignment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_port_assignments#interface_name FabricPortAssignments#interface_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_port_assignments#security_group_name FabricPortAssignments#security_group_name}
  */
  readonly securityGroupName?: string;
  /**
  * Voice VLAN name of the port assignment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_port_assignments#voice_vlan_name FabricPortAssignments#voice_vlan_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_port_assignments catalystcenter_fabric_port_assignments}
*/
export class FabricPortAssignments extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FabricPortAssignments that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_port_assignments#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/fabric_port_assignments catalystcenter_fabric_port_assignments} Resource
  *
  * @param scope The scope in which to define this construct
