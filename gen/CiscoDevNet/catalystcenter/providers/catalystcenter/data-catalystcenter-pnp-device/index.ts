// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/pnp_device
...
export interface DataCatalystcenterPnpDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/pnp_device#serial_number DataCatalystcenterPnpDevice#serial_number}
  */
  readonly serialNumber: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/pnp_device catalystcenter_pnp_device}
*/
export class DataCatalystcenterPnpDevice extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCatalystcenterPnpDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/pnp_device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/data-sources/pnp_device catalystcenter_pnp_device} Data Source
  *
  * @param scope The scope in which to define this construct
