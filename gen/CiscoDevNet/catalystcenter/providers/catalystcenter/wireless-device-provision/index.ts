// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/wireless_device_provision
...
export interface WirelessDeviceProvisionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/wireless_device_provision#ap_authorization_list_name WirelessDeviceProvision#ap_authorization_list_name}
  */
  readonly apAuthorizationListName?: string;
  /**
  * AP Reboot Percentage
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/wireless_device_provision#ap_reboot_percentage WirelessDeviceProvision#ap_reboot_percentage}
  */
  readonly apRebootPercentage?: number;
  /**
  * True if Mesh and Non-Mesh Access Points are authorized, else False
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/wireless_device_provision#authorize_mesh_and_non_mesh_access_points WirelessDeviceProvision#authorize_mesh_and_non_mesh_access_points}
  */
  readonly authorizeMeshAndNonMeshAccessPoints?: boolean | cdktf.IResolvable;
  /**
  * True if Rolling AP Upgrade is enabled, else False
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/wireless_device_provision#enable_rolling_ap_upgrade WirelessDeviceProvision#enable_rolling_ap_upgrade}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/wireless_device_provision#interfaces WirelessDeviceProvision#interfaces}
  */
  readonly interfaces?: WirelessDeviceProvisionInterfaces[] | cdktf.IResolvable;
  /**
  * Network Device ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/wireless_device_provision#network_device_id WirelessDeviceProvision#network_device_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/wireless_device_provision#reprovision WirelessDeviceProvision#reprovision}
  */
  readonly reprovision?: boolean | cdktf.IResolvable;
  /**
  * True if Skip AP Provision is enabled, else False
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/wireless_device_provision#skip_ap_provision WirelessDeviceProvision#skip_ap_provision}
  */
...
export interface WirelessDeviceProvisionInterfaces {
  ...
  * Interface Gateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/wireless_device_provision#interface_gateway WirelessDeviceProvision#interface_gateway}
  */
  readonly interfaceGateway?: string;
  /**
  * Interface IP Address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/wireless_device_provision#interface_ip_address WirelessDeviceProvision#interface_ip_address}
  */
  readonly interfaceIpAddress?: string;
  /**
  * Interface Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/wireless_device_provision#interface_name WirelessDeviceProvision#interface_name}
  */
  ...
  *   - Range: `1`-`30`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/wireless_device_provision#interface_netmask WirelessDeviceProvision#interface_netmask}
  */
  readonly interfaceNetmask?: number;
  /**
  * LAG or Port Number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/wireless_device_provision#lag_or_port_number WirelessDeviceProvision#lag_or_port_number}
  */
  ...
  *   - Range: `1`-`4094`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/wireless_device_provision#vlan_id WirelessDeviceProvision#vlan_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/wireless_device_provision catalystcenter_wireless_device_provision}
*/
export class WirelessDeviceProvision extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WirelessDeviceProvision that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/wireless_device_provision#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.0/docs/resources/wireless_device_provision catalystcenter_wireless_device_provision} Resource
  *
  * @param scope The scope in which to define this construct
