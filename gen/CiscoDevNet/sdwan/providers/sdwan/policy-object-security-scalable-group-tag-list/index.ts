// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_scalable_group_tag_list
...
export interface PolicyObjectSecurityScalableGroupTagListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_scalable_group_tag_list#description PolicyObjectSecurityScalableGroupTagList#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_scalable_group_tag_list#entries PolicyObjectSecurityScalableGroupTagList#entries}
  */
  readonly entries: PolicyObjectSecurityScalableGroupTagListEntries[] | cdktf.IResolvable;
  /**
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_scalable_group_tag_list#feature_profile_id PolicyObjectSecurityScalableGroupTagList#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The name of the Policy_object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_scalable_group_tag_list#name PolicyObjectSecurityScalableGroupTagList#name}
  */
  readonly name: string;
}
export interface PolicyObjectSecurityScalableGroupTagListEntries {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_scalable_group_tag_list#sgt_name PolicyObjectSecurityScalableGroupTagList#sgt_name}
  */
  readonly sgtName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_scalable_group_tag_list#tag PolicyObjectSecurityScalableGroupTagList#tag}
  */
  readonly tag?: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_scalable_group_tag_list sdwan_policy_object_security_scalable_group_tag_list}
*/
export class PolicyObjectSecurityScalableGroupTagList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyObjectSecurityScalableGroupTagList that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_scalable_group_tag_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_scalable_group_tag_list sdwan_policy_object_security_scalable_group_tag_list} Resource
  *
  * @param scope The scope in which to define this construct
