// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cli_template_feature_template
...
export interface CliTemplateFeatureTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  * Cli config
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cli_template_feature_template#cli_config CliTemplateFeatureTemplate#cli_config}
  */
  readonly cliConfig?: string;
  /**
  * The description of the feature template
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cli_template_feature_template#description CliTemplateFeatureTemplate#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cli_template_feature_template#device_types CliTemplateFeatureTemplate#device_types}
  */
  readonly deviceTypes: string[];
  /**
  * The name of the feature template
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cli_template_feature_template#name CliTemplateFeatureTemplate#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cli_template_feature_template sdwan_cli_template_feature_template}
*/
export class CliTemplateFeatureTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CliTemplateFeatureTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cli_template_feature_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cli_template_feature_template sdwan_cli_template_feature_template} Resource
  *
  * @param scope The scope in which to define this construct
