// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_gps_feature
...
export interface TransportGpsFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_gps_feature#description TransportGpsFeature#description}
  */
  readonly description?: string;
  /**
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_gps_feature#feature_profile_id TransportGpsFeature#feature_profile_id}
  */
  ...
  *   - Default value: `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_gps_feature#gps_enable TransportGpsFeature#gps_enable}
  */
  readonly gpsEnable?: boolean | cdktf.IResolvable;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_gps_feature#gps_enable_variable TransportGpsFeature#gps_enable_variable}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_gps_feature#gps_mode TransportGpsFeature#gps_mode}
  */
  readonly gpsMode?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_gps_feature#gps_mode_variable TransportGpsFeature#gps_mode_variable}
  */
  readonly gpsModeVariable?: string;
  /**
  * The name of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_gps_feature#name TransportGpsFeature#name}
  */
  readonly name: string;
  /**
  * Destination address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_gps_feature#nmea_destination_address TransportGpsFeature#nmea_destination_address}
  */
  readonly nmeaDestinationAddress?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_gps_feature#nmea_destination_address_variable TransportGpsFeature#nmea_destination_address_variable}
  */
  ...
  *   - Range: `1`-`65535`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_gps_feature#nmea_destination_port TransportGpsFeature#nmea_destination_port}
  */
  readonly nmeaDestinationPort?: number;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_gps_feature#nmea_destination_port_variable TransportGpsFeature#nmea_destination_port_variable}
  */
  ...
  *   - Default value: `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_gps_feature#nmea_enable TransportGpsFeature#nmea_enable}
  */
  readonly nmeaEnable?: boolean | cdktf.IResolvable;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_gps_feature#nmea_enable_variable TransportGpsFeature#nmea_enable_variable}
  */
  readonly nmeaEnableVariable?: string;
  /**
  * Source address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_gps_feature#nmea_source_address TransportGpsFeature#nmea_source_address}
  */
  readonly nmeaSourceAddress?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_gps_feature#nmea_source_address_variable TransportGpsFeature#nmea_source_address_variable}
  */
  readonly nmeaSourceAddressVariable?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_gps_feature sdwan_transport_gps_feature}
*/
export class TransportGpsFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransportGpsFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_gps_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_gps_feature sdwan_transport_gps_feature} Resource
  *
  * @param scope The scope in which to define this construct
