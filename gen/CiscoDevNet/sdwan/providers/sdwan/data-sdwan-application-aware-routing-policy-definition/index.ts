// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/application_aware_routing_policy_definition
...
export interface DataSdwanApplicationAwareRoutingPolicyDefinitionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/application_aware_routing_policy_definition#id DataSdwanApplicationAwareRoutingPolicyDefinition#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/application_aware_routing_policy_definition sdwan_application_aware_routing_policy_definition}
*/
export class DataSdwanApplicationAwareRoutingPolicyDefinition extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanApplicationAwareRoutingPolicyDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/application_aware_routing_policy_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/application_aware_routing_policy_definition sdwan_application_aware_routing_policy_definition} Data Source
  *
  * @param scope The scope in which to define this construct
