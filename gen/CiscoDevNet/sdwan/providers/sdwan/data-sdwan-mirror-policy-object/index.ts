// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/mirror_policy_object
...
export interface DataSdwanMirrorPolicyObjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/mirror_policy_object#id DataSdwanMirrorPolicyObject#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/mirror_policy_object sdwan_mirror_policy_object}
*/
export class DataSdwanMirrorPolicyObject extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanMirrorPolicyObject that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/mirror_policy_object#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/mirror_policy_object sdwan_mirror_policy_object} Data Source
  *
  * @param scope The scope in which to define this construct
