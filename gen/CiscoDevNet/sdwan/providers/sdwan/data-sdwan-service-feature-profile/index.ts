// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_feature_profile
...
export interface DataSdwanServiceFeatureProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_feature_profile#id DataSdwanServiceFeatureProfile#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_feature_profile sdwan_service_feature_profile}
*/
export class DataSdwanServiceFeatureProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanServiceFeatureProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_feature_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_feature_profile sdwan_service_feature_profile} Data Source
  *
  * @param scope The scope in which to define this construct
