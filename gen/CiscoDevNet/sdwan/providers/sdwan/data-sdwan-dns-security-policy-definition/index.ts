// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/dns_security_policy_definition
...
export interface DataSdwanDnsSecurityPolicyDefinitionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/dns_security_policy_definition#id DataSdwanDnsSecurityPolicyDefinition#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/dns_security_policy_definition sdwan_dns_security_policy_definition}
*/
export class DataSdwanDnsSecurityPolicyDefinition extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanDnsSecurityPolicyDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/dns_security_policy_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/dns_security_policy_definition sdwan_dns_security_policy_definition} Data Source
  *
  * @param scope The scope in which to define this construct
