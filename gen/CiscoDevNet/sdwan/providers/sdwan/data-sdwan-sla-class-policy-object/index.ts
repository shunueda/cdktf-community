// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/sla_class_policy_object
...
export interface DataSdwanSlaClassPolicyObjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/sla_class_policy_object#id DataSdwanSlaClassPolicyObject#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/sla_class_policy_object sdwan_sla_class_policy_object}
*/
export class DataSdwanSlaClassPolicyObject extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanSlaClassPolicyObject that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/sla_class_policy_object#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/sla_class_policy_object sdwan_sla_class_policy_object} Data Source
  *
  * @param scope The scope in which to define this construct
