// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/tls_ssl_profile_policy_definition
...
export interface TlsSslProfilePolicyDefinitionConfig extends cdktf.TerraformMetaArguments {
  ...
  * Allow URL list ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/tls_ssl_profile_policy_definition#allow_url_list_id TlsSslProfilePolicyDefinition#allow_url_list_id}
  */
  readonly allowUrlListId?: string;
  /**
  * Allow URL list version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/tls_ssl_profile_policy_definition#allow_url_list_version TlsSslProfilePolicyDefinition#allow_url_list_version}
  */
  readonly allowUrlListVersion?: number;
  /**
  * Block URL list ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/tls_ssl_profile_policy_definition#block_url_list_id TlsSslProfilePolicyDefinition#block_url_list_id}
  */
  readonly blockUrlListId?: string;
  /**
  * Block URL list version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/tls_ssl_profile_policy_definition#block_url_list_version TlsSslProfilePolicyDefinition#block_url_list_version}
  */
  readonly blockUrlListVersion?: number;
  /**
  * Categories that should be decrypted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/tls_ssl_profile_policy_definition#decrypt_categories TlsSslProfilePolicyDefinition#decrypt_categories}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/tls_ssl_profile_policy_definition#decrypt_threshold TlsSslProfilePolicyDefinition#decrypt_threshold}
  */
  readonly decryptThreshold?: string;
  /**
  * The description of the policy definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/tls_ssl_profile_policy_definition#description TlsSslProfilePolicyDefinition#description}
  */
  readonly description: string;
  /**
  * Fail decrypt enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/tls_ssl_profile_policy_definition#fail_decrypt TlsSslProfilePolicyDefinition#fail_decrypt}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/tls_ssl_profile_policy_definition#mode TlsSslProfilePolicyDefinition#mode}
  */
  readonly mode?: string;
  /**
  * The name of the policy definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/tls_ssl_profile_policy_definition#name TlsSslProfilePolicyDefinition#name}
  */
  readonly name: string;
  /**
  * Categories that should never be decrypted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/tls_ssl_profile_policy_definition#never_decrypt_categories TlsSslProfilePolicyDefinition#never_decrypt_categories}
  */
  readonly neverDecryptCategories?: string[];
  /**
  * Reputation enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/tls_ssl_profile_policy_definition#reputation TlsSslProfilePolicyDefinition#reputation}
  */
  readonly reputation?: boolean | cdktf.IResolvable;
  /**
  * Categories that should skipped
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/tls_ssl_profile_policy_definition#skip_decrypt_categories TlsSslProfilePolicyDefinition#skip_decrypt_categories}
  */
  readonly skipDecryptCategories?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/tls_ssl_profile_policy_definition sdwan_tls_ssl_profile_policy_definition}
*/
export class TlsSslProfilePolicyDefinition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TlsSslProfilePolicyDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/tls_ssl_profile_policy_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/tls_ssl_profile_policy_definition sdwan_tls_ssl_profile_policy_definition} Resource
  *
  * @param scope The scope in which to define this construct
