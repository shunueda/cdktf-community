// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_svi_feature_associate_dhcp_server_feature
...
export interface ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_svi_feature_associate_dhcp_server_feature#feature_profile_id ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * Service DHCP Server Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_svi_feature_associate_dhcp_server_feature#service_dhcp_server_feature_id ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeature#service_dhcp_server_feature_id}
  */
  readonly serviceDhcpServerFeatureId: string;
  /**
  * Service LAN VPN Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_svi_feature_associate_dhcp_server_feature#service_lan_vpn_feature_id ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeature#service_lan_vpn_feature_id}
  */
  readonly serviceLanVpnFeatureId: string;
  /**
  * Service LAN VPN Interface SVI Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_svi_feature_associate_dhcp_server_feature#service_lan_vpn_interface_svi_feature_id ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeature#service_lan_vpn_interface_svi_feature_id}
  */
  readonly serviceLanVpnInterfaceSviFeatureId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_svi_feature_associate_dhcp_server_feature sdwan_service_lan_vpn_interface_svi_feature_associate_dhcp_server_feature}
*/
export class ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceLanVpnInterfaceSviFeatureAssociateDhcpServerFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_svi_feature_associate_dhcp_server_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_svi_feature_associate_dhcp_server_feature sdwan_service_lan_vpn_interface_svi_feature_associate_dhcp_server_feature} Resource
  *
  * @param scope The scope in which to define this construct
