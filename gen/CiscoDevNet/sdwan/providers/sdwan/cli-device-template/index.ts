// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cli_device_template
...
export interface CliDeviceTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  * CLI configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cli_device_template#cli_configuration CliDeviceTemplate#cli_configuration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cli_device_template#cli_type CliDeviceTemplate#cli_type}
  */
  readonly cliType: string;
  /**
  * The description of the device template
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cli_device_template#description CliDeviceTemplate#description}
  */
  readonly description: string;
  /**
  * The device type (e.g., `vedge-ISR-4331`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cli_device_template#device_type CliDeviceTemplate#device_type}
  */
  readonly deviceType: string;
  /**
  * The name of the device template
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cli_device_template#name CliDeviceTemplate#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cli_device_template sdwan_cli_device_template}
*/
export class CliDeviceTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CliDeviceTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cli_device_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cli_device_template sdwan_cli_device_template} Resource
  *
  * @param scope The scope in which to define this construct
