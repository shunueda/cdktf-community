// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition
...
export interface UrlFilteringPolicyDefinitionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition#alerts UrlFilteringPolicyDefinition#alerts}
  */
  readonly alerts?: string[];
  /**
  * Allow URL list ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition#allow_url_list_id UrlFilteringPolicyDefinition#allow_url_list_id}
  */
  readonly allowUrlListId?: string;
  /**
  * Allow URL list version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition#allow_url_list_version UrlFilteringPolicyDefinition#allow_url_list_version}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition#block_page_action UrlFilteringPolicyDefinition#block_page_action}
  */
  readonly blockPageAction?: string;
  /**
  * The message displayed or URL redirected to when a blocked page is accessed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition#block_page_contents UrlFilteringPolicyDefinition#block_page_contents}
  */
  readonly blockPageContents?: string;
  /**
  * Block URL list ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition#block_url_list_id UrlFilteringPolicyDefinition#block_url_list_id}
  */
  readonly blockUrlListId?: string;
  /**
  * Block URL list version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition#block_url_list_version UrlFilteringPolicyDefinition#block_url_list_version}
  */
  readonly blockUrlListVersion?: number;
  /**
  * The description of the policy definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition#description UrlFilteringPolicyDefinition#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition#logging UrlFilteringPolicyDefinition#logging}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition#mode UrlFilteringPolicyDefinition#mode}
  */
  readonly mode?: string;
  /**
  * The name of the policy definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition#name UrlFilteringPolicyDefinition#name}
  */
  readonly name: string;
  /**
  * List of VPN IDs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition#target_vpns UrlFilteringPolicyDefinition#target_vpns}
  */
  readonly targetVpns?: string[];
  /**
  * List of categories to block or allow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition#web_categories UrlFilteringPolicyDefinition#web_categories}
  */
  ...
  *   - Choices: `block`, `allow`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition#web_categories_action UrlFilteringPolicyDefinition#web_categories_action}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition#web_reputation UrlFilteringPolicyDefinition#web_reputation}
  */
...
export interface UrlFilteringPolicyDefinitionLogging {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition#external_syslog_server_ip UrlFilteringPolicyDefinition#external_syslog_server_ip}
  */
  readonly externalSyslogServerIp?: string;
  /**
  * External Syslog Server VPN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition#external_syslog_server_vpn UrlFilteringPolicyDefinition#external_syslog_server_vpn}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition sdwan_url_filtering_policy_definition}
*/
export class UrlFilteringPolicyDefinition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UrlFilteringPolicyDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/url_filtering_policy_definition sdwan_url_filtering_policy_definition} Resource
  *
  * @param scope The scope in which to define this construct
