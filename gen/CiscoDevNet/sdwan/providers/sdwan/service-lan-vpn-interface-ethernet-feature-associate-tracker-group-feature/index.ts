// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_ethernet_feature_associate_tracker_group_feature
...
export interface ServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_ethernet_feature_associate_tracker_group_feature#feature_profile_id ServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * Service LAN VPN Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_ethernet_feature_associate_tracker_group_feature#service_lan_vpn_feature_id ServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeature#service_lan_vpn_feature_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_ethernet_feature_associate_tracker_group_feature sdwan_service_lan_vpn_interface_ethernet_feature_associate_tracker_group_feature}
*/
export class ServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_ethernet_feature_associate_tracker_group_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_ethernet_feature_associate_tracker_group_feature sdwan_service_lan_vpn_interface_ethernet_feature_associate_tracker_group_feature} Resource
  *
  * @param scope The scope in which to define this construct
