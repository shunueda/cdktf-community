// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_list_policy_object
...
export interface ApplicationListPolicyObjectConfig extends cdktf.TerraformMetaArguments {
  ...
  * List of entries
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_list_policy_object#entries ApplicationListPolicyObject#entries}
  */
  readonly entries: ApplicationListPolicyObjectEntries[] | cdktf.IResolvable;
  /**
  * The name of the policy object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_list_policy_object#name ApplicationListPolicyObject#name}
  */
...
export interface ApplicationListPolicyObjectEntries {
  ...
  * Application name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_list_policy_object#application ApplicationListPolicyObject#application}
  */
  readonly application?: string;
  /**
  * Application family name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_list_policy_object#application_family ApplicationListPolicyObject#application_family}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_list_policy_object sdwan_application_list_policy_object}
*/
export class ApplicationListPolicyObject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationListPolicyObject that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_list_policy_object#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_list_policy_object sdwan_application_list_policy_object} Resource
  *
  * @param scope The scope in which to define this construct
