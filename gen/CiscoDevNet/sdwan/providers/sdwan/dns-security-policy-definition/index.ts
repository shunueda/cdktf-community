// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/dns_security_policy_definition
...
export interface DnsSecurityPolicyDefinitionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/dns_security_policy_definition#cisco_sig_credentials_feature_template_id DnsSecurityPolicyDefinition#cisco_sig_credentials_feature_template_id}
  */
  readonly ciscoSigCredentialsFeatureTemplateId: string;
  /**
  * Credentials feature template version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/dns_security_policy_definition#cisco_sig_credentials_feature_template_version DnsSecurityPolicyDefinition#cisco_sig_credentials_feature_template_version}
  */
  readonly ciscoSigCredentialsFeatureTemplateVersion?: number;
  /**
  * Only relevant when `umbrella_dns_default` is `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/dns_security_policy_definition#custom_dns_server_ip DnsSecurityPolicyDefinition#custom_dns_server_ip}
  */
  readonly customDnsServerIp?: string;
  /**
  * The description of the policy definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/dns_security_policy_definition#description DnsSecurityPolicyDefinition#description}
  */
  readonly description: string;
  /**
  * Should DNSCrypt be enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/dns_security_policy_definition#dnscrypt DnsSecurityPolicyDefinition#dnscrypt}
  */
  readonly dnscrypt?: boolean | cdktf.IResolvable;
  /**
  * Local domain bypass list ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/dns_security_policy_definition#domain_list_id DnsSecurityPolicyDefinition#domain_list_id}
  */
  readonly domainListId?: string;
  /**
  * Local domain bypass list version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/dns_security_policy_definition#domain_list_version DnsSecurityPolicyDefinition#domain_list_version}
  */
  readonly domainListVersion?: number;
  /**
  * Should the local domain bypass list be enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/dns_security_policy_definition#local_domain_bypass_enabled DnsSecurityPolicyDefinition#local_domain_bypass_enabled}
  */
  readonly localDomainBypassEnabled?: boolean | cdktf.IResolvable;
  /**
  * Should use match all VPN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/dns_security_policy_definition#match_all_vpn DnsSecurityPolicyDefinition#match_all_vpn}
  */
  readonly matchAllVpn: boolean | cdktf.IResolvable;
  /**
  * The name of the policy definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/dns_security_policy_definition#name DnsSecurityPolicyDefinition#name}
  */
  readonly name: string;
  /**
  * Only relevant when `match_all_vpn` is `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/dns_security_policy_definition#target_vpns DnsSecurityPolicyDefinition#target_vpns}
  */
  readonly targetVpns?: DnsSecurityPolicyDefinitionTargetVpns[] | cdktf.IResolvable;
  /**
  * Should use umbrella as DNS Server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/dns_security_policy_definition#umbrella_dns_default DnsSecurityPolicyDefinition#umbrella_dns_default}
  */
...
export interface DnsSecurityPolicyDefinitionTargetVpns {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/dns_security_policy_definition#vpn_ids DnsSecurityPolicyDefinition#vpn_ids}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/dns_security_policy_definition sdwan_dns_security_policy_definition}
*/
export class DnsSecurityPolicyDefinition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsSecurityPolicyDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/dns_security_policy_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/dns_security_policy_definition sdwan_dns_security_policy_definition} Resource
  *
  * @param scope The scope in which to define this construct
