// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/cisco_sig_credentials_feature_template
...
export interface DataSdwanCiscoSigCredentialsFeatureTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/cisco_sig_credentials_feature_template#id DataSdwanCiscoSigCredentialsFeatureTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/cisco_sig_credentials_feature_template#name DataSdwanCiscoSigCredentialsFeatureTemplate#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/cisco_sig_credentials_feature_template sdwan_cisco_sig_credentials_feature_template}
*/
export class DataSdwanCiscoSigCredentialsFeatureTemplate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanCiscoSigCredentialsFeatureTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/cisco_sig_credentials_feature_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/cisco_sig_credentials_feature_template sdwan_cisco_sig_credentials_feature_template} Data Source
  *
  * @param scope The scope in which to define this construct
