// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/preferred_color_group_policy_object
...
export interface DataSdwanPreferredColorGroupPolicyObjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/preferred_color_group_policy_object#id DataSdwanPreferredColorGroupPolicyObject#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/preferred_color_group_policy_object sdwan_preferred_color_group_policy_object}
*/
export class DataSdwanPreferredColorGroupPolicyObject extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanPreferredColorGroupPolicyObject that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/preferred_color_group_policy_object#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/preferred_color_group_policy_object sdwan_preferred_color_group_policy_object} Data Source
  *
  * @param scope The scope in which to define this construct
