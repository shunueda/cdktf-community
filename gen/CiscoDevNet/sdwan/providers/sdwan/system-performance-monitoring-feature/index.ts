// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_performance_monitoring_feature
...
export interface SystemPerformanceMonitoringFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_performance_monitoring_feature#app_perf_monitor_app_group SystemPerformanceMonitoringFeature#app_perf_monitor_app_group}
  */
  ...
  *   - Default value: `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_performance_monitoring_feature#app_perf_monitor_enabled SystemPerformanceMonitoringFeature#app_perf_monitor_enabled}
  */
  readonly appPerfMonitorEnabled?: boolean | cdktf.IResolvable;
  /**
  * The description of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_performance_monitoring_feature#description SystemPerformanceMonitoringFeature#description}
  */
  ...
  *   - Default value: `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_performance_monitoring_feature#event_driven_config_enabled SystemPerformanceMonitoringFeature#event_driven_config_enabled}
  */
  readonly eventDrivenConfigEnabled?: boolean | cdktf.IResolvable;
  /**
  * UMTS events
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_performance_monitoring_feature#event_driven_events SystemPerformanceMonitoringFeature#event_driven_events}
  */
  readonly eventDrivenEvents?: string[];
  /**
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_performance_monitoring_feature#feature_profile_id SystemPerformanceMonitoringFeature#feature_profile_id}
  */
  ...
  *   - Default value: `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_performance_monitoring_feature#monitoring_config_enabled SystemPerformanceMonitoringFeature#monitoring_config_enabled}
  */
  ...
  *   - Choices: `30`, `60`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_performance_monitoring_feature#monitoring_config_interval SystemPerformanceMonitoringFeature#monitoring_config_interval}
  */
  readonly monitoringConfigInterval?: string;
  /**
  * The name of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_performance_monitoring_feature#name SystemPerformanceMonitoringFeature#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_performance_monitoring_feature sdwan_system_performance_monitoring_feature}
*/
export class SystemPerformanceMonitoringFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemPerformanceMonitoringFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_performance_monitoring_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_performance_monitoring_feature sdwan_system_performance_monitoring_feature} Resource
  *
  * @param scope The scope in which to define this construct
