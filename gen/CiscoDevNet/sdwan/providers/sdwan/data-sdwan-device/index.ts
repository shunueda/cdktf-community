// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/device
...
export interface DataSdwanDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/device#name DataSdwanDevice#name}
  */
  readonly name?: string;
  /**
  * Serial number for device. Could be board or virtual identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/device#serial_number DataSdwanDevice#serial_number}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/device sdwan_device}
*/
export class DataSdwanDevice extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/device sdwan_device} Data Source
  *
  * @param scope The scope in which to define this construct
