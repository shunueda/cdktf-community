// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_ospfv3_ipv6_feature
...
export interface TransportWanVpnFeatureAssociateRoutingOspfv3Ipv6FeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_ospfv3_ipv6_feature#feature_profile_id TransportWanVpnFeatureAssociateRoutingOspfv3Ipv6Feature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * Transport Routing OSPFv4 IPv6 Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_ospfv3_ipv6_feature#transport_routing_ospfv3_ipv6_feature_id TransportWanVpnFeatureAssociateRoutingOspfv3Ipv6Feature#transport_routing_ospfv3_ipv6_feature_id}
  */
  readonly transportRoutingOspfv3Ipv6FeatureId: string;
  /**
  * Transport WAN VPN Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_ospfv3_ipv6_feature#transport_wan_vpn_feature_id TransportWanVpnFeatureAssociateRoutingOspfv3Ipv6Feature#transport_wan_vpn_feature_id}
  */
  readonly transportWanVpnFeatureId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_ospfv3_ipv6_feature sdwan_transport_wan_vpn_feature_associate_routing_ospfv3_ipv6_feature}
*/
export class TransportWanVpnFeatureAssociateRoutingOspfv3Ipv6Feature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransportWanVpnFeatureAssociateRoutingOspfv3Ipv6Feature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_ospfv3_ipv6_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_ospfv3_ipv6_feature sdwan_transport_wan_vpn_feature_associate_routing_ospfv3_ipv6_feature} Resource
  *
  * @param scope The scope in which to define this construct
