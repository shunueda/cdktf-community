// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/zone_list_policy_object
...
export interface ZoneListPolicyObjectConfig extends cdktf.TerraformMetaArguments {
  ...
  * List of entries
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/zone_list_policy_object#entries ZoneListPolicyObject#entries}
  */
  readonly entries: ZoneListPolicyObjectEntries[] | cdktf.IResolvable;
  /**
  * The name of the policy object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/zone_list_policy_object#name ZoneListPolicyObject#name}
  */
...
export interface ZoneListPolicyObjectEntries {
  ...
  * Interface name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/zone_list_policy_object#interface ZoneListPolicyObject#interface}
  */
  readonly interface?: string;
  /**
  * VPN ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/zone_list_policy_object#vpn ZoneListPolicyObject#vpn}
  */
  readonly vpn?: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/zone_list_policy_object sdwan_zone_list_policy_object}
*/
export class ZoneListPolicyObject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZoneListPolicyObject that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/zone_list_policy_object#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/zone_list_policy_object sdwan_zone_list_policy_object} Resource
  *
  * @param scope The scope in which to define this construct
