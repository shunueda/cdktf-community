// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/mirror_policy_object
...
export interface MirrorPolicyObjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/mirror_policy_object#name MirrorPolicyObject#name}
  */
  readonly name: string;
  /**
  * Remote destination IP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/mirror_policy_object#remote_destination_ip MirrorPolicyObject#remote_destination_ip}
  */
  readonly remoteDestinationIp: string;
  /**
  * Source IP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/mirror_policy_object#source_ip MirrorPolicyObject#source_ip}
  */
  readonly sourceIp: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/mirror_policy_object sdwan_mirror_policy_object}
*/
export class MirrorPolicyObject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MirrorPolicyObject that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/mirror_policy_object#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/mirror_policy_object sdwan_mirror_policy_object} Resource
  *
  * @param scope The scope in which to define this construct
