// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_lan_vpn_interface_ipsec_feature
...
export interface DataSdwanServiceLanVpnInterfaceIpsecFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_lan_vpn_interface_ipsec_feature#feature_profile_id DataSdwanServiceLanVpnInterfaceIpsecFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The id of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_lan_vpn_interface_ipsec_feature#id DataSdwanServiceLanVpnInterfaceIpsecFeature#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_lan_vpn_interface_ipsec_feature#service_lan_vpn_feature_id DataSdwanServiceLanVpnInterfaceIpsecFeature#service_lan_vpn_feature_id}
  */
  readonly serviceLanVpnFeatureId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_lan_vpn_interface_ipsec_feature sdwan_service_lan_vpn_interface_ipsec_feature}
*/
export class DataSdwanServiceLanVpnInterfaceIpsecFeature extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanServiceLanVpnInterfaceIpsecFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_lan_vpn_interface_ipsec_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_lan_vpn_interface_ipsec_feature sdwan_service_lan_vpn_interface_ipsec_feature} Data Source
  *
  * @param scope The scope in which to define this construct
