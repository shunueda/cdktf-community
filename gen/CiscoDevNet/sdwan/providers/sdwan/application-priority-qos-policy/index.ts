// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_priority_qos_policy
...
export interface ApplicationPriorityQosPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_priority_qos_policy#description ApplicationPriorityQosPolicy#description}
  */
  readonly description?: string;
  /**
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_priority_qos_policy#feature_profile_id ApplicationPriorityQosPolicy#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The name of the Policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_priority_qos_policy#name ApplicationPriorityQosPolicy#name}
  */
  readonly name: string;
  /**
  * qosSchedulers
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_priority_qos_policy#qos_schedulers ApplicationPriorityQosPolicy#qos_schedulers}
  */
  readonly qosSchedulers?: ApplicationPriorityQosPolicyQosSchedulers[] | cdktf.IResolvable;
  /**
  * interfaces
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_priority_qos_policy#target_interfaces ApplicationPriorityQosPolicy#target_interfaces}
  */
  readonly targetInterfaces?: string[];
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_priority_qos_policy#target_interfaces_variable ApplicationPriorityQosPolicy#target_interfaces_variable}
  */
...
export interface ApplicationPriorityQosPolicyQosSchedulers {
  ...
  * bandwidthPercent
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_priority_qos_policy#bandwidth ApplicationPriorityQosPolicy#bandwidth}
  */
  readonly bandwidth?: string;
  /**
  * drops
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_priority_qos_policy#drops ApplicationPriorityQosPolicy#drops}
  */
  readonly drops?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_priority_qos_policy#forwarding_class_id ApplicationPriorityQosPolicy#forwarding_class_id}
  */
  readonly forwardingClassId?: string;
  /**
  * queue
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_priority_qos_policy#queue ApplicationPriorityQosPolicy#queue}
  */
  readonly queue?: string;
  /**
  * scheduling
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_priority_qos_policy#scheduling_type ApplicationPriorityQosPolicy#scheduling_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_priority_qos_policy sdwan_application_priority_qos_policy}
*/
export class ApplicationPriorityQosPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationPriorityQosPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_priority_qos_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/application_priority_qos_policy sdwan_application_priority_qos_policy} Resource
  *
  * @param scope The scope in which to define this construct
