// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_local_application_list
...
export interface PolicyObjectSecurityLocalApplicationListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_local_application_list#description PolicyObjectSecurityLocalApplicationList#description}
  */
  readonly description?: string;
  /**
  * Localapp list
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_local_application_list#entries PolicyObjectSecurityLocalApplicationList#entries}
  */
  readonly entries?: PolicyObjectSecurityLocalApplicationListEntries[] | cdktf.IResolvable;
  /**
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_local_application_list#feature_profile_id PolicyObjectSecurityLocalApplicationList#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The name of the Policy_object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_local_application_list#name PolicyObjectSecurityLocalApplicationList#name}
  */
  readonly name: string;
}
export interface PolicyObjectSecurityLocalApplicationListEntries {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_local_application_list#app PolicyObjectSecurityLocalApplicationList#app}
  */
  readonly app?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_local_application_list#app_family PolicyObjectSecurityLocalApplicationList#app_family}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_local_application_list sdwan_policy_object_security_local_application_list}
*/
export class PolicyObjectSecurityLocalApplicationList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyObjectSecurityLocalApplicationList that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_local_application_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_local_application_list sdwan_policy_object_security_local_application_list} Resource
  *
  * @param scope The scope in which to define this construct
