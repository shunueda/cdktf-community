// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_application_list
...
export interface PolicyObjectApplicationListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_application_list#description PolicyObjectApplicationList#description}
  */
  readonly description?: string;
  /**
  * Centralized Policy App List
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_application_list#entries PolicyObjectApplicationList#entries}
  */
  readonly entries: PolicyObjectApplicationListEntries[] | cdktf.IResolvable;
  /**
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_application_list#feature_profile_id PolicyObjectApplicationList#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The name of the Policy_object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_application_list#name PolicyObjectApplicationList#name}
  */
  readonly name: string;
}
export interface PolicyObjectApplicationListEntries {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_application_list#application PolicyObjectApplicationList#application}
  */
  readonly application?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_application_list#application_family PolicyObjectApplicationList#application_family}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_application_list sdwan_policy_object_application_list}
*/
export class PolicyObjectApplicationList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyObjectApplicationList that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_application_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_application_list sdwan_policy_object_application_list} Resource
  *
  * @param scope The scope in which to define this construct
