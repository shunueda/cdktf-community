// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/transport_wan_vpn_interface_ipsec_feature
...
export interface DataSdwanTransportWanVpnInterfaceIpsecFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/transport_wan_vpn_interface_ipsec_feature#feature_profile_id DataSdwanTransportWanVpnInterfaceIpsecFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The id of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/transport_wan_vpn_interface_ipsec_feature#id DataSdwanTransportWanVpnInterfaceIpsecFeature#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/transport_wan_vpn_interface_ipsec_feature#transport_wan_vpn_feature_id DataSdwanTransportWanVpnInterfaceIpsecFeature#transport_wan_vpn_feature_id}
  */
  readonly transportWanVpnFeatureId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/transport_wan_vpn_interface_ipsec_feature sdwan_transport_wan_vpn_interface_ipsec_feature}
*/
export class DataSdwanTransportWanVpnInterfaceIpsecFeature extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanTransportWanVpnInterfaceIpsecFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/transport_wan_vpn_interface_ipsec_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/transport_wan_vpn_interface_ipsec_feature sdwan_transport_wan_vpn_interface_ipsec_feature} Data Source
  *
  * @param scope The scope in which to define this construct
