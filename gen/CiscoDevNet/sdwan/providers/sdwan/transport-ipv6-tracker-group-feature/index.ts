// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_ipv6_tracker_group_feature
...
export interface TransportIpv6TrackerGroupFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_ipv6_tracker_group_feature#description TransportIpv6TrackerGroupFeature#description}
  */
  readonly description?: string;
  /**
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_ipv6_tracker_group_feature#feature_profile_id TransportIpv6TrackerGroupFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The name of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_ipv6_tracker_group_feature#name TransportIpv6TrackerGroupFeature#name}
  */
  ...
  *   - Default value: `or`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_ipv6_tracker_group_feature#tracker_boolean TransportIpv6TrackerGroupFeature#tracker_boolean}
  */
  readonly trackerBoolean?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_ipv6_tracker_group_feature#tracker_boolean_variable TransportIpv6TrackerGroupFeature#tracker_boolean_variable}
  */
  readonly trackerBooleanVariable?: string;
  /**
  * trackers ref list
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_ipv6_tracker_group_feature#tracker_elements TransportIpv6TrackerGroupFeature#tracker_elements}
  */
  readonly trackerElements?: TransportIpv6TrackerGroupFeatureTrackerElements[] | cdktf.IResolvable;
  /**
  * Tracker Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_ipv6_tracker_group_feature#tracker_name TransportIpv6TrackerGroupFeature#tracker_name}
  */
  readonly trackerName: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_ipv6_tracker_group_feature#tracker_name_variable TransportIpv6TrackerGroupFeature#tracker_name_variable}
  */
  readonly trackerNameVariable?: string;
}
export interface TransportIpv6TrackerGroupFeatureTrackerElements {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_ipv6_tracker_group_feature#tracker_id TransportIpv6TrackerGroupFeature#tracker_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_ipv6_tracker_group_feature sdwan_transport_ipv6_tracker_group_feature}
*/
export class TransportIpv6TrackerGroupFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransportIpv6TrackerGroupFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_ipv6_tracker_group_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_ipv6_tracker_group_feature sdwan_transport_ipv6_tracker_group_feature} Resource
  *
  * @param scope The scope in which to define this construct
