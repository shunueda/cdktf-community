// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/qos_map_policy_definition
...
export interface QosMapPolicyDefinitionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/qos_map_policy_definition#description QosMapPolicyDefinition#description}
  */
  readonly description: string;
  /**
  * The name of the policy definition
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/qos_map_policy_definition#name QosMapPolicyDefinition#name}
  */
  readonly name: string;
  /**
  * List of QoS schedulers
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/qos_map_policy_definition#qos_schedulers QosMapPolicyDefinition#qos_schedulers}
  */
...
export interface QosMapPolicyDefinitionQosSchedulers {
  ...
  *   - Range: `0`-`100`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/qos_map_policy_definition#bandwidth_percent QosMapPolicyDefinition#bandwidth_percent}
  */
  ...
  *   - Range: `0`-`100`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/qos_map_policy_definition#buffer_percent QosMapPolicyDefinition#buffer_percent}
  */
  ...
  *   - Range: `5000`-`10000000`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/qos_map_policy_definition#burst QosMapPolicyDefinition#burst}
  */
  readonly burst?: number;
  /**
  * Class map ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/qos_map_policy_definition#class_map_id QosMapPolicyDefinition#class_map_id}
  */
  readonly classMapId: string;
  /**
  * Class map version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/qos_map_policy_definition#class_map_version QosMapPolicyDefinition#class_map_version}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/qos_map_policy_definition#drop_type QosMapPolicyDefinition#drop_type}
  */
  ...
  *   - Range: `0`-`7`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/qos_map_policy_definition#queue QosMapPolicyDefinition#queue}
  */
  ...
  *   - Choices: `llq`, `wrr`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/qos_map_policy_definition#scheduling_type QosMapPolicyDefinition#scheduling_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/qos_map_policy_definition sdwan_qos_map_policy_definition}
*/
export class QosMapPolicyDefinition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QosMapPolicyDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/qos_map_policy_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/qos_map_policy_definition sdwan_qos_map_policy_definition} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _qosSchedulers = new QosMapPolicyDefinitionQosSchedulersList(this, "qos_schedulers", false);
