// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_routing_ospfv3_ipv4_feature
...
export interface DataSdwanServiceRoutingOspfv3Ipv4FeatureConfig extends cdktf.TerraformMetaArguments {
  /**
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_routing_ospfv3_ipv4_feature#feature_profile_id DataSdwanServiceRoutingOspfv3Ipv4Feature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The id of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_routing_ospfv3_ipv4_feature#id DataSdwanServiceRoutingOspfv3Ipv4Feature#id}
  *
...
export interface DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasInterfaces {
}

export function dataSdwanServiceRoutingOspfv3Ipv4FeatureAreasInterfacesToTerraform(struct?: DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasInterfaces): any {
...
export function dataSdwanServiceRoutingOspfv3Ipv4FeatureAreasInterfacesToHclTerraform(struct?: DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasInterfaces): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasInterfacesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasInterfaces | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasInterfaces | undefined) {
    if (value === undefined) {
...
export class DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasInterfacesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasInterfacesOutputReference {
    return new DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasInterfacesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasRanges {
}

export function dataSdwanServiceRoutingOspfv3Ipv4FeatureAreasRangesToTerraform(struct?: DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasRanges): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataSdwanServiceRoutingOspfv3Ipv4FeatureAreasRangesToHclTerraform(struct?: DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasRanges): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasRangesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasRanges | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasRanges | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasRangesList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasRangesOutputReference {
    return new DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasRangesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataSdwanServiceRoutingOspfv3Ipv4FeatureAreas {
}

export function dataSdwanServiceRoutingOspfv3Ipv4FeatureAreasToTerraform(struct?: DataSdwanServiceRoutingOspfv3Ipv4FeatureAreas): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataSdwanServiceRoutingOspfv3Ipv4FeatureAreasToHclTerraform(struct?: DataSdwanServiceRoutingOspfv3Ipv4FeatureAreas): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataSdwanServiceRoutingOspfv3Ipv4FeatureAreas | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSdwanServiceRoutingOspfv3Ipv4FeatureAreas | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _interfaces = new DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasInterfacesList(this, "interfaces", false);
  ...
  private _ranges = new DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasRangesList(this, "ranges", false);
  public get ranges() {
    return this._ranges;
  }
}

export class DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasOutputReference {
    return new DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataSdwanServiceRoutingOspfv3Ipv4FeatureRedistributes {
}

export function dataSdwanServiceRoutingOspfv3Ipv4FeatureRedistributesToTerraform(struct?: DataSdwanServiceRoutingOspfv3Ipv4FeatureRedistributes): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataSdwanServiceRoutingOspfv3Ipv4FeatureRedistributesToHclTerraform(struct?: DataSdwanServiceRoutingOspfv3Ipv4FeatureRedistributes): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSdwanServiceRoutingOspfv3Ipv4FeatureRedistributesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataSdwanServiceRoutingOspfv3Ipv4FeatureRedistributes | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSdwanServiceRoutingOspfv3Ipv4FeatureRedistributes | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataSdwanServiceRoutingOspfv3Ipv4FeatureRedistributesList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataSdwanServiceRoutingOspfv3Ipv4FeatureRedistributesOutputReference {
    return new DataSdwanServiceRoutingOspfv3Ipv4FeatureRedistributesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_routing_ospfv3_ipv4_feature sdwan_service_routing_ospfv3_ipv4_feature}
*/
export class DataSdwanServiceRoutingOspfv3Ipv4Feature extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataSdwanServiceRoutingOspfv3Ipv4Feature resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataSdwanServiceRoutingOspfv3Ipv4Feature to import
  * @param importFromId The id of the existing DataSdwanServiceRoutingOspfv3Ipv4Feature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_routing_ospfv3_ipv4_feature#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataSdwanServiceRoutingOspfv3Ipv4Feature to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_routing_ospfv3_ipv4_feature sdwan_service_routing_ospfv3_ipv4_feature} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataSdwanServiceRoutingOspfv3Ipv4FeatureConfig
  */
  public constructor(scope: Construct, id: string, config: DataSdwanServiceRoutingOspfv3Ipv4FeatureConfig) {
    super(scope, id, {
  ...
  private _areas = new DataSdwanServiceRoutingOspfv3Ipv4FeatureAreasList(this, "areas", false);
  public get areas() {
    return this._areas;
  }
  ...
  private _redistributes = new DataSdwanServiceRoutingOspfv3Ipv4FeatureRedistributesList(this, "redistributes", false);
