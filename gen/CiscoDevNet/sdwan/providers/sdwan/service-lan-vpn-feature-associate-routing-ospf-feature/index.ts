// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_feature_associate_routing_ospf_feature
...
export interface ServiceLanVpnFeatureAssociateRoutingOspfFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_feature_associate_routing_ospf_feature#feature_profile_id ServiceLanVpnFeatureAssociateRoutingOspfFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * Service LAN VPN Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_feature_associate_routing_ospf_feature#service_lan_vpn_feature_id ServiceLanVpnFeatureAssociateRoutingOspfFeature#service_lan_vpn_feature_id}
  */
  readonly serviceLanVpnFeatureId: string;
  /**
  * Service Routing OSPF Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_feature_associate_routing_ospf_feature#service_routing_ospf_feature_id ServiceLanVpnFeatureAssociateRoutingOspfFeature#service_routing_ospf_feature_id}
  */
  readonly serviceRoutingOspfFeatureId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_feature_associate_routing_ospf_feature sdwan_service_lan_vpn_feature_associate_routing_ospf_feature}
*/
export class ServiceLanVpnFeatureAssociateRoutingOspfFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceLanVpnFeatureAssociateRoutingOspfFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_feature_associate_routing_ospf_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_feature_associate_routing_ospf_feature sdwan_service_lan_vpn_feature_associate_routing_ospf_feature} Resource
  *
  * @param scope The scope in which to define this construct
