// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_ospf_feature
...
export interface TransportWanVpnFeatureAssociateRoutingOspfFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_ospf_feature#feature_profile_id TransportWanVpnFeatureAssociateRoutingOspfFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * Transport Routing OSPF Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_ospf_feature#transport_routing_ospf_feature_id TransportWanVpnFeatureAssociateRoutingOspfFeature#transport_routing_ospf_feature_id}
  */
  readonly transportRoutingOspfFeatureId: string;
  /**
  * Transport WAN VPN Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_ospf_feature#transport_wan_vpn_feature_id TransportWanVpnFeatureAssociateRoutingOspfFeature#transport_wan_vpn_feature_id}
  */
  readonly transportWanVpnFeatureId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_ospf_feature sdwan_transport_wan_vpn_feature_associate_routing_ospf_feature}
*/
export class TransportWanVpnFeatureAssociateRoutingOspfFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransportWanVpnFeatureAssociateRoutingOspfFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_ospf_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_ospf_feature sdwan_transport_wan_vpn_feature_associate_routing_ospf_feature} Resource
  *
  * @param scope The scope in which to define this construct
