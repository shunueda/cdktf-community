// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/attach_feature_device_template
...
export interface AttachFeatureDeviceTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  * Devices
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/attach_feature_device_template#devices AttachFeatureDeviceTemplate#devices}
  */
  readonly devices: AttachFeatureDeviceTemplateDevices[] | cdktf.IResolvable;
  /**
  * The ID of the device template
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/attach_feature_device_template#id AttachFeatureDeviceTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/attach_feature_device_template#version AttachFeatureDeviceTemplate#version}
  */
...
export interface AttachFeatureDeviceTemplateDevices {
  ...
  * Device variables
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/attach_feature_device_template#variables AttachFeatureDeviceTemplate#variables}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/attach_feature_device_template sdwan_attach_feature_device_template}
*/
export class AttachFeatureDeviceTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AttachFeatureDeviceTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/attach_feature_device_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/attach_feature_device_template sdwan_attach_feature_device_template} Resource
  *
  * @param scope The scope in which to define this construct
