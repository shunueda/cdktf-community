// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/preferred_color_group_policy_object
...
export interface PreferredColorGroupPolicyObjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/preferred_color_group_policy_object#name PreferredColorGroupPolicyObject#name}
  */
  readonly name: string;
  /**
  * Color or space separated list of colors
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/preferred_color_group_policy_object#primary_color_preference PreferredColorGroupPolicyObject#primary_color_preference}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/preferred_color_group_policy_object#primary_path_preference PreferredColorGroupPolicyObject#primary_path_preference}
  */
  readonly primaryPathPreference?: string;
  /**
  * Color or space separated list of colors
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/preferred_color_group_policy_object#secondary_color_preference PreferredColorGroupPolicyObject#secondary_color_preference}
  */
  ...
  *   - Choices: `direct-path`, `multi-hop-path`, `all-paths`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/preferred_color_group_policy_object#secondary_path_preference PreferredColorGroupPolicyObject#secondary_path_preference}
  */
  readonly secondaryPathPreference?: string;
  /**
  * Color or space separated list of colors
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/preferred_color_group_policy_object#tertiary_color_preference PreferredColorGroupPolicyObject#tertiary_color_preference}
  */
  ...
  *   - Choices: `direct-path`, `multi-hop-path`, `all-paths`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/preferred_color_group_policy_object#tertiary_path_preference PreferredColorGroupPolicyObject#tertiary_path_preference}
  */
  readonly tertiaryPathPreference?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/preferred_color_group_policy_object sdwan_preferred_color_group_policy_object}
*/
export class PreferredColorGroupPolicyObject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PreferredColorGroupPolicyObject that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/preferred_color_group_policy_object#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/preferred_color_group_policy_object sdwan_preferred_color_group_policy_object} Resource
  *
  * @param scope The scope in which to define this construct
