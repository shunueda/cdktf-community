// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_ips_signature
...
export interface PolicyObjectSecurityIpsSignatureConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_ips_signature#description PolicyObjectSecurityIpsSignature#description}
  */
  readonly description?: string;
  /**
  * Ips Signature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_ips_signature#entries PolicyObjectSecurityIpsSignature#entries}
  */
  readonly entries: PolicyObjectSecurityIpsSignatureEntries[] | cdktf.IResolvable;
  /**
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_ips_signature#feature_profile_id PolicyObjectSecurityIpsSignature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The name of the Policy_object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_ips_signature#name PolicyObjectSecurityIpsSignature#name}
  */
  readonly name: string;
}
export interface PolicyObjectSecurityIpsSignatureEntries {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_ips_signature#generator_id PolicyObjectSecurityIpsSignature#generator_id}
  */
  readonly generatorId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_ips_signature#signature_id PolicyObjectSecurityIpsSignature#signature_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_ips_signature sdwan_policy_object_security_ips_signature}
*/
export class PolicyObjectSecurityIpsSignature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyObjectSecurityIpsSignature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_ips_signature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_security_ips_signature sdwan_policy_object_security_ips_signature} Resource
  *
  * @param scope The scope in which to define this construct
