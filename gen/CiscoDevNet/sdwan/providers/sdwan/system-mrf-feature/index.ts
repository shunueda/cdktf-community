// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_mrf_feature
...
export interface SystemMrfFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_mrf_feature#description SystemMrfFeature#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_mrf_feature#enable_migration_to_mrf SystemMrfFeature#enable_migration_to_mrf}
  */
  readonly enableMigrationToMrf?: string;
  /**
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_mrf_feature#feature_profile_id SystemMrfFeature#feature_profile_id}
  */
  ...
  *   - Range: `1`-`4294967295`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_mrf_feature#migration_bgp_community SystemMrfFeature#migration_bgp_community}
  */
  readonly migrationBgpCommunity?: number;
  /**
  * The name of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_mrf_feature#name SystemMrfFeature#name}
  */
  ...
  *   - Range: `1`-`63`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_mrf_feature#region_id SystemMrfFeature#region_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_mrf_feature#role SystemMrfFeature#role}
  */
  readonly role?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_mrf_feature#role_variable SystemMrfFeature#role_variable}
  */
  ...
  *   - Range: `1`-`63`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_mrf_feature#secondary_region_id SystemMrfFeature#secondary_region_id}
  */
  readonly secondaryRegionId?: number;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_mrf_feature#secondary_region_id_variable SystemMrfFeature#secondary_region_id_variable}
  */
  readonly secondaryRegionIdVariable?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_mrf_feature sdwan_system_mrf_feature}
*/
export class SystemMrfFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemMrfFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_mrf_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_mrf_feature sdwan_system_mrf_feature} Resource
  *
  * @param scope The scope in which to define this construct
