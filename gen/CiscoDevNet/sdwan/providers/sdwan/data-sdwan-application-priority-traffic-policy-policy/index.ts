// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/application_priority_traffic_policy_policy
...
export interface DataSdwanApplicationPriorityTrafficPolicyPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/application_priority_traffic_policy_policy#feature_profile_id DataSdwanApplicationPriorityTrafficPolicyPolicy#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The id of the Policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/application_priority_traffic_policy_policy#id DataSdwanApplicationPriorityTrafficPolicyPolicy#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/application_priority_traffic_policy_policy sdwan_application_priority_traffic_policy_policy}
*/
export class DataSdwanApplicationPriorityTrafficPolicyPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanApplicationPriorityTrafficPolicyPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/application_priority_traffic_policy_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/application_priority_traffic_policy_policy sdwan_application_priority_traffic_policy_policy} Data Source
  *
  * @param scope The scope in which to define this construct
