// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_expanded_community_list
...
export interface PolicyObjectExpandedCommunityListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_expanded_community_list#description PolicyObjectExpandedCommunityList#description}
  */
  readonly description?: string;
  /**
  * Expanded Community List
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_expanded_community_list#expanded_community_lists PolicyObjectExpandedCommunityList#expanded_community_lists}
  */
  readonly expandedCommunityLists: string[];
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_expanded_community_list#expanded_community_lists_variable PolicyObjectExpandedCommunityList#expanded_community_lists_variable}
  */
  readonly expandedCommunityListsVariable?: string;
  /**
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_expanded_community_list#feature_profile_id PolicyObjectExpandedCommunityList#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The name of the Policy_object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_expanded_community_list#name PolicyObjectExpandedCommunityList#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_expanded_community_list sdwan_policy_object_expanded_community_list}
*/
export class PolicyObjectExpandedCommunityList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyObjectExpandedCommunityList that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_expanded_community_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policy_object_expanded_community_list sdwan_policy_object_expanded_community_list} Resource
  *
  * @param scope The scope in which to define this construct
