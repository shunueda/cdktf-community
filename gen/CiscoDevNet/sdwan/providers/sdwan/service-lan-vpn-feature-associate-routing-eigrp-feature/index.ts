// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_feature_associate_routing_eigrp_feature
...
export interface ServiceLanVpnFeatureAssociateRoutingEigrpFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_feature_associate_routing_eigrp_feature#feature_profile_id ServiceLanVpnFeatureAssociateRoutingEigrpFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * Service LAN VPN Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_feature_associate_routing_eigrp_feature#service_lan_vpn_feature_id ServiceLanVpnFeatureAssociateRoutingEigrpFeature#service_lan_vpn_feature_id}
  */
  readonly serviceLanVpnFeatureId: string;
  /**
  * Service Routing EIGRP Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_feature_associate_routing_eigrp_feature#service_routing_eigrp_feature_id ServiceLanVpnFeatureAssociateRoutingEigrpFeature#service_routing_eigrp_feature_id}
  */
  readonly serviceRoutingEigrpFeatureId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_feature_associate_routing_eigrp_feature sdwan_service_lan_vpn_feature_associate_routing_eigrp_feature}
*/
export class ServiceLanVpnFeatureAssociateRoutingEigrpFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceLanVpnFeatureAssociateRoutingEigrpFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_feature_associate_routing_eigrp_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_feature_associate_routing_eigrp_feature sdwan_service_lan_vpn_feature_associate_routing_eigrp_feature} Resource
  *
  * @param scope The scope in which to define this construct
