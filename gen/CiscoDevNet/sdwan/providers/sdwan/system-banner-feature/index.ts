// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_banner_feature
...
export interface SystemBannerFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_banner_feature#description SystemBannerFeature#description}
  */
  readonly description?: string;
  /**
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_banner_feature#feature_profile_id SystemBannerFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_banner_feature#login SystemBannerFeature#login}
  */
  readonly login?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_banner_feature#login_variable SystemBannerFeature#login_variable}
  */
  readonly loginVariable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_banner_feature#motd SystemBannerFeature#motd}
  */
  readonly motd?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_banner_feature#motd_variable SystemBannerFeature#motd_variable}
  */
  readonly motdVariable?: string;
  /**
  * The name of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_banner_feature#name SystemBannerFeature#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_banner_feature sdwan_system_banner_feature}
*/
export class SystemBannerFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemBannerFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_banner_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_banner_feature sdwan_system_banner_feature} Resource
  *
  * @param scope The scope in which to define this construct
