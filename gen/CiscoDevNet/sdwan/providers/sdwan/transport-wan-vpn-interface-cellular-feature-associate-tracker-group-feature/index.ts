// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_cellular_feature_associate_tracker_group_feature
...
export interface TransportWanVpnInterfaceCellularFeatureAssociateTrackerGroupFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_cellular_feature_associate_tracker_group_feature#feature_profile_id TransportWanVpnInterfaceCellularFeatureAssociateTrackerGroupFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * Transport Tracker Group Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_cellular_feature_associate_tracker_group_feature#transport_tracker_group_feature_id TransportWanVpnInterfaceCellularFeatureAssociateTrackerGroupFeature#transport_tracker_group_feature_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_cellular_feature_associate_tracker_group_feature sdwan_transport_wan_vpn_interface_cellular_feature_associate_tracker_group_feature}
*/
export class TransportWanVpnInterfaceCellularFeatureAssociateTrackerGroupFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransportWanVpnInterfaceCellularFeatureAssociateTrackerGroupFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_cellular_feature_associate_tracker_group_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_cellular_feature_associate_tracker_group_feature sdwan_transport_wan_vpn_interface_cellular_feature_associate_tracker_group_feature} Resource
  *
  * @param scope The scope in which to define this construct
