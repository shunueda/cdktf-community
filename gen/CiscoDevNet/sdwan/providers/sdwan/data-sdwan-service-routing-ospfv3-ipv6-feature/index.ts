// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_routing_ospfv3_ipv6_feature
...
export interface DataSdwanServiceRoutingOspfv3Ipv6FeatureConfig extends cdktf.TerraformMetaArguments {
  /**
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_routing_ospfv3_ipv6_feature#feature_profile_id DataSdwanServiceRoutingOspfv3Ipv6Feature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The id of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_routing_ospfv3_ipv6_feature#id DataSdwanServiceRoutingOspfv3Ipv6Feature#id}
  *
...
export interface DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasInterfaces {
}

export function dataSdwanServiceRoutingOspfv3Ipv6FeatureAreasInterfacesToTerraform(struct?: DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasInterfaces): any {
...
export function dataSdwanServiceRoutingOspfv3Ipv6FeatureAreasInterfacesToHclTerraform(struct?: DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasInterfaces): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasInterfacesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasInterfaces | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasInterfaces | undefined) {
    if (value === undefined) {
...
export class DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasInterfacesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasInterfacesOutputReference {
    return new DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasInterfacesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasRanges {
}

export function dataSdwanServiceRoutingOspfv3Ipv6FeatureAreasRangesToTerraform(struct?: DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasRanges): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataSdwanServiceRoutingOspfv3Ipv6FeatureAreasRangesToHclTerraform(struct?: DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasRanges): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasRangesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasRanges | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasRanges | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasRangesList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasRangesOutputReference {
    return new DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasRangesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataSdwanServiceRoutingOspfv3Ipv6FeatureAreas {
}

export function dataSdwanServiceRoutingOspfv3Ipv6FeatureAreasToTerraform(struct?: DataSdwanServiceRoutingOspfv3Ipv6FeatureAreas): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataSdwanServiceRoutingOspfv3Ipv6FeatureAreasToHclTerraform(struct?: DataSdwanServiceRoutingOspfv3Ipv6FeatureAreas): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataSdwanServiceRoutingOspfv3Ipv6FeatureAreas | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSdwanServiceRoutingOspfv3Ipv6FeatureAreas | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _interfaces = new DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasInterfacesList(this, "interfaces", false);
  ...
  private _ranges = new DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasRangesList(this, "ranges", false);
  public get ranges() {
    return this._ranges;
  }
}

export class DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasOutputReference {
    return new DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataSdwanServiceRoutingOspfv3Ipv6FeatureRedistributes {
}

export function dataSdwanServiceRoutingOspfv3Ipv6FeatureRedistributesToTerraform(struct?: DataSdwanServiceRoutingOspfv3Ipv6FeatureRedistributes): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataSdwanServiceRoutingOspfv3Ipv6FeatureRedistributesToHclTerraform(struct?: DataSdwanServiceRoutingOspfv3Ipv6FeatureRedistributes): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSdwanServiceRoutingOspfv3Ipv6FeatureRedistributesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataSdwanServiceRoutingOspfv3Ipv6FeatureRedistributes | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSdwanServiceRoutingOspfv3Ipv6FeatureRedistributes | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataSdwanServiceRoutingOspfv3Ipv6FeatureRedistributesList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataSdwanServiceRoutingOspfv3Ipv6FeatureRedistributesOutputReference {
    return new DataSdwanServiceRoutingOspfv3Ipv6FeatureRedistributesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_routing_ospfv3_ipv6_feature sdwan_service_routing_ospfv3_ipv6_feature}
*/
export class DataSdwanServiceRoutingOspfv3Ipv6Feature extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataSdwanServiceRoutingOspfv3Ipv6Feature resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataSdwanServiceRoutingOspfv3Ipv6Feature to import
  * @param importFromId The id of the existing DataSdwanServiceRoutingOspfv3Ipv6Feature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_routing_ospfv3_ipv6_feature#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataSdwanServiceRoutingOspfv3Ipv6Feature to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_routing_ospfv3_ipv6_feature sdwan_service_routing_ospfv3_ipv6_feature} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataSdwanServiceRoutingOspfv3Ipv6FeatureConfig
  */
  public constructor(scope: Construct, id: string, config: DataSdwanServiceRoutingOspfv3Ipv6FeatureConfig) {
    super(scope, id, {
  ...
  private _areas = new DataSdwanServiceRoutingOspfv3Ipv6FeatureAreasList(this, "areas", false);
  public get areas() {
    return this._areas;
  }
  ...
  private _redistributes = new DataSdwanServiceRoutingOspfv3Ipv6FeatureRedistributesList(this, "redistributes", false);
