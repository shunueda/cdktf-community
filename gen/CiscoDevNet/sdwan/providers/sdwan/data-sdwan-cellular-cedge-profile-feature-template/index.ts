// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/cellular_cedge_profile_feature_template
...
export interface DataSdwanCellularCedgeProfileFeatureTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/cellular_cedge_profile_feature_template#id DataSdwanCellularCedgeProfileFeatureTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/cellular_cedge_profile_feature_template#name DataSdwanCellularCedgeProfileFeatureTemplate#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/cellular_cedge_profile_feature_template sdwan_cellular_cedge_profile_feature_template}
*/
export class DataSdwanCellularCedgeProfileFeatureTemplate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanCellularCedgeProfileFeatureTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/cellular_cedge_profile_feature_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/cellular_cedge_profile_feature_template sdwan_cellular_cedge_profile_feature_template} Data Source
  *
  * @param scope The scope in which to define this construct
