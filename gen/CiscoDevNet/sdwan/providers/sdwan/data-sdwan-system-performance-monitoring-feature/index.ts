// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/system_performance_monitoring_feature
...
export interface DataSdwanSystemPerformanceMonitoringFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/system_performance_monitoring_feature#feature_profile_id DataSdwanSystemPerformanceMonitoringFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The id of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/system_performance_monitoring_feature#id DataSdwanSystemPerformanceMonitoringFeature#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/system_performance_monitoring_feature sdwan_system_performance_monitoring_feature}
*/
export class DataSdwanSystemPerformanceMonitoringFeature extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanSystemPerformanceMonitoringFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/system_performance_monitoring_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/system_performance_monitoring_feature sdwan_system_performance_monitoring_feature} Data Source
  *
  * @param scope The scope in which to define this construct
