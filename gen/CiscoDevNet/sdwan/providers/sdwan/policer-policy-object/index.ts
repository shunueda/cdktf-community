// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policer_policy_object
...
export interface PolicerPolicyObjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policer_policy_object#burst PolicerPolicyObject#burst}
  */
  ...
  *   - Choices: `drop`, `remark`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policer_policy_object#exceed_action PolicerPolicyObject#exceed_action}
  */
  readonly exceedAction: string;
  /**
  * The name of the policy object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policer_policy_object#name PolicerPolicyObject#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policer_policy_object#rate PolicerPolicyObject#rate}
  */
  readonly rate: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policer_policy_object sdwan_policer_policy_object}
*/
export class PolicerPolicyObject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicerPolicyObject that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policer_policy_object#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/policer_policy_object sdwan_policer_policy_object} Resource
  *
  * @param scope The scope in which to define this construct
