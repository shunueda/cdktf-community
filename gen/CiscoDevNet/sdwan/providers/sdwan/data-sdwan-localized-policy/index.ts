// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/localized_policy
...
export interface DataSdwanLocalizedPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/localized_policy#id DataSdwanLocalizedPolicy#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/localized_policy sdwan_localized_policy}
*/
export class DataSdwanLocalizedPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanLocalizedPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/localized_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/localized_policy sdwan_localized_policy} Data Source
  *
  * @param scope The scope in which to define this construct
