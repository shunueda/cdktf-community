// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_cellular_feature_associate_tracker_feature
...
export interface TransportWanVpnInterfaceCellularFeatureAssociateTrackerFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_cellular_feature_associate_tracker_feature#feature_profile_id TransportWanVpnInterfaceCellularFeatureAssociateTrackerFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * Transport Tracker Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_cellular_feature_associate_tracker_feature#transport_tracker_feature_id TransportWanVpnInterfaceCellularFeatureAssociateTrackerFeature#transport_tracker_feature_id}
  */
  readonly transportTrackerFeatureId: string;
  /**
  * Transport WAN VPN Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_cellular_feature_associate_tracker_feature#transport_wan_vpn_feature_id TransportWanVpnInterfaceCellularFeatureAssociateTrackerFeature#transport_wan_vpn_feature_id}
  */
  readonly transportWanVpnFeatureId: string;
  /**
  * Transport WAN VPN Interface Cellular Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_cellular_feature_associate_tracker_feature#transport_wan_vpn_interface_cellular_feature_id TransportWanVpnInterfaceCellularFeatureAssociateTrackerFeature#transport_wan_vpn_interface_cellular_feature_id}
  */
  readonly transportWanVpnInterfaceCellularFeatureId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_cellular_feature_associate_tracker_feature sdwan_transport_wan_vpn_interface_cellular_feature_associate_tracker_feature}
*/
export class TransportWanVpnInterfaceCellularFeatureAssociateTrackerFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransportWanVpnInterfaceCellularFeatureAssociateTrackerFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_cellular_feature_associate_tracker_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_cellular_feature_associate_tracker_feature sdwan_transport_wan_vpn_interface_cellular_feature_associate_tracker_feature} Resource
  *
  * @param scope The scope in which to define this construct
