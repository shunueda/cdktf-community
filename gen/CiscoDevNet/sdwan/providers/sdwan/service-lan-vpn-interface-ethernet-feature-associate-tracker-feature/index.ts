// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_ethernet_feature_associate_tracker_feature
...
export interface ServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_ethernet_feature_associate_tracker_feature#feature_profile_id ServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * Service LAN VPN Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_ethernet_feature_associate_tracker_feature#service_lan_vpn_feature_id ServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeature#service_lan_vpn_feature_id}
  */
  readonly serviceLanVpnFeatureId: string;
  /**
  * Service LAN VPN Interface Ethernet Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_ethernet_feature_associate_tracker_feature#service_lan_vpn_interface_ethernet_feature_id ServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeature#service_lan_vpn_interface_ethernet_feature_id}
  */
  readonly serviceLanVpnInterfaceEthernetFeatureId: string;
  /**
  * Service Tracker Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_ethernet_feature_associate_tracker_feature#service_tracker_feature_id ServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeature#service_tracker_feature_id}
  */
  readonly serviceTrackerFeatureId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_ethernet_feature_associate_tracker_feature sdwan_service_lan_vpn_interface_ethernet_feature_associate_tracker_feature}
*/
export class ServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_ethernet_feature_associate_tracker_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/service_lan_vpn_interface_ethernet_feature_associate_tracker_feature sdwan_service_lan_vpn_interface_ethernet_feature_associate_tracker_feature} Resource
  *
  * @param scope The scope in which to define this construct
