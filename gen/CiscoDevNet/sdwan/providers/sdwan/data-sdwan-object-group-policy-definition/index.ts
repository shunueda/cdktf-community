// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/object_group_policy_definition
...
export interface DataSdwanObjectGroupPolicyDefinitionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/object_group_policy_definition#id DataSdwanObjectGroupPolicyDefinition#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/object_group_policy_definition sdwan_object_group_policy_definition}
*/
export class DataSdwanObjectGroupPolicyDefinition extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanObjectGroupPolicyDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/object_group_policy_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/object_group_policy_definition sdwan_object_group_policy_definition} Data Source
  *
  * @param scope The scope in which to define this construct
