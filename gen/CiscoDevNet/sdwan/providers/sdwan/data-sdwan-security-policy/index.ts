// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/security_policy
...
export interface DataSdwanSecurityPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/security_policy#id DataSdwanSecurityPolicy#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/security_policy sdwan_security_policy}
*/
export class DataSdwanSecurityPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanSecurityPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/security_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/security_policy sdwan_security_policy} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _definitions = new DataSdwanSecurityPolicyDefinitionsList(this, "definitions", false);
