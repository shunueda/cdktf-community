// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_bgp_feature
...
export interface TransportWanVpnFeatureAssociateRoutingBgpFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_bgp_feature#feature_profile_id TransportWanVpnFeatureAssociateRoutingBgpFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * Transport Routing BGP Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_bgp_feature#transport_routing_bgp_feature_id TransportWanVpnFeatureAssociateRoutingBgpFeature#transport_routing_bgp_feature_id}
  */
  readonly transportRoutingBgpFeatureId: string;
  /**
  * Transport WAN VPN Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_bgp_feature#transport_wan_vpn_feature_id TransportWanVpnFeatureAssociateRoutingBgpFeature#transport_wan_vpn_feature_id}
  */
  readonly transportWanVpnFeatureId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_bgp_feature sdwan_transport_wan_vpn_feature_associate_routing_bgp_feature}
*/
export class TransportWanVpnFeatureAssociateRoutingBgpFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransportWanVpnFeatureAssociateRoutingBgpFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_bgp_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_feature_associate_routing_bgp_feature sdwan_transport_wan_vpn_feature_associate_routing_bgp_feature} Resource
  *
  * @param scope The scope in which to define this construct
