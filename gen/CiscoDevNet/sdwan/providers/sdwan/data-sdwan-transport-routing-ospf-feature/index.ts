// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/transport_routing_ospf_feature
...
export interface DataSdwanTransportRoutingOspfFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/transport_routing_ospf_feature#feature_profile_id DataSdwanTransportRoutingOspfFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The id of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/transport_routing_ospf_feature#id DataSdwanTransportRoutingOspfFeature#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/transport_routing_ospf_feature sdwan_transport_routing_ospf_feature}
*/
export class DataSdwanTransportRoutingOspfFeature extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanTransportRoutingOspfFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/transport_routing_ospf_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/transport_routing_ospf_feature sdwan_transport_routing_ospf_feature} Data Source
  *
  * @param scope The scope in which to define this construct
