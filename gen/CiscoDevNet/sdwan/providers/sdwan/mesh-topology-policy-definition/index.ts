// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/mesh_topology_policy_definition
...
export interface MeshTopologyPolicyDefinitionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/mesh_topology_policy_definition#description MeshTopologyPolicyDefinition#description}
  */
  readonly description: string;
  /**
  * The name of the policy definition
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/mesh_topology_policy_definition#name MeshTopologyPolicyDefinition#name}
  */
  readonly name: string;
  /**
  * List of regions
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/mesh_topology_policy_definition#regions MeshTopologyPolicyDefinition#regions}
  */
  readonly regions: MeshTopologyPolicyDefinitionRegions[] | cdktf.IResolvable;
  /**
  * VPN list ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/mesh_topology_policy_definition#vpn_list_id MeshTopologyPolicyDefinition#vpn_list_id}
  */
  readonly vpnListId?: string;
  /**
  * VPN list version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/mesh_topology_policy_definition#vpn_list_version MeshTopologyPolicyDefinition#vpn_list_version}
  */
...
export interface MeshTopologyPolicyDefinitionRegions {
  ...
  * Site list IDs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/mesh_topology_policy_definition#site_list_ids MeshTopologyPolicyDefinition#site_list_ids}
  */
  readonly siteListIds?: string[];
  /**
  * Site list versions
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/mesh_topology_policy_definition#site_list_versions MeshTopologyPolicyDefinition#site_list_versions}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/mesh_topology_policy_definition sdwan_mesh_topology_policy_definition}
*/
export class MeshTopologyPolicyDefinition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MeshTopologyPolicyDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/mesh_topology_policy_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/mesh_topology_policy_definition sdwan_mesh_topology_policy_definition} Resource
  *
  * @param scope The scope in which to define this construct
