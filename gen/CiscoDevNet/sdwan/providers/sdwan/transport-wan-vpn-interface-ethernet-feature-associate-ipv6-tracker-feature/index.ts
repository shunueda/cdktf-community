// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_ethernet_feature_associate_ipv6_tracker_feature
...
export interface TransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_ethernet_feature_associate_ipv6_tracker_feature#feature_profile_id TransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * Transport IPv6 Tracker Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_ethernet_feature_associate_ipv6_tracker_feature#transport_ipv6_tracker_feature_id TransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeature#transport_ipv6_tracker_feature_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_ethernet_feature_associate_ipv6_tracker_feature sdwan_transport_wan_vpn_interface_ethernet_feature_associate_ipv6_tracker_feature}
*/
export class TransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_ethernet_feature_associate_ipv6_tracker_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/transport_wan_vpn_interface_ethernet_feature_associate_ipv6_tracker_feature sdwan_transport_wan_vpn_interface_ethernet_feature_associate_ipv6_tracker_feature} Resource
  *
  * @param scope The scope in which to define this construct
