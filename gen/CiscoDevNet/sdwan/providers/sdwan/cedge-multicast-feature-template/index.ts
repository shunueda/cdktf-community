// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cedge_multicast_feature_template
...
export interface CedgeMulticastFeatureTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cedge_multicast_feature_template#description CedgeMulticastFeatureTemplate#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cedge_multicast_feature_template#device_types CedgeMulticastFeatureTemplate#device_types}
  */
  ...
  *   - Default value: `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cedge_multicast_feature_template#local_replicator CedgeMulticastFeatureTemplate#local_replicator}
  */
  readonly localReplicator?: boolean | cdktf.IResolvable;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cedge_multicast_feature_template#local_replicator_variable CedgeMulticastFeatureTemplate#local_replicator_variable}
  */
  readonly localReplicatorVariable?: string;
  /**
  * The name of the feature template
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cedge_multicast_feature_template#name CedgeMulticastFeatureTemplate#name}
  */
  ...
  *   - Default value: `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cedge_multicast_feature_template#spt_only CedgeMulticastFeatureTemplate#spt_only}
  */
  readonly sptOnly?: boolean | cdktf.IResolvable;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cedge_multicast_feature_template#spt_only_variable CedgeMulticastFeatureTemplate#spt_only_variable}
  */
  ...
  *   - Range: `0`-`1000`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cedge_multicast_feature_template#threshold CedgeMulticastFeatureTemplate#threshold}
  */
  readonly threshold?: number;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cedge_multicast_feature_template#threshold_variable CedgeMulticastFeatureTemplate#threshold_variable}
  */
  readonly thresholdVariable?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cedge_multicast_feature_template sdwan_cedge_multicast_feature_template}
*/
export class CedgeMulticastFeatureTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CedgeMulticastFeatureTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cedge_multicast_feature_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cedge_multicast_feature_template sdwan_cedge_multicast_feature_template} Resource
  *
  * @param scope The scope in which to define this construct
