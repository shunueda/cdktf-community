// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_lan_vpn_interface_ethernet_feature_associate_tracker_feature
...
export interface DataSdwanServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_lan_vpn_interface_ethernet_feature_associate_tracker_feature#feature_profile_id DataSdwanServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The id of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_lan_vpn_interface_ethernet_feature_associate_tracker_feature#id DataSdwanServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeature#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_lan_vpn_interface_ethernet_feature_associate_tracker_feature#service_lan_vpn_feature_id DataSdwanServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeature#service_lan_vpn_feature_id}
  */
  readonly serviceLanVpnFeatureId: string;
  /**
  * Service LAN VPN Interface Ethernet Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_lan_vpn_interface_ethernet_feature_associate_tracker_feature#service_lan_vpn_interface_ethernet_feature_id DataSdwanServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeature#service_lan_vpn_interface_ethernet_feature_id}
  */
  readonly serviceLanVpnInterfaceEthernetFeatureId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_lan_vpn_interface_ethernet_feature_associate_tracker_feature sdwan_service_lan_vpn_interface_ethernet_feature_associate_tracker_feature}
*/
export class DataSdwanServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeature extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_lan_vpn_interface_ethernet_feature_associate_tracker_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/service_lan_vpn_interface_ethernet_feature_associate_tracker_feature sdwan_service_lan_vpn_interface_ethernet_feature_associate_tracker_feature} Data Source
  *
  * @param scope The scope in which to define this construct
