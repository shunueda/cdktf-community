// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_ipv4_device_access_feature
...
export interface SystemIpv4DeviceAccessFeatureConfig extends cdktf.TerraformMetaArguments {
  /**
  * Default Action
  *   - Choices: `drop`, `accept`
  *   - Default value: `drop`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_ipv4_device_access_feature#default_action SystemIpv4DeviceAccessFeature#default_action}
  */
  readonly defaultAction?: string;
  /**
  * The description of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_ipv4_device_access_feature#description SystemIpv4DeviceAccessFeature#description}
  */
  readonly description?: string;
  /**
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_ipv4_device_access_feature#feature_profile_id SystemIpv4DeviceAccessFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The name of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_ipv4_device_access_feature#name SystemIpv4DeviceAccessFeature#name}
  */
  readonly name: string;
  /**
  * Device Access Control List
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_ipv4_device_access_feature#sequences SystemIpv4DeviceAccessFeature#sequences}
  */
  readonly sequences?: SystemIpv4DeviceAccessFeatureSequences[] | cdktf.IResolvable;
}
export interface SystemIpv4DeviceAccessFeatureSequences {
  /**
  * Base Action
  *   - Choices: `drop`, `accept`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_ipv4_device_access_feature#base_action SystemIpv4DeviceAccessFeature#base_action}
  */
  readonly baseAction?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_ipv4_device_access_feature#destination_data_prefix_list_id SystemIpv4DeviceAccessFeature#destination_data_prefix_list_id}
  */
  readonly destinationDataPrefixListId?: string;
  /**
  * Destination Data IP Prefix List
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_ipv4_device_access_feature#destination_ip_prefix_list SystemIpv4DeviceAccessFeature#destination_ip_prefix_list}
  */
  readonly destinationIpPrefixList?: string[];
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_ipv4_device_access_feature#destination_ip_prefix_list_variable SystemIpv4DeviceAccessFeature#destination_ip_prefix_list_variable}
  */
  readonly destinationIpPrefixListVariable?: string;
  /**
  * device access protocol
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_ipv4_device_access_feature#device_access_port SystemIpv4DeviceAccessFeature#device_access_port}
  */
  ...
  *   - Range: `1`-`65536`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_ipv4_device_access_feature#id SystemIpv4DeviceAccessFeature#id}
  *
  ...
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_ipv4_device_access_feature#source_data_prefix_list_id SystemIpv4DeviceAccessFeature#source_data_prefix_list_id}
  */
  readonly sourceDataPrefixListId?: string;
  /**
  * Source Data IP Prefix List
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_ipv4_device_access_feature#source_ip_prefix_list SystemIpv4DeviceAccessFeature#source_ip_prefix_list}
  */
  readonly sourceIpPrefixList?: string[];
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_ipv4_device_access_feature#source_ip_prefix_list_variable SystemIpv4DeviceAccessFeature#source_ip_prefix_list_variable}
  */
  readonly sourceIpPrefixListVariable?: string;
  /**
  * Source Port List
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_ipv4_device_access_feature#source_ports SystemIpv4DeviceAccessFeature#source_ports}
  */
  readonly sourcePorts?: number[];
}

export function systemIpv4DeviceAccessFeatureSequencesToTerraform(struct?: SystemIpv4DeviceAccessFeatureSequences | cdktf.IResolvable): any {
...
export function systemIpv4DeviceAccessFeatureSequencesToHclTerraform(struct?: SystemIpv4DeviceAccessFeatureSequences | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SystemIpv4DeviceAccessFeatureSequencesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SystemIpv4DeviceAccessFeatureSequences | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SystemIpv4DeviceAccessFeatureSequences | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class SystemIpv4DeviceAccessFeatureSequencesList extends cdktf.ComplexList {
  public internalValue? : SystemIpv4DeviceAccessFeatureSequences[] | cdktf.IResolvable
  ...
  */
  public get(index: number): SystemIpv4DeviceAccessFeatureSequencesOutputReference {
    return new SystemIpv4DeviceAccessFeatureSequencesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_ipv4_device_access_feature sdwan_system_ipv4_device_access_feature}
*/
export class SystemIpv4DeviceAccessFeature extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a SystemIpv4DeviceAccessFeature resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the SystemIpv4DeviceAccessFeature to import
  * @param importFromId The id of the existing SystemIpv4DeviceAccessFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_ipv4_device_access_feature#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SystemIpv4DeviceAccessFeature to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/system_ipv4_device_access_feature sdwan_system_ipv4_device_access_feature} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options SystemIpv4DeviceAccessFeatureConfig
  */
  public constructor(scope: Construct, id: string, config: SystemIpv4DeviceAccessFeatureConfig) {
    super(scope, id, {
  ...
  private _sequences = new SystemIpv4DeviceAccessFeatureSequencesList(this, "sequences", false);
  public get sequences() {
    return this._sequences;
  }
  public putSequences(value: SystemIpv4DeviceAccessFeatureSequences[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sequences: cdktf.listMapper(systemIpv4DeviceAccessFeatureSequencesToTerraform, false)(this._sequences.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sequences: {
        value: cdktf.listMapperHcl(systemIpv4DeviceAccessFeatureSequencesToHclTerraform, false)(this._sequences.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "SystemIpv4DeviceAccessFeatureSequencesList",
      },
    };
