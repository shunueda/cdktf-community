// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cisco_banner_feature_template
...
export interface CiscoBannerFeatureTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cisco_banner_feature_template#description CiscoBannerFeatureTemplate#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cisco_banner_feature_template#device_types CiscoBannerFeatureTemplate#device_types}
  */
  readonly deviceTypes: string[];
  /**
  * Set message to display before login prompt
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cisco_banner_feature_template#login CiscoBannerFeatureTemplate#login}
  */
  readonly login?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cisco_banner_feature_template#login_variable CiscoBannerFeatureTemplate#login_variable}
  */
  readonly loginVariable?: string;
  /**
  * Set message to display after a user logs in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cisco_banner_feature_template#motd CiscoBannerFeatureTemplate#motd}
  */
  readonly motd?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cisco_banner_feature_template#motd_variable CiscoBannerFeatureTemplate#motd_variable}
  */
  readonly motdVariable?: string;
  /**
  * The name of the feature template
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cisco_banner_feature_template#name CiscoBannerFeatureTemplate#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cisco_banner_feature_template sdwan_cisco_banner_feature_template}
*/
export class CiscoBannerFeatureTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CiscoBannerFeatureTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cisco_banner_feature_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/cisco_banner_feature_template sdwan_cisco_banner_feature_template} Resource
  *
  * @param scope The scope in which to define this construct
