// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/policy_object_expanded_community_list
...
export interface DataSdwanPolicyObjectExpandedCommunityListConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/policy_object_expanded_community_list#feature_profile_id DataSdwanPolicyObjectExpandedCommunityList#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The id of the Policy_object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/policy_object_expanded_community_list#id DataSdwanPolicyObjectExpandedCommunityList#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/policy_object_expanded_community_list sdwan_policy_object_expanded_community_list}
*/
export class DataSdwanPolicyObjectExpandedCommunityList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanPolicyObjectExpandedCommunityList that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/policy_object_expanded_community_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/data-sources/policy_object_expanded_community_list sdwan_policy_object_expanded_community_list} Data Source
  *
  * @param scope The scope in which to define this construct
