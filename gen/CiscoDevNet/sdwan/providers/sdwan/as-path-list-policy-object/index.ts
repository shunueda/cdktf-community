// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/as_path_list_policy_object
...
export interface AsPathListPolicyObjectConfig extends cdktf.TerraformMetaArguments {
  ...
  * List of entries
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/as_path_list_policy_object#entries AsPathListPolicyObject#entries}
  */
  readonly entries: AsPathListPolicyObjectEntries[] | cdktf.IResolvable;
  /**
  * The name of the policy object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/as_path_list_policy_object#name AsPathListPolicyObject#name}
  */
...
export interface AsPathListPolicyObjectEntries {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/as_path_list_policy_object#as_path AsPathListPolicyObject#as_path}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/as_path_list_policy_object sdwan_as_path_list_policy_object}
*/
export class AsPathListPolicyObject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AsPathListPolicyObject that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/as_path_list_policy_object#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.0/docs/resources/as_path_list_policy_object sdwan_as_path_list_policy_object} Resource
  *
  * @param scope The scope in which to define this construct
