// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/leaf_access_bundle_policy_sub_group
...
export interface LeafAccessBundlePolicySubGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/leaf_access_bundle_policy_sub_group#annotation LeafAccessBundlePolicySubGroup#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/leaf_access_bundle_policy_sub_group#description LeafAccessBundlePolicySubGroup#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/leaf_access_bundle_policy_sub_group#id LeafAccessBundlePolicySubGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/leaf_access_bundle_policy_sub_group#leaf_access_bundle_policy_group_dn LeafAccessBundlePolicySubGroup#leaf_access_bundle_policy_group_dn}
  */
  readonly leafAccessBundlePolicyGroupDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/leaf_access_bundle_policy_sub_group#name LeafAccessBundlePolicySubGroup#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/leaf_access_bundle_policy_sub_group#name_alias LeafAccessBundlePolicySubGroup#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Create relation to lacp:IfPol
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/leaf_access_bundle_policy_sub_group#port_channel_member LeafAccessBundlePolicySubGroup#port_channel_member}
  */
  readonly portChannelMember?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/leaf_access_bundle_policy_sub_group aci_leaf_access_bundle_policy_sub_group}
*/
export class LeafAccessBundlePolicySubGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LeafAccessBundlePolicySubGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/leaf_access_bundle_policy_sub_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/leaf_access_bundle_policy_sub_group aci_leaf_access_bundle_policy_sub_group} Resource
  *
  * @param scope The scope in which to define this construct
