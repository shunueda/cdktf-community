// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/recurring_window
...
export interface DataAciRecurringWindowConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/recurring_window#annotation DataAciRecurringWindow#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/recurring_window#concur_cap DataAciRecurringWindow#concur_cap}
  */
  readonly concurCap?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/recurring_window#day DataAciRecurringWindow#day}
  */
  readonly day?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/recurring_window#hour DataAciRecurringWindow#hour}
  */
  readonly hour?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/recurring_window#id DataAciRecurringWindow#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/recurring_window#minute DataAciRecurringWindow#minute}
  */
  readonly minute?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/recurring_window#name DataAciRecurringWindow#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/recurring_window#name_alias DataAciRecurringWindow#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/recurring_window#node_upg_interval DataAciRecurringWindow#node_upg_interval}
  */
  readonly nodeUpgInterval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/recurring_window#proc_break DataAciRecurringWindow#proc_break}
  */
  readonly procBreak?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/recurring_window#proc_cap DataAciRecurringWindow#proc_cap}
  */
  readonly procCap?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/recurring_window#scheduler_dn DataAciRecurringWindow#scheduler_dn}
  */
  readonly schedulerDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/recurring_window#time_cap DataAciRecurringWindow#time_cap}
  */
  readonly timeCap?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/recurring_window aci_recurring_window}
*/
export class DataAciRecurringWindow extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciRecurringWindow that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/recurring_window#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/recurring_window aci_recurring_window} Data Source
  *
  * @param scope The scope in which to define this construct
