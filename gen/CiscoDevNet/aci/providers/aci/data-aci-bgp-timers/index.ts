// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_timers
...
export interface DataAciBgpTimersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_timers#annotation DataAciBgpTimers#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_timers#description DataAciBgpTimers#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_timers#gr_ctrl DataAciBgpTimers#gr_ctrl}
  */
  readonly grCtrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_timers#hold_intvl DataAciBgpTimers#hold_intvl}
  */
  readonly holdIntvl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_timers#id DataAciBgpTimers#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_timers#ka_intvl DataAciBgpTimers#ka_intvl}
  */
  readonly kaIntvl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_timers#max_as_limit DataAciBgpTimers#max_as_limit}
  */
  readonly maxAsLimit?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_timers#name DataAciBgpTimers#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_timers#name_alias DataAciBgpTimers#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_timers#stale_intvl DataAciBgpTimers#stale_intvl}
  */
  readonly staleIntvl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_timers#tenant_dn DataAciBgpTimers#tenant_dn}
  */
  readonly tenantDn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_timers aci_bgp_timers}
*/
export class DataAciBgpTimers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciBgpTimers that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_timers#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_timers aci_bgp_timers} Data Source
  *
  * @param scope The scope in which to define this construct
