// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bgp_protocol_profile
...
export interface L3OutBgpProtocolProfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bgp_protocol_profile#annotation L3OutBgpProtocolProfile#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bgp_protocol_profile#id L3OutBgpProtocolProfile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bgp_protocol_profile#logical_node_profile_dn L3OutBgpProtocolProfile#logical_node_profile_dn}
  */
  readonly logicalNodeProfileDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bgp_protocol_profile#name L3OutBgpProtocolProfile#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bgp_protocol_profile#name_alias L3OutBgpProtocolProfile#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bgp_protocol_profile#relation_bgp_rs_best_path_ctrl_pol L3OutBgpProtocolProfile#relation_bgp_rs_best_path_ctrl_pol}
  */
  readonly relationBgpRsBestPathCtrlPol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bgp_protocol_profile#relation_bgp_rs_bgp_node_ctx_pol L3OutBgpProtocolProfile#relation_bgp_rs_bgp_node_ctx_pol}
  */
  readonly relationBgpRsBgpNodeCtxPol?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bgp_protocol_profile aci_l3out_bgp_protocol_profile}
*/
export class L3OutBgpProtocolProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing L3OutBgpProtocolProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bgp_protocol_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bgp_protocol_profile aci_l3out_bgp_protocol_profile} Resource
  *
  * @param scope The scope in which to define this construct
