// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/netflow_monitor_policy
...
export interface DataAciNetflowMonitorPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/netflow_monitor_policy#name DataAciNetflowMonitorPolicy#name}
  */
  readonly name: string;
  /**
  * The distinguished name (DN) of the parent object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/netflow_monitor_policy#parent_dn DataAciNetflowMonitorPolicy#parent_dn}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/netflow_monitor_policy aci_netflow_monitor_policy}
*/
export class DataAciNetflowMonitorPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciNetflowMonitorPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/netflow_monitor_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/netflow_monitor_policy aci_netflow_monitor_policy} Data Source
  *
  * @param scope The scope in which to define this construct
