// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/l3out_static_route_next_hop
...
export interface DataAciL3OutStaticRouteNextHopConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/l3out_static_route_next_hop#annotation DataAciL3OutStaticRouteNextHop#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/l3out_static_route_next_hop#description DataAciL3OutStaticRouteNextHop#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/l3out_static_route_next_hop#id DataAciL3OutStaticRouteNextHop#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/l3out_static_route_next_hop#name_alias DataAciL3OutStaticRouteNextHop#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/l3out_static_route_next_hop#nexthop_profile_type DataAciL3OutStaticRouteNextHop#nexthop_profile_type}
  */
  readonly nexthopProfileType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/l3out_static_route_next_hop#nh_addr DataAciL3OutStaticRouteNextHop#nh_addr}
  */
  readonly nhAddr: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/l3out_static_route_next_hop#pref DataAciL3OutStaticRouteNextHop#pref}
  */
  readonly pref?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/l3out_static_route_next_hop#static_route_dn DataAciL3OutStaticRouteNextHop#static_route_dn}
  */
  readonly staticRouteDn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/l3out_static_route_next_hop aci_l3out_static_route_next_hop}
*/
export class DataAciL3OutStaticRouteNextHop extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciL3OutStaticRouteNextHop that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/l3out_static_route_next_hop#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/l3out_static_route_next_hop aci_l3out_static_route_next_hop} Data Source
  *
  * @param scope The scope in which to define this construct
