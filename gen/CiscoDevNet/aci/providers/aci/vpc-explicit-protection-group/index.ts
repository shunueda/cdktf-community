// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/vpc_explicit_protection_group
...
export interface VpcExplicitProtectionGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/vpc_explicit_protection_group#annotation VpcExplicitProtectionGroup#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/vpc_explicit_protection_group#id VpcExplicitProtectionGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/vpc_explicit_protection_group#name VpcExplicitProtectionGroup#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/vpc_explicit_protection_group#switch1 VpcExplicitProtectionGroup#switch1}
  */
  readonly switch1: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/vpc_explicit_protection_group#switch2 VpcExplicitProtectionGroup#switch2}
  */
  readonly switch2: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/vpc_explicit_protection_group#vpc_domain_policy VpcExplicitProtectionGroup#vpc_domain_policy}
  */
  readonly vpcDomainPolicy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/vpc_explicit_protection_group#vpc_explicit_protection_group_id VpcExplicitProtectionGroup#vpc_explicit_protection_group_id}
  */
  readonly vpcExplicitProtectionGroupId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/vpc_explicit_protection_group aci_vpc_explicit_protection_group}
*/
export class VpcExplicitProtectionGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcExplicitProtectionGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/vpc_explicit_protection_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/vpc_explicit_protection_group aci_vpc_explicit_protection_group} Resource
  *
  * @param scope The scope in which to define this construct
