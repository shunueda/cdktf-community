// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/external_management_network_subnet
...
export interface DataAciExternalManagementNetworkSubnetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/external_management_network_subnet#ip DataAciExternalManagementNetworkSubnet#ip}
  */
  readonly ip: string;
  /**
  * The distinguished name (DN) of the parent object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/external_management_network_subnet#parent_dn DataAciExternalManagementNetworkSubnet#parent_dn}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/external_management_network_subnet aci_external_management_network_subnet}
*/
export class DataAciExternalManagementNetworkSubnet extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciExternalManagementNetworkSubnet that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/external_management_network_subnet#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/external_management_network_subnet aci_external_management_network_subnet} Data Source
  *
  * @param scope The scope in which to define this construct
