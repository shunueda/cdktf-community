// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/l3out_redistribute_policy
...
export interface DataAciL3OutRedistributePolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/l3out_redistribute_policy#parent_dn DataAciL3OutRedistributePolicy#parent_dn}
  */
  readonly parentDn: string;
  /**
  * The name of the Route Control Profile object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/l3out_redistribute_policy#route_control_profile_name DataAciL3OutRedistributePolicy#route_control_profile_name}
  */
  readonly routeControlProfileName: string;
  /**
  * The source of the L3Out Redistribute Policy object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/l3out_redistribute_policy#source DataAciL3OutRedistributePolicy#source}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/l3out_redistribute_policy aci_l3out_redistribute_policy}
*/
export class DataAciL3OutRedistributePolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciL3OutRedistributePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/l3out_redistribute_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/l3out_redistribute_policy aci_l3out_redistribute_policy} Data Source
  *
  * @param scope The scope in which to define this construct
