// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/cloud_context_profile
...
export interface DataAciCloudContextProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/cloud_context_profile#access_policy_type DataAciCloudContextProfile#access_policy_type}
  */
  readonly accessPolicyType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/cloud_context_profile#annotation DataAciCloudContextProfile#annotation}
  */
  readonly annotation?: string;
  /**
  * Import Brownfield Virtual Network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/cloud_context_profile#cloud_brownfield DataAciCloudContextProfile#cloud_brownfield}
  */
  readonly cloudBrownfield?: string;
  /**
  * Name of the vendor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/cloud_context_profile#cloud_vendor DataAciCloudContextProfile#cloud_vendor}
  */
  readonly cloudVendor?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/cloud_context_profile#description DataAciCloudContextProfile#description}
  */
  readonly description?: string;
  /**
  * hub network to enable transit gateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/cloud_context_profile#hub_network DataAciCloudContextProfile#hub_network}
  */
  readonly hubNetwork?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/cloud_context_profile#id DataAciCloudContextProfile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/cloud_context_profile#name DataAciCloudContextProfile#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/cloud_context_profile#name_alias DataAciCloudContextProfile#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Primary CIDR block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/cloud_context_profile#primary_cidr DataAciCloudContextProfile#primary_cidr}
  */
  readonly primaryCidr?: string;
  /**
  * region
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/cloud_context_profile#region DataAciCloudContextProfile#region}
  */
  readonly region?: string;
  /**
  * Create relation to cloudAwsFlowLogPol
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/cloud_context_profile#relation_cloud_rs_ctx_to_flow_log DataAciCloudContextProfile#relation_cloud_rs_ctx_to_flow_log}
  */
  readonly relationCloudRsCtxToFlowLog?: string;
  /**
  * Create relation to fvCtx
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/cloud_context_profile#relation_cloud_rs_to_ctx DataAciCloudContextProfile#relation_cloud_rs_to_ctx}
  */
  readonly relationCloudRsToCtx?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/cloud_context_profile#tenant_dn DataAciCloudContextProfile#tenant_dn}
  */
  readonly tenantDn: string;
  /**
  * component type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/cloud_context_profile#type DataAciCloudContextProfile#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/cloud_context_profile aci_cloud_context_profile}
*/
export class DataAciCloudContextProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciCloudContextProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/cloud_context_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/cloud_context_profile aci_cloud_context_profile} Data Source
  *
  * @param scope The scope in which to define this construct
