// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pbr_l1_l2_destination
...
export interface DataAciPbrL1L2DestinationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pbr_l1_l2_destination#annotation DataAciPbrL1L2Destination#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pbr_l1_l2_destination#description DataAciPbrL1L2Destination#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pbr_l1_l2_destination#destination_name DataAciPbrL1L2Destination#destination_name}
  */
  readonly destinationName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pbr_l1_l2_destination#id DataAciPbrL1L2Destination#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pbr_l1_l2_destination#mac DataAciPbrL1L2Destination#mac}
  */
  readonly mac?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pbr_l1_l2_destination#name DataAciPbrL1L2Destination#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pbr_l1_l2_destination#name_alias DataAciPbrL1L2Destination#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pbr_l1_l2_destination#pod_id DataAciPbrL1L2Destination#pod_id}
  */
  readonly podId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pbr_l1_l2_destination#policy_based_redirect_dn DataAciPbrL1L2Destination#policy_based_redirect_dn}
  */
  readonly policyBasedRedirectDn: string;
  /**
  * Create relation to vns:RedirectHealthGroup
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pbr_l1_l2_destination#relation_vns_rs_l1_l2_redirect_health_group DataAciPbrL1L2Destination#relation_vns_rs_l1_l2_redirect_health_group}
  */
  readonly relationVnsRsL1L2RedirectHealthGroup?: string;
  /**
  * Create relation to vns:CIf
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pbr_l1_l2_destination#relation_vns_rs_to_c_if DataAciPbrL1L2Destination#relation_vns_rs_to_c_if}
  */
  readonly relationVnsRsToCIf?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pbr_l1_l2_destination aci_pbr_l1_l2_destination}
*/
export class DataAciPbrL1L2Destination extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciPbrL1L2Destination that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pbr_l1_l2_destination#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pbr_l1_l2_destination aci_pbr_l1_l2_destination} Data Source
  *
  * @param scope The scope in which to define this construct
