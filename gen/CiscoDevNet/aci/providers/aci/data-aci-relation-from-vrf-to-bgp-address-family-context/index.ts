// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_vrf_to_bgp_address_family_context
...
export interface DataAciRelationFromVrfToBgpAddressFamilyContextConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_vrf_to_bgp_address_family_context#address_family DataAciRelationFromVrfToBgpAddressFamilyContext#address_family}
  */
  readonly addressFamily: string;
  /**
  * The name of the BGP Address Family Context.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_vrf_to_bgp_address_family_context#bgp_address_family_context_name DataAciRelationFromVrfToBgpAddressFamilyContext#bgp_address_family_context_name}
  */
  readonly bgpAddressFamilyContextName: string;
  /**
  * The distinguished name (DN) of the parent object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_vrf_to_bgp_address_family_context#parent_dn DataAciRelationFromVrfToBgpAddressFamilyContext#parent_dn}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_vrf_to_bgp_address_family_context aci_relation_from_vrf_to_bgp_address_family_context}
*/
export class DataAciRelationFromVrfToBgpAddressFamilyContext extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciRelationFromVrfToBgpAddressFamilyContext that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_vrf_to_bgp_address_family_context#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_vrf_to_bgp_address_family_context aci_relation_from_vrf_to_bgp_address_family_context} Data Source
  *
  * @param scope The scope in which to define this construct
