// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_selector
...
export interface SpinePortSelectorConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_selector#annotation SpinePortSelector#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_selector#id SpinePortSelector#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_selector#spine_profile_dn SpinePortSelector#spine_profile_dn}
  */
  readonly spineProfileDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_selector#tdn SpinePortSelector#tdn}
  */
  readonly tdn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_selector aci_spine_port_selector}
*/
export class SpinePortSelector extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpinePortSelector that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_selector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_selector aci_spine_port_selector} Resource
  *
  * @param scope The scope in which to define this construct
