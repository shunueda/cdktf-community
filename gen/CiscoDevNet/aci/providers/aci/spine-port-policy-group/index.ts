// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_policy_group
...
export interface SpinePortPolicyGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_policy_group#annotation SpinePortPolicyGroup#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_policy_group#description SpinePortPolicyGroup#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_policy_group#id SpinePortPolicyGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_policy_group#name SpinePortPolicyGroup#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_policy_group#name_alias SpinePortPolicyGroup#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_policy_group#relation_infra_rs_att_ent_p SpinePortPolicyGroup#relation_infra_rs_att_ent_p}
  */
  readonly relationInfraRsAttEntP?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_policy_group#relation_infra_rs_cdp_if_pol SpinePortPolicyGroup#relation_infra_rs_cdp_if_pol}
  */
  readonly relationInfraRsCdpIfPol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_policy_group#relation_infra_rs_copp_if_pol SpinePortPolicyGroup#relation_infra_rs_copp_if_pol}
  */
  readonly relationInfraRsCoppIfPol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_policy_group#relation_infra_rs_h_if_pol SpinePortPolicyGroup#relation_infra_rs_h_if_pol}
  */
  readonly relationInfraRsHIfPol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_policy_group#relation_infra_rs_macsec_if_pol SpinePortPolicyGroup#relation_infra_rs_macsec_if_pol}
  */
  readonly relationInfraRsMacsecIfPol?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_policy_group aci_spine_port_policy_group}
*/
export class SpinePortPolicyGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpinePortPolicyGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_policy_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_port_policy_group aci_spine_port_policy_group} Resource
  *
  * @param scope The scope in which to define this construct
