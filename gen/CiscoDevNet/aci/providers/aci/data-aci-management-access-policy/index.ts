// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/management_access_policy
...
export interface DataAciManagementAccessPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/management_access_policy#name DataAciManagementAccessPolicy#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/management_access_policy aci_management_access_policy}
*/
export class DataAciManagementAccessPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciManagementAccessPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/management_access_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/management_access_policy aci_management_access_policy} Data Source
  *
  * @param scope The scope in which to define this construct
