// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/access_port_selector
...
export interface AccessPortSelectorConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/access_port_selector#access_port_selector_type AccessPortSelector#access_port_selector_type}
  */
  readonly accessPortSelectorType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/access_port_selector#annotation AccessPortSelector#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/access_port_selector#description AccessPortSelector#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/access_port_selector#id AccessPortSelector#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/access_port_selector#leaf_interface_profile_dn AccessPortSelector#leaf_interface_profile_dn}
  */
  readonly leafInterfaceProfileDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/access_port_selector#name AccessPortSelector#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/access_port_selector#name_alias AccessPortSelector#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/access_port_selector#relation_infra_rs_acc_base_grp AccessPortSelector#relation_infra_rs_acc_base_grp}
  */
  readonly relationInfraRsAccBaseGrp?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/access_port_selector aci_access_port_selector}
*/
export class AccessPortSelector extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccessPortSelector that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/access_port_selector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/access_port_selector aci_access_port_selector} Resource
  *
  * @param scope The scope in which to define this construct
