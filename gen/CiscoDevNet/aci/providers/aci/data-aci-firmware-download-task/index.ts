// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task
...
export interface DataAciFirmwareDownloadTaskConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task#annotation DataAciFirmwareDownloadTask#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task#auth_pass DataAciFirmwareDownloadTask#auth_pass}
  */
  readonly authPass?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task#auth_type DataAciFirmwareDownloadTask#auth_type}
  */
  readonly authType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task#description DataAciFirmwareDownloadTask#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task#dnld_task_flip DataAciFirmwareDownloadTask#dnld_task_flip}
  */
  readonly dnldTaskFlip?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task#id DataAciFirmwareDownloadTask#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task#identity_private_key_contents DataAciFirmwareDownloadTask#identity_private_key_contents}
  */
  readonly identityPrivateKeyContents?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task#identity_private_key_passphrase DataAciFirmwareDownloadTask#identity_private_key_passphrase}
  */
  readonly identityPrivateKeyPassphrase?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task#identity_public_key_contents DataAciFirmwareDownloadTask#identity_public_key_contents}
  */
  readonly identityPublicKeyContents?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task#load_catalog_if_exists_and_newer DataAciFirmwareDownloadTask#load_catalog_if_exists_and_newer}
  */
  readonly loadCatalogIfExistsAndNewer?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task#name DataAciFirmwareDownloadTask#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task#name_alias DataAciFirmwareDownloadTask#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task#password DataAciFirmwareDownloadTask#password}
  */
  readonly password?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task#polling_interval DataAciFirmwareDownloadTask#polling_interval}
  */
  readonly pollingInterval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task#proto DataAciFirmwareDownloadTask#proto}
  */
  readonly proto?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task#url DataAciFirmwareDownloadTask#url}
  */
  readonly url?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task#user DataAciFirmwareDownloadTask#user}
  */
  readonly user?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task aci_firmware_download_task}
*/
export class DataAciFirmwareDownloadTask extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataAciFirmwareDownloadTask resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAciFirmwareDownloadTask to import
  * @param importFromId The id of the existing DataAciFirmwareDownloadTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAciFirmwareDownloadTask to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/firmware_download_task aci_firmware_download_task} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataAciFirmwareDownloadTaskConfig
  */
  public constructor(scope: Construct, id: string, config: DataAciFirmwareDownloadTaskConfig) {
    super(scope, id, {
