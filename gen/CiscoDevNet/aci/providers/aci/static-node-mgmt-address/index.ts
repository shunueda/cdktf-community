// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/static_node_mgmt_address
...
export interface StaticNodeMgmtAddressConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/static_node_mgmt_address#addr StaticNodeMgmtAddress#addr}
  */
  readonly addr?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/static_node_mgmt_address#annotation StaticNodeMgmtAddress#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/static_node_mgmt_address#description StaticNodeMgmtAddress#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/static_node_mgmt_address#gw StaticNodeMgmtAddress#gw}
  */
  readonly gw?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/static_node_mgmt_address#id StaticNodeMgmtAddress#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/static_node_mgmt_address#management_epg_dn StaticNodeMgmtAddress#management_epg_dn}
  */
  readonly managementEpgDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/static_node_mgmt_address#t_dn StaticNodeMgmtAddress#t_dn}
  */
  readonly tDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/static_node_mgmt_address#type StaticNodeMgmtAddress#type}
  */
  readonly type: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/static_node_mgmt_address#v6_addr StaticNodeMgmtAddress#v6_addr}
  */
  readonly v6Addr?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/static_node_mgmt_address#v6_gw StaticNodeMgmtAddress#v6_gw}
  */
  readonly v6Gw?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/static_node_mgmt_address aci_static_node_mgmt_address}
*/
export class StaticNodeMgmtAddress extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StaticNodeMgmtAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/static_node_mgmt_address#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/static_node_mgmt_address aci_static_node_mgmt_address} Resource
  *
  * @param scope The scope in which to define this construct
