// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/firmware_group
...
export interface FirmwareGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/firmware_group#annotation FirmwareGroup#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/firmware_group#description FirmwareGroup#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/firmware_group#firmware_group_type FirmwareGroup#firmware_group_type}
  */
  readonly firmwareGroupType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/firmware_group#id FirmwareGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/firmware_group#name FirmwareGroup#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/firmware_group#name_alias FirmwareGroup#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/firmware_group#relation_firmware_rs_fwgrpp FirmwareGroup#relation_firmware_rs_fwgrpp}
  */
  readonly relationFirmwareRsFwgrpp?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/firmware_group aci_firmware_group}
*/
export class FirmwareGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FirmwareGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/firmware_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/firmware_group aci_firmware_group} Resource
  *
  * @param scope The scope in which to define this construct
