// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_node_policy
...
export interface BfdMultihopNodePolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_node_policy#admin_state BfdMultihopNodePolicy#admin_state}
  */
  readonly adminState?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_node_policy#annotation BfdMultihopNodePolicy#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_node_policy#description BfdMultihopNodePolicy#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_node_policy#detection_multiplier BfdMultihopNodePolicy#detection_multiplier}
  */
  readonly detectionMultiplier?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_node_policy#id BfdMultihopNodePolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_node_policy#min_rx_interval BfdMultihopNodePolicy#min_rx_interval}
  */
  readonly minRxInterval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_node_policy#min_tx_interval BfdMultihopNodePolicy#min_tx_interval}
  */
  readonly minTxInterval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_node_policy#name BfdMultihopNodePolicy#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_node_policy#name_alias BfdMultihopNodePolicy#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_node_policy#tenant_dn BfdMultihopNodePolicy#tenant_dn}
  */
  readonly tenantDn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_node_policy aci_bfd_multihop_node_policy}
*/
export class BfdMultihopNodePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BfdMultihopNodePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_node_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_node_policy aci_bfd_multihop_node_policy} Resource
  *
  * @param scope The scope in which to define this construct
