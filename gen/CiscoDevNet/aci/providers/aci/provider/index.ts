// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs
...
export interface AciProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs#allow_existing_on_create AciProvider#allow_existing_on_create}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs#annotation AciProvider#annotation}
  */
  readonly annotation?: string;
  /**
  * Certificate name for the User in Cisco ACI. This can also be set as the ACI_CERT_NAME environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs#cert_name AciProvider#cert_name}
  */
  readonly certName?: string;
  /**
  * Allow insecure HTTPS client. This can also be set as the ACI_INSECURE environment variable. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs#insecure AciProvider#insecure}
  */
  readonly insecure?: string;
  /**
  * Password for the APIC Account. This can also be set as the ACI_PASSWORD environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs#password AciProvider#password}
  */
  readonly password?: string;
  /**
  * Private key path for signature calculation. This can also be set as the ACI_PRIVATE_KEY environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs#private_key AciProvider#private_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs#proxy_creds AciProvider#proxy_creds}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs#proxy_url AciProvider#proxy_url}
  */
  readonly proxyUrl?: string;
  /**
  * Number of retries for REST API calls. This can also be set as the ACI_RETRIES environment variable. Defaults to `2`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs#retries AciProvider#retries}
  */
  readonly retries?: string;
  /**
  * URL of the Cisco ACI web interface. This can also be set as the ACI_URL environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs#url AciProvider#url}
  */
  readonly url?: string;
  /**
  * Username for the APIC Account. This can also be set as the ACI_USERNAME environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs#username AciProvider#username}
  */
  readonly username?: string;
  /**
  * Flag to validate if a object with entered relation Dn exists in the APIC. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs#validate_relation_dn AciProvider#validate_relation_dn}
  */
  readonly validateRelationDn?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs#alias AciProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs aci}
*/
export class AciProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing AciProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs aci} Resource
  *
  * @param scope The scope in which to define this construct
