// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_ospf_external_policy
...
export interface L3OutOspfExternalPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_ospf_external_policy#annotation L3OutOspfExternalPolicy#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_ospf_external_policy#area_cost L3OutOspfExternalPolicy#area_cost}
  */
  readonly areaCost?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_ospf_external_policy#area_ctrl L3OutOspfExternalPolicy#area_ctrl}
  */
  readonly areaCtrl?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_ospf_external_policy#area_id L3OutOspfExternalPolicy#area_id}
  */
  readonly areaId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_ospf_external_policy#area_type L3OutOspfExternalPolicy#area_type}
  */
  readonly areaType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_ospf_external_policy#description L3OutOspfExternalPolicy#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_ospf_external_policy#id L3OutOspfExternalPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_ospf_external_policy#l3_outside_dn L3OutOspfExternalPolicy#l3_outside_dn}
  */
  readonly l3OutsideDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_ospf_external_policy#multipod_internal L3OutOspfExternalPolicy#multipod_internal}
  */
  readonly multipodInternal?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_ospf_external_policy#name_alias L3OutOspfExternalPolicy#name_alias}
  */
  readonly nameAlias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_ospf_external_policy aci_l3out_ospf_external_policy}
*/
export class L3OutOspfExternalPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing L3OutOspfExternalPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_ospf_external_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_ospf_external_policy aci_l3out_ospf_external_policy} Resource
  *
  * @param scope The scope in which to define this construct
