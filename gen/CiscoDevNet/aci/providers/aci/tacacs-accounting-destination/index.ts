// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/tacacs_accounting_destination
...
export interface TacacsAccountingDestinationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/tacacs_accounting_destination#annotation TacacsAccountingDestination#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/tacacs_accounting_destination#auth_protocol TacacsAccountingDestination#auth_protocol}
  */
  readonly authProtocol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/tacacs_accounting_destination#description TacacsAccountingDestination#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/tacacs_accounting_destination#host TacacsAccountingDestination#host}
  */
  readonly host: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/tacacs_accounting_destination#id TacacsAccountingDestination#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/tacacs_accounting_destination#key TacacsAccountingDestination#key}
  */
  readonly key?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/tacacs_accounting_destination#name TacacsAccountingDestination#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/tacacs_accounting_destination#name_alias TacacsAccountingDestination#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/tacacs_accounting_destination#port TacacsAccountingDestination#port}
  */
  readonly port?: string;
  /**
  * Create relation to fv:ATg
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/tacacs_accounting_destination#relation_file_rs_a_remote_host_to_epg TacacsAccountingDestination#relation_file_rs_a_remote_host_to_epg}
  */
  readonly relationFileRsARemoteHostToEpg?: string;
  /**
  * Create relation to fv:AREpP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/tacacs_accounting_destination#relation_file_rs_a_remote_host_to_epp TacacsAccountingDestination#relation_file_rs_a_remote_host_to_epp}
  */
  readonly relationFileRsARemoteHostToEpp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/tacacs_accounting_destination#tacacs_accounting_dn TacacsAccountingDestination#tacacs_accounting_dn}
  */
  readonly tacacsAccountingDn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/tacacs_accounting_destination aci_tacacs_accounting_destination}
*/
export class TacacsAccountingDestination extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TacacsAccountingDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/tacacs_accounting_destination#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/tacacs_accounting_destination aci_tacacs_accounting_destination} Resource
  *
  * @param scope The scope in which to define this construct
