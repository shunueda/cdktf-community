// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/error_disable_recovery
...
export interface ErrorDisableRecoveryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/error_disable_recovery#annotation ErrorDisableRecovery#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/error_disable_recovery#description ErrorDisableRecovery#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/error_disable_recovery#edr_event_ids ErrorDisableRecovery#edr_event_ids}
  */
  readonly edrEventIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/error_disable_recovery#err_dis_recov_intvl ErrorDisableRecovery#err_dis_recov_intvl}
  */
  readonly errDisRecovIntvl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/error_disable_recovery#id ErrorDisableRecovery#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/error_disable_recovery#name_alias ErrorDisableRecovery#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * edr_event block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/error_disable_recovery#edr_event ErrorDisableRecovery#edr_event}
  */
...
export interface ErrorDisableRecoveryEdrEvent {
  ...
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/error_disable_recovery#event ErrorDisableRecovery#event}
  */
  readonly event: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/error_disable_recovery#name ErrorDisableRecovery#name}
  */
  ...
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/error_disable_recovery#recover ErrorDisableRecovery#recover}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/error_disable_recovery aci_error_disable_recovery}
*/
export class ErrorDisableRecovery extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ErrorDisableRecovery that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/error_disable_recovery#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/error_disable_recovery aci_error_disable_recovery} Resource
  *
  * @param scope The scope in which to define this construct
