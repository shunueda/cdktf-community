// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/pod_maintenance_group
...
export interface PodMaintenanceGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/pod_maintenance_group#annotation PodMaintenanceGroup#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/pod_maintenance_group#description PodMaintenanceGroup#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/pod_maintenance_group#fwtype PodMaintenanceGroup#fwtype}
  */
  readonly fwtype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/pod_maintenance_group#id PodMaintenanceGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/pod_maintenance_group#name PodMaintenanceGroup#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/pod_maintenance_group#name_alias PodMaintenanceGroup#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/pod_maintenance_group#pod_maintenance_group_type PodMaintenanceGroup#pod_maintenance_group_type}
  */
  readonly podMaintenanceGroupType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/pod_maintenance_group#relation_maint_rs_mgrpp PodMaintenanceGroup#relation_maint_rs_mgrpp}
  */
  readonly relationMaintRsMgrpp?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/pod_maintenance_group aci_pod_maintenance_group}
*/
export class PodMaintenanceGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PodMaintenanceGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/pod_maintenance_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/pod_maintenance_group aci_pod_maintenance_group} Resource
  *
  * @param scope The scope in which to define this construct
