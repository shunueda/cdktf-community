// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bulk_epg_to_static_path
...
export interface BulkEpgToStaticPathConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bulk_epg_to_static_path#application_epg_dn BulkEpgToStaticPath#application_epg_dn}
  */
  readonly applicationEpgDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bulk_epg_to_static_path#id BulkEpgToStaticPath#id}
  *
  ...
  * static_path block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bulk_epg_to_static_path#static_path BulkEpgToStaticPath#static_path}
  */
  readonly staticPath: BulkEpgToStaticPathStaticPath[] | cdktf.IResolvable;
}
export interface BulkEpgToStaticPathStaticPath {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bulk_epg_to_static_path#deployment_immediacy BulkEpgToStaticPath#deployment_immediacy}
  */
  readonly deploymentImmediacy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bulk_epg_to_static_path#description BulkEpgToStaticPath#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bulk_epg_to_static_path#encap BulkEpgToStaticPath#encap}
  */
  readonly encap: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bulk_epg_to_static_path#interface_dn BulkEpgToStaticPath#interface_dn}
  */
  readonly interfaceDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bulk_epg_to_static_path#mode BulkEpgToStaticPath#mode}
  */
  readonly mode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bulk_epg_to_static_path#primary_encap BulkEpgToStaticPath#primary_encap}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bulk_epg_to_static_path aci_bulk_epg_to_static_path}
*/
export class BulkEpgToStaticPath extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BulkEpgToStaticPath that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bulk_epg_to_static_path#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bulk_epg_to_static_path aci_bulk_epg_to_static_path} Resource
  *
  * @param scope The scope in which to define this construct
