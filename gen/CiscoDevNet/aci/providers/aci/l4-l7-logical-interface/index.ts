// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l4_l7_logical_interface
...
export interface L4L7LogicalInterfaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l4_l7_logical_interface#annotation L4L7LogicalInterface#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l4_l7_logical_interface#description L4L7LogicalInterface#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l4_l7_logical_interface#encap L4L7LogicalInterface#encap}
  */
  readonly encap?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l4_l7_logical_interface#enhanced_lag_policy_name L4L7LogicalInterface#enhanced_lag_policy_name}
  */
  readonly enhancedLagPolicyName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l4_l7_logical_interface#id L4L7LogicalInterface#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l4_l7_logical_interface#l4_l7_device_dn L4L7LogicalInterface#l4_l7_device_dn}
  */
  readonly l4L7DeviceDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l4_l7_logical_interface#name L4L7LogicalInterface#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l4_l7_logical_interface#name_alias L4L7LogicalInterface#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Create relation to vnsCIf
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l4_l7_logical_interface#relation_vns_rs_c_if_att_n L4L7LogicalInterface#relation_vns_rs_c_if_att_n}
  */
  readonly relationVnsRsCIfAttN?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l4_l7_logical_interface aci_l4_l7_logical_interface}
*/
export class L4L7LogicalInterface extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing L4L7LogicalInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l4_l7_logical_interface#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l4_l7_logical_interface aci_l4_l7_logical_interface} Resource
  *
  * @param scope The scope in which to define this construct
