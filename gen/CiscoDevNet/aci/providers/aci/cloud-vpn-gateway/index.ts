// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_vpn_gateway
...
export interface CloudVpnGatewayConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_vpn_gateway#annotation CloudVpnGateway#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_vpn_gateway#cloud_context_profile_dn CloudVpnGateway#cloud_context_profile_dn}
  */
  readonly cloudContextProfileDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_vpn_gateway#cloud_router_profile_type CloudVpnGateway#cloud_router_profile_type}
  */
  readonly cloudRouterProfileType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_vpn_gateway#description CloudVpnGateway#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_vpn_gateway#id CloudVpnGateway#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_vpn_gateway#name CloudVpnGateway#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_vpn_gateway#name_alias CloudVpnGateway#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_vpn_gateway#num_instances CloudVpnGateway#num_instances}
  */
  readonly numInstances?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_vpn_gateway#relation_cloud_rs_to_direct_conn_pol CloudVpnGateway#relation_cloud_rs_to_direct_conn_pol}
  */
  readonly relationCloudRsToDirectConnPol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_vpn_gateway#relation_cloud_rs_to_host_router_pol CloudVpnGateway#relation_cloud_rs_to_host_router_pol}
  */
  readonly relationCloudRsToHostRouterPol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_vpn_gateway#relation_cloud_rs_to_vpn_gw_pol CloudVpnGateway#relation_cloud_rs_to_vpn_gw_pol}
  */
  readonly relationCloudRsToVpnGwPol?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_vpn_gateway aci_cloud_vpn_gateway}
*/
export class CloudVpnGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudVpnGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_vpn_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_vpn_gateway aci_cloud_vpn_gateway} Resource
  *
  * @param scope The scope in which to define this construct
