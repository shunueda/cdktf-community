// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_external_epg_to_route_control_profile
...
export interface DataAciRelationFromExternalEpgToRouteControlProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_external_epg_to_route_control_profile#direction DataAciRelationFromExternalEpgToRouteControlProfile#direction}
  */
  readonly direction: string;
  /**
  * The distinguished name (DN) of the parent object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_external_epg_to_route_control_profile#parent_dn DataAciRelationFromExternalEpgToRouteControlProfile#parent_dn}
  */
  readonly parentDn: string;
  /**
  * The name of the Route Control Profile object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_external_epg_to_route_control_profile#route_control_profile_name DataAciRelationFromExternalEpgToRouteControlProfile#route_control_profile_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_external_epg_to_route_control_profile aci_relation_from_external_epg_to_route_control_profile}
*/
export class DataAciRelationFromExternalEpgToRouteControlProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciRelationFromExternalEpgToRouteControlProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_external_epg_to_route_control_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_external_epg_to_route_control_profile aci_relation_from_external_epg_to_route_control_profile} Data Source
  *
  * @param scope The scope in which to define this construct
