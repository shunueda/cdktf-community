// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_access_port_selector
...
export interface SpineAccessPortSelectorConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_access_port_selector#annotation SpineAccessPortSelector#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_access_port_selector#description SpineAccessPortSelector#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_access_port_selector#id SpineAccessPortSelector#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_access_port_selector#name SpineAccessPortSelector#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_access_port_selector#name_alias SpineAccessPortSelector#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Create relation to infra:SpAccGrp
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_access_port_selector#relation_infra_rs_sp_acc_grp SpineAccessPortSelector#relation_infra_rs_sp_acc_grp}
  */
  readonly relationInfraRsSpAccGrp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_access_port_selector#spine_access_port_selector_type SpineAccessPortSelector#spine_access_port_selector_type}
  */
  readonly spineAccessPortSelectorType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_access_port_selector#spine_interface_profile_dn SpineAccessPortSelector#spine_interface_profile_dn}
  */
  readonly spineInterfaceProfileDn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_access_port_selector aci_spine_access_port_selector}
*/
export class SpineAccessPortSelector extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpineAccessPortSelector that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_access_port_selector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_access_port_selector aci_spine_access_port_selector} Resource
  *
  * @param scope The scope in which to define this construct
