// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_device_context
...
export interface LogicalDeviceContextConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_device_context#annotation LogicalDeviceContext#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_device_context#context LogicalDeviceContext#context}
  */
  readonly context?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_device_context#ctrct_name_or_lbl LogicalDeviceContext#ctrct_name_or_lbl}
  */
  readonly ctrctNameOrLbl: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_device_context#description LogicalDeviceContext#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_device_context#graph_name_or_lbl LogicalDeviceContext#graph_name_or_lbl}
  */
  readonly graphNameOrLbl: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_device_context#id LogicalDeviceContext#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_device_context#name_alias LogicalDeviceContext#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_device_context#node_name_or_lbl LogicalDeviceContext#node_name_or_lbl}
  */
  readonly nodeNameOrLbl: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_device_context#relation_vns_rs_l_dev_ctx_to_l_dev LogicalDeviceContext#relation_vns_rs_l_dev_ctx_to_l_dev}
  */
  readonly relationVnsRsLDevCtxToLDev: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_device_context#relation_vns_rs_l_dev_ctx_to_rtr_cfg LogicalDeviceContext#relation_vns_rs_l_dev_ctx_to_rtr_cfg}
  */
  readonly relationVnsRsLDevCtxToRtrCfg?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_device_context#tenant_dn LogicalDeviceContext#tenant_dn}
  */
  readonly tenantDn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_device_context aci_logical_device_context}
*/
export class LogicalDeviceContext extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogicalDeviceContext that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_device_context#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_device_context aci_logical_device_context} Resource
  *
  * @param scope The scope in which to define this construct
