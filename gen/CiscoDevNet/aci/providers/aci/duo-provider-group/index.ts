// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/duo_provider_group
...
export interface DuoProviderGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/duo_provider_group#annotation DuoProviderGroup#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/duo_provider_group#auth_choice DuoProviderGroup#auth_choice}
  */
  readonly authChoice?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/duo_provider_group#description DuoProviderGroup#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/duo_provider_group#id DuoProviderGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/duo_provider_group#ldap_group_map_ref DuoProviderGroup#ldap_group_map_ref}
  */
  readonly ldapGroupMapRef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/duo_provider_group#name DuoProviderGroup#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/duo_provider_group#name_alias DuoProviderGroup#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/duo_provider_group#provider_type DuoProviderGroup#provider_type}
  */
  readonly providerType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/duo_provider_group#sec_fac_auth_methods DuoProviderGroup#sec_fac_auth_methods}
  */
  readonly secFacAuthMethods?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/duo_provider_group aci_duo_provider_group}
*/
export class DuoProviderGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DuoProviderGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/duo_provider_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/duo_provider_group aci_duo_provider_group} Resource
  *
  * @param scope The scope in which to define this construct
