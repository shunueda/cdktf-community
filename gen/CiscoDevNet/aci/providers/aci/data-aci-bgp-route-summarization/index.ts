// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_route_summarization
...
export interface DataAciBgpRouteSummarizationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_route_summarization#address_type_controls DataAciBgpRouteSummarization#address_type_controls}
  */
  readonly addressTypeControls?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_route_summarization#annotation DataAciBgpRouteSummarization#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_route_summarization#attrmap DataAciBgpRouteSummarization#attrmap}
  */
  readonly attrmap?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_route_summarization#ctrl DataAciBgpRouteSummarization#ctrl}
  */
  readonly ctrl?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_route_summarization#description DataAciBgpRouteSummarization#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_route_summarization#id DataAciBgpRouteSummarization#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_route_summarization#name DataAciBgpRouteSummarization#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_route_summarization#name_alias DataAciBgpRouteSummarization#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_route_summarization#tenant_dn DataAciBgpRouteSummarization#tenant_dn}
  */
  readonly tenantDn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_route_summarization aci_bgp_route_summarization}
*/
export class DataAciBgpRouteSummarization extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciBgpRouteSummarization that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_route_summarization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/bgp_route_summarization aci_bgp_route_summarization} Data Source
  *
  * @param scope The scope in which to define this construct
