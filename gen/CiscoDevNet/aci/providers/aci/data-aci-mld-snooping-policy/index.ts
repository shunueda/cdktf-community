// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mld_snooping_policy
...
export interface DataAciMldSnoopingPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mld_snooping_policy#name DataAciMldSnoopingPolicy#name}
  */
  readonly name: string;
  /**
  * The distinguished name (DN) of the parent object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mld_snooping_policy#parent_dn DataAciMldSnoopingPolicy#parent_dn}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mld_snooping_policy aci_mld_snooping_policy}
*/
export class DataAciMldSnoopingPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciMldSnoopingPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mld_snooping_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mld_snooping_policy aci_mld_snooping_policy} Data Source
  *
  * @param scope The scope in which to define this construct
