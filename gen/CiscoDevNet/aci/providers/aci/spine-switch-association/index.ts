// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_switch_association
...
export interface SpineSwitchAssociationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_switch_association#annotation SpineSwitchAssociation#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_switch_association#description SpineSwitchAssociation#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_switch_association#id SpineSwitchAssociation#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_switch_association#name SpineSwitchAssociation#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_switch_association#name_alias SpineSwitchAssociation#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_switch_association#relation_infra_rs_spine_acc_node_p_grp SpineSwitchAssociation#relation_infra_rs_spine_acc_node_p_grp}
  */
  readonly relationInfraRsSpineAccNodePGrp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_switch_association#spine_profile_dn SpineSwitchAssociation#spine_profile_dn}
  */
  readonly spineProfileDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_switch_association#spine_switch_association_type SpineSwitchAssociation#spine_switch_association_type}
  */
  readonly spineSwitchAssociationType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_switch_association aci_spine_switch_association}
*/
export class SpineSwitchAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpineSwitchAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_switch_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/spine_switch_association aci_spine_switch_association} Resource
  *
  * @param scope The scope in which to define this construct
