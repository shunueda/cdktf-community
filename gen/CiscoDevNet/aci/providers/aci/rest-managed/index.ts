// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/rest_managed
...
export interface RestManagedConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/rest_managed#annotation RestManaged#annotation}
  */
  readonly annotation?: string;
  /**
  * Which class object is being created, eg. fvTenant. (Make sure there is no colon in the classname)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/rest_managed#class_name RestManaged#class_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/rest_managed#content RestManaged#content}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/rest_managed#dn RestManaged#dn}
  */
  readonly dn: string;
  /**
  * Enable escaping of HTML characters when encoding the JSON payload.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/rest_managed#escape_html RestManaged#escape_html}
  */
  readonly escapeHtml?: boolean | cdktf.IResolvable;
  /**
  * child block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/rest_managed#child RestManaged#child}
  */
...
export interface RestManagedChild {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/rest_managed#rn RestManaged#rn}
  */
  readonly rn: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/rest_managed aci_rest_managed}
*/
export class RestManaged extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RestManaged that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/rest_managed#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/rest_managed aci_rest_managed} Resource
  *
  * @param scope The scope in which to define this construct
