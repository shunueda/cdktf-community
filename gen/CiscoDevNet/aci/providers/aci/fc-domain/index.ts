// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fc_domain
...
export interface FcDomainConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fc_domain#annotation FcDomain#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fc_domain#id FcDomain#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fc_domain#name FcDomain#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fc_domain#name_alias FcDomain#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fc_domain#relation_fc_rs_vsan_attr FcDomain#relation_fc_rs_vsan_attr}
  */
  readonly relationFcRsVsanAttr?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fc_domain#relation_fc_rs_vsan_attr_def FcDomain#relation_fc_rs_vsan_attr_def}
  */
  readonly relationFcRsVsanAttrDef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fc_domain#relation_fc_rs_vsan_ns FcDomain#relation_fc_rs_vsan_ns}
  */
  readonly relationFcRsVsanNs?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fc_domain#relation_fc_rs_vsan_ns_def FcDomain#relation_fc_rs_vsan_ns_def}
  */
  readonly relationFcRsVsanNsDef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fc_domain#relation_infra_rs_dom_vxlan_ns_def FcDomain#relation_infra_rs_dom_vxlan_ns_def}
  */
  readonly relationInfraRsDomVxlanNsDef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fc_domain#relation_infra_rs_vip_addr_ns FcDomain#relation_infra_rs_vip_addr_ns}
  */
  readonly relationInfraRsVipAddrNs?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fc_domain#relation_infra_rs_vlan_ns FcDomain#relation_infra_rs_vlan_ns}
  */
  readonly relationInfraRsVlanNs?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fc_domain#relation_infra_rs_vlan_ns_def FcDomain#relation_infra_rs_vlan_ns_def}
  */
  readonly relationInfraRsVlanNsDef?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fc_domain aci_fc_domain}
*/
export class FcDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FcDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fc_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fc_domain aci_fc_domain} Resource
  *
  * @param scope The scope in which to define this construct
