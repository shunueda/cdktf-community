// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fex_bundle_group
...
export interface FexBundleGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fex_bundle_group#annotation FexBundleGroup#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fex_bundle_group#description FexBundleGroup#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fex_bundle_group#fex_profile_dn FexBundleGroup#fex_profile_dn}
  */
  readonly fexProfileDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fex_bundle_group#id FexBundleGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fex_bundle_group#name FexBundleGroup#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fex_bundle_group#name_alias FexBundleGroup#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fex_bundle_group#relation_infra_rs_fex_bndl_grp_to_aggr_if FexBundleGroup#relation_infra_rs_fex_bndl_grp_to_aggr_if}
  */
  readonly relationInfraRsFexBndlGrpToAggrIf?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fex_bundle_group#relation_infra_rs_mon_fex_infra_pol FexBundleGroup#relation_infra_rs_mon_fex_infra_pol}
  */
  readonly relationInfraRsMonFexInfraPol?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fex_bundle_group aci_fex_bundle_group}
*/
export class FexBundleGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FexBundleGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fex_bundle_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/fex_bundle_group aci_fex_bundle_group} Resource
  *
  * @param scope The scope in which to define this construct
