// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_to_vrf_fallback_route_group
...
export interface DataAciRelationToVrfFallbackRouteGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_to_vrf_fallback_route_group#parent_dn DataAciRelationToVrfFallbackRouteGroup#parent_dn}
  */
  readonly parentDn: string;
  /**
  * The distinguished name of the VRF Fallback Route Group object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_to_vrf_fallback_route_group#target_dn DataAciRelationToVrfFallbackRouteGroup#target_dn}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_to_vrf_fallback_route_group aci_relation_to_vrf_fallback_route_group}
*/
export class DataAciRelationToVrfFallbackRouteGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciRelationToVrfFallbackRouteGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_to_vrf_fallback_route_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_to_vrf_fallback_route_group aci_relation_to_vrf_fallback_route_group} Data Source
  *
  * @param scope The scope in which to define this construct
