// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/neighbor_discovery_interface_policy
...
export interface DataAciNeighborDiscoveryInterfacePolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/neighbor_discovery_interface_policy#name DataAciNeighborDiscoveryInterfacePolicy#name}
  */
  readonly name: string;
  /**
  * The distinguished name (DN) of the parent object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/neighbor_discovery_interface_policy#parent_dn DataAciNeighborDiscoveryInterfacePolicy#parent_dn}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/neighbor_discovery_interface_policy aci_neighbor_discovery_interface_policy}
*/
export class DataAciNeighborDiscoveryInterfacePolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciNeighborDiscoveryInterfacePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/neighbor_discovery_interface_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/neighbor_discovery_interface_policy aci_neighbor_discovery_interface_policy} Data Source
  *
  * @param scope The scope in which to define this construct
