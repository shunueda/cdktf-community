// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/encryption_key
...
export interface EncryptionKeyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/encryption_key#annotation EncryptionKey#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/encryption_key#clear_encryption_key EncryptionKey#clear_encryption_key}
  */
  readonly clearEncryptionKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/encryption_key#description EncryptionKey#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/encryption_key#id EncryptionKey#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/encryption_key#name_alias EncryptionKey#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/encryption_key#passphrase EncryptionKey#passphrase}
  */
  readonly passphrase?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/encryption_key#passphrase_key_derivation_version EncryptionKey#passphrase_key_derivation_version}
  */
  readonly passphraseKeyDerivationVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/encryption_key#strong_encryption_enabled EncryptionKey#strong_encryption_enabled}
  */
  readonly strongEncryptionEnabled?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/encryption_key aci_encryption_key}
*/
export class EncryptionKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EncryptionKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/encryption_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/encryption_key aci_encryption_key} Resource
  *
  * @param scope The scope in which to define this construct
