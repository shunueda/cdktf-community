// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pim_route_map_entry
...
export interface DataAciPimRouteMapEntryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pim_route_map_entry#order DataAciPimRouteMapEntry#order}
  */
  readonly order: string;
  /**
  * The distinguished name (DN) of the parent object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pim_route_map_entry#parent_dn DataAciPimRouteMapEntry#parent_dn}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pim_route_map_entry aci_pim_route_map_entry}
*/
export class DataAciPimRouteMapEntry extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciPimRouteMapEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pim_route_map_entry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/pim_route_map_entry aci_pim_route_map_entry} Data Source
  *
  * @param scope The scope in which to define this construct
