// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/external_management_network_instance_profile
...
export interface DataAciExternalManagementNetworkInstanceProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/external_management_network_instance_profile#name DataAciExternalManagementNetworkInstanceProfile#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/external_management_network_instance_profile aci_external_management_network_instance_profile}
*/
export class DataAciExternalManagementNetworkInstanceProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciExternalManagementNetworkInstanceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/external_management_network_instance_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/external_management_network_instance_profile aci_external_management_network_instance_profile} Data Source
  *
  * @param scope The scope in which to define this construct
