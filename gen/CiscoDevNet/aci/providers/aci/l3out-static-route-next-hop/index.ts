// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_static_route_next_hop
...
export interface L3OutStaticRouteNextHopConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_static_route_next_hop#annotation L3OutStaticRouteNextHop#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_static_route_next_hop#description L3OutStaticRouteNextHop#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_static_route_next_hop#id L3OutStaticRouteNextHop#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_static_route_next_hop#name_alias L3OutStaticRouteNextHop#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_static_route_next_hop#nexthop_profile_type L3OutStaticRouteNextHop#nexthop_profile_type}
  */
  readonly nexthopProfileType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_static_route_next_hop#nh_addr L3OutStaticRouteNextHop#nh_addr}
  */
  readonly nhAddr: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_static_route_next_hop#pref L3OutStaticRouteNextHop#pref}
  */
  readonly pref?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_static_route_next_hop#relation_ip_rs_nexthop_route_track L3OutStaticRouteNextHop#relation_ip_rs_nexthop_route_track}
  */
  readonly relationIpRsNexthopRouteTrack?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_static_route_next_hop#relation_ip_rs_nh_track_member L3OutStaticRouteNextHop#relation_ip_rs_nh_track_member}
  */
  readonly relationIpRsNhTrackMember?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_static_route_next_hop#static_route_dn L3OutStaticRouteNextHop#static_route_dn}
  */
  readonly staticRouteDn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_static_route_next_hop aci_l3out_static_route_next_hop}
*/
export class L3OutStaticRouteNextHop extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing L3OutStaticRouteNextHop that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_static_route_next_hop#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_static_route_next_hop aci_l3out_static_route_next_hop} Resource
  *
  * @param scope The scope in which to define this construct
