// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/epg_useg_ad_group_attribute
...
export interface DataAciEpgUsegAdGroupAttributeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/epg_useg_ad_group_attribute#parent_dn DataAciEpgUsegAdGroupAttribute#parent_dn}
  */
  readonly parentDn: string;
  /**
  * The selector of the EPG uSeg AD Group Attribute object. Represents the DN or expression to select an identity group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/epg_useg_ad_group_attribute#selector DataAciEpgUsegAdGroupAttribute#selector}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/epg_useg_ad_group_attribute aci_epg_useg_ad_group_attribute}
*/
export class DataAciEpgUsegAdGroupAttribute extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciEpgUsegAdGroupAttribute that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/epg_useg_ad_group_attribute#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/epg_useg_ad_group_attribute aci_epg_useg_ad_group_attribute} Data Source
  *
  * @param scope The scope in which to define this construct
