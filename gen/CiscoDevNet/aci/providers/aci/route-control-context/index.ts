// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/route_control_context
...
export interface RouteControlContextConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/route_control_context#action RouteControlContext#action}
  */
  readonly action?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/route_control_context#annotation RouteControlContext#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/route_control_context#description RouteControlContext#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/route_control_context#id RouteControlContext#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/route_control_context#name RouteControlContext#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/route_control_context#name_alias RouteControlContext#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/route_control_context#order RouteControlContext#order}
  */
  readonly order?: string;
  /**
  * Create relation to rtctrl:SubjP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/route_control_context#relation_rtctrl_rs_ctx_p_to_subj_p RouteControlContext#relation_rtctrl_rs_ctx_p_to_subj_p}
  */
  readonly relationRtctrlRsCtxPToSubjP?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/route_control_context#route_control_profile_dn RouteControlContext#route_control_profile_dn}
  */
  readonly routeControlProfileDn: string;
  /**
  * Create relation to rtctrl:AttrP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/route_control_context#set_rule RouteControlContext#set_rule}
  */
  readonly setRule?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/route_control_context aci_route_control_context}
*/
export class RouteControlContext extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RouteControlContext that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/route_control_context#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/route_control_context aci_route_control_context} Resource
  *
  * @param scope The scope in which to define this construct
