// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/dot1p_classifier
...
export interface DataAciDot1PClassifierConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/dot1p_classifier#from DataAciDot1PClassifier#from}
  */
  readonly from: string;
  /**
  * The distinguished name (DN) of the parent object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/dot1p_classifier#parent_dn DataAciDot1PClassifier#parent_dn}
  */
  readonly parentDn: string;
  /**
  * The Dot1p priority range ending value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/dot1p_classifier#to DataAciDot1PClassifier#to}
  */
  readonly to: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/dot1p_classifier aci_dot1p_classifier}
*/
export class DataAciDot1PClassifier extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciDot1PClassifier that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/dot1p_classifier#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/dot1p_classifier aci_dot1p_classifier} Data Source
  *
  * @param scope The scope in which to define this construct
