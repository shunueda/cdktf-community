// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/mgmt_zone
...
export interface MgmtZoneConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/mgmt_zone#annotation MgmtZone#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/mgmt_zone#description MgmtZone#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/mgmt_zone#id MgmtZone#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/mgmt_zone#managed_node_connectivity_group_dn MgmtZone#managed_node_connectivity_group_dn}
  */
  readonly managedNodeConnectivityGroupDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/mgmt_zone#name MgmtZone#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/mgmt_zone#name_alias MgmtZone#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Create relation to fvns:AddrInst
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/mgmt_zone#relation_mgmt_rs_addr_inst MgmtZone#relation_mgmt_rs_addr_inst}
  */
  readonly relationMgmtRsAddrInst?: string;
  /**
  * Create relation to mgmt:InB
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/mgmt_zone#relation_mgmt_rs_in_b MgmtZone#relation_mgmt_rs_in_b}
  */
  readonly relationMgmtRsInB?: string;
  /**
  * Create relation to mgmt:InB
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/mgmt_zone#relation_mgmt_rs_inb_epg MgmtZone#relation_mgmt_rs_inb_epg}
  */
  readonly relationMgmtRsInbEpg?: string;
  /**
  * Create relation to mgmt:OoB
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/mgmt_zone#relation_mgmt_rs_oo_b MgmtZone#relation_mgmt_rs_oo_b}
  */
  readonly relationMgmtRsOoB?: string;
  /**
  * Create relation to mgmt:OoB
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/mgmt_zone#relation_mgmt_rs_oob_epg MgmtZone#relation_mgmt_rs_oob_epg}
  */
  readonly relationMgmtRsOobEpg?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/mgmt_zone#type MgmtZone#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/mgmt_zone aci_mgmt_zone}
*/
export class MgmtZone extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MgmtZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/mgmt_zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/mgmt_zone aci_mgmt_zone} Resource
  *
  * @param scope The scope in which to define this construct
