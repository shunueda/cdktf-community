// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l2_outside
...
export interface L2OutsideConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l2_outside#annotation L2Outside#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l2_outside#description L2Outside#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l2_outside#id L2Outside#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l2_outside#name L2Outside#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l2_outside#name_alias L2Outside#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l2_outside#relation_l2ext_rs_e_bd L2Outside#relation_l2ext_rs_e_bd}
  */
  readonly relationL2ExtRsEBd?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l2_outside#relation_l2ext_rs_l2_dom_att L2Outside#relation_l2ext_rs_l2_dom_att}
  */
  readonly relationL2ExtRsL2DomAtt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l2_outside#target_dscp L2Outside#target_dscp}
  */
  readonly targetDscp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l2_outside#tenant_dn L2Outside#tenant_dn}
  */
  readonly tenantDn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l2_outside aci_l2_outside}
*/
export class L2Outside extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing L2Outside that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l2_outside#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l2_outside aci_l2_outside} Resource
  *
  * @param scope The scope in which to define this construct
