// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/system
...
export interface DataAciSystemConfig extends cdktf.TerraformMetaArguments {
  ...
  * POD Identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/system#pod_id DataAciSystem#pod_id}
  */
  readonly podId: string;
  /**
  * The identifier of the System object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/system#system_id DataAciSystem#system_id}
  */
  readonly systemId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/system aci_system}
*/
export class DataAciSystem extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/system#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/system aci_system} Data Source
  *
  * @param scope The scope in which to define this construct
