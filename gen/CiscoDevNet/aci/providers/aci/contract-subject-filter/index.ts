// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/contract_subject_filter
...
export interface ContractSubjectFilterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/contract_subject_filter#action ContractSubjectFilter#action}
  */
  readonly action?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/contract_subject_filter#annotation ContractSubjectFilter#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/contract_subject_filter#contract_subject_dn ContractSubjectFilter#contract_subject_dn}
  */
  readonly contractSubjectDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/contract_subject_filter#description ContractSubjectFilter#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/contract_subject_filter#directives ContractSubjectFilter#directives}
  */
  readonly directives?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/contract_subject_filter#filter_dn ContractSubjectFilter#filter_dn}
  */
  readonly filterDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/contract_subject_filter#id ContractSubjectFilter#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/contract_subject_filter#priority_override ContractSubjectFilter#priority_override}
  */
  readonly priorityOverride?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/contract_subject_filter aci_contract_subject_filter}
*/
export class ContractSubjectFilter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContractSubjectFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/contract_subject_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/contract_subject_filter aci_contract_subject_filter} Resource
  *
  * @param scope The scope in which to define this construct
