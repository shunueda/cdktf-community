// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/eigrp_address_family_context
...
export interface DataAciEigrpAddressFamilyContextConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/eigrp_address_family_context#name DataAciEigrpAddressFamilyContext#name}
  */
  readonly name: string;
  /**
  * The distinguished name (DN) of the parent object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/eigrp_address_family_context#parent_dn DataAciEigrpAddressFamilyContext#parent_dn}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/eigrp_address_family_context aci_eigrp_address_family_context}
*/
export class DataAciEigrpAddressFamilyContext extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciEigrpAddressFamilyContext that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/eigrp_address_family_context#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/eigrp_address_family_context aci_eigrp_address_family_context} Data Source
  *
  * @param scope The scope in which to define this construct
