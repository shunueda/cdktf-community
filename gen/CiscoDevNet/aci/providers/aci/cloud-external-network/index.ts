// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_network
...
export interface CloudExternalNetworkConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_network#all_regions CloudExternalNetwork#all_regions}
  */
  readonly allRegions?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_network#annotation CloudExternalNetwork#annotation}
  */
  readonly annotation?: string;
  /**
  * Name of the vendor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_network#cloud_vendor CloudExternalNetwork#cloud_vendor}
  */
  readonly cloudVendor?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_network#description CloudExternalNetwork#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_network#host_router_name CloudExternalNetwork#host_router_name}
  */
  readonly hostRouterName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_network#hub_network_name CloudExternalNetwork#hub_network_name}
  */
  readonly hubNetworkName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_network#id CloudExternalNetwork#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_network#name CloudExternalNetwork#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_network#name_alias CloudExternalNetwork#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_network#regions CloudExternalNetwork#regions}
  */
  readonly regions?: string[];
  /**
  * Parameter used only for AWS cAPIC
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_network#router_type CloudExternalNetwork#router_type}
  */
  readonly routerType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_network#vpn_router_name CloudExternalNetwork#vpn_router_name}
  */
  readonly vpnRouterName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_network#vrf_dn CloudExternalNetwork#vrf_dn}
  */
  readonly vrfDn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_network aci_cloud_external_network}
*/
export class CloudExternalNetwork extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudExternalNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_network aci_cloud_external_network} Resource
  *
  * @param scope The scope in which to define this construct
