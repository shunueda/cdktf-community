// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bfd_interface_profile
...
export interface L3OutBfdInterfaceProfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bfd_interface_profile#annotation L3OutBfdInterfaceProfile#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bfd_interface_profile#description L3OutBfdInterfaceProfile#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bfd_interface_profile#id L3OutBfdInterfaceProfile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bfd_interface_profile#interface_profile_type L3OutBfdInterfaceProfile#interface_profile_type}
  */
  readonly interfaceProfileType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bfd_interface_profile#key L3OutBfdInterfaceProfile#key}
  */
  readonly key?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bfd_interface_profile#key_id L3OutBfdInterfaceProfile#key_id}
  */
  readonly keyId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bfd_interface_profile#logical_interface_profile_dn L3OutBfdInterfaceProfile#logical_interface_profile_dn}
  */
  readonly logicalInterfaceProfileDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bfd_interface_profile#name_alias L3OutBfdInterfaceProfile#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bfd_interface_profile#relation_bfd_rs_if_pol L3OutBfdInterfaceProfile#relation_bfd_rs_if_pol}
  */
  readonly relationBfdRsIfPol?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bfd_interface_profile aci_l3out_bfd_interface_profile}
*/
export class L3OutBfdInterfaceProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing L3OutBfdInterfaceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bfd_interface_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_bfd_interface_profile aci_l3out_bfd_interface_profile} Resource
  *
  * @param scope The scope in which to define this construct
