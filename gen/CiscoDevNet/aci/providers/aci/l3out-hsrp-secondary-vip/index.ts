// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_hsrp_secondary_vip
...
export interface L3OutHsrpSecondaryVipConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_hsrp_secondary_vip#annotation L3OutHsrpSecondaryVip#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_hsrp_secondary_vip#config_issues L3OutHsrpSecondaryVip#config_issues}
  */
  readonly configIssues?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_hsrp_secondary_vip#description L3OutHsrpSecondaryVip#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_hsrp_secondary_vip#id L3OutHsrpSecondaryVip#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_hsrp_secondary_vip#ip L3OutHsrpSecondaryVip#ip}
  */
  readonly ip: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_hsrp_secondary_vip#l3out_hsrp_interface_group_dn L3OutHsrpSecondaryVip#l3out_hsrp_interface_group_dn}
  */
  readonly l3OutHsrpInterfaceGroupDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_hsrp_secondary_vip#name_alias L3OutHsrpSecondaryVip#name_alias}
  */
  readonly nameAlias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_hsrp_secondary_vip aci_l3out_hsrp_secondary_vip}
*/
export class L3OutHsrpSecondaryVip extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing L3OutHsrpSecondaryVip that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_hsrp_secondary_vip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/l3out_hsrp_secondary_vip aci_l3out_hsrp_secondary_vip} Resource
  *
  * @param scope The scope in which to define this construct
