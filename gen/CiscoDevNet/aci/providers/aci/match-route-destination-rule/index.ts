// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/match_route_destination_rule
...
export interface MatchRouteDestinationRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/match_route_destination_rule#aggregate MatchRouteDestinationRule#aggregate}
  */
  readonly aggregate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/match_route_destination_rule#annotation MatchRouteDestinationRule#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/match_route_destination_rule#description MatchRouteDestinationRule#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/match_route_destination_rule#greater_than_mask MatchRouteDestinationRule#greater_than_mask}
  */
  readonly greaterThanMask?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/match_route_destination_rule#id MatchRouteDestinationRule#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/match_route_destination_rule#ip MatchRouteDestinationRule#ip}
  */
  readonly ip: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/match_route_destination_rule#less_than_mask MatchRouteDestinationRule#less_than_mask}
  */
  readonly lessThanMask?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/match_route_destination_rule#match_rule_dn MatchRouteDestinationRule#match_rule_dn}
  */
  readonly matchRuleDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/match_route_destination_rule#name MatchRouteDestinationRule#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/match_route_destination_rule#name_alias MatchRouteDestinationRule#name_alias}
  */
  readonly nameAlias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/match_route_destination_rule aci_match_route_destination_rule}
*/
export class MatchRouteDestinationRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MatchRouteDestinationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/match_route_destination_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/match_route_destination_rule aci_match_route_destination_rule} Resource
  *
  * @param scope The scope in which to define this construct
