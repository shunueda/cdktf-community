// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_bridge_domain_to_netflow_monitor_policy
...
export interface DataAciRelationFromBridgeDomainToNetflowMonitorPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_bridge_domain_to_netflow_monitor_policy#filter_type DataAciRelationFromBridgeDomainToNetflowMonitorPolicy#filter_type}
  */
  readonly filterType: string;
  /**
  * The name of the NetFlow Monitor Policy object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_bridge_domain_to_netflow_monitor_policy#netflow_monitor_policy_name DataAciRelationFromBridgeDomainToNetflowMonitorPolicy#netflow_monitor_policy_name}
  */
  readonly netflowMonitorPolicyName: string;
  /**
  * The distinguished name (DN) of the parent object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_bridge_domain_to_netflow_monitor_policy#parent_dn DataAciRelationFromBridgeDomainToNetflowMonitorPolicy#parent_dn}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_bridge_domain_to_netflow_monitor_policy aci_relation_from_bridge_domain_to_netflow_monitor_policy}
*/
export class DataAciRelationFromBridgeDomainToNetflowMonitorPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciRelationFromBridgeDomainToNetflowMonitorPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_bridge_domain_to_netflow_monitor_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/relation_from_bridge_domain_to_netflow_monitor_policy aci_relation_from_bridge_domain_to_netflow_monitor_policy} Data Source
  *
  * @param scope The scope in which to define this construct
