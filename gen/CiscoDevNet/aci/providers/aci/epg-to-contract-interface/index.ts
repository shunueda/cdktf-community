// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/epg_to_contract_interface
...
export interface EpgToContractInterfaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/epg_to_contract_interface#annotation EpgToContractInterface#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/epg_to_contract_interface#application_epg_dn EpgToContractInterface#application_epg_dn}
  */
  readonly applicationEpgDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/epg_to_contract_interface#contract_interface_dn EpgToContractInterface#contract_interface_dn}
  */
  readonly contractInterfaceDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/epg_to_contract_interface#description EpgToContractInterface#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/epg_to_contract_interface#id EpgToContractInterface#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/epg_to_contract_interface#prio EpgToContractInterface#prio}
  */
  readonly prio?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/epg_to_contract_interface aci_epg_to_contract_interface}
*/
export class EpgToContractInterface extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EpgToContractInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/epg_to_contract_interface#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/epg_to_contract_interface aci_epg_to_contract_interface} Resource
  *
  * @param scope The scope in which to define this construct
