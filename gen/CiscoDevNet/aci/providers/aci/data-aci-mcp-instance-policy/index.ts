// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mcp_instance_policy
...
export interface DataAciMcpInstancePolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mcp_instance_policy#admin_st DataAciMcpInstancePolicy#admin_st}
  */
  readonly adminSt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mcp_instance_policy#annotation DataAciMcpInstancePolicy#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mcp_instance_policy#ctrl DataAciMcpInstancePolicy#ctrl}
  */
  readonly ctrl?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mcp_instance_policy#description DataAciMcpInstancePolicy#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mcp_instance_policy#id DataAciMcpInstancePolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mcp_instance_policy#init_delay_time DataAciMcpInstancePolicy#init_delay_time}
  */
  readonly initDelayTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mcp_instance_policy#key DataAciMcpInstancePolicy#key}
  */
  readonly key?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mcp_instance_policy#loop_detect_mult DataAciMcpInstancePolicy#loop_detect_mult}
  */
  readonly loopDetectMult?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mcp_instance_policy#loop_protect_act DataAciMcpInstancePolicy#loop_protect_act}
  */
  readonly loopProtectAct?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mcp_instance_policy#name_alias DataAciMcpInstancePolicy#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mcp_instance_policy#tx_freq DataAciMcpInstancePolicy#tx_freq}
  */
  readonly txFreq?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mcp_instance_policy#tx_freq_msec DataAciMcpInstancePolicy#tx_freq_msec}
  */
  readonly txFreqMsec?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mcp_instance_policy aci_mcp_instance_policy}
*/
export class DataAciMcpInstancePolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciMcpInstancePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mcp_instance_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/mcp_instance_policy aci_mcp_instance_policy} Data Source
  *
  * @param scope The scope in which to define this construct
