// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/data_plane_policing_policy
...
export interface DataAciDataPlanePolicingPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/data_plane_policing_policy#name DataAciDataPlanePolicingPolicy#name}
  */
  readonly name: string;
  /**
  * The distinguished name (DN) of the parent object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/data_plane_policing_policy#parent_dn DataAciDataPlanePolicingPolicy#parent_dn}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/data_plane_policing_policy aci_data_plane_policing_policy}
*/
export class DataAciDataPlanePolicingPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciDataPlanePolicingPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/data_plane_policing_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/data_plane_policing_policy aci_data_plane_policing_policy} Data Source
  *
  * @param scope The scope in which to define this construct
