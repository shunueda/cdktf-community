// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/interface_fc_policy
...
export interface InterfaceFcPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/interface_fc_policy#annotation InterfaceFcPolicy#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/interface_fc_policy#automaxspeed InterfaceFcPolicy#automaxspeed}
  */
  readonly automaxspeed?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/interface_fc_policy#description InterfaceFcPolicy#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/interface_fc_policy#fill_pattern InterfaceFcPolicy#fill_pattern}
  */
  readonly fillPattern?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/interface_fc_policy#id InterfaceFcPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/interface_fc_policy#name InterfaceFcPolicy#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/interface_fc_policy#name_alias InterfaceFcPolicy#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/interface_fc_policy#port_mode InterfaceFcPolicy#port_mode}
  */
  readonly portMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/interface_fc_policy#rx_bb_credit InterfaceFcPolicy#rx_bb_credit}
  */
  readonly rxBbCredit?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/interface_fc_policy#speed InterfaceFcPolicy#speed}
  */
  readonly speed?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/interface_fc_policy#trunk_mode InterfaceFcPolicy#trunk_mode}
  */
  readonly trunkMode?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/interface_fc_policy aci_interface_fc_policy}
*/
export class InterfaceFcPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterfaceFcPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/interface_fc_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/interface_fc_policy aci_interface_fc_policy} Resource
  *
  * @param scope The scope in which to define this construct
