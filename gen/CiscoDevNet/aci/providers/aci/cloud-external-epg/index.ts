// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg
...
export interface CloudExternalEpgConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#annotation CloudExternalEpg#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#cloud_applicationcontainer_dn CloudExternalEpg#cloud_applicationcontainer_dn}
  */
  readonly cloudApplicationcontainerDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#description CloudExternalEpg#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#exception_tag CloudExternalEpg#exception_tag}
  */
  readonly exceptionTag?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#flood_on_encap CloudExternalEpg#flood_on_encap}
  */
  readonly floodOnEncap?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#id CloudExternalEpg#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#match_t CloudExternalEpg#match_t}
  */
  readonly matchT?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#name CloudExternalEpg#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#name_alias CloudExternalEpg#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#pref_gr_memb CloudExternalEpg#pref_gr_memb}
  */
  readonly prefGrMemb?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#prio CloudExternalEpg#prio}
  */
  readonly prio?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#relation_cloud_rs_cloud_epg_ctx CloudExternalEpg#relation_cloud_rs_cloud_epg_ctx}
  */
  readonly relationCloudRsCloudEpgCtx?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#relation_fv_rs_cons CloudExternalEpg#relation_fv_rs_cons}
  */
  readonly relationFvRsCons?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#relation_fv_rs_cons_if CloudExternalEpg#relation_fv_rs_cons_if}
  */
  readonly relationFvRsConsIf?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#relation_fv_rs_cust_qos_pol CloudExternalEpg#relation_fv_rs_cust_qos_pol}
  */
  readonly relationFvRsCustQosPol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#relation_fv_rs_intra_epg CloudExternalEpg#relation_fv_rs_intra_epg}
  */
  readonly relationFvRsIntraEpg?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#relation_fv_rs_prot_by CloudExternalEpg#relation_fv_rs_prot_by}
  */
  readonly relationFvRsProtBy?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#relation_fv_rs_prov CloudExternalEpg#relation_fv_rs_prov}
  */
  readonly relationFvRsProv?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#relation_fv_rs_sec_inherited CloudExternalEpg#relation_fv_rs_sec_inherited}
  */
  readonly relationFvRsSecInherited?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#route_reachability CloudExternalEpg#route_reachability}
  */
  readonly routeReachability?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg aci_cloud_external_epg}
*/
export class CloudExternalEpg extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "aci_cloud_external_epg";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a CloudExternalEpg resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the CloudExternalEpg to import
  * @param importFromId The id of the existing CloudExternalEpg that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the CloudExternalEpg to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "aci_cloud_external_epg", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/cloud_external_epg aci_cloud_external_epg} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options CloudExternalEpgConfig
  */
  public constructor(scope: Construct, id: string, config: CloudExternalEpgConfig) {
    super(scope, id, {
      terraformResourceType: 'aci_cloud_external_epg',
    ...
    this._routeReachability = config.routeReachability;
  }
  ...
  // route_reachability - computed: true, optional: true, required: false
  private _routeReachability?: string; 
  public get routeReachability() {
    return this.getStringAttribute('route_reachability');
  }
  public set routeReachability(value: string) {
    this._routeReachability = value;
  }
  public resetRouteReachability() {
    this._routeReachability = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get routeReachabilityInput() {
    return this._routeReachability;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      route_reachability: cdktf.stringToTerraform(this._routeReachability),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      route_reachability: {
        value: cdktf.stringToHclTerraform(this._routeReachability),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
