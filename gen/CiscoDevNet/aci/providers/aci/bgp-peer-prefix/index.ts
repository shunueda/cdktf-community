// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bgp_peer_prefix
...
export interface BgpPeerPrefixConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bgp_peer_prefix#action BgpPeerPrefix#action}
  */
  readonly action?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bgp_peer_prefix#annotation BgpPeerPrefix#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bgp_peer_prefix#description BgpPeerPrefix#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bgp_peer_prefix#id BgpPeerPrefix#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bgp_peer_prefix#max_pfx BgpPeerPrefix#max_pfx}
  */
  readonly maxPfx?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bgp_peer_prefix#name BgpPeerPrefix#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bgp_peer_prefix#name_alias BgpPeerPrefix#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bgp_peer_prefix#restart_time BgpPeerPrefix#restart_time}
  */
  readonly restartTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bgp_peer_prefix#tenant_dn BgpPeerPrefix#tenant_dn}
  */
  readonly tenantDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bgp_peer_prefix#thresh BgpPeerPrefix#thresh}
  */
  readonly thresh?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bgp_peer_prefix aci_bgp_peer_prefix}
*/
export class BgpPeerPrefix extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BgpPeerPrefix that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bgp_peer_prefix#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bgp_peer_prefix aci_bgp_peer_prefix} Resource
  *
  * @param scope The scope in which to define this construct
