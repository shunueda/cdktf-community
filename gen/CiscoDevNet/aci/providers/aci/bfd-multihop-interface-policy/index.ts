// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_interface_policy
...
export interface BfdMultihopInterfacePolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_interface_policy#admin_state BfdMultihopInterfacePolicy#admin_state}
  */
  readonly adminState?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_interface_policy#annotation BfdMultihopInterfacePolicy#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_interface_policy#description BfdMultihopInterfacePolicy#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_interface_policy#detection_multiplier BfdMultihopInterfacePolicy#detection_multiplier}
  */
  readonly detectionMultiplier?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_interface_policy#id BfdMultihopInterfacePolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_interface_policy#min_receive_interval BfdMultihopInterfacePolicy#min_receive_interval}
  */
  readonly minReceiveInterval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_interface_policy#min_transmit_interval BfdMultihopInterfacePolicy#min_transmit_interval}
  */
  readonly minTransmitInterval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_interface_policy#name BfdMultihopInterfacePolicy#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_interface_policy#name_alias BfdMultihopInterfacePolicy#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_interface_policy#tenant_dn BfdMultihopInterfacePolicy#tenant_dn}
  */
  readonly tenantDn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_interface_policy aci_bfd_multihop_interface_policy}
*/
export class BfdMultihopInterfacePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BfdMultihopInterfacePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_interface_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/bfd_multihop_interface_policy aci_bfd_multihop_interface_policy} Resource
  *
  * @param scope The scope in which to define this construct
