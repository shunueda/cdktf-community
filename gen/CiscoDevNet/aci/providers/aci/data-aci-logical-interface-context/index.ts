// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/logical_interface_context
...
export interface DataAciLogicalInterfaceContextConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/logical_interface_context#annotation DataAciLogicalInterfaceContext#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/logical_interface_context#conn_name_or_lbl DataAciLogicalInterfaceContext#conn_name_or_lbl}
  */
  readonly connNameOrLbl: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/logical_interface_context#description DataAciLogicalInterfaceContext#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/logical_interface_context#id DataAciLogicalInterfaceContext#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/logical_interface_context#l3_dest DataAciLogicalInterfaceContext#l3_dest}
  */
  readonly l3Dest?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/logical_interface_context#logical_device_context_dn DataAciLogicalInterfaceContext#logical_device_context_dn}
  */
  readonly logicalDeviceContextDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/logical_interface_context#name_alias DataAciLogicalInterfaceContext#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/logical_interface_context#permit_log DataAciLogicalInterfaceContext#permit_log}
  */
  readonly permitLog?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/logical_interface_context aci_logical_interface_context}
*/
export class DataAciLogicalInterfaceContext extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciLogicalInterfaceContext that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/logical_interface_context#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/logical_interface_context aci_logical_interface_context} Data Source
  *
  * @param scope The scope in which to define this construct
