// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/isis_domain_policy
...
export interface IsisDomainPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/isis_domain_policy#annotation IsisDomainPolicy#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/isis_domain_policy#description IsisDomainPolicy#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/isis_domain_policy#id IsisDomainPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/isis_domain_policy#isis_level_name IsisDomainPolicy#isis_level_name}
  */
  readonly isisLevelName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/isis_domain_policy#isis_level_type IsisDomainPolicy#isis_level_type}
  */
  readonly isisLevelType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/isis_domain_policy#lsp_fast_flood IsisDomainPolicy#lsp_fast_flood}
  */
  readonly lspFastFlood?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/isis_domain_policy#lsp_gen_init_intvl IsisDomainPolicy#lsp_gen_init_intvl}
  */
  readonly lspGenInitIntvl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/isis_domain_policy#lsp_gen_max_intvl IsisDomainPolicy#lsp_gen_max_intvl}
  */
  readonly lspGenMaxIntvl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/isis_domain_policy#lsp_gen_sec_intvl IsisDomainPolicy#lsp_gen_sec_intvl}
  */
  readonly lspGenSecIntvl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/isis_domain_policy#mtu IsisDomainPolicy#mtu}
  */
  readonly mtu?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/isis_domain_policy#name_alias IsisDomainPolicy#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/isis_domain_policy#redistrib_metric IsisDomainPolicy#redistrib_metric}
  */
  readonly redistribMetric?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/isis_domain_policy#spf_comp_init_intvl IsisDomainPolicy#spf_comp_init_intvl}
  */
  readonly spfCompInitIntvl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/isis_domain_policy#spf_comp_max_intvl IsisDomainPolicy#spf_comp_max_intvl}
  */
  readonly spfCompMaxIntvl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/isis_domain_policy#spf_comp_sec_intvl IsisDomainPolicy#spf_comp_sec_intvl}
  */
  readonly spfCompSecIntvl?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/isis_domain_policy aci_isis_domain_policy}
*/
export class IsisDomainPolicy extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a IsisDomainPolicy resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the IsisDomainPolicy to import
  * @param importFromId The id of the existing IsisDomainPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/isis_domain_policy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the IsisDomainPolicy to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/isis_domain_policy aci_isis_domain_policy} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options IsisDomainPolicyConfig = {}
  */
  public constructor(scope: Construct, id: string, config: IsisDomainPolicyConfig = {}) {
    super(scope, id, {
  ...
  // isis_level_type - computed: false, optional: true, required: false
