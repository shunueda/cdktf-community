// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/ospf_interface_policy
...
export interface OspfInterfacePolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/ospf_interface_policy#annotation OspfInterfacePolicy#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/ospf_interface_policy#cost OspfInterfacePolicy#cost}
  */
  readonly cost?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/ospf_interface_policy#ctrl OspfInterfacePolicy#ctrl}
  */
  readonly ctrl?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/ospf_interface_policy#dead_intvl OspfInterfacePolicy#dead_intvl}
  */
  readonly deadIntvl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/ospf_interface_policy#description OspfInterfacePolicy#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/ospf_interface_policy#hello_intvl OspfInterfacePolicy#hello_intvl}
  */
  readonly helloIntvl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/ospf_interface_policy#id OspfInterfacePolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/ospf_interface_policy#name OspfInterfacePolicy#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/ospf_interface_policy#name_alias OspfInterfacePolicy#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/ospf_interface_policy#nw_t OspfInterfacePolicy#nw_t}
  */
  readonly nwT?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/ospf_interface_policy#pfx_suppress OspfInterfacePolicy#pfx_suppress}
  */
  readonly pfxSuppress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/ospf_interface_policy#prio OspfInterfacePolicy#prio}
  */
  readonly prio?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/ospf_interface_policy#rexmit_intvl OspfInterfacePolicy#rexmit_intvl}
  */
  readonly rexmitIntvl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/ospf_interface_policy#tenant_dn OspfInterfacePolicy#tenant_dn}
  */
  readonly tenantDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/ospf_interface_policy#xmit_delay OspfInterfacePolicy#xmit_delay}
  */
  readonly xmitDelay?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/ospf_interface_policy aci_ospf_interface_policy}
*/
export class OspfInterfacePolicy extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a OspfInterfacePolicy resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the OspfInterfacePolicy to import
  * @param importFromId The id of the existing OspfInterfacePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/ospf_interface_policy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the OspfInterfacePolicy to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/ospf_interface_policy aci_ospf_interface_policy} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options OspfInterfacePolicyConfig
  */
  public constructor(scope: Construct, id: string, config: OspfInterfacePolicyConfig) {
    super(scope, id, {
