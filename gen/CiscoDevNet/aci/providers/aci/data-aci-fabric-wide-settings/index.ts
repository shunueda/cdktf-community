// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings
...
export interface DataAciFabricWideSettingsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#annotation DataAciFabricWideSettings#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#description DataAciFabricWideSettings#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#disable_ep_dampening DataAciFabricWideSettings#disable_ep_dampening}
  */
  readonly disableEpDampening?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#domain_validation DataAciFabricWideSettings#domain_validation}
  */
  readonly domainValidation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#enable_mo_streaming DataAciFabricWideSettings#enable_mo_streaming}
  */
  readonly enableMoStreaming?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#enable_remote_leaf_direct DataAciFabricWideSettings#enable_remote_leaf_direct}
  */
  readonly enableRemoteLeafDirect?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#enforce_subnet_check DataAciFabricWideSettings#enforce_subnet_check}
  */
  readonly enforceSubnetCheck?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#id DataAciFabricWideSettings#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#leaf_opflexp_authenticate_clients DataAciFabricWideSettings#leaf_opflexp_authenticate_clients}
  */
  readonly leafOpflexpAuthenticateClients?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#leaf_opflexp_use_ssl DataAciFabricWideSettings#leaf_opflexp_use_ssl}
  */
  readonly leafOpflexpUseSsl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#name DataAciFabricWideSettings#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#name_alias DataAciFabricWideSettings#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#opflexp_authenticate_clients DataAciFabricWideSettings#opflexp_authenticate_clients}
  */
  readonly opflexpAuthenticateClients?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#opflexp_ssl_protocols DataAciFabricWideSettings#opflexp_ssl_protocols}
  */
  readonly opflexpSslProtocols?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#opflexp_use_ssl DataAciFabricWideSettings#opflexp_use_ssl}
  */
  readonly opflexpUseSsl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#policy_sync_node_bringup DataAciFabricWideSettings#policy_sync_node_bringup}
  */
  readonly policySyncNodeBringup?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#reallocate_gipo DataAciFabricWideSettings#reallocate_gipo}
  */
  readonly reallocateGipo?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#restrict_infra_vlan_traffic DataAciFabricWideSettings#restrict_infra_vlan_traffic}
  */
  readonly restrictInfraVlanTraffic?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#unicast_xr_ep_learn_disable DataAciFabricWideSettings#unicast_xr_ep_learn_disable}
  */
  readonly unicastXrEpLearnDisable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#validate_overlapping_vlans DataAciFabricWideSettings#validate_overlapping_vlans}
  */
  readonly validateOverlappingVlans?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings aci_fabric_wide_settings}
*/
export class DataAciFabricWideSettings extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataAciFabricWideSettings resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAciFabricWideSettings to import
  * @param importFromId The id of the existing DataAciFabricWideSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAciFabricWideSettings to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/fabric_wide_settings aci_fabric_wide_settings} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataAciFabricWideSettingsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataAciFabricWideSettingsConfig = {}) {
    super(scope, id, {
  ...
  public get opflexpSslProtocols() {
    return this.getStringAttribute('opflexp_ssl_protocols');
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      opflexp_ssl_protocols: cdktf.stringToTerraform(this._opflexpSslProtocols),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      opflexp_ssl_protocols: {
        value: cdktf.stringToHclTerraform(this._opflexpSslProtocols),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
