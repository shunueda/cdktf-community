// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/lacp_enhanced_lag_policy
...
export interface DataAciLacpEnhancedLagPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/lacp_enhanced_lag_policy#name DataAciLacpEnhancedLagPolicy#name}
  */
  readonly name: string;
  /**
  * The distinguished name (DN) of the parent object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/lacp_enhanced_lag_policy#parent_dn DataAciLacpEnhancedLagPolicy#parent_dn}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/lacp_enhanced_lag_policy aci_lacp_enhanced_lag_policy}
*/
export class DataAciLacpEnhancedLagPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciLacpEnhancedLagPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/lacp_enhanced_lag_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/data-sources/lacp_enhanced_lag_policy aci_lacp_enhanced_lag_policy} Data Source
  *
  * @param scope The scope in which to define this construct
