// https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_node_to_fabric_node
...
export interface LogicalNodeToFabricNodeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_node_to_fabric_node#annotation LogicalNodeToFabricNode#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_node_to_fabric_node#config_issues LogicalNodeToFabricNode#config_issues}
  */
  readonly configIssues?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_node_to_fabric_node#description LogicalNodeToFabricNode#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_node_to_fabric_node#id LogicalNodeToFabricNode#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_node_to_fabric_node#logical_node_profile_dn LogicalNodeToFabricNode#logical_node_profile_dn}
  */
  readonly logicalNodeProfileDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_node_to_fabric_node#rtr_id LogicalNodeToFabricNode#rtr_id}
  */
  readonly rtrId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_node_to_fabric_node#rtr_id_loop_back LogicalNodeToFabricNode#rtr_id_loop_back}
  */
  readonly rtrIdLoopBack?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_node_to_fabric_node#tdn LogicalNodeToFabricNode#tdn}
  */
  readonly tdn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_node_to_fabric_node aci_logical_node_to_fabric_node}
*/
export class LogicalNodeToFabricNode extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogicalNodeToFabricNode that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_node_to_fabric_node#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.17.0/docs/resources/logical_node_to_fabric_node aci_logical_node_to_fabric_node} Resource
  *
  * @param scope The scope in which to define this construct
