// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/trustsec_egress_matrix_cell
...
export interface TrustsecEgressMatrixCellConfig extends cdktf.TerraformMetaArguments {
  ...
  *   - Default value: `NONE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/trustsec_egress_matrix_cell#default_rule TrustsecEgressMatrixCell#default_rule}
  */
  readonly defaultRule?: string;
  /**
  * Description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/trustsec_egress_matrix_cell#description TrustsecEgressMatrixCell#description}
  */
  readonly description?: string;
  /**
  * Destination Trustsec Security Group ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/trustsec_egress_matrix_cell#destination_sgt_id TrustsecEgressMatrixCell#destination_sgt_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/trustsec_egress_matrix_cell#matrix_cell_status TrustsecEgressMatrixCell#matrix_cell_status}
  */
  readonly matrixCellStatus?: string;
  /**
  * List of TrustSec Security Groups ACLs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/trustsec_egress_matrix_cell#sgacls TrustsecEgressMatrixCell#sgacls}
  */
  readonly sgacls?: string[];
  /**
  * Source Trustsec Security Group ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/trustsec_egress_matrix_cell#source_sgt_id TrustsecEgressMatrixCell#source_sgt_id}
  */
  readonly sourceSgtId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/trustsec_egress_matrix_cell ise_trustsec_egress_matrix_cell}
*/
export class TrustsecEgressMatrixCell extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TrustsecEgressMatrixCell that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/trustsec_egress_matrix_cell#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/trustsec_egress_matrix_cell ise_trustsec_egress_matrix_cell} Resource
  *
  * @param scope The scope in which to define this construct
