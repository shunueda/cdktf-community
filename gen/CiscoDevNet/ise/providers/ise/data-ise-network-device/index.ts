// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/data-sources/network_device
...
export interface DataIseNetworkDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/data-sources/network_device#id DataIseNetworkDevice#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/data-sources/network_device#name DataIseNetworkDevice#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/data-sources/network_device ise_network_device}
*/
export class DataIseNetworkDevice extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIseNetworkDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/data-sources/network_device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/data-sources/network_device ise_network_device} Data Source
  *
  * @param scope The scope in which to define this construct
