// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/device_admin_time_and_date_condition
...
export interface DeviceAdminTimeAndDateConditionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Condition description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/device_admin_time_and_date_condition#description DeviceAdminTimeAndDateCondition#description}
  */
  readonly description?: string;
  /**
  * End date
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/device_admin_time_and_date_condition#end_date DeviceAdminTimeAndDateCondition#end_date}
  */
  readonly endDate?: string;
  /**
  * End time
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/device_admin_time_and_date_condition#end_time DeviceAdminTimeAndDateCondition#end_time}
  */
  readonly endTime?: string;
  /**
  * Exception end date
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/device_admin_time_and_date_condition#exception_end_date DeviceAdminTimeAndDateCondition#exception_end_date}
  */
  readonly exceptionEndDate?: string;
  /**
  * Exception end time
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/device_admin_time_and_date_condition#exception_end_time DeviceAdminTimeAndDateCondition#exception_end_time}
  */
  readonly exceptionEndTime?: string;
  /**
  * Exception start date
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/device_admin_time_and_date_condition#exception_start_date DeviceAdminTimeAndDateCondition#exception_start_date}
  */
  readonly exceptionStartDate?: string;
  /**
  * Exception start time
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/device_admin_time_and_date_condition#exception_start_time DeviceAdminTimeAndDateCondition#exception_start_time}
  */
  readonly exceptionStartTime?: string;
  /**
  * Indicates whereas this condition is in negate mode
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/device_admin_time_and_date_condition#is_negate DeviceAdminTimeAndDateCondition#is_negate}
  */
  readonly isNegate?: boolean | cdktf.IResolvable;
  /**
  * Condition name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/device_admin_time_and_date_condition#name DeviceAdminTimeAndDateCondition#name}
  */
  readonly name: string;
  /**
  * Start date
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/device_admin_time_and_date_condition#start_date DeviceAdminTimeAndDateCondition#start_date}
  */
  readonly startDate?: string;
  /**
  * Start time
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/device_admin_time_and_date_condition#start_time DeviceAdminTimeAndDateCondition#start_time}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/device_admin_time_and_date_condition#week_days DeviceAdminTimeAndDateCondition#week_days}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/device_admin_time_and_date_condition#week_days_exception DeviceAdminTimeAndDateCondition#week_days_exception}
  */
  readonly weekDaysException?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/device_admin_time_and_date_condition ise_device_admin_time_and_date_condition}
*/
export class DeviceAdminTimeAndDateCondition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DeviceAdminTimeAndDateCondition that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/device_admin_time_and_date_condition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/device_admin_time_and_date_condition ise_device_admin_time_and_date_condition} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DeviceAdminTimeAndDateConditionConfig
  */
  public constructor(scope: Construct, id: string, config: DeviceAdminTimeAndDateConditionConfig) {
    super(scope, id, {
