// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device
...
export interface NetworkDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  * Enforce use of DTLS
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#authentication_dtls_required NetworkDevice#authentication_dtls_required}
  */
  readonly authenticationDtlsRequired?: boolean | cdktf.IResolvable;
  /**
  * Enable key wrap
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#authentication_enable_key_wrap NetworkDevice#authentication_enable_key_wrap}
  */
  readonly authenticationEnableKeyWrap?: boolean | cdktf.IResolvable;
  /**
  * Enable multiple RADIUS shared secrets
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#authentication_enable_multi_secret NetworkDevice#authentication_enable_multi_secret}
  */
  readonly authenticationEnableMultiSecret?: boolean | cdktf.IResolvable;
  /**
  * Encryption key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#authentication_encryption_key NetworkDevice#authentication_encryption_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#authentication_encryption_key_format NetworkDevice#authentication_encryption_key_format}
  */
  readonly authenticationEncryptionKeyFormat?: string;
  /**
  * Message authenticator code key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#authentication_message_authenticator_code_key NetworkDevice#authentication_message_authenticator_code_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#authentication_network_protocol NetworkDevice#authentication_network_protocol}
  */
  readonly authenticationNetworkProtocol?: string;
  /**
  * RADIUS shared secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#authentication_radius_shared_secret NetworkDevice#authentication_radius_shared_secret}
  */
  readonly authenticationRadiusSharedSecret?: string;
  /**
  * Second RADIUS shared secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#authentication_second_radius_shared_secret NetworkDevice#authentication_second_radius_shared_secret}
  */
  ...
  *   - Default value: `1700`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#coa_port NetworkDevice#coa_port}
  */
  readonly coaPort?: number;
  /**
  * Description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#description NetworkDevice#description}
  */
  readonly description?: string;
  /**
  * This value is used to verify the client identity contained in the X.509 RADIUS/DTLS client certificate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#dtls_dns_name NetworkDevice#dtls_dns_name}
  */
  readonly dtlsDnsName?: string;
  /**
  * List of IP subnets
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#ips NetworkDevice#ips}
  */
  readonly ips: NetworkDeviceIps[] | cdktf.IResolvable;
  /**
  * Model name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#model_name NetworkDevice#model_name}
  */
  readonly modelName?: string;
  /**
  * The name of the network device
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#name NetworkDevice#name}
  */
  readonly name: string;
  /**
  * List of network device groups, e.g. `Device Type#All Device Types#ACCESS`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#network_device_groups NetworkDevice#network_device_groups}
  */
  ...
  *   - Default value: `Cisco`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#profile_name NetworkDevice#profile_name}
  */
  readonly profileName?: string;
  /**
  * SNMP link Trap Query
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#snmp_link_trap_query NetworkDevice#snmp_link_trap_query}
  */
  readonly snmpLinkTrapQuery?: boolean | cdktf.IResolvable;
  /**
  * SNMP MAC Trap Query
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#snmp_mac_trap_query NetworkDevice#snmp_mac_trap_query}
  */
  readonly snmpMacTrapQuery?: boolean | cdktf.IResolvable;
  /**
  * Originating Policy Services Node
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#snmp_originating_policy_service_node NetworkDevice#snmp_originating_policy_service_node}
  */
  ...
  *   - Range: `600`-`86400`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#snmp_polling_interval NetworkDevice#snmp_polling_interval}
  */
  readonly snmpPollingInterval?: number;
  /**
  * SNMP RO Community
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#snmp_ro_community NetworkDevice#snmp_ro_community}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#snmp_version NetworkDevice#snmp_version}
  */
  readonly snmpVersion?: string;
  /**
  * Software version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#software_version NetworkDevice#software_version}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#tacacs_connect_mode_options NetworkDevice#tacacs_connect_mode_options}
  */
  readonly tacacsConnectModeOptions?: string;
  /**
  * Shared secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#tacacs_shared_secret NetworkDevice#tacacs_shared_secret}
  */
  readonly tacacsSharedSecret?: string;
  /**
  * CoA source host
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#trustsec_coa_source_host NetworkDevice#trustsec_coa_source_host}
  */
  readonly trustsecCoaSourceHost?: string;
  /**
  * TrustSec device ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#trustsec_device_id NetworkDevice#trustsec_device_id}
  */
  readonly trustsecDeviceId?: string;
  /**
  * TrustSec device password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#trustsec_device_password NetworkDevice#trustsec_device_password}
  */
  readonly trustsecDevicePassword?: string;
  /**
  * Download environment data every X seconds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#trustsec_download_environment_data_every_x_seconds NetworkDevice#trustsec_download_environment_data_every_x_seconds}
  */
  readonly trustsecDownloadEnvironmentDataEveryXSeconds?: number;
  /**
  * Download peer authorization policy every X seconds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#trustsec_download_peer_authorization_policy_every_x_seconds NetworkDevice#trustsec_download_peer_authorization_policy_every_x_seconds}
  */
  readonly trustsecDownloadPeerAuthorizationPolicyEveryXSeconds?: number;
  /**
  * Download SGACL lists every X seconds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#trustsec_download_sgacl_lists_every_x_seconds NetworkDevice#trustsec_download_sgacl_lists_every_x_seconds}
  */
  readonly trustsecDownloadSgaclListsEveryXSeconds?: number;
  /**
  * Enable mode password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#trustsec_enable_mode_password NetworkDevice#trustsec_enable_mode_password}
  */
  readonly trustsecEnableModePassword?: string;
  /**
  * EXEC mode password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#trustsec_exec_mode_password NetworkDevice#trustsec_exec_mode_password}
  */
  readonly trustsecExecModePassword?: string;
  /**
  * EXEC mode username
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#trustsec_exec_mode_username NetworkDevice#trustsec_exec_mode_username}
  */
  readonly trustsecExecModeUsername?: string;
  /**
  * Include this device when deploying Security Group Tag Mapping Updates
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#trustsec_include_when_deploying_sgt_updates NetworkDevice#trustsec_include_when_deploying_sgt_updates}
  */
  readonly trustsecIncludeWhenDeployingSgtUpdates?: boolean | cdktf.IResolvable;
  /**
  * Other TrustSec devices to trust this device
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#trustsec_other_sga_devices_to_trust_this_device NetworkDevice#trustsec_other_sga_devices_to_trust_this_device}
  */
  readonly trustsecOtherSgaDevicesToTrustThisDevice?: boolean | cdktf.IResolvable;
  /**
  * Re-authenticate every X seconds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#trustsec_re_authentication_every_x_seconds NetworkDevice#trustsec_re_authentication_every_x_seconds}
  */
  readonly trustsecReAuthenticationEveryXSeconds?: number;
  /**
  * REST API password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#trustsec_rest_api_password NetworkDevice#trustsec_rest_api_password}
  */
  readonly trustsecRestApiPassword?: string;
  /**
  * REST API username
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#trustsec_rest_api_username NetworkDevice#trustsec_rest_api_username}
  */
  readonly trustsecRestApiUsername?: string;
  /**
  * Send configuration to device
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#trustsec_send_configuration_to_device NetworkDevice#trustsec_send_configuration_to_device}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#trustsec_send_configuration_to_device_using NetworkDevice#trustsec_send_configuration_to_device_using}
  */
...
export interface NetworkDeviceIps {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#ipaddress NetworkDevice#ipaddress}
  */
  readonly ipaddress: string;
  /**
  * It can be either single ip address or ip range address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#ipaddress_exclude NetworkDevice#ipaddress_exclude}
  */
  readonly ipaddressExclude?: string;
  /**
  * Subnet mask length
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#mask NetworkDevice#mask}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device ise_network_device}
*/
export class NetworkDevice extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_device ise_network_device} Resource
  *
  * @param scope The scope in which to define this construct
