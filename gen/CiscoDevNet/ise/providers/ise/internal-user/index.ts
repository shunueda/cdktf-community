// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/internal_user
...
export interface InternalUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/internal_user#account_name_alias InternalUser#account_name_alias}
  */
  ...
  *   - Default value: `true`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/internal_user#change_password InternalUser#change_password}
  */
  readonly changePassword?: boolean | cdktf.IResolvable;
  /**
  * Key value map
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/internal_user#custom_attributes InternalUser#custom_attributes}
  */
  readonly customAttributes?: string;
  /**
  * Description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/internal_user#description InternalUser#description}
  */
  readonly description?: string;
  /**
  * Email address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/internal_user#email InternalUser#email}
  */
  readonly email?: string;
  /**
  * This field is added in ISE 2.0 to support TACACS+
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/internal_user#enable_password InternalUser#enable_password}
  */
  readonly enablePassword?: string;
  /**
  * Whether the user is enabled/disabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/internal_user#enabled InternalUser#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * First name of the internal user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/internal_user#first_name InternalUser#first_name}
  */
  readonly firstName?: string;
  /**
  * Comma separated list of identity group IDs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/internal_user#identity_groups InternalUser#identity_groups}
  */
  readonly identityGroups?: string;
  /**
  * Last name of the internal user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/internal_user#last_name InternalUser#last_name}
  */
  readonly lastName?: string;
  /**
  * The name of the internal user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/internal_user#name InternalUser#name}
  */
  readonly name: string;
  /**
  * The password of the internal user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/internal_user#password InternalUser#password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/internal_user#password_id_store InternalUser#password_id_store}
  */
  ...
  *   - Default value: `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/internal_user#password_never_expires InternalUser#password_never_expires}
  */
  readonly passwordNeverExpires?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/internal_user ise_internal_user}
*/
export class InternalUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InternalUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/internal_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/internal_user ise_internal_user} Resource
  *
  * @param scope The scope in which to define this construct
