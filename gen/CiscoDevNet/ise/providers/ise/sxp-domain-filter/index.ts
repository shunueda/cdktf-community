// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/sxp_domain_filter
...
export interface SxpDomainFilterConfig extends cdktf.TerraformMetaArguments {
  ...
  * Description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/sxp_domain_filter#description SxpDomainFilter#description}
  */
  readonly description?: string;
  /**
  * List of SXP Domains, separated with comma
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/sxp_domain_filter#domains SxpDomainFilter#domains}
  */
  readonly domains: string;
  /**
  * Resource name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/sxp_domain_filter#name SxpDomainFilter#name}
  */
  readonly name?: string;
  /**
  * SGT name or ID. At least one of subnet or sgt or vn should be defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/sxp_domain_filter#sgt SxpDomainFilter#sgt}
  */
  readonly sgt?: string;
  /**
  * Subnet for filter policy (hostname is not supported). At least one of subnet or sgt or vn should be defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/sxp_domain_filter#subnet SxpDomainFilter#subnet}
  */
  readonly subnet?: string;
  /**
  * Virtual Network. At least one of subnet or sgt or vn should be defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/sxp_domain_filter#vn SxpDomainFilter#vn}
  */
  readonly vn?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/sxp_domain_filter ise_sxp_domain_filter}
*/
export class SxpDomainFilter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SxpDomainFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/sxp_domain_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/sxp_domain_filter ise_sxp_domain_filter} Resource
  *
  * @param scope The scope in which to define this construct
