// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/downloadable_acl
...
export interface DownloadableAclConfig extends cdktf.TerraformMetaArguments {
  ...
  * The DACL content
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/downloadable_acl#dacl DownloadableAcl#dacl}
  */
  ...
  *   - Default value: `IPV4`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/downloadable_acl#dacl_type DownloadableAcl#dacl_type}
  */
  readonly daclType?: string;
  /**
  * Description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/downloadable_acl#description DownloadableAcl#description}
  */
  readonly description?: string;
  /**
  * The name of the downloadable ACL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/downloadable_acl#name DownloadableAcl#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/downloadable_acl ise_downloadable_acl}
*/
export class DownloadableAcl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DownloadableAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/downloadable_acl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/downloadable_acl ise_downloadable_acl} Resource
  *
  * @param scope The scope in which to define this construct
