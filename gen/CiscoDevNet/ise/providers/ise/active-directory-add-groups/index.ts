// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/active_directory_add_groups
...
export interface ActiveDirectoryAddGroupsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/active_directory_add_groups#ad_scopes_names ActiveDirectoryAddGroups#ad_scopes_names}
  */
  readonly adScopesNames?: string;
  /**
  * Join point Description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/active_directory_add_groups#description ActiveDirectoryAddGroups#description}
  */
  readonly description?: string;
  /**
  * AD domain associated with the join point
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/active_directory_add_groups#domain ActiveDirectoryAddGroups#domain}
  */
  ...
  *   - Default value: `true`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/active_directory_add_groups#enable_domain_allowed_list ActiveDirectoryAddGroups#enable_domain_allowed_list}
  */
  readonly enableDomainAllowedList?: boolean | cdktf.IResolvable;
  /**
  * List of AD Groups
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/active_directory_add_groups#groups ActiveDirectoryAddGroups#groups}
  */
  readonly groups?: ActiveDirectoryAddGroupsGroups[] | cdktf.IResolvable;
  /**
  * Active Directory Join Point ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/active_directory_add_groups#join_point_id ActiveDirectoryAddGroups#join_point_id}
  */
  readonly joinPointId: string;
  /**
  * The name of the active directory join point
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/active_directory_add_groups#name ActiveDirectoryAddGroups#name}
  */
...
export interface ActiveDirectoryAddGroupsGroups {
  ...
  * Required for each group in the group list with no duplication between groups
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/active_directory_add_groups#sid ActiveDirectoryAddGroups#sid}
  */
  readonly sid: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/active_directory_add_groups#type ActiveDirectoryAddGroups#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/active_directory_add_groups ise_active_directory_add_groups}
*/
export class ActiveDirectoryAddGroups extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ActiveDirectoryAddGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/active_directory_add_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/active_directory_add_groups ise_active_directory_add_groups} Resource
  *
  * @param scope The scope in which to define this construct
