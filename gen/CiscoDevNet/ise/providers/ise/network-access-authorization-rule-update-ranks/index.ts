// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_access_authorization_rule_update_ranks
...
export interface NetworkAccessAuthorizationRuleUpdateRanksConfig extends cdktf.TerraformMetaArguments {
  ...
  * Policy set ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_access_authorization_rule_update_ranks#policy_set_id NetworkAccessAuthorizationRuleUpdateRanks#policy_set_id}
  */
  readonly policySetId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_access_authorization_rule_update_ranks#rules NetworkAccessAuthorizationRuleUpdateRanks#rules}
  */
...
export interface NetworkAccessAuthorizationRuleUpdateRanksRules {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_access_authorization_rule_update_ranks#id NetworkAccessAuthorizationRuleUpdateRanks#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_access_authorization_rule_update_ranks#rank NetworkAccessAuthorizationRuleUpdateRanks#rank}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_access_authorization_rule_update_ranks ise_network_access_authorization_rule_update_ranks}
*/
export class NetworkAccessAuthorizationRuleUpdateRanks extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkAccessAuthorizationRuleUpdateRanks that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_access_authorization_rule_update_ranks#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.11/docs/resources/network_access_authorization_rule_update_ranks ise_network_access_authorization_rule_update_ranks} Resource
  *
  * @param scope The scope in which to define this construct
