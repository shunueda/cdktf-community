// https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/policy_rule_set
...
export interface PolicyRuleSetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/policy_rule_set#child_rule_set_ids PolicyRuleSet#child_rule_set_ids}
  */
  readonly childRuleSetIds?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/policy_rule_set#description PolicyRuleSet#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/policy_rule_set#group_member_ids PolicyRuleSet#group_member_ids}
  */
  readonly groupMemberIds?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/policy_rule_set#id PolicyRuleSet#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/policy_rule_set#name PolicyRuleSet#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/policy_rule_set#type PolicyRuleSet#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/policy_rule_set ciscomcd_policy_rule_set}
*/
export class PolicyRuleSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyRuleSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/policy_rule_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/policy_rule_set ciscomcd_policy_rule_set} Resource
  *
  * @param scope The scope in which to define this construct
