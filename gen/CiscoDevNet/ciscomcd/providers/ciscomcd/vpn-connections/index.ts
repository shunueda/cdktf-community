// https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/vpn_connections
...
export interface VpnConnectionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/vpn_connections#connection_set_id VpnConnections#connection_set_id}
  */
  readonly connectionSetId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/vpn_connections#id VpnConnections#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/vpn_connections#vpn_connection VpnConnections#vpn_connection}
  */
  readonly vpnConnection?: VpnConnectionsVpnConnection[] | cdktf.IResolvable;
}
export interface VpnConnectionsVpnConnection {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/vpn_connections#description VpnConnections#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/vpn_connections#ipsec_profile VpnConnections#ipsec_profile}
  */
  readonly ipsecProfile: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/vpn_connections#name VpnConnections#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/vpn_connections#pre_shared_key VpnConnections#pre_shared_key}
  */
  readonly preSharedKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/vpn_connections#tunnel_address_left VpnConnections#tunnel_address_left}
  */
  readonly tunnelAddressLeft: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/vpn_connections#tunnel_address_right VpnConnections#tunnel_address_right}
  */
  readonly tunnelAddressRight: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/vpn_connections#tunnel_endpoint_left VpnConnections#tunnel_endpoint_left}
  */
  readonly tunnelEndpointLeft: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/vpn_connections#tunnel_endpoint_right VpnConnections#tunnel_endpoint_right}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/vpn_connections ciscomcd_vpn_connections}
*/
export class VpnConnections extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "ciscomcd_vpn_connections";
  ...
  * @param importFromId The id of the existing VpnConnections that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/vpn_connections#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the VpnConnections to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "ciscomcd_vpn_connections", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.1/docs/resources/vpn_connections ciscomcd_vpn_connections} Resource
  *
  * @param scope The scope in which to define this construct
