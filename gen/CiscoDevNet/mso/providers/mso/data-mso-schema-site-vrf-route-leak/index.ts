// https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_site_vrf_route_leak
...
export interface DataMsoSchemaSiteVrfRouteLeakConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_site_vrf_route_leak#id DataMsoSchemaSiteVrfRouteLeak#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_site_vrf_route_leak#schema_id DataMsoSchemaSiteVrfRouteLeak#schema_id}
  */
  readonly schemaId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_site_vrf_route_leak#site_id DataMsoSchemaSiteVrfRouteLeak#site_id}
  */
  readonly siteId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_site_vrf_route_leak#target_vrf_name DataMsoSchemaSiteVrfRouteLeak#target_vrf_name}
  */
  readonly targetVrfName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_site_vrf_route_leak#target_vrf_schema_id DataMsoSchemaSiteVrfRouteLeak#target_vrf_schema_id}
  */
  readonly targetVrfSchemaId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_site_vrf_route_leak#target_vrf_template_name DataMsoSchemaSiteVrfRouteLeak#target_vrf_template_name}
  */
  readonly targetVrfTemplateName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_site_vrf_route_leak#template_name DataMsoSchemaSiteVrfRouteLeak#template_name}
  */
  readonly templateName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_site_vrf_route_leak#vrf_name DataMsoSchemaSiteVrfRouteLeak#vrf_name}
  */
  readonly vrfName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_site_vrf_route_leak mso_schema_site_vrf_route_leak}
*/
export class DataMsoSchemaSiteVrfRouteLeak extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMsoSchemaSiteVrfRouteLeak that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_site_vrf_route_leak#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_site_vrf_route_leak mso_schema_site_vrf_route_leak} Data Source
  *
  * @param scope The scope in which to define this construct
