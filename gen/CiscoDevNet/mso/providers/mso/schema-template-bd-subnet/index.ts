// https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_bd_subnet
...
export interface SchemaTemplateBdSubnetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_bd_subnet#bd_name SchemaTemplateBdSubnet#bd_name}
  */
  readonly bdName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_bd_subnet#description SchemaTemplateBdSubnet#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_bd_subnet#id SchemaTemplateBdSubnet#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_bd_subnet#ip SchemaTemplateBdSubnet#ip}
  */
  readonly ip: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_bd_subnet#no_default_gateway SchemaTemplateBdSubnet#no_default_gateway}
  */
  readonly noDefaultGateway?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_bd_subnet#primary SchemaTemplateBdSubnet#primary}
  */
  readonly primary?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_bd_subnet#querier SchemaTemplateBdSubnet#querier}
  */
  readonly querier?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_bd_subnet#schema_id SchemaTemplateBdSubnet#schema_id}
  */
  readonly schemaId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_bd_subnet#scope SchemaTemplateBdSubnet#scope}
  */
  readonly scope: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_bd_subnet#shared SchemaTemplateBdSubnet#shared}
  */
  readonly shared?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_bd_subnet#template_name SchemaTemplateBdSubnet#template_name}
  */
  readonly templateName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_bd_subnet#virtual SchemaTemplateBdSubnet#virtual}
  */
  readonly virtual?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_bd_subnet mso_schema_template_bd_subnet}
*/
export class SchemaTemplateBdSubnet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SchemaTemplateBdSubnet that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_bd_subnet#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_bd_subnet mso_schema_template_bd_subnet} Resource
  *
  * @param scope The scope in which to define this construct
