// https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_vrf_route_leak
...
export interface SchemaSiteVrfRouteLeakConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_vrf_route_leak#id SchemaSiteVrfRouteLeak#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_vrf_route_leak#schema_id SchemaSiteVrfRouteLeak#schema_id}
  */
  readonly schemaId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_vrf_route_leak#site_id SchemaSiteVrfRouteLeak#site_id}
  */
  readonly siteId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_vrf_route_leak#subnet_ips SchemaSiteVrfRouteLeak#subnet_ips}
  */
  readonly subnetIps?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_vrf_route_leak#target_vrf_name SchemaSiteVrfRouteLeak#target_vrf_name}
  */
  readonly targetVrfName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_vrf_route_leak#target_vrf_schema_id SchemaSiteVrfRouteLeak#target_vrf_schema_id}
  */
  readonly targetVrfSchemaId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_vrf_route_leak#target_vrf_template_name SchemaSiteVrfRouteLeak#target_vrf_template_name}
  */
  readonly targetVrfTemplateName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_vrf_route_leak#template_name SchemaSiteVrfRouteLeak#template_name}
  */
  readonly templateName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_vrf_route_leak#tenant_name SchemaSiteVrfRouteLeak#tenant_name}
  */
  readonly tenantName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_vrf_route_leak#type SchemaSiteVrfRouteLeak#type}
  */
  readonly type?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_vrf_route_leak#vrf_name SchemaSiteVrfRouteLeak#vrf_name}
  */
  readonly vrfName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_vrf_route_leak mso_schema_site_vrf_route_leak}
*/
export class SchemaSiteVrfRouteLeak extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SchemaSiteVrfRouteLeak that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_vrf_route_leak#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_vrf_route_leak mso_schema_site_vrf_route_leak} Resource
  *
  * @param scope The scope in which to define this construct
