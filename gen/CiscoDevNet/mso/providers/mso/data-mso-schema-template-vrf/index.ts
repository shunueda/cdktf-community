// https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_template_vrf
...
export interface DataMsoSchemaTemplateVrfConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_template_vrf#id DataMsoSchemaTemplateVrf#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_template_vrf#name DataMsoSchemaTemplateVrf#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_template_vrf#schema_id DataMsoSchemaTemplateVrf#schema_id}
  */
  readonly schemaId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_template_vrf#template DataMsoSchemaTemplateVrf#template}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_template_vrf mso_schema_template_vrf}
*/
export class DataMsoSchemaTemplateVrf extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMsoSchemaTemplateVrf that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_template_vrf#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_template_vrf mso_schema_template_vrf} Data Source
  *
  * @param scope The scope in which to define this construct
