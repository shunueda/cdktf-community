// https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_external_epg_contract
...
export interface SchemaTemplateExternalEpgContractConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_external_epg_contract#contract_name SchemaTemplateExternalEpgContract#contract_name}
  */
  readonly contractName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_external_epg_contract#contract_schema_id SchemaTemplateExternalEpgContract#contract_schema_id}
  */
  readonly contractSchemaId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_external_epg_contract#contract_template_name SchemaTemplateExternalEpgContract#contract_template_name}
  */
  readonly contractTemplateName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_external_epg_contract#external_epg_name SchemaTemplateExternalEpgContract#external_epg_name}
  */
  readonly externalEpgName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_external_epg_contract#id SchemaTemplateExternalEpgContract#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_external_epg_contract#relationship_type SchemaTemplateExternalEpgContract#relationship_type}
  */
  readonly relationshipType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_external_epg_contract#schema_id SchemaTemplateExternalEpgContract#schema_id}
  */
  readonly schemaId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_external_epg_contract#template_name SchemaTemplateExternalEpgContract#template_name}
  */
  readonly templateName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_external_epg_contract mso_schema_template_external_epg_contract}
*/
export class SchemaTemplateExternalEpgContract extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SchemaTemplateExternalEpgContract that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_external_epg_contract#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_template_external_epg_contract mso_schema_template_external_epg_contract} Resource
  *
  * @param scope The scope in which to define this construct
