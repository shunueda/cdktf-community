// https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_template_l3out
...
export interface DataMsoSchemaTemplateL3OutConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_template_l3out#id DataMsoSchemaTemplateL3Out#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_template_l3out#l3out_name DataMsoSchemaTemplateL3Out#l3out_name}
  */
  readonly l3OutName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_template_l3out#schema_id DataMsoSchemaTemplateL3Out#schema_id}
  */
  readonly schemaId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_template_l3out#template_name DataMsoSchemaTemplateL3Out#template_name}
  */
  readonly templateName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_template_l3out mso_schema_template_l3out}
*/
export class DataMsoSchemaTemplateL3Out extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMsoSchemaTemplateL3Out that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_template_l3out#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/schema_template_l3out mso_schema_template_l3out} Data Source
  *
  * @param scope The scope in which to define this construct
