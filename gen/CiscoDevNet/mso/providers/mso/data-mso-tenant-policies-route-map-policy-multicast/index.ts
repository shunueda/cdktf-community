// https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/tenant_policies_route_map_policy_multicast
...
export interface DataMsoTenantPoliciesRouteMapPolicyMulticastConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/tenant_policies_route_map_policy_multicast#id DataMsoTenantPoliciesRouteMapPolicyMulticast#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/tenant_policies_route_map_policy_multicast#name DataMsoTenantPoliciesRouteMapPolicyMulticast#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/tenant_policies_route_map_policy_multicast#template_id DataMsoTenantPoliciesRouteMapPolicyMulticast#template_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/tenant_policies_route_map_policy_multicast mso_tenant_policies_route_map_policy_multicast}
*/
export class DataMsoTenantPoliciesRouteMapPolicyMulticast extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMsoTenantPoliciesRouteMapPolicyMulticast that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/tenant_policies_route_map_policy_multicast#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/data-sources/tenant_policies_route_map_policy_multicast mso_tenant_policies_route_map_policy_multicast} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _routeMapMulticastEntries = new DataMsoTenantPoliciesRouteMapPolicyMulticastRouteMapMulticastEntriesList(this, "route_map_multicast_entries", true);
