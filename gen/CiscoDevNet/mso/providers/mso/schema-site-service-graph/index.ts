// https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_service_graph
...
export interface SchemaSiteServiceGraphConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_service_graph#id SchemaSiteServiceGraph#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_service_graph#schema_id SchemaSiteServiceGraph#schema_id}
  */
  readonly schemaId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_service_graph#service_graph_name SchemaSiteServiceGraph#service_graph_name}
  */
  readonly serviceGraphName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_service_graph#site_id SchemaSiteServiceGraph#site_id}
  */
  readonly siteId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_service_graph#template_name SchemaSiteServiceGraph#template_name}
  */
  readonly templateName: string;
  /**
  * service_node block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_service_graph#service_node SchemaSiteServiceGraph#service_node}
  */
...
export interface SchemaSiteServiceGraphServiceNode {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_service_graph#consumer_connector_type SchemaSiteServiceGraph#consumer_connector_type}
  */
  readonly consumerConnectorType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_service_graph#consumer_interface SchemaSiteServiceGraph#consumer_interface}
  */
  readonly consumerInterface?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_service_graph#device_dn SchemaSiteServiceGraph#device_dn}
  */
  readonly deviceDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_service_graph#provider_connector_type SchemaSiteServiceGraph#provider_connector_type}
  */
  readonly providerConnectorType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_service_graph#provider_interface SchemaSiteServiceGraph#provider_interface}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_service_graph mso_schema_site_service_graph}
*/
export class SchemaSiteServiceGraph extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SchemaSiteServiceGraph that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_service_graph#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.5.3/docs/resources/schema_site_service_graph mso_schema_site_service_graph} Resource
  *
  * @param scope The scope in which to define this construct
