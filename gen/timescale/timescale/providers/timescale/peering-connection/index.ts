// https://registry.terraform.io/providers/timescale/timescale/2.5.0/docs/resources/peering_connection
...
export interface PeeringConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timescale/timescale/2.5.0/docs/resources/peering_connection#peer_account_id PeeringConnection#peer_account_id}
  */
  readonly peerAccountId: string;
  /**
  * List of CIDR blocks for the peering connection. Required for Transit Gateway peering, optional for VPC peering
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timescale/timescale/2.5.0/docs/resources/peering_connection#peer_cidr_blocks PeeringConnection#peer_cidr_blocks}
  */
  readonly peerCidrBlocks?: string[];
  /**
  * Region code for the VPC or Transit Gateway to be paired
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timescale/timescale/2.5.0/docs/resources/peering_connection#peer_region_code PeeringConnection#peer_region_code}
  */
  readonly peerRegionCode: string;
  /**
  * AWS ID for the Transit Gateway to be paired. Mutually exclusive with peer_vpc_id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timescale/timescale/2.5.0/docs/resources/peering_connection#peer_tgw_id PeeringConnection#peer_tgw_id}
  */
  readonly peerTgwId?: string;
  /**
  * AWS ID for the VPC to be paired. Mutually exclusive with peer_tgw_id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timescale/timescale/2.5.0/docs/resources/peering_connection#peer_vpc_id PeeringConnection#peer_vpc_id}
  */
  readonly peerVpcId?: string;
  /**
  * Timescale internal ID for a vpc
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timescale/timescale/2.5.0/docs/resources/peering_connection#timescale_vpc_id PeeringConnection#timescale_vpc_id}
  */
  readonly timescaleVpcId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/timescale/timescale/2.5.0/docs/resources/peering_connection timescale_peering_connection}
*/
export class PeeringConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PeeringConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/timescale/timescale/2.5.0/docs/resources/peering_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/timescale/timescale/2.5.0/docs/resources/peering_connection timescale_peering_connection} Resource
  *
  * @param scope The scope in which to define this construct
