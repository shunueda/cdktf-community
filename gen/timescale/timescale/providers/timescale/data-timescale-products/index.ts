// https://registry.terraform.io/providers/timescale/timescale/2.5.0/docs/data-sources/products
...
/**
* Represents a {@link https://registry.terraform.io/providers/timescale/timescale/2.5.0/docs/data-sources/products timescale_products}
*/
export class DataTimescaleProducts extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTimescaleProducts that should be imported. Refer to the {@link https://registry.terraform.io/providers/timescale/timescale/2.5.0/docs/data-sources/products#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/timescale/timescale/2.5.0/docs/data-sources/products timescale_products} Data Source
  *
  * @param scope The scope in which to define this construct
