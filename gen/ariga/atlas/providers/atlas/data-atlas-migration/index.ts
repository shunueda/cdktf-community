// https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/migration
...
export interface DataAtlasMigrationConfig extends cdktf.TerraformMetaArguments {
  /**
  * The configuration file for the migration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/migration#config DataAtlasMigration#config}
  */
  readonly config?: string;
  /**
  * The URL of the dev-db. See https://atlasgo.io/cli/url
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/migration#dev_url DataAtlasMigration#dev_url}
  */
  readonly devUrl?: string;
  /**
  * Select migration directory using URL format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/migration#dir DataAtlasMigration#dir}
  */
  readonly dir?: string;
  /**
  * The name of the environment used for reporting runs to Atlas Cloud. Default: tf
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/migration#env_name DataAtlasMigration#env_name}
  */
  readonly envName?: string;
  /**
  * The name of the schema the revisions table resides in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/migration#revisions_schema DataAtlasMigration#revisions_schema}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/migration#url DataAtlasMigration#url}
  */
  readonly url?: string;
  /**
  * Stringify JSON object containing variables to be used inside the Atlas configuration file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/migration#variables DataAtlasMigration#variables}
  */
  readonly variables?: string;
  /**
  * cloud block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/migration#cloud DataAtlasMigration#cloud}
  */
  readonly cloud?: DataAtlasMigrationCloud;
  /**
  * remote_dir block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/migration#remote_dir DataAtlasMigration#remote_dir}
  */
  readonly remoteDir?: DataAtlasMigrationRemoteDir;
}
export interface DataAtlasMigrationCloud {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/migration#project DataAtlasMigration#project}
  */
  readonly project?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/migration#repo DataAtlasMigration#repo}
  */
  readonly repo?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/migration#token DataAtlasMigration#token}
  */
...
export interface DataAtlasMigrationRemoteDir {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/migration#name DataAtlasMigration#name}
  */
  readonly name?: string;
  /**
  * The tag of the remote directory
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/migration#tag DataAtlasMigration#tag}
  */
  readonly tag?: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/migration atlas_migration}
*/
export class DataAtlasMigration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAtlasMigration that should be imported. Refer to the {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/migration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/migration atlas_migration} Data Source
  *
  * @param scope The scope in which to define this construct
