// https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/schema
...
export interface DataAtlasSchemaConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/schema#config DataAtlasSchema#config}
  */
  readonly config?: string;
  /**
  * The url of the dev-db see https://atlasgo.io/cli/url
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/schema#dev_url DataAtlasSchema#dev_url}
  */
  readonly devUrl?: string;
  /**
  * The name of the environment to be picked from the Atlas configuration. Default: tf
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/schema#env_name DataAtlasSchema#env_name}
  */
  readonly envName?: string;
  /**
  * The schema definition of the database. This attribute can be HCL schema or an URL to HCL/SQL file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/schema#src DataAtlasSchema#src}
  */
  readonly src: string;
  /**
  * The map of variables used in the Atlas configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/schema#variables DataAtlasSchema#variables}
  */
  readonly variables?: { [key: string]: string };
  /**
  * cloud block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/schema#cloud DataAtlasSchema#cloud}
  */
  readonly cloud?: DataAtlasSchemaCloud;
}
export interface DataAtlasSchemaCloud {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/schema#project DataAtlasSchema#project}
  */
  readonly project?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/schema#repo DataAtlasSchema#repo}
  */
  readonly repo?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/schema#token DataAtlasSchema#token}
  */
  readonly token?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/schema#url DataAtlasSchema#url}
  */
  readonly url?: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/schema atlas_schema}
*/
export class DataAtlasSchema extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAtlasSchema that should be imported. Refer to the {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/schema#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs/data-sources/schema atlas_schema} Data Source
  *
  * @param scope The scope in which to define this construct
