// https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs
...
export interface AtlasProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs#binary_path AtlasProvider#binary_path}
  */
  readonly binaryPath?: string;
  /**
  * The URL of the dev database. This configuration is shared for all resources if there is no config on the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs#dev_url AtlasProvider#dev_url}
  */
  readonly devUrl?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs#alias AtlasProvider#alias}
  */
  readonly alias?: string;
  /**
  * cloud block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs#cloud AtlasProvider#cloud}
  */
  readonly cloud?: AtlasProviderCloud;
}
export interface AtlasProviderCloud {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs#project AtlasProvider#project}
  */
  readonly project?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs#repo AtlasProvider#repo}
  */
  readonly repo?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs#token AtlasProvider#token}
  */
  readonly token?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs#url AtlasProvider#url}
  */
  readonly url?: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs atlas}
*/
export class AtlasProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing AtlasProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ariga/atlas/0.9.11/docs atlas} Resource
  *
  * @param scope The scope in which to define this construct
