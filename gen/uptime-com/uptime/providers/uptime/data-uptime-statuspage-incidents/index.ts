// https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/data-sources/statuspage_incidents
...
export interface DataUptimeStatuspageIncidentsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/data-sources/statuspage_incidents#statuspage_id DataUptimeStatuspageIncidents#statuspage_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/data-sources/statuspage_incidents uptime_statuspage_incidents}
*/
export class DataUptimeStatuspageIncidents extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataUptimeStatuspageIncidents that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/data-sources/statuspage_incidents#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/data-sources/statuspage_incidents uptime_statuspage_incidents} Data Source
  *
  * @param scope The scope in which to define this construct
