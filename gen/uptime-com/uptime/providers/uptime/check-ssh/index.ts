// https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh
...
export interface CheckSshConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh#address CheckSsh#address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh#contact_groups CheckSsh#contact_groups}
  */
  readonly contactGroups?: string[];
  /**
  * Include this check in uptime/response time calculations for the dashboard and status pages
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh#include_in_global_metrics CheckSsh#include_in_global_metrics}
  */
  readonly includeInGlobalMetrics?: boolean | cdktf.IResolvable;
  /**
  * The interval between checks in minutes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh#interval CheckSsh#interval}
  */
  readonly interval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh#is_paused CheckSsh#is_paused}
  */
  readonly isPaused?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh#locations CheckSsh#locations}
  */
  readonly locations?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh#name CheckSsh#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh#notes CheckSsh#notes}
  */
  readonly notes?: string;
  /**
  * How many times the check should be retried before a location is considered down
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh#num_retries CheckSsh#num_retries}
  */
  readonly numRetries?: number;
  /**
  * The port to check
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh#port CheckSsh#port}
  */
  readonly port: number;
  /**
  * How many locations should be down before an alert is sent
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh#sensitivity CheckSsh#sensitivity}
  */
  readonly sensitivity?: number;
  /**
  * SLA related attributes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh#sla CheckSsh#sla}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh#tags CheckSsh#tags}
  */
  readonly tags?: string[];
  /**
  * Whether to use IPv4 or IPv6 for the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh#use_ip_version CheckSsh#use_ip_version}
  */
...
export interface CheckSshSla {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh#latency CheckSsh#latency}
  */
  readonly latency?: string;
  /**
  * The minimum uptime percentage. \nMust be a fraction with exactly 4 decimal places (e.g. 0.9995 for 99.95% uptime)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh#uptime CheckSsh#uptime}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh uptime_check_ssh}
*/
export class CheckSsh extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CheckSsh that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_ssh uptime_check_ssh} Resource
  *
  * @param scope The scope in which to define this construct
