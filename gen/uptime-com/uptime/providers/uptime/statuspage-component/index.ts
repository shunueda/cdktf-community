// https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_component
...
export interface StatuspageComponentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_component#auto_status_down StatuspageComponent#auto_status_down}
  */
  readonly autoStatusDown?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_component#auto_status_up StatuspageComponent#auto_status_up}
  */
  readonly autoStatusUp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_component#description StatuspageComponent#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_component#group_id StatuspageComponent#group_id}
  */
  readonly groupId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_component#is_group StatuspageComponent#is_group}
  */
  readonly isGroup?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_component#name StatuspageComponent#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_component#service_id StatuspageComponent#service_id}
  */
  readonly serviceId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_component#status StatuspageComponent#status}
  */
  readonly status?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_component#statuspage_id StatuspageComponent#statuspage_id}
  */
  readonly statuspageId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_component uptime_statuspage_component}
*/
export class StatuspageComponent extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StatuspageComponent that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_component#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_component uptime_statuspage_component} Resource
  *
  * @param scope The scope in which to define this construct
