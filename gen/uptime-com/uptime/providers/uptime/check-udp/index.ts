// https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp
...
export interface CheckUdpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp#address CheckUdp#address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp#contact_groups CheckUdp#contact_groups}
  */
  readonly contactGroups?: string[];
  /**
  * String to expect in server response (may be repeated)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp#expect_string CheckUdp#expect_string}
  */
  readonly expectString: string;
  /**
  * Include this check in uptime/response time calculations for the dashboard and status pages
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp#include_in_global_metrics CheckUdp#include_in_global_metrics}
  */
  readonly includeInGlobalMetrics?: boolean | cdktf.IResolvable;
  /**
  * The interval between checks in minutes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp#interval CheckUdp#interval}
  */
  readonly interval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp#is_paused CheckUdp#is_paused}
  */
  readonly isPaused?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp#locations CheckUdp#locations}
  */
  readonly locations?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp#name CheckUdp#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp#notes CheckUdp#notes}
  */
  readonly notes?: string;
  /**
  * How many times the check should be retried before a location is considered down
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp#num_retries CheckUdp#num_retries}
  */
  readonly numRetries?: number;
  /**
  * The port to check
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp#port CheckUdp#port}
  */
  readonly port: number;
  /**
  * String to send to the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp#send_string CheckUdp#send_string}
  */
  readonly sendString: string;
  /**
  * How many locations should be down before an alert is sent
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp#sensitivity CheckUdp#sensitivity}
  */
  readonly sensitivity?: number;
  /**
  * SLA related attributes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp#sla CheckUdp#sla}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp#tags CheckUdp#tags}
  */
  readonly tags?: string[];
  /**
  * Whether to use IPv4 or IPv6 for the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp#use_ip_version CheckUdp#use_ip_version}
  */
...
export interface CheckUdpSla {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp#latency CheckUdp#latency}
  */
  readonly latency?: string;
  /**
  * The minimum uptime percentage. \nMust be a fraction with exactly 4 decimal places (e.g. 0.9995 for 99.95% uptime)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp#uptime CheckUdp#uptime}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp uptime_check_udp}
*/
export class CheckUdp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CheckUdp that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/check_udp uptime_check_udp} Resource
  *
  * @param scope The scope in which to define this construct
