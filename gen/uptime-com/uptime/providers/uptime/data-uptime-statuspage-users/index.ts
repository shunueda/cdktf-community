// https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/data-sources/statuspage_users
...
export interface DataUptimeStatuspageUsersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/data-sources/statuspage_users#statuspage_id DataUptimeStatuspageUsers#statuspage_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/data-sources/statuspage_users uptime_statuspage_users}
*/
export class DataUptimeStatuspageUsers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataUptimeStatuspageUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/data-sources/statuspage_users#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/data-sources/statuspage_users uptime_statuspage_users} Data Source
  *
  * @param scope The scope in which to define this construct
