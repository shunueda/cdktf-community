// https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_metric
...
export interface StatuspageMetricConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_metric#is_visible StatuspageMetric#is_visible}
  */
  readonly isVisible?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_metric#name StatuspageMetric#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_metric#service_id StatuspageMetric#service_id}
  */
  readonly serviceId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_metric#statuspage_id StatuspageMetric#statuspage_id}
  */
  readonly statuspageId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_metric uptime_statuspage_metric}
*/
export class StatuspageMetric extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StatuspageMetric that should be imported. Refer to the {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_metric#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/uptime-com/uptime/2.15.0/docs/resources/statuspage_metric uptime_statuspage_metric} Resource
  *
  * @param scope The scope in which to define this construct
