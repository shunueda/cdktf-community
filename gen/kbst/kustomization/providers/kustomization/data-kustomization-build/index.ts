// https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/build
...
export interface DataKustomizationBuildConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/build#id DataKustomizationBuild#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/build#path DataKustomizationBuild#path}
  */
  readonly path: string;
  /**
  * kustomize_options block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/build#kustomize_options DataKustomizationBuild#kustomize_options}
  */
  readonly kustomizeOptions?: DataKustomizationBuildKustomizeOptions;
}
export interface DataKustomizationBuildKustomizeOptions {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/build#enable_alpha_plugins DataKustomizationBuild#enable_alpha_plugins}
  */
  readonly enableAlphaPlugins?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/build#enable_exec DataKustomizationBuild#enable_exec}
  */
  readonly enableExec?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/build#enable_helm DataKustomizationBuild#enable_helm}
  */
  readonly enableHelm?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/build#enable_star DataKustomizationBuild#enable_star}
  */
  readonly enableStar?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/build#helm_path DataKustomizationBuild#helm_path}
  */
  readonly helmPath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/build#load_restrictor DataKustomizationBuild#load_restrictor}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/build kustomization_build}
*/
export class DataKustomizationBuild extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKustomizationBuild that should be imported. Refer to the {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/build#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/build kustomization_build} Data Source
  *
  * @param scope The scope in which to define this construct
