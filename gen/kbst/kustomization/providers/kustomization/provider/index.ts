// https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs
...
export interface KustomizationProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs#context KustomizationProvider#context}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs#gzip_last_applied_config KustomizationProvider#gzip_last_applied_config}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs#kubeconfig_incluster KustomizationProvider#kubeconfig_incluster}
  */
  readonly kubeconfigIncluster?: boolean | cdktf.IResolvable;
  /**
  * Path to a kubeconfig file. Can be set using KUBECONFIG_PATH env var
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs#kubeconfig_path KustomizationProvider#kubeconfig_path}
  */
  readonly kubeconfigPath?: string;
  /**
  * Raw kube config. If kubeconfig_raw is set, KUBECONFIG_PATH is ignored.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs#kubeconfig_raw KustomizationProvider#kubeconfig_raw}
  */
  readonly kubeconfigRaw?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs#alias KustomizationProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs kustomization}
*/
export class KustomizationProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing KustomizationProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs kustomization} Resource
  *
  * @param scope The scope in which to define this construct
