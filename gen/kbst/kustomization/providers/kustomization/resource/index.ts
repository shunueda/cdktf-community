// https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/resources/resource
...
export interface ResourceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/resources/resource#id Resource#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/resources/resource#manifest Resource#manifest}
  */
  readonly manifest: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/resources/resource#wait Resource#wait}
  */
  readonly wait?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/resources/resource#timeouts Resource#timeouts}
  */
  readonly timeouts?: ResourceTimeouts;
}
export interface ResourceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/resources/resource#create Resource#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/resources/resource#delete Resource#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/resources/resource#update Resource#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/resources/resource kustomization_resource}
*/
export class Resource extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "kustomization_resource";
  ...
  * @param importFromId The id of the existing Resource that should be imported. Refer to the {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/resources/resource#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the Resource to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "kustomization_resource", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/resources/resource kustomization_resource} Resource
  *
  * @param scope The scope in which to define this construct
