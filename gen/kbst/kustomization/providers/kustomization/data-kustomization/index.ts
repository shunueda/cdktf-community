// https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/kustomization
...
export interface DataKustomizationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/kustomization#id DataKustomization#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/kustomization#path DataKustomization#path}
  */
  readonly path: string;
  /**
  * kustomize_options block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/kustomization#kustomize_options DataKustomization#kustomize_options}
  */
  readonly kustomizeOptions?: DataKustomizationKustomizeOptions;
}
export interface DataKustomizationKustomizeOptions {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/kustomization#enable_alpha_plugins DataKustomization#enable_alpha_plugins}
  */
  readonly enableAlphaPlugins?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/kustomization#enable_exec DataKustomization#enable_exec}
  */
  readonly enableExec?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/kustomization#enable_helm DataKustomization#enable_helm}
  */
  readonly enableHelm?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/kustomization#enable_star DataKustomization#enable_star}
  */
  readonly enableStar?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/kustomization#helm_path DataKustomization#helm_path}
  */
  readonly helmPath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/kustomization#load_restrictor DataKustomization#load_restrictor}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/kustomization kustomization}
*/
export class DataKustomization extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKustomization that should be imported. Refer to the {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/kustomization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.6/docs/data-sources/kustomization kustomization} Data Source
  *
  * @param scope The scope in which to define this construct
