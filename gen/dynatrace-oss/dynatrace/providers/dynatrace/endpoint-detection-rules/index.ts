// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/endpoint_detection_rules
...
export interface EndpointDetectionRulesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/endpoint_detection_rules#enabled EndpointDetectionRules#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/endpoint_detection_rules#id EndpointDetectionRules#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/endpoint_detection_rules#insert_after EndpointDetectionRules#insert_after}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/endpoint_detection_rules#scope EndpointDetectionRules#scope}
  */
  readonly scope?: string;
  /**
  * rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/endpoint_detection_rules#rule EndpointDetectionRules#rule}
  */
...
export interface EndpointDetectionRulesRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/endpoint_detection_rules#condition EndpointDetectionRules#condition}
  */
  readonly condition?: string;
  /**
  * no documentation available
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/endpoint_detection_rules#description EndpointDetectionRules#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/endpoint_detection_rules#endpoint_name_template EndpointDetectionRules#endpoint_name_template}
  */
  readonly endpointNameTemplate?: string;
  /**
  * Possible Values: `DETECT_REQUEST_ON_ENDPOINT`, `SUPPRESS_REQUEST`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/endpoint_detection_rules#if_condition_matches EndpointDetectionRules#if_condition_matches}
  */
  readonly ifConditionMatches: string;
  /**
  * Rule name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/endpoint_detection_rules#rule_name EndpointDetectionRules#rule_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/endpoint_detection_rules dynatrace_endpoint_detection_rules}
*/
export class EndpointDetectionRules extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EndpointDetectionRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/endpoint_detection_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/endpoint_detection_rules dynatrace_endpoint_detection_rules} Resource
  *
  * @param scope The scope in which to define this construct
