// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/opentelemetry_metrics
...
export interface OpentelemetryMetricsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/opentelemetry_metrics#additional_attributes_to_dimension_enabled OpentelemetryMetrics#additional_attributes_to_dimension_enabled}
  */
  readonly additionalAttributesToDimensionEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/opentelemetry_metrics#id OpentelemetryMetrics#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/opentelemetry_metrics#meter_name_to_dimension_enabled OpentelemetryMetrics#meter_name_to_dimension_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/opentelemetry_metrics#mode OpentelemetryMetrics#mode}
  */
  readonly mode?: string;
  /**
  * The scope of this setting (environment-default). Omit this property if you want to cover the whole environment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/opentelemetry_metrics#scope OpentelemetryMetrics#scope}
  */
  readonly scope?: string;
  /**
  * additional_attributes block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/opentelemetry_metrics#additional_attributes OpentelemetryMetrics#additional_attributes}
  */
  readonly additionalAttributes?: OpentelemetryMetricsAdditionalAttributes;
  /**
  * to_drop_attributes block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/opentelemetry_metrics#to_drop_attributes OpentelemetryMetrics#to_drop_attributes}
  */
...
export interface OpentelemetryMetricsAdditionalAttributesAdditionalAttribute {
  ...
  * Attribute key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/opentelemetry_metrics#attribute_key OpentelemetryMetrics#attribute_key}
  */
  readonly attributeKey: string;
  /**
  * This setting is enabled (`true`) or disabled (`false`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/opentelemetry_metrics#enabled OpentelemetryMetrics#enabled}
  */
...
export interface OpentelemetryMetricsAdditionalAttributes {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/opentelemetry_metrics#additional_attribute OpentelemetryMetrics#additional_attribute}
  */
...
export interface OpentelemetryMetricsToDropAttributes {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/opentelemetry_metrics#to_drop_attribute OpentelemetryMetrics#to_drop_attribute}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/opentelemetry_metrics dynatrace_opentelemetry_metrics}
*/
export class OpentelemetryMetrics extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpentelemetryMetrics that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/opentelemetry_metrics#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/opentelemetry_metrics dynatrace_opentelemetry_metrics} Resource
  *
  * @param scope The scope in which to define this construct
