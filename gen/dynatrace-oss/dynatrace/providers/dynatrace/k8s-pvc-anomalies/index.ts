// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/k8s_pvc_anomalies
...
export interface K8SPvcAnomaliesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/k8s_pvc_anomalies#id K8SPvcAnomalies#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/k8s_pvc_anomalies#scope K8SPvcAnomalies#scope}
  */
  readonly scope?: string;
  /**
  * low_disk_space_critical block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/k8s_pvc_anomalies#low_disk_space_critical K8SPvcAnomalies#low_disk_space_critical}
  */
  readonly lowDiskSpaceCritical: K8SPvcAnomaliesLowDiskSpaceCritical;
  /**
  * low_disk_space_critical_percentage block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/k8s_pvc_anomalies#low_disk_space_critical_percentage K8SPvcAnomalies#low_disk_space_critical_percentage}
  */
...
export interface K8SPvcAnomaliesLowDiskSpaceCriticalConfiguration {
  ...
  * within the last
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/k8s_pvc_anomalies#observation_period_in_minutes K8SPvcAnomalies#observation_period_in_minutes}
  */
  readonly observationPeriodInMinutes: number;
  /**
  * for at least
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/k8s_pvc_anomalies#sample_period_in_minutes K8SPvcAnomalies#sample_period_in_minutes}
  */
  readonly samplePeriodInMinutes: number;
  /**
  * the available disk space is below
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/k8s_pvc_anomalies#threshold K8SPvcAnomalies#threshold}
  */
...
export interface K8SPvcAnomaliesLowDiskSpaceCritical {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/k8s_pvc_anomalies#enabled K8SPvcAnomalies#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * configuration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/k8s_pvc_anomalies#configuration K8SPvcAnomalies#configuration}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/k8s_pvc_anomalies dynatrace_k8s_pvc_anomalies}
*/
export class K8SPvcAnomalies extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing K8SPvcAnomalies that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/k8s_pvc_anomalies#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/k8s_pvc_anomalies dynatrace_k8s_pvc_anomalies} Resource
  *
  * @param scope The scope in which to define this construct
