// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules
...
export interface ApplicationErrorRulesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#id ApplicationErrorRules#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#ignore_custom_errors_apdex ApplicationErrorRules#ignore_custom_errors_apdex}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#ignore_http_errors_apdex ApplicationErrorRules#ignore_http_errors_apdex}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#ignore_js_errors_apdex ApplicationErrorRules#ignore_js_errors_apdex}
  */
  readonly ignoreJsErrorsApdex?: boolean | cdktf.IResolvable;
  /**
  * The EntityID of the the WebApplication
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#web_application_id ApplicationErrorRules#web_application_id}
  */
  readonly webApplicationId?: string;
  /**
  * custom_errors block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#custom_errors ApplicationErrorRules#custom_errors}
  */
  readonly customErrors?: ApplicationErrorRulesCustomErrors;
  /**
  * http_errors block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#http_errors ApplicationErrorRules#http_errors}
  */
...
export interface ApplicationErrorRulesCustomErrorsRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#capture ApplicationErrorRules#capture}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#custom_alerting ApplicationErrorRules#custom_alerting}
  */
  readonly customAlerting?: boolean | cdktf.IResolvable;
  /**
  * Include (`true`) or exclude (`false`) the error in Apdex calculation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#impact_apdex ApplicationErrorRules#impact_apdex}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#key_matcher ApplicationErrorRules#key_matcher}
  */
  readonly keyMatcher?: string;
  /**
  * The key of the error to look for
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#key_pattern ApplicationErrorRules#key_pattern}
  */
  readonly keyPattern?: string;
  /**
  * The matching operation for the **valuePattern**. Possible values are `BEGINS_WITH`, `CONTAINS`, `ENDS_WITH` and `EQUALS`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#value_matcher ApplicationErrorRules#value_matcher}
  */
  readonly valueMatcher?: string;
  /**
  * The value of the error to look for
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#value_pattern ApplicationErrorRules#value_pattern}
  */
...
export interface ApplicationErrorRulesCustomErrors {
  ...
  * rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#rule ApplicationErrorRules#rule}
  */
...
export interface ApplicationErrorRulesHttpErrorsRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#consider_blocked_requests ApplicationErrorRules#consider_blocked_requests}
  */
  readonly considerBlockedRequests?: boolean | cdktf.IResolvable;
  /**
  * Include (`true`) or exclude (`false`) the error in Davis AI [problem detection and analysis](https://dt-url.net/a963kd2)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#consider_for_ai ApplicationErrorRules#consider_for_ai}
  */
  readonly considerForAi?: boolean | cdktf.IResolvable;
  /**
  * If `true`, match by errors that have unknown HTTP status code
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#consider_unknown_error_code ApplicationErrorRules#consider_unknown_error_code}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#error_codes ApplicationErrorRules#error_codes}
  */
  readonly errorCodes?: string;
  /**
  * The matching rule for the URL. Popssible values are `BEGINS_WITH`, `CONTAINS`, `ENDS_WITH` and `EQUALS`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#filter ApplicationErrorRules#filter}
  */
  readonly filter?: string;
  /**
  * If `true`, filter errors by URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#filter_by_url ApplicationErrorRules#filter_by_url}
  */
  ...
  * The URL to look for
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#url ApplicationErrorRules#url}
  */
  readonly url?: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules dynatrace_application_error_rules}
*/
export class ApplicationErrorRules extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationErrorRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/application_error_rules dynatrace_application_error_rules} Resource
  *
  * @param scope The scope in which to define this construct
