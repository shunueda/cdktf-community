// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/user_group
...
export interface UserGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/user_group#access_account UserGroup#access_account}
  */
  readonly accessAccount?: boolean | cdktf.IResolvable;
  /**
  * If `true`, then the group has the cluster administrator rights
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/user_group#cluster_admin UserGroup#cluster_admin}
  */
  readonly clusterAdmin?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/user_group#id UserGroup#id}
  *
  ...
  * LDAP group names
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/user_group#ldap_groups UserGroup#ldap_groups}
  */
  readonly ldapGroups?: string[];
  /**
  * If `true`, then the group has the manage account rights
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/user_group#manage_account UserGroup#manage_account}
  */
  readonly manageAccount?: boolean | cdktf.IResolvable;
  /**
  * The name of the user group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/user_group#name UserGroup#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/user_group#sso_groups UserGroup#sso_groups}
  */
  readonly ssoGroups?: string[];
  /**
  * permissions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/user_group#permissions UserGroup#permissions}
  */
...
export interface UserGroupPermissionsGrant {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/user_group#environments UserGroup#environments}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/user_group#permission UserGroup#permission}
  */
...
export interface UserGroupPermissions {
  ...
  * grant block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/user_group#grant UserGroup#grant}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/user_group dynatrace_user_group}
*/
export class UserGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/user_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/user_group dynatrace_user_group} Resource
  *
  * @param scope The scope in which to define this construct
