// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/synthetic_locations
...
export interface DataDynatraceSyntheticLocationsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/synthetic_locations#id DataDynatraceSyntheticLocations#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/synthetic_locations#name DataDynatraceSyntheticLocations#name}
  */
  readonly name?: string;
  /**
  * locations block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/synthetic_locations#locations DataDynatraceSyntheticLocations#locations}
  */
...
export interface DataDynatraceSyntheticLocationsLocations {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/synthetic_locations#cloud_platform DataDynatraceSyntheticLocations#cloud_platform}
  */
  readonly cloudPlatform?: string;
  /**
  * The unique ID of the location
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/synthetic_locations#entity_id DataDynatraceSyntheticLocations#entity_id}
  */
  readonly entityId?: string;
  /**
  * The Dynatrace GeoLocation ID of the location
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/synthetic_locations#geo_location_id DataDynatraceSyntheticLocations#geo_location_id}
  */
  ...
  *  Only applicable to `PUBLIC` locations
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/synthetic_locations#ips DataDynatraceSyntheticLocations#ips}
  */
  readonly ips?: string[];
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/synthetic_locations#stage DataDynatraceSyntheticLocations#stage}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/synthetic_locations#status DataDynatraceSyntheticLocations#status}
  */
  readonly status?: string;
  /**
  * The type of the location. Supported values are `PUBLIC`, `PRIVATE` and `CLUSTER`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/synthetic_locations#type DataDynatraceSyntheticLocations#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/synthetic_locations dynatrace_synthetic_locations}
*/
export class DataDynatraceSyntheticLocations extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDynatraceSyntheticLocations that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/synthetic_locations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/synthetic_locations dynatrace_synthetic_locations} Data Source
  *
  * @param scope The scope in which to define this construct
