// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/mgmz_permission
...
export interface MgmzPermissionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/mgmz_permission#environment MgmzPermission#environment}
  */
  readonly environment: string;
  /**
  * The ID of the group the permissions are valid for. You may refer to the id of a resource `dynatrace_user_group` here
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/mgmz_permission#group MgmzPermission#group}
  */
  readonly group: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/mgmz_permission#id MgmzPermission#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/mgmz_permission#management_zone MgmzPermission#management_zone}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/mgmz_permission#permissions MgmzPermission#permissions}
  */
  readonly permissions: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/mgmz_permission dynatrace_mgmz_permission}
*/
export class MgmzPermission extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MgmzPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/mgmz_permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/mgmz_permission dynatrace_mgmz_permission} Resource
  *
  * @param scope The scope in which to define this construct
