// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/event_driven_ansible_connections
...
export interface EventDrivenAnsibleConnectionsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/event_driven_ansible_connections#event_stream_enabled EventDrivenAnsibleConnections#event_stream_enabled}
  */
  readonly eventStreamEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/event_driven_ansible_connections#id EventDrivenAnsibleConnections#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/event_driven_ansible_connections#name EventDrivenAnsibleConnections#name}
  */
  readonly name: string;
  /**
  * API access token for the Event-Driven Ansible Controller. Please note that this token is not refreshed and can expire.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/event_driven_ansible_connections#token EventDrivenAnsibleConnections#token}
  */
  readonly token?: string;
  /**
  * Possible Values: `Api_token`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/event_driven_ansible_connections#type EventDrivenAnsibleConnections#type}
  */
  readonly type: string;
  /**
  * URL of the Event-Driven Ansible source plugin webhook. For example, https://eda.yourdomain.com:5010
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/event_driven_ansible_connections#url EventDrivenAnsibleConnections#url}
  */
  readonly url: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/event_driven_ansible_connections dynatrace_event_driven_ansible_connections}
*/
export class EventDrivenAnsibleConnections extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EventDrivenAnsibleConnections that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/event_driven_ansible_connections#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/event_driven_ansible_connections dynatrace_event_driven_ansible_connections} Resource
  *
  * @param scope The scope in which to define this construct
