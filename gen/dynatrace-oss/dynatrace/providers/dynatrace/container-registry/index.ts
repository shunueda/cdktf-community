// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/container_registry
...
export interface ContainerRegistryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/container_registry#container_registry ContainerRegistry#container_registry}
  */
  readonly containerRegistry?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/container_registry#id ContainerRegistry#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/container_registry dynatrace_container_registry}
*/
export class ContainerRegistry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContainerRegistry that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/container_registry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/container_registry dynatrace_container_registry} Resource
  *
  * @param scope The scope in which to define this construct
