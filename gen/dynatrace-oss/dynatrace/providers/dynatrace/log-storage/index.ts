// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_storage
...
export interface LogStorageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_storage#enabled LogStorage#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_storage#id LogStorage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_storage#insert_after LogStorage#insert_after}
  */
  readonly insertAfter?: string;
  /**
  * Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_storage#name LogStorage#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_storage#scope LogStorage#scope}
  */
  readonly scope?: string;
  /**
  * If `true` matching logs will be included in storage. If `false` matching logs will be excluded from storage.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_storage#send_to_storage LogStorage#send_to_storage}
  */
  readonly sendToStorage: boolean | cdktf.IResolvable;
  /**
  * matchers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_storage#matchers LogStorage#matchers}
  */
...
export interface LogStorageMatchersMatcher {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_storage#attribute LogStorage#attribute}
  */
  readonly attribute: string;
  /**
  * Possible Values: `MATCHES`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_storage#operator LogStorage#operator}
  */
  readonly operator: string;
  /**
  * no documentation available
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_storage#values LogStorage#values}
  */
...
export interface LogStorageMatchers {
  ...
  * matcher block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_storage#matcher LogStorage#matcher}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_storage dynatrace_log_storage}
*/
export class LogStorage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogStorage that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_storage#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_storage dynatrace_log_storage} Resource
  *
  * @param scope The scope in which to define this construct
