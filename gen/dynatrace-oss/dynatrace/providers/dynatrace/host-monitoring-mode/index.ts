// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring_mode
...
export interface HostMonitoringModeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring_mode#host_id HostMonitoringMode#host_id}
  */
  readonly hostId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring_mode#id HostMonitoringMode#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring_mode#monitoring_mode HostMonitoringMode#monitoring_mode}
  */
  readonly monitoringMode: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring_mode dynatrace_host_monitoring_mode}
*/
export class HostMonitoringMode extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HostMonitoringMode that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring_mode#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring_mode dynatrace_host_monitoring_mode} Resource
  *
  * @param scope The scope in which to define this construct
