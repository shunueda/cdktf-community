// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/settings_permissions
...
export interface SettingsPermissionsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/settings_permissions#all_users SettingsPermissions#all_users}
  */
  readonly allUsers?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/settings_permissions#id SettingsPermissions#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/settings_permissions#settings_object_id SettingsPermissions#settings_object_id}
  */
  readonly settingsObjectId: string;
  /**
  * groups block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/settings_permissions#groups SettingsPermissions#groups}
  */
  readonly groups?: SettingsPermissionsGroups;
  /**
  * users block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/settings_permissions#users SettingsPermissions#users}
  */
...
export interface SettingsPermissionsGroupsGroup {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/settings_permissions#access SettingsPermissions#access}
  */
...
export interface SettingsPermissionsGroups {
  ...
  * group block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/settings_permissions#group SettingsPermissions#group}
  */
...
export interface SettingsPermissionsUsersUser {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/settings_permissions#uid SettingsPermissions#uid}
  */
  readonly uid: string;
}
...
export interface SettingsPermissionsUsers {
  ...
  * user block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/settings_permissions#user SettingsPermissions#user}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/settings_permissions dynatrace_settings_permissions}
*/
export class SettingsPermissions extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SettingsPermissions that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/settings_permissions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/settings_permissions dynatrace_settings_permissions} Resource
  *
  * @param scope The scope in which to define this construct
