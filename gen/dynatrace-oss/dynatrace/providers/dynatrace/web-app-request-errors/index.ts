// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_request_errors
...
export interface WebAppRequestErrorsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_request_errors#id WebAppRequestErrors#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_request_errors#ignore_request_errors_in_apdex_calculation WebAppRequestErrors#ignore_request_errors_in_apdex_calculation}
  */
  readonly ignoreRequestErrorsInApdexCalculation: boolean | cdktf.IResolvable;
  /**
  * The scope of this setting (APPLICATION)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_request_errors#scope WebAppRequestErrors#scope}
  */
  readonly scope: string;
  /**
  * error_rules block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_request_errors#error_rules WebAppRequestErrors#error_rules}
  */
...
export interface WebAppRequestErrorsErrorRulesErrorRuleCaptureSettings {
  ...
  * Capture this error
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_request_errors#capture WebAppRequestErrors#capture}
  */
  readonly capture: boolean | cdktf.IResolvable;
  /**
  * [View more details](https://dt-url.net/hd580p2k)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_request_errors#consider_for_ai WebAppRequestErrors#consider_for_ai}
  */
  readonly considerForAi?: boolean | cdktf.IResolvable;
  /**
  * Include error in Apdex calculations
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_request_errors#impact_apdex WebAppRequestErrors#impact_apdex}
  */
...
export interface WebAppRequestErrorsErrorRulesErrorRuleFilterSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_request_errors#filter WebAppRequestErrors#filter}
  */
  readonly filter?: string;
  /**
  * no documentation available
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_request_errors#url WebAppRequestErrors#url}
  */
  readonly url?: string;
}
...
export interface WebAppRequestErrorsErrorRulesErrorRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_request_errors#consider_csp_violations WebAppRequestErrors#consider_csp_violations}
  */
  readonly considerCspViolations: boolean | cdktf.IResolvable;
  /**
  * Match by errors that have failed image requests
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_request_errors#consider_failed_images WebAppRequestErrors#consider_failed_images}
  */
  readonly considerFailedImages: boolean | cdktf.IResolvable;
  /**
  * Match by error code
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_request_errors#error_codes WebAppRequestErrors#error_codes}
  */
  readonly errorCodes?: string;
  /**
  * capture_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_request_errors#capture_settings WebAppRequestErrors#capture_settings}
  */
  readonly captureSettings: WebAppRequestErrorsErrorRulesErrorRuleCaptureSettings;
  /**
  * filter_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_request_errors#filter_settings WebAppRequestErrors#filter_settings}
  */
...
export interface WebAppRequestErrorsErrorRules {
  ...
  * error_rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_request_errors#error_rule WebAppRequestErrors#error_rule}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_request_errors dynatrace_web_app_request_errors}
*/
export class WebAppRequestErrors extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WebAppRequestErrors that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_request_errors#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_request_errors dynatrace_web_app_request_errors} Resource
  *
  * @param scope The scope in which to define this construct
