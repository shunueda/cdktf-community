// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring
...
export interface HostMonitoringConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring#auto_injection HostMonitoring#auto_injection}
  */
  readonly autoInjection?: boolean | cdktf.IResolvable;
  /**
  * This setting is enabled (`true`) or disabled (`false`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring#enabled HostMonitoring#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring#full_stack HostMonitoring#full_stack}
  */
  readonly fullStack?: boolean | cdktf.IResolvable;
  /**
  * The scope of this settings. If the settings should cover the whole environment, just don't specify any scope.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring#host_id HostMonitoring#host_id}
  */
  readonly hostId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring#id HostMonitoring#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring dynatrace_host_monitoring}
*/
export class HostMonitoring extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HostMonitoring that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring dynatrace_host_monitoring} Resource
  *
  * @param scope The scope in which to define this construct
