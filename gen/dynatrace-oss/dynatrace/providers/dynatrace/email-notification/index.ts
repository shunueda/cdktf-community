// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/email_notification
...
export interface EmailNotificationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/email_notification#active EmailNotification#active}
  */
  readonly active?: boolean | cdktf.IResolvable;
  /**
  * The list of the email BCC-recipients
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/email_notification#bcc EmailNotification#bcc}
  */
  readonly bcc?: string[];
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/email_notification#body EmailNotification#body}
  */
  readonly body: string;
  /**
  * The list of the email CC-recipients
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/email_notification#cc EmailNotification#cc}
  */
  readonly cc?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/email_notification#id EmailNotification#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/email_notification#legacy_id EmailNotification#legacy_id}
  */
  readonly legacyId?: string;
  /**
  * The name of the notification configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/email_notification#name EmailNotification#name}
  */
  readonly name: string;
  /**
  * Send email if problem is closed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/email_notification#notify_closed_problems EmailNotification#notify_closed_problems}
  */
  readonly notifyClosedProblems?: boolean | cdktf.IResolvable;
  /**
  * The ID of the associated alerting profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/email_notification#profile EmailNotification#profile}
  */
  readonly profile: string;
  /**
  * The subject of the email notifications
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/email_notification#subject EmailNotification#subject}
  */
  readonly subject: string;
  /**
  * The list of the email recipients
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/email_notification#to EmailNotification#to}
  */
  readonly to: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/email_notification dynatrace_email_notification}
*/
export class EmailNotification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmailNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/email_notification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/email_notification dynatrace_email_notification} Resource
  *
  * @param scope The scope in which to define this construct
