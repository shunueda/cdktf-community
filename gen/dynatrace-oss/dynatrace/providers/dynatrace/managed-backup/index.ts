// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_backup
...
export interface ManagedBackupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_backup#bandwidth_limit_mbits ManagedBackup#bandwidth_limit_mbits}
  */
  readonly bandwidthLimitMbits?: number;
  /**
  * Hour to start Cassandra backups each day.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_backup#cassandra_scheduled_time ManagedBackup#cassandra_scheduled_time}
  */
  readonly cassandraScheduledTime: number;
  /**
  * For internal use: current state of rules in JSON format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_backup#current_state ManagedBackup#current_state}
  */
  readonly currentState?: string;
  /**
  * Datacenter which will create backups
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_backup#datacenter ManagedBackup#datacenter}
  */
  readonly datacenter?: string;
  /**
  * Backups are enabled (true) or disabled (false).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_backup#enabled ManagedBackup#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_backup#id ManagedBackup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_backup#include_lm20_data ManagedBackup#include_lm20_data}
  */
  readonly includeLm20Data?: boolean | cdktf.IResolvable;
  /**
  * Include user sessions (true) or GDPR compliance (false)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_backup#include_rum_data ManagedBackup#include_rum_data}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_backup#include_ts_metric_data ManagedBackup#include_ts_metric_data}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_backup#max_es_snapshots_to_clean ManagedBackup#max_es_snapshots_to_clean}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_backup#pause_backups ManagedBackup#pause_backups}
  */
  readonly pauseBackups?: boolean | cdktf.IResolvable;
  /**
  * A full path to the backup archive
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_backup#storage_path ManagedBackup#storage_path}
  */
  readonly storagePath?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_backup dynatrace_managed_backup}
*/
export class ManagedBackup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_backup dynatrace_managed_backup} Resource
  *
  * @param scope The scope in which to define this construct
