// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/transaction_start_filters
...
export interface TransactionStartFiltersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/transaction_start_filters#cics_terminal_transaction_ids TransactionStartFilters#cics_terminal_transaction_ids}
  */
  readonly cicsTerminalTransactionIds?: string[];
  /**
  * You can use * as wildcard. For example use A* to trace all transaction IDs that start with A.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/transaction_start_filters#cics_transaction_ids TransactionStartFilters#cics_transaction_ids}
  */
  readonly cicsTransactionIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/transaction_start_filters#id TransactionStartFilters#id}
  *
  ...
  * You can use * as wildcard. For example use A* to trace all transaction IDs that start with A.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/transaction_start_filters#ims_terminal_transaction_ids TransactionStartFilters#ims_terminal_transaction_ids}
  */
  readonly imsTerminalTransactionIds?: string[];
  /**
  * You can use * as wildcard. For example use A* to trace all transaction IDs that start with A.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/transaction_start_filters#ims_transaction_ids TransactionStartFilters#ims_transaction_ids}
  */
  readonly imsTransactionIds?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/transaction_start_filters dynatrace_transaction_start_filters}
*/
export class TransactionStartFilters extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransactionStartFilters that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/transaction_start_filters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/transaction_start_filters dynatrace_transaction_start_filters} Resource
  *
  * @param scope The scope in which to define this construct
