// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_resource_types
...
export interface WebAppResourceTypesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_resource_types#id WebAppResourceTypes#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_resource_types#insert_after WebAppResourceTypes#insert_after}
  */
  readonly insertAfter?: string;
  /**
  * Possible Values: `CSS`, `IMAGE`, `OTHER`, `SCRIPT`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_resource_types#primary_resource_type WebAppResourceTypes#primary_resource_type}
  */
  readonly primaryResourceType: string;
  /**
  * The regular expression to detect the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_resource_types#regular_expression WebAppResourceTypes#regular_expression}
  */
  readonly regularExpression: string;
  /**
  * The secondary type of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_resource_types#secondary_resource_type WebAppResourceTypes#secondary_resource_type}
  */
  readonly secondaryResourceType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_resource_types dynatrace_web_app_resource_types}
*/
export class WebAppResourceTypes extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WebAppResourceTypes that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_resource_types#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_resource_types dynatrace_web_app_resource_types} Resource
  *
  * @param scope The scope in which to define this construct
