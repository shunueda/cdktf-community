// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/url_based_sampling
...
export interface UrlBasedSamplingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/url_based_sampling#enabled UrlBasedSampling#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/url_based_sampling#factor UrlBasedSampling#factor}
  */
  readonly factor?: string;
  /**
  * Possible values: `GET`, `POST`, `PUT`, `DELETE`, `HEAD`, `CONNECT`, `OPTIONS`, `TRACE`, `PATCH`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/url_based_sampling#http_method UrlBasedSampling#http_method}
  */
  readonly httpMethod?: string[];
  /**
  * The scaling factor for the defined URL will be applied to any HTTP method.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/url_based_sampling#http_method_any UrlBasedSampling#http_method_any}
  */
  readonly httpMethodAny: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/url_based_sampling#id UrlBasedSampling#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/url_based_sampling#ignore UrlBasedSampling#ignore}
  */
  readonly ignore: boolean | cdktf.IResolvable;
  /**
  * Because this resource allows for ordering you may specify the ID of the resource instance that comes before this instance regarding order. If not specified when creating the setting will be added to the end of the list. If not specified during update the order will remain untouched
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/url_based_sampling#insert_after UrlBasedSampling#insert_after}
  */
  readonly insertAfter?: string;
  /**
  * Path of the URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/url_based_sampling#path UrlBasedSampling#path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/url_based_sampling#path_comparison_type UrlBasedSampling#path_comparison_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/url_based_sampling#scope UrlBasedSampling#scope}
  */
  readonly scope?: string;
  /**
  * query_parameters block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/url_based_sampling#query_parameters UrlBasedSampling#query_parameters}
  */
...
export interface UrlBasedSamplingQueryParametersParameter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/url_based_sampling#name UrlBasedSampling#name}
  */
  readonly name: string;
  /**
  * Query parameter value
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/url_based_sampling#value UrlBasedSampling#value}
  */
  readonly value?: string;
  /**
  * Query parameter value is undefined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/url_based_sampling#value_is_undefined UrlBasedSampling#value_is_undefined}
  */
...
export interface UrlBasedSamplingQueryParameters {
  ...
  * parameter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/url_based_sampling#parameter UrlBasedSampling#parameter}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/url_based_sampling dynatrace_url_based_sampling}
*/
export class UrlBasedSampling extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UrlBasedSampling that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/url_based_sampling#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/url_based_sampling dynatrace_url_based_sampling} Resource
  *
  * @param scope The scope in which to define this construct
