// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_group_simple_detection
...
export interface ProcessGroupSimpleDetectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_group_simple_detection#enabled ProcessGroupSimpleDetection#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_group_simple_detection#group_identifier ProcessGroupSimpleDetection#group_identifier}
  */
  readonly groupIdentifier: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_group_simple_detection#id ProcessGroupSimpleDetection#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_group_simple_detection#insert_after ProcessGroupSimpleDetection#insert_after}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_group_simple_detection#instance_identifier ProcessGroupSimpleDetection#instance_identifier}
  */
  readonly instanceIdentifier: string;
  /**
  * Note: Not all types can be detected at startup.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_group_simple_detection#process_type ProcessGroupSimpleDetection#process_type}
  */
  readonly processType?: string;
  /**
  * Possible Values: `Prop`, `Env`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_group_simple_detection#rule_type ProcessGroupSimpleDetection#rule_type}
  */
  readonly ruleType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_group_simple_detection dynatrace_process_group_simple_detection}
*/
export class ProcessGroupSimpleDetection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProcessGroupSimpleDetection that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_group_simple_detection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_group_simple_detection dynatrace_process_group_simple_detection} Resource
  *
  * @param scope The scope in which to define this construct
