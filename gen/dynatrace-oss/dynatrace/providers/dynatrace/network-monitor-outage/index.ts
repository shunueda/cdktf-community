// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/network_monitor_outage
...
export interface NetworkMonitorOutageConfig extends cdktf.TerraformMetaArguments {
  /**
  * Alert if all locations are unable to access my target address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/network_monitor_outage#global_consecutive_outage_count_threshold NetworkMonitorOutage#global_consecutive_outage_count_threshold}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/network_monitor_outage#global_outages NetworkMonitorOutage#global_outages}
  */
  readonly globalOutages: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/network_monitor_outage#id NetworkMonitorOutage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/network_monitor_outage#local_consecutive_outage_count_threshold NetworkMonitorOutage#local_consecutive_outage_count_threshold}
  */
  readonly localConsecutiveOutageCountThreshold?: number;
  /**
  * Alert if at least
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/network_monitor_outage#local_location_outage_count_threshold NetworkMonitorOutage#local_location_outage_count_threshold}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/network_monitor_outage#local_outages NetworkMonitorOutage#local_outages}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/network_monitor_outage#scope NetworkMonitorOutage#scope}
  */
  readonly scope?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/network_monitor_outage dynatrace_network_monitor_outage}
*/
export class NetworkMonitorOutage extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "dynatrace_network_monitor_outage";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a NetworkMonitorOutage resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the NetworkMonitorOutage to import
  * @param importFromId The id of the existing NetworkMonitorOutage that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/network_monitor_outage#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the NetworkMonitorOutage to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "dynatrace_network_monitor_outage", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/network_monitor_outage dynatrace_network_monitor_outage} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options NetworkMonitorOutageConfig
  */
  public constructor(scope: Construct, id: string, config: NetworkMonitorOutageConfig) {
    super(scope, id, {
      terraformResourceType: 'dynatrace_network_monitor_outage',
