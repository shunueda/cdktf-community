// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability
...
export interface ProcessAvailabilityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#enabled ProcessAvailability#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#id ProcessAvailability#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#insert_after ProcessAvailability#insert_after}
  */
  readonly insertAfter?: string;
  /**
  * Specify a minimum number of processes matching the monitoring rule. If it's not satisfied, an alert will open.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#minimum_processes ProcessAvailability#minimum_processes}
  */
  readonly minimumProcesses?: number;
  /**
  * Monitoring rule name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#name ProcessAvailability#name}
  */
  readonly name: string;
  /**
  * Select the operating systems on which the monitoring rule should be applied.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#operating_system ProcessAvailability#operating_system}
  */
  readonly operatingSystem?: string[];
  /**
  * The scope of this setting (HOST, HOST_GROUP). Omit this property if you want to cover the whole environment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#scope ProcessAvailability#scope}
  */
  readonly scope?: string;
  /**
  * metadata block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#metadata ProcessAvailability#metadata}
  */
  readonly metadata?: ProcessAvailabilityMetadata;
  /**
  * rules block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#rules ProcessAvailability#rules}
  */
...
export interface ProcessAvailabilityMetadataItem {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#key ProcessAvailability#key}
  */
  readonly key: string;
  /**
  * no documentation available
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#value ProcessAvailability#value}
  */
...
export interface ProcessAvailabilityMetadata {
  ...
  * item block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#item ProcessAvailability#item}
  */
...
export interface ProcessAvailabilityRulesRuleHostMetadataCondition {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#key_must_exist ProcessAvailability#key_must_exist}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#metadata_condition ProcessAvailability#metadata_condition}
  */
  readonly metadataCondition: string;
  /**
  * Key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#metadata_key ProcessAvailability#metadata_key}
  */
...
export interface ProcessAvailabilityRulesRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#condition ProcessAvailability#condition}
  */
  readonly condition?: string;
  /**
  * Possible Values: `CommandLine`, `Executable`, `ExecutablePath`, `User`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#property ProcessAvailability#property}
  */
  readonly property?: string;
  /**
  * Possible Values: `RuleTypeHost`, `RuleTypeProcess`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#rule_type ProcessAvailability#rule_type}
  */
  readonly ruleType?: string;
  /**
  * host_metadata_condition block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#host_metadata_condition ProcessAvailability#host_metadata_condition}
  */
...
export interface ProcessAvailabilityRules {
  ...
  * rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#rule ProcessAvailability#rule}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability dynatrace_process_availability}
*/
export class ProcessAvailability extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProcessAvailability that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_availability dynatrace_process_availability} Resource
  *
  * @param scope The scope in which to define this construct
