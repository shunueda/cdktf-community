// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/entities
...
export interface DataDynatraceEntitiesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/entities#entity_selector DataDynatraceEntities#entity_selector}
  */
  ...
  *     - `y` for years
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/entities#from DataDynatraceEntities#from}
  */
  readonly from?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/entities#id DataDynatraceEntities#id}
  *
  ...
  *     - `y` for years
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/entities#to DataDynatraceEntities#to}
  */
  readonly to?: string;
  /**
  * The type of the entities to find, e.g. `HOST`. You cannot use `type` and `entity_selector` at the same time
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/entities#type DataDynatraceEntities#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/entities dynatrace_entities}
*/
export class DataDynatraceEntities extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDynatraceEntities that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/entities#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/entities dynatrace_entities} Data Source
  *
  * @param scope The scope in which to define this construct
