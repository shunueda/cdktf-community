// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships
...
export interface GenericRelationshipsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships#created_by GenericRelationships#created_by}
  */
  readonly createdBy: string;
  /**
  * This setting is enabled (`true`) or disabled (`false`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships#enabled GenericRelationships#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships#from_role GenericRelationships#from_role}
  */
  readonly fromRole?: string;
  /**
  * Define an entity type as the source of the relationship.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships#from_type GenericRelationships#from_type}
  */
  readonly fromType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships#id GenericRelationships#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships#to_role GenericRelationships#to_role}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships#to_type GenericRelationships#to_type}
  */
  readonly toType: string;
  /**
  * Possible Values: `CALLS`, `CHILD_OF`, `INSTANCE_OF`, `PART_OF`, `RUNS_ON`, `SAME_AS`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships#type_of_relation GenericRelationships#type_of_relation}
  */
  readonly typeOfRelation: string;
  /**
  * sources block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships#sources GenericRelationships#sources}
  */
...
export interface GenericRelationshipsSourcesSourceMappingRulesMappingRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships#destination_property GenericRelationships#destination_property}
  */
  readonly destinationProperty: string;
  /**
  * Possible Values: `Leavetextas_is`, `Tolowercase`, `Touppercase`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships#destination_transformation GenericRelationships#destination_transformation}
  */
  readonly destinationTransformation: string;
  /**
  * The case-sensitive name of a property of the source type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships#source_property GenericRelationships#source_property}
  */
  readonly sourceProperty: string;
  /**
  * Possible Values: `Leavetextas_is`, `Tolowercase`, `Touppercase`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships#source_transformation GenericRelationships#source_transformation}
  */
...
export interface GenericRelationshipsSourcesSourceMappingRules {
  ...
  * mapping_rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships#mapping_rule GenericRelationships#mapping_rule}
  */
...
export interface GenericRelationshipsSourcesSource {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships#condition GenericRelationships#condition}
  */
  readonly condition?: string;
  /**
  * Possible Values: `BusinessEvents`, `Entities`, `Events`, `Logs`, `Metrics`, `Spans`, `Topology`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships#source_type GenericRelationships#source_type}
  */
  readonly sourceType: string;
  /**
  * mapping_rules block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships#mapping_rules GenericRelationships#mapping_rules}
  */
...
export interface GenericRelationshipsSources {
  ...
  * source block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships#source GenericRelationships#source}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships dynatrace_generic_relationships}
*/
export class GenericRelationships extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GenericRelationships that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/generic_relationships dynatrace_generic_relationships} Resource
  *
  * @param scope The scope in which to define this construct
