// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/lambda_agent_version
...
export interface DataDynatraceLambdaAgentVersionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/lambda_agent_version#collector DataDynatraceLambdaAgentVersion#collector}
  */
  readonly collector?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/lambda_agent_version#id DataDynatraceLambdaAgentVersion#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/lambda_agent_version#java DataDynatraceLambdaAgentVersion#java}
  */
  readonly java?: string;
  /**
  * Latest version name of Java code module with log collector
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/lambda_agent_version#java_with_collector DataDynatraceLambdaAgentVersion#java_with_collector}
  */
  readonly javaWithCollector?: string;
  /**
  * Latest version name of NodeJS code module
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/lambda_agent_version#nodejs DataDynatraceLambdaAgentVersion#nodejs}
  */
  readonly nodejs?: string;
  /**
  * Latest version name of NodeJS code module with log collector
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/lambda_agent_version#nodejs_with_collector DataDynatraceLambdaAgentVersion#nodejs_with_collector}
  */
  readonly nodejsWithCollector?: string;
  /**
  * Latest version name of Python code module
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/lambda_agent_version#python DataDynatraceLambdaAgentVersion#python}
  */
  readonly python?: string;
  /**
  * Latest version name of Python code module with log collector
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/lambda_agent_version#python_with_collector DataDynatraceLambdaAgentVersion#python_with_collector}
  */
  readonly pythonWithCollector?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/lambda_agent_version dynatrace_lambda_agent_version}
*/
export class DataDynatraceLambdaAgentVersion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDynatraceLambdaAgentVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/lambda_agent_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/data-sources/lambda_agent_version dynatrace_lambda_agent_version} Data Source
  *
  * @param scope The scope in which to define this construct
