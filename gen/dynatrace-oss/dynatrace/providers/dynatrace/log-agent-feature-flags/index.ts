// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_agent_feature_flags
...
export interface LogAgentFeatureFlagsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_agent_feature_flags#id LogAgentFeatureFlags#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_agent_feature_flags#journald_log_detector LogAgentFeatureFlags#journald_log_detector}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_agent_feature_flags#new_container_log_detector LogAgentFeatureFlags#new_container_log_detector}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_agent_feature_flags#scope LogAgentFeatureFlags#scope}
  */
  readonly scope?: string;
  /**
  * Enable OneAgent to collect data from Event Logs in the User Data and Event Data sections.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_agent_feature_flags#user_and_event_data LogAgentFeatureFlags#user_and_event_data}
  */
  readonly userAndEventData?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_agent_feature_flags dynatrace_log_agent_feature_flags}
*/
export class LogAgentFeatureFlags extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogAgentFeatureFlags that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_agent_feature_flags#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/log_agent_feature_flags dynatrace_log_agent_feature_flags} Resource
  *
  * @param scope The scope in which to define this construct
