// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/attributes_preferences
...
export interface AttributesPreferencesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/attributes_preferences#id AttributesPreferences#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/attributes_preferences#persistence_mode AttributesPreferences#persistence_mode}
  */
  readonly persistenceMode: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/attributes_preferences dynatrace_attributes_preferences}
*/
export class AttributesPreferences extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AttributesPreferences that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/attributes_preferences#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/attributes_preferences dynatrace_attributes_preferences} Resource
  *
  * @param scope The scope in which to define this construct
