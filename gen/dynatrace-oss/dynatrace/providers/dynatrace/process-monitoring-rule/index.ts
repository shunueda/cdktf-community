// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_monitoring_rule
...
export interface ProcessMonitoringRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_monitoring_rule#enabled ProcessMonitoringRule#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * The scope of this settings. If the settings should cover the whole environment, just don't specify any scope
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_monitoring_rule#host_group_id ProcessMonitoringRule#host_group_id}
  */
  readonly hostGroupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_monitoring_rule#id ProcessMonitoringRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_monitoring_rule#insert_after ProcessMonitoringRule#insert_after}
  */
  readonly insertAfter?: string;
  /**
  * Possible Values: `MONITORING_ON`, `MONITORING_OFF`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_monitoring_rule#mode ProcessMonitoringRule#mode}
  */
  readonly mode: string;
  /**
  * condition block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_monitoring_rule#condition ProcessMonitoringRule#condition}
  */
...
export interface ProcessMonitoringRuleCondition {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_monitoring_rule#env_var ProcessMonitoringRule#env_var}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_monitoring_rule#item ProcessMonitoringRule#item}
  */
  readonly item: string;
  /**
  * Possible Values: `CONTAINS`, `ENDS`, `EQUALS`, `EXISTS`, `NOT_CONTAINS`, `NOT_ENDS`, `NOT_EQUALS`, `NOT_EXISTS`, `NOT_STARTS`, `STARTS`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_monitoring_rule#operator ProcessMonitoringRule#operator}
  */
  readonly operator: string;
  /**
  * Condition value
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_monitoring_rule#value ProcessMonitoringRule#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_monitoring_rule dynatrace_process_monitoring_rule}
*/
export class ProcessMonitoringRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProcessMonitoringRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_monitoring_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/process_monitoring_rule dynatrace_process_monitoring_rule} Resource
  *
  * @param scope The scope in which to define this construct
