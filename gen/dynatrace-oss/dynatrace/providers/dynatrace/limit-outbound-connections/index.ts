// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/limit_outbound_connections
...
export interface LimitOutboundConnectionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/limit_outbound_connections#id LimitOutboundConnections#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/limit_outbound_connections#allowed_outbound_connections LimitOutboundConnections#allowed_outbound_connections}
  */
...
export interface LimitOutboundConnectionsAllowedOutboundConnections {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/limit_outbound_connections#enforced LimitOutboundConnections#enforced}
  */
  readonly enforced: boolean | cdktf.IResolvable;
  /**
  * The Dynatrace JavaScript runtime will only be to connect to these hosts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/limit_outbound_connections#host_list LimitOutboundConnections#host_list}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/limit_outbound_connections dynatrace_limit_outbound_connections}
*/
export class LimitOutboundConnections extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LimitOutboundConnections that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/limit_outbound_connections#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/limit_outbound_connections dynatrace_limit_outbound_connections} Resource
  *
  * @param scope The scope in which to define this construct
