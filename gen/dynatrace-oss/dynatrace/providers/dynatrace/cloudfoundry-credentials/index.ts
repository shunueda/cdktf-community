// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/cloudfoundry_credentials
...
export interface CloudfoundryCredentialsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/cloudfoundry_credentials#active CloudfoundryCredentials#active}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/cloudfoundry_credentials#api_url CloudfoundryCredentials#api_url}
  */
  readonly apiUrl: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/cloudfoundry_credentials#id CloudfoundryCredentials#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/cloudfoundry_credentials#login_url CloudfoundryCredentials#login_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/cloudfoundry_credentials#name CloudfoundryCredentials#name}
  */
  readonly name: string;
  /**
  * The password of the Cloud Foundry foundation credentials.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/cloudfoundry_credentials#password CloudfoundryCredentials#password}
  */
  readonly password?: string;
  /**
  * Any attributes that aren't yet supported by this provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/cloudfoundry_credentials#unknowns CloudfoundryCredentials#unknowns}
  */
  readonly unknowns?: string;
  /**
  * The username of the Cloud Foundry foundation credentials.  Leading and trailing whitespaces are not allowed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/cloudfoundry_credentials#username CloudfoundryCredentials#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/cloudfoundry_credentials dynatrace_cloudfoundry_credentials}
*/
export class CloudfoundryCredentials extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudfoundryCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/cloudfoundry_credentials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/cloudfoundry_credentials dynatrace_cloudfoundry_credentials} Resource
  *
  * @param scope The scope in which to define this construct
