// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_custom_errors
...
export interface WebAppCustomErrorsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_custom_errors#id WebAppCustomErrors#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_custom_errors#ignore_custom_errors_in_apdex_calculation WebAppCustomErrors#ignore_custom_errors_in_apdex_calculation}
  */
  readonly ignoreCustomErrorsInApdexCalculation: boolean | cdktf.IResolvable;
  /**
  * The scope of this setting (APPLICATION)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_custom_errors#scope WebAppCustomErrors#scope}
  */
  readonly scope: string;
  /**
  * error_rules block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_custom_errors#error_rules WebAppCustomErrors#error_rules}
  */
...
export interface WebAppCustomErrorsErrorRulesErrorRuleCaptureSettings {
  ...
  * Capture this error
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_custom_errors#capture WebAppCustomErrors#capture}
  */
  readonly capture: boolean | cdktf.IResolvable;
  /**
  * [View more details](https://dt-url.net/hd580p2k)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_custom_errors#consider_for_ai WebAppCustomErrors#consider_for_ai}
  */
  readonly considerForAi?: boolean | cdktf.IResolvable;
  /**
  * Include error in Apdex calculations
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_custom_errors#impact_apdex WebAppCustomErrors#impact_apdex}
  */
...
export interface WebAppCustomErrorsErrorRulesErrorRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_custom_errors#key_matcher WebAppCustomErrors#key_matcher}
  */
  readonly keyMatcher: string;
  /**
  * A case-insensitive key pattern
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_custom_errors#key_pattern WebAppCustomErrors#key_pattern}
  */
  readonly keyPattern?: string;
  /**
  * Possible Values: `ALL`, `BEGINS_WITH`, `CONTAINS`, `ENDS_WITH`, `EQUALS`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_custom_errors#value_matcher WebAppCustomErrors#value_matcher}
  */
  readonly valueMatcher: string;
  /**
  * A case-insensitive value pattern
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_custom_errors#value_pattern WebAppCustomErrors#value_pattern}
  */
  readonly valuePattern?: string;
  /**
  * capture_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_custom_errors#capture_settings WebAppCustomErrors#capture_settings}
  */
...
export interface WebAppCustomErrorsErrorRules {
  ...
  * error_rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_custom_errors#error_rule WebAppCustomErrors#error_rule}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_custom_errors dynatrace_web_app_custom_errors}
*/
export class WebAppCustomErrors extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WebAppCustomErrors that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_custom_errors#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/web_app_custom_errors dynatrace_web_app_custom_errors} Resource
  *
  * @param scope The scope in which to define this construct
