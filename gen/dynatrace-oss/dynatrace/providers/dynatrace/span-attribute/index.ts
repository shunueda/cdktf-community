// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/span_attribute
...
export interface SpanAttributeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/span_attribute#id SpanAttribute#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/span_attribute#key SpanAttribute#key}
  */
  readonly key: string;
  /**
  * Possible Values: `MASK_ENTIRE_VALUE`, `MASK_ONLY_CONFIDENTIAL_DATA`, `NOT_MASKED`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/span_attribute#masking SpanAttribute#masking}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/span_attribute#persistent SpanAttribute#persistent}
  */
  readonly persistent?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/span_attribute dynatrace_span_attribute}
*/
export class SpanAttribute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpanAttribute that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/span_attribute#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/span_attribute dynatrace_span_attribute} Resource
  *
  * @param scope The scope in which to define this construct
