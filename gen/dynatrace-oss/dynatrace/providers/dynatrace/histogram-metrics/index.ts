// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/histogram_metrics
...
export interface HistogramMetricsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/histogram_metrics#enable_histogram_bucket_ingest HistogramMetrics#enable_histogram_bucket_ingest}
  */
  readonly enableHistogramBucketIngest: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/histogram_metrics#id HistogramMetrics#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/histogram_metrics dynatrace_histogram_metrics}
*/
export class HistogramMetrics extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HistogramMetrics that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/histogram_metrics#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/histogram_metrics dynatrace_histogram_metrics} Resource
  *
  * @param scope The scope in which to define this construct
