// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/http_monitor_outage
...
export interface HttpMonitorOutageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/http_monitor_outage#global_consecutive_outage_count_threshold HttpMonitorOutage#global_consecutive_outage_count_threshold}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/http_monitor_outage#global_outages HttpMonitorOutage#global_outages}
  */
  readonly globalOutages: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/http_monitor_outage#id HttpMonitorOutage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/http_monitor_outage#local_consecutive_outage_count_threshold HttpMonitorOutage#local_consecutive_outage_count_threshold}
  */
  readonly localConsecutiveOutageCountThreshold?: number;
  /**
  * (Field has overlap with `dynatrace_http_monitor`) Alert if at least
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/http_monitor_outage#local_location_outage_count_threshold HttpMonitorOutage#local_location_outage_count_threshold}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/http_monitor_outage#local_outages HttpMonitorOutage#local_outages}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/http_monitor_outage#scope HttpMonitorOutage#scope}
  */
  readonly scope?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/http_monitor_outage dynatrace_http_monitor_outage}
*/
export class HttpMonitorOutage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HttpMonitorOutage that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/http_monitor_outage#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/http_monitor_outage dynatrace_http_monitor_outage} Resource
  *
  * @param scope The scope in which to define this construct
