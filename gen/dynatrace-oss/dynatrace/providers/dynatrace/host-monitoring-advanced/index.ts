// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring_advanced
...
export interface HostMonitoringAdvancedConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring_advanced#code_module_injection HostMonitoringAdvanced#code_module_injection}
  */
  readonly codeModuleInjection?: boolean | cdktf.IResolvable;
  /**
  * The scope of this settings. If the settings should cover the whole environment, just don't specify any scope.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring_advanced#host_id HostMonitoringAdvanced#host_id}
  */
  readonly hostId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring_advanced#id HostMonitoringAdvanced#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring_advanced#process_agent_injection HostMonitoringAdvanced#process_agent_injection}
  */
  readonly processAgentInjection: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring_advanced dynatrace_host_monitoring_advanced}
*/
export class HostMonitoringAdvanced extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HostMonitoringAdvanced that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring_advanced#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/host_monitoring_advanced dynatrace_host_monitoring_advanced} Resource
  *
  * @param scope The scope in which to define this construct
