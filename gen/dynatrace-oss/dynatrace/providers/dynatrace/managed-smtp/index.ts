// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_smtp
...
export interface ManagedSmtpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_smtp#allow_fallback_via_mission_control ManagedSmtp#allow_fallback_via_mission_control}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_smtp#connection_security ManagedSmtp#connection_security}
  */
  readonly connectionSecurity?: string;
  /**
  * Host Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_smtp#host_name ManagedSmtp#host_name}
  */
  readonly hostName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_smtp#id ManagedSmtp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_smtp#is_password_configured ManagedSmtp#is_password_configured}
  */
  readonly isPasswordConfigured?: boolean | cdktf.IResolvable;
  /**
  * Password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_smtp#password ManagedSmtp#password}
  */
  readonly password: string;
  /**
  * Integer value of port. Default: `25`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_smtp#port ManagedSmtp#port}
  */
  readonly port?: number;
  /**
  * Sender email address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_smtp#sender_email_address ManagedSmtp#sender_email_address}
  */
  readonly senderEmailAddress: string;
  /**
  * If true, we will send e-mails via SMTP server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_smtp#use_smtp_server ManagedSmtp#use_smtp_server}
  */
  readonly useSmtpServer?: boolean | cdktf.IResolvable;
  /**
  * User Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_smtp#user_name ManagedSmtp#user_name}
  */
  readonly userName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_smtp dynatrace_managed_smtp}
*/
export class ManagedSmtp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedSmtp that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_smtp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_smtp dynatrace_managed_smtp} Resource
  *
  * @param scope The scope in which to define this construct
