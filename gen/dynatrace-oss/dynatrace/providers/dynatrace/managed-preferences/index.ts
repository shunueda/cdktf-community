// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_preferences
...
export interface ManagedPreferencesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Default: `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_preferences#certificate_management_enabled ManagedPreferences#certificate_management_enabled}
  */
  readonly certificateManagementEnabled?: boolean | cdktf.IResolvable;
  /**
  * Default: `true`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_preferences#certificate_management_possible ManagedPreferences#certificate_management_possible}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_preferences#community_create_user ManagedPreferences#community_create_user}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_preferences#community_external_search ManagedPreferences#community_external_search}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_preferences#help_chat_enabled ManagedPreferences#help_chat_enabled}
  */
  readonly helpChatEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_preferences#id ManagedPreferences#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_preferences#read_only_remote_access_allowed ManagedPreferences#read_only_remote_access_allowed}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_preferences#remote_access_on_demand_only ManagedPreferences#remote_access_on_demand_only}
  */
  readonly remoteAccessOnDemandOnly?: boolean | cdktf.IResolvable;
  /**
  * If true, Dynatrace OneAgent monitors Dynatrace. Default: `true`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_preferences#ruxit_monitors_ruxit ManagedPreferences#ruxit_monitors_ruxit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_preferences#support_allow_remote_access ManagedPreferences#support_allow_remote_access}
  */
  readonly supportAllowRemoteAccess?: boolean | cdktf.IResolvable;
  /**
  * If true, usage and billing information will be reported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_preferences#support_send_billing ManagedPreferences#support_send_billing}
  */
  readonly supportSendBilling: boolean | cdktf.IResolvable;
  /**
  * If true, Dynatrace cluster health will be reported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_preferences#support_send_cluster_health ManagedPreferences#support_send_cluster_health}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_preferences#support_send_events ManagedPreferences#support_send_events}
  */
  readonly supportSendEvents?: boolean | cdktf.IResolvable;
  /**
  * If true, usage and billing information will NOT be reported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_preferences#suppress_non_billing_relevant_data ManagedPreferences#suppress_non_billing_relevant_data}
  */
  readonly suppressNonBillingRelevantData: boolean | cdktf.IResolvable;
  /**
  * Default: `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_preferences#telemetry_sharing ManagedPreferences#telemetry_sharing}
  */
  readonly telemetrySharing?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_preferences dynatrace_managed_preferences}
*/
export class ManagedPreferences extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedPreferences that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_preferences#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/managed_preferences dynatrace_managed_preferences} Resource
  *
  * @param scope The scope in which to define this construct
