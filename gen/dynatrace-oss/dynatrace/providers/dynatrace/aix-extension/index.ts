// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/aix_extension
...
export interface AixExtensionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/aix_extension#enabled AixExtension#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The scope of this settings. If the settings should cover the whole environment, just don't specify any scope.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/aix_extension#host_id AixExtension#host_id}
  */
  readonly hostId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/aix_extension#id AixExtension#id}
  *
  ...
  * Use global settings
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/aix_extension#use_global_settings AixExtension#use_global_settings}
  */
  readonly useGlobalSettings: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/aix_extension dynatrace_aix_extension}
*/
export class AixExtension extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AixExtension that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/aix_extension#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/aix_extension dynatrace_aix_extension} Resource
  *
  * @param scope The scope in which to define this construct
