// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/oneagent_side_masking
...
export interface OneagentSideMaskingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/oneagent_side_masking#id OneagentSideMasking#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/oneagent_side_masking#is_email_masking_enabled OneagentSideMasking#is_email_masking_enabled}
  */
  readonly isEmailMaskingEnabled: boolean | cdktf.IResolvable;
  /**
  * Exclude IBANs and payment card numbers from URLs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/oneagent_side_masking#is_financial_masking_enabled OneagentSideMasking#is_financial_masking_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/oneagent_side_masking#is_numbers_masking_enabled OneagentSideMasking#is_numbers_masking_enabled}
  */
  readonly isNumbersMaskingEnabled: boolean | cdktf.IResolvable;
  /**
  * Exclude query parameters from URLs and web requests
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/oneagent_side_masking#is_query_masking_enabled OneagentSideMasking#is_query_masking_enabled}
  */
  readonly isQueryMaskingEnabled: boolean | cdktf.IResolvable;
  /**
  * The scope of this settings. If the settings should cover the whole environment, just don't specify any scope.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/oneagent_side_masking#process_group_id OneagentSideMasking#process_group_id}
  */
  readonly processGroupId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/oneagent_side_masking dynatrace_oneagent_side_masking}
*/
export class OneagentSideMasking extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OneagentSideMasking that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/oneagent_side_masking#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/oneagent_side_masking dynatrace_oneagent_side_masking} Resource
  *
  * @param scope The scope in which to define this construct
