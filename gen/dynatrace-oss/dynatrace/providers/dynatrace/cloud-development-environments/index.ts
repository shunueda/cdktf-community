// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/cloud_development_environments
...
export interface CloudDevelopmentEnvironmentsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/cloud_development_environments#cloud_development_environments CloudDevelopmentEnvironments#cloud_development_environments}
  */
  readonly cloudDevelopmentEnvironments?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/cloud_development_environments#id CloudDevelopmentEnvironments#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/cloud_development_environments dynatrace_cloud_development_environments}
*/
export class CloudDevelopmentEnvironments extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudDevelopmentEnvironments that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/cloud_development_environments#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/cloud_development_environments dynatrace_cloud_development_environments} Resource
  *
  * @param scope The scope in which to define this construct
