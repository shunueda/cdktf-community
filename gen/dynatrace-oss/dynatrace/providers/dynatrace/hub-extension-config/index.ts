// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/hub_extension_config
...
export interface HubExtensionConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/hub_extension_config#active_gate_group HubExtensionConfig#active_gate_group}
  */
  readonly activeGateGroup?: string;
  /**
  * The ID of the host this monitoring configuration will be defined for
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/hub_extension_config#host HubExtensionConfig#host}
  */
  readonly host?: string;
  /**
  * The ID of the host group this monitoring configuration will be defined for
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/hub_extension_config#host_group HubExtensionConfig#host_group}
  */
  readonly hostGroup?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/hub_extension_config#id HubExtensionConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/hub_extension_config#management_zone HubExtensionConfig#management_zone}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/hub_extension_config#name HubExtensionConfig#name}
  */
  readonly name: string;
  /**
  * The JSON encoded value for this monitoring configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/hub_extension_config#value HubExtensionConfig#value}
  */
  readonly value: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/hub_extension_config dynatrace_hub_extension_config}
*/
export class HubExtensionConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HubExtensionConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/hub_extension_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.86.0/docs/resources/hub_extension_config dynatrace_hub_extension_config} Resource
  *
  * @param scope The scope in which to define this construct
