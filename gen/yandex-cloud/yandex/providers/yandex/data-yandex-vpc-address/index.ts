// https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/vpc_address
...
export interface DataYandexVpcAddressConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID of the address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/vpc_address#address_id DataYandexVpcAddress#address_id}
  */
  readonly addressId?: string;
  /**
  * The folder identifier that resource belongs to. If it is not provided, the default provider `folder-id` is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/vpc_address#folder_id DataYandexVpcAddress#folder_id}
  */
  readonly folderId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/vpc_address#id DataYandexVpcAddress#id}
  *
  ...
  * The resource name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/vpc_address#name DataYandexVpcAddress#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/vpc_address yandex_vpc_address}
*/
export class DataYandexVpcAddress extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataYandexVpcAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/vpc_address#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/vpc_address yandex_vpc_address} Data Source
  *
  * @param scope The scope in which to define this construct
