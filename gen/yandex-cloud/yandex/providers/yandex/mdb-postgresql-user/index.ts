// https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user
...
export interface MdbPostgresqlUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user#cluster_id MdbPostgresqlUser#cluster_id}
  */
  readonly clusterId: string;
  /**
  * The maximum number of connections per user. (Default 50).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user#conn_limit MdbPostgresqlUser#conn_limit}
  */
  readonly connLimit?: number;
  /**
  * The `true` value means that resource is protected from accidental deletion.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user#deletion_protection MdbPostgresqlUser#deletion_protection}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user#generate_password MdbPostgresqlUser#generate_password}
  */
  readonly generatePassword?: boolean | cdktf.IResolvable;
  /**
  * List of the user's grants.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user#grants MdbPostgresqlUser#grants}
  */
  readonly grants?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user#id MdbPostgresqlUser#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user#login MdbPostgresqlUser#login}
  */
  readonly login?: boolean | cdktf.IResolvable;
  /**
  * The name of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user#name MdbPostgresqlUser#name}
  */
  readonly name: string;
  /**
  * The password of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user#password MdbPostgresqlUser#password}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user#settings MdbPostgresqlUser#settings}
  */
  readonly settings?: { [key: string]: string };
  /**
  * permission block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user#permission MdbPostgresqlUser#permission}
  */
  readonly permission?: MdbPostgresqlUserPermission[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user#timeouts MdbPostgresqlUser#timeouts}
  */
...
export interface MdbPostgresqlUserPermission {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user#database_name MdbPostgresqlUser#database_name}
  */
...
export function mdbPostgresqlUserPermissionToHclTerraform(struct?: MdbPostgresqlUserPermission | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface MdbPostgresqlUserTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user#create MdbPostgresqlUser#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user#delete MdbPostgresqlUser#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user#read MdbPostgresqlUser#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user#update MdbPostgresqlUser#update}
  */
  readonly update?: string;
}

export function mdbPostgresqlUserTimeoutsToTerraform(struct?: MdbPostgresqlUserTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function mdbPostgresqlUserTimeoutsToHclTerraform(struct?: MdbPostgresqlUserTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user yandex_mdb_postgresql_user}
*/
export class MdbPostgresqlUser extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a MdbPostgresqlUser resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the MdbPostgresqlUser to import
  * @param importFromId The id of the existing MdbPostgresqlUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the MdbPostgresqlUser to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_postgresql_user yandex_mdb_postgresql_user} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      permission: {
        value: cdktf.listMapperHcl(mdbPostgresqlUserPermissionToHclTerraform, true)(this._permission.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "MdbPostgresqlUserPermissionList",
      },
      timeouts: {
        value: mdbPostgresqlUserTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "MdbPostgresqlUserTimeouts",
      },
    };
