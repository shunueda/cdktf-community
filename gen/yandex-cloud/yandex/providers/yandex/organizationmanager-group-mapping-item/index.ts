// https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/organizationmanager_group_mapping_item
...
export interface OrganizationmanagerGroupMappingItemConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/organizationmanager_group_mapping_item#external_group_id OrganizationmanagerGroupMappingItem#external_group_id}
  */
  readonly externalGroupId: string;
  /**
  * ID of the SAML Federation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/organizationmanager_group_mapping_item#federation_id OrganizationmanagerGroupMappingItem#federation_id}
  */
  readonly federationId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/organizationmanager_group_mapping_item#id OrganizationmanagerGroupMappingItem#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/organizationmanager_group_mapping_item#internal_group_id OrganizationmanagerGroupMappingItem#internal_group_id}
  */
  readonly internalGroupId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/organizationmanager_group_mapping_item#timeouts OrganizationmanagerGroupMappingItem#timeouts}
  */
...
export interface OrganizationmanagerGroupMappingItemTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/organizationmanager_group_mapping_item#create OrganizationmanagerGroupMappingItem#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/organizationmanager_group_mapping_item#delete OrganizationmanagerGroupMappingItem#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/organizationmanager_group_mapping_item#read OrganizationmanagerGroupMappingItem#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/organizationmanager_group_mapping_item yandex_organizationmanager_group_mapping_item}
*/
export class OrganizationmanagerGroupMappingItem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationmanagerGroupMappingItem that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/organizationmanager_group_mapping_item#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/organizationmanager_group_mapping_item yandex_organizationmanager_group_mapping_item} Resource
  *
  * @param scope The scope in which to define this construct
