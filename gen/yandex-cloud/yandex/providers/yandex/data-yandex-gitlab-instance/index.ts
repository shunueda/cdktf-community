// https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/gitlab_instance
...
export interface DataYandexGitlabInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/gitlab_instance#approval_rules_id DataYandexGitlabInstance#approval_rules_id}
  */
  readonly approvalRulesId?: string;
  /**
  * Approval rules token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/gitlab_instance#approval_rules_token DataYandexGitlabInstance#approval_rules_token}
  */
  readonly approvalRulesToken?: string;
  /**
  * The `true` value means that resource is protected from accidental deletion.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/gitlab_instance#deletion_protection DataYandexGitlabInstance#deletion_protection}
  */
  readonly deletionProtection?: boolean | cdktf.IResolvable;
  /**
  * The resource description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/gitlab_instance#description DataYandexGitlabInstance#description}
  */
  readonly description?: string;
  /**
  * The folder identifier that resource belongs to. If it is not provided, the default provider `folder-id` is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/gitlab_instance#folder_id DataYandexGitlabInstance#folder_id}
  */
  readonly folderId?: string;
  /**
  * The resource identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/gitlab_instance#id DataYandexGitlabInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/gitlab_instance#labels DataYandexGitlabInstance#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The `true` value means that untagged images will be deleted during maintenance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/gitlab_instance#maintenance_delete_untagged DataYandexGitlabInstance#maintenance_delete_untagged}
  */
  readonly maintenanceDeleteUntagged?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/gitlab_instance#timeouts DataYandexGitlabInstance#timeouts}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/gitlab_instance yandex_gitlab_instance}
*/
export class DataYandexGitlabInstance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataYandexGitlabInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/gitlab_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/data-sources/gitlab_instance yandex_gitlab_instance} Data Source
  *
  * @param scope The scope in which to define this construct
