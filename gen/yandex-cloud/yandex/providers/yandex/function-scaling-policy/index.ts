// https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/function_scaling_policy
...
export interface FunctionScalingPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/function_scaling_policy#function_id FunctionScalingPolicy#function_id}
  */
  readonly functionId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/function_scaling_policy#id FunctionScalingPolicy#id}
  *
  ...
  * policy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/function_scaling_policy#policy FunctionScalingPolicy#policy}
  */
...
export interface FunctionScalingPolicyPolicy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/function_scaling_policy#tag FunctionScalingPolicy#tag}
  */
  readonly tag: string;
  /**
  * Max number of instances in one zone for Yandex Cloud Function with tag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/function_scaling_policy#zone_instances_limit FunctionScalingPolicy#zone_instances_limit}
  */
  readonly zoneInstancesLimit?: number;
  /**
  * Max number of requests in one zone for Yandex Cloud Function with tag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/function_scaling_policy#zone_requests_limit FunctionScalingPolicy#zone_requests_limit}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/function_scaling_policy yandex_function_scaling_policy}
*/
export class FunctionScalingPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FunctionScalingPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/function_scaling_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/function_scaling_policy yandex_function_scaling_policy} Resource
  *
  * @param scope The scope in which to define this construct
