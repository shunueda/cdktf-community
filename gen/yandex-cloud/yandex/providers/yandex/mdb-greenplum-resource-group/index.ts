// https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_greenplum_resource_group
...
export interface MdbGreenplumResourceGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_greenplum_resource_group#cluster_id MdbGreenplumResourceGroup#cluster_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_greenplum_resource_group#concurrency MdbGreenplumResourceGroup#concurrency}
  */
  readonly concurrency?: number;
  /**
  * The percentage of CPU resources available to this resource group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_greenplum_resource_group#cpu_rate_limit MdbGreenplumResourceGroup#cpu_rate_limit}
  */
  readonly cpuRateLimit?: number;
  /**
  * The percentage of reserved memory resources available to this resource group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_greenplum_resource_group#memory_limit MdbGreenplumResourceGroup#memory_limit}
  */
  readonly memoryLimit?: number;
  /**
  * The percentage of reserved memory to share across transactions submitted in this resource group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_greenplum_resource_group#memory_shared_quota MdbGreenplumResourceGroup#memory_shared_quota}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_greenplum_resource_group#memory_spill_ratio MdbGreenplumResourceGroup#memory_spill_ratio}
  */
  readonly memorySpillRatio?: number;
  /**
  * The name of the resource group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_greenplum_resource_group#name MdbGreenplumResourceGroup#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_greenplum_resource_group#timeouts MdbGreenplumResourceGroup#timeouts}
  */
...
export interface MdbGreenplumResourceGroupTimeouts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_greenplum_resource_group#create MdbGreenplumResourceGroup#create}
  */
  readonly create?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_greenplum_resource_group#delete MdbGreenplumResourceGroup#delete}
  */
  readonly delete?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_greenplum_resource_group#update MdbGreenplumResourceGroup#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_greenplum_resource_group yandex_mdb_greenplum_resource_group}
*/
export class MdbGreenplumResourceGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MdbGreenplumResourceGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_greenplum_resource_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.168.0/docs/resources/mdb_greenplum_resource_group yandex_mdb_greenplum_resource_group} Resource
  *
  * @param scope The scope in which to define this construct
