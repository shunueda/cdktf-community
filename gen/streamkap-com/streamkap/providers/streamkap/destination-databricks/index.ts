// https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_databricks
...
export interface DestinationDatabricksConfig extends cdktf.TerraformMetaArguments {
  ...
  * JDBC URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_databricks#connection_url DestinationDatabricks#connection_url}
  */
  readonly connectionUrl: string;
  /**
  * Catalog Name. Make sure to change this to the correct cataog name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_databricks#databricks_catalog DestinationDatabricks#databricks_catalog}
  */
  readonly databricksCatalog?: string;
  /**
  * Token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_databricks#databricks_token DestinationDatabricks#databricks_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_databricks#hard_delete DestinationDatabricks#hard_delete}
  */
  readonly hardDelete?: boolean | cdktf.IResolvable;
  /**
  * `upsert` or `append` modes are available
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_databricks#ingestion_mode DestinationDatabricks#ingestion_mode}
  */
  readonly ingestionMode?: string;
  /**
  * Destination name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_databricks#name DestinationDatabricks#name}
  */
  readonly name: string;
  /**
  * Partition tables or not
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_databricks#partition_mode DestinationDatabricks#partition_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_databricks#schema_evolution DestinationDatabricks#schema_evolution}
  */
  readonly schemaEvolution?: string;
  /**
  * Schema for the associated table name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_databricks#table_name_prefix DestinationDatabricks#table_name_prefix}
  */
  readonly tableNamePrefix: string;
  /**
  * The maximum number of active task
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_databricks#tasks_max DestinationDatabricks#tasks_max}
  */
  readonly tasksMax?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_databricks streamkap_destination_databricks}
*/
export class DestinationDatabricks extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DestinationDatabricks that should be imported. Refer to the {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_databricks#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_databricks streamkap_destination_databricks} Resource
  *
  * @param scope The scope in which to define this construct
