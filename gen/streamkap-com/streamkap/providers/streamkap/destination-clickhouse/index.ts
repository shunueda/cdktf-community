// https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_clickhouse
...
export interface DestinationClickhouseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_clickhouse#connection_password DestinationClickhouse#connection_password}
  */
  readonly connectionPassword: string;
  /**
  * Username to access ClickHouse
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_clickhouse#connection_username DestinationClickhouse#connection_username}
  */
  readonly connectionUsername: string;
  /**
  * ClickHouse database
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_clickhouse#database DestinationClickhouse#database}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_clickhouse#hard_delete DestinationClickhouse#hard_delete}
  */
  readonly hardDelete?: boolean | cdktf.IResolvable;
  /**
  * ClickHouse Hostname Or IP address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_clickhouse#hostname DestinationClickhouse#hostname}
  */
  readonly hostname: string;
  /**
  * Upsert or append modes are available
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_clickhouse#ingestion_mode DestinationClickhouse#ingestion_mode}
  */
  readonly ingestionMode?: string;
  /**
  * Destination name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_clickhouse#name DestinationClickhouse#name}
  */
  readonly name: string;
  /**
  * ClickHouse Port. For example, 8443
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_clickhouse#port DestinationClickhouse#port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_clickhouse#schema_evolution DestinationClickhouse#schema_evolution}
  */
  readonly schemaEvolution?: string;
  /**
  * Enable TLS for network connections
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_clickhouse#ssl DestinationClickhouse#ssl}
  */
  readonly ssl?: boolean | cdktf.IResolvable;
  /**
  * The maximum number of active task
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_clickhouse#tasks_max DestinationClickhouse#tasks_max}
  */
  readonly tasksMax?: number;
  /**
  * Per topic configuration in JSON format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_clickhouse#topics_config_map DestinationClickhouse#topics_config_map}
  */
...
export interface DestinationClickhouseTopicsConfigMap {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_clickhouse#delete_sql_execute DestinationClickhouse#delete_sql_execute}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_clickhouse streamkap_destination_clickhouse}
*/
export class DestinationClickhouse extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DestinationClickhouse that should be imported. Refer to the {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_clickhouse#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/streamkap-com/streamkap/2.1.14/docs/resources/destination_clickhouse streamkap_destination_clickhouse} Resource
  *
  * @param scope The scope in which to define this construct
