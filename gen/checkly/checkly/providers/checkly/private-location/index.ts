// https://registry.terraform.io/providers/checkly/checkly/1.15.0/docs/resources/private_location
...
export interface PrivateLocationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkly/checkly/1.15.0/docs/resources/private_location#icon PrivateLocation#icon}
  */
  readonly icon?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkly/checkly/1.15.0/docs/resources/private_location#id PrivateLocation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkly/checkly/1.15.0/docs/resources/private_location#name PrivateLocation#name}
  */
  readonly name: string;
  /**
  * Valid slug name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkly/checkly/1.15.0/docs/resources/private_location#slug_name PrivateLocation#slug_name}
  */
  readonly slugName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/checkly/checkly/1.15.0/docs/resources/private_location checkly_private_location}
*/
export class PrivateLocation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivateLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkly/checkly/1.15.0/docs/resources/private_location#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkly/checkly/1.15.0/docs/resources/private_location checkly_private_location} Resource
  *
  * @param scope The scope in which to define this construct
