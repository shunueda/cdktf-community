// https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/data-sources/trusted_ip_addresses
...
/**
* Represents a {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/data-sources/trusted_ip_addresses rhcs_trusted_ip_addresses}
*/
export class DataRhcsTrustedIpAddresses extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRhcsTrustedIpAddresses that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/data-sources/trusted_ip_addresses#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/data-sources/trusted_ip_addresses rhcs_trusted_ip_addresses} Data Source
  *
  * @param scope The scope in which to define this construct
