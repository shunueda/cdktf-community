// https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/dns_domain
...
export interface DnsDomainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/dns_domain#cluster_arch DnsDomain#cluster_arch}
  */
  readonly clusterArch?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/dns_domain rhcs_dns_domain}
*/
export class DnsDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/dns_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/dns_domain rhcs_dns_domain} Resource
  *
  * @param scope The scope in which to define this construct
