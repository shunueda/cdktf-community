// https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/hcp_default_ingress
...
export interface HcpDefaultIngressConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/hcp_default_ingress#cluster HcpDefaultIngress#cluster}
  */
  readonly cluster: string;
  /**
  * Listening Method for apps ingress. Options are external,internal.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/hcp_default_ingress#listening_method HcpDefaultIngress#listening_method}
  */
  readonly listeningMethod: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/hcp_default_ingress rhcs_hcp_default_ingress}
*/
export class HcpDefaultIngress extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HcpDefaultIngress that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/hcp_default_ingress#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/hcp_default_ingress rhcs_hcp_default_ingress} Resource
  *
  * @param scope The scope in which to define this construct
