// https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/data-sources/rosa_hcp_operator_roles
...
export interface DataRhcsRosaHcpOperatorRolesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Account role prefix.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/data-sources/rosa_hcp_operator_roles#account_role_prefix DataRhcsRosaHcpOperatorRoles#account_role_prefix}
  */
  readonly accountRolePrefix?: string;
  /**
  * Operator role prefix.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/data-sources/rosa_hcp_operator_roles#operator_role_prefix DataRhcsRosaHcpOperatorRoles#operator_role_prefix}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/data-sources/rosa_hcp_operator_roles rhcs_rosa_hcp_operator_roles}
*/
export class DataRhcsRosaHcpOperatorRoles extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRhcsRosaHcpOperatorRoles that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/data-sources/rosa_hcp_operator_roles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/data-sources/rosa_hcp_operator_roles rhcs_rosa_hcp_operator_roles} Data Source
  *
  * @param scope The scope in which to define this construct
