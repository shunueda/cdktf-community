// https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster
...
export interface ClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  * Availability zones.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#availability_zones Cluster#availability_zones}
  */
  readonly availabilityZones?: string[];
  /**
  * Identifier of the AWS access key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#aws_access_key_id Cluster#aws_access_key_id}
  */
  readonly awsAccessKeyId?: string;
  /**
  * Identifier of the AWS account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#aws_account_id Cluster#aws_account_id}
  */
  readonly awsAccountId?: string;
  /**
  * AWS additional compute security group ids.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#aws_additional_compute_security_group_ids Cluster#aws_additional_compute_security_group_ids}
  */
  readonly awsAdditionalComputeSecurityGroupIds?: string[];
  /**
  * AWS additional control plane security group ids.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#aws_additional_control_plane_security_group_ids Cluster#aws_additional_control_plane_security_group_ids}
  */
  readonly awsAdditionalControlPlaneSecurityGroupIds?: string[];
  /**
  * AWS additional infra security group ids.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#aws_additional_infra_security_group_ids Cluster#aws_additional_infra_security_group_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#aws_private_link Cluster#aws_private_link}
  */
  readonly awsPrivateLink?: boolean | cdktf.IResolvable;
  /**
  * AWS access key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#aws_secret_access_key Cluster#aws_secret_access_key}
  */
  readonly awsSecretAccessKey?: string;
  /**
  * AWS subnet IDs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#aws_subnet_ids Cluster#aws_subnet_ids}
  */
  readonly awsSubnetIds?: string[];
  /**
  * Enables customer cloud subscription.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#ccs_enabled Cluster#ccs_enabled}
  */
  readonly ccsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Cloud provider identifier, for example 'aws'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#cloud_provider Cluster#cloud_provider}
  */
  readonly cloudProvider: string;
  /**
  * Cloud region identifier, for example 'us-east-1'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#cloud_region Cluster#cloud_region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#compute_machine_type Cluster#compute_machine_type}
  */
  readonly computeMachineType?: string;
  /**
  * Number of compute nodes of the cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#compute_nodes Cluster#compute_nodes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#domain_prefix Cluster#domain_prefix}
  */
  readonly domainPrefix?: string;
  /**
  * Length of the prefix of the subnet assigned to each node.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#host_prefix Cluster#host_prefix}
  */
  readonly hostPrefix?: number;
  /**
  * Block of IP addresses for nodes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#machine_cidr Cluster#machine_cidr}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#multi_az Cluster#multi_az}
  */
  readonly multiAz?: boolean | cdktf.IResolvable;
  /**
  * Name of the cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#name Cluster#name}
  */
  readonly name: string;
  /**
  * Block of IP addresses for pods.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#pod_cidr Cluster#pod_cidr}
  */
  readonly podCidr?: string;
  /**
  * Product ID OSD or Rosa
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#product Cluster#product}
  */
  readonly product: string;
  /**
  * User defined properties.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#properties Cluster#properties}
  */
  readonly properties?: { [key: string]: string };
  /**
  * proxy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#proxy Cluster#proxy}
  */
  readonly proxy?: ClusterProxy;
  /**
  * Block of IP addresses for services.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#service_cidr Cluster#service_cidr}
  */
  readonly serviceCidr?: string;
  /**
  * Identifier of the version of OpenShift, for example 'openshift-v4.1.0'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#version Cluster#version}
  */
  readonly version?: string;
  /**
  * Wait till the cluster is ready.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#wait Cluster#wait}
  */
...
export interface ClusterProxy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#additional_trust_bundle Cluster#additional_trust_bundle}
  */
  readonly additionalTrustBundle?: string;
  /**
  * HTTP proxy. To reset please provide '' (empty string)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#http_proxy Cluster#http_proxy}
  */
  readonly httpProxy?: string;
  /**
  * HTTPS proxy. To reset please provide '' (empty string)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#https_proxy Cluster#https_proxy}
  */
  readonly httpsProxy?: string;
  /**
  * No proxy. To reset please provide '' (empty string)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#no_proxy Cluster#no_proxy}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster rhcs_cluster}
*/
export class Cluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/cluster rhcs_cluster} Resource
  *
  * @param scope The scope in which to define this construct
