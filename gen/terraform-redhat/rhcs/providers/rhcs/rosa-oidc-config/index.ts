// https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/rosa_oidc_config
...
export interface RosaOidcConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/rosa_oidc_config#installer_role_arn RosaOidcConfig#installer_role_arn}
  */
  readonly installerRoleArn?: string;
  /**
  * The bucket/issuer URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/rosa_oidc_config#issuer_url RosaOidcConfig#issuer_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/rosa_oidc_config#managed RosaOidcConfig#managed}
  */
  readonly managed: boolean | cdktf.IResolvable;
  /**
  * Indicates for unmanaged OIDC config, the secret ARN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/rosa_oidc_config#secret_arn RosaOidcConfig#secret_arn}
  */
  readonly secretArn?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/rosa_oidc_config rhcs_rosa_oidc_config}
*/
export class RosaOidcConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RosaOidcConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/rosa_oidc_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/rosa_oidc_config rhcs_rosa_oidc_config} Resource
  *
  * @param scope The scope in which to define this construct
