// https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/kubeletconfig
...
export interface KubeletconfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/kubeletconfig#cluster Kubeletconfig#cluster}
  */
  readonly cluster: string;
  /**
  * ID of the KubeletConfig.After the creation of the resource, it is not possible to update the attribute value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/kubeletconfig#id Kubeletconfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/kubeletconfig#name Kubeletconfig#name}
  */
  readonly name?: string;
  /**
  * Sets the requested podPidsLimit to be applied as part of the custom KubeletConfig.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/kubeletconfig#pod_pids_limit Kubeletconfig#pod_pids_limit}
  */
  readonly podPidsLimit: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/kubeletconfig rhcs_kubeletconfig}
*/
export class Kubeletconfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Kubeletconfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/kubeletconfig#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/kubeletconfig rhcs_kubeletconfig} Resource
  *
  * @param scope The scope in which to define this construct
