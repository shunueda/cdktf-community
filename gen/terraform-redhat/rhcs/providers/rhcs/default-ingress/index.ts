// https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/default_ingress
...
export interface DefaultIngressConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/default_ingress#cluster DefaultIngress#cluster}
  */
  readonly cluster: string;
  /**
  * Components route hostname for oauth, console, download.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/default_ingress#cluster_routes_hostname DefaultIngress#cluster_routes_hostname}
  */
  readonly clusterRoutesHostname?: string;
  /**
  * Components route TLS secret reference for oauth, console, download.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/default_ingress#cluster_routes_tls_secret_ref DefaultIngress#cluster_routes_tls_secret_ref}
  */
  readonly clusterRoutesTlsSecretRef?: string;
  /**
  * Component route parameters for oauth, console, downloads.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/default_ingress#component_routes DefaultIngress#component_routes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/default_ingress#excluded_namespaces DefaultIngress#excluded_namespaces}
  */
  readonly excludedNamespaces?: string[];
  /**
  * Unique identifier of the ingress.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/default_ingress#id DefaultIngress#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/default_ingress#load_balancer_type DefaultIngress#load_balancer_type}
  */
  readonly loadBalancerType?: string;
  /**
  * Namespace Ownership Policy for ingress. Options are Strict,InterNamespaceAllowed. Default is 'Strict'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/default_ingress#route_namespace_ownership_policy DefaultIngress#route_namespace_ownership_policy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/default_ingress#route_selectors DefaultIngress#route_selectors}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/default_ingress#route_wildcard_policy DefaultIngress#route_wildcard_policy}
  */
  readonly routeWildcardPolicy?: string;
}
export interface DefaultIngressComponentRoutes {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/default_ingress#hostname DefaultIngress#hostname}
  */
  readonly hostname?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/default_ingress#tls_secret_ref DefaultIngress#tls_secret_ref}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/default_ingress rhcs_default_ingress}
*/
export class DefaultIngress extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DefaultIngress that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/default_ingress#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/resources/default_ingress rhcs_default_ingress} Resource
  *
  * @param scope The scope in which to define this construct
