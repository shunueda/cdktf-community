// https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs
...
export interface RhcsProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs#client_id RhcsProvider#client_id}
  */
  readonly clientId?: string;
  /**
  * OpenID client secret.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs#client_secret RhcsProvider#client_secret}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs#insecure RhcsProvider#insecure}
  */
  readonly insecure?: boolean | cdktf.IResolvable;
  /**
  * Refresh token that is generated from `rosa login`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs#refresh_token RhcsProvider#refresh_token}
  */
  readonly refreshToken?: string;
  /**
  * Access or refresh token that is generated from https://console.redhat.com/openshift/token/rosa.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs#token RhcsProvider#token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs#token_url RhcsProvider#token_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs#trusted_cas RhcsProvider#trusted_cas}
  */
  readonly trustedCas?: string;
  /**
  * URL sets the base URL of the API gateway. The default is `https://api.openshift.com`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs#url RhcsProvider#url}
  */
  readonly url?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs#alias RhcsProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs rhcs}
*/
export class RhcsProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing RhcsProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs rhcs} Resource
  *
  * @param scope The scope in which to define this construct
