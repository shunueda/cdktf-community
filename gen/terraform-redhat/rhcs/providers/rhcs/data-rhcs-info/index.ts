// https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/data-sources/info
...
/**
* Represents a {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/data-sources/info rhcs_info}
*/
export class DataRhcsInfo extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRhcsInfo that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/data-sources/info#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/data-sources/info rhcs_info} Data Source
  *
  * @param scope The scope in which to define this construct
