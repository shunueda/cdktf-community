// https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/data-sources/groups
...
export interface DataRhcsGroupsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/data-sources/groups#cluster DataRhcsGroups#cluster}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/data-sources/groups rhcs_groups}
*/
export class DataRhcsGroups extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRhcsGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/data-sources/groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-redhat/rhcs/1.7.1/docs/data-sources/groups rhcs_groups} Data Source
  *
  * @param scope The scope in which to define this construct
