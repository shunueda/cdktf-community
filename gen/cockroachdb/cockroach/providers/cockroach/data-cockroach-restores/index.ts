// https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/data-sources/restores
...
export interface DataCockroachRestoresConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/data-sources/restores#cluster_id DataCockroachRestores#cluster_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/data-sources/restores#end_time DataCockroachRestores#end_time}
  */
  readonly endTime?: string;
  /**
  * The maximum number of restore jobs to return. If not set, only the first 500 restore jobs will be returned.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/data-sources/restores#limit DataCockroachRestores#limit}
  */
  readonly limit?: number;
  /**
  * Specifies the sort direction for the returned results. Use `ASC` for ascending or `DESC` for descending order.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/data-sources/restores#sort_order DataCockroachRestores#sort_order}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/data-sources/restores#start_time DataCockroachRestores#start_time}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/data-sources/restores cockroach_restores}
*/
export class DataCockroachRestores extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCockroachRestores that should be imported. Refer to the {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/data-sources/restores#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/data-sources/restores cockroach_restores} Data Source
  *
  * @param scope The scope in which to define this construct
