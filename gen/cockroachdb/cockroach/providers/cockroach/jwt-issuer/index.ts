// https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/jwt_issuer
...
export interface JwtIssuerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/jwt_issuer#audience JwtIssuer#audience}
  */
  readonly audience: string;
  /**
  * Used to identify the user from the external Identity Provider. Defaults to "sub".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/jwt_issuer#claim JwtIssuer#claim}
  */
  readonly claim?: string;
  /**
  * A list of mappings to map the external token identity into CockroachDB Cloud.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/jwt_issuer#identity_map JwtIssuer#identity_map}
  */
  readonly identityMap?: JwtIssuerIdentityMap[] | cdktf.IResolvable;
  /**
  * The URL of the server issuing JWTs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/jwt_issuer#issuer_url JwtIssuer#issuer_url}
  */
  readonly issuerUrl: string;
  /**
  * A set of public keys (JWKS) used to verify the JWT.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/jwt_issuer#jwks JwtIssuer#jwks}
  */
...
export interface JwtIssuerIdentityMap {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/jwt_issuer#cc_identity JwtIssuer#cc_identity}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/jwt_issuer#token_identity JwtIssuer#token_identity}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/jwt_issuer cockroach_jwt_issuer}
*/
export class JwtIssuer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing JwtIssuer that should be imported. Refer to the {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/jwt_issuer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/jwt_issuer cockroach_jwt_issuer} Resource
  *
  * @param scope The scope in which to define this construct
