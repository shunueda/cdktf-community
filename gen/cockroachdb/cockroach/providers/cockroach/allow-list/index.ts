// https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/allow_list
...
export interface AllowListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/allow_list#cidr_ip AllowList#cidr_ip}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/allow_list#cidr_mask AllowList#cidr_mask}
  */
  readonly cidrMask: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/allow_list#cluster_id AllowList#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Name of this allowlist entry. If left unset, it will inherit a server-side default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/allow_list#name AllowList#name}
  */
  readonly name?: string;
  /**
  * Set to 'true' to allow SQL connections from this CIDR range.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/allow_list#sql AllowList#sql}
  */
  readonly sql: boolean | cdktf.IResolvable;
  /**
  * Set to 'true' to allow access to the management console from this CIDR range.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/allow_list#ui AllowList#ui}
  */
  readonly ui: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/allow_list cockroach_allow_list}
*/
export class AllowList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AllowList that should be imported. Refer to the {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/allow_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/allow_list cockroach_allow_list} Resource
  *
  * @param scope The scope in which to define this construct
