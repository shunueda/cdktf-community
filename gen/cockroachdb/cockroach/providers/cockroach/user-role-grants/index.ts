// https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/user_role_grants
...
export interface UserRoleGrantsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/user_role_grants#roles UserRoleGrants#roles}
  */
  readonly roles: UserRoleGrantsRoles[] | cdktf.IResolvable;
  /**
  * ID of the user to grant these roles to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/user_role_grants#user_id UserRoleGrants#user_id}
  */
...
export interface UserRoleGrantsRoles {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/user_role_grants#resource_id UserRoleGrants#resource_id}
  */
  ...
  *   * FOLDER
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/user_role_grants#resource_type UserRoleGrants#resource_type}
  */
  ...
  *   * FOLDER_MOVER
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/user_role_grants#role_name UserRoleGrants#role_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/user_role_grants cockroach_user_role_grants}
*/
export class UserRoleGrants extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserRoleGrants that should be imported. Refer to the {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/user_role_grants#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/user_role_grants cockroach_user_role_grants} Resource
  *
  * @param scope The scope in which to define this construct
