// https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/maintenance_window
...
export interface MaintenanceWindowConfig extends cdktf.TerraformMetaArguments {
  ...
  * Cluster ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/maintenance_window#id MaintenanceWindow#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/maintenance_window#offset_duration MaintenanceWindow#offset_duration}
  */
  readonly offsetDuration: number;
  /**
  * Duration in seconds that the maintenance window will remain active for after it starts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/maintenance_window#window_duration MaintenanceWindow#window_duration}
  */
  readonly windowDuration: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/maintenance_window cockroach_maintenance_window}
*/
export class MaintenanceWindow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MaintenanceWindow that should be imported. Refer to the {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/maintenance_window#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/maintenance_window cockroach_maintenance_window} Resource
  *
  * @param scope The scope in which to define this construct
