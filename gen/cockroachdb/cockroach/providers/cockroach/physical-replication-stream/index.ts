// https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/physical_replication_stream
...
export interface PhysicalReplicationStreamConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/physical_replication_stream#failover_at PhysicalReplicationStream#failover_at}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/physical_replication_stream#failover_immediately PhysicalReplicationStream#failover_immediately}
  */
  readonly failoverImmediately?: boolean | cdktf.IResolvable;
  /**
  * ID of the primary cluster, which is the replication source.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/physical_replication_stream#primary_cluster_id PhysicalReplicationStream#primary_cluster_id}
  */
  readonly primaryClusterId: string;
  /**
  * ID of the standby cluster, which is the replication target.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/physical_replication_stream#standby_cluster_id PhysicalReplicationStream#standby_cluster_id}
  */
  readonly standbyClusterId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/physical_replication_stream cockroach_physical_replication_stream}
*/
export class PhysicalReplicationStream extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PhysicalReplicationStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/physical_replication_stream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/physical_replication_stream cockroach_physical_replication_stream} Resource
  *
  * @param scope The scope in which to define this construct
