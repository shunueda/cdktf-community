// https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/metric_export_cloudwatch_config
...
export interface MetricExportCloudwatchConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/metric_export_cloudwatch_config#external_id MetricExportCloudwatchConfig#external_id}
  */
  readonly externalId?: string;
  /**
  * Cluster ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/metric_export_cloudwatch_config#id MetricExportCloudwatchConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/metric_export_cloudwatch_config#log_group_name MetricExportCloudwatchConfig#log_group_name}
  */
  readonly logGroupName?: string;
  /**
  * The IAM role used to upload metric segments to the target AWS account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/metric_export_cloudwatch_config#role_arn MetricExportCloudwatchConfig#role_arn}
  */
  readonly roleArn: string;
  /**
  * The specific AWS region that the metrics will be exported to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/metric_export_cloudwatch_config#target_region MetricExportCloudwatchConfig#target_region}
  */
  readonly targetRegion?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/metric_export_cloudwatch_config cockroach_metric_export_cloudwatch_config}
*/
export class MetricExportCloudwatchConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MetricExportCloudwatchConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/metric_export_cloudwatch_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/metric_export_cloudwatch_config cockroach_metric_export_cloudwatch_config} Resource
  *
  * @param scope The scope in which to define this construct
