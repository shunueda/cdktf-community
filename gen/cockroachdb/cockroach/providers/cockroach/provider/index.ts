// https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs
...
export interface CockroachProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs#apijwt CockroachProvider#apijwt}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs#apikey CockroachProvider#apikey}
  */
  readonly apikey?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs#alias CockroachProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs cockroach}
*/
export class CockroachProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing CockroachProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs cockroach} Resource
  *
  * @param scope The scope in which to define this construct
