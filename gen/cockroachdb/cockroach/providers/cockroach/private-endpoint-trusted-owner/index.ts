// https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/private_endpoint_trusted_owner
...
export interface PrivateEndpointTrustedOwnerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/private_endpoint_trusted_owner#cluster_id PrivateEndpointTrustedOwner#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Owner ID of the private endpoint connection in the cloud provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/private_endpoint_trusted_owner#external_owner_id PrivateEndpointTrustedOwner#external_owner_id}
  */
  ...
  *   * AWS_ACCOUNT_ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/private_endpoint_trusted_owner#type PrivateEndpointTrustedOwner#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/private_endpoint_trusted_owner cockroach_private_endpoint_trusted_owner}
*/
export class PrivateEndpointTrustedOwner extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivateEndpointTrustedOwner that should be imported. Refer to the {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/private_endpoint_trusted_owner#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/private_endpoint_trusted_owner cockroach_private_endpoint_trusted_owner} Resource
  *
  * @param scope The scope in which to define this construct
