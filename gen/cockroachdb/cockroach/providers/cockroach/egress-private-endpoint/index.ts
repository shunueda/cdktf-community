// https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/egress_private_endpoint
...
export interface EgressPrivateEndpointConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/egress_private_endpoint#cluster_id EgressPrivateEndpoint#cluster_id}
  */
  readonly clusterId: string;
  /**
  * region represents the region that the endpoint will be created in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/egress_private_endpoint#region EgressPrivateEndpoint#region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/egress_private_endpoint#target_service_identifier EgressPrivateEndpoint#target_service_identifier}
  */
  ...
  *   * MSK_TLS
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/egress_private_endpoint#target_service_type EgressPrivateEndpoint#target_service_type}
  */
  readonly targetServiceType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/egress_private_endpoint cockroach_egress_private_endpoint}
*/
export class EgressPrivateEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EgressPrivateEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/egress_private_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/egress_private_endpoint cockroach_egress_private_endpoint} Resource
  *
  * @param scope The scope in which to define this construct
