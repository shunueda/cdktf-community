// https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/log_export_config
...
export interface LogExportConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/log_export_config#auth_principal LogExportConfig#auth_principal}
  */
  readonly authPrincipal: string;
  /**
  * The external ID to use when assuming the AWS role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/log_export_config#aws_external_id LogExportConfig#aws_external_id}
  */
  readonly awsExternalId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/log_export_config#groups LogExportConfig#groups}
  */
  readonly groups?: LogExportConfigGroups[] | cdktf.IResolvable;
  /**
  * Cluster ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/log_export_config#id LogExportConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/log_export_config#log_name LogExportConfig#log_name}
  */
  readonly logName: string;
  /**
  * Controls what CRDB channels do not get exported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/log_export_config#omitted_channels LogExportConfig#omitted_channels}
  */
  readonly omittedChannels?: string[];
  /**
  * Controls whether logs are redacted before forwarding to customer sinks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/log_export_config#redact LogExportConfig#redact}
  */
  readonly redact?: boolean | cdktf.IResolvable;
  /**
  * Controls whether all logs are sent to a specific region in the customer sink.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/log_export_config#region LogExportConfig#region}
  */
  ...
  *   * AZURE_LOG_ANALYTICS
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/log_export_config#type LogExportConfig#type}
  */
...
export interface LogExportConfigGroups {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/log_export_config#channels LogExportConfig#channels}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/log_export_config#min_level LogExportConfig#min_level}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/log_export_config cockroach_log_export_config}
*/
export class LogExportConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogExportConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/log_export_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.15.2/docs/resources/log_export_config cockroach_log_export_config} Resource
  *
  * @param scope The scope in which to define this construct
