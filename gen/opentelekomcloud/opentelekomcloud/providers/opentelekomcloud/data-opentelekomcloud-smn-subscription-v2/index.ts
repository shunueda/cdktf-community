// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/data-sources/smn_subscription_v2
...
export interface DataOpentelekomcloudSmnSubscriptionV2Config extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class DataOpentelekomcloudSmnSubscriptionV2 extends cdktf.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataOpentelekomcloudSmnSubscriptionV2 to import
  * @param importFromId The id of the existing DataOpentelekomcloudSmnSubscriptionV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/data-sources/smn_subscription_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/data-sources/smn_subscription_v2 opentelekomcloud_smn_subscription_v2} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataOpentelekomcloudSmnSubscriptionV2Config
  */
  public constructor(scope: Construct, id: string, config: DataOpentelekomcloudSmnSubscriptionV2Config) {
    super(scope, id, {
