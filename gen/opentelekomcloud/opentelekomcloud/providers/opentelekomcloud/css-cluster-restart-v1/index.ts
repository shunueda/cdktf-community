// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/resources/css_cluster_restart_v1
...
export class CssClusterRestartV1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CssClusterRestartV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/resources/css_cluster_restart_v1#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/resources/css_cluster_restart_v1 opentelekomcloud_css_cluster_restart_v1} Resource
  *
  * @param scope The scope in which to define this construct
