// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/data-sources/rms_advanced_query_schemas_v1
...
export class DataOpentelekomcloudRmsAdvancedQuerySchemasV1 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpentelekomcloudRmsAdvancedQuerySchemasV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/data-sources/rms_advanced_query_schemas_v1#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/data-sources/rms_advanced_query_schemas_v1 opentelekomcloud_rms_advanced_query_schemas_v1} Data Source
  *
  * @param scope The scope in which to define this construct
