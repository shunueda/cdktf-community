// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/data-sources/fgs_functions_v2
...
export interface DataOpentelekomcloudFgsFunctionsV2Config extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataOpentelekomcloudFgsFunctionsV2Functions {
}

export function dataOpentelekomcloudFgsFunctionsV2FunctionsToTerraform(struct?: DataOpentelekomcloudFgsFunctionsV2Functions): any {
...
export function dataOpentelekomcloudFgsFunctionsV2FunctionsToHclTerraform(struct?: DataOpentelekomcloudFgsFunctionsV2Functions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataOpentelekomcloudFgsFunctionsV2FunctionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataOpentelekomcloudFgsFunctionsV2Functions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataOpentelekomcloudFgsFunctionsV2Functions | undefined) {
    if (value === undefined) {
  ...
  public get maxInstanceNum() {
    return this.getNumberAttribute('max_instance_num');
  }
...
export class DataOpentelekomcloudFgsFunctionsV2FunctionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataOpentelekomcloudFgsFunctionsV2FunctionsOutputReference {
    return new DataOpentelekomcloudFgsFunctionsV2FunctionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class DataOpentelekomcloudFgsFunctionsV2 extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "opentelekomcloud_fgs_functions_v2";
  ...
  * @param importToId The construct id used in the generated config for the DataOpentelekomcloudFgsFunctionsV2 to import
  * @param importFromId The id of the existing DataOpentelekomcloudFgsFunctionsV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/data-sources/fgs_functions_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "opentelekomcloud_fgs_functions_v2", importId: importFromId, provider });
      }
  ...
  * @param options DataOpentelekomcloudFgsFunctionsV2Config = {}
  */
  public constructor(scope: Construct, id: string, config: DataOpentelekomcloudFgsFunctionsV2Config = {}) {
    super(scope, id, {
      terraformResourceType: 'opentelekomcloud_fgs_functions_v2',
  ...
  private _functions = new DataOpentelekomcloudFgsFunctionsV2FunctionsList(this, "functions", false);
