// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/resources/cce_node_attach_v3
...
export class CceNodeAttachV3 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CceNodeAttachV3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/resources/cce_node_attach_v3#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/resources/cce_node_attach_v3 opentelekomcloud_cce_node_attach_v3} Resource
  *
  * @param scope The scope in which to define this construct
