// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/data-sources/er_instances_v3
...
export interface DataOpentelekomcloudErInstancesV3Config extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataOpentelekomcloudErInstancesV3Instances {
}

export function dataOpentelekomcloudErInstancesV3InstancesToTerraform(struct?: DataOpentelekomcloudErInstancesV3Instances): any {
...
export function dataOpentelekomcloudErInstancesV3InstancesToHclTerraform(struct?: DataOpentelekomcloudErInstancesV3Instances): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataOpentelekomcloudErInstancesV3InstancesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataOpentelekomcloudErInstancesV3Instances | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataOpentelekomcloudErInstancesV3Instances | undefined) {
    if (value === undefined) {
...
export class DataOpentelekomcloudErInstancesV3InstancesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataOpentelekomcloudErInstancesV3InstancesOutputReference {
    return new DataOpentelekomcloudErInstancesV3InstancesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class DataOpentelekomcloudErInstancesV3 extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "opentelekomcloud_er_instances_v3";
  ...
  * @param importToId The construct id used in the generated config for the DataOpentelekomcloudErInstancesV3 to import
  * @param importFromId The id of the existing DataOpentelekomcloudErInstancesV3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/data-sources/er_instances_v3#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "opentelekomcloud_er_instances_v3", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/data-sources/er_instances_v3 opentelekomcloud_er_instances_v3} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataOpentelekomcloudErInstancesV3Config = {}
  */
  public constructor(scope: Construct, id: string, config: DataOpentelekomcloudErInstancesV3Config = {}) {
    super(scope, id, {
      terraformResourceType: 'opentelekomcloud_er_instances_v3',
  ...
  private _instances = new DataOpentelekomcloudErInstancesV3InstancesList(this, "instances", false);
