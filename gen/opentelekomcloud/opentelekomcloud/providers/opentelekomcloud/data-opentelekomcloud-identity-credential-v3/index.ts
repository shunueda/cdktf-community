// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/data-sources/identity_credential_v3
...
export function dataOpentelekomcloudIdentityCredentialV3CredentialsToHclTerraform(struct?: DataOpentelekomcloudIdentityCredentialV3Credentials): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataOpentelekomcloudIdentityCredentialV3 extends cdktf.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataOpentelekomcloudIdentityCredentialV3 to import
  * @param importFromId The id of the existing DataOpentelekomcloudIdentityCredentialV3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/data-sources/identity_credential_v3#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/data-sources/identity_credential_v3 opentelekomcloud_identity_credential_v3} Data Source
  *
  * @param scope The scope in which to define this construct
