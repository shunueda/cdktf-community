// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/resources/obs_bucket_inventory
...
export class ObsBucketInventory extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ObsBucketInventory that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/resources/obs_bucket_inventory#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/resources/obs_bucket_inventory opentelekomcloud_obs_bucket_inventory} Resource
  *
  * @param scope The scope in which to define this construct
