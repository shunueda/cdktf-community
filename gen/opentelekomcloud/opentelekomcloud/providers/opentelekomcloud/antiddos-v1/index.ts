// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/resources/antiddos_v1
...
export class AntiddosV1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AntiddosV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/resources/antiddos_v1#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/resources/antiddos_v1 opentelekomcloud_antiddos_v1} Resource
  *
  * @param scope The scope in which to define this construct
