// https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/resources/fgs_trigger_v2
...
export class FgsTriggerV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FgsTriggerV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/resources/fgs_trigger_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.51/docs/resources/fgs_trigger_v2 opentelekomcloud_fgs_trigger_v2} Resource
  *
  * @param scope The scope in which to define this construct
