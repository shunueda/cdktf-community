// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/postgresql_modify_switch_time_period_operation
...
export interface PostgresqlModifySwitchTimePeriodOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/postgresql_modify_switch_time_period_operation#db_instance_id PostgresqlModifySwitchTimePeriodOperation#db_instance_id}
  */
  readonly dbInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/postgresql_modify_switch_time_period_operation#id PostgresqlModifySwitchTimePeriodOperation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/postgresql_modify_switch_time_period_operation#switch_tag PostgresqlModifySwitchTimePeriodOperation#switch_tag}
  */
  readonly switchTag: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/postgresql_modify_switch_time_period_operation tencentcloud_postgresql_modify_switch_time_period_operation}
*/
export class PostgresqlModifySwitchTimePeriodOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PostgresqlModifySwitchTimePeriodOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/postgresql_modify_switch_time_period_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/postgresql_modify_switch_time_period_operation tencentcloud_postgresql_modify_switch_time_period_operation} Resource
  *
  * @param scope The scope in which to define this construct
