// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/kubernetes_cluster_endpoint
...
export interface KubernetesClusterEndpointConfig extends cdktf.TerraformMetaArguments {
  ...
  * Specify cluster ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/kubernetes_cluster_endpoint#cluster_id KubernetesClusterEndpoint#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Open internet access or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/kubernetes_cluster_endpoint#cluster_internet KubernetesClusterEndpoint#cluster_internet}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/kubernetes_cluster_endpoint#cluster_internet_domain KubernetesClusterEndpoint#cluster_internet_domain}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/kubernetes_cluster_endpoint#cluster_internet_security_group KubernetesClusterEndpoint#cluster_internet_security_group}
  */
  readonly clusterInternetSecurityGroup?: string;
  /**
  * Open intranet access or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/kubernetes_cluster_endpoint#cluster_intranet KubernetesClusterEndpoint#cluster_intranet}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/kubernetes_cluster_endpoint#cluster_intranet_domain KubernetesClusterEndpoint#cluster_intranet_domain}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/kubernetes_cluster_endpoint#cluster_intranet_subnet_id KubernetesClusterEndpoint#cluster_intranet_subnet_id}
  */
  readonly clusterIntranetSubnetId?: string;
  /**
  * The LB parameter. Only used for public network access.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/kubernetes_cluster_endpoint#extensive_parameters KubernetesClusterEndpoint#extensive_parameters}
  */
  readonly extensiveParameters?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/kubernetes_cluster_endpoint#id KubernetesClusterEndpoint#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/kubernetes_cluster_endpoint#managed_cluster_internet_security_policies KubernetesClusterEndpoint#managed_cluster_internet_security_policies}
  */
  readonly managedClusterInternetSecurityPolicies?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/kubernetes_cluster_endpoint tencentcloud_kubernetes_cluster_endpoint}
*/
export class KubernetesClusterEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesClusterEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/kubernetes_cluster_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/kubernetes_cluster_endpoint tencentcloud_kubernetes_cluster_endpoint} Resource
  *
  * @param scope The scope in which to define this construct
