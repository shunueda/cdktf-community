// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dbbrain_diag_history
...
export interface DataTencentcloudDbbrainDiagHistoryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dbbrain_diag_history#end_time DataTencentcloudDbbrainDiagHistory#end_time}
  */
  readonly endTime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dbbrain_diag_history#id DataTencentcloudDbbrainDiagHistory#id}
  *
  ...
  * instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dbbrain_diag_history#instance_id DataTencentcloudDbbrainDiagHistory#instance_id}
  */
  readonly instanceId: string;
  /**
  * Service product type, supported values include: `mysql` - cloud database MySQL, `cynosdb` - cloud database CynosDB for MySQL, the default is `mysql`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dbbrain_diag_history#product DataTencentcloudDbbrainDiagHistory#product}
  */
  readonly product?: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dbbrain_diag_history#result_output_file DataTencentcloudDbbrainDiagHistory#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Start time, such as `2019-09-10 12:13:14`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dbbrain_diag_history#start_time DataTencentcloudDbbrainDiagHistory#start_time}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dbbrain_diag_history tencentcloud_dbbrain_diag_history}
*/
export class DataTencentcloudDbbrainDiagHistory extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudDbbrainDiagHistory that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dbbrain_diag_history#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dbbrain_diag_history tencentcloud_dbbrain_diag_history} Data Source
  *
  * @param scope The scope in which to define this construct
