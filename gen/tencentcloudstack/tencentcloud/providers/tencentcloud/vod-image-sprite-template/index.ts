// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/vod_image_sprite_template
...
export interface VodImageSpriteTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/vod_image_sprite_template#column_count VodImageSpriteTemplate#column_count}
  */
  readonly columnCount: number;
  /**
  * Template description. Length limit: 256 characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/vod_image_sprite_template#comment VodImageSpriteTemplate#comment}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/vod_image_sprite_template#fill_type VodImageSpriteTemplate#fill_type}
  */
  ...
  * Default value: jpg.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/vod_image_sprite_template#format VodImageSpriteTemplate#format}
  */
  readonly format?: string;
  /**
  * Maximum value of the `height` (or short side) of a screenshot in px. Value range: 0 and [128, 4,096]. If both `width` and `height` are `0`, the resolution will be the same as that of the source video; If `width` is `0`, but `height` is not `0`, `width` will be proportionally scaled; If `width` is not `0`, but `height` is `0`, `height` will be proportionally scaled; If both `width` and `height` are not `0`, the custom resolution will be used. Default value: `0`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/vod_image_sprite_template#height VodImageSpriteTemplate#height}
  */
  readonly height?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/vod_image_sprite_template#id VodImageSpriteTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/vod_image_sprite_template#name VodImageSpriteTemplate#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/vod_image_sprite_template#resolution_adaptive VodImageSpriteTemplate#resolution_adaptive}
  */
  readonly resolutionAdaptive?: boolean | cdktf.IResolvable;
  /**
  * Subimage row count of an image sprite.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/vod_image_sprite_template#row_count VodImageSpriteTemplate#row_count}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/vod_image_sprite_template#sample_interval VodImageSpriteTemplate#sample_interval}
  */
  readonly sampleInterval: number;
  /**
  * Sampling type. Valid values: `Percent`, `Time`. `Percent`: by percent. `Time`: by time interval.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/vod_image_sprite_template#sample_type VodImageSpriteTemplate#sample_type}
  */
  readonly sampleType: string;
  /**
  * The VOD [application](https://intl.cloud.tencent.com/document/product/266/14574) ID. For customers who activate VOD service from December 25, 2023, if they want to access resources in a VOD application (whether it's the default application or a newly created one), they must fill in this field with the application ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/vod_image_sprite_template#sub_app_id VodImageSpriteTemplate#sub_app_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/vod_image_sprite_template#width VodImageSpriteTemplate#width}
  */
  readonly width?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/vod_image_sprite_template tencentcloud_vod_image_sprite_template}
*/
export class VodImageSpriteTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VodImageSpriteTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/vod_image_sprite_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/vod_image_sprite_template tencentcloud_vod_image_sprite_template} Resource
  *
  * @param scope The scope in which to define this construct
