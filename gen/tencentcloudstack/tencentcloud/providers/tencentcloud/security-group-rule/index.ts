// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/security_group_rule
...
export interface SecurityGroupRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/security_group_rule#cidr_ip SecurityGroupRule#cidr_ip}
  */
  readonly cidrIp?: string;
  /**
  * Description of the security group rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/security_group_rule#description SecurityGroupRule#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/security_group_rule#id SecurityGroupRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/security_group_rule#ip_protocol SecurityGroupRule#ip_protocol}
  */
  readonly ipProtocol?: string;
  /**
  * Rule policy of security group. Valid values: `ACCEPT` and `DROP`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/security_group_rule#policy SecurityGroupRule#policy}
  */
  readonly policy: string;
  /**
  * The security group rule index number, the value of which dynamically changes as the security group rule changes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/security_group_rule#policy_index SecurityGroupRule#policy_index}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/security_group_rule#port_range SecurityGroupRule#port_range}
  */
  readonly portRange?: string;
  /**
  * ID of the security group to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/security_group_rule#security_group_id SecurityGroupRule#security_group_id}
  */
  readonly securityGroupId: string;
  /**
  * ID of the nested security group, and conflicts with `cidr_ip` and `address_template`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/security_group_rule#source_sgid SecurityGroupRule#source_sgid}
  */
  readonly sourceSgid?: string;
  /**
  * Type of the security group rule. Valid values: `ingress` and `egress`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/security_group_rule#type SecurityGroupRule#type}
  */
  readonly type: string;
  /**
  * address_template block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/security_group_rule#address_template SecurityGroupRule#address_template}
  */
  readonly addressTemplate?: SecurityGroupRuleAddressTemplate;
  /**
  * protocol_template block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/security_group_rule#protocol_template SecurityGroupRule#protocol_template}
  */
...
export interface SecurityGroupRuleAddressTemplate {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/security_group_rule#group_id SecurityGroupRule#group_id}
  */
  readonly groupId?: string;
  /**
  * Address template ID, conflicts with `group_id`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/security_group_rule#template_id SecurityGroupRule#template_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/security_group_rule tencentcloud_security_group_rule}
*/
export class SecurityGroupRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityGroupRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/security_group_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/security_group_rule tencentcloud_security_group_rule} Resource
  *
  * @param scope The scope in which to define this construct
