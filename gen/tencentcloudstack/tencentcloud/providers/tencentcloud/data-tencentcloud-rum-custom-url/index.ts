// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url
...
export interface DataTencentcloudRumCustomUrlConfig extends cdktf.TerraformMetaArguments {
  /**
  * The region where the data reporting takes place.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#area DataTencentcloudRumCustomUrl#area}
  */
  readonly area?: string;
  /**
  * The mobile phone brand used for data reporting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#brand DataTencentcloudRumCustomUrl#brand}
  */
  readonly brand?: string;
  /**
  * The browser type used for data reporting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#browser DataTencentcloudRumCustomUrl#browser}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#cost_type DataTencentcloudRumCustomUrl#cost_type}
  */
  readonly costType?: string;
  /**
  * The device used for data reporting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#device DataTencentcloudRumCustomUrl#device}
  */
  readonly device?: string;
  /**
  * End time but is represented using a timestamp in seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#end_time DataTencentcloudRumCustomUrl#end_time}
  */
  readonly endTime: number;
  /**
  * The browser engine used for data reporting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#engine DataTencentcloudRumCustomUrl#engine}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#env DataTencentcloudRumCustomUrl#env}
  */
  readonly env?: string;
  /**
  * First Expansion parameter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#ext_first DataTencentcloudRumCustomUrl#ext_first}
  */
  readonly extFirst?: string;
  /**
  * Second Expansion parameter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#ext_second DataTencentcloudRumCustomUrl#ext_second}
  */
  readonly extSecond?: string;
  /**
  * Third Expansion parameter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#ext_third DataTencentcloudRumCustomUrl#ext_third}
  */
  readonly extThird?: string;
  /**
  * The source page of the data reporting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#from DataTencentcloudRumCustomUrl#from}
  */
  readonly from?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#id DataTencentcloudRumCustomUrl#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#is_abroad DataTencentcloudRumCustomUrl#is_abroad}
  */
  readonly isAbroad?: string;
  /**
  * The internet service provider used for data reporting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#isp DataTencentcloudRumCustomUrl#isp}
  */
  readonly isp?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#level DataTencentcloudRumCustomUrl#level}
  */
  readonly level?: string;
  /**
  * The network type used for data reporting.(`1`: Wifi, `2`: 2G, `3`: 3G, `4`: 4G, `5`: 5G, `6`: 6G, `100`: Unknown).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#net_type DataTencentcloudRumCustomUrl#net_type}
  */
  readonly netType?: string;
  /**
  * The operating system used for data reporting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#os DataTencentcloudRumCustomUrl#os}
  */
  readonly os?: string;
  /**
  * The platform where the data reporting takes place.(`1`: Android, `2`: IOS, `3`: Windows, `4`: Mac, `5`: Linux, `100`: Other).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#platform DataTencentcloudRumCustomUrl#platform}
  */
  readonly platform?: string;
  /**
  * Project ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#project_id DataTencentcloudRumCustomUrl#project_id}
  */
  readonly projectId: number;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#result_output_file DataTencentcloudRumCustomUrl#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Start time but is represented using a timestamp in seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#start_time DataTencentcloudRumCustomUrl#start_time}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#type DataTencentcloudRumCustomUrl#type}
  */
  readonly type: string;
  /**
  * The URL Key where the data reporting takes place.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#url DataTencentcloudRumCustomUrl#url}
  */
  readonly url?: string;
  /**
  * The SDK version used for data reporting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#version_num DataTencentcloudRumCustomUrl#version_num}
  */
  readonly versionNum?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url tencentcloud_rum_custom_url}
*/
export class DataTencentcloudRumCustomUrl extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "tencentcloud_rum_custom_url";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataTencentcloudRumCustomUrl resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataTencentcloudRumCustomUrl to import
  * @param importFromId The id of the existing DataTencentcloudRumCustomUrl that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataTencentcloudRumCustomUrl to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "tencentcloud_rum_custom_url", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_custom_url tencentcloud_rum_custom_url} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataTencentcloudRumCustomUrlConfig
  */
  public constructor(scope: Construct, id: string, config: DataTencentcloudRumCustomUrlConfig) {
    super(scope, id, {
      terraformResourceType: 'tencentcloud_rum_custom_url',
