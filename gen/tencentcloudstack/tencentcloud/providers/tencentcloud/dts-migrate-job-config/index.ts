// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_job_config
...
export interface DtsMigrateJobConfigAConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_job_config#action DtsMigrateJobConfigA#action}
  */
  readonly action: string;
  /**
  * complete mode, optional value is waitForSync or immediately.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_job_config#complete_mode DtsMigrateJobConfigA#complete_mode}
  */
  readonly completeMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_job_config#id DtsMigrateJobConfigA#id}
  *
  ...
  * job id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_job_config#job_id DtsMigrateJobConfigA#job_id}
  */
  readonly jobId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_job_config tencentcloud_dts_migrate_job_config}
*/
export class DtsMigrateJobConfigA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DtsMigrateJobConfigA that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_job_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_job_config tencentcloud_dts_migrate_job_config} Resource
  *
  * @param scope The scope in which to define this construct
