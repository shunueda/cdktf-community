// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/wedata_ops_task_owner
...
export interface WedataOpsTaskOwnerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/wedata_ops_task_owner#id WedataOpsTaskOwner#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/wedata_ops_task_owner#owner_uin WedataOpsTaskOwner#owner_uin}
  */
  readonly ownerUin: string;
  /**
  * Project id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/wedata_ops_task_owner#project_id WedataOpsTaskOwner#project_id}
  */
  readonly projectId: string;
  /**
  * Task id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/wedata_ops_task_owner#task_id WedataOpsTaskOwner#task_id}
  */
  readonly taskId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/wedata_ops_task_owner tencentcloud_wedata_ops_task_owner}
*/
export class WedataOpsTaskOwner extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WedataOpsTaskOwner that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/wedata_ops_task_owner#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/wedata_ops_task_owner tencentcloud_wedata_ops_task_owner} Resource
  *
  * @param scope The scope in which to define this construct
