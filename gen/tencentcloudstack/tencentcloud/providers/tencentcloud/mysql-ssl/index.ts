// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mysql_ssl
...
export interface MysqlSslConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mysql_ssl#id MysqlSsl#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mysql_ssl#instance_id MysqlSsl#instance_id}
  */
  readonly instanceId?: string;
  /**
  * RO group ID. Example value: cdbrg-k9a6gup3.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mysql_ssl#ro_group_id MysqlSsl#ro_group_id}
  */
  readonly roGroupId?: string;
  /**
  * Whether to enable SSL. `ON` means enabled, `OFF` means not enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mysql_ssl#status MysqlSsl#status}
  */
  readonly status: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mysql_ssl tencentcloud_mysql_ssl}
*/
export class MysqlSsl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlSsl that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mysql_ssl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mysql_ssl tencentcloud_mysql_ssl} Resource
  *
  * @param scope The scope in which to define this construct
