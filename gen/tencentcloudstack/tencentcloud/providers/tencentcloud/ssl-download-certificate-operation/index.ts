// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_download_certificate_operation
...
export interface SslDownloadCertificateOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  * Certificate ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_download_certificate_operation#certificate_id SslDownloadCertificateOperation#certificate_id}
  */
  readonly certificateId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_download_certificate_operation#id SslDownloadCertificateOperation#id}
  *
  ...
  * Certificate ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_download_certificate_operation#output_path SslDownloadCertificateOperation#output_path}
  */
  readonly outputPath: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_download_certificate_operation tencentcloud_ssl_download_certificate_operation}
*/
export class SslDownloadCertificateOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslDownloadCertificateOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_download_certificate_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_download_certificate_operation tencentcloud_ssl_download_certificate_operation} Resource
  *
  * @param scope The scope in which to define this construct
