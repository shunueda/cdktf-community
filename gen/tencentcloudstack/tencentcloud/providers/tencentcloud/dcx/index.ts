// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx
...
export interface DcxConfig extends cdktf.TerraformMetaArguments {
  ...
  * Bandwidth of the DC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx#bandwidth Dcx#bandwidth}
  */
  readonly bandwidth?: number;
  /**
  * BGP ASN of the user. A required field within BGP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx#bgp_asn Dcx#bgp_asn}
  */
  readonly bgpAsn?: number;
  /**
  * BGP key of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx#bgp_auth_key Dcx#bgp_auth_key}
  */
  readonly bgpAuthKey?: string;
  /**
  * Interconnect IP of the DC within client.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx#customer_address Dcx#customer_address}
  */
  readonly customerAddress?: string;
  /**
  * ID of the DC to be queried, application deployment offline.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx#dc_id Dcx#dc_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx#dc_owner_account Dcx#dc_owner_account}
  */
  readonly dcOwnerAccount?: string;
  /**
  * ID of the DC Gateway. Currently only new in the console.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx#dcg_id Dcx#dcg_id}
  */
  readonly dcgId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx#id Dcx#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx#name Dcx#name}
  */
  readonly name: string;
  /**
  * Network region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx#network_region Dcx#network_region}
  */
  readonly networkRegion?: string;
  /**
  * Type of the network. Valid value: `VPC`, `BMVPC` and `CCN`. The default value is `VPC`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx#network_type Dcx#network_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx#route_filter_prefixes Dcx#route_filter_prefixes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx#route_type Dcx#route_type}
  */
  readonly routeType?: string;
  /**
  * Interconnect IP of the DC within Tencent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx#tencent_address Dcx#tencent_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx#vlan Dcx#vlan}
  */
  readonly vlan?: number;
  /**
  * ID of the VPC or BMVPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx#vpc_id Dcx#vpc_id}
  */
  readonly vpcId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx tencentcloud_dcx}
*/
export class Dcx extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Dcx that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dcx tencentcloud_dcx} Resource
  *
  * @param scope The scope in which to define this construct
