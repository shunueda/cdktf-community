// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_replace_certificate_operation
...
export interface SslReplaceCertificateOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_replace_certificate_operation#cert_csr_encrypt_algo SslReplaceCertificateOperation#cert_csr_encrypt_algo}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_replace_certificate_operation#cert_csr_key_parameter SslReplaceCertificateOperation#cert_csr_key_parameter}
  */
  readonly certCsrKeyParameter?: string;
  /**
  * Certificate ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_replace_certificate_operation#certificate_id SslReplaceCertificateOperation#certificate_id}
  */
  readonly certificateId: string;
  /**
  * CSR Content.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_replace_certificate_operation#csr_content SslReplaceCertificateOperation#csr_content}
  */
  readonly csrContent?: string;
  /**
  * KEY Password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_replace_certificate_operation#csr_key_password SslReplaceCertificateOperation#csr_key_password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_replace_certificate_operation#csr_type SslReplaceCertificateOperation#csr_type}
  */
  readonly csrType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_replace_certificate_operation#id SslReplaceCertificateOperation#id}
  *
  ...
  * Reason for reissue.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_replace_certificate_operation#reason SslReplaceCertificateOperation#reason}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_replace_certificate_operation#valid_type SslReplaceCertificateOperation#valid_type}
  */
  readonly validType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_replace_certificate_operation tencentcloud_ssl_replace_certificate_operation}
*/
export class SslReplaceCertificateOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslReplaceCertificateOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_replace_certificate_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssl_replace_certificate_operation tencentcloud_ssl_replace_certificate_operation} Resource
  *
  * @param scope The scope in which to define this construct
