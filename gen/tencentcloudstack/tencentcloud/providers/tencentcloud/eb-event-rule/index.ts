// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/eb_event_rule
...
export interface EbEventRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/eb_event_rule#description EbEventRule#description}
  */
  readonly description?: string;
  /**
  * Enable switch.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/eb_event_rule#enable EbEventRule#enable}
  */
  readonly enable?: boolean | cdktf.IResolvable;
  /**
  * event bus Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/eb_event_rule#event_bus_id EbEventRule#event_bus_id}
  */
  readonly eventBusId: string;
  /**
  * Reference: [Event Mode](https://cloud.tencent.com/document/product/1359/56084).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/eb_event_rule#event_pattern EbEventRule#event_pattern}
  */
  readonly eventPattern: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/eb_event_rule#id EbEventRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/eb_event_rule#rule_name EbEventRule#rule_name}
  */
  readonly ruleName: string;
  /**
  * Tag description list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/eb_event_rule#tags EbEventRule#tags}
  */
  readonly tags?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/eb_event_rule tencentcloud_eb_event_rule}
*/
export class EbEventRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EbEventRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/eb_event_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/eb_event_rule tencentcloud_eb_event_rule} Resource
  *
  * @param scope The scope in which to define this construct
