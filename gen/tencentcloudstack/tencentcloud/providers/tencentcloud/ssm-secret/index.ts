// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret
...
export interface SsmSecretConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret#additional_config SsmSecret#additional_config}
  */
  readonly additionalConfig?: string;
  /**
  * Description of secret. The maximum is 2048 bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret#description SsmSecret#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret#id SsmSecret#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret#is_enabled SsmSecret#is_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret#kms_key_id SsmSecret#kms_key_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret#recovery_window_in_days SsmSecret#recovery_window_in_days}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret#secret_name SsmSecret#secret_name}
  */
  readonly secretName: string;
  /**
  * Type of secret. `0`: user-defined secret. `4`: redis secret. Default is `0`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret#secret_type SsmSecret#secret_type}
  */
  readonly secretType?: number;
  /**
  * Tags of secret.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret#tags SsmSecret#tags}
  */
  readonly tags?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret tencentcloud_ssm_secret}
*/
export class SsmSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret tencentcloud_ssm_secret} Resource
  *
  * @param scope The scope in which to define this construct
