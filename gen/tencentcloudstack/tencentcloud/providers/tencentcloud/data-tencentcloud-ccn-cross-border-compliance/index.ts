// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance
...
export interface DataTencentcloudCcnCrossBorderComplianceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance#business_address DataTencentcloudCcnCrossBorderCompliance#business_address}
  */
  readonly businessAddress?: string;
  /**
  * (Fuzzy query) Company name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance#company DataTencentcloudCcnCrossBorderCompliance#company}
  */
  readonly company?: string;
  /**
  * (Exact match) compliance approval form: 'ID'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance#compliance_id DataTencentcloudCcnCrossBorderCompliance#compliance_id}
  */
  readonly complianceId?: number;
  /**
  * (Exact match) email.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance#email DataTencentcloudCcnCrossBorderCompliance#email}
  */
  readonly email?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance#id DataTencentcloudCcnCrossBorderCompliance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance#issuing_authority DataTencentcloudCcnCrossBorderCompliance#issuing_authority}
  */
  readonly issuingAuthority?: string;
  /**
  * (Fuzzy query) legal representative.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance#legal_person DataTencentcloudCcnCrossBorderCompliance#legal_person}
  */
  readonly legalPerson?: string;
  /**
  * (Fuzzy query) Person in charge.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance#manager DataTencentcloudCcnCrossBorderCompliance#manager}
  */
  readonly manager?: string;
  /**
  * (Fuzzy query) ID card address of the person in charge.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance#manager_address DataTencentcloudCcnCrossBorderCompliance#manager_address}
  */
  readonly managerAddress?: string;
  /**
  * (Exact query) ID number of the person in charge.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance#manager_id DataTencentcloudCcnCrossBorderCompliance#manager_id}
  */
  readonly managerId?: string;
  /**
  * (Exact match) contact number of the person in charge.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance#manager_telephone DataTencentcloudCcnCrossBorderCompliance#manager_telephone}
  */
  readonly managerTelephone?: string;
  /**
  * (Exact match) post code.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance#post_code DataTencentcloudCcnCrossBorderCompliance#post_code}
  */
  readonly postCode?: number;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance#result_output_file DataTencentcloudCcnCrossBorderCompliance#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * (Exact match) service end date, such as: '2020-07-28'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance#service_end_date DataTencentcloudCcnCrossBorderCompliance#service_end_date}
  */
  readonly serviceEndDate?: string;
  /**
  * (Exact match) service provider, optional value: 'UNICOM'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance#service_provider DataTencentcloudCcnCrossBorderCompliance#service_provider}
  */
  readonly serviceProvider?: string;
  /**
  * (Exact match) service start date, such as: '2020-07-28'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance#service_start_date DataTencentcloudCcnCrossBorderCompliance#service_start_date}
  */
  readonly serviceStartDate?: string;
  /**
  * (Exact match) status. Pending: PENDING, Passed: APPROVED, Denied: DENY.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance#state DataTencentcloudCcnCrossBorderCompliance#state}
  */
  readonly state?: string;
  /**
  * (Exact match) Uniform Social Credit Code.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance#uniform_social_credit_code DataTencentcloudCcnCrossBorderCompliance#uniform_social_credit_code}
  */
  readonly uniformSocialCreditCode?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance tencentcloud_ccn_cross_border_compliance}
*/
export class DataTencentcloudCcnCrossBorderCompliance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudCcnCrossBorderCompliance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/ccn_cross_border_compliance tencentcloud_ccn_cross_border_compliance} Data Source
  *
  * @param scope The scope in which to define this construct
