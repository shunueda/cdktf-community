// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point
...
export interface CynosdbProxyEndPointConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#access_mode CynosdbProxyEndPoint#access_mode}
  */
  readonly accessMode?: string;
  /**
  * Do you want to automatically add read-only instances? Yes - Yes, no - Do not automatically add.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#auto_add_ro CynosdbProxyEndPoint#auto_add_ro}
  */
  readonly autoAddRo?: string;
  /**
  * Cluster ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#cluster_id CynosdbProxyEndPoint#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Connection pool threshold: unit (second).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#connection_pool_time_out CynosdbProxyEndPoint#connection_pool_time_out}
  */
  readonly connectionPoolTimeOut?: number;
  /**
  * Connection pool type: SessionConnectionPool (session level Connection pool).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#connection_pool_type CynosdbProxyEndPoint#connection_pool_type}
  */
  readonly connectionPoolType?: string;
  /**
  * Consistency timeout.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#consistency_time_out CynosdbProxyEndPoint#consistency_time_out}
  */
  readonly consistencyTimeOut?: number;
  /**
  * Consistency type: event, global, session.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#consistency_type CynosdbProxyEndPoint#consistency_type}
  */
  readonly consistencyType?: string;
  /**
  * Description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#description CynosdbProxyEndPoint#description}
  */
  readonly description?: string;
  /**
  * Enable Failover. yes or no.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#fail_over CynosdbProxyEndPoint#fail_over}
  */
  readonly failOver?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#id CynosdbProxyEndPoint#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#open_connection_pool CynosdbProxyEndPoint#open_connection_pool}
  */
  readonly openConnectionPool?: string;
  /**
  * Read and write attributes: READWRITE, READONLY.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#rw_type CynosdbProxyEndPoint#rw_type}
  */
  readonly rwType?: string;
  /**
  * Security Group ID Array.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#security_group_ids CynosdbProxyEndPoint#security_group_ids}
  */
  readonly securityGroupIds?: string[];
  /**
  * Transaction splitting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#trans_split CynosdbProxyEndPoint#trans_split}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#unique_subnet_id CynosdbProxyEndPoint#unique_subnet_id}
  */
  readonly uniqueSubnetId: string;
  /**
  * Private network ID, which is consistent with the cluster private network ID by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#unique_vpc_id CynosdbProxyEndPoint#unique_vpc_id}
  */
  readonly uniqueVpcId: string;
  /**
  * VIP Information.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#vip CynosdbProxyEndPoint#vip}
  */
  readonly vip?: string;
  /**
  * Port Information.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#vport CynosdbProxyEndPoint#vport}
  */
  readonly vport?: number;
  /**
  * Weight mode: system system allocation, custom customization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#weight_mode CynosdbProxyEndPoint#weight_mode}
  */
  readonly weightMode?: string;
  /**
  * instance_weights block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#instance_weights CynosdbProxyEndPoint#instance_weights}
  */
...
export interface CynosdbProxyEndPointInstanceWeights {
  ...
  * Instance Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#instance_id CynosdbProxyEndPoint#instance_id}
  */
  readonly instanceId: string;
  /**
  * Instance Weight.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#weight CynosdbProxyEndPoint#weight}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point tencentcloud_cynosdb_proxy_end_point}
*/
export class CynosdbProxyEndPoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CynosdbProxyEndPoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy_end_point tencentcloud_cynosdb_proxy_end_point} Resource
  *
  * @param scope The scope in which to define this construct
