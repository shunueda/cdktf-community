// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/sqlserver_backup_by_flow_id
...
export interface DataTencentcloudSqlserverBackupByFlowIdConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/sqlserver_backup_by_flow_id#flow_id DataTencentcloudSqlserverBackupByFlowId#flow_id}
  */
  readonly flowId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/sqlserver_backup_by_flow_id#id DataTencentcloudSqlserverBackupByFlowId#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/sqlserver_backup_by_flow_id#instance_id DataTencentcloudSqlserverBackupByFlowId#instance_id}
  */
  readonly instanceId: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/sqlserver_backup_by_flow_id#result_output_file DataTencentcloudSqlserverBackupByFlowId#result_output_file}
  */
  readonly resultOutputFile?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/sqlserver_backup_by_flow_id tencentcloud_sqlserver_backup_by_flow_id}
*/
export class DataTencentcloudSqlserverBackupByFlowId extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudSqlserverBackupByFlowId that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/sqlserver_backup_by_flow_id#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/sqlserver_backup_by_flow_id tencentcloud_sqlserver_backup_by_flow_id} Data Source
  *
  * @param scope The scope in which to define this construct
