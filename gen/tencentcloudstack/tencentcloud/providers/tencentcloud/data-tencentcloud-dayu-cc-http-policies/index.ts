// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dayu_cc_http_policies
...
export interface DataTencentcloudDayuCcHttpPoliciesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dayu_cc_http_policies#id DataTencentcloudDayuCcHttpPolicies#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dayu_cc_http_policies#name DataTencentcloudDayuCcHttpPolicies#name}
  */
  readonly name?: string;
  /**
  * Id of the CC http policy to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dayu_cc_http_policies#policy_id DataTencentcloudDayuCcHttpPolicies#policy_id}
  */
  readonly policyId?: string;
  /**
  * ID of the resource that the CC http policy works for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dayu_cc_http_policies#resource_id DataTencentcloudDayuCcHttpPolicies#resource_id}
  */
  readonly resourceId: string;
  /**
  * Type of the resource that the CC http policy works for, valid values are `bgpip`, `bgp`, `bgp-multip` and `net`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dayu_cc_http_policies#resource_type DataTencentcloudDayuCcHttpPolicies#resource_type}
  */
  readonly resourceType: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dayu_cc_http_policies#result_output_file DataTencentcloudDayuCcHttpPolicies#result_output_file}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dayu_cc_http_policies tencentcloud_dayu_cc_http_policies}
*/
export class DataTencentcloudDayuCcHttpPolicies extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudDayuCcHttpPolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dayu_cc_http_policies#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/dayu_cc_http_policies tencentcloud_dayu_cc_http_policies} Data Source
  *
  * @param scope The scope in which to define this construct
