// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy
...
export interface CynosdbProxyConfig extends cdktf.TerraformMetaArguments {
  ...
  * Cluster ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy#cluster_id CynosdbProxy#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Connection pool threshold: unit (second).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy#connection_pool_time_out CynosdbProxy#connection_pool_time_out}
  */
  readonly connectionPoolTimeOut?: number;
  /**
  * Connection pool type: SessionConnectionPool (session level Connection pool).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy#connection_pool_type CynosdbProxy#connection_pool_type}
  */
  readonly connectionPoolType?: string;
  /**
  * Number of CPU cores.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy#cpu CynosdbProxy#cpu}
  */
  readonly cpu: number;
  /**
  * Description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy#description CynosdbProxy#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy#id CynosdbProxy#id}
  *
  ...
  * Memory.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy#mem CynosdbProxy#mem}
  */
  readonly mem: number;
  /**
  * Whether to enable Connection pool, yes - enable, no - do not enable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy#open_connection_pool CynosdbProxy#open_connection_pool}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy#proxy_count CynosdbProxy#proxy_count}
  */
  readonly proxyCount?: number;
  /**
  * Security Group ID Array.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy#security_group_ids CynosdbProxy#security_group_ids}
  */
  readonly securityGroupIds?: string[];
  /**
  * The private network subnet ID is consistent with the cluster subnet ID by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy#unique_subnet_id CynosdbProxy#unique_subnet_id}
  */
  readonly uniqueSubnetId?: string;
  /**
  * Private network ID, which is consistent with the cluster private network ID by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy#unique_vpc_id CynosdbProxy#unique_vpc_id}
  */
  readonly uniqueVpcId?: string;
  /**
  * proxy_zones block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy#proxy_zones CynosdbProxy#proxy_zones}
  */
...
export interface CynosdbProxyProxyZones {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy#proxy_node_count CynosdbProxy#proxy_node_count}
  */
  readonly proxyNodeCount?: number;
  /**
  * Proxy node availability zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy#proxy_node_zone CynosdbProxy#proxy_node_zone}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy tencentcloud_cynosdb_proxy}
*/
export class CynosdbProxy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CynosdbProxy that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cynosdb_proxy tencentcloud_cynosdb_proxy} Resource
  *
  * @param scope The scope in which to define this construct
