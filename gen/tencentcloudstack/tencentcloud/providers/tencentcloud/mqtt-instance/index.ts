// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mqtt_instance
...
export interface MqttInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mqtt_instance#authorization_policy MqttInstance#authorization_policy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mqtt_instance#automatic_activation MqttInstance#automatic_activation}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mqtt_instance#force_delete MqttInstance#force_delete}
  */
  readonly forceDelete?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mqtt_instance#id MqttInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mqtt_instance#instance_type MqttInstance#instance_type}
  */
  readonly instanceType: string;
  /**
  * Instance name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mqtt_instance#name MqttInstance#name}
  */
  readonly name: string;
  /**
  * Payment mode (0: Postpaid; 1: Prepaid).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mqtt_instance#pay_mode MqttInstance#pay_mode}
  */
  readonly payMode?: number;
  /**
  * Remarks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mqtt_instance#remark MqttInstance#remark}
  */
  readonly remark?: string;
  /**
  * Whether to enable auto-renewal (0: Disabled; 1: Enabled).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mqtt_instance#renew_flag MqttInstance#renew_flag}
  */
  readonly renewFlag?: number;
  /**
  * Product SKU, available SKUs can be queried via the DescribeProductSKUList API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mqtt_instance#sku_code MqttInstance#sku_code}
  */
  readonly skuCode: string;
  /**
  * Tags of the MQTT instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mqtt_instance#tags MqttInstance#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Purchase duration (unit: months).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mqtt_instance#time_span MqttInstance#time_span}
  */
  readonly timeSpan?: number;
  /**
  * vpc_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mqtt_instance#vpc_list MqttInstance#vpc_list}
  */
...
export interface MqttInstanceVpcListStruct {
  ...
  * Subnet ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mqtt_instance#subnet_id MqttInstance#subnet_id}
  */
  readonly subnetId: string;
  /**
  * VPC ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mqtt_instance#vpc_id MqttInstance#vpc_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mqtt_instance tencentcloud_mqtt_instance}
*/
export class MqttInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MqttInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mqtt_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mqtt_instance tencentcloud_mqtt_instance} Resource
  *
  * @param scope The scope in which to define this construct
