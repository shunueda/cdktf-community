// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance
...
export interface MongodbShardingInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#auto_renew_flag MongodbShardingInstance#auto_renew_flag}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#availability_zone_list MongodbShardingInstance#availability_zone_list}
  */
  readonly availabilityZoneList?: string[];
  /**
  * The available zone of the Mongodb.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#available_zone MongodbShardingInstance#available_zone}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#charge_type MongodbShardingInstance#charge_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#engine_version MongodbShardingInstance#engine_version}
  */
  readonly engineVersion: string;
  /**
  * The availability zone to which the Hidden node belongs. This parameter is required in cross-AZ instance deployment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#hidden_zone MongodbShardingInstance#hidden_zone}
  */
  readonly hiddenZone?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#id MongodbShardingInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#in_maintenance MongodbShardingInstance#in_maintenance}
  */
  readonly inMaintenance?: number;
  /**
  * Name of the Mongodb instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#instance_name MongodbShardingInstance#instance_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#machine_type MongodbShardingInstance#machine_type}
  */
  readonly machineType: string;
  /**
  * Memory size. The minimum value is 2, and unit is GB. Memory and volume must be upgraded or degraded simultaneously.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#memory MongodbShardingInstance#memory}
  */
  readonly memory: number;
  /**
  * Number of mongos cpu.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#mongos_cpu MongodbShardingInstance#mongos_cpu}
  */
  readonly mongosCpu?: number;
  /**
  * Mongos memory size in GB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#mongos_memory MongodbShardingInstance#mongos_memory}
  */
  readonly mongosMemory?: number;
  /**
  * Number of mongos.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#mongos_node_num MongodbShardingInstance#mongos_node_num}
  */
  readonly mongosNodeNum?: number;
  /**
  * Number of nodes per shard, at least 3(one master and two slaves).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#nodes_per_shard MongodbShardingInstance#nodes_per_shard}
  */
  readonly nodesPerShard: number;
  /**
  * Password of this Mongodb account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#password MongodbShardingInstance#password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#prepaid_period MongodbShardingInstance#prepaid_period}
  */
  readonly prepaidPeriod?: number;
  /**
  * ID of the project which the instance belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#project_id MongodbShardingInstance#project_id}
  */
  readonly projectId?: number;
  /**
  * ID of the security group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#security_groups MongodbShardingInstance#security_groups}
  */
  readonly securityGroups?: string[];
  /**
  * Number of sharding.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#shard_quantity MongodbShardingInstance#shard_quantity}
  */
  readonly shardQuantity: number;
  /**
  * ID of the subnet within this VPC. The value is required if `vpc_id` is set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#subnet_id MongodbShardingInstance#subnet_id}
  */
  readonly subnetId?: string;
  /**
  * The tags of the Mongodb. Key name `project` is system reserved and can't be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#tags MongodbShardingInstance#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Disk size. The minimum value is 25, and unit is GB. Memory and volume must be upgraded or degraded simultaneously.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#volume MongodbShardingInstance#volume}
  */
  readonly volume: number;
  /**
  * ID of the VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#vpc_id MongodbShardingInstance#vpc_id}
  */
  readonly vpcId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance tencentcloud_mongodb_sharding_instance}
*/
export class MongodbShardingInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MongodbShardingInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/mongodb_sharding_instance tencentcloud_mongodb_sharding_instance} Resource
  *
  * @param scope The scope in which to define this construct
