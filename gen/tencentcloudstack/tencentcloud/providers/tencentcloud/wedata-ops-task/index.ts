// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/wedata_ops_task
...
export interface WedataOpsTaskConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/wedata_ops_task#action WedataOpsTask#action}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/wedata_ops_task#enable_data_backfill WedataOpsTask#enable_data_backfill}
  */
  readonly enableDataBackfill?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/wedata_ops_task#id WedataOpsTask#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/wedata_ops_task#kill_instance WedataOpsTask#kill_instance}
  */
  readonly killInstance?: boolean | cdktf.IResolvable;
  /**
  * Project Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/wedata_ops_task#project_id WedataOpsTask#project_id}
  */
  readonly projectId: string;
  /**
  * Task id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/wedata_ops_task#task_id WedataOpsTask#task_id}
  */
  readonly taskId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/wedata_ops_task tencentcloud_wedata_ops_task}
*/
export class WedataOpsTask extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WedataOpsTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/wedata_ops_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/wedata_ops_task tencentcloud_wedata_ops_task} Resource
  *
  * @param scope The scope in which to define this construct
