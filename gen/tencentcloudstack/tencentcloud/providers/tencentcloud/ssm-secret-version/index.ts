// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret_version
...
export interface SsmSecretVersionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret_version#id SsmSecretVersion#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret_version#secret_binary SsmSecretVersion#secret_binary}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret_version#secret_name SsmSecretVersion#secret_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret_version#secret_string SsmSecretVersion#secret_string}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret_version#version_id SsmSecretVersion#version_id}
  */
  readonly versionId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret_version tencentcloud_ssm_secret_version}
*/
export class SsmSecretVersion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmSecretVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/ssm_secret_version tencentcloud_ssm_secret_version} Resource
  *
  * @param scope The scope in which to define this construct
