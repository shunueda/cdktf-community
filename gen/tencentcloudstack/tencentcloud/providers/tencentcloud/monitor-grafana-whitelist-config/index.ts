// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/monitor_grafana_whitelist_config
...
export interface MonitorGrafanaWhitelistConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/monitor_grafana_whitelist_config#id MonitorGrafanaWhitelistConfig#id}
  *
  ...
  * Grafana instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/monitor_grafana_whitelist_config#instance_id MonitorGrafanaWhitelistConfig#instance_id}
  */
  readonly instanceId: string;
  /**
  * The addresses in the whitelist.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/monitor_grafana_whitelist_config#whitelist MonitorGrafanaWhitelistConfig#whitelist}
  */
  readonly whitelist?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/monitor_grafana_whitelist_config tencentcloud_monitor_grafana_whitelist_config}
*/
export class MonitorGrafanaWhitelistConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitorGrafanaWhitelistConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/monitor_grafana_whitelist_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/monitor_grafana_whitelist_config tencentcloud_monitor_grafana_whitelist_config} Resource
  *
  * @param scope The scope in which to define this construct
