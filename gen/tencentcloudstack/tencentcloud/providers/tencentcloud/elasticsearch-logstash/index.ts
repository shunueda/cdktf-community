// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash
...
export interface ElasticsearchLogstashConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#auto_voucher ElasticsearchLogstash#auto_voucher}
  */
  readonly autoVoucher?: number;
  /**
  * Period when charged by months or years(unit depends on TimeUnit).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#charge_period ElasticsearchLogstash#charge_period}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#charge_type ElasticsearchLogstash#charge_type}
  */
  readonly chargeType?: string;
  /**
  * Deployment mode, 0: single availability zone, 1: multiple availability zones.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#deploy_mode ElasticsearchLogstash#deploy_mode}
  */
  readonly deployMode?: number;
  /**
  * node disk size (unit GB).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#disk_size ElasticsearchLogstash#disk_size}
  */
  readonly diskSize?: number;
  /**
  * Disk type. CLOUD_SSD: SSD cloud disk; CLOUD_PREMIUM: high hard energy cloud disk; default: CLOUD_SSD.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#disk_type ElasticsearchLogstash#disk_type}
  */
  readonly diskType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#id ElasticsearchLogstash#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#instance_name ElasticsearchLogstash#instance_name}
  */
  readonly instanceName: string;
  /**
  * License type. oss: open source version; xpack:xpack version; default: xpack.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#license_type ElasticsearchLogstash#license_type}
  */
  readonly licenseType?: string;
  /**
  * Instance version(6.8.13, 7.10.1).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#logstash_version ElasticsearchLogstash#logstash_version}
  */
  readonly logstashVersion: string;
  /**
  * Node num(range 2-50).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#node_num ElasticsearchLogstash#node_num}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#node_type ElasticsearchLogstash#node_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#renew_flag ElasticsearchLogstash#renew_flag}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#subnet_id ElasticsearchLogstash#subnet_id}
  */
  readonly subnetId: string;
  /**
  * Tag description list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#tags ElasticsearchLogstash#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * charge time unit(set when ChargeType is PREPAID, default value: ms).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#time_unit ElasticsearchLogstash#time_unit}
  */
  readonly timeUnit?: string;
  /**
  * Voucher list(only can use one voucher by now).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#voucher_ids ElasticsearchLogstash#voucher_ids}
  */
  readonly voucherIds?: string[];
  /**
  * VPC id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#vpc_id ElasticsearchLogstash#vpc_id}
  */
  readonly vpcId: string;
  /**
  * Available zone. Create multi zone instance, parameter zone need input '-', details input to multi_zone_infos.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#zone ElasticsearchLogstash#zone}
  */
  readonly zone: string;
  /**
  * multi_zone_infos block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#multi_zone_infos ElasticsearchLogstash#multi_zone_infos}
  */
  readonly multiZoneInfos?: ElasticsearchLogstashMultiZoneInfos[] | cdktf.IResolvable;
  /**
  * operation_duration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#operation_duration ElasticsearchLogstash#operation_duration}
  */
...
export interface ElasticsearchLogstashMultiZoneInfos {
  ...
  * Availability zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#availability_zone ElasticsearchLogstash#availability_zone}
  */
  readonly availabilityZone: string;
  /**
  * Whether it is a hidden availability zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#hidden ElasticsearchLogstash#hidden}
  */
...
export interface ElasticsearchLogstashOperationDuration {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#periods ElasticsearchLogstash#periods}
  */
  readonly periods: number[];
  /**
  * operation end time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#time_end ElasticsearchLogstash#time_end}
  */
  readonly timeEnd: string;
  /**
  * operation start time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#time_start ElasticsearchLogstash#time_start}
  */
  readonly timeStart: string;
  /**
  * time zone, for example: UTC+8.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#time_zone ElasticsearchLogstash#time_zone}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash tencentcloud_elasticsearch_logstash}
*/
export class ElasticsearchLogstash extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticsearchLogstash that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/elasticsearch_logstash tencentcloud_elasticsearch_logstash} Resource
  *
  * @param scope The scope in which to define this construct
