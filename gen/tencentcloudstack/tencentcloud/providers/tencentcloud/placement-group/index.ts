// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/placement_group
...
export interface PlacementGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/placement_group#affinity PlacementGroup#affinity}
  */
  readonly affinity?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/placement_group#id PlacementGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/placement_group#name PlacementGroup#name}
  */
  readonly name: string;
  /**
  * Tags of the placement group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/placement_group#tags PlacementGroup#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Type of the placement group. Valid values: `HOST`, `SW` and `RACK`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/placement_group#type PlacementGroup#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/placement_group tencentcloud_placement_group}
*/
export class PlacementGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlacementGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/placement_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/placement_group tencentcloud_placement_group} Resource
  *
  * @param scope The scope in which to define this construct
