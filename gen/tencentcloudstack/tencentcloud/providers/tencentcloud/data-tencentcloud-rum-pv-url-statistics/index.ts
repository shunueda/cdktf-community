// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics
...
export interface DataTencentcloudRumPvUrlStatisticsConfig extends cdktf.TerraformMetaArguments {
  /**
  * The region where the data reporting takes place.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#area DataTencentcloudRumPvUrlStatistics#area}
  */
  readonly area?: string;
  /**
  * The mobile phone brand used for data reporting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#brand DataTencentcloudRumPvUrlStatistics#brand}
  */
  readonly brand?: string;
  /**
  * The browser type used for data reporting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#browser DataTencentcloudRumPvUrlStatistics#browser}
  */
  readonly browser?: string;
  /**
  * The device used for data reporting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#device DataTencentcloudRumPvUrlStatistics#device}
  */
  readonly device?: string;
  /**
  * End time but is represented using a timestamp in seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#end_time DataTencentcloudRumPvUrlStatistics#end_time}
  */
  readonly endTime: number;
  /**
  * The browser engine used for data reporting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#engine DataTencentcloudRumPvUrlStatistics#engine}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#env DataTencentcloudRumPvUrlStatistics#env}
  */
  readonly env?: string;
  /**
  * First Expansion parameter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#ext_first DataTencentcloudRumPvUrlStatistics#ext_first}
  */
  readonly extFirst?: string;
  /**
  * Second Expansion parameter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#ext_second DataTencentcloudRumPvUrlStatistics#ext_second}
  */
  readonly extSecond?: string;
  /**
  * Third Expansion parameter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#ext_third DataTencentcloudRumPvUrlStatistics#ext_third}
  */
  readonly extThird?: string;
  /**
  * The source page of the data reporting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#from DataTencentcloudRumPvUrlStatistics#from}
  */
  readonly from?: string;
  /**
  * Query groupby type `1`: 1m, `2`: 5m, `3`: 30m, `4`: 1h, `5`: 1d.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#group_by_type DataTencentcloudRumPvUrlStatistics#group_by_type}
  */
  readonly groupByType?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#id DataTencentcloudRumPvUrlStatistics#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#is_abroad DataTencentcloudRumPvUrlStatistics#is_abroad}
  */
  readonly isAbroad?: string;
  /**
  * The internet service provider used for data reporting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#isp DataTencentcloudRumPvUrlStatistics#isp}
  */
  readonly isp?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#level DataTencentcloudRumPvUrlStatistics#level}
  */
  readonly level?: string;
  /**
  * The network type used for data reporting.(`1`: Wifi, `2`: 2G, `3`: 3G, `4`: 4G, `5`: 5G, `6`: 6G, `100`: Unknown).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#net_type DataTencentcloudRumPvUrlStatistics#net_type}
  */
  readonly netType?: string;
  /**
  * The operating system used for data reporting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#os DataTencentcloudRumPvUrlStatistics#os}
  */
  readonly os?: string;
  /**
  * The platform where the data reporting takes place.(`1`: Android, `2`: IOS, `3`: Windows, `4`: Mac, `5`: Linux, `100`: Other).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#platform DataTencentcloudRumPvUrlStatistics#platform}
  */
  readonly platform?: string;
  /**
  * Project ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#project_id DataTencentcloudRumPvUrlStatistics#project_id}
  */
  readonly projectId: number;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#result_output_file DataTencentcloudRumPvUrlStatistics#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Start time but is represented using a timestamp in seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#start_time DataTencentcloudRumPvUrlStatistics#start_time}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#type DataTencentcloudRumPvUrlStatistics#type}
  */
  readonly type: string;
  /**
  * The SDK version used for data reporting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#version_num DataTencentcloudRumPvUrlStatistics#version_num}
  */
  readonly versionNum?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics tencentcloud_rum_pv_url_statistics}
*/
export class DataTencentcloudRumPvUrlStatistics extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "tencentcloud_rum_pv_url_statistics";
  ...
  * @param importFromId The id of the existing DataTencentcloudRumPvUrlStatistics that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "tencentcloud_rum_pv_url_statistics", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/data-sources/rum_pv_url_statistics tencentcloud_rum_pv_url_statistics} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataTencentcloudRumPvUrlStatisticsConfig
  */
  public constructor(scope: Construct, id: string, config: DataTencentcloudRumPvUrlStatisticsConfig) {
    super(scope, id, {
    ...
    this._groupByType = config.groupByType;
    this._id = config.id;
  ...
  // group_by_type - computed: false, optional: true, required: false
  private _groupByType?: number; 
  public get groupByType() {
    return this.getNumberAttribute('group_by_type');
  }
  public set groupByType(value: number) {
    this._groupByType = value;
  }
  public resetGroupByType() {
    this._groupByType = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get groupByTypeInput() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      group_by_type: cdktf.numberToTerraform(this._groupByType),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      group_by_type: {
        value: cdktf.numberToHclTerraform(this._groupByType),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
