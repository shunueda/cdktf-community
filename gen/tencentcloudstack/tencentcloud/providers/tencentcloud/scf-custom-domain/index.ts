// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain
...
export interface ScfCustomDomainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain#domain ScfCustomDomain#domain}
  */
  readonly domain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain#id ScfCustomDomain#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain#protocol ScfCustomDomain#protocol}
  */
  readonly protocol: string;
  /**
  * cert_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain#cert_config ScfCustomDomain#cert_config}
  */
  readonly certConfig?: ScfCustomDomainCertConfig;
  /**
  * endpoints_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain#endpoints_config ScfCustomDomain#endpoints_config}
  */
  readonly endpointsConfig: ScfCustomDomainEndpointsConfig[] | cdktf.IResolvable;
  /**
  * waf_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain#waf_config ScfCustomDomain#waf_config}
  */
...
export interface ScfCustomDomainCertConfig {
  ...
  * SSL Certificates ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain#certificate_id ScfCustomDomain#certificate_id}
  */
...
export interface ScfCustomDomainEndpointsConfigPathRewrite {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain#path ScfCustomDomain#path}
  */
  readonly path: string;
  /**
  * Replacement values: such as/, /$.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain#rewrite ScfCustomDomain#rewrite}
  */
  readonly rewrite: string;
  /**
  * Matching rules, value range: WildcardRules wildcard matching, ExactRules exact matching.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain#type ScfCustomDomain#type}
  */
...
export interface ScfCustomDomainEndpointsConfig {
  ...
  * Function name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain#function_name ScfCustomDomain#function_name}
  */
  readonly functionName: string;
  /**
  * Function namespace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain#namespace ScfCustomDomain#namespace}
  */
  readonly namespace: string;
  /**
  * Path, value specification: /,/*,/xxx,/xxx/a,/xxx/*.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain#path_match ScfCustomDomain#path_match}
  */
  readonly pathMatch: string;
  /**
  * Function alias or version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain#qualifier ScfCustomDomain#qualifier}
  */
  readonly qualifier: string;
  /**
  * path_rewrite block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain#path_rewrite ScfCustomDomain#path_rewrite}
  */
...
export interface ScfCustomDomainWafConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain#waf_instance_id ScfCustomDomain#waf_instance_id}
  */
  readonly wafInstanceId?: string;
  /**
  * Whether the Web Application Firewall is turned on, value range:OPEN, CLOSE.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain#waf_open ScfCustomDomain#waf_open}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain tencentcloud_scf_custom_domain}
*/
export class ScfCustomDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ScfCustomDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/scf_custom_domain tencentcloud_scf_custom_domain} Resource
  *
  * @param scope The scope in which to define this construct
