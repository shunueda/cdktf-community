// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dnat
...
export interface DnatConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dnat#description Dnat#description}
  */
  readonly description?: string;
  /**
  * Network address of the EIP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dnat#elastic_ip Dnat#elastic_ip}
  */
  readonly elasticIp: string;
  /**
  * Port of the EIP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dnat#elastic_port Dnat#elastic_port}
  */
  readonly elasticPort: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dnat#id Dnat#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dnat#nat_id Dnat#nat_id}
  */
  readonly natId: string;
  /**
  * Network address of the backend service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dnat#private_ip Dnat#private_ip}
  */
  readonly privateIp: string;
  /**
  * Port of intranet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dnat#private_port Dnat#private_port}
  */
  readonly privatePort: string;
  /**
  * Type of the network protocol. Valid value: `TCP` and `UDP`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dnat#protocol Dnat#protocol}
  */
  readonly protocol: string;
  /**
  * ID of the VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dnat#vpc_id Dnat#vpc_id}
  */
  readonly vpcId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dnat tencentcloud_dnat}
*/
export class Dnat extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Dnat that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dnat#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dnat tencentcloud_dnat} Resource
  *
  * @param scope The scope in which to define this construct
