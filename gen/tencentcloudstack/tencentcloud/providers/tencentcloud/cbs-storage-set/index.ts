// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cbs_storage_set
...
export interface CbsStorageSetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cbs_storage_set#availability_zone CbsStorageSet#availability_zone}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cbs_storage_set#charge_type CbsStorageSet#charge_type}
  */
  readonly chargeType?: string;
  /**
  * Exclusive cluster id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cbs_storage_set#dedicated_cluster_id CbsStorageSet#dedicated_cluster_id}
  */
  readonly dedicatedClusterId?: string;
  /**
  * The number of disks to be purchased. Default 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cbs_storage_set#disk_count CbsStorageSet#disk_count}
  */
  readonly diskCount?: number;
  /**
  * Indicates whether CBS is encrypted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cbs_storage_set#encrypt CbsStorageSet#encrypt}
  */
  readonly encrypt?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cbs_storage_set#id CbsStorageSet#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cbs_storage_set#kms_key_id CbsStorageSet#kms_key_id}
  */
  readonly kmsKeyId?: string;
  /**
  * ID of the project to which the instance belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cbs_storage_set#project_id CbsStorageSet#project_id}
  */
  readonly projectId?: number;
  /**
  * ID of the snapshot. If specified, created the CBS by this snapshot.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cbs_storage_set#snapshot_id CbsStorageSet#snapshot_id}
  */
  readonly snapshotId?: string;
  /**
  * Name of CBS. The maximum length can not exceed 60 bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cbs_storage_set#storage_name CbsStorageSet#storage_name}
  */
  readonly storageName: string;
  /**
  * Volume of CBS, and unit is GB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cbs_storage_set#storage_size CbsStorageSet#storage_size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cbs_storage_set#storage_type CbsStorageSet#storage_type}
  */
  readonly storageType: string;
  /**
  * Add extra performance to the data disk. Only works when disk type is `CLOUD_TSSD` or `CLOUD_HSSD`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cbs_storage_set#throughput_performance CbsStorageSet#throughput_performance}
  */
  readonly throughputPerformance?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cbs_storage_set tencentcloud_cbs_storage_set}
*/
export class CbsStorageSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CbsStorageSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cbs_storage_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/cbs_storage_set tencentcloud_cbs_storage_set} Resource
  *
  * @param scope The scope in which to define this construct
