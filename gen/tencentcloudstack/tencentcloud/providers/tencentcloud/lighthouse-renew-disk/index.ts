// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/lighthouse_renew_disk
...
export interface LighthouseRenewDiskConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/lighthouse_renew_disk#auto_voucher LighthouseRenewDisk#auto_voucher}
  */
  readonly autoVoucher?: boolean | cdktf.IResolvable;
  /**
  * List of disk ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/lighthouse_renew_disk#disk_id LighthouseRenewDisk#disk_id}
  */
  readonly diskId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/lighthouse_renew_disk#id LighthouseRenewDisk#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/lighthouse_renew_disk#renew_disk_charge_prepaid LighthouseRenewDisk#renew_disk_charge_prepaid}
  */
...
export interface LighthouseRenewDiskRenewDiskChargePrepaid {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/lighthouse_renew_disk#cur_instance_deadline LighthouseRenewDisk#cur_instance_deadline}
  */
  readonly curInstanceDeadline?: string;
  /**
  * Renewal period.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/lighthouse_renew_disk#period LighthouseRenewDisk#period}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/lighthouse_renew_disk#renew_flag LighthouseRenewDisk#renew_flag}
  */
  readonly renewFlag?: string;
  /**
  * newly purchased unit. Default: m.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/lighthouse_renew_disk#time_unit LighthouseRenewDisk#time_unit}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/lighthouse_renew_disk tencentcloud_lighthouse_renew_disk}
*/
export class LighthouseRenewDisk extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LighthouseRenewDisk that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/lighthouse_renew_disk#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/lighthouse_renew_disk tencentcloud_lighthouse_renew_disk} Resource
  *
  * @param scope The scope in which to define this construct
