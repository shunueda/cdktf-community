// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/pts_cron_job
...
export interface PtsCronJobConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/pts_cron_job#cron_expression PtsCronJob#cron_expression}
  */
  readonly cronExpression: string;
  /**
  * End Time; type: Timestamp ISO8601.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/pts_cron_job#end_time PtsCronJob#end_time}
  */
  readonly endTime?: string;
  /**
  * Execution frequency type, `1`: execute only once; `2`: daily granularity; `3`: weekly granularity; `4`: advanced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/pts_cron_job#frequency_type PtsCronJob#frequency_type}
  */
  readonly frequencyType: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/pts_cron_job#id PtsCronJob#id}
  *
  ...
  * Job Owner.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/pts_cron_job#job_owner PtsCronJob#job_owner}
  */
  readonly jobOwner: string;
  /**
  * Cron Job Name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/pts_cron_job#name PtsCronJob#name}
  */
  readonly name: string;
  /**
  * Note.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/pts_cron_job#note PtsCronJob#note}
  */
  readonly note?: string;
  /**
  * Notice ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/pts_cron_job#notice_id PtsCronJob#notice_id}
  */
  readonly noticeId?: string;
  /**
  * Project Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/pts_cron_job#project_id PtsCronJob#project_id}
  */
  readonly projectId: string;
  /**
  * Scenario Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/pts_cron_job#scenario_id PtsCronJob#scenario_id}
  */
  readonly scenarioId: string;
  /**
  * Scenario Name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/pts_cron_job#scenario_name PtsCronJob#scenario_name}
  */
  readonly scenarioName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/pts_cron_job tencentcloud_pts_cron_job}
*/
export class PtsCronJob extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PtsCronJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/pts_cron_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/pts_cron_job tencentcloud_pts_cron_job} Resource
  *
  * @param scope The scope in which to define this construct
