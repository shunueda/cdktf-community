// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/gaap_proxy
...
export interface GaapProxyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/gaap_proxy#access_region GaapProxy#access_region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/gaap_proxy#bandwidth GaapProxy#bandwidth}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/gaap_proxy#concurrent GaapProxy#concurrent}
  */
  readonly concurrent: number;
  /**
  * Indicates whether GAAP proxy is enabled, default value is `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/gaap_proxy#enable GaapProxy#enable}
  */
  readonly enable?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/gaap_proxy#id GaapProxy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/gaap_proxy#name GaapProxy#name}
  */
  readonly name: string;
  /**
  * Network type. `normal`: regular BGP, `cn2`: boutique BGP, `triple`: triple play.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/gaap_proxy#network_type GaapProxy#network_type}
  */
  readonly networkType?: string;
  /**
  * ID of the project within the GAAP proxy, `0` means is default project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/gaap_proxy#project_id GaapProxy#project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/gaap_proxy#realserver_region GaapProxy#realserver_region}
  */
  readonly realserverRegion: string;
  /**
  * Tags of the GAAP proxy. Tags that do not exist are not created automatically.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/gaap_proxy#tags GaapProxy#tags}
  */
  readonly tags?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/gaap_proxy tencentcloud_gaap_proxy}
*/
export class GaapProxy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GaapProxy that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/gaap_proxy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/gaap_proxy tencentcloud_gaap_proxy} Resource
  *
  * @param scope The scope in which to define this construct
