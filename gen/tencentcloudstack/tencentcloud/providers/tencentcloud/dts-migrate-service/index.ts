// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_service
...
export interface DtsMigrateServiceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_service#dst_database_type DtsMigrateService#dst_database_type}
  */
  readonly dstDatabaseType: string;
  /**
  * destination region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_service#dst_region DtsMigrateService#dst_region}
  */
  readonly dstRegion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_service#id DtsMigrateService#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_service#instance_class DtsMigrateService#instance_class}
  */
  readonly instanceClass: string;
  /**
  * job name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_service#job_name DtsMigrateService#job_name}
  */
  readonly jobName?: string;
  /**
  * source database type, optional value is mysql/redis/percona/mongodb/postgresql/sqlserver/mariadb.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_service#src_database_type DtsMigrateService#src_database_type}
  */
  readonly srcDatabaseType: string;
  /**
  * source region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_service#src_region DtsMigrateService#src_region}
  */
  readonly srcRegion: string;
  /**
  * tags block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_service#tags DtsMigrateService#tags}
  */
...
export interface DtsMigrateServiceTags {
  ...
  * tag key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_service#tag_key DtsMigrateService#tag_key}
  */
  readonly tagKey?: string;
  /**
  * tag value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_service#tag_value DtsMigrateService#tag_value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_service tencentcloud_dts_migrate_service}
*/
export class DtsMigrateService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DtsMigrateService that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/dts_migrate_service tencentcloud_dts_migrate_service} Resource
  *
  * @param scope The scope in which to define this construct
