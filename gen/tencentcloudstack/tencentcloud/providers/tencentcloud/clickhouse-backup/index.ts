// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/clickhouse_backup
...
export interface ClickhouseBackupConfig extends cdktf.TerraformMetaArguments {
  ...
  * COS bucket name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/clickhouse_backup#cos_bucket_name ClickhouseBackup#cos_bucket_name}
  */
  readonly cosBucketName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/clickhouse_backup#id ClickhouseBackup#id}
  *
  ...
  * Instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/clickhouse_backup#instance_id ClickhouseBackup#instance_id}
  */
  readonly instanceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/clickhouse_backup tencentcloud_clickhouse_backup}
*/
export class ClickhouseBackup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClickhouseBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/clickhouse_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/clickhouse_backup tencentcloud_clickhouse_backup} Resource
  *
  * @param scope The scope in which to define this construct
