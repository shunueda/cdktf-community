// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/as_lifecycle_hook
...
export interface AsLifecycleHookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/as_lifecycle_hook#default_result AsLifecycleHook#default_result}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/as_lifecycle_hook#heartbeat_timeout AsLifecycleHook#heartbeat_timeout}
  */
  readonly heartbeatTimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/as_lifecycle_hook#id AsLifecycleHook#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/as_lifecycle_hook#lifecycle_hook_name AsLifecycleHook#lifecycle_hook_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/as_lifecycle_hook#lifecycle_transition AsLifecycleHook#lifecycle_transition}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/as_lifecycle_hook#lifecycle_transition_type AsLifecycleHook#lifecycle_transition_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/as_lifecycle_hook#notification_metadata AsLifecycleHook#notification_metadata}
  */
  readonly notificationMetadata?: string;
  /**
  * For CMQ_QUEUE type, a name of queue must be set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/as_lifecycle_hook#notification_queue_name AsLifecycleHook#notification_queue_name}
  */
  readonly notificationQueueName?: string;
  /**
  * Target type. Valid values: `CMQ_QUEUE`, `CMQ_TOPIC`, `TDMQ_CMQ_QUEUE`, `TDMQ_CMQ_TOPIC`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/as_lifecycle_hook#notification_target_type AsLifecycleHook#notification_target_type}
  */
  readonly notificationTargetType?: string;
  /**
  * For CMQ_TOPIC type, a name of topic must be set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/as_lifecycle_hook#notification_topic_name AsLifecycleHook#notification_topic_name}
  */
  readonly notificationTopicName?: string;
  /**
  * ID of a scaling group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/as_lifecycle_hook#scaling_group_id AsLifecycleHook#scaling_group_id}
  */
  readonly scalingGroupId: string;
  /**
  * lifecycle_command block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/as_lifecycle_hook#lifecycle_command AsLifecycleHook#lifecycle_command}
  */
...
export interface AsLifecycleHookLifecycleCommand {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/as_lifecycle_hook#command_id AsLifecycleHook#command_id}
  */
  readonly commandId: string;
  /**
  * Custom parameter. The field type is JSON encoded string. For example, {"varA": "222"}.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/as_lifecycle_hook#parameters AsLifecycleHook#parameters}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/as_lifecycle_hook tencentcloud_as_lifecycle_hook}
*/
export class AsLifecycleHook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AsLifecycleHook that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/as_lifecycle_hook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.32/docs/resources/as_lifecycle_hook tencentcloud_as_lifecycle_hook} Resource
  *
  * @param scope The scope in which to define this construct
