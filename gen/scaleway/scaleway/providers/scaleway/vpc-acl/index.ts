// https://registry.terraform.io/providers/scaleway/scaleway/2.60.5/docs/resources/vpc_acl
...
export interface VpcAclConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.5/docs/resources/vpc_acl#default_policy VpcAcl#default_policy}
  */
  readonly defaultPolicy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.5/docs/resources/vpc_acl#id VpcAcl#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.5/docs/resources/vpc_acl#is_ipv6 VpcAcl#is_ipv6}
  */
  readonly isIpv6?: boolean | cdktf.IResolvable;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.5/docs/resources/vpc_acl#region VpcAcl#region}
  */
  readonly region?: string;
  /**
  * The VPC in which to create the ACL rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.5/docs/resources/vpc_acl#vpc_id VpcAcl#vpc_id}
  */
  readonly vpcId: string;
  /**
  * rules block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.5/docs/resources/vpc_acl#rules VpcAcl#rules}
  */
...
export interface VpcAclRules {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.5/docs/resources/vpc_acl#action VpcAcl#action}
  */
  readonly action?: string;
  /**
  * The rule description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.5/docs/resources/vpc_acl#description VpcAcl#description}
  */
  readonly description?: string;
  /**
  * Destination IP range to which this rule applies (CIDR notation with subnet mask)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.5/docs/resources/vpc_acl#destination VpcAcl#destination}
  */
  readonly destination?: string;
  /**
  * Ending port of the destination port range to which this rule applies (inclusive)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.5/docs/resources/vpc_acl#dst_port_high VpcAcl#dst_port_high}
  */
  readonly dstPortHigh?: number;
  /**
  * Starting port of the destination port range to which this rule applies (inclusive)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.5/docs/resources/vpc_acl#dst_port_low VpcAcl#dst_port_low}
  */
  readonly dstPortLow?: number;
  /**
  * The protocol to which this rule applies. Default value: ANY
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.5/docs/resources/vpc_acl#protocol VpcAcl#protocol}
  */
  readonly protocol?: string;
  /**
  * Source IP range to which this rule applies (CIDR notation with subnet mask)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.5/docs/resources/vpc_acl#source VpcAcl#source}
  */
  readonly source?: string;
  /**
  * Ending port of the source port range to which this rule applies (inclusive)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.5/docs/resources/vpc_acl#src_port_high VpcAcl#src_port_high}
  */
  readonly srcPortHigh?: number;
  /**
  * Starting port of the source port range to which this rule applies (inclusive)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.5/docs/resources/vpc_acl#src_port_low VpcAcl#src_port_low}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.5/docs/resources/vpc_acl scaleway_vpc_acl}
*/
export class VpcAcl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.5/docs/resources/vpc_acl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.5/docs/resources/vpc_acl scaleway_vpc_acl} Resource
  *
  * @param scope The scope in which to define this construct
