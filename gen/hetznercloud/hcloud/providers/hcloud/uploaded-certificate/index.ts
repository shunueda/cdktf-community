// https://registry.terraform.io/providers/hetznercloud/hcloud/1.54.0/docs/resources/uploaded_certificate
...
export class UploadedCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UploadedCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hetznercloud/hcloud/1.54.0/docs/resources/uploaded_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hetznercloud/hcloud/1.54.0/docs/resources/uploaded_certificate hcloud_uploaded_certificate} Resource
  *
  * @param scope The scope in which to define this construct
