// https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster
...
export interface CksClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#audit_policy CksCluster#audit_policy}
  */
  readonly auditPolicy?: string;
  /**
  * Authentication webhook configuration for the cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#authn_webhook CksCluster#authn_webhook}
  */
  readonly authnWebhook?: CksClusterAuthnWebhook;
  /**
  * Authorization webhook configuration for the cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#authz_webhook CksCluster#authz_webhook}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#internal_lb_cidr_names CksCluster#internal_lb_cidr_names}
  */
  readonly internalLbCidrNames: string[];
  /**
  * The name of the cluster. Must not be longer than 30 characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#name CksCluster#name}
  */
  readonly name: string;
  /**
  * OpenID Connect (OIDC) configuration for authentication to the api-server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#oidc CksCluster#oidc}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#pod_cidr_name CksCluster#pod_cidr_name}
  */
  readonly podCidrName: string;
  /**
  * Whether the cluster's api-server is publicly accessible from the internet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#public CksCluster#public}
  */
  readonly public?: boolean | cdktf.IResolvable;
  /**
  * The name of the vpc prefix to use as the service CIDR range. The prefix must exist in the cluster's VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#service_cidr_name CksCluster#service_cidr_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#shared_storage_cluster_id CksCluster#shared_storage_cluster_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#version CksCluster#version}
  */
  readonly version: string;
  /**
  * The ID of the VPC in which the cluster is located. Must be a VPC in the same Availability Zone as the cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#vpc_id CksCluster#vpc_id}
  */
  readonly vpcId: string;
  /**
  * The Availability Zone in which the cluster is located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#zone CksCluster#zone}
  */
...
export interface CksClusterAuthnWebhook {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#ca CksCluster#ca}
  */
  readonly ca?: string;
  /**
  * The URL of the webhook server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#server CksCluster#server}
  */
...
export interface CksClusterOidc {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#admin_group_binding CksCluster#admin_group_binding}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#client_id CksCluster#client_id}
  */
  readonly clientId: string;
  /**
  * The claim to use as the groups.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#groups_claim CksCluster#groups_claim}
  */
  readonly groupsClaim?: string;
  /**
  * The prefix to use for the groups.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#groups_prefix CksCluster#groups_prefix}
  */
  readonly groupsPrefix?: string;
  /**
  * The URL of the OIDC issuer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#issuer_url CksCluster#issuer_url}
  */
  readonly issuerUrl: string;
  /**
  * The claim to require for authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#required_claim CksCluster#required_claim}
  */
  readonly requiredClaim?: string;
  /**
  * A list of signing algorithms that the OpenID Connect discovery endpoint uses.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#signing_algs CksCluster#signing_algs}
  */
  readonly signingAlgs?: string[];
  /**
  * The claim to use as the username.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#username_claim CksCluster#username_claim}
  */
  readonly usernameClaim?: string;
  /**
  * The prefix to use for the username.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#username_prefix CksCluster#username_prefix}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster coreweave_cks_cluster}
*/
export class CksCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CksCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/cks_cluster coreweave_cks_cluster} Resource
  *
  * @param scope The scope in which to define this construct
