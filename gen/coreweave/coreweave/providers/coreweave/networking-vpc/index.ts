// https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/networking_vpc
...
export interface NetworkingVpcConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/networking_vpc#dhcp NetworkingVpc#dhcp}
  */
  readonly dhcp?: NetworkingVpcDhcp;
  /**
  * Settings affecting traffic leaving the VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/networking_vpc#egress NetworkingVpc#egress}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/networking_vpc#host_prefix NetworkingVpc#host_prefix}
  */
  readonly hostPrefix?: string;
  /**
  * Settings affecting traffic entering the VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/networking_vpc#ingress NetworkingVpc#ingress}
  */
  readonly ingress?: NetworkingVpcIngress;
  /**
  * The name of the VPC. Must not be longer than 30 characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/networking_vpc#name NetworkingVpc#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/networking_vpc#vpc_prefixes NetworkingVpc#vpc_prefixes}
  */
  readonly vpcPrefixes?: NetworkingVpcVpcPrefixes[] | cdktf.IResolvable;
  /**
  * The Availability Zone in which the VPC is located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/networking_vpc#zone NetworkingVpc#zone}
  */
...
export interface NetworkingVpcDhcpDns {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/networking_vpc#servers NetworkingVpc#servers}
  */
...
export interface NetworkingVpcDhcp {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/networking_vpc#dns NetworkingVpc#dns}
  */
...
export interface NetworkingVpcEgress {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/networking_vpc#disable_public_access NetworkingVpc#disable_public_access}
  */
...
export interface NetworkingVpcIngress {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/networking_vpc#disable_public_services NetworkingVpc#disable_public_services}
  */
...
export interface NetworkingVpcVpcPrefixes {
  ...
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/networking_vpc#value NetworkingVpc#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/networking_vpc coreweave_networking_vpc}
*/
export class NetworkingVpc extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkingVpc that should be imported. Refer to the {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/networking_vpc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/resources/networking_vpc coreweave_networking_vpc} Resource
  *
  * @param scope The scope in which to define this construct
