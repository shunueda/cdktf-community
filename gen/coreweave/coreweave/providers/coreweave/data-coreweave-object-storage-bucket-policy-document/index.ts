// https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/data-sources/object_storage_bucket_policy_document
...
export interface DataCoreweaveObjectStorageBucketPolicyDocumentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/data-sources/object_storage_bucket_policy_document#id DataCoreweaveObjectStorageBucketPolicyDocument#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/data-sources/object_storage_bucket_policy_document#version DataCoreweaveObjectStorageBucketPolicyDocument#version}
  */
  readonly version?: string;
  /**
  * statement block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/data-sources/object_storage_bucket_policy_document#statement DataCoreweaveObjectStorageBucketPolicyDocument#statement}
  */
...
export interface DataCoreweaveObjectStorageBucketPolicyDocumentStatement {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/data-sources/object_storage_bucket_policy_document#action DataCoreweaveObjectStorageBucketPolicyDocument#action}
  */
  readonly action?: string[];
  /**
  * Map of condition operators to JSON expressions
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/data-sources/object_storage_bucket_policy_document#condition DataCoreweaveObjectStorageBucketPolicyDocument#condition}
  */
  readonly condition?: { [key: string]: { [key: string]: string } } | cdktf.IResolvable;
  /**
  * `Allow` or `Deny`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/data-sources/object_storage_bucket_policy_document#effect DataCoreweaveObjectStorageBucketPolicyDocument#effect}
  */
  readonly effect?: string;
  /**
  * Map of principal types to ARNs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/data-sources/object_storage_bucket_policy_document#principal DataCoreweaveObjectStorageBucketPolicyDocument#principal}
  */
  readonly principal?: { [key: string]: string[] } | cdktf.IResolvable;
  /**
  * List of resource ARNs, e.g. `["arn:aws:s3:::bucket/*"]`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/data-sources/object_storage_bucket_policy_document#resource DataCoreweaveObjectStorageBucketPolicyDocument#resource}
  */
  readonly resource?: string[];
  /**
  * An optional statement identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/data-sources/object_storage_bucket_policy_document#sid DataCoreweaveObjectStorageBucketPolicyDocument#sid}
  */
  readonly sid?: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/data-sources/object_storage_bucket_policy_document coreweave_object_storage_bucket_policy_document}
*/
export class DataCoreweaveObjectStorageBucketPolicyDocument extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCoreweaveObjectStorageBucketPolicyDocument that should be imported. Refer to the {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/data-sources/object_storage_bucket_policy_document#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/coreweave/coreweave/0.6.0/docs/data-sources/object_storage_bucket_policy_document coreweave_object_storage_bucket_policy_document} Data Source
  *
  * @param scope The scope in which to define this construct
